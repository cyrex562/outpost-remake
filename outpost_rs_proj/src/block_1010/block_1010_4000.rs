...

{
  ...
  while( true ) {
    ...
    pass1_1008_3f62((u16 *)(pcStack20 & 0xffff0000 | (uStack24 * 0x6 + pcStack20)),
  ...
  for (iStack26 = 0x0; piVar2 = &iVar9->field112_0x74, *piVar2 != iStack26 && iStack26 <= *piVar2; iStack26 += 0x1) {
    pass1_1008_3e94((u16 *)(pcStack20 & 0xffff0000 | (iStack26 * 0x6 + pcStack20)),
                    (u16 *)CONCAT22(0x1050,&local_2e),CONCAT22(0x1050,&local_30));
...

{
  ...
  if ((puVar5 | puVar3) != 0x0) {
    ...
    (**fn_ptr_1)(s_tile2_bmp_1050_1538,puVar3,puVar5,0x1);
    puVar5 = extraout_DX;
  }
  iVar5 = param_3 + 0x105;
...

{
  ...
  &param_2->field11_0x16 = 0x0;
  &param_2->field_0x1a = 0x0;
...

{
  ...
  pstructd_1_hi = (StructD *)(param_1 >> 0x10);
  ...
  puVar1 = (u32*)(&pstructd_1->field12_0x14 + 0x2);
...

{
  ...
  if ((uVar4 | (iVar5 + 0x12)) != 0x0) {
    ...
    while( true ) {
      ...
      iStack4 += (-(iStack14 == 0x0) & 0x5) + 0x14 + (uVar9 + 0x4);
      iStack14 += 0x1;
    }
