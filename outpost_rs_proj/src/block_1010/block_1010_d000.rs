...

{
  ...
  uVar11 = param_3;
  uVar12 = (param_3 >> 0x10);
  struct_1010_dd5e(uVar11,uVar12,(iVar9 + 0x1));
  puVar6 = (u16 *)(param_2 | pcVar3);
  if (puVar6 != NULL) {
    pcStack12 = pcVar3;
    uStack10 = param_2;
    pass1_1010_e8f6(pcVar3,puVar6,uVar11,uVar12,(iVar9 + 0x1));
...

{
  ...
  uVar10 = (astruct_104 *)(param_5 >> 0x10);
  ...
  if ((uVar8 | uVar1) != 0x0) {
    ...
    if ((uVar1 | uStack1034) != 0x0) {
      ...
      uVar9 = (&iVar10->field1_0x2 + 0x2);
      (puVar2 + 0x4) = PTR_DAT_1050_1805_1050_368e;
      uVar3 = (iVar10 + 0x1);
      pcVar6 = pass1_1010_b038(param_3,uVar3,(uVar3 >> 0x10),*(u8 **)(puVar2 + 0x4),
                               param_6);
      ...
      string_1040_a626(uVar9,(u16 *)(uVar4 & 0xffff0000 | (iVar7 + 0xa)),CONCAT22(0x1050,local_402));
      uVar4 = iVar10->field1_0x2;
      iVar7 = uVar4;
      ...
      string_1040_a626(uVar9,(u16 *)(uVar4 & 0xffff0000 | (iVar7 + 0x14)),CONCAT22(0x1050,local_402));
...

{
  ...
  if (uVar7 != 0x0) {
    ...
    if ((uStack1032 | uStack1034) != 0x0) {
      ...
      uVar9 = (iVar10 + 0x6);
      pcVar5 = pass1_1010_b038(param_3,uVar9,(uVar9 >> 0x10),*(u8 **)(puVar1 + 0x4),
                               param_6);
      ...
      string_1040_a626(uVar8,(u16 *)(uVar2 & 0xffff0000 | (iVar6 + 0xa)),CONCAT22(0x1050,string_402));
      ...
      string_1040_a626(uVar8,(u16 *)(uVar2 & 0xffff0000 | (iVar6 + 0x14)),CONCAT22(0x1050,string_402))
      ;
...

{
  ...
  uVar13 = param_3;
  uVar14 = (param_3 >> 0x10);
  struct_1010_dd5e(uVar13,uVar14,(iVar9 + 0x1));
  ...
  if (uVar6 != 0x0) {
    ...
    iStack316 = 0x0;
    uVar12 = (iVar9 + 0x1);
    lVar1 = *(i32 *)(uVar12 + 0x26);
    for (uStack322 = 0x1; uStack322 < 0x25; uStack322 += 0x1) {
      if (*(i32 *)(uStack322 * 0x4 + uStack12) != 0x0) {
        if (iStack14 == 0x0) {
          iStack14 = 0x1;
        }
        ...
        uVar6 = (uStack322 * 0x4 + uStack12 + 0x2);
...

{
  ...
  do {
    ...
    *param_3 = *param_3 + uStack24;
    ...
    string_1040_a626(uVar6,(u16 *)CONCAT22(uVar1,iVar4),CONCAT22(0x1050,local_418));
    uVar1 = (iVar7 + 0x4);
    iStack4 += 0x1;
    iVar4 = (iVar7 + 0x2) + iStack4 * 0xa;
    (iVar4 + 0x4) = (iStack4 * 0x2 + iVar8);
...

{
  ...
  while( true ) {
    ...
    uVar1 = (&iVar4->field1_0x2 + 0x2);
    iVar2 = (astruct_493 *)(&iVar4->field1_0x2 + uStack94 * 0xa);
    uVar5 = (param_5 >> 0x10);
    uVar6 = (param_4 >> 0x10);
    if ((*(i32 *)(iStack92 * 0x4 + param_5) == 0x0) && (*(i32 *)(iStack92 * 0x4 + param_4) == 0x0)) break;
    uVar4 = uVar1;
    unk_str_op_1000_3d3e(CONCAT22(0x1050,local_54),*(char **)(iStack92 * 0x4 + param_4));
    uVar6 = (param_6 >> 0x10);
    iVar2->field4_0x4 = (uStack90 * 0x2 + param_6);
    string_1040_a626(uVar4,(u16 *)CONCAT22(uVar1,iVar2),CONCAT22(0x1050,local_54));
...

{
  ...
  while( true ) {
    ...
    uStack90 += 0x1;
    string_1040_a626(uVar2,(u16 *)(uVar3 & 0xffff0000 | uVar5),CONCAT22(0x1050,&string_54));
  }
  return;
}
...

{
  ...
  param_5_seg = (astruct_104 *)(param_5 >> 0x10);
  struct_104_5 = (astruct_104 *)param_5;
  uVar2 = (&struct_104_5->field1_0x2 + 0x2);
  ...
  string_1040_a626(uVar3,(u16 *)(uVar1 & 0xffff0000 | uVar4),string_4);
  return uVar3;
}
...

{
  ...
  if (param_3 != 0x0) {
    ...
    uVar3 = (uVar4 >> 0x10);
    iVar2 = uVar4;
    plStack16 = (i32 *)(uVar4 & 0xffff0000 | (iVar2 + 0x14U));
...

{
  ...
  *param_4 = 0x0;
  *param_3 = 0x0;
  paVar9 = (astruct_15 *)struct_op_1030_73a8((astruct_419 *)param_5,0x0,in_EDX);
  paVar6 = (astruct_57 *)(in_EDX & 0xffff0000 | paVar9 >> 0x10);
  iVar4 = (paVar9 + 0x12);
  uVar5 = param_1;
  uVar11 = (param_1 >> 0x10);
  ...
  paVar6 = (astruct_57 *)(paVar6 & 0xffff0000 | puVar10 >> 0x10);
  iVar7 = param_4;
  uVar8 = (param_4 >> 0x10);
  if (param_2 == 0x13) {
    iStack34 = 0x0;
    ...
    if ((paVar6 | param_4) != 0x0) {
      iStack34 = 0x0;
      for (uStack30 = 0x0; uVar2 = uStack30, *param_3 != uStack30 && uStack30 <= *param_3; uStack30 += 0x1) {
        do {
          iStack34 += 0x1;
    ...
    if ((char)param_2 == '\x06') {
      ...
      if ((bVar1 == 0x0) && (((iVar4 == 0x5 || (iVar4 == 0x6)) || (iVar4 == 0x8)))) {
        ...
        *param_3 = uVar5;
        ...
        for (iStack26 = 0x0; iStack26 < (-(uVar2 == 0x0) + 0xf); iStack26 += 0x1) {
