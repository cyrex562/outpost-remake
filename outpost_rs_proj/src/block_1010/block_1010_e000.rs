...

{
  ...
  for (uStack18 = 0x0; uStack18 < uStack14; uStack18 += 0x1) {
    ...
    uVar4 = uStack14;
    (**ppcVar1)(unaff_CS,param_1,param_2,(char)uStack18,(uStack18 >> 0x10));
    uVar3 = uVar4;
...

{
  ...
  *(iVar6 + 0x13c) = 0x0;
  ...
  if ((((((((BVar2 == 0x0) && (BVar2 = pass1_1008_c6ae(_u16_1050_06e0,uVar1,0x14), BVar2 == 0x0)) &&
    ...
    if ((pcVar3 == NULL) && (pcVar3 = pass1_1008_c6ae(_u16_1050_06e0,uVar1,0x11), pcVar3 == NULL)) {
...

{
  ...
  paVar7 = (astruct_57 *)CONCAT22(uVar8,(paVar10 >> 0x10));
  (param_1 + 0xa) = 0x389a;
  (param_1 + 0xc) = 0x1008;
  (param_1 + 0xa) = 0x3aa8;
  (param_1 + 0xc) = 0x1008;
  ...
  pass1_1000_4906((StructD *)(param_1 & 0xffff0000 | (param_1 + 0x34)),NULL,0x24);
  (param_1 + 0x38) = 0xfa;
  (param_1 + 0x3c) = 0x15e;
  uVar6 = 0x1c2;
  (param_1 + 0x40) = 0x1c2;
  ...
  for (iStack4 = 0x1; iStack4 < 0x9; iStack4 += 0x1) {
    ...
    iVar9 = iStack4 * 0x4;
    puVar1 = (u16 *)(param_1 + 0x34 + iVar9);
    uVar2 = *puVar1;
    uVar4 = uVar5 + *puVar1;
    uVar6 = uVar4;
    iVar3 = (param_1 + 0x34 + iVar9 + 0x2);
...

{
  ...
  pass1_1010_1f62((astruct_27 *)(param_1 & 0xffff | uVar1 << 0x10),0x13);
  return;
}
...

{
  ...
  pass1_1030_532e((astruct_97 *)CONCAT22(0x1050,local_10e),(param_1 + 0x20));
...

{
  ...
  pass1_1010_1f62((astruct_27 *)(param_1 & 0xffff | uVar1 << 0x10),0x12);
  return;
}
