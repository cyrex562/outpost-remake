      ...
      *piVar1 = *piVar1 - iVar10.field33_0x28;
      ...
      if (((&iVar10.field69_0x52 + 0x2) | &iVar10.field69_0x52) != 0x0) {
        ...
        for (iStack16 = 0x0; piVar1 = &iVar10.field_0x18, *piVar1 != iStack16 && iStack16 <= *piVar1;
          ...
          iVar13 = iStack16;
          (**ppcVar5)(uVar16,param_1,uVar4,(char)(uVar4 >> 0x10),&iVar10.field30_0x22);
          *piStack48 = iVar13;
          (uVar8 + 0x2) = in_EDX;
...

{
  ...
  uVar2 = (param_2 + 0x56);
  uVar2 = (uVar2 + 0x8);
  puStack8 = (u32*)(uVar2 + (param_2 + 0x5a) * 0x4);
  uStack12 = param_3;
  if (param_3 != 0x0) {
    uVar9 = 0x1000;
...

{
  ...
  *param_1 = 0x37c4;
  (param_1 + 0x2) = 0x1010;
  fn_ptr_1000_17ce(*(char **)(param_1 + 0xa));
...

{
  ...
  if (*(i32 *)(&iVar2.field12_0x14 + 0x2) != 0x0) {
    fn_ptr_1000_17ce(*(char **)(&iVar2.field12_0x14 + 0x2));
  }
...

{
  ...
  puVar1 = pass1_1000_4906((StructD *)(param_1 & 0xffff0000 | ZEXT24(&iVar1.field20_0x26)),NULL,0x40);
