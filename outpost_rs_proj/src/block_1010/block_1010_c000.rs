...

{
  ...
  case 0x12:
    ...
    break;
  case 0x13:
    pass1_1010_debe(param_3,param_4,(u16 *)CONCAT22(uVar2,&pstructd_1_lo->field_0x10),
...

{
  ...
  uStack404 = pass1_1000_4906((StructD *)CONCAT22(0x1050,&local_18a),NULL,0x94);
  uStack398 = 0x0;
    ...
    while( true ) {
      ...
      if (uVar9 != 0x0) {
        ...
        if (((0x0 < iVar10) && (!SBORROW2(iVar10,0x1))) &&
           (uVar7 = (iVar10 - 0x6U), iVar10 - 0x6U == 0x0 || (iVar10 - 0x1U) < 0x5)) {
