...

{
  ...
  pass1_1000_4906((StructD *)(param_1 & 0xffff | struct_1_hi << 0x10),NULL,0x124);
  return param_1;
}
...

{
  ...
  uVar7 = (param_2 >> 0x10);
  iVar6 = param_2;
  puStack6 = (u32*)(&paVar5.field_0x0 + iVar6);
  if (puStack6 != NULL) {
    return puStack6;
  }
  switch(param_3) {
...
LAB_1010_2126:
  ...
  case 0x7:
    ...
    uVar10 = pass1_1010_3d82(param_1 & 0xffff0000 | uVar4,(astruct_19 *)paVar5,(astruct_19 *)param_1,
                             param_3);
    puVar2 = (uVar10 >> 0x10);
...
LAB_1010_25b8:
      ...
      paVar13 = pass1_1010_195e(param_1 & 0xffff0000 | uVar4,(astruct_19 *)paVar5,(astruct_19 *)param_1,
                                param_3);
      uVar3 = (paVar13 >> 0x10);
  ...
  case 0x34:
    ...
    paVar13 = pass1_1010_1b6e((StructD *)(param_1 & 0xffff0000 | uVar4),(astruct_19 *)paVar5,
...

{
  ...
  *(astruct_19 **)0x4232 = param_4;
  ...
  for (iStack6 = 0x0; iStack6 < 0x10; iStack6 += 0x1) {
    ...
    uVar1 = (&param_3.field20_0x26 + 0x2);
    uVar7 = (uVar1 >> 0x10);
    iVar6 = uVar1;
...

{
  ...
  case 0x5:
    BVar15 = write_to_file_1008_7e1c
                       (param_2,ZEXT24(in_BX),
                        CONCAT13((char)(in_stack_00000000 >> 0x8),
  ...
  case 0x7:
    ...
    *(u8 **)(buffer_param_2 + iVar23 + 0x28) = puVar18;
    uVar36 = 0x50;
    uVar37 = 0x10;
    uVar34 = 0x80;
    uVar35 = 0x13;
    ...
    uVar28 = 0x0;
    uVar29 = 0x0;
    init_data = (DEVMODEA *)pass1_1008_4772(*(astruct_76 **)(buffer_param_2 + 0x26 + iVar23));
    uVar25 = (init_data >> 0x10);
    HVar11 = CreateDC16(init_data,CONCAT13(uVar29,CONCAT12(uVar28,uVar25)),
    ...
    HVar12 = palette_op_1008_4e08
                       ((HPALETTE16)&stack0xffec,uVar25,*(astruct_13 **)(_PTR_LOOP_1050_4230 + 0xe),
    ...
    for (read_buffer_22 = 0x0; piVar1 = (buffer_param_2 + 0x74),
      ...
      uVar13 = pass1_1000_484c(CONCAT13(0x10,CONCAT12(0x50,&stack0xfff2)),
                               CONCAT13((char)(uVar25 >> 0x8),
                                        CONCAT12((char)uVar25,iVar16 + (buffer_param_2 + 0x70))),0x8);
      if (uVar13 != 0x0) {
  ...
  case 0xd:
    ...
    *pbVar3 = bVar4 + (uVar10 < 0x1c);
    puVar5 = (CARRY1(bVar26,(u8)in_EDX) || CARRY1(bVar4,uVar10 < 0x1c));
    puVar6 = in_BX + -0x404;
    ...
    *piVar1 = s_SCInternalPutBldg2_site_0x_08lx__1050_5099 + 0x1;
    (iVar16 + 0x2) = 0x1010;
    ...
    if ((((iVar16 + 0x22) != 0x0) || ((iVar16 + 0x24) != 0x0)) ||
      ...
      in_BX =
              WritePrivateProfileString16
                         ...
                         *(char **)(buffer_param_2 * 0x4 + 0x1446),s_windows_1050_13b8);
    }
    return (u16_t)in_BX;
  case 0x14:
  ...
  case 0x17:
    uVar21 = uVar14 - 0x1;
    paVar22 = (astruct_57 *)(in_EDX & 0xffff0000 | uVar21);
    pbVar3 = (uVar10 + unaff_SI);
    ...
    while( true ) {
      if (uStack54 <= uStack42) {
        ...
        if (((BVar15 != 0x0) &&
            (BVar15 = read_file_1008_7dee((HFILE16 *)param_2,
                                          ((buffer_param_2 & 0xff00) << 0x10 |
                                                CONCAT12(uVar38,buffer_param_2 + 0x1c)),0x2), BVar15 != 0x0)
            ) && (BVar15 = read_file_1008_7dee((HFILE16 *)param_2,
                                               ((buffer_param_2 & 0xff00) << 0x10 |
      ...
      paVar22 = (astruct_57 *)(paVar22 & 0xffff0000 | (uVar21 | uVar10));
      ...
      if ((BVar15 == 0x0) ||
         (BVar15 = read_file_1008_7dee((HFILE16 *)param_2,
                                       (read_buffer_38 & 0xff000000 |
                                             CONCAT12((char)(read_buffer_38 >> 0x10),
                                                             read_buffer_38 + 0x6)),0x2), BVar15 == 0x0)) break;
      iVar16 = switch_1008_73ea(param_2,param_2,read_buffer_22);
      (read_buffer_38 + 0x4) = iVar16;
      ppcVar7 = (code **)((buffer_param_2 + 0x12) + 0x4);
      (**ppcVar7)();
      uStack42 += 0x1;
    }
...
LAB_1010_2ad8:
  if ((bVar26 == 0x1) || (bVar26 == 0x2)) {
    if (bVar26 == 0x1) {
      param_2 = ((buffer_param_2 + 0x20) + (buffer_param_2 + 0x22) +
                            (buffer_param_2 + 0x24) + (buffer_param_2 + 0x26));
    }
    if (param_2 != NULL) {
      uVar10 = param_2 / 0x2 + 0x1;
      if (0x5 < uVar10) {
        uVar10 = 0x5;
      }
      param_2 = uVar10;
...

{
  ...
  paVar3 = (astruct_57 *)(in_EDX & 0xffff0000 | puVar4 >> 0x10);
  in_buffer_4 = puVar4;
...

{
  ...
  puVar3 = mixed_1010_20ba((astruct_57 *)CONCAT22(uVar1,(paVar2 >> 0x10)),_u16_1050_0ed0,
                           ...
                           in_stack_0000ffb0);
  pass1_1008_3e94((u16 *)(puVar3 & 0xffff0000 | (puVar3 + 0xe)),(u16 *)CONCAT22(uVar5,piVar4),
  ...
  pass1_1000_4906((StructD *)(param_1 & 0xffff0000 | (param_1 + 0x2a)),NULL,0x28);
  return;
}
...

{
  ...
  (iVar3 + 0x28) = 0x0;
  uVar5 = *param_1;
  ppcVar1 = (code **)(uVar5 + 0x20);
  (**ppcVar1)();
  if (iVar2 == 0x0) {
    paStack6 = *(astruct_65 **)(iVar3 + 0x56);
  }
  else {
    ppcVar1 = (code **)(uVar5 + 0x14);
    (**ppcVar1)();
...

{
  ...
  if ((iVar3.field82_0x54 | &iVar3.field_0x52) != 0x0) {
    ...
    do {
      ...
      if (*(i32 *)(uVar2 + iStack4 * 0x4) != 0x0) {
        uVar2 = &iVar3.field_0x52;
        uVar2 = (uVar2 + iStack4 * 0x4);
        DestroyWindow16(*(HWND16 *)(uVar2 + 0x18));
        uVar2 = &iVar3.field_0x52;
