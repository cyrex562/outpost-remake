...
StructD * pass1_1020_70c0(StructD *param_1,param_2: u8)
...

{
  ...
  uVar7 = (astruct_40 *)(param_3 >> 0x10);
  iVar7 = (astruct_40 *)param_3;
  &iVar7->field17_0x14 = 0x0;
  iVar7->field20_0x18 = param_4;
  &iVar7->field21_0x1c = 0x0;
  (&iVar7[0x1].field0_0x0 + 0x1) = 0x0;
  ...
  ppcVar2 = (code **)(*(u32*)&iVar7->field21_0x1c + 0x4);
  ...
  *(HDC16 *)(uVar3 + 0x178) = local_4;
  ...
  paVar1 = *(astruct_13 **)(puVar12 + 0xe);
  pass1_1008_4d84(puVar10,(astruct_90 *)(puVar6 & 0xffff | (long)paVar11 << 0x10),paVar1);
  HVar6 = palette_op_1008_4e08((HPALETTE16)&local_4,puVar10,paVar1,(HDC16 *)CONCAT13(0x10,CONCAT12(0x50,&local_4)));
  *(HPALETTE16 *)(&iVar7[0x1].field0_0x0 + 0x1) = HVar6;
  return;
}
...

{
  ...
  if (*(i32 *)&struct767_var1->field_0x1c != 0x0) {
    pass1_1010_1ea6(&struct767_var1->field_0x1c,
                    (StructD *)(pstruct_param_1 & 0xffff | uVar4 << 0x10));
  }
  uVar1 = &struct767_var1->field12_0x14;
  uVar2 = (&struct767_var1->field12_0x14 + 0x2);
  ...
  obj = SelectPalette16(0x0,struct767_var1->field19_0x20,*(HDC16 *)(uVar3 + 0x178));
...
LAB_1020_7310:
  PostMessage16(0x0,0xeb,0x111,*(HWND16 *)(param_1 + 0x4));
...

{
  ...
  uVar1 = (param_1 + 0x1c);
  InvalidateRect16(0x0,(RECT16 *)(uVar1 + 0x16c),(HWND16)(uVar1 >> 0x10));
  return;
}
...

{
  ...
  if (is_iconic == 0x0) {
    ...
    fn_ptr_1 = (code **)(struct_1->field22_0x1c + 0x2c);
...
StructD * pass1_1020_7526(StructD *param_1,param_2: u8)
...
StructD * pass1_1020_774c(StructD *param_1,param_2: u8)
...
StructD * pass1_1020_78dc(StructD *param_1,param_2: u8)
...

{
  ...
  uVar1 = (StructD *)(in_struct_1 >> 0x10);
  ...
  pass1_1008_57c4((StructD *)(in_struct_1 & 0xffff0000 | ZEXT24(&local_struct_1->field192_0xd2)));
...

{
  ...
  ppcVar2 = (code **)(*iVar4->field223_0xe0 + 0x24);
  iVar3 = (**ppcVar2)();
  if (iVar3 != param_4) {
...

{
  ...
  ppcVar1 = (code **)(*(u32*)&iVar2->field_0xe0 + 0x14);
  (**ppcVar1)();
  return;
}
pub fn win_ui_menu_op_1020_7ad2(param_1: *mut astruct_854,param_2: HWND16,RECT16 *param_3)
...
StructD * pass1_1020_7b60(StructD *param_1,param_2: u8)
...

{
  ...
  if ((is_iconic == 0x0) || (PTR_LOOP_1050_0010 != NULL)) {
    ...
    fn_ptr_1 = (code **)(*struct_e_1->field5_0x6 + 0x18);
...
StructD * pass1_1020_7f38(StructD *param_1,param_2: u8)
