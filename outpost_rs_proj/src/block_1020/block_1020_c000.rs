...

{
  ...
  uVar3 = (param_1 >> 0x10);
  if ((param_1 + 0x1c) != 0x0) {
    pass1_1020_c6a4((astruct_359 *)(param_1 & 0xffff | uVar3 << 0x10));
  }
  uVar1 = (param_1 + 0x18);
  uVar4 = (uVar1 >> 0x10);
...

{
  ...
  uVar1 = (param_1 >> 0x10);
  if ((param_1 + 0x1c) != 0x0) {
    pass1_1020_c6a4((astruct_359 *)(param_1 & 0xffff | uVar1 << 0x10));
  }
  return;
}
...

{
  ...
  uVar3 = (astruct_360 *)(param_1 >> 0x10);
  iVar3 = (astruct_360 *)param_1;
  if (iVar3->field22_0x1c != 0x0) {
    pass1_1020_c6a4((astruct_359 *)(param_1 & 0xffff | ZEXT24(uVar3) << 0x10));
  }
  uStack6 = 0x0;
  while( true ) {
    ...
    if (*(i32 *)(uVar2 + uStack6 * 0x6) == param_2) break;
    uStack6 += 0x1;
  }
  return;
}
...

{
  ...
  if (*(i32 *)(iVar6 + 0x10) == 0x0) {
    uVar4 = (iVar6 + 0xc);
    pSVar5 = (StructD *)(in_EDX & 0xffff0000 | (iVar6 + 0xe));
  }
  else {
    uVar2 = (iVar6 + 0x10);
...
StructD * pass1_1020_c80e(StructD *param_1,param_2: u8)
...
LAB_1020_c92d:
    ...
    if ((bVar12 || *puVar1 == param_2) &&
       ((bVar12 || (puVar1 = (u16 *)(uStack14 + 0xc), *puVar1 < param_2 || *puVar1 == param_2))))
    goto LAB_1020_c92d;
    bVar12 = false;
    while( true ) {
...

{
  ...
  if (*(i32 *)(uVar3 + 0x200) != 0x8000002) {
    uVar1 = (param_1 >> 0x10);
    if ((param_1 + 0x12) == 0x5) {
      pass1_1020_cac2(uVar3,in_stack_0000ffb4,(astruct_15 *)(param_1 & 0xffff | uVar1 << 0x10));
    }
  }
  return;
}
...

{
  ...
  paVar9 = (astruct_57 *)(paVar9 & 0xffff0000 | puVar11 >> 0x10);
  ...
  puStack12 = mixed_1010_20ba(paVar9,_u16_1050_0ed0,(u8 **)CONCAT22(param_2,0x8),in_stack_0000fe72,
                              in_stack_0000ff96,in_stack_0000ff9c,in_stack_0000ffa0);
  paVar9 = (astruct_57 *)(paVar9 & 0xffff0000 | puStack12 >> 0x10);
...
LAB_1020_cbb0:
    ...
    paVar9 = (astruct_57 *)(paVar9 & 0xffff0000 | (uVar6 >> 0xf));
    pass1_1030_7ddc(uVar6,paVar9,CONCAT22(uVar10,puVar5),(long)uVar6,0x1e);
    ppcVar2 = (code **)(*puStack16 + 0xc);
...
StructD * pass1_1020_cc56(StructD *param_1,param_2: u8)
...
StructD * pass1_1020_cd58(StructD *param_1,param_2: u8)
...

{
  ...
  if (*(i32 *)(uVar4 + 0x200) != 0x8000002) {
    ...
    paVar2 = (astruct_57 *)(paVar2 & 0xffff0000 | puVar5 >> 0x10);
...

{
  ...
  if ((param_2 + 0x12) == 0x5) {
    ...
    if (*(i32 *)(uVar3 + 0x200) != 0x8000002) {
      ...
      pass1_1010_043a(paVar4,*(i32 *)(uVar3 + 0x4),0x5);
    }
  }
  return;
}
...
StructD * pass1_1020_cfde(StructD *param_1,param_2: u8)
