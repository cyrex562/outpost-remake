...

{
  ...
  paVar8 = (astruct_57 *)(param_2 & 0xffff0000 | uVar5);
  if (uVar5 != 0x0) {
    pass1_1008_3bd6(paVar8,param_1,(astruct_57 *)param_2,0x0,0x1f009b,0x0,0x740075,
  ...
  paVar9 = (astruct_57 *)(paVar8 & 0xffff0000 | uVar5);
  if (uVar5 != 0x0) {
    pass1_1008_3bd6(paVar9,param_1,(astruct_57 *)paVar8,0x0,0x31009b,0x0,0x760077,
  ...
  paVar8 = (astruct_57 *)(paVar9 & 0xffff0000 | uVar5);
  if (uVar5 != 0x0) {
    pass1_1008_3bd6(paVar8,param_1,(astruct_57 *)paVar9,0x0,0x77009b,0x0,0x780079,
  ...
  puVar10 = mixed_1010_20ba(paVar8,_u16_1050_0ed0,(u8 **)CONCAT22(unaff_SI,0x2d),param_9,param_5,param_14,
                            param_15);
  paVar8 = (astruct_57 *)(paVar8 & 0xffff0000 | puVar10 >> 0x10);
  ...
  *(astruct_160 **)&struct_1.field_0xc2 = paVar3;
  ...
  ppcVar2 = (code **)(*(u32*)&struct_1[0x1].field20_0x26 + 0x10);
...

{
  ...
  if ((param_1 | in_AX) == 0x0) {
    ...
    hcursor = pt_in_rect_1010_40f8
                        (uVar3,(iVar4 + 0xf2),(POINT16 *)CONCAT22(0x1050,&local_6),in_stack_0000ffc2);
    if (hcursor != 0xffff) {
      hcursor_00 = LoadCursor16(0x7f02,0x0);
      SetCursor16(hcursor_00);
      ppcVar2 = (code **)(*puStack10 + 0x4);
      (**ppcVar2)();
...
StructD * pass1_1020_135e(StructD *param_1,param_2: u8)
...

{
  ...
  &iVar5.field17_0x14 = 0x0;
  iVar5.field20_0x18 = NULL;
  puVar10 = pass1_1008_3e38((astruct_19 *)(param_1 & 0xffff0000 | ZEXT24(&iVar5.field_0x1e)));
  paVar7 = (astruct_57 *)CONCAT22(uVar8,(puVar10 >> 0x10));
  ...
  puStack6 = mixed_1010_20ba((astruct_57 *)(paVar7 & 0xffff0000 | puVar11 >> 0x10),_u16_1050_0ed0,
  ...
  ppcVar3 = (code **)(*(u32*)&iVar5.field17_0x14 + 0x4);
  ...
  *(HDC16 *)(uVar1 + 0x7c) = local_8;
  ...
  ppcVar3 = (code **)(iVar5.field20_0x18 + 0x14);
  (**ppcVar3)();
  paVar2 = *(astruct_13 **)(puStack6 + 0xe);
  pass1_1008_4d84(puVar6,(astruct_90 *)(pSVar5 & 0xffff | ZEXT24(puVar6) << 0x10),paVar2);
...

{
  ...
  if (iVar1.field12_0x14 != 0x0) {
    pass1_1010_1ea6(iVar1.field12_0x14,(StructD *)(param_1 & 0xffff | uVar2 << 0x10));
  }
  uVar1 = iVar1.field12_0x14;
  obj = SelectPalette16(0x0,*(HPALETTE16 *)&iVar1.field_0x1c,*(HDC16 *)(uVar1 + 0x7c));
...

{
  ...
  if (BVar2 == 0x0) {
    uVar4 = 0x1010;
    paVar3 = (astruct_76 *)pass1_1010_454a(iVar3.field20_0x14);
...

{
  ...
  if (PTR_LOOP_1050_0010 == NULL) {
    ...
    fn_ptr_1 = (code **)(*struct_1.field20_0x14 + 0x2c);
...
StructD * pass1_1020_170a(StructD *param_1,param_2: u8)
...
pub fn *pvStack60;
  ...
  paVar8 = (astruct_57 *)(paVar8 & 0xffff0000 | puStack6 >> 0x10);
  ...
  HVar3 = (HWND16)(puVar10 >> 0x10);
  struct_9[0x7].hwnd_0x6 = HVar3;
  uVar16 = struct_9[0x7].field1_0x2;
  fn_ptr_1 = (code **)(*(u32*)&struct_9[0x7].field1_0x2 + 0x10);
  (**fn_ptr_1)(0x1010,uVar16,HVar3,uStack8);
  mem_op_1000_179c(0x12,paVar8);
  uStack76 = paVar8;
  puVar4 = (uStack76 | pvVar1);
  paVar8 = (astruct_57 *)(paVar8 & 0xffff0000 | ZEXT24(puVar4));
  uStack78 = pvVar1;
  if (puVar4 == NULL) {
    &struct_9[0x7].lpvoid_field_0x8 = 0x0;
  }
  else {
  ...
  pIStack12 = (INT16 *)(puVar1 & 0xffff0000 | (puVar1 + 0xa));
...

{
  ...
  if (((uVar2 + 0x30) < 0x3) &&
     (pass1_1010_4df0(param_2,&struct_b_1[0x7].field1_0x2), param_1 == 0x0)) {
    return 0x1;
  }
  return 0x0;
}
...
u16 destroy_win_1020_1e1e(mut param_1: u16 ,mut param_2: u16 ,param_3: HWND16)
...
StructD * pass1_1020_1e54(StructD *param_1,param_2: u8)
...
// WARNING: Globals starting with '_' overlap smaller symbols at the same address
pub fn pass1_1020_1eea(u8 *param_1,param_2: *mut astruct_663,StructB *param_3,param_4: HWND16)

{
  ...
  ppuVar5 = (u8 **)CONCAT22((in_stack_0000ffec >> 0x10),0x39);
  ...
  ppcVar1 = (code **)(*iVar3.field4_0x6 + 0x4);
