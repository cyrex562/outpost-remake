...

{
  ...
  if (iVar5.field3_0x6 == NULL) {
    ...
    PTR_LOOP_1050_5f2e = ((u32)lVar7 >> 0x10);
    uVar4 = lVar7;
  }
...

{
  ...
  BVar1 = write_to_file_1008_7e1c(param_2,CONCAT22(0x1050,local_10),(char *)0x4,in_stack_0000ffd8);
  if (BVar1 != 0x0) {
    local_8 = (u32)((int)param_1 + 0x8);
    BVar1 = write_to_file_1008_7e1c(param_2,CONCAT22(0x1050,&local_8),(char *)0x4,in_stack_0000ffd8);
    if (BVar1 != 0x0) {
      return;
    }
  }
...

{
  ...
  BVar1 = read_file_1008_7dee(param_2,((u32)param_1 & 0xffff0000 | (u32)((int)param_1 + 0x4)),0x4);
  if (BVar1 != 0x0) {
    BVar1 = read_file_1008_7dee(param_2,((u32)param_1 & 0xffff0000 | (u32)((int)param_1 + 0x8)),0x4);
    if (BVar1 != 0x0) {
      return;
    }
  }
...

{
  ...
  PTR_LOOP_1050_5168 = ((u32)param_1 >> 0x10);
...

{
  ...
  if (uVar2 != 0x0) {
    ...
    BVar3 = write_to_file_1008_7e1c(param_2,CONCAT22(0x1050,local_c),(char *)0x2,in_stack_0000ffde);
    if (BVar3 != 0x0) {
      ...
      BVar3 = write_to_file_1008_7e1c
                        (param_2,(u32)((int)piVar1 + 0x2),(char *)(u32)(*piVar1 * 0x2),
                         in_stack_0000ffde);
      if (BVar3 != 0x0) {
        return 0x1;
      }
...

{
  ...
  if (*(i32 *)(iVar3 + 0xc) == 0x0) {
    ...
    param_2 = (astruct_57 *)((u32)param_2 & 0xffff0000 | (u32)(uVar3 | param_1));
    if ((uVar3 | param_1) == 0x0) {
      (u32)(iVar3 + 0xc) = 0x0;
    }
    else {
...

{
  ...
  if (*(i32 *)(iVar6 + 0x4) == 0x0) {
    ...
    PTR_LOOP_1050_5f2e = ((u32)lVar8 >> 0x10);
    uVar4 = lVar8;
  }
...

{
  ...
  if (uVar1 != 0x0) {
    iVar2 = (int)param_2;
    BVar3 = write_to_file_1008_7e1c
                      (param_3,param_2 & 0xffff0000 | (u32)(iVar2 + 0x10),(char *)0x106,in_stack_0000ffe8);
    if (BVar3 != 0x0) {
      BVar3 = write_to_file_1008_7e1c
                        (param_3,param_2 & 0xffff0000 | (u32)(iVar2 + 0x116),(char *)0x86,in_stack_0000ffe8);
      if (BVar3 != 0x0) {
        BVar3 = write_to_file_1008_7e1c
                          (param_3,param_2 & 0xffff0000 | (u32)(iVar2 + 0x19c),(char *)0xa,in_stack_0000ffe8);
        if (BVar3 != 0x0) {
          BVar3 = write_to_file_1008_7e1c
                            (param_3,param_2 & 0xffff0000 | (u32)(iVar2 + 0x1a6),(char *)0x106,in_stack_0000ffe8
                            );
          if (BVar3 != 0x0) {
            BVar3 = write_to_file_1008_7e1c
                              (param_3,param_2 & 0xffff0000 | (u32)(iVar2 + 0x2ac),(char *)0x106,
                               in_stack_0000ffe8);
            if (BVar3 != 0x0) {
              return;
            }
...

{
  ...
  if (param_1 != 0x0) {
    iVar1 = (int)param_3;
    BVar2 = read_file_1008_7dee((HFILE16 *)param_4,(param_3 & 0xffff0000 | (u32)(iVar1 + 0x10)),0x106);
    if (BVar2 != 0x0) {
      BVar2 = read_file_1008_7dee((HFILE16 *)param_4,(param_3 & 0xffff0000 | (u32)(iVar1 + 0x116)),0x86);
      if (BVar2 != 0x0) {
        BVar2 = read_file_1008_7dee((HFILE16 *)param_4,(param_3 & 0xffff0000 | (u32)(iVar1 + 0x19c)),0xa);
        if (BVar2 != 0x0) {
          BVar2 = read_file_1008_7dee((HFILE16 *)param_4,(param_3 & 0xffff0000 | (u32)(iVar1 + 0x1a6)),0x106);
          if (BVar2 != 0x0) {
            BVar2 = read_file_1008_7dee((HFILE16 *)param_4,(param_3 & 0xffff0000 | (u32)(iVar1 + 0x2ac)),0x106);
            if (BVar2 != 0x0) {
              return;
            }
          }
...

{
  ...
  BVar3 = write_to_file_1008_7e1c(param_3,CONCAT22(0x1050,local_c),(char *)0x2,in_stack_0000ffc8);
  if (((BVar3 != 0x0) &&
    ...
    BVar3 = write_to_file_1008_7e1c(param_3,CONCAT22(0x1050,local_6),(char *)0x2,in_stack_0000ffc8);
    if (BVar3 != 0x0) {
      puVar1 = iVar6.field16_0x10;
      local_18[0] = (u32)((int)puVar1 + 0xe);
      BVar3 = write_to_file_1008_7e1c(param_3,CONCAT22(0x1050,local_18),(char *)0x4,in_stack_0000ffc8);
      if ((BVar3 != 0x0) &&
         (puVar1 = iVar6.field16_0x10,
         BVar3 = write_to_file_1008_7e1c
                           (param_3,(u32)puVar1 & 0xffff0000 | (u32)((int)puVar1 + 0x12),(char *)0x10,
        ...
        if ((BVar3 != 0x0) &&
           ((puVar1 = iVar6.field16_0x10, ((int)puVar1 + 0x22) == 0x0 ||
            ...
            BVar3 = write_to_file_1008_7e1c
                              (param_3,(u32)(iVar4 + 0x24),(char *)(u32)((iVar4 + 0x22) * 0x2),
                               in_stack_0000ffc8), BVar3 != 0x0)))) {
...

{
  ...
  if (BVar3 != 0x0) {
    ...
    if (puVar4 != NULL) {
      ...
      if ((((BVar3 != 0x0) &&
           (puVar1 = iVar14.field13_0x10,
           BVar3 = read_file_1008_7dee(param_4,((u32)puVar1 & 0xffff0000 | (u32)((int)puVar1 + 0xc)),0x2),
           BVar3 != 0x0)) &&
          (puVar1 = iVar14.field13_0x10,
          BVar3 = read_file_1008_7dee(param_4,((u32)puVar1 & 0xffff0000 | (u32)((int)puVar1 + 0xe)),0x4),
          BVar3 != 0x0)) &&
         ((puVar1 = iVar14.field13_0x10,
          BVar3 = read_file_1008_7dee(param_4,((u32)puVar1 & 0xffff0000 | (u32)((int)puVar1 + 0x12)),0x10),
          BVar3 != 0x0 &&
          (puVar1 = iVar14.field13_0x10,
          BVar3 = read_file_1008_7dee(param_4,((u32)puVar1 & 0xffff0000 | (u32)((int)puVar1 + 0x22)),0x2),
          BVar3 != 0x0)))) {
        puVar1 = iVar14.field13_0x10;
        if (((int)puVar1 + 0x22) != 0x0) {
          ...
          BVar3 = read_file_1008_7dee(param_4,iVar9.field35_0x24,(u32)(iVar9.field34_0x22 * 0x2));
          if (BVar3 == 0x0) {
            u16_1050_0310 = 0x6d2;
            return;
          }
        }
        BVar3 = read_file_1008_7dee(param_4,((u32)param_3 & 0xffff0000 | ZEXT24(&iVar14.field_0x14)),0x2);
        if (((BVar3 != 0x0) &&
            (BVar3 = read_file_1008_7dee(param_4,CONCAT22(0x1050,&local_404),0x2), BVar3 != 0x0)) &&
           ((BVar3 = read_file_1008_7dee(param_4,((u32)param_3 & 0xffff0000 | ZEXT24(&iVar14.field_0x18)),0x2),
...

{
  ...
  BVar2 = write_to_file_1008_7e1c
                    (param_2,param_1 & 0xffff0000 | (u32)(iVar1 + 0x4),(char *)0x16c,in_stack_0000ffd0);
  if (BVar2 != 0x0) {
    BVar2 = write_to_file_1008_7e1c
                      (param_2,param_1 & 0xffff0000 | (u32)(iVar1 + 0x174),&DAT_0000_000c,in_stack_0000ffd0);
    if (BVar2 != 0x0) {
      BVar2 = write_to_file_1008_7e1c
                        (param_2,param_1 & 0xffff0000 | (u32)(iVar1 + 0x180),&DAT_0000_000c,in_stack_0000ffd0);
      if (BVar2 != 0x0) {
        BVar2 = write_to_file_1008_7e1c
                          (param_2,param_1 & 0xffff0000 | (u32)(iVar1 + 0x18c),(char *)0x18,in_stack_0000ffd0);
        if (BVar2 != 0x0) {
          uVar3 = (param_1 >> 0x10);
          local_c = (iVar1 + 0x1a8);
          BVar2 = write_to_file_1008_7e1c(param_2,CONCAT22(0x1050,&local_c),(char *)0x2,in_stack_0000ffd0);
          if (BVar2 != 0x0) {
            local_16[0] = (u32)(iVar1 + 0x1aa);
            BVar2 = write_to_file_1008_7e1c(param_2,CONCAT22(0x1050,local_16),(char *)0x4,in_stack_0000ffd0);
            if (BVar2 != 0x0) {
              local_a[0] = (u32)(iVar1 + 0x170);
              BVar2 = write_to_file_1008_7e1c(param_2,CONCAT22(0x1050,local_a),(char *)0x4,in_stack_0000ffd0);
              if (BVar2 != 0x0) {
                local_c = (iVar1 + 0x1ae);
                BVar2 = write_to_file_1008_7e1c(param_2,CONCAT22(0x1050,&local_c),(char *)0x2,in_stack_0000ffd0);
                if (BVar2 != 0x0) {
...

{
  ...
  BVar1 = read_file_1008_7dee(param_2,((u32)param_1 & 0xffff0000 | ZEXT24(iVar2)),0x16c);
  if (((((BVar1 != 0x0) &&
        (BVar1 = read_file_1008_7dee(param_2,((u32)param_1 & 0xffff0000 | ZEXT24(&iVar2.field_0x174)),0xc),
        BVar1 != 0x0)) &&
       (BVar1 = read_file_1008_7dee(param_2,((u32)param_1 & 0xffff0000 | ZEXT24(&iVar2.field_0x180)),0xc),
       BVar1 != 0x0)) &&
      ((BVar1 = read_file_1008_7dee(param_2,((u32)param_1 & 0xffff0000 | ZEXT24(&iVar2.field_0x18c)),0x18),
       BVar1 != 0x0 &&
       (BVar1 = read_file_1008_7dee(param_2,((u32)param_1 & 0xffff0000 | ZEXT24(&iVar2.field_0x1a8)),0x2),
       BVar1 != 0x0)))) &&
     (BVar1 = read_file_1008_7dee(param_2,((u32)param_1 & 0xffff0000 | ZEXT24(&iVar2->field_0x1aa)),0x4),
     BVar1 != 0x0)) {
    if ((int)u16_1050_0312 < 0x2) {
      return;
    }
    BVar1 = read_file_1008_7dee(param_2,((u32)param_1 & 0xffff0000 | ZEXT24(&iVar2->field_0x170)),0x4);
    if ((BVar1 != 0x0) &&
       (BVar1 = read_file_1008_7dee(param_2,((u32)param_1 & 0xffff0000 | ZEXT24(&iVar2->field_0x1ae)),0x2),
       BVar1 != 0x0)) {
      return;
    }
  }
...

{
  ...
  pass1_1030_3948(param_2,(u16 *)CONCAT22(0x1050,local_c),CONCAT13(0x10,CONCAT12(0x50,&local_a)),0x3);
  uVar6 = (u32)((int)&local_a + 0x2U);
  pass1_1030_3948(param_2,(u16 *)CONCAT22(0x1050,(int)&local_a + 0x2U),CONCAT13(0x10,CONCAT12(0x50,local_c)),
                  0x4);
  do {
    uVar5 = uVar6;
    ...
    uVar3 = *puVar1;
    *puVar1 = *puVar1 + uVar6;
    piVar2 = (uVar5 * 0x4 + (int)uStack6 + 0x2);
...

{
  ...
  if (param_2 == 0x0) {
    ...
    pass1_1030_3948(param_1,(u16 *)CONCAT22(0x1050,&local_4),CONCAT22(0x1050,&local_6),param_2);
...

{
  ...
  uStack6 = 0x0;
  pass1_1030_3948(param_1,(u16 *)CONCAT22(0x1050,&local_a),CONCAT22(0x1050,&local_8),param_2);
...

{
  ...
  pass1_1030_3948(param_1,(u16 *)CONCAT22(0x1050,&local_6),CONCAT22(0x1050,&local_4),param_4);
  iStack8 = local_6;
  while( true ) {
    if (iStack8 < local_4) {
      return;
...

{
  ...
  piStack6 = CONCAT22((int)paVar8,uVar2);
  *piStack6 = param_6;
      ...
      if (h_file != 0xffff) {
        ...
        if ((lVar1 | param_3) != 0x0) {
          ...
          while (iStack56 != 0x0) {
            ...
            pbStack60 = ((u32)pbStack60 & 0xffff0000 | (u32)((int)pbStack60 + 0x1));
...
// WARNING: Globals starting with '_' overlap smaller symbols at the same address
pub fn pass1_1030_5044(u16_t param_1,param_2: *mut astruct_117)
...
u16 pass1_1030_5260(mut param_1: u16 ,mut param_2: u16 ,mut param_3: u32)
...
pub fn pass1_1030_5290(param_1: *mut astruct_376,u8 *param_2,param_3: *mut astruct_377)
...
u16 pass1_1030_538a(param_1: *mut astruct_694)
...
pub fn pass1_1030_54f8(param_1: *mut astruct_378,u8 *param_2,param_3: *mut astruct_379)
...
pub fn pass1_1030_56f6(u16_t param_1,param_2: *mut astruct_731,mut param_3: u32)

{
  ...
  if (uVar4 != 0x0) {
    ...
    BVar5 = write_to_file_1008_7e1c(param_3,CONCAT22(0x1050,local_e),(char *)0x2,in_stack_0000ffd6);
    if (BVar5 != 0x0) {
      uVar3 = (u32)&iVar7->field_0x10;
      local_8[0] = ((int)uVar3 + 0x2);
      BVar5 = write_to_file_1008_7e1c(param_3,CONCAT22(0x1050,local_8),(char *)0x2,in_stack_0000ffd6);
      if ((BVar5 != 0x0) &&
        ...
        BVar5 = write_to_file_1008_7e1c(param_3,CONCAT22(0x1050,local_8),(char *)0x2,in_stack_0000ffd6);
        if (BVar5 != 0x0) {
          for (iStack4 = 0x0; uVar3 = (u32)&iVar7->field_0x10, piVar1 = ((int)uVar3 + 0x1a),
...
// WARNING: Globals starting with '_' overlap smaller symbols at the same address
pub fn file_1030_581e(mut param_1: i16,u8 *param_2,param_3: *mut astruct_381,mut param_4: u32)
    ...
    if (BVar5 != 0x0) {
      ...
      if (BVar5 != 0x0) {
        ...
        if (puVar6 != NULL) {
          ...
          BVar5 = read_file_1008_7dee((HFILE16 *)param_4,(uVar3 & 0xffff0000 | (u32)((int)uVar3 + 0x1a)),0x2);
          if (BVar5 != 0x0) {
            uVar8 = (u32)&iVar12->field16_0x10;
            ...
            for (iStack1036 = 0x0; uVar8 = (u32)&iVar12->field16_0x10, piVar1 = ((int)uVar8 + 0x1a),
            ...
            if ((BVar5 != 0x0) &&
               (BVar5 = read_file_1008_7dee((HFILE16 *)param_4,
                                            ((u32)param_3 & 0xffff0000 | ZEXT24(&iVar12->field_0x1c)),0x2),
               BVar5 != 0x0)) {
              return;
            }
          }
...
pub fn pass1_1030_5a52(mut param_1: u32,u32 *param_2,u32 *param_3)
...

{
  ...
  pass1_1008_6cb4((astruct_362 *)CONCAT22(0x1050,local_20),&local_14,&DAT_1050_1050,puVar1,uVar2);
...
i16 pass1_1030_5b00(mut param_1: u32)
...
pub fn pass1_1030_5b6c(mut param_1: u16 ,param_2: *mut astruct_610,char *param_3)
...

{
  ...
  if (BVar1 != 0x0) {
    BVar1 = write_to_file_1008_7e1c(param_2,param_1,(char *)0x24,in_stack_0000ffe8);
    if (BVar1 == 0x0) {
      u16_1050_0310 = 0x6d0;
      return BVar1;
    }
...
u16 * pass1_1030_5d3c(mut param_1: u16 ,u8 *param_2,param_3: *mut u16,mut param_4: u32)
...
pub fn pass1_1030_5dbe(u16_t param_1,mut param_2: u32,mut param_3: u32)

{
  ...
  if (uVar3 != 0x0) {
    ...
    if ((BVar4 != 0x0) &&
      ...
      BVar4 = write_to_file_1008_7e1c(param_3,CONCAT22(0x1050,local_c),(char *)0x2,in_stack_0000ffde);
      if (BVar4 != 0x0) {
        uVar2 = (u32)(iVar6 + 0x10);
        ...
        BVar4 = write_to_file_1008_7e1c
                          (param_3,(u32)(iVar6 + 0xc),(char *)(u32)((iVar6 + 0xa) * 0x2),
                           in_stack_0000ffde);
        if (BVar4 != 0x0) {
          return;
        }
...
// WARNING: Globals starting with '_' overlap smaller symbols at the same address
pub fn file_1030_5e70(mut param_1: i16,u8 *param_2,mut param_3: u32,mut param_4: u32)
    ...
    if (puVar5 != NULL) {
      ...
      *puVar2 = uVar4;
      ...
      if (BVar6 != 0x0) {
        uVar1 = (u32)(iVar15 + 0x10);
        uVar7 = (int)uVar1 + 0xa;
        BVar6 = read_file_1008_7dee((HFILE16 *)param_4,(uVar1 & 0xffff0000 | (u32)uVar7),0x2);
        if (BVar6 != 0x0) {
...

{
  ...
  do {
    do {
      ...
      paVar6 = (astruct_57 *)(u32)(uVar4 | iVar2);
...
pub fn pass1_1030_8030(mut param_1: u16 ,mut param_2: u32)
...
pub fn pass1_1030_8086(mut param_1: u32) -> u32
...
pub fn pass1_1030_809c(mut param_1: u32)
...
astruct_611 * pass1_1030_80ee(param_1: *mut astruct_611,u8 param_2)
...
// WARNING: Globals starting with '_' overlap smaller symbols at the same address
pub fn struct_1030_8128(param_1: *mut astruct_57,param_2: *mut astruct_135)
...
// WARNING: Globals starting with '_' overlap smaller symbols at the same address
pub fn pass1_1030_8210(param_1: *mut u16)
...
pub fn pass1_1030_82f0(mut param_1: u32,mut param_2: u32)
...
// WARNING: Globals starting with '_' overlap smaller symbols at the same address
pub fn pass1_1030_8308(mut param_1: u16 ,mut param_2: u16 ,mut param_3: u16 ,mut param_4: u16 ,param_5: *mut u16,param_6: *mut u16,
                    mut param_7: u32)
...
pub fn pass1_1030_8326(void) -> u32
...
// WARNING: Globals starting with '_' overlap smaller symbols at the same address
pub fn pass1_1030_8344(mut param_1: u32,mut param_2: u32)

{
  pass1_1028_e1ec(_PTR_LOOP_1050_65e2,param_2);
  return;
}
pub fn fn_ptr_1030_835a(u32 **param_1,char *param_2)

{
  fn_ptr_1028_d566(*param_1,(astruct_97 *)param_2);
  return;
}
pub fn pass1_1030_8372(u32 **param_1,mut param_2: u32,u32 *param_3)
...
// WARNING: Globals starting with '_' overlap smaller symbols at the same address
pub fn pass1_1030_838e(u32 *param_1)
...
// WARNING: Globals starting with '_' overlap smaller symbols at the same address
pub fn pass1_1030_83ba(undefined1 param_1,u32 **param_2,i32 param_3)
...
// WARNING: Globals starting with '_' overlap smaller symbols at the same address
pub fn vsprintf_op_1030_840a(mut param_1: u16 ,mut param_2: u32)
...
pub fn pass1_1030_8480(StructD *param_1)

{
  fn_ptr_1000_17ce(*(char **)param_1);
  return;
}
pub fn pass1_1030_8496(mut param_1: u32)

{
  fn_ptr_1000_17ce(*(char **)((int)param_1 + 0x2));
  return;
}
pub fn pass1_1030_84ae(mut param_1: u32)
...
pub fn fn_ptr_1030_84d0(mut param_1: u32)
...
pub fn struct_1030_8544(param_1: *mut astruct_355,param_2: *mut astruct_356)
...
pub fn pass1_1030_85be(param_1: *mut astruct_172,mut param_2: u16 ,mut param_3: i16)
...
pub fn pass1_1030_8604(StructD *param_1)

{
  fn_ptr_1000_17ce(*(char **)param_1);
  return;
}
pub fn pass1_1030_861a(mut param_1: u16 ,mut param_2: u16 ,mut param_3: u16 ,mut param_4: u16 ,mut param_5: u16 )
...
pub fn pass1_1030_8660(mut param_1: u16 ,mut param_2: u16 ,mut param_3: u32,u32 *param_4,mut param_5: u16 )
...
pub fn pass1_1030_86ec(param_1: *mut astruct_612,mut param_2: u16 )
...
pub fn pass1_1030_871e(i32 *param_1,u32 *param_2,mut param_3: u16 )
...
pub fn pass1_1030_877c(param_1: *mut u16)
...
// WARNING: Globals starting with '_' overlap smaller symbols at the same address
pub fn pass1_1030_878c(param_1: *mut astruct_172)

{
  ...
  if ((int)pSVar4 == 0x0) {
    if (*(i32 *)param_1 == 0x0) {
      ...
      PTR_LOOP_1050_5f2e = ((u32)lVar5 >> 0x10);
      uVar3 = lVar5;
    }
...

{
  ...
  pass1_1000_4aea(*param_1,uVar1,(int)((u32)uVar1 >> 0x10),0x6,0x888e);
  return;
}
pub fn pass1_1030_8854(mut param_1: u16 ,mut param_2: u16 ,mut param_3: u16 )

{
  ...
  pass1_1000_49c6(&local_c,&DAT_1050_1050,*_param_1,uVar1,((u32)uVar1 >> 0x10),0x6,
                  0x888e);
  return;
}
...
u16 pass1_1030_888e(mut param_1: u32,mut param_2: u32)
...
pub fn pass1_1030_88ce(param_1: *mut u16,mut param_2: u32,mut param_3: u32)

{
  ...
  *param_1 = 0x8e38;
  ...
  puVar2 = ((u32)((long)local_1e * (long)local_1c) >> 0x10);
...
pub fn pass1_1030_8a2c(StructD *param_1)
...
// WARNING: Could not reconcile some variable overlaps
pub fn pass1_1030_8b00(mut param_1: u32,param_2: *mut u16,param_3: *mut u16)

{
  ...
  if (uStack38._3_1_ == '\0') {
    puVar1 = &local_2a;
    uStack28 = uStack38;
    pass1_1030_8c66(param_1,local_c,local_a,((u32)local_a >> 0x10),(u32 *)CONCAT22(0x1050,puVar1),
                    uVar3);
    uStack6 = *puVar1;
    uVar3 = ((int)puVar1 + 0x2);
  }
...
pub fn pass1_1030_8bac(mut param_1: u32,mut param_2: u16 )
...
pub fn pass1_1030_8bdc(mut param_1: u32,mut param_2: u32,param_3: *mut u16)
...
pub fn pass1_1030_8c38(mut param_1: u32)
...
pub fn pass1_1030_8c66(mut param_1: u32,mut param_2: i16,u8 *param_3,mut param_4: u16 ,u32 *param_5,mut param_6: u16 )
...
// WARNING: Globals starting with '_' overlap smaller symbols at the same address
pub fn pass1_1030_8d08(mut param_1: u32,mut param_2: u16 )
...
pub fn pass1_1030_8d9e(mut param_1: u32)
...
pub fn pass1_1030_8e3c(StructD *param_1,mut param_2: u32,mut param_3: u32,mut param_4: u16 ) -> u32

{
  ...
  if (uVar4 == 0x0) {
    ...
    uVar2 = set_struct_1008_574a((astruct_57 *)CONCAT22(paVar7,uVar1));
    paVar9 = paVar8;
  }
...
// WARNING: Could not reconcile some variable overlaps
// WARNING: Globals starting with '_' overlap smaller symbols at the same address
pub fn pass1_1030_8f04(mut param_1: u32,mut param_2: u16 ,mut param_3: u16 ,mut param_4: u16 ,mut param_5: u32)
...
BOOL16 pass1_1030_8fe4(mut param_1: u16 ,mut param_2: u16 ,mut param_3: u16 ,mut param_4: u16 ,param_5: *mut u16,i32 param_6)
...
// WARNING: Could not reconcile some variable overlaps
// WARNING: Globals starting with '_' overlap smaller symbols at the same address
pub fn pass1_1030_9296(mut param_1: u16 ,mut param_2: u32,u32 *param_3,mut param_4: u32)

{
  ...
  if ((int)in_EAX != 0x0) {
    ...
    uVar4 = ((u32)pstruct99_18 >> 0x10);
    paVar7 = (astruct_57 *)((u32)paVar7 & 0xffff0000 | (u32)(uVar4 | uVar5));
    if ((uVar4 | uVar5) == 0x0) {
      paStack6 = NULL;
    }
    else {
...
// WARNING: Could not reconcile some variable overlaps
// WARNING: Globals starting with '_' overlap smaller symbols at the same address
pub fn pass1_1030_951a(mut param_1: u16 ,mut param_2: u32,u32 *param_3,mut param_4: u32)
...
LAB_1030_97e8:
  ...
  if (((int)puStack10 + 0x138) != 0x0) {
    ...
    uVar6 = puVar16;
    uVar15 = 0x38;
    pass1_1038_4d6e(uVar6,((u32)puVar16 >> 0x10),(astruct_691 *)param_4,puVar16);
    uVar14 = uVar17;
...
// WARNING: Globals starting with '_' overlap smaller symbols at the same address
pub fn pass1_1030_9adc(mut param_1: u16 ,mut param_2: u16 ,mut param_3: u16 ,mut param_4: u16 ,u32 *param_5,mut param_6: u32)
...
// WARNING: Globals starting with '_' overlap smaller symbols at the same address
pub fn pass1_1030_9c1c(mut param_1: u32,u32 *param_2,mut param_3: u32)
...
// WARNING: Globals starting with '_' overlap smaller symbols at the same address
pub fn pass1_1030_9d42(mut param_1: u16 ,mut param_2: u16 ,mut param_3: u16 ,u32 *param_4,mut param_5: u32)
...
u16 * pass1_1030_9e9c(param_1: *mut u16,u8 param_2)
...
pub fn pass1_1030_9ecc(u32 *param_1,param_2: *mut astruct_424)
...
// WARNING: Globals starting with '_' overlap smaller symbols at the same address
pub fn pass1_1030_9f40(uchar param_1,mut param_2: u32,mut param_3: u16 )
...
pub fn pass1_1030_9f64(u32 *param_1)
...

{
  ...
  if (puVar3 != NULL) {
    ...
    uVar1 = (u32)(uVar5 + 0x4);
    struct_op_1028_87f0((astruct_97 *)CONCAT22(0x1050,local_130),0x0,0x0,param_2,&local_8,&DAT_1050_1050,
...
// WARNING: Globals starting with '_' overlap smaller symbols at the same address
pub fn pass1_1030_b2aa(u8 *param_1,mut param_2: u32,param_3: *mut u16)
...

{
  ...
  pass1_1030_b13c();
  uStack30 = CONCAT22(-(((int)s_Unsupported_FileStructType_in_Op_1050_01ca + 0x2aU) < puVar3) - iVar4
                      ,0x1f4 - (int)puVar3);
  do {
    puVar3 = local_12;
    pass1_1008_5b12((char *)CONCAT22(0x1050,puVar3));
    ...
    if (((int)uVar5 <= uStack30) && (((int)uVar5 < uStack30 || (puVar3 <= uStack30)))) {
...
// WARNING: Globals starting with '_' overlap smaller symbols at the same address
pub fn pass1_1030_b718(u8 *param_1,mut param_2: u16 ,mut param_3: u16 ,param_4: *mut u16,u32 *param_5)
...

{
  ...
  BVar2 = write_to_file_1008_7e1c(param_2,CONCAT22(0x1050,&local_10),(char *)0x4,in_stack_0000ffc8);
  if ((BVar2 != 0x0) &&
     (iVar3 = write_to_file_1008_7b4c(param_2,(astruct_615 *)(param_1 & 0xffff0000 | (u32)(iVar5 + 0x8))),
     iVar3 != 0x0)) {
    local_8[0] = (iVar5 + 0xe);
    BVar2 = write_to_file_1008_7e1c(param_2,CONCAT22(0x1050,local_8),(char *)0x2,in_stack_0000ffc8);
    if (BVar2 != 0x0) {
      uVar1 = (u32)(iVar5 + 0x10);
      local_22[0] = ((int)uVar1 + 0x8);
      local_10 = local_10 & 0xffff0000 | (u32)local_22[0];
      BVar2 = write_to_file_1008_7e1c(param_2,CONCAT22(0x1050,local_22),(char *)0x2,in_stack_0000ffc8);
      if (BVar2 == 0x0) {
        return;
      }
...
pub fn file_1030_b836(u8 *param_1,param_2: *mut astruct_401,mut param_3: u32)

{
  ...
  BVar2 = read_file_1008_7dee((HFILE16 *)param_3,((u32)param_2 & 0xffff0000 | ZEXT24(iVar4)),0x4);
  if (((BVar2 == 0x0) ||
      (BVar2 = read_file_1008_7bc8(param_3,(u16 *)((u32)param_2 & 0xffff0000 | ZEXT24(&iVar4->field_0x8))),
      BVar2 == 0x0)) ||
     (BVar2 = read_file_1008_7dee((HFILE16 *)param_3,CONCAT22(0x1050,&local_4),0x2), BVar2 == 0x0)) {
    u16_1050_0310 = 0x6d2;
  }
  else {
    uVar8 = ((u32)param_2 >> 0x10);
    iVar4->field13_0xe = local_4;
    BVar2 = read_file_1008_7dee((HFILE16 *)param_3,CONCAT22(0x1050,local_12),0x2);
    if (BVar2 != 0x0) {
      while( true ) {
        if (local_12[0] == 0x0) {
          return;
        ...
        file_1038_774e(paVar6,(astruct_169 *)CONCAT22(paVar6,uVar3),uVar9);
        if (uVar3 == 0x0) break;
...

{
  ...
  if (*(i32 *)&iVar7->field14_0xe == 0x0) {
    ...
    uVar3 = (astruct_57 *)(param_1 | param_2);
...
u16 * pass1_1030_bc24(mut param_1: u16 ,mut param_2: i16,mut param_3: u16 ,mut param_4: u16 ,mut param_5: u32)
...
pub fn pass1_1030_bcde(mut param_1: u16 ,mut param_2: u16 ,mut param_3: u32,param_4: *mut u16,i32 param_5)
...
u16 * pass1_1030_be56(mut param_1: u16 ,param_2: *mut astruct_12,mut param_3: i16,mut param_4: u32)
...
pub fn pass1_1030_be80(u8 *param_1,param_2: *mut astruct_15)
...
u16 pass1_1030_bfb8(mut param_1: u32)
...

{
  ...
  if (BVar1 != 0x0) {
    ...
    if (BVar1 != 0x0) {
      ...
      BVar1 = write_to_file_1008_7e1c(param_2,CONCAT22(0x1050,local_8),(char *)0x2,in_stack_0000ffd8);
      if (BVar1 != 0x0) {
        return;
      }
    }
...

{
  ...
  if (param_1 != 0x0) {
    BVar1 = read_file_1008_7dee(param_4,((u32)param_3 & 0xffff0000 | (u32)((int)param_3 + 0x20)),0x4);
    if (BVar1 != 0x0) {
      BVar1 = read_file_1008_7dee(param_4,((u32)param_3 & 0xffff0000 | (u32)((int)param_3 + 0x24)),0x2);
      if (BVar1 != 0x0) {
        return;
      }
    }
  ...
  if (((int)param_3 + 0xc) != 0xb) {
    ...
    for (uStack84 = 0x11; uVar5 = uVar6, (int)uStack84 < 0x25; uStack84 += 0x1) {
      if (0x0 < (uStack84 * 0x2 + (int)_PTR_LOOP_1050_580e)) {
        ...
        if (lStack80 < iVar4) {
          iVar4 = (uStack84 * 0x2 + (int)_PTR_LOOP_1050_580e);
          paVar8 = (astruct_57 *)(u32)(iVar4 >> 0xf);
          uVar13 = 0x21;
        }
    ...
    if (local_20._3_1_ == 0x0) {
      ...
      if ((uStack8 != 0x4) && (uStack8 != 0x0)) {
        ...
        while( true ) {
          ...
          puVar4 = &local_20;
          uStack16 = uVar7;
          pass1_1030_bcde(puVar4,&DAT_1050_1050,uVar5 & 0xffff | (u32)uVar7 << 0x10,puVar10,uVar8);
...

{
  ...
  if ((((int)param_2 + 0x12) == 0x5) && (PTR_LOOP_1050_5812 == NULL)) {
    PTR_LOOP_1050_5812 = ((int)&PTR_LOOP_1050_0000 + 0x1);
...
u16 pass1_1030_d0a8(mut param_1: u32)
...
i16 pass1_1030_d0c6(mut param_1: u32)
...
i16 pass1_1030_d102(mut param_1: i16,mut param_2: u16 )
...
i16 pass1_1030_d144(mut param_1: u32)
...
u16 pass1_1030_d230(mut param_1: u32)
...
u16 pass1_1030_d36e(mut param_1: u32,mut param_2: i16)
...
i16 pass1_1030_d56a(mut param_1: u32)
...

{
  ...
  if (BVar1 != 0x0) {
    for (iStack4 = 0x0; iStack4 < 0xa; iStack4 += 0x1) {
      ...
      BVar1 = write_to_file_1008_7e1c(param_2,CONCAT22(0x1050,local_12),(char *)0x4,in_stack_0000ffcc);
      if (BVar1 == 0x0) goto LAB_1030_d701;
      local_14 = (iVar2 + iStack4 * 0xc + 0x24);
      BVar1 = write_to_file_1008_7e1c(param_2,CONCAT22(0x1050,&local_14),(char *)0x2,in_stack_0000ffcc);
      if (BVar1 == 0x0) goto LAB_1030_d701;
      local_16 = (iVar2 + iStack4 * 0xc + 0x26);
      BVar1 = write_to_file_1008_7e1c(param_2,CONCAT22(0x1050,&local_16),(char *)0x2,in_stack_0000ffcc);
      if (BVar1 == 0x0) goto LAB_1030_d701;
      local_1a = (u32)(iVar2 + iStack4 * 0xc + 0x28);
      BVar1 = write_to_file_1008_7e1c(param_2,CONCAT22(0x1050,&local_1a),(char *)0x4,in_stack_0000ffcc);
      if (BVar1 == 0x0) goto LAB_1030_d701;
    }
...
// WARNING: Could not reconcile some variable overlaps
pub fn pass1_1030_d72e(mut param_1: i16,u8 *param_2,param_3: *mut astruct_373,HFILE16 *param_4)
  ...
  while( true ) {
    ...
    // just 0x5812
      if ((0x3 < (int)u16_1050_0312) &&
         (BVar2 = read_file_1008_7dee(param_4,&PTR_LOOP_1050_5812,0x2), BVar2 == 0x0)) {
        u16_1050_0310 = 0x6d2;
        return;
      }
      return;
...
pub fn pass1_1030_d994(u32 *param_1)
...
// WARNING: Globals starting with '_' overlap smaller symbols at the same address
pub fn pass1_1030_db92(mut param_1: u16 ,mut param_2: u16 ,param_3: *mut u16,mut param_4: u32,i32 param_5)
...

{
  ...
  if (BVar1 != 0x0) {
    local_10[0] = (u32)((int)param_1 + 0x20);
    BVar1 = write_to_file_1008_7e1c(param_2,CONCAT22(0x1050,local_10),(char *)0x4,in_stack_0000ffda);
    if (BVar1 == 0x0) {
      u16_1050_0310 = 0x6d0;
      return;
    }
...
pub fn pass1_1030_dec4(mut param_1: i16,u8 *param_2,param_3: *mut astruct_373,HFILE16 *param_4)
...
u16 pass1_1030_dfcc(mut param_1: u32)
...
// WARNING: Could not reconcile some variable overlaps
// WARNING: Globals starting with '_' overlap smaller symbols at the same address
pub fn pass1_1030_e0d4(u8 *param_1)
    ...
    while( true ) {
      ...
      if (&paVar3->field_0x8 != 0x0) {
        ...
        if (paVar4 != NULL) {
          ...
          uVar5 = uVar2;
          pass1_1038_35a8(uVar2,uVar6,(((int)uStack20 + 0x10) * 0x2 + (int)uStack42),paVar3)
          ;
          if (uVar5 != 0x0) {
            uVar8 = ((u32)uStack20 >> 0x10);
            iVar7 = (int)uStack20;
...
pub fn pass1_1030_e1f4(mut param_1: u16 ,u8 *param_2,mut param_3: u32)
...
u16 pass1_1030_e300(u8 *param_1,mut param_2: u32)
...
pub fn pass1_1030_e34e(mut param_1: u16 ,u8 *param_2,param_3: *mut astruct_403)
...
pub fn pass1_1030_e564(mut param_1: u16 ,u8 *param_2,param_3: *mut astruct_405)
...
pub fn pass1_1030_e6c2(mut param_1: u16 ,u8 *param_2,param_3: *mut astruct_406)
...
pub fn pass1_1030_e7d6(mut param_1: u16 ,u8 *param_2,mut param_3: u32)
...
pub fn pass1_1030_e98e(mut param_1: u16 ,u8 *param_2,param_3: *mut astruct_407)
...
astruct_97 * pass1_1030_ecc2(uchar param_1,param_2: *mut astruct_97)
...
// WARNING: Globals starting with '_' overlap smaller symbols at the same address
pub fn pass1_1030_ecf8(uchar param_1,param_2: *mut astruct_57,mut param_3: u32)

{
  ...
  if ((0x0 < (int)PTR_LOOP_1050_13ae) && (!SBORROW2((int)PTR_LOOP_1050_13ae,0x1))) {
    if (PTR_LOOP_1050_13ae == &u16_1050_0002 || (int)(PTR_LOOP_1050_13ae + -0x1) < 0x1) {
      ...
      if (PTR_LOOP_1050_13ae != ((int)&u16_1050_0002 + 0x1)) goto LAB_1030_ed5b;
  ...
  while( true ) {
    ...
    if ((((int)&paVar6[0x1c].field3_0x4 + 0x2) != 0x0) && (paVar6[0x1c].field4_0x8 != 0x8000002)) {
      ...
      if (uVar9 != 0x0) {
        ...
        pass1_1038_008e(pSVar13,uVar4,uVar19,(u32)paStack38);
        if (iVar7 < 0x0) {
          iStack56 += iVar7;
        }
        else {
