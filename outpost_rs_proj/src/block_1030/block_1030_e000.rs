...

{
  ...
  while( true ) {
    ...
    pass1_1020_bb16((u32*)(iVar5 + 0x108),CONCAT22(0x1050,&local_12),(u16 *)CONCAT22(0x1050,&local_e),
                    uStack10);
...

{
  ...
  puVar17 = mixed_1010_20ba(paVar12,_u16_1050_0ed0,(u8 **)CONCAT22(in_stack_0000ff98,0x2),in_stack_0000fe40,
                            in_stack_0000ff64,in_stack_0000ff6a,in_stack_0000ff6e);
  pSVar13 = (StructD *)(paVar12 & 0xffff0000 | puVar17 >> 0x10);
  if ((0x0 < PTR_LOOP_1050_13ae) && (!SBORROW2(PTR_LOOP_1050_13ae,0x1))) {
    if (PTR_LOOP_1050_13ae == &u16_1050_0002 || (PTR_LOOP_1050_13ae + -0x1) < 0x1) {
      ...
      if (PTR_LOOP_1050_13ae != (&u16_1050_0002 + 0x1)) goto LAB_1030_ed5b;
...
LAB_1030_ed5b:
  ...
  while( true ) {
    ...
    pSVar13 = (StructD *)(pSVar13 & 0xffff0000 | (paVar6 + 0x1c));
    if (((&paVar6[0x1c].field3_0x4 + 0x2) != 0x0) && (paVar6[0x1c].field4_0x8 != 0x8000002)) {
      pass1_1030_38b8();
      uVar9 = pSVar13 | uVar9;
      ...
      if (uVar9 != 0x0) {
        ...
        for (uStack64 = 0x0; uStack64 < uVar5; uStack64 += 0x1) {
          ...
          uVar8 = uVar5;
          (**ppcVar3)(uVar15,(char)puVar2,(puVar2 >> 0x10),uStack64,(uStack64 >> 0x10));
          uVar9 = uVar8;
          uVar11 = pSVar13 | uVar9;
          pSVar14 = (StructD *)(pSVar13 & 0xffff0000 | uVar11);
          if (uVar11 != 0x0) {
            uVar15 = 0x1028;
            ...
            uVar9 = puVar18;
            uVar11 = (puVar18 >> 0x10);
            pSVar14 = (StructD *)(pSVar14 & 0xffff0000 | (uVar11 | uVar9));
