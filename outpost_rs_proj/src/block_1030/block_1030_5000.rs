...

{
  ...
  plVar2 = &local_a;
  uVar9 = read_file_1030_4e70(param_2,CONCAT22(0x1050,plVar2),(u8 **)CONCAT22(0x1050,&local_6),
                              (i32)s_bldgops_dat_1050_5708,param_1);
  pcVar1 = local_6;
  pSVar11 = (StructD *)CONCAT22(extraout_var,uVar9);
  if (plVar2 != NULL) {
    pstruct117_10 = (astruct_117 *)param_2;
    pstruct117_10_hi = (astruct_117 *)(param_2 >> 0x10);
    pcVar7 = local_6;
    ...
    for (uStack24 = 0x0; uStack24 < uVar3; uStack24 += 0x1) {
      uVar10 = (&pstruct117_10[0xd].field10_0xa + 0x2);
...

{
  ...
  if ((uVar4 | param_1) != 0x0) {
    *puStack10 = 0x389a;
    ...
    uVar8 = (astruct_377 *)(param_3 >> 0x10);
...

{
  ...
  uVar1 = (&iVar4->field264_0x108 + 0x2);
  uVar2 = uVar1 >> 0x8;
  puVar4 = mixed_1010_20ba((astruct_57 *)(in_EDX & 0xffff0000 | uVar1),_u16_1050_0ed0,
...

{
  ...
  if (uStack12._3_1_ == -0x1) {
    uVar7 = pass1_1028_e2e0(paVar4,_PTR_LOOP_1050_65e2,(u8)((iVar5 + 0x108) >> 0x18));
    uVar3 = (uVar7 >> 0x10);
  }
  else {
  ...
  if (uStack12._3_1_ != '\x03') {
    pass1_1030_521c((astruct_97 *)CONCAT13(0x10,CONCAT12(0x50,local_11e)),(iVar5 + 0x108));
    uStack16 = *_u16_1050_5748;
    fn_ptr_1028_d566(uStack16,(astruct_97 *)CONCAT22(0x1050,local_11e));
    bStack291 = (u8)((iVar5 + 0x108) >> 0x18);
    uVar2 = bStack291;
    if (bStack291 == 0x2) {
...

{
  ...
  if ((uVar4 | param_1) != 0x0) {
    *puStack10 = 0x389a;
    param_1->field2_0x2 = 0x1008;
    uVar8 = (astruct_379 *)(param_3 >> 0x10);
...
StructD * pass1_1030_5596(StructD *param_1,param_2: u8)
...
StructD * pass1_1030_55c2(StructD *param_1,param_2: u8)
...

{
  ...
  uVar2 = (astruct_180 *)(param_1 >> 0x10);
  iVar1 = (astruct_180 *)param_1;
  &iVar1->field12_0x10 = 0x0;
  pass1_1008_3e38((astruct_19 *)(param_1 & 0xffff0000 | ZEXT24(&iVar1->field14_0x14)));
...

{
  ...
  pass1_1008_3e38((astruct_19 *)(param_3 & 0xffff0000 | ZEXT24(&pstruct_1->field16_0x14)));
...

{
  ...
  if (uVar4 != 0x0) {
    uVar8 = (astruct_731 *)(param_2 >> 0x10);
    ...
    if (BVar5 != 0x0) {
      ...
      if ((BVar5 != 0x0) &&
         (uVar3 = &iVar7->field_0x10, BVar5 = pass1_1008_7c2a(param_3,*(char **)(uVar3 + 0x4)),
         BVar5 != 0x0)) {
        uVar3 = &iVar7->field_0x10;
        local_8[0] = (uVar3 + 0x1a);
        BVar5 = write_to_file_1008_7e1c(param_3,CONCAT22(0x1050,local_8),0x2,in_stack_0000ffd6);
        if (BVar5 != 0x0) {
          for (iStack4 = 0x0; uVar3 = &iVar7->field_0x10, piVar1 = (uVar3 + 0x1a),
              *piVar1 != iStack4 && iStack4 <= *piVar1; iStack4 += 0x1) {
            uVar3 = &iVar7->field_0x10;
            uVar2 = (uVar3 + 0x16);
            iVar6 = write_to_file_1008_7b4c
                              (param_3,(astruct_615 *)(uVar2 & 0xffff0000 | (uVar2 + iStack4 * 0x6)));
            if (iVar6 == 0x0) goto LAB_1030_5734;
          }
          iVar6 = write_to_file_1008_7b4c
                            (param_3,(astruct_615 *)(param_2 & 0xffff0000 | ZEXT24(&iVar7->field19_0x14)));
          if (iVar6 != 0x0) {
...

{
  ...
  uVar15 = (astruct_381 *)(param_3 >> 0x10);
  ...
  if (param_1 != 0x0) {
    ...
    if (BVar5 != 0x0) {
      ...
      if (BVar5 != 0x0) {
        puVar6 = local_408;
        read_file_1008_7c6e((HFILE16)param_4,(param_4 >> 0x10),CONCAT22(0x1050,puVar6));
        if (puVar6 != NULL) {
          uVar8 = &iVar12->field16_0x10;
          fn_ptr_1000_17ce(*(char **)(uVar8 + 0x4));
          ...
          if (BVar5 != 0x0) {
            ...
            for (iStack1036 = 0x0; uVar8 = &iVar12->field16_0x10, piVar1 = (uVar8 + 0x1a),
            ...
            BVar5 = read_file_1008_7bc8(param_4,(u16 *)(param_3 & 0xffff0000 | ZEXT24(&iVar12->field_0x14)));
            if ((BVar5 != 0x0) &&
...
StructD * pass1_1030_5baa(StructD *param_1,param_2: u8)
...

{
  ...
  if ((uVar3 + 0x4) != 0x0) {
    pass1_1030_12ca((astruct_176 *)(uVar3 & 0xffff | uVar4 << 0x10));
    uStack6 = uVar3 & 0xffff | uVar4 << 0x10;
  }
  if (uStack6 == 0x0) {
    plVar1 = (i32 *)(uVar2 * 0x4 + param_1);
    *plVar1 = *plVar1 + 0x1;
  }
  return;
}
...

{
  ...
  *param_1 = 0x613e;
  ...
  uVar1 = (iVar3 + 0x12);
  if ((uVar1 | pcVar2) != 0x0) {
    pass1_1030_8480((StructD *)(pcVar2 & 0xffff | uVar1 << 0x10));
    fn_ptr_1000_17ce(pcVar2);
  }
  pass1_1030_18b2(param_1);
  return;
...

{
  ...
  if (uVar3 != 0x0) {
    uVar7 = (param_2 >> 0x10);
    iVar6 = param_2;
    BVar4 = pass1_1008_7c2a(param_3,*(char **)(iVar6 + 0x10));
    if ((BVar4 != 0x0) &&
       (uVar1 = (iVar6 + 0x10),
       iVar5 = write_to_file_1008_7b4c(param_3,(astruct_615 *)(uVar1 & 0xffff0000 | (uVar1 + 0x4))),
       iVar5 != 0x0)) {
      uVar2 = (iVar6 + 0x10);
      local_c[0] = (uVar2 + 0xa);
...

{
  ...
  if (param_1 != 0x0) {
    ...
    paVar10 = (astruct_57 *)(pSVar9 & 0xffff0000 | (uVar7 | uVar4));
    if ((uVar7 | uVar4) == 0x0) {
      (iVar15 + 0x10) = 0x0;
    }
    else {
      puVar13 = pass1_1008_3e38((astruct_19 *)CONCAT22(uVar7,uVar4 + 0x4));
      paVar10 = (astruct_57 *)(pSVar9 & 0xffff0000 | puVar13 >> 0x10);
      (iVar15 + 0x10) = uStack1034;
    }
    puVar5 = local_402;
    read_file_1008_7c6e((HFILE16)param_4,(param_4 >> 0x10),CONCAT22(0x1050,puVar5));
    if (puVar5 != NULL) {
      ...
      *puVar2 = uVar4;
      (puVar2 + 0x2) = paVar10;
      uVar1 = (iVar15 + 0x10);
      BVar6 = read_file_1008_7bc8(param_4,(u16 *)(uVar1 & 0xffff0000 | (uVar1 + 0x4)));
      if (BVar6 != 0x0) {
        uVar1 = (iVar15 + 0x10);
        uVar7 = uVar1 + 0xa;
...
LAB_1030_5fb7:
          ...
          (iVar11 + 0xe) = paVar10;
          uVar3 = (iVar15 + 0x10);
          BVar6 = read_file_1008_7dee((HFILE16 *)param_4,*(u8 **)(uVar3 + 0xc),uVar7);
...

{
  ...
  if (*(i32 *)(iVar6 + 0xc) == 0x0) {
    ...
    uStack6 = param_2;
    param_2 = (astruct_57 *)(param_2 & 0xffff0000 | (uStack6 | param_1));
    uStack8 = param_1;
  ...
  for (uStack4 = 0x0; uVar3 = (iVar6 + 0x10), puVar1 = (u16 *)(uVar3 + 0xa),
      uStack4 <= *puVar1 && *puVar1 != uStack4; uStack4 += 0x1) {
    uStack12 = pass1_1028_e2e0(param_2,_PTR_LOOP_1050_65e2,0x2);
    param_2 = (astruct_57 *)(param_2 & 0xffff0000 | uStack12 >> 0x10);
    iVar4 = uStack12;
    uVar3 = (iVar6 + 0xc);
    ppcVar2 = (code **)((iVar6 + 0xc) + 0x8);
    (**ppcVar2)(0x1028,uVar3,(uVar3 >> 0x10),iVar4,(char)(uStack12 >> 0x10),uStack4,0x0);
    pass1_1030_8344(_u16_1050_5748,uStack12);
    uStack16 = CONCAT22(param_2,iVar4);
    uStack20 = (iVar4 + 0x10);
    if (*(i32 *)(uStack20 + 0x2) == 0x0) {
