...

{
  ...
  for (uStack4 = 0x0; uVar3 = iVar4.field13_0x10, puVar1 = (u16 *)(uVar3 + 0x22),
...

{
  ...
  uVar6 = (&local_a + 0x2U);
  pass1_1030_3948(param_2,(u16 *)CONCAT22(0x1050,&local_a + 0x2U),CONCAT13(0x10,CONCAT12(0x50,local_c)),
                  0x4);
  do {
    uVar5 = uVar6;
