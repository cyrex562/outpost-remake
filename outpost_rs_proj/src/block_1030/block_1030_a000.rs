...
LAB_1030_a305:
  if (uStack6 != 0x0) {
    ...
    *param_3 = paStack20;
    ...
    if (0x0 < (puVar3 + 0x1)) {
      pass1_1030_a044(extraout_DX,uVar4,uVar6,(u16 *)(param_4 & 0xffff | uVar5 << 0x10),uStack16);
    }
  }
  return;
}
...
LAB_1030_a4e7:
      if (puStack14 != NULL) {
        ...
        (**ppcVar1)(0x1008,puStack14,(char)(puStack14 >> 0x10),0x1,uVar17,uVar10,puStack14,puStack14);
      }
      return;
    }
    uVar6 = uStack18;
    ...
    if (uVar7 != 0x0) {
      ...
      if ((local_28 == iStack6) &&
         ...
         uVar2 = (iVar12 + 0x4),
         uVar4 = pass1_1030_addc(&local_1c,uVar9,uVar11,uVar13,(u16 *)CONCAT22(0x1050,&local_1c),
                                 uVar2,(uVar2 >> 0x10),(iVar12 + 0x8)), uVar4 != 0x0))
      {
        pass1_1008_3f62((u16 *)CONCAT22(0x1050,local_22),(u16 *)CONCAT22(0x1050,&local_1c));
        iStack26 = local_26 + -0x1;
        BVar5 = pass1_1030_ad22(&local_1c,uVar9,uVar11,uVar13,(u16 *)CONCAT22(0x1050,&local_1c),lStack22);
        if (BVar5 == 0x0) {
          iStack26 = local_26 + 0x1;
          BVar5 = pass1_1030_ad22(&local_1c,uVar9,uVar11,uVar13,(u16 *)CONCAT22(0x1050,&local_1c),lStack22);
          if (BVar5 == 0x0) {
...

{
  ...
  uVar15 = (param_3 >> 0x10);
  uVar11 = param_3;
  pass1_1038_53ba((uVar11 + 0x4),0x1);
  if ((param_2 != 0x0) || (param_1 != 0x0)) {
    ...
    for (uStack40 = 0x0; uVar4 = uVar10, uStack40 < uVar7; uStack40 += 0x1) {
      ...
      if (uVar8 != 0x0) {
        ...
        iVar13 = uVar3;
        uVar3 = (iVar13 + 0x4);
        uVar5 = pass1_1030_addc(&local_16,uVar10,uVar11,uVar15,(u16 *)CONCAT22(0x1050,&local_16),
...
LAB_1030_a660:
    ...
    if (uStack16 != NULL) {
      ...
      (**ppcVar2)(uVar18,uStack16,(char)(uStack16 >> 0x10),0x1,uVar12,uVar16,uStack16,uStack16);
    }
  }
  return;
}
      ...
      if ((uVar10 != 0x0) &&
        ...
        if ((uVar10 | uVar4) != 0x0) {
          ...
          if ((iVar1 == local_1c) &&
             ...
             uVar2 = (iVar11 + 0x4),
             uVar5 = pass1_1030_addc(&local_16,uVar10,uVar8,uVar12,(u16 *)CONCAT22(0x1050,&local_16),
  ...
  while( true ) {
    ...
    if (uVar6 <= uStack38) {
      if (uStack14 != NULL) {
        ...
        (**ppcVar2)(uVar18,uStack14,(char)(uStack14 >> 0x10),0x1,uVar12,uVar16,uStack14,uStack14);
      }
      return;
    }
    uVar21 = uVar6;
...
LAB_1030_aadc:
  ...
  iVar13 = uVar3;
  uVar3 = (iVar13 + 0x4);
  uVar4 = pass1_1030_addc(&local_14,uVar10,uVar11,uVar15,(u16 *)CONCAT22(0x1050,&local_14),uVar3
...

{
  ...
  &iVar5->field9_0x10 = 0x0;
  param_1->field0_0x0 = 0xb932;
  iVar5->field1_0x2 = 0x1030;
  iVar5->field2_0x4 = (param_2 + 0x4);
  puVar3 = (u16 *)(param_1 & 0xffff0000 | ZEXT24(&iVar5->field3_0x8));
  pass1_1008_3f62(puVar3,(u16 *)(param_2 & 0xffff0000 | (param_2 + 0xc)));
  uVar2 = puVar3;
