...

{
  ...
  if (((BVar3 != 0x0) && (uVar2 = (iVar4 + 0x1a), (uVar2 + 0x12) == 0x5)) &&
...

{
  ...
  if (pstruct295_1->field30_0x1e != NULL) {
    ...
    uVar2 = (&pstruct295_1->field30_0x1e + 0x2);
    if ((uVar2 | puVar1) != 0x0) {
      ppcVar3 = (code **)*puVar1;
          ...
          if ((((plVar7 != 0x0) &&
            ...
            if ((BVar2 != 0x0) &&
              ...
              if ((paVar8 != 0x0) &&
                ...
                for (uStack14 = 0x0; uVar15 = (paVar12 >> 0x10), uStack14 < local_20[0];
                    uStack14 += 0x1) {
                ...
                if (BVar2 != 0x0) {
                  ...
                  while( true ) {
                    ...
                    paStack50 = pass1_1000_07fc(_PTR_LOOP_1050_68a2);
                    uVar10 = (astruct_99 *)(paStack50 >> 0x10);
                    ...
                    if ((uVar10 | uVar8) == 0x0) {
                      ...
                      (&uVar8->field2_0x4 + 0x2) = 0x0;
                      &uVar8->field3_0x8 = 0x0;
                      (&uVar8->field3_0x8 + 0x2) = 0x0;
                    ...
                    if ((((BVar2 == 0x0) ||
                       ...
                       ((BVar2 = read_file_1008_7dee(param_4,(paStack74 & 0xffff0000 |
                        ...
                        (BVar2 = read_file_1008_7dee(param_4,(paStack74 & 0xffff0000 |
                                                                   (paStack74 + 0xc)),0x2), BVar2 == 0x0))))
                    break;
                    uVar14 = (astruct_99 *)(paStack74 >> 0x10);
