...

{
  ...
  while( true ) {
    ...
    uVar4 = struct_op_1030_73a8((astruct_419 *)CONCAT22(param_2,uVar2),uVar2,param_2);
...

{
  ...
  if ((puVar7 != NULL) || (uVar4 != 0x0)) {
    ...
    if (((puVar7 != NULL) || (uVar5 != 0x0)) &&
       (pass1_1038_11b0(uVar5,uVar9,param_2,CONCAT13((char)(puVar6 >> 0x8),CONCAT12((char)puVar6,uVar3)),
                        CONCAT22(puVar8,uVar4)), uVar5 == 0x0)) {
      if (puStack14 == NULL) {
        return;
      }
      ppcVar1 = (code **)uVar2;
...

{
  ...
  do {
    ...
    if ((uStack18 | uStack14) != 0x0) {
      ...
      uVar15 = ((qword)sVar2 >> 0x20);
      uVar7 = sVar2 >> 0x1;
      ppcVar1 = (code **)(*param_3 + 0x4);
      uStack34 = uVar7;
      (**ppcVar1)(0x1028,param_3,(char)uStack22,(uStack22 >> 0x10));
      uVar6 = uVar7;
      uStack36 = uVar15;
      uStack38 = uVar6;
      ...
      for (uStack58 = 0x0; uVar5 = uStack56, uStack58 < uStack56; uStack58 += 0x1) {
        ...
        if (((local_46 != 0x0) && (0xd < local_42[0])) && (local_42[0] < 0x1d)) {
          ...
          paVar11 = (astruct_57 *)(paVar14 & 0xffff0000 | uVar7 >> 0x10);
          uVar5 = uVar15;
          uVar10 = (uVar7 >> 0x10);
          if ((local_a <= uVar10) && ((local_a < uVar10 || (local_a < uVar5)))) {
            paVar11 = (astruct_57 *)(paVar14 & 0xffff0000 | local_a);
            uVar5 = local_a;
          }
          iVar8 = paVar11;
          ...
          pass1_1020_bb8a((i32 *)puStack54,uVar5,paVar11 & 0xffff | local_42[0] << 0x10);
          uVar7 = local_46 - lStack74;
          pass1_1020_bb8a((i32 *)puStack50,uVar7,CONCAT22(local_42[0],(uVar7 >> 0x10)));
          paVar14 = paVar13;
          if (local_a == 0x0) {
            ...
            paVar14 = (astruct_57 *)(paVar13 & 0xffff0000 | uVar10);
            if (uVar10 != 0x0) {
              uVar17 = 0x64;
              uVar18 = 0x0;
              uVar6 = 0x0;
...

{
  ...
  if (uVar9 != 0x0) {
    ...
    for (uStack22 = 0x0; uStack22 < uStack18; uStack22 += 0x1) {
      ppcVar2 = (code **)(*param_3 + 0x4);
      uVar16 = uStack18;
      uVar10 = uVar9;
      (**ppcVar2)(unaff_CS,param_3,(char)uStack22,(uStack22 >> 0x10),puVar19);
      iVar6 = uVar16;
          ...
          while( true ) {
            ...
            if ((uVar12 | puVar8) != 0x0) {
              ...
              if ((local_a <= paVar14) &&
                ...
                paVar14 = (astruct_57 *)(paVar14 & 0xffff0000 | local_a);
                puVar8 = local_a;
              }
              iVar6 = paVar14;
              ...
              if (plStack50 == NULL) {
                ...
                paVar13 = (astruct_57 *)(paVar15 & 0xffff0000 | uVar12);
                if (uVar12 == 0x0) {
                  puVar5 = NULL;
                ...
                plStack50 = (i32 *)CONCAT22(paVar13,puVar5);
              }
...

{
  ...
  uStack6 = CONCAT22(extraout_DX,param_1);
  pass1_1030_e8a0((astruct_97 *)CONCAT22(0x1050,local_118),param_5,(param_4 + 0xc),
                  (param_1 + 0x4));
...

{
  ...
  do {
    ...
    if (uVar12 != 0x0) {
      ...
      unaff_CS = 0x1030;
      uStack24 = uVar11;
      puStack28 = struct_op_1030_73a8((astruct_419 *)CONCAT22(uStack22,uVar11),uVar11,uStack22);
      uVar13 = puStack28 >> 0x10;
      puVar9 = local_20;
      ppcVar6 = (code **)(*puStack28 + 0x40);
      (**ppcVar6)(0x1030,puStack28,(puStack28 >> 0x10),puVar9,&DAT_1050_1050);
      if (puVar9 == NULL) {
