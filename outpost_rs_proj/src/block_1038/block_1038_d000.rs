...

{
  ...
  if ((handle_1 | handle_3) != 0x0) {
    var5 = 0x0;
    if (l_param == 0x19) {
      fn_ptr_1 = (code **)(*var6 + 0x34);
      var5 = (**fn_ptr_1)(s_tile2_bmp_1050_1538,(char)handle_3,handle_1,win_handle_1,param_3);
    }
    else {
      if (l_param == 0x86) {
        fn_ptr_1 = (code **)(*var6 + 0x20);
  ...
  if (param_3 < 0x310000) {
    ...
    if (cVar2 == '\x02') {
      if ((HVar3 | HVar4) != 0x0) {
        ...
        (**fn_ptr_1)(s_tile2_bmp_1050_1538,HVar4,(char)HVar3,param_2,param_3);
        if (puStack6 != NULL) {
          fn_ptr_1 = (code **)uVar1;
          (**fn_ptr_1)(s_tile2_bmp_1050_1538,HVar4,HVar3,0x1);
        }
      }
    ...
    if (cVar2 == '\x06') {
      ...
      uVar2 = &u16_1050_5bc8;
      *(HWND16 *)(uVar2 + 0x8) = hwnd_param_3;
      return;
    }
  }
  if ((HVar3 | HVar4) != 0x0) {
    fn_ptr_1 = (code **)(*puStack6 + 0xc);
    (**fn_ptr_1)(s_tile2_bmp_1050_1538,HVar4,(char)HVar3,param_2,param_3);
  }
  return;
}
...
StructD * pass1_1038_d218(StructD *param_1,param_2: u8)
...

{
  ...
  uStack4 = 0x7;
  for (uStack10 = 0x0; struct_b_6 = (StructB *)struct_b_param_1, uVar6 = (struct_b_param_1 >> 0x10),
      uStack10 < uStack4; uStack10 += 0x1) {
    ...
    paVar5 = (astruct_57 *)(param_1 & 0xffff0000 | uVar3);
    if (uVar3 == 0x0) {
      rect = NULL;
      param_1 = (astruct_57 *)(param_1 & 0xffff0000);
    }
    else {
      pass1_1008_3bd6(paVar5,rect,(astruct_57 *)param_1,0x1,CONCAT22(local_16,uStack20),0x104,0x1020103,
...

{
  ...
  case 0x146:
    ...
    paVar3 = (astruct_57 *)CONCAT22(uVar4,(LVar6 >> 0x10));
    HVar1 = GetDlgItem16(0x146,param_2->field6_0x6);
    EnableWindow16(0x0,HVar1);
...
StructD * pass1_1038_d6c4(StructD *param_1,param_2: u8)
...

{
  ...
  ppcVar1 = (code **)(*(u32*)&iVar2[0x1].field2_0x4 + 0x4);
  (**ppcVar1)();
  return param_2;
}
...

{
  ...
  if (_PTR_LOOP_1050_5f2c == 0x0) {
    ...
    param_1 = (StructD *)(param_1 & 0xffff0000 | _PTR_LOOP_1050_5f2c >> 0x10);
  }
  ...
  for (iStack10 = 0x1; iStack10 <= uStack8; iStack10 += 0x1) {
    ...
    puStack30 = (u16 *)pass1_1010_08e2(uVar2,(uVar2 >> 0x10),iStack10);
    paVar5 = (astruct_57 *)(param_1 & 0xffff0000 | puStack30 >> 0x10);
    local_26 = *puStack30;
    uStack36 = (puStack30 + 0x2);
    uStack34 = 0x1;
    uStack32 = 0x1;
    ...
    param_1 = (StructD *)(paVar5 & 0xffff0000 | uVar4);
    if (uVar4 == 0x0) {
      uVar2 = &struct_b_1[0x7].field5_0xa;
      (uVar2 + iStack10 * 0x4) = 0x0;
    }
    else {
      pvVar1 = struct_b_1->lpvoid_field_0x8;
      pass1_1008_3bd6(param_1,rect,(astruct_57 *)paVar5,0x0,CONCAT22(local_26,uStack36),0x101,0xff0100,
                      CONCAT13((char)(pvVar1 >> 0x8),CONCAT12((char)pvVar1,(puStack30 + 0x4)))
  ...
  SetWindowText16((puStack14 + 0x68),(HWND16)struct_b_1->lpvoid_field_0x8);
...

{
  ...
  if (param_5 < 0x1220000) {
    ...
    if (uVar2 == 0x0) {
      param_5 = uVar2;
      if ((param_2 + 0x8e) == 0x0) {
        pass1_1010_1ea6(_u16_1050_02a0,(StructD *)CONCAT22(param_3,param_2));
        (param_2 + 0x90) = 0x0;
      }
      iStack4 = 0x72c;
      uStack8 = 0x48;
...
LAB_1038_dc20:
    ...
    if (param_5 != 0x123) {
      if (param_5 - 0x125 == 0x0) {
        ppcVar1 = (code **)(*_u16_1050_02a0 + 0x4);
        ...
        if (iVar9 == 0x0) {
          ...
          param_5 = WinHelp16(0x0,0x3,CONCAT22(paVar5,uVar3),*(HWND16 *)(param_2 + 0x6));
        }
        else {
  ...
  if (iStack4 != 0x0) {
    ...
    if (uVar4 == 0x0) {
      ...
      iVar9 = string_1040_8520(uVar7,(astruct_57 *)
                                     CONCAT13((char)(paVar5 >> 0x8),CONCAT12((char)paVar5,param_5)),
    ...
    if (uStack8 == 0x0) {
      ...
      ppcVar1 = (code **)(*puStack14 + 0x6c);
      (**ppcVar1)(0x1008,(char)iVar9,uVar3,&stack0xffea,&DAT_1050_1050);
    }
  }
  return;
}
...

{
  ...
  paVar7 = (astruct_57 *)(uVar8 & 0xffff0000 | puVar9 >> 0x10);
  ...
  if (uVar3 == 0x6) {
    ...
    if ((uStack14 | uVar3) == 0x0) {
      ...
      iVar4 = string_1040_8520(uVar6,(astruct_57 *)CONCAT13((char)(paVar7 >> 0x8),CONCAT12((char)paVar7,uVar3)),
    ...
    paVar7 = (astruct_57 *)(uVar8 & 0xffff0000 | puVar9 >> 0x10);
    ppcVar1 = (code **)(*puStack6 + 0x6c);
    (**ppcVar1)(0x1008,puStack6,(puStack6 >> 0x10),(char)local_14,&DAT_1050_1050);
    uVar14 = 0x0;
    uVar15 = 0x0;
    iVar2 = 0x15;
    uVar12 = 0x1;
  ...
  if ((uStack14 | uVar3) == 0x0) {
    ...
    iVar4 = string_1040_8520(uVar8,(astruct_57 *)CONCAT13((char)(paVar7 >> 0x8),CONCAT12((char)paVar7,uVar3)),
  ...
  ppcVar1 = (code **)(*puStack6 + 0x6c);
  (**ppcVar1)(0x1008,puStack6,(puStack6 >> 0x10),(char)&local_18,&DAT_1050_1050);
  return;
}
...

{
  ...
  if (iStack4 != 0x0) {
    ...
    if ((uStack12 | param_1) == 0x0) {
      ...
      uVar6 = SUB42(&PTR_LOOP_1050_1040,0x0);
      iVar2 = string_1040_8520(uVar5,(astruct_57 *)CONCAT22(uStack12,param_1),(param_3 + 0x6),0x20000,
    ...
    if (uStack6 == 0x0) {
      ...
      (**ppcVar1)(0x1008,(char)puStack10,(puStack10 >> 0x10),local_12,&DAT_1050_1050);
    }
  }
  return;
}
...

{
  ...
  paVar13 = (astruct_57 *)(uVar7 & 0xffff0000 | pcVar12 >> 0x10);
  uVar4 = pcVar12;
  uVar10 = 0x1000;
