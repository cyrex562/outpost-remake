...

{
  ...
  uVar1 = (param_1 >> 0x10);
  CheckRadioButton16(0x1807,0x1807,0x1807,*(HWND16 *)(param_1 + 0x6));
...

{
  ...
  if (param_3 != 0x0) {
    ...
    SendMessage16(0x0,(WPARAM16)uVar2,(uVar2 >> 0x10),HWND16_1050_0396);
  }//
LAB_1038_e229:
...

{
  ...
  uVar6 = (StructD *)(uVar6 & 0xffff0000 | puStack6 >> 0x10);
  uStack8 = pass1_1010_088c();
  if (_PTR_LOOP_1050_5f2c == 0x0) {
    PTR_LOOP_1050_5f2c = mem_op_1000_160a(uVar6);
  }
  else {
    uVar6 = (StructD *)(uVar6 & 0xffff0000 | _PTR_LOOP_1050_5f2c >> 0x10);
  }
  ...
  for (iStack10 = 0x1; uVar11 = (uVar6 >> 0x10), iStack10 <= uStack8; iStack10 += 0x1) {
    ...
    uVar6 = (StructD *)(paVar8 & 0xffff0000 | uVar7);
    if (uVar7 == 0x0) {
      uVar3 = &struct_b_5[0x7].field1_0x2;
      (uVar3 + iStack10 * 0x4) = 0x0;
    }
    else {
      pvVar1 = struct_b_5->lpvoid_field_0x8;
      pass1_1008_3bd6(uVar6,rect,(astruct_57 *)paVar8,0x0,CONCAT22(local_22,uStack32),0x101,0xff0100,
                      CONCAT13((char)(pvVar1 >> 0x8),CONCAT12((char)pvVar1,(puStack26 + 0x4)))
  ...
  if (param_4 == 0x1c4) {
    ...
    if (uVar3 != 0x0) {
      ...
      if ((uVar7 | uVar3) != 0x0) {
        ...
        paVar11 = (astruct_57 *)(uVar8 & 0xffff0000 | puVar10 >> 0x10);
        uVar4 = puVar10;
        ...
        uVar3 = paVar6 | uVar5;
        paVar6 = (astruct_57 *)(paVar6 & 0xffff0000 | uVar3);
        if (uVar3 == 0x0) {
          if (puStack22 != NULL) {
            ppcVar1 = (code **)uVar2;
          ...
          pass1_1028_e1ec(_PTR_LOOP_1050_65e2,CONCAT13((char)(paVar6 >> 0x8),CONCAT12((char)paVar6,uVar5)));
          ...
          pass1_1010_71d6(uVar5 + 0xc,(puVar9 >> 0x10),puVar9,0x1,
                          (u16 *)((paVar6 & 0xff00) << 0x10 | CONCAT12((char)paVar6,uVar5 + 0xc)),
                          &DAT_1050_1050);
          if (puStack22 != NULL) {
...

{
  ...
  struct_1[0x7].lpvoid_field_0x8 = (LPVOID)(&PTR_LOOP_1050_0000 + 0x1);
...

{
  ...
  if (param_2 == 0x0) {
    ...
    if (UVar2 == 0x0) {
      UVar2 = IsDlgButtonChecked(s_vrpal_bmp_1050_183a + 0x1,*(HWND16 *)&iVar3->field_0x6);
      if (UVar2 == 0x0) {
        uVar1 = iVar3->field142_0x8e;
        (uVar1 + 0xc) = 0x0;
      }
    ...
    UVar2 = IsDlgButtonChecked(s_vrpal_bmp_1050_183a + 0x2,*(HWND16 *)&iVar3->field_0x6);
    if (UVar2 == 0x0) {
      UVar2 = IsDlgButtonChecked(s_vrpal_bmp_1050_183a + 0x3,*(HWND16 *)&iVar3->field_0x6);
      if (UVar2 == 0x0) {
        uVar1 = iVar3->field142_0x8e;
        (uVar1 + 0xe) = 0x0;
      }
...

{
  ...
  if (param_2 != 0x0) {
    ...
    pass1_1010_3770((LVar1 >> 0x10),(astruct_477 *)struct_1->field140_0x8e,
...

{
  ...
  pSVar5 = (StructD *)(param_3 & 0xffff0000 | puStack6 >> 0x10);
  ...
  (iVar7 + 0x8e) = uVar2;
  (iVar7 + 0x90) = pSVar5;
  for (iStack10 = 0x1; uVar10 = (pSVar5 >> 0x10), iStack10 <= uStack8; iStack10 += 0x1) {
    puStack26 = (u16 *)pass1_1010_0932(puStack6,(puStack6 >> 0x10),iStack10);
    ...
    pSVar5 = (StructD *)(paVar6 & 0xffff0000 | uVar4);
    if (uVar4 == 0x0) {
      uVar1 = (iVar7 + 0x8e);
      ...
      uVar10 = (iVar7 + 0x6);
      pass1_1008_3bd6(pSVar5,rect,(astruct_57 *)paVar6,0x0,CONCAT22(local_22,uStack32),0x101,0xff0100,
                      CONCAT13((char)(uVar10 >> 0x8),CONCAT12((char)uVar10,(puStack26 + 0x4)))
                      ,param_4,in_stack_0000fe2a,in_stack_0000fe2e,in_stack_0000ff54,in_stack_0000ff58,in_stack_0000ff5c
                     );
      uVar1 = (iVar7 + 0x8e);
      uVar10 = (uVar1 >> 0x10);
...

{
  ...
  if (param_4 != 0x1c8) {
    if (param_4 == 0x1c9) {
      ...
      uVar5 = uVar8 | uVar3;
      paVar6 = (astruct_57 *)(uVar8 & 0xffff0000 | uVar5);
      if (uVar5 == 0x0) {
        return;
      }
...

{
  ...
  if (*(i32 *)&iVar1->field_0x96 != 0x0) {
    ...
    DestroyWindow16(*(HWND16 *)(uVar2 + 0x6));
