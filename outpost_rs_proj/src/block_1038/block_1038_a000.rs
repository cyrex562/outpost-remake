...
StructD * pass1_1038_a090(StructD *param_1,param_2: u8)
...

{
  ...
  puVar2 = local_c;
  pass1_1008_3e94((u16 *)CONCAT22(0x1050,puVar2),(u16 *)CONCAT22(0x1050,&local_10),CONCAT22(0x1050,&local_e));
  uVar3 = FUN_1010_830a(puVar2,uVar5,0x1008,_u16_1050_14cc,0x1c0);
  puStack20 = CONCAT22(uVar5,uVar3);
  uStack24 = pass1_1008_4772((astruct_76 *)CONCAT22(uVar5,uVar3));
  puVar2 = local_1a;
  piVar7 = &local_1c;
  uVar8 = 0x50;
  uVar9 = 0x10;
  puStack36 = mixed_1010_20ba((astruct_57 *)(uVar5 & 0xffff0000 | uStack24 >> 0x10),_u16_1050_0ed0,
                              ...
                              in_stack_0000ff84);
  pass1_1008_3e94((u16 *)(puStack36 & 0xffff0000 | (puStack36 + 0xe)),
                  (u16 *)CONCAT13(uVar9,CONCAT12(uVar8,piVar7)),CONCAT22(0x1050,puVar2));
  uVar3 = (puStack36 >> 0x10);
  uStack30 = (puStack36 + 0xa);
  iStack32 = (puStack36 + 0xc);
  local_10 += (iStack32 * 0xa) / 0x258 + (uStack24 + 0x8) + local_1c;
  GetWindowRect16((RECT16 *)CONCAT22(0x1050,local_2c),*(HWND16 *)(param_2 + 0x6));
...
StructD * pass1_1038_a2aa(StructD *param_1,param_2: u8)
...

{
  ...
  paVar1 = (astruct_57 *)(param_1 >> 0x10);
...

{
  ...
  ShowWindow16(0x5,*(HWND16 *)(param_3 + 0x6));
  return;
}
...

{
  ...
  hwnd = GetWindowWord16(-0x8,*(HWND16 *)(param_1 + 0x6));
...
StructD * pass1_1038_a402(StructD *param_1,param_2: u8)
...
StructD * pass1_1038_a608(StructD *param_1,param_2: u8)
...

{
  ...
  if (param_3 != 0x0) {
    uVar3 = (param_2 >> 0x10);
    hwnd = GetDlgItem16(0x115,*(HWND16 *)(param_2 + 0x6));
    GetWindowText16(0x50,CONCAT22(0x1050,local_52),hwnd);
    uVar1 = str_op_1000_3da4(CONCAT22(0x1050,local_52));
    if (uVar1 != 0x0) {
      puVar4 = local_52;
      ...
      pUVar2 = (u16 *)
               mixed_1010_20ba(paVar2,_u16_1050_0ed0,(u8 **)CONCAT22(puVar4,0x2),in_stack_0000fe4c,
                               in_stack_0000ff70,in_stack_0000ff76,in_stack_0000ff7a);
      pass1_1010_5fd8((pUVar2 >> 0x10),(astruct_485 *)pUVar2,CONCAT22(uVar5,puVar4));
      hwnd_00 = GetWindowWord16(-0x8,*(HWND16 *)(param_2 + 0x6));
      PostMessage16(0x0,0x105,0x111,hwnd_00);
...
StructD * pass1_1038_a80c(StructD *param_1,param_2: u8)
...

{
  ...
  if (param_3.b_0x2 == 0x116) {
    SendDlgItemMessage16(0x0,0x1,0x401,0x11a,*(HWND16 *)(param_1 + 0x6));
    hwnd = GetDlgItem16(0x11a,*(HWND16 *)(param_1 + 0x6));
    enable = 0x0;
  }
  else {
    ...
    if (((LVar4 >> 0x10) | LVar4) == 0x0) {
      ...
      if (((LVar4 >> 0x10) | LVar4) == 0x0) {
        ...
        if (((LVar4 >> 0x10) | LVar4) == 0x0) {
          ...
          PTR_LOOP_1050_13ae = (&u16_1050_0002 + 0x1);
        }
      }
      else {
...
StructD * pass1_1038_aaf0(StructD *param_1,param_2: u8)
...
StructD * pass1_1038_ad4c(StructD *param_1,param_2: u8)
...
StructD * pass1_1038_ae28(StructD *param_1,param_2: u8)
...
LAB_1038_afa0:
  ...
  case 0x26:
    ...
    uVar4 = paVar12 | param_1;
    pSVar7 = (StructD *)(paVar12 & 0xffff0000 | uVar4);
    if (uVar4 == 0x0) goto LAB_1038_afa0;
    uVar11 = SUB42(&PTR_LOOP_1050_1040,0x0);
...
switchD_1038_b581_caseD_18:
  if (*(i32 *)(param_5 * 0x4 + iVar9) != 0x0) {
    ...
    (iVar9 + 0xae) = 0x0;
    uVar2 = (param_5 * 0x4 + iVar9);
    ppcVar1 = (code **)((param_5 * 0x4 + iVar9) + 0x8);
