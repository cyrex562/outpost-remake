...

{
  ...
  if (uStack6 != 0x0) {
    ...
    if (uVar1 != 0x0) {
      ...
      uVar7 = pass1_1008_b38c((StructD *)CONCAT22(uVar7,(uVar7 >> 0x10)),*(astruct_196 **)(uVar4 + 0x94));
      if (uVar7 != 0x0) {
...
LAB_1038_89af:
  if (bVar2) {
    SetDlgItemInt16(0x0,(iVar3 + 0x9a),s_dibtext_bmp_1050_1844 + 0x9,*(HWND16 *)(iVar3 + 0x6));
    SetDlgItemInt16(0x0,(iVar3 + 0x98),s_dibtext_bmp_1050_1844 + 0xb,*(HWND16 *)(iVar3 + 0x6));
  }
  return 0x0;
}
...

{
  ...
  uVar4 = (astruct_50 *)(param_2 >> 0x10);
  iVar4 = (astruct_50 *)param_2;
  dlg_item = GetDlgItemInt16(0x0,&local_4,(INT16)&DAT_1050_1050,s_dibtext_bmp_1050_1844 + 0x9);
...

{
  ...
  LVar7 = SendDlgItemMessage16
                    (CONCAT22(0x1050,local_106),0x0,0xc,s_dibtext_bmp_1050_1844 + 0x2,*(HWND16 *)(iVar5 + 0x6));
  uVar4 = (LVar7 >> 0x10);
  uVar1 = (iVar5 + 0x94);
  (iVar5 + 0x9c) = (uVar1 + 0x32);
  (iVar5 + 0x9a) = (iVar5 + 0x9c);
  SetDlgItemInt16(0x0,(iVar5 + 0x9c),s_dibtext_bmp_1050_1844 + 0x9,*(HWND16 *)(iVar5 + 0x6));
  uVar1 = (iVar5 + 0x94);
  uVar3 = (uVar1 + 0x2e);
  pass1_1038_3aa6(uVar3,uVar4,uVar3);
  (iVar5 + 0x98) = uVar3;
  SetDlgItemInt16(0x0,uVar3,s_dibtext_bmp_1050_1844 + 0xb,*(HWND16 *)(iVar5 + 0x6));
  return;
}
