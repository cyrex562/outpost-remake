...

{
  ...
  if (BVar3 != 0x0) {
    ...
    for (iStack22 = 0x0; iStack22 < 0xa; iStack22 += 0x1) {
      ...
      paVar6 = (astruct_57 *)((long)uStack10 >> 0x10);
      if ((long)uStack10 < (long)uStack10) {
        paVar6 = (astruct_57 *)(uStack10 >> 0x10);
      }
      lStack26 = CONCAT22(paVar6,uStack10);
      pass1_1030_7ddc(uStack10,paVar6,uStack18,
                      CONCAT13((char)(paVar6 >> 0x8),CONCAT12((char)paVar6,uStack10)),iStack22 + 0x4);
      uStack10 -= lStack26;
...

{
  ...
  if (paVar1 < (astruct_409 *)(&u16_1050_0008 + 0x1U)) {
    switch(paVar1) {
    case NULL:
...

{
  ...
  puVar2 = &local_c;
  pass1_1030_64ce(puVar2,param_2,_PTR_LOOP_1050_5740,(u16 *)param_4,param_6,CONCAT22(0x1050,puVar2));
  uStack6 = *puVar2;
  uStack30 = (puVar2 + 0x2);
...

{
  ...
  *piVar1 = *piVar1 + -0x1;
  if (*piVar1 == 0x0) {
    ...
    paVar3 = (astruct_57 *)(in_EDX & 0xffff0000 | uStack4);
    ...
    pass1_1008_3eb4((astruct_615 *)CONCAT22(0x1050,&local_10),(u16 *)CONCAT22(0x1050,&local_16),
                    (u16 *)CONCAT22(0x1050,&local_14),(u16 *)CONCAT22(0x1050,&local_14 + 0x2));
    ...
    local_15e = 0x389a;
    uStack348 = 0x1008;
    pass1_1008_3e76((u16 *)CONCAT22(0x1050,&local_10),local_16 + 0x1,local_14,(local_14 >> 0x10));
...

{
  ...
  if ((*(param_1 + 0x1a) & 0x2) == 0x0) {
    ...
    uVar5 = 0x23;
    uVar3 = 0x1;
    uVar2 = pass1_1028_b58e((astruct_15 *)(param_1 & 0xffff | uVar1 << 0x10));
