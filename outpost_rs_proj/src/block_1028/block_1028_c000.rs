...
LAB_1028_c0d6:
    ...
    ppcVar2 = (code **)(*puStack18 + 0x4);
    uVar9 = uStack22;
    (**ppcVar2)((char)uVar7,uVar3,puVar5,(char)uStack26,(uStack26 >> 0x10));
    uVar4 = uVar9;
...

{
  ...
  uVar8 = (paVar1 >> 0x10);
  if (((paVar1 + 0x204) == 0x0) && ((paVar1 + 0x206) == 0x0)) {
    ...
    for (uStack28 = 0x0; uStack28 < uStack24; uStack28 += 0x1) {
      ...
      uVar10 = uStack24;
      (**ppcVar2)((char)uVar8,uVar3,puVar5,(char)uStack28,(uStack28 >> 0x10));
      uVar4 = uVar10;
      uVar6 = extraout_DX_01;
...

{
  ...
  paVar12 = (astruct_57 *)CONCAT22(uVar10,(uVar15 >> 0x10));
  iVar2 = uVar15;
  ...
  if (0x1e < puStack24) {
    ...
    if (uVar3 == 0x0) {
      ...
      pass1_1038_4d6e(uVar4,(puVar17 >> 0x10),(astruct_691 *)CONCAT22(uVar10,iVar2),puVar17);
      uVar10 = uVar15;
...

{
  ...
  if (uVar2 != 0x0) {
    ...
    if (paStack10 != NULL) {
      ...
      if ((uVar3 != 0x0) && ((iVar1 = (uVar3 + 0xc), iVar1 == iStack14 || (iVar1 == param_5)))) {
        return 0x1;
      }
    }
  }
...

{
  ...
  pass1_1008_3eb4((astruct_615 *)param_3,CONCAT22(0x1050,&local_8),CONCAT22(0x1050,&local_6),
...

{
  ...
  uVar10 = (astruct_15 *)(param_1 >> 0x10);
  ...
  if (uVar7 != 0x0) {
    ...
    if ((((pSVar5 + 0x30) | uStack14) != 0x0) &&
      ...
      if (BVar3 == 0x0) {
        ...
        if ((BVar3 != 0x0) && (((qword)*_PTR_LOOP_1050_65e2 % 0x5) == 0x0)) {
          return;
        }
      }
      else if (((qword)*_PTR_LOOP_1050_65e2 % 0xa) == 0x0) {
        return;
      }
      uVar12 = (uVar1 >> 0x10);
...

{
  ...
  if (uVar1 != 0x0) {
    ...
    uVar2 = (uVar5 + 0x2e);
    uStack18 = (uVar5 + 0x30);
    paVar9 = (astruct_57 *)(in_EDX & 0xffff0000 | uStack18);
    uStack14 = uVar2;
    uStack18 |= uStack14;
    if (uStack18 != 0x0) {
      uVar11 = (uVar2 >> 0x10);
      ...
      if ((uStack14 + 0x204) != 0x0) {
        ...
        if ((puVar8 <= puStack36) &&
          ...
          paVar9 = (astruct_57 *)(paVar14 >> 0x10);
      ...
      for (iStack22 = 0x11; iStack22 < 0x25; iStack22 += 0x1) {
        ...
        paVar9 = (astruct_57 *)(paVar9 & 0xffff0000 | ZEXT24(puStack52));
        if (uVar5 < uVar1) {
          if ((((iStack22 == 0x23) || (iStack22 == 0x24)) || (puStack16 < puStack52)) ||
            ...
            if (iStack22 == 0x23) {
              paVar14 = (astruct_27 *)
                        mixed_1010_20ba(paVar9,_u16_1050_0ed0,(u8 **)CONCAT22(unaff_SI,0x2b),in_stack_0000fe70,
                                        in_stack_0000ff94,in_stack_0000ff9a,in_stack_0000ff9e);
              paVar9 = (astruct_57 *)(paVar9 & 0xffff0000 | paVar14 >> 0x10);
              pass1_1010_043a(paVar14,*(i32 *)(uStack14 + 0x4),0x12);
            }
          }
          else {
...

{
  ...
  puVar2 = &local_8;
  pass1_1008_3eb4((astruct_615 *)param_2,CONCAT22(0x1050,puVar2),CONCAT22(0x1050,&local_6),
  ...
  if ((uVar5 | puVar3) != 0x0) {
    ...
    for (uStack64 = uStack12; uStack64 <= iStack16; uStack64 += 0x1) {
      for (uStack72 = uStack10; iVar4 = iStack62, uStack72 <= iStack14; uStack72 += 0x1) {
        iVar6 = iStack62 >> 0xf;
        ...
        if (uStack60._3_1_ == '\0') {
          ...
          struct_op_1028_87f0((astruct_97 *)CONCAT22(0x1050,&local_178),0x0,0x0,uVar7,param_2,
...

{
  ...
  uVar1 = (astruct_15 *)(param_1 >> 0x10);
  bVar1 = (*(param_1 + 0x1a) & 0x2) == 0x0;
  if (bVar1) {
    uVar5 = 0x0;
    uVar6 = 0x23;
    uVar4 = 0x1;
    paVar3 = (astruct_398 *)pass1_1028_b58e((astruct_15 *)(param_1 & 0xffff | ZEXT24(uVar1) << 0x10));
    pass1_1030_7d7c(paVar3,(paVar3 >> 0x10),paVar3,uVar4,CONCAT22(uVar6,uVar5));
  }
  bVar2 = (*(param_1 + 0x1a) & 0x1) == 0x0;
  if (bVar2) {
    uVar5 = 0x0;
    uVar6 = 0xe;
    uVar4 = 0x1;
