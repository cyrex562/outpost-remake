...
//        LAB_1000_085b:
        ...
        while (true) {
            ...
            if (u_stack6 >> 0x1 < (param_1 + 0x18) + 0x14U) {
                // &DAT_1050_1050
                uvar7 = block_1000_1000::pass1_1000_1e61(REG_CS,
                                                         0x2,
                                                         param_1);
...
pub fn mem_1000_0670(mut param_1: u16,
                     param_2: *mut Struct7,
                     mut param_3: i16,
                     mut param_4: u16,
                     param_5: *mut i16) -> u16
...
pub fn pass1_1000_0782(mut param_1: u16,
                       mut param_2: u16,
                       mut param_3: i16,
                       mut param_4: u16 ) -> u16
{
...
pub fn pass1_1000_07fc(mut param_1: u32) -> *mut astruct_99
{
    // let mut unaff_CS: u16;
...
pub fn pass1_1000_093a(param_1: *mut astruct_611) -> u16
{
...
pub fn pass1_1000_09a0(param_1: *mut u16) -> *mut u8
{
    u8 *puVar1;
    let mut uVar2: u32;
...
pub fn pass1_1000_09ca(mut param_1: i16,
                       param_2: *mut u16) -> u16
{
    let mut puVar1: *mut u16;
    let mut iVar2: i16;
...
pub fn mem_op_1000_0a48(param_1: u8,
                        mut param_2: u16,
                        mut param_3: i16,
...
pub fn mem_op_1000_0b20(mut param_1: u16,
                        mut param_2: u16,
                        mut param_3: u16 ) -> u32
{
    let mut puVar1: *mut u16;
...
pub fn pass1_1000_0c32(mut param_1: u16,
                       mut param_2: u16,
                       mut param_3: u16 ) -> U32
{
    let mut puVar1: *mut u16;
...
pub fn call_fn_ptr_1000_0dc6(param_1: *mut c_char) -> bool
{
//    let mut unaff_CS: u16;
...
pub fn pass1_1000_0ed4(mut param_1: u16,
                       mut param_2: u16,
                       mut param_3: u16,
...
pub fn pass1_1000_0fb8(mut param_1: u16,
                       mut param_2: i16,
                       mut param_3: u16,
                       mut param_4: u16,
                       param_5: *mut u16,
...
pub fn pass1_1000_115c(mut param_1: i16,
