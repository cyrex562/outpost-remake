...

{
  ...
  puVar3 = mixed_1010_20ba((astruct_57 *)(paVar1 & 0xffff0000 | puVar3 >> 0x10),_u16_1050_0ed0,
                           (u8 **)CONCAT22((ppuVar4 >> 0x10),0x29),in_stack_0000fea6,
...

{
  ...
  if ((local_1e == 0x0) && (local_1e == 0x0)) {
    ...
    paVar2 = (astruct_57 *)CONCAT22(uVar7,(puVar4 >> 0x10));
    uVar1 = &struct_b_3[0x7].field5_0xa;
    pass1_1018_2678(uVar1,(uVar1 >> 0x10),(u16 *)CONCAT22(0x1050,local_30));
    pass1_1008_3e94((u16 *)CONCAT22(0x1050,local_30),(u16 *)CONCAT22(0x1050,&local_32),CONCAT22(0x1050,local_2a)
                   );
    ...
    pass1_1008_3e94((u16 *)(puVar5 & 0xffff0000 | (puVar5 + 0xe)),(u16 *)CONCAT22(uVar7,piVar6),
                    pcVar8);
...
StructD * pass1_1040_4440(StructD *param_1,param_2: u8)
...

{
  ...
  paVar6 = (astruct_57 *)(param_2 & 0xffff0000 | uVar4);
  if (uVar4 == 0x0) {
...

{
  ...
  paVar7 = (astruct_57 *)(paVar7 & 0xffff0000 | paVar12 >> 0x10);
  ...
  if (pSVar1 != NULL) {
    ...
    ppcVar2 = (code **)(CONCAT22(param_3,param_2) + 0x70);
...
StructD * pass1_1040_47fe(StructD *param_1,param_2: u8)
...

{
  ...
  uVar10 = (astruct_57 *)(param_2 >> 0x10);
  iVar5 = (astruct_57 *)param_2;
  &iVar5[0x1].field3_0x6 = 0x0;
  ...
  uVar6 = paVar8 | uVar5;
  paVar9 = (astruct_57 *)(paVar8 & 0xffff0000 | uVar6);
  if (uVar6 == 0x0) {
  ...
  *(u16*)&iVar5[0x1].field1_0x2 = 0x7;
  ...
  pass1_1010_debe(&iVar5[0x1].field3_0x6,(uVar2 + 0xa),(u16 *)CONCAT22(uVar3,uVar2 + 0x10),
...

{
  ...
  uVar6 = (astruct_48 *)(struct_param_1 >> 0x10);
  iVar5 = (astruct_48 *)struct_param_1;
  ppcVar2 = (code **)(struct_param_1 + 0x74);
  (**ppcVar2)();
  ...
  for (WStack10 = 0x0; uVar3 = iVar5->field143_0x90, pWVar1 = (WPARAM16 *)(uVar3 + 0x10),
      *pWVar1 != WStack10 && WStack10 <= *pWVar1; WStack10 += 0x1) {
    wparam = 0x0;
    UVar7 = 0x403;
...

{
  ...
  if (param_4 == 0xeb) {
    ...
    paVar6 = (astruct_57 *)(in_EDX & 0xffff0000 | paStack6 >> 0x10);
    pSVar4 = *(StructD **)(param_1 + 0x90);
    if (pSVar4 != NULL) {
      pSStack10 = pSVar4;
      mem_op_1000_179c(0x18,paVar6);
      uVar3 = pSVar4;
      pSStack16 = (StructD *)(pSVar4 & 0xffff | (long)paVar6 << 0x10);
      uVar5 = paVar6 | uVar3;
      ...
      if (uVar5 == 0x0) {
        ...
        struct_1040_a598((astruct_259 *)(pSVar4 & 0xffff | (long)paVar6 << 0x10));
        paVar8 = paVar7;
      }
      (param_1 + 0x90) = uVar3;
      (param_1 + 0x92) = paVar8;
...

{
  ...
  HVar1 = GetDlgItem16(0x1770,*(HWND16 *)(param_2 + 0x6));
  uVar3 = 0xffff;
  uVar4 = 0x40d;
  hwnd = HVar1;
  pass1_1040_4d7e((astruct_48 *)param_2);
  uVar2 = pass1_1040_4dcc(param_1,(astruct_48 *)param_2,HVar1);
...

{
  ...
  iStack8 = 0x0;
  while ((piVar2 = *(i16 **)(param_1 + 0x90), *piVar2 != iStack8 && iStack8 <= *piVar2 &&
         ((puStack6 + 0x4) != 0x1770))) {
    iStack8 += 0x1;
...
StructD * pass1_1040_4df2(StructD *param_1,param_2: u8)
...

{
  ...
  paVar12 = (astruct_57 *)(param_1 & 0xffff0000 | puVar17 >> 0x10);
  ...
  fn_ptr_1 = (code **)(*(u32*)&struct_b_11[0x7].field6_0xc + 0x10);
  (**fn_ptr_1)(0x1010,puVar22,uVar9);
  mem_op_1000_179c(0xa,paVar12);
  uVar10 = paVar12 | paVar5;
  paVar13 = (astruct_57 *)(paVar12 & 0xffff0000 | uVar10);
  if (uVar10 == 0x0) {
  ...
  paVar12 = (astruct_57 *)(paVar13 & 0xffff0000 | uVar10);
  if (uVar10 != 0x0) {
    pass1_1008_3bd6(paVar12,paVar5,(astruct_57 *)paVar13,0x1,0xa000a,0x0,0x800081,
  ...
  paVar13 = (astruct_57 *)(paVar12 & 0xffff0000 | uVar10);
  if (uVar10 != 0x0) {
    pass1_1008_3bd6(paVar13,paVar5,(astruct_57 *)paVar12,0x1,0xa0028,0x0,0x840085,
  ...
  paVar12 = (astruct_57 *)(paVar13 & 0xffff0000 | uVar10);
  if (uVar10 != 0x0) {
    pass1_1008_3bd6(paVar12,paVar5,(astruct_57 *)paVar13,0x1,0xa0046,0x0,0x860087,
  ...
  paVar13 = (astruct_57 *)(paVar12 & 0xffff0000 | uVar10);
  if (uVar10 != 0x0) {
    pass1_1008_3bd6(paVar13,paVar5,(astruct_57 *)paVar12,0x1,0xa0064,0x0,0x880089,
  ...
  paVar12 = (astruct_57 *)(paVar13 & 0xffff0000 | uVar10);
  if (uVar10 != 0x0) {
    pass1_1008_3bd6(paVar12,paVar5,(astruct_57 *)paVar13,0x1,0xa0082,0x0,0x820083,
  ...
  paVar13 = (astruct_57 *)(paVar12 & 0xffff0000 | uVar10);
  if (uVar10 != 0x0) {
    pass1_1008_3bd6(paVar13,paVar5,(astruct_57 *)paVar12,0x1,0xa00d2,0x0,0x8a008b,
  ...
  mem_op_1000_179c(0x42,paVar13);
  uVar10 = (astruct_57 *)paVar13 | paVar5;
  paVar12 = (astruct_57 *)(paVar13 & 0xffff0000);
  paVar14 = (astruct_57 *)(paVar12 | uVar10);
  if (uVar10 == 0x0) {
    paVar5 = NULL;
  }
  else {
