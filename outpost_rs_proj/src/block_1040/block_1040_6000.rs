...

{
  ...
  uVar5 = (StructD *)(uVar5 & 0xffff0000 | puStack6 >> 0x10);
  uStack8 = pass1_1010_0898();
  if (_PTR_LOOP_1050_5f2c == 0x0) {
    PTR_LOOP_1050_5f2c = mem_op_1000_160a(uVar5);
  }
  else {
    uVar5 = (StructD *)(uVar5 & 0xffff0000 | _PTR_LOOP_1050_5f2c >> 0x10);
  }
  ...
  for (iStack10 = 0x1; iStack10 <= uStack8; iStack10 += 0x1) {
    puStack26 = (u16 *)pass1_1010_0946(puStack6,(puStack6 >> 0x10),iStack10,uVar5,unaff_DI,
                                       &DAT_1050_1050);
    ...
    uVar5 = (StructD *)(paVar5 & 0xffff0000 | uVar4);
    if (uVar4 == 0x0) {
...

{
  ...
  ppcVar2 = (code **)(*(u32*)&struct_b_6[0x7].max_count_field_0x10 + 0x4);
  (**ppcVar2)(0x1010,struct_b_6[0x7].max_count_field_0x10,(char)(puVar15 >> 0x10),0x0,struct_b_param_1);
  mem_op_1000_179c(0xa,paVar11);
  uVar10 = paVar11 | paVar3;
  paVar12 = (astruct_57 *)(paVar11 & 0xffff0000 | uVar10);
  if (uVar10 == 0x0) {
    &struct_b_6[0x7].field6_0xc = 0x0;
  }
  else {
    puVar14 = struct_1040_bf3e((astruct_442 *)CONCAT13((char)(paVar11 >> 0x8),CONCAT12((char)paVar11,paVar3)),
  ...
  paStack6 = paVar3;
  enable_win_1040_9234(CONCAT13((char)(paVar11 >> 0x8),CONCAT12((char)paVar11,paVar3)),BVar21);
  BVar21 = 0x0;
  mem_op_1000_179c(0x42,paVar11);
  ...
  ppcVar2 = (code **)(*(u32*)&struct_b_6[0x7].max_count_field_0x10 + 0x10);
...
LAB_1040_6deb:
  ...
  case 0x107:
    ...
    goto LAB_1040_6e48;
  case 0x108:
    iVar3 = (astruct_895 *)(&PTR_LOOP_1050_0000 + 0x1);//
LAB_1040_6e48:
