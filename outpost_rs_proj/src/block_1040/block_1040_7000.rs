...

{
  ...
  paVar5 = (astruct_57 *)(param_1 & 0xffff0000 | puVar10 >> 0x10);
  ...
  fn_ptr_1 = (code **)(*(u32*)&struct_b_5[0x7].max_count_field_0x10 + 0x4);
  (**fn_ptr_1)(0x1010,struct_b_5[0x7].max_count_field_0x10,(char)(puVar10 >> 0x10),0x0,struct_b_param_1);
  mem_op_1000_179c(0xa,paVar5);
  uVar4 = paVar5 | paVar2;
  paVar6 = (astruct_57 *)(paVar5 & 0xffff0000 | uVar4);
  if (uVar4 == 0x0) {
    &struct_b_5[0x7].field6_0xc = 0x0;
  }
  else {
    puVar11 = struct_1040_bf3e((astruct_442 *)CONCAT13((char)(paVar5 >> 0x8),CONCAT12((char)paVar5,paVar2)),
                               struct_b_5->lpvoid_field_0x8);
    paVar6 = (astruct_57 *)(paVar6 & 0xffff0000 | puVar11 >> 0x10);
  ...
  paVar5 = (astruct_57 *)(paVar6 & 0xffff0000 | uVar4);
  if (uVar4 != 0x0) {
    pass1_1008_3bd6(paVar5,paVar2,(astruct_57 *)paVar6,0x1,0xa000a,0x0,0x800081,
  ...
  paVar6 = (astruct_57 *)(paVar5 & 0xffff0000 | uVar4);
  if (uVar4 != 0x0) {
    pass1_1008_3bd6(paVar6,paVar2,(astruct_57 *)paVar5,0x1,0xa0028,0x0,0x820083,
  ...
  mem_op_1000_179c(0x42,paVar6);
  uVar4 = (astruct_57 *)paVar6 | paVar2;
  paVar5 = (astruct_57 *)(paVar6 & 0xffff0000);
  paVar7 = (astruct_57 *)(paVar5 | uVar4);
  if (uVar4 == 0x0) {
    paVar2 = NULL;
  }
  else {
    pvVar1 = struct_b_5->lpvoid_field_0x8;
    pass1_1008_3bd6(paVar7,paVar2,(astruct_57 *)paVar6,0x1,0xa00aa,0x101,0xff0100,
  ...
  paStack6 = paVar2;
  enable_win_1040_9234(CONCAT13((char)(paVar5 >> 0x8),CONCAT12((char)paVar5,paVar2)),BVar13);
  BVar13 = 0x0;
  mem_op_1000_179c(0x42,paVar5);
  ...
  fn_ptr_1 = (code **)(*(u32*)&struct_b_5[0x7].max_count_field_0x10 + 0x10);
...

{
  ...
  uVar5 = (param_1 >> 0x10);
  iVar4 = param_1;
  pass1_1010_1ea6((iVar4 + 0x94),(StructD *)(param_1 & 0xffff | uVar5 << 0x10));
  puVar1 = (iVar4 + 0x98);
  uVar2 = (iVar4 + 0x9a);
  if ((uVar2 | puVar1) != 0x0) {
    ppcVar3 = (code **)*puVar1;
...

{
  ...
  switch(param_5) {
  case 0xfa:
    fn_ptr_1 = (code **)(*param_2->field144_0x94 + 0x18);
    (**fn_ptr_1)();
    break;
  default:
...
LAB_1040_755d:
    ...
    fn_ptr_1 = (code **)(*param_2->field144_0x94 + 0x10);
...

{
  ...
  CreateWindow16(0x0,(void *)CONCAT22(param_5,HINSTANCE16_1050_038c),*(HINSTANCE16 *)(param_1 + 0x6),
                 ...
                 (INT16)(_h_instance >> 0x10),window_name,s_button_1050_5da8);
  return;
}
...

{
  ...
  pass1_1000_4906((StructD *)(param_1 & 0xffff0000 | ZEXT24(&iVar2->field_0x7a)),NULL,0x8);
  pass1_1000_4906((StructD *)(param_1 & 0xffff0000 | ZEXT24(&iVar2->field_0x82)),NULL,0x8);
...

{
  ...
  if ((struct_1 + 0x4) != 0x0) {
    DeleteObject16(*(HGDIOBJ16 *)(struct_1 + 0x4));
    (struct_1 + 0x4) = 0x0;
  }
  if ((struct_1 + 0x68) != 0x0) {
    DestroyMenu16(*(HMENU16 *)(struct_1 + 0x68));
  }
  RemoveProp16(s_thisLo_1050_5db1,*(HWND16 *)(struct_1 + 0x6));
  RemoveProp16(s_thisHi_1050_5db8,*(HWND16 *)(struct_1 + 0x6));
  RemoveProp16(s_procLo_1050_5dbf,*(HWND16 *)(struct_1 + 0x6));
  RemoveProp16(s_procHi_1050_5dc6,*(HWND16 *)(struct_1 + 0x6));
...
pub fn *pvStack6;
  ...
  GetWindowText16(0x50,in_struct_1 & 0xffff0000 | ZEXT24(&struct_b_1->field8_0x10),(HWND16)dialog_handle);
  ...
  fn_ptr_1 = (code **)(in_struct_1 + 0x50);
...

{
  ...
  if ((param_4 == 0x1) || (param_4 == 0x2)) {
    ...
    PostMessage16(0x0,0xf060,0x112,*(HWND16 *)(param_1 + 0x6));
  }
  return 0x1;
}
...

{
  ...
  pRVar1 = (RECT16 *)(in_struct_1 >> 0x10);
  ...
  if (is_iconic == 0x0) {
    ...
    func_ptr_1 = (code **)(in_struct_1 + 0x68);
    ...
    if ((astruct_13 *)uStack8 != NULL) {
      ...
      func_ptr_1 = (code **)(in_struct_1 + 0x64);
...

{
  ...
  PostMessage16(0x0,0x0,0x85,*(HWND16 *)(param_1 + 0x6));
  return;
}
