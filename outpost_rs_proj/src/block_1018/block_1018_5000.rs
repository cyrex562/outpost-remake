...
StructD * pass1_1018_5032(StructD *param_1,param_2: u8)
...

{
  ...
  if (*(i32 *)(iVar1 + 0xe) == 0x0) {
    pass1_1018_5292((astruct_9 *)(param_1 & 0xffff | uVar2 << 0x10),param_2);
  }
...

{
  ...
  pstruct9_v16 = (astruct_9 *)(param_1 >> 0x10);
  ...
  paVar14 = (astruct_57 *)(paVar15 | (pSStack16 | puStack18));
  if ((pSStack16 | puStack18) == 0x0) {
    uVar9 = 0x0;
  }
  else {
  ...
  while( true ) {
    ...
    paVar15 = (astruct_57 *)(paVar15 & 0xffff0000 | uVar12);
    if (uVar12 != 0x0) {
      ...
      paVar13 = (astruct_57 *)(paVar15 & 0xffff0000 | (pSStack12 | puStack14));
      if ((pSStack12 | puStack14) == 0x0) {
        uVar9 = 0x0;
        paVar15 = (astruct_57 *)(paVar15 & 0xffff0000);
      }
      else {
  ...
  if (BVar4 != 0x0) {
    ...
    while( true ) {
      ...
      paVar13 = (astruct_57 *)(paVar13 & 0xffff0000 | (uVar12 | puVar5));
...
LAB_1018_53f0:
        ...
        if ((pSStack16 | uVar8) == 0x0) {
          ...
          paVar18 = struct_1018_48b0((astruct_203 *)CONCAT22(pSStack16,uVar8),(uStack22 + 0xa),
                                     CONCAT22(uVar17,uVar7),(uStack22 + 0x6));
          paVar13 = (astruct_57 *)(paVar13 & 0xffff0000 | paVar18 >> 0x10);
      ...
      if ((uStack22 + 0x8) != 0x0) {
        ...
        if ((pSStack12 | uVar8) == 0x0) {
          ...
          uVar16 = (uStack22 >> 0x10);
          puVar19 = struct_1018_48e8((astruct_203 *)CONCAT22(pSStack12,uVar8),(uStack22 + 0xa),
                                     CONCAT22(uVar17,uVar7),(uStack22 + 0x8));
          paVar13 = (astruct_57 *)(paVar13 & 0xffff0000 | puVar19 >> 0x10);
  ...
  uVar3 = (param_2 + 0x3e);
  uVar12 = (param_2 + 0x40);
  paVar13 = (astruct_57 *)(paVar13 & 0xffff0000 | uVar12);
  uStack50 = uVar3;
  if ((uVar12 | uStack50) != 0x0) {
    ...
    while( true ) {
      ...
      uVar12 = paVar13;
      paVar13 = (astruct_57 *)(paVar13 & 0xffff0000 | (uVar12 | pcVar6));
      ...
      if ((pcVar6 + 0x4) != 0x0) {
        ...
        pSStack16 = (StructD *)paVar13;
        paVar13 = (astruct_57 *)(paVar13 & 0xffff0000);
        paVar15 = (astruct_57 *)(paVar13 | (pSStack16 | uVar10));
        puStack18 = uVar10;
      ...
      if ((pcVar6 + 0x6) != 0x0) {
        ...
        if ((pSStack12 | uVar10) == 0x0) {
          ...
          paVar18 = struct_1018_48b0((astruct_203 *)CONCAT22(pSStack12,uVar10),(pcVar6 + 0xa),uStack30,
                                     (pcVar6 + 0x6));
          paVar13 = (astruct_57 *)(paVar13 & 0xffff0000 | paVar18 >> 0x10);
          uVar17 = SUB42(paVar18,0x0);
        }
      ...
      if ((pcVar6 + 0x8) != 0x0) {
        ...
        if ((pSStack16 | uVar10) == 0x0) {
          ...
          puVar19 = struct_1018_48e8((astruct_203 *)CONCAT22(pSStack16,uVar10),(pcVar6 + 0xa),uStack30,
                                     (pcVar6 + 0x8));
          paVar13 = (astruct_57 *)(paVar13 & 0xffff0000 | puVar19 >> 0x10);
          uVar17 = SUB42(puVar19,0x0);
        }
...
StructD * pass1_1018_5a2e(StructD *param_1,param_2: u8)
...
StructD * FUN_1018_5a3c(mut param_1: u16 ,StructD *param_2,param_3: u8)
...

{
  ...
  (param_2 + 0x14) = 0x0;
  (param_2 + 0x18) = 0x0;
  puVar11 = pass1_1008_3e38((astruct_19 *)(param_2 & 0xffff0000 | (param_2 + 0x1c)));
  paVar8 = (astruct_57 *)CONCAT22(uVar10,(puVar11 >> 0x10));
  ...
  paVar8 = (astruct_57 *)(uVar9 & 0xffff0000 | puVar11 >> 0x10);
  ...
  ppcVar2 = (code **)((param_2 + 0x14) + 0x4);
  (**ppcVar2)();
  (param_2 + 0x6) = (param_2 + 0x14);
  uVar3 = (param_2 + 0x14);
  paVar1 = *(astruct_76 **)(uVar3 + 0xa);
  iVar4 = param_2 + 0xa;
  ppcVar2 = (code **)(paVar1 + 0x8);
  (**ppcVar2)();
  (param_2 + 0x12) = iVar4;
  draw_op_1020_9364((StructA *)(param_2 & 0xffff | param_2 << 0x10));
  uVar9 = (param_2 + 0x14);
  pass1_1008_3f62((u16 *)(param_2 & 0xffff0000 | (param_2 + 0x1c)),
                  (u16 *)(uVar9 & 0xffff0000 | (uVar9 + 0x52)));
  ...
  if (uVar7 == 0x0) {
    ...
    pass1_1008_50c2((astruct_110 *)CONCAT22(paVar8,uVar5),(uVar4 + 0x8),(uVar4 + 0x4),
                    (u16 *)(param_2 & 0xffff0000 | (param_2 + 0x1cU)),paVar1);
    (param_2 + 0x18) = uVar5;
    (param_2 + 0x1a) = uVar7;
  }
  ...
  (param_2 + 0x26) = (uVar4 + 0x4) + (param_2 + 0x22) + 0x1;
  (param_2 + 0x28) = (uVar4 + 0x8) + (param_2 + 0x24) + 0x1;
  return;
}
...

{
  ...
  if (iVar3->field12_0x14 != 0x0) {
    pass1_1010_1ea6(iVar3->field12_0x14,(StructD *)(param_1 & 0xffff | uVar3 << 0x10));
...

{
  ...
  InvalidateRect16(0x0,(RECT16 *)(param_1 + 0x22),hwnd);
  return;
}
...

{
  ...
  paVar1 = *(astruct_76 **)(uVar4 + 0xa);
  paVar2 = pass1_1008_9f48(struct_4->pstruct134_0x14);
  pass1_1008_5236(struct_4->field20_0x18);
  pass1_1008_4480(paVar1,(u16 *)(param_1 & 0xffff0000 | ZEXT24(struct_4 + 0x1)),paVar2);
  fn_ptr_1 = (code **)(paVar1 + 0x4);
...

{
  ...
  paVar7 = (astruct_57 *)(paVar7 & 0xffff0000 | puVar13 >> 0x10);
  pvVar2 = (LPVOID)puVar13;
  uVar11 = (structb_param_1 >> 0x10);
  structb_9 = (StructB *)structb_param_1;
  structb_9[0x7].field1_0x2 = pvVar2;
  structb_9[0x7].hwnd_0x6 = (HWND16)(puVar13 >> 0x10);
  mem_op_1000_179c(0x12,paVar7);
  puVar5 = (paVar7 | pvVar2);
  paVar8 = (astruct_57 *)(paVar7 & 0xffff0000 | ZEXT24(puVar5));
  if (puVar5 == NULL) {
    &structb_9[0x7].lpvoid_field_0x8 = 0x0;
  }
  else {
  ...
  pIStack6 = (INT16 *)(uVar9 & 0xffff0000 | (uVar9 + 0xa));
