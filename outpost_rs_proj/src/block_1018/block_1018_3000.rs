...
pub fn pass1_1018_30ca(mut param_1: u16, param_2: *mut astruct_504, param_3: *mut c_char)
...

{
  ...
  if u16_var1 != 0x0 {
    ...
    pstruct57_1 = (astruct_57 *)(pstruct57_1 & 0xffff0000 | (u16_var7 | u16_var4));
    if ((u16_var7 | u16_var4) == 0x0) {
      *param_3 = NULL;
    }
    else {
      *pu32_var8 = 0x0;
    ...
    *pu16_var3 = u16_var5;
    ...
    for (iStack6 = 0x0; i16_var9 < uVar1; iStack6 += 0x1) {
      i16_var6 = i16_var9;
      empty_1008_8fc4();
...

{
  ...
  uVar2 = (param_1 >> 0x10);
  if ((*(i32 *)(param_1 + 0x17e) != 0x0) &&
     (uVar1 = (param_1 + 0x17e), *(i32 *)(uVar1 + 0xa) != 0x0)) {
    return 0x1;
  }
  return 0x0;
}
...

{
  ...
  if (((param_2 | pstruct126_5.field374_0x17e) != 0x0) &&
     (uVar2 = &pstruct126_5.field374_0x17e, iVar4 = (uVar2 + 0xa), iVar4 != 0x0)) {
...

{
  ...
  iVar3 = param_3;
  uVar1 = (iVar3 + 0x122);
  pass1_1008_e852(param_2,uVar1,(uVar1 >> 0x10),*(char **)(iVar3 + 0x126));
  uStack6 = CONCAT22(param_2,param_1);
  uVar1 = (iVar3 + 0x122);
  pass1_1008_e852(param_2,uVar1,(uVar1 >> 0x10),*(char **)(iVar3 + 0x12a));
...

{
  ...
  if (iVar1 == 0x188) {
    ...
    if (iVar1 != 0x18c) {
      load_string_1010_84e0
                (_u16_1050_14cc,(_u16_1050_14cc >> 0x10),0x100,(iVar6 + 0x22),
                 in_buf_len_5);
      return;
    }
    lVar8 = pass1_1008_57f0(uVar7,(iVar6 + 0x130));
  ...
  wsprintf16((WORD *)(iVar6 + 0x22),CONCAT22(uVar9,in_buf_len_5),CONCAT22(uVar10,0x1050),uVar11,pcVar3,
             uVar5,lVar8,uVar4);
  return;
}
...

{
  ...
  uStack4 = (uVar13 >> 0x10);
  uStack6 = uVar13;
  pstruct263_2 = (astruct_263 *)(param_2 >> 0x10);
  ...
  if ((bVar12) || ((bVar12 || plVar1 == uStack4 && (pstruct263_1[0x1].field14_0x14 < uStack6)))) {
    ...
    if (&pstruct263_1[0x1].field_0x10 < uVar3) {
      ...
      pass1_1018_3e8c(pstruct263_1,pstruct263_2,CONCAT22(0x1050,&local_12),
      ...
      *piVar2 = *piVar2 + 0x1;
      ...
      uVar14 = (iVar10 + 0x4);
      uVar5 = (iVar10 + 0x8);
      wsprintf16((WORD *)&pstruct263_1.field_0x22,CONCAT22(0x4165,pstruct263_2),0x50,
                 CONCAT13((char)(uVar5 >> 0x8),CONCAT12((char)uVar5,0x1050)),(char)uVar5,
                 (uVar5 >> 0x10),uVar14,(uVar14 >> 0x10));
      return;
    }
...

{
  ...
  uStack18 = (astruct_203 *)(uStack10 & 0xffff0000 | uVar4);
  switch(uVar4) {
  case 0x0:
    ...
    uVar6 = paVar7 | uVar4;
    if (uVar6 != 0x0) {
      uVar3 = struct_1018_4790(CONCAT22(paVar7,uVar4),&iVar8[0x1].field_0x8,0x0,
                               (lVar9 + 0xe));
  ...
  case 0x1:
    ...
    uVar5 = paVar7 | uVar4;
    if (uVar5 != 0x0) {
      struct_1018_47c8((astruct_203 *)CONCAT22(paVar7,uVar4),&iVar8[0x1].field_0x8,0x0,
                       (uVar6 + 0x12),(uVar6 + 0xe));
  ...
  case 0x2:
    ...
    uVar6 = paVar7 | uVar4;
    if (uVar6 != 0x0) {
      pass1_1018_4808((astruct_203 *)CONCAT22(paVar7,uVar4),&iVar8[0x1].field_0x8,0x0,
                      (lVar9 + 0xe));
  ...
  case 0x3:
    ...
    mem_op_1000_179c(0x14,paVar7);
    if ((paVar7 | uVar4) != 0x0) {
      uStack18 = struct_1018_4842((astruct_203 *)CONCAT22(paVar7,uVar4),&iVar8[0x1].field_0x8,0x0,
                                  (lVar9 + 0xe));
      paStack6 = uStack18;
      goto switchD_1018_393f_caseD_6;
    }
  ...
  case 0x4:
    ...
    mem_op_1000_179c(0x10,paVar7);
    if ((paVar7 | uVar4) != 0x0) {
      uStack18 = struct_1018_48b0((astruct_203 *)CONCAT22(paVar7,uVar4),&iVar8[0x1].field_0x8,0x0,
                                  (lVar9 + 0xe));
      paStack6 = uStack18;
      goto switchD_1018_393f_caseD_6;
    }
  ...
  case 0x5:
    ...
    uVar6 = paVar7 | uVar4;
    if (uVar6 != 0x0) {
      uVar3 = struct_1018_4920((astruct_203 *)CONCAT22(paVar7,uVar4),&iVar8[0x1].field_0x8,0x0,
                               (lVar9 + 0xe));
      uStack18 = (astruct_203 *)CONCAT22(uVar6,uVar3);
      paStack6 = uStack18;
    }
...
switchD_1018_393f_caseD_6:
  ...
  pass1_1008_e852((uStack18 >> 0x10),uVar1,(uVar1 >> 0x10),
                  iVar8.field275_0x126);
  uVar1 = iVar8.field274_0x122;
  paStack14 = uStack18;
  pass1_1008_e852((uStack18 >> 0x10),uVar1,(uVar1 >> 0x10),*(char **)(iVar8 + 0x1));
  pass1_1038_2a0e((astruct_97 *)CONCAT22(0x1050,local_12a),&iVar8[0x1].field9_0xc,paStack6,
                  uStack18,paStack14);
  fn_ptr_1030_835a(_u16_1050_5748,CONCAT22(0x1050,local_12a));
  &iVar8[0x1].field9_0xc = 0x0;
  ppcVar2 = (code **)(param_3 + 0x10);
...
{
  pass1_1008_e320(*(astruct_102 **)(param_1 + 0x122),param_2,param_3);
  return;
}
...
{
  pass1_1008_e3ec(*(astruct_218 **)(param_1 + 0x122),param_2,param_3);
  return;
}
...

{
  ...
  uStack6 = 0x0;
  uStack4 = 0x0;
  pstruct_1_2 = (astruct_263 *)(param_3 >> 0x10);
  ...
  case 0x188:
    if (*(i32 *)&pstruct_1_1.field8_0xa == 0x0) {
      pass1_1008_d3ae((astruct_263 *)(param_3 & 0xffff | ZEXT24(pstruct_1_2) << 0x10));
    }
  ...
  case 0x189:
    if (*(i32 *)&pstruct_1_1.field10_0xe == 0x0) {
      unk_str_op_1008_d4f6((astruct_263 *)(param_3 & 0xffff | ZEXT24(pstruct_1_2) << 0x10),paStack14);
    }
  ...
  case 0x18a:
    if (*(i32 *)&pstruct_1_1.field13_0x12 == 0x0) {
      unk_str_op_1008_d1c6((astruct_263 *)(param_3 & 0xffff | ZEXT24(pstruct_1_2) << 0x10),paStack14);
    }
  ...
  case 0x18b:
    if (pstruct_1_1.field15_0x16 == 0x0) {
      pass1_1008_cfa0((astruct_263 *)(param_3 & 0xffff | ZEXT24(pstruct_1_2) << 0x10),paStack14);
    }
    uStack6 = &pstruct_1_1.field15_0x16;
    uStack4 = (&pstruct_1_1.field15_0x16 + 0x2);
    break;
  case 0x18c:
    if (pstruct_1_1.field16_0x1a == 0x0) {
      pass1_1008_cda2((astruct_263 *)(param_3 & 0xffff | ZEXT24(pstruct_1_2) << 0x10),paStack14);
    }
    uStack6 = &pstruct_1_1.field16_0x1a;
    uStack4 = (&pstruct_1_1.field16_0x1a + 0x2);
    break;
  case 0x18d:
    if (pstruct_1_1.field17_0x1e == 0x0) {
      pass1_1008_cbc4((astruct_263 *)(param_3 & 0xffff | ZEXT24(pstruct_1_2) << 0x10),paStack14);
    }
    uStack6 = &pstruct_1_1.field17_0x1e;
    uStack4 = (&pstruct_1_1.field17_0x1e + 0x2);
  }
...

{
  ...
  uVar5 = (astruct_679 *)(param_1 >> 0x10);
...
LAB_1018_3e3d:
      ...
      if (0x14 < bVar1) {
        if (bVar1 == 0x1e) {
          ...
          if (PTR_LOOP_1050_13ae != &u16_1050_0002 && 0x0 < (PTR_LOOP_1050_13ae + -0x1)) {
...

{
  ...
  if (iVar11 == 0x1) {
    ...
    IVar13 = (INT16)(_u16_1050_14cc >> 0x10);
    if (uVar4 == 0x0) {
