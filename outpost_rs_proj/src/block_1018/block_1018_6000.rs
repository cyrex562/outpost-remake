piVar2: *mut i16;
  ...
  uStack46 = *(u32*)(uVar28 + 0x12);
  uStack48 = 0x14;
  local_32 = 0x0;
  uVar13 = 0x1008;
  pass1_1008_3e38((astruct_19 *)CONCAT22(0x1050,local_38));
  paVar25 = (astruct_57 *)(uVar22 << 0x10);
  while (uVar27 = (paVar25 >> 0x10), &puVar11[-0x6].field_0x4 < (puVar11 + -0x4)) {
    ...
    uVar28 = pass1_1008_4772(*(astruct_76 **)(iVar9 + uVar8));
    puVar7 = (uVar28 >> 0x10);
    ...
    *(u8 **)&puVar11[-0x7].field_0x4 = puVar7;
    ...
    uVar19 = uVar10;
    uVar20 = (u8)(uVar10 >> 0x10);
    uVar21 = (u8)(uVar10 >> 0x18);
    ...
    *piVar2 = *piVar2 + (-(&puVar11[-0x6].field_0x4 == 0x0) & 0x5) + 0x14 + (uVar2_01 + 0x4);
  ...
  *(HGDIOBJ16 *)&puVar11[-0x7].field6_0x6 = hgdiobj16_var7;
  ...
  EndPaint16((PAINTSTRUCT16 *)CONCAT22(0x1050,(&puVar11[-0x4].field6_0x6 + 0x2)),
             *(HWND16 *)(uVar15 + 0x4));
  return;
}
...

{
  ...
  if (param_1 != NULL) {
    for (iStack12 = 0x0; iStack10 = (param_1 >> 0x10), uStack8 = SUB42(param_1,0x0), iStack12 < 0x9;
        iStack12 += 0x1) {
      ...
      set_window_text_1018_6066
                ((astruct_937 *)uVar2,(uVar2 >> 0x10),CONCAT22(uStack8,iStack10),dialog_id_5);
      uVar3 = str_op_1000_3da4(CONCAT22(uStack8,iStack10));
      param_1 = (param_1 & 0xffff | (iStack10 + uVar3 + 0x1) << 0x10);
    }
  }
  return;
}
...
StructD * pass1_1018_669a(StructD *param_1,param_2: u8)
...
pub fn window_op_1018_67b6(StructD *param_1,param_2: *mut StructA)

{
  ...
  paVar1 = (astruct_666 *)(param_1 >> 0x10);
...
StructD * pass1_1018_684c(StructD *param_1,param_2: u8)
...
StructD * FUN_1018_685a(mut param_1: u16 ,StructD *param_2,param_3: u8)
...
StructD * pass1_1018_69dc(StructD *param_1,param_2: u8)
...

{
  ...
  paVar3 = (astruct_57 *)CONCAT22(in_register_0000000a,param_1);
  uVar1 = (param_3 >> 0x10);
  BeginPaint16((PAINTSTRUCT16 *)CONCAT22(0x1050,&local_22),*(HWND16 *)(param_3 + 0x8));
  EndPaint16((PAINTSTRUCT16 *)CONCAT22(0x1050,&local_22),*(HWND16 *)(param_3 + 0x8));
...
pub fn pass1_1018_6c1e(StructD *param_1,param_2: u8)
