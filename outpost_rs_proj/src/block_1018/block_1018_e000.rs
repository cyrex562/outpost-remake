...
pub fn pass1_1018_e01c(StructD *param_1,param_2: u8)

{
  ...
  pass1_1008_57c4((StructD *)(param_1 & 0xffff0000 | ZEXT24(iVar1)));
  uVar1 = (param_1 >> 0x10);
...

{
  ...
  *param_2 = 0xe228;
  ...
  puVar2 = mixed_1010_20ba((astruct_57 *)CONCAT22(in_register_0000000a,param_1),_u16_1050_0ed0,
                           (u8 **)CONCAT22((in_stack_0000ffec >> 0x10),0x36),in_stack_0000fe96,
...
StructD * pass1_1018_e1ee(StructD *param_1,param_2: u8)
...

{
  ...
  if (iVar7->field235_0xee != NULL) {
    ppcVar2 = (code **)(*iVar7->field235_0xee + 0x8);
    (**ppcVar2)();
  }
  if (iVar7->field233_0xea == 0x0) {
    ...
    ppcVar2 = (code **)(*uStack10 + 0xc);
    (**ppcVar2)(0x8,uStack10,uStack10,0x5);
  }
  return;
}
pub fn window_op_1018_e384(param_1: *mut astruct_659,param_2: *mut astruct_57,param_3: *mut StructA)

{
  ...
  if (uVar1 != 0x0) {
    pass1_1018_e4f2(param_1,(astruct_57 *)(param_2 & 0xffff | struct_1->field4_0x8 << 0x10));
    struct_1[0x1].field78_0x60 = param_1;
    struct_1[0x1].field79_0x62 = uVar1;
    return;
  }
  &struct_1[0x1].field78_0x60 = 0x0;
  return;
}
...
StructD * pass1_1018_e41a(StructD *param_1,param_2: u8)
...

{
  ...
  set_struct_op_1020_921c
            (in_EDX,(StructA *)CONCAT22(uVar6,param_1),(param_2 >> 0x10),in_stack_0000ffca);
  &param_1->field16_0x14 = 0x0;
...
StructD * pass1_1018_e5aa(StructD *param_1,param_2: u8)
...
pub fn window_op_1018_e6c6(param_1: *mut astruct_666,mut param_2: u16 ,param_3: *mut StructA)
...
StructD * pass1_1018_e75c(StructD *param_1,param_2: u8)
...
StructD * FUN_1018_e76a(mut param_1: u16 ,StructD *param_2,param_3: u8)
...
// WARNING: Globals starting with '_' overlap smaller symbols at the same address
pub fn pass1_1018_e834(param_1: *mut StructA,mut param_2: u16 ,param_3: *mut astruct_57)

{
  ...
  (**ppcVar1)();
  (param_1 + 0x12) = iVar4;
  draw_op_1020_9364((StructA *)(param_1 & 0xffff | param_1 << 0x10));
  return;
}
...
StructD * pass1_1018_e8ec(StructD *param_1,param_2: u8)
...

{
  ...
  &iVar7[0x1].field5_0xc = 0x0;
  iVar7[0x1].field7_0x10 = NULL;
  &iVar7[0x1].field8_0x14 = 0x0;
  ...
  puVar6 = mixed_1010_20ba((astruct_57 *)(paVar5 & 0xffff0000 | puVar6 >> 0x10),_u16_1050_0ed0,
  ...
  iVar7[0x1].field9_0x16 = (astruct_19 *)(puVar6 >> 0x10);
  if (param_2 == NULL) {
    paVar3 = NULL;
    uVar4 = 0x0;
  }
  ...
  ppcVar2 = (code **)(*(u32*)&iVar7[0x1].field8_0x14 + 0x4);
...
pub fn window_op_1018_eada(param_1: *mut astruct_661,param_2: *mut astruct_57,param_3: *mut StructA)
...

{
  ...
  if (*(i32 *)(iVar6 + 0xf6) != 0x0) {
    ...
    pass1_1010_1ea6((iVar6 + 0xf6),(StructD *)CONCAT22(uVar5,iVar4));
  }
  destroy_win_1008_628e(param_1);
  return;
}
...
StructD * pass1_1018_eb9c(StructD *param_1,param_2: u8)
...
StructD * FUN_1018_ebaa(mut param_1: u16 ,StructD *param_2,param_3: u8)
...

{
  ...
  paVar6 = (astruct_57 *)CONCAT22(in_register_0000000a,(puVar8 >> 0x10));
  &param_2->field28_0x24 = 0x0;
  ...
  ppcVar2 = (code **)(*param_2->field15_0x14 + 0x4);
  paVar13 = param_2;
  iVar14 = param_3;
  (**ppcVar2)();
  param_2->field5_0x6 = param_2->field15_0x14;
  puVar1 = param_2->field15_0x14;
  pass1_1010_2b50(puVar1,(puVar1 >> 0x10),(u16 *)CONCAT22(param_3,&param_2->field_0x18));
  ...
  pass1_1008_3f62((u16 *)CONCAT22(param_3,&param_2->field_0x1e),
                  (u16 *)(puVar9 & 0xffff0000 | (puVar9 + 0xe)));
...

{
  ...
  pass1_1008_3e94((u16 *)(param_1 & 0xffff0000 | (iVar1 + 0x18)),(u16 *)CONCAT22(0x1050,&local_6),
