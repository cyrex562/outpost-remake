...

{
  ...
  do {
    ...
    uVar2 = in_EDX;
    in_EDX = (astruct_57 *)((u32)in_EDX & 0xffff0000 | (u32)(uVar2 | pchar_1));
  ...
  if (param_1 == 0x0) {
    ...
    if (BVar2 != 0x0) {
      for (paStack8 = NULL; iVar6 = (astruct_228 *)param_3, paStack8 < local_6;
        ...
        paVar6 = (astruct_57 *)((u32)paVar6 & 0xffff0000 | (u32)(uVar5 | uVar4));
        if ((uVar5 | uVar4) == 0x0) {
          puStack22 = NULL;
        }
        else {
...

{
  ...
  do {
    do {
      ...
      param_3 = (astruct_57 *)((u32)param_3 & 0xffff0000 | (u32)(uVar8 | paVar4));
...
void pass1_1010_1656(u16 param_1,u8 *param_2,u16 param_3,astruct_27 *param_4,u16 param_5,u32 param_6)
...
u8 pass1_1010_1a66(u32 param_1,astruct_15 *param_2)
...

{
  ...
  if ((param_2 != NULL) &&
     (ppcVar5 = (code **)((int)(u32)param_1 + 0x24), (**ppcVar5)(CS_REG,param_1,param_2), uVar8 != 0x0)) {
    ppcVar5 = (code **)((int)(u32)param_2 + 0x4);
    (**ppcVar5)(CS_REG,param_2);
...

{
  ...
  puVar3 = (u32 *)FUN_1010_830a(puVar3,uVar5,CS_REG,_u16_1050_14cc,iVar4->field18_0x14);
...

{
  ...
  param_2->segment_0x2 = 0x1010;
  IVar1 = FUN_1010_830a((int)paVar4,uVar2,CS_REG,_u16_1050_14cc,0x99);
...

{
  ...
  param_2->segment_0x2 = 0x1010;
  IVar1 = FUN_1010_830a(0x0,paVar2,CS_REG,_u16_1050_14cc,0x1b3);
  ...
  if (**(i32 **)&pstructd_1->field11_0x12 != 0x0) {
    ...
    while( true ) {
      ...
      if ((uVar1 | puVar2) != 0x0) {
        ...
        (**fn_ptr_1)(CS_REG,puVar2,uVar1,0x1);
      }
      iStack4 += 0x1;
    }
  }
  ...
  if ((uVar4 | (iVar5 + 0x12)) != 0x0) {
    if (param_2 == 0x0) {
      ...
      if ((iVar6 == 0x5) || (iVar6 == 0x6)) {
        ...
        uVar3 = FUN_1010_830a((int)uVar2,uVar4,CS_REG,_u16_1050_14cc,0x1bf);
        uVar2 = (u32)(u32)(iVar5 + 0x12);
...
void struct_1010_4d5c(u8 *param_1,astruct_245 *param_2,u16 param_3,u16 param_4,u16 param_5,u16 param_6,i16 param_7)
...

{
  ...
  puVar4 = (u32 *)FUN_1010_830a(puVar4,uVar5,CS_REG,_u16_1050_14cc,0x1b3);
...
void pass1_1010_519a(u8 *param_1,u32 param_2,char *param_3)

{
  ...
  while( true ) {
    ...
    paVar4 = &local_18;
    pass1_1028_e4ec((astruct_92 *)CONCAT22(0x1050,paVar4));
    paVar6 = (astruct_57 *)(u32)(uVar5 | paVar4);
...
void pass1_1010_52fc(u16 param_1,u8 *param_2,u32 param_3,u32 param_4)
...
void pass1_1010_531c(u16 param_1,u8 *param_2,u32 param_3,u32 param_4)
...
void pass1_1010_533c(u8 *param_1,u32 param_2,char *param_3)
...

{
  ...
  paVar13 = (astruct_57 *)((u32)paVar13 & 0xffff0000 | (u32)(uVar6 | uVar4));
  if ((uVar6 | uVar4) != 0x0) {
    *puStack50 = 0x389a;
    uVar4->field2_0x2 = 0x1008;
...
void pass1_1010_5d9c(u8 *param_1,u32 param_2,i16 param_3)
...
void pass1_1010_68c6(u16 param_1,u8 *param_2,u32 param_3,u32 param_4)
...
LAB_1010_73fe:
  ...
  case 0xa:
    mem_op_1000_179c(0x94,param_1);
    paVar10 = (astruct_57 *)((u32)param_1 & 0xffff0000);
    if (((astruct_57 *)param_1 | paVar5) == 0x0) goto LAB_1010_73fe;
    uVar12 = SUB42(&u16_1050_1038,0x0);
    puVar14 = pass1_1038_9a1e(paVar5,(astruct_57 *)param_1,uStack6,CONCAT22(paVar11->field7_0xe,uStack6));
    paVar10 = (astruct_57 *)((u32)paVar10 & 0xffff0000 | (u32)puVar14 >> 0x10);
    paVar5 = (astruct_57 *)puVar14;
    break;
  case 0xb:
    ...
    if (((astruct_57 *)param_1 | paVar5) == 0x0) goto LAB_1010_73fe;
    uVar12 = SUB42(&u16_1050_1038,0x0);
    uVar15 = pass1_1038_9b72(paVar5,(astruct_57 *)param_1,uStack6,CONCAT22(paVar11->field7_0xe,uStack6));
  ...
  case 0xc:
    ...
    if (uVar8 == 0x0) goto LAB_1010_73fe;
    uVar12 = SUB42(&PTR_LOOP_1050_1040,0x0);
    pass1_1040_6826((astruct_57 *)CONCAT22(param_1,paVar5),paVar11->field7_0xe);
    break;
  case 0xd:
    mem_op_1000_179c(0x9c,param_1);
    uVar8 = param_1 | paVar5;
    ...
    if (uVar8 == 0x0) goto LAB_1010_73fe;
    uVar12 = SUB42(&PTR_LOOP_1050_1040,0x0);
    pass1_1040_6fb6((astruct_57 *)CONCAT22(param_1,paVar5),paVar11->field7_0xe);
    break;
  case 0x12:
    mem_op_1000_179c(0x94,param_1);
  ...
  case 0x14:
    ...
    uVar12 = SUB42(&PTR_LOOP_1050_1040,0x0);
    pass1_1040_0e1c(pSVar7,(astruct_57 *)CONCAT22(param_1,paVar5),0x1,uStack6,paVar11->field7_0xe);
    break;
  case 0x15:
    mem_op_1000_179c(0x9c,param_1);
    uVar8 = param_1 | paVar5;
...
void pass1_1010_8018(u8 *param_1,u32 param_2,u16 param_3)
...

{
  ...
  if (((u8 *)pcVar5 == local_106) && (uVar2 == &DAT_1050_1050)) {
...

{
  ...
  if ((iVar6 + 0x10) == 0x1) {
    ...
    if (uVar4 == 0x0) {
      ...
      paVar3 = &local_2e;
      struct_op_1008_3f92((astruct_76 *)CONCAT22(paVar5,puVar2),(char *)CONCAT22(unaff_SS,paVar3));
    }
...
void pass1_1010_86de(u16 param_1,u16 param_2,u8 param_3,astruct_76 *param_4)
...

{
  ...
  paVar3 = (astruct_57 *)(in_EDX & 0xffff0000 | (u32)(puVar2 | uVar4));
  if ((puVar2 | uVar4) != 0x0) {
...

{
  ...
  if (*(i32 *)((int)param_1 + 0x67c) != 0x0) {
    ...
    if (uVar4 == 0x0) {
      ...
      struct_op_1008_6604((astruct_76 *)CONCAT22(paVar5,uVar1),(int)uStack24,
...

{
  ...
  if (((param_1 + 0x67e) | (param_1 + 0x67c)) != 0x0) {
    for (uStack8 = 0x1; puVar3 = (u8 *)paVar5, (int)uStack8 < 0xa; uStack8 += 0x1) {
      ...
      pass1_1010_86de(param_1,param_2,(u8)param_3,(astruct_76 *)CONCAT22(puVar3,uVar1));
...
u32 unk_load_str_op_1010_8c96(u8 *param_1,u32 param_2,u32 param_3,u32 param_4)
...
void pass1_1010_9130(u16 param_1,u16 param_2,u32 param_3,u8 *param_4)
...
void pass1_1010_9304(u16 param_1,u8 *param_2,u16 param_3,u16 param_4,i16 param_5)
...
void pass1_1010_abd2(u8 *param_1,u16 param_2,u16 param_3,i16 param_4)
...

{
  ...
  pass1_1038_4e78(puVar4,(astruct_57 *)(uVar3 & 0xffff0000 | (u32)puVar4 >> 0x10),
...
void pass1_1010_bf1e(i16 param_1,u8 *param_2,u32 param_3,i16 *param_4)
...
void pass1_1010_c3c2(u8 *param_1,u16 param_2,u16 param_3,u32 param_4,u32 param_5)
...

{
  ...
  paVar4 = (astruct_57 *)((u32)paVar6 & 0xffff0000 | (u32)(uVar2 | pstructd_1_lo));
...
void pass1_1010_d24a(u8 param_1,u16 param_2,u32 param_3,u32 param_4,astruct_104 *param_5)
...
void pass1_1010_d448(u16 param_1,u16 param_2,u8 *param_3,u32 param_4,astruct_104 *param_5,i16 param_6
                    )
...
void pass1_1010_d5ae(u16 param_1,u16 param_2,u8 *param_3,u32 param_4,astruct_104 *param_5,i16 param_6
                    )
...
void pass1_1010_d710(u8 param_1,u16 param_2,u32 param_3,u32 param_4,astruct_104 *param_5)
...

{
  ...
  for (uStack18 = 0x0; uStack18 < uStack14; uStack18 += 0x1) {
    ...
    uVar4 = uStack14;
    (**ppcVar1)(CS_REG,param_1,param_2,(char)uStack18,(int)(uStack18 >> 0x10));
    uVar3 = uVar4;
    uVar5 = DX_REG_00;
  ...
  if (puStack10 != NULL) {
    ...
    (**ppcVar1)(CS_REG,param_1,(char)param_2,0x1,uVar6,uVar7);
  }
  return;
}
