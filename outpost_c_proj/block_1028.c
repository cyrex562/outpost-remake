...

{
  ...
  iVar2 = pass1_1028_1024(CONCAT11(AH_REG,bVar1),param_1,(astruct_15 *)param_2);
  return iVar2 * 0xf;
}
...

{
  ...
  while( true ) {
    ...
    puVar3 = local_a;
    uVar5 = DX_REG_00;
    pass1_1030_bd74(puVar3,&DAT_1050_1050,CONCAT22(DX_REG_00,uVar2),paVar7);
...
LAB_1028_72d3:
  ...
  if (uVar7 != 0x0) {
    ...
    pass1_1008_df4a(paVar12,DI_REG,&DAT_1050_1050);
    paVar13 = (astruct_679 *)
...
u16 pass1_1028_74e4(u8 param_1,astruct_57 *param_2,u32 param_3)
...
LAB_1028_77e7:
    ...
    uVar7 = DX_REG_00;
    pass1_1030_bd74(puVar4,&DAT_1050_1050,CONCAT22(DX_REG_00,uVar5),paVar2);
...

{
  ...
  if (_PTR_LOOP_1050_5166 != NULL) {
    ...
    (**ppcVar4)(CS_REG,(int)_PTR_LOOP_1050_5166);
  }
  ...
  if ((uVar1 | puVar3) != 0x0) {
    ppcVar4 = (code **)*puVar3;
    (**ppcVar4)(CS_REG,puVar3,uVar1,0x1);
  }
...

{
  ...
  *param_1 = *param_1 + 0x1;
  if (param_2 != 0x0) {
    pass1_1028_e28a(puVar1,DI_REG,&DAT_1050_1050);
  }
  return;
}
    ...
    case (u16 *)0xb:
      if (puVar16 < (u16 *)((int)&PTR_LOOP_1050_000e + 0x1)) {
        ...
        *piVar2 = *piVar2 + (-0x6600 - ((char)(cVar4 << 0x5) < '\0'));
        ...
        uVar39 = 0x7af0;
        pass1_1028_780c(uVar21,DI_REG,CONCAT22(in_stack_0000ffcc,in_stack_0000ffca));
