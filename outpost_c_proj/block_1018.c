...

{
  ...
  *(u32 *)((int)param_1 + 0x3c) = param_2;
  ...
  uVar8 = pass1_1010_ec18((int)param_2,param_2,(u16)uVar1,(u16)((u32)uVar1 >> 0x10),
...

{
  ...
  if (uVar3 == 0x0) {
    ...
    pass1_1008_87cc((astruct_86 *)CONCAT22((u16)param_2,uVar1),param_5,(int)param_6,param_6,
