...
use crate::structs::prog_structs_24::Struct129;
use crate::structs::prog_structs_30::{Struct14, Struct417};
...
pub unsafe fn begin_end_Paint_1018_6a7a(ctx: &mut AppContext, param_1: &mut Struct129) {
    ...
    ppVar2 = process_struct_1010_20ba(ctx.g_struct_var_1050_0ed0, CONCAT22(HVar3, 2));
    if ((ppVar2 + 0x20) == 0) {
