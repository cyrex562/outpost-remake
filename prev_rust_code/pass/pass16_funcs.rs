...
pub fn pass1_1028_8d9e(param_1: &mut  Struct500, param_2: u32, param_3: u32, param_4: u32) {
  ...
  // u_var1 = (param_1  >> 0x10);
    ...
    local_bx_19.field_0x114 = 0;
    param_1.a = 0x8fb0;
    local_bx_19.field_0x2 = &ctx.PTR_LOOP_1050_1028;
    return;
}
...
pub fn pass1_1028_84ca(
  ...
  // pcVar3 = (param_1  >> 0x10);
    ...
    param_1.a = 0x8688;
    (i_var2 + 2) = &ctx.PTR_LOOP_1050_1028;
    if ((i_var2 + 0x108) == 1) {
...
pub fn pass1_1028_7742(param_1: u16, param_2: u16, param_1_00: i32, param_2_00: &mut Struct44) {
  ...
  // local_8 = (paVar9  >> 0x10);
    ...
    u_var3 = u_var4;
    u_var13 = ctx.dx_reg;
    (**pp_var1)(&ctx.PTR_LOOP_1050_1038, u_var4, ctx.dx_reg);
            ...
            if (u_var10 == 0) {
                ...
                while (true) {
                    ...
                    if ((pu_var4 + 0x100) != 0x8000002) {
                        ...
                        (**ppc_var3)(&ctx.PTR_LOOP_1050_1038, u_var5, u_var10);
            ...
            if (u_var10 == 0) {
                ...
                while (true) {
                    ...
                    if ((pu_var4 + 0x100) != 0x8000002) {
                        ...
                        ppc_var3 = (*_local_2e + 0x10);
                        (**ppc_var3)(&ctx.PTR_LOOP_1050_1038, u_var5, u_var9);
        ...
        if (u_var8 == 0) {
            ...
            while (true) {
                ...
                if ((pu_var2 + 0x100) != 0x8000002) {
                    ...
                    (**pp_var1)(&ctx.PTR_LOOP_1050_1038, u_var3, u_var7);
...
pub fn pass1_1028_740c(param_1: u16, param_2: u16, param_3: u16, param_2_00: u32) {
    ...
    if (_local_a != 0x0) {
        pp_var1 = u_var2;
        (**pp_var1)(&ctx.PTR_LOOP_1050_1038, u_var3, ctx.dx_reg, 1);
    }
    if (_local_e != 0) {
        return;
    }
...
pub fn pass1_1028_6926(param_1: u32) {
  ...
  // paVar4 = pass4_funcs::pass1_1028_e1ec(ctx._PTR_LOOP_1050_65e2, u_var2, (u_var2  >> 0x10));
    ...
    u_var7 = u_var5;
    (**ppc_var3)(&ctx.PTR_LOOP_1050_1038, u_var5, ctx.dx_reg);
...
pub fn pass1_1028_69cc(param_1: &mut  Struct788) {
    ...
    if ((in_d_x | local_a_x__1) != 0) {
      ...
      // u_var6 = (param_1  >> 0x10);
        ...
        *_local_a = 0x6ad2;
        local_a_x__1.field_0x2 = &ctx.PTR_LOOP_1050_1028;
...
pub fn pass1_1028_6064(param_1: u32, param_2: u8) {
    ...
    pc_var1 = (&ctx.PTR_LOOP_1050_1028 + unaff_DI);
    cVar6 = (in_bx >> 8);
    unsafe {
        if (*pc_var1 != cVar6 && cVar6 <= *pc_var1) {
            ...
            *pc_var1 = *pc_var1 + u8_var4;
            LOCK();
            pc_var1 = (CONCAT11(*(&ctx.PTR_LOOP_1050_1028 + unaff_si) + '\x10', 0x28) + unaff_si);
            *pc_var1 = *pc_var1 - b_var5;
            return CONCAT22(
                in_dx,
...
pub fn pass1_1028_4faa(ctx: &mut AppContext, param_1: &mut Struct44) {
    ...
    u_var6 = pass1_1030_627e(ctx._PTR_LOOP_1050_5740, CONCAT22(unaff_ss, &local_c), u_var5);
  // u_var4 = (u_var6  >> 0x10);
