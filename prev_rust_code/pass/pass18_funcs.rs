...
use crate::struct_ops::struct_ops_2::{process_struct_1000_179c, struct_fn_1000_160a};
use crate::structs::prog_structs_1::{Struct1065, Struct1067, Struct393};
use crate::structs::prog_structs_14::Struct1036;
use crate::structs::prog_structs_16::{Struct1010, Struct493, Struct982};
use crate::structs::prog_structs_17::Struct983;
use crate::structs::prog_structs_19::{Struct1050, Struct500};
use crate::structs::prog_structs_21::{Struct1060, Struct1078};
use crate::structs::prog_structs_22::Struct922;
use crate::structs::prog_structs_24::{Struct1068, Struct2111};
use crate::structs::prog_structs_25::Struct1021;
use crate::structs::prog_structs_26::Struct1052;
use crate::structs::prog_structs_27::{pass1_struct_2, Struct1082, Struct1083};
use crate::structs::prog_structs_28::{Struct1008, Struct1009, Struct1012, Struct1013, Struct1014, Struct1015, Struct1017, Struct1018, Struct1045, Struct1058, Struct1059, Struct1061, Struct1062, Struct1063, Struct1064, Struct1066, Struct1069, Struct1070, Struct1076, Struct1077, Struct1079, Struct1080, Struct1081, Struct918};
use crate::structs::prog_structs_29::{Struct763, Struct764, Struct990};
use crate::structs::prog_structs_2::Struct199;
use crate::structs::prog_structs_31::Struct981;
...
pub unsafe fn pass1_1038_2c82(
  ...
  // u_var15 = (param_1_00  >> 0x10);
    ...
    if (i_var9 == 2) {
        ...
        local_16 = (local_e + 8);
        while (local_16 = local_16 - 1, (local_16 | local_16) != 0) {
            pass1_1020_a6ee(
        ...
        if (i_var9 == 4) {
            ...
            if ((local_6 == (&ctx.PTR_LOOP_1050_0000 + 1)) && ((local_6 & 0xff0000) == 0)) {
                ...
                if (ctx.g_struct_ptr_1 == 0) {
                    g_struct_ptr_1 = local_6;
                    struct_fn_1000_160a();
                } else {
                }
                alloc_mem_1000_1708(0x6c, 0, 1, g_struct_ptr_1, ctx.g_u16_ptr_1050_5f2e);
                local_bx_35.field_0x10 = g_struct_ptr_1;
...
pub unsafe fn pass1_1038_2f92(param_1: u16, param_2: u16, param_3: u16, param_2_00: u32) {
    ...
    u_var6 = (param_2_00 + 0x200);
    i_var3 = (param_1_00 + 0xc);
    if (i_var3 == 1) {
        u_var7 = (param_1_00 + 8);
        pass6_funcs::pass1_1038_3cc0(
            CONCAT22(in_stack_0000000e, param_2_00),
            u_var7,
            (u_var7 >> 0x10),
            (param_1_00 + 0xe),
        );
    ...
    if (i_var3 == 4) {
        pass1_1030_355c((param_2_00 + 0x1f6), (param_1_00 + 0x10));
        return;
    }
    if (i_var3 == 5) {
...
pub unsafe fn pass1_1038_30aa(param_1: &mut  Struct393) {
  ...
  // u_var4 = (param_1  >> 0x10);
    ...
    local_bx_19.field_0x2 = &ctx.PTR_LOOP_1050_1038;
...
pub unsafe fn pass1_1038_2a0e(
  ...
  // local_es_19 = (param_1  >> 0x10);
    ...
    param_1.a = 0x309a;
    local_bx_19.b = &ctx.PTR_LOOP_1050_1038;
    return;
}
  ...
  // u_var12 = (param_1  >> 0x10);
    ...
    loop {
        ...
        if ((local_10 | u_var11) != 0) {
            ...
            pp_var1 = (param_2 + 4);
            local_22 = u_var8;
            (**pp_var1)(&ctx.PTR_LOOP_1050_1028, param_2, local_16, (local_16 >> 0x10));
            local_26 = u_var8;
            local_24 = u_var7;
            ...
            while (local_3a < local_38) {
                ...
                if (((local_46 != 0) && (0xd < local_42)) && (local_42 < 0x1d)) {
                    ...
                    u_var11 = u_var8;
                    if ((local_a <= local_46)
                        && (local_a < local_46 || (local_a < u_var11)))
                    {
                        u_var11 = local_a;
                        local_46 = local_a;
                    }
                    local_4a = CONCAT22(local_46, u_var11);
                    local_22 = CONCAT22(
                        local_22 + (-(local_22 < u_var11) - local_46),
                        local_22 - u_var11,
                    );
                    local_a = CONCAT22(
                        local_a + (-(local_a < u_var11) - local_46),
                        local_a - u_var11,
                    );
                    pa_var10 = local_46;
                    if (local_36 == 0) {
                        paVar9 = local_46;
                        u_var6 = u_var11;
                        process_struct_1000_179c(10, local_46);
                    ...
                    loop {
                      ...
                      // u_var4 = (u_var1  >> 0x10);
                        ...
                        if ((u_var12 | u_var9) != 0) {
                            u_var14 = u_var12;
                            if ((local_2a <= u_var12)
                                && (local_2a < u_var12 || (local_2a < u_var9)))
                            {
                                u_var14 = local_2a;
                                u_var9 = local_2a;
                            }
                            if ((local_a <= u_var14)
                                && (local_a < u_var14 || (local_a < u_var9)))
                            {
                                u_var14 = local_a;
                                u_var9 = local_a;
                            }
                            ...
                            local_2a = CONCAT22(
                                (local_2a - struct_a) - (local_2a < u_var9),
                                local_2a - u_var9,
                            );
                            local_a = CONCAT22(
                                (local_a - struct_a) - (local_a < u_var9),
                                local_a - u_var9,
                            );
                            u_var13 = u_var14;
                            if (_local_32 == 0) {
...
pub unsafe fn pass1_1038_1d68(ctx: &mut AppContext, param_1: u16, param_2: u16, param_1_00: &mut  u32, param_2_00: u32) {
    let pu_var1: &mut  u16;
    let mut u_var2: u16;
    let mut u_var3: u16;
    let mut u_var4: i32;
    ...
    pu_var15 = param_1_00;
    (**ppcVar5)();
    _local_c = CONCAT22(ctx.edx, in_ax);
    local_10 = 0;
    loop {
        if _local_c <= local_10 {
            return;
              ...
              // u_var11 = _local_24  >> 0x10;
                ...
                loop {
                    ...
                    if (((0 < temp_5f69f6c76a) && (!SBORROW2(temp_5f69f6c76a, 1)))
                        && (temp_5f69f6c76a == (&ctx.PTR_DAT_0005_0000_1050_0004 + 1)
                            || (temp_5f69f6c76a + -1) < 4
                            || (temp_5f69f6c76a == &ctx.BYTE_1050_0008)))
                    {
                        bVar9 = true;
                    }
                    if bVar9 {
...
pub unsafe fn pass1_1038_201a(param_1: u16, param_2: u16, param_1_00: &mut  Struct918) {
  ...
  // pu_var7 = (u_var13  >> 0x10);
    ...
    // LAB_1038_2102:
    if (_local_14 != 0) {
        pass1_1038_7a5a(ctx._PTR_LOOP_1050_5a64);
        u_var16 = 0x1030;
  ...
  // u_var12 = (param_1_00  >> 0x10);
    ...
    loop {
        ...
        if ((u_var9 + 10) == 0) {
            ...
            _local_22 = local_18 | local_c << 0x10;
            u_var10 = local_18 | local_c << 0x10;
  ...
  // u_var6 = (param_1_00  >> 0x10);
    ...
    while (u_var2 = local_12, local_1e < local_12) {
        ...
        if (local_18 != 0) {
            ...
            u_var4 = u_var2;
            u_var2 = u_var2 & 0xffff | local_10 << 0x10;
            iVar1 = (local_18 - local_10) - (local_18 < u_var4);
            ...
            pass1_1020_bb70(_local_1c, u_var4, CONCAT22(local_14, local_10));
  ...
  // u_var6 = (param_1_00  >> 0x10);
    ...
    while {
        ...
        if (paVar4 != 0x0) {
            paVar4 = pa_var5;
            u_var2 = u_var1;
            if ((local_10 <= pa_var5) && (local_10 < pa_var5 || (local_10 < u_var1))) {
                paVar4 = local_10;
                u_var2 = local_10;
            }
...
pub unsafe fn pass1_1038_290e() {
    ...
    pass6_funcs::pass1_1038_7a76(ctx._PTR_LOOP_1050_5a64);
    return 1;
}
...
pub unsafe fn pass1_1038_05d8(param_1: u16, param_2: u16, param_1_00: i32, param_2_00: u32) {
    ...
    local_a = u_var2 & 0xffff | local_1e << 0x10;
    // LAB_1038_0841:
    if (local_c != 0) {
...
pub unsafe fn pass1_1038_08d4(param_1: u16, param_2: u32, param_3: u32) {
    ...
    if (local_4 != 0) {
        if (param_2 < 0xc90000) {
            pass1_1038_0340(param_1, param_2, param_2, param_3);
            return;
        }
        if (0x31fffff < param_2) {
            pass1_1038_05d8(param_1, param_2, param_2, param_3);
        }
    }
    return;
}
...
pub unsafe fn pass1_1030_ecf8(param_1: u32) {
    ...
    local_c = 0;
    ppVar15 = process_struct_1010_20ba(ctx.g_struct_var_1050_0ed0, CONCAT22(local_68, 0x2f));
  // local_4 = (ppVar15  >> 0x10);
    ...
    ppVar15 = process_struct_1010_20ba(ctx.g_struct_var_1050_0ed0, CONCAT22(local_68, 2));
  // local_e = (ppVar15  >> 0x10);
    ...
    loop {
            ...
            ))
        {
            ...
            pu_var16 = pu_var3;
            (**ppcVar4)(&ctx.PTR_LOOP_1050_1028, pu_var3, &local_AX_122.field_0xe);
            ...
            while (local_40 < u_var6) {
                ...
                if (u_var11 != 0) {
                    u_var13 = SUB42(&ctx.PTR_LOOP_1050_1028, 0);
                  ...
                  // u_var12 = (pu_var16  >> 0x10);
                    ...
                    if (((u_var12 | u_var11) != 0) && ((u_var11 + 0x12) == 5)) {
                        ...
                        (**ppcVar4)(&ctx.PTR_LOOP_1050_1028, u_var11, u_var12);
                        if (u_var11 < 0) {
      ...
      // u_var3 = (pu_var4  >> 0x10);
        ...
        if ((pu_var4 + 0x12) == 5) {
                    ...
                    || (0x2b < iVar1 + -0x34 && (iVar1 + -0x60 < 2))))
            {
                ...
                ppc_var2(&ctx.PTR_LOOP_1050_1028);
            }
        }
    }
    return 1;
...
pub unsafe fn pass1_1030_e0d4() {
    ...
    pp_var9 = process_struct_1010_20ba(ctx.g_struct_var_1050_0ed0, CONCAT22(unaff_si, 0x40));
        ...
        if (((local_a + 0x212) | local_e) != 0) {
          // u_var8 = (u_var1  >> 0x10);
            ...
            if (u_var5 != 0) {
                local_18._0_2_ = 1;
                local_18 = 0;
                while (CONCAT22(local_18, local_18) < u_var2) {
                    u_var7 = u_var2;
                    u_var9 = u_var5;
...
pub unsafe fn pass1_1030_da22(param_1: &mut Struct44) {
  ...
  // u_var4 = (u_var9  >> 0x10);
    ...
    ppc_var2 = (*pu_var1 + 0x10);
    pu_var7 = pu_var1;
    ppc_var2(&ctx.PTR_LOOP_1050_1028, pu_var1, (u_var9 + 0xe));
    u_var3 = pu_var7 & 0xffff | ctx.dx_reg << 0x10;
    local_12 = 0;
    loop {
        if (u_var3 <= local_12) {
