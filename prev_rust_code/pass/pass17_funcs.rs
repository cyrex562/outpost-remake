...
use crate::string_ops::misc::{fn_1008_6048, string_fn_1000_3f9c, pass1_1030_4594, wvsprintf_FUN_1030_840a, load_string_1010_847e, pass1_1030_4dbc, pass1_1030_521c};
use crate::struct_ops::struct_ops_2::{pass1_1030_3af6, pass1_1030_4574, pass1_1030_8c66, pass1_1038_78e2, process_struct_1000_179c, process_struct_1008_4772, process_struct_1008_574a, set_struct_field_1018_04ca, struct_fn_1000_160a, process_struct_1010_20ba};
...
pub unsafe fn pass1_1030_7c28(param_1: &String, param_2: u16) {
...
pub unsafe fn pass1_1030_7f5a(param_1: &mut Struct493) {
    let mut u_var1: i32;
    let mut u_var2: u32;
    let mut local_6: u16;
    let mut local_4: u16;
...
pub unsafe fn pass1_1030_8210(param_1: &mut  u32) {
  ...
  // u_var5 = (param_1  >> 0x10);
    ...
    if (ctx._PTR_LOOP_1050_5736 != 0x0) {
        pass1_1030_5c0e();
        error_check_1000_17ce(paVar3);
    }
    paVar3 = _PTR_LOOP_1050_5a64;
    if (ctx.PTR_LOOP_1050_5a66 | ctx._PTR_LOOP_1050_5a64) != 0 {
        pass1_1038_7964((ctx._PTR_LOOP_1050_5a64 & 0xffff | ZEXT24(ctx.PTR_LOOP_1050_5a66) << 0x10));
        error_check_1000_17ce(paVar3);
    }
...
pub unsafe fn pass1_1030_6ddc(param_1: &mut  Struct493) {
    let u_var1: u8;
    let BVar2: bool;
    let extraout_var: u32;
        ...
        while (local_a < _local_6) {
            ...
            if (u_var5 != 0) {
                ...
                if (&paVar3.field_0xc == param_3) {
                    ...
                    (**pp_var1)(&ctx.PTR_LOOP_1050_1028, &local_bx_4.field_0x1e, 0, local_a);
                }
...
pub unsafe fn pass1_1030_7064(param_1: &mut Struct493) -> u16 {
    let mut u_var1: u32;
    if (param_1 + 0x1a) == 0 {
        pass1_1030_73a8(param_1);
    }
    // u_var1 = (param_1 + 0x1a);
    u_var1 = param_1.field_0x1a;
    // TODO: figure out which structure is being accessed
    if (u_var1 + 0x12) == 5 {
        return 0;
    }
    0
...
pub unsafe fn pass1_1030_70ac(param_1: &mut Struct493) -> u16 {
    let mut u_var1: u32;
...
pub unsafe fn pass1_1030_73a8(ctx: &mut AppContext, param_1: &mut Struct493) -> Option<&mut Struct493> {
    let mut u_var1: u32;
    ...
    if param_1.field_0x1a == 0 {
        let var1 = param_1z.field_0x16;
        let var2 = pass1_1028_e1ec(ctx, &mut ctx._PTR_LOOP_1050_65e2, var1, 0);
        param_1.field_0x1a = var2.clone();
    }
    return Some(var2);
}
...
pub unsafe fn pass1_1030_5290(struct_a: &Struct895) {
    ...
    if ((in_dx | struct_e) != 0) {
      ...
      // local_es_41 = (struct_a  >> 0x10);
        ...
        *_local_a = 0x6ad2;
        struct_e.field_0x2 = &ctx.PTR_LOOP_1050_1028;
...
pub unsafe fn pass1_1030_4c52(param_1: u16, param_2: u16, param_1_00: u32, param_2_00: u32) {
    ...
    local_4 = 0x0;
    loop {
        u_var1 = pass1_fn_1000_47a4(param_2_00, &ctx.PTR_s_n_Op_Op_1050_002c_1050_518a);
...
pub unsafe fn pass1_1030_1a32(param_1: &mut  Struct848) -> &mut  Struct848 {
  ...
  ctx.PTR_LOOP_1050_5166 = param_1;
    (ctx.PTR_LOOP_1050_5166 + 0x10) = 0;
    param_1.field_0x0 = (s_288_flc_1050_1cb6 + 6);
    (ctx.PTR_LOOP_1050_5166 + 2) = 0x1030;
    return param_1;
}
...
pub unsafe fn pass1_1028_ebee(param_1: u32) {
  ...
  // u_var2 = (ctx._PTR_LOOP_1050_5166  >> 0x10);
    iVar1 = ctx._PTR_LOOP_1050_5166;
    (iVar1 + 0x10) = u_var3;
    (iVar1 + 0x12) = (u_var3 >> 0x10);
  // u_var2 = (ctx._PTR_LOOP_1050_5166  >> 0x10);
    return CONCAT22((ctx._PTR_LOOP_1050_5166 + 6), (ctx._PTR_LOOP_1050_5166 + 4));
}
