...

{
  ...
  if (param_4 == 0x181) {
    ...
    iVar7 = 0x1;
    paVar6 = (astruct_27 *)
             mixed_1010_20ba((astruct_57 *)CONCAT22(uVar4,(LVar5 >> 0x10)),_u16_1050_0ed0,
...

{
  ...
  LVar3 = SendMessage16(param_1 & 0xffff0000 | (iVar1 + 0x19a),wparam_00,0x408,*(HWND16 *)(iVar1 + 0x94));
  return LVar3;
}
...

{
  ...
  SetWindowText16(CONCAT22(uVar2,uVar1),*(HWND16 *)(param_1 + 0x90));
  BVar1 = string_1018_39d8((param_1 + 0x96),
                           (param_1 & 0xffff0000 | (param_1 + 0x9aU)),uStack12);
  EnableWindow16(BVar1 & 0x1,*(HWND16 *)(param_1 + 0x8e));
  return;
}
...

{
  ...
  if (param_5 == 0x186) {
    ...
    iVar6 = 0x1;
    paVar5 = (astruct_27 *)
             mixed_1010_20ba((astruct_57 *)CONCAT22(in_register_0000000a,(LVar4 >> 0x10)),_u16_1050_0ed0,
...

{
  ...
  while( true ) {
    ...
    iVar2 = (LVar3 >> 0x10);
    if (((LVar3 == -0x1) && (iVar2 == -0x1)) || ((LVar3 == -0x2 && (iVar2 == -0x1)))) break;
  }
