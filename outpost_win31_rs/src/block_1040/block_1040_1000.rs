...

{
  ...
  if (param_5 == 0x1c1) {
    ...
    iVar3 = paVar6;
    uVar1 = (param_2 + 0x92);
    ui_op_1010_79aa(paVar6,0xfb6,*(i32 *)(uVar1 + 0x6));
    if (iVar3 == 0) {
      uVar1 = (param_2 + 0x92);
...
// WARNING: Globals starting with '_' overlap smaller symbols at the same address
pub fn win_ui_op_1040_12bc(param_1: u8,StructB *struct_b_param_1)

{
  ...
  HVar2 = GetDlgItem16(s_vrpal_bmp_1050_183a + 0x5,(HWND16)struct_b_3.lpvoid_field_0x8);
  send_msg_1040_1696(struct_b_param_1,HVar2);
  SendMessage16((LPARAM)lparam,0xffff,0x40d,HVar2);
  HVar2 = GetDlgItem16(s_vrpal_bmp_1050_183a + 0x4,(HWND16)struct_b_3.lpvoid_field_0x8);
  send_msg_1040_1696(struct_b_param_1,HVar2);
  SendMessage16((LPARAM)lparam,0xffff,0x40d,HVar2);
...

{
  ...
  if (PTR_LOOP_1050_13ae != NULL) {
    ...
    load_string_1010_84e0
              (_u16_1050_14cc,(_u16_1050_14cc >> 0x10),0x3ff,local_204,(short)&DAT_1050_1050);
...

{
  ...
  pstruct_32_hi = (astruct_32 *)(param_1 >> 0x10);
  if (param_2 != 0) {
...

{
  ...
  uVar2 = &iVar3[0x7].field1_0x2;
  check_01 = (uVar2 + 0x72);
  CheckDlgButton16((uVar1 + 0x1e),0xfdb,(HWND16)iVar3.lpvoid_field_0x8);
...

{
  ...
  puVar2 = mixed_1010_20ba((astruct_57 *)(paVar1 & 0xffff0000 | puVar2 >> 0x10),_u16_1050_0ed0,
                           (u8 **)CONCAT22((ppuVar3 >> 0x10),0x37),in_stack_0000fea6,
                           in_stack_0000ffca,in_stack_0000ffd0,in_stack_0000ffd4);
...

{
  ...
  uVar4 = pass1_1008_4772((astruct_76 *)CONCAT22(param_3,(iVar6 + 1)->field0_0x0));
