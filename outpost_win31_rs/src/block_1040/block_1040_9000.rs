...

{
  ...
  uVar1 = (param_1 >> 0x10);
  if ((param_1 + 0x18) != 0x0) {
    EnableWindow16(param_2,*(HWND16 *)(param_1 + 0x18));
  }
  return;
}
...

{
  ...
  uVar5 = (astruct_65 *)(param_1 >> 0x10);
  iVar3 = (astruct_65 *)param_1;
  if (*(i32 *)&iVar3->field2_0x4 != 0x0) {
    draw_text_1040_9650((astruct_65 *)(param_1 & 0xffff | ZEXT24(uVar5) << 0x10));
  }
  if (*(i32 *)&iVar3->field4_0x8 != 0x0) {
    pass1_1040_9618((astruct_65 *)(param_1 & 0xffff | ZEXT24(uVar5) << 0x10));
  }
...

{
  ...
  pstruct65_1 = (astruct_65 *)(param_1 >> 0x10);
...

{
  ...
  uVar1 = (param_1 >> 0x10);
  LVar2 = SendMessage16(0x0,*(WPARAM16 *)(param_1 + 0x1c),0x111,*(HWND16 *)(param_1 + 0x1a));
  return LVar2;
}
...

{
  ...
  if (iVar4->field8_0x8 != NULL) {
    ...
    if ((((&iVar4->field9_0xc + 0x2) | &iVar4->field9_0xc) != 0x0) && ((param_2 & 0x1) != 0x0)) {
...

{
  ...
  DrawText16(0x10,(RECT16 *)(struct_param_1 & 0xffff0000 | ZEXT24(&struct_1->field40_0x2e)),-0x1,
...

{
  ...
  hdc = GetDC16(0x0);
  DrawText16(0x410,(RECT16 *)(param_1 & 0xffff0000 | (param_1 + 0x2e)),-0x1,
...

{
  ...
  if ((handle_1 | handle_2) != 0x0) {
    if (l_param_1 == 0x2) {
      ...
      if (var10 != NULL) {
        fn_ptr_1 = (code **)*var10;
        (**fn_ptr_1)(s_tile2_bmp_1050_1538,handle_2,handle_1,0x1);
      }
    }
      ...
      if (handle_1 == 0x0) {
        ...
        fn_ptr_1 = (code **)(*var10 + 0x1c);
        (**fn_ptr_1)(0x1008,(char)var10,(var10 >> 0x10),param_2,win_handle_1,w_param_1,uVar2);
        return;
      }
    }
      ...
      fn_ptr_1 = (code **)(*var10 + 0x20);
      (**fn_ptr_1)(0x8,var10,(char)(var10 >> 0x10),param_2,win_handle_1,w_param_1,uVar2);
      return;
    }
  }
  if (var6 != 0x0) {
...
pub fn win_op_1040_9cde(LPARAM lparam_param_1,wparam_param_2: WPARAM16,u16 msg_param_3,HWND16 hwnd_param_4,
...

{
  ...
  paVar7 = (astruct_57 *)CONCAT22(uVar10,(win_long_11 >> 0x10));
      ...
      if (bVar3 == 0x8) {
        ...
        *pbVar1 = *pbVar1 & 0xf7;
        ...
        if (((iVar3 + 0x5c) != 0x0) && ((iVar3 + 0x5c) != win_long_11)) {
          SendDlgItemMessage16(uVar6,0x1,0x404,*(INT16 *)(iVar3 + 0x5c),*(HWND16 *)(iVar3 + 0x2));
        }
        (iVar3 + 0x5c) = 0x0;
      }
      else if (bVar3 < 0x9) {
        if (bVar3 == 0x1) {
          ...
          *pWVar11 = WVar4;
          ...
          unk_str_op_1000_3d3e
                    ((pWVar11 & 0xffff0000 | (iVar2 + 0x6)),*(char **)(lparam_param_1 + 0x16)
                    );
          if ((*(lparam_param_1 + 0x12) & 0x1) != 0x0) {
            SendMessage16(0x0,*pWVar11,0x401,*(HWND16 *)(lparam_param_1 + 0x8));
          }
          if (((lparam_param_1 + 0x14) & 0x800) == 0x0) {
            return;
          }
          pbVar1 = (iVar2 + 0x4);
          *pbVar1 = *pbVar1 | 0x4;
          ...
          if ((wparam_param_2 == 0x26) || (wparam_param_2 == 0x25)) {
            ...
            if ((wparam_param_2 != 0x28) && (wparam_param_2 != 0x27)) {
              if (((wparam_param_2 == 0x20) || (wparam_param_2 == 0xd)) && (PTR_LOOP_1050_5ed8 == NULL)) {
                PTR_LOOP_1050_5ed8 = (&PTR_LOOP_1050_0000 + 0x1);
                pbVar1 = (iVar3 + 0x4);
                *pbVar1 = *pbVar1 | 0x2;
                goto LAB_1040_9e20;
              }
