...
pub fn pass1_1018_20ee(mut param_1: u32,param_2: *mut i16)
...
// WARNING: Globals starting with '_' overlap smaller symbols at the same address
pub fn struct_1018_229c(param_1: *mut u8,param_2: *mut astruct_19,mut param_3: u16 )

{
  ...
  (param_2 + 0x2a) = uVar1;
  (param_2 + 0x2c) = uVar4;
  pass1_1000_4906((param_2 & 0xffff0000 | ZEXT24((param_2 + 0x2eU))),NULL,0x10);
...
// WARNING: Globals starting with '_' overlap smaller symbols at the same address
pub fn pass1_1018_2440(param_1: *mut StructD)
...
u8 * pass1_1018_2580(param_1: u8,mut param_2: u32,mut param_3: u16 ,mut param_4: u32,mut param_5: u16 )

{
  let mut puVar1: *mut u8;
  let mut iVar2: i16;
  let mut uVar3: u16;
  ulet mut local_8: [u8;0x6] = [0;0x6];
  ...
  pass1_1018_161c((iVar2 + 0x20),CONCAT22(0x1050,local_8),param_4,(param_4 >> 0x10));
  puVar1 = local_8;
...

{
  ...
  pass1_1018_161c((param_1 + 0x20),CONCAT22(0x1050,local_8),param_3,(param_3 >> 0x10)
                 );
  puVar7 = CONCAT22(0x1050,local_8);
  puVar6 = mixed_1010_20ba(paVar2,_u16_1050_0ed0,CONCAT22(param_2,0x32),in_stack_0000fe96,
...
// WARNING: Globals starting with '_' overlap smaller symbols at the same address
pub fn pass1_1018_270e(param_1: *mut u8,param_2: *mut astruct_27,mut param_3: i16,mut param_4: u16 )

{
  ...
  if (param_3 == 0) {
    if ((&iVar5.field_0x20 == 0) ||
      ...
      puVar7 = mixed_1010_20ba(paVar5,_u16_1050_0ed0,CONCAT22(in_stack_0000fff4,param_4),in_stack_0000fe9c
...
pub fn win_op_1018_294a(mut param_1: u16 ,in_string_6: u16,param_3: *mut astruct_8,mut param_4: u16 ,mut param_5: u32)
...

{
  ...
  iVar9: *mut astruct_931;
  let mut uVar8: u16;
  let mut uVar7: u16;
  let mut uVar9: u16;
  let mut HVar8: HWND16;
  paVar9: *mut astruct_394;
  ...
  puVar2 = &local_2a;
  uStack6 = param_1;
  struct_op_1008_48fe(paVar5,CONCAT13(0x10,CONCAT12(0x50,puVar2)),0x1,CONCAT22(uStack4,param_1));
  uVar7 = 0x1000;
  ...
  *(astruct_394 **)&iVar9.field12_0xe = paVar2;
  ...
  if (uVar6 == 0) {
    ...
    uVar9 = 0x1008;
    pass1_1008_405c(CONCAT22(paVar7,rect),iVar9.field12_0xe,iVar4,
...
pub fn pass1_1018_2aa8(param_1: *mut StructD,param_2: u8) -> *mut StructD
...
pub fn pass1_1018_2afa(param_1: u32)
...
pub fn pass1_1018_2c60(param_1: *mut StructD)
...
pub fn pass1_1018_2d22(mut param_1: u32,param_2: *mut i16,param_3: *mut u16,mut param_4: i16)
...

{
  ...
  if ((&iVar4.field374_0x17e != 0) &&
     (uVar3 = &iVar4.field374_0x17e, (uVar3 + 0xa) != 0)) {
...

{
  ...
  puVar5 = mixed_1010_20ba(in_EDX,_u16_1050_0ed0,CONCAT22(piVar7,0x48),in_stack_0000fe7c,in_stack_0000ffa0
...

{
  ...
  let mut extraout_DX: u16;
  let mut uVar8: u16;
  pstruct126_9: *mut astruct_126;
  uVar9: *mut astruct_126;
