pub unsafe fn pass1_1018_0000(mut param_1: i16,param_2: *mut u8,mut param_3: u32,mut param_4: u32)
...
pub unsafe fn pass1_1018_017c(mut param_1: u32,mut param_2: u16 )
...
pub unsafe fn pass1_1018_0196(mut param_1: u16 ,param_2: *mut u8,mut param_3: u32,mut param_4: u32,mut param_5: u32)
...
//    if (uVar4 < (iVar8 + 0x32)) goto LAB_1018_022a;
    ...
    *piVar1 = *piVar1 + 0x5;
    uVar3 = (iVar8 + 0x2c);
    uVar10 = pass1_1000_0ed4(0x1,(iVar8 + 0x32) * 0x6,0x0,uVar3,
                             (uVar3 >> 0x10));
    pSVar7 = (uVar10 >> 0x10);
    uVar4 = uVar10;
  }
...
// LAB_1018_022a:
  ...
  *piVar1 = *piVar1 + 1;
  uVar10 = (iVar8 + 0x2c);
  pass1_1008_3f62((uVar10 & 0xffff0000 | (uVar10 + iVar2 * 0x6)),
...
// WARNING: Globals starting with '_' overlap smaller symbols at the same address
pub unsafe fn pass1_1018_028c(mut param_1: u16 ,param_2: *mut StructD,mut param_3: u32,mut param_4: u32,mut param_5: u16 )

{
  ...
  paStack12 =
              mixed_1010_20ba(param_2,_u16_1050_0ed0,CONCAT22(param_5,iStack8),
  ...
  for (iStack36 = 0; iStack36 < uVar5; iStack36 += 1) {
    ...
    if (uVar4 != 0) {
      iVar6 = iStack36 / 0x6;
      uVar12 = uVar11 & 0xffff0000 | iStack36 % 0x6 & 0xffffU;
      uVar1 = (iVar14 + 0xe);
...
// WARNING: Globals starting with '_' overlap smaller symbols at the same address
pub unsafe fn pass1_1018_0412(param_1: *mut astruct_27,mut param_2: u16 ,mut param_3: u32,mut param_4: u16 ,mut param_5: u32)

{
  pstruct97_1: *mut astruct_97;
  ...
  struct_op_1028_933c(CONCAT22(0x1050,&struct97_128),param_2,uStack4,param_4,param_3,
...
pub unsafe fn pass1_1018_04a4(mut param_1: u32,mut param_2: u32)
...
pub unsafe fn pass1_1018_04b8(mut param_1: u32) -> u32
...
pub unsafe fn pass1_1018_04ca(mut param_1: u32,mut param_2: u32)

{
  (param_1 + 0x1a) = param_2;
  return;
}
pub unsafe fn pass1_1018_04de(mut param_1: u32,mut param_2: u32)

{
  (param_1 + 0x20) = param_2;
  return;
}
pub unsafe fn pass1_1018_04f2(param_1: *mut StructD)
...

{
  ...
  puVar8 = mixed_1010_20ba(paVar5,_u16_1050_0ed0,CONCAT22(param_3,0x2f),in_stack_0000fe98,
  ...
  puVar8 = mixed_1010_20ba(paVar5,_u16_1050_0ed0,CONCAT22(uVar6,0x2),in_stack_0000fe8e,in_stack_0000ffb2,
                           in_stack_0000ffb8,in_stack_0000ffbc);
  paVar5 = (paVar5 & 0xffff0000 | puVar8 >> 0x10);
  if ((puVar8 + 0x80) != 0) {
    uVar9[0x1].field19_0x24 = 0x2;
  }
  puVar8 = mixed_1010_20ba(paVar5,_u16_1050_0ed0,CONCAT22(uVar6,0x9),in_stack_0000fe8e,in_stack_0000ffb2,
                           in_stack_0000ffb8,in_stack_0000ffbc);
  paVar5 = (paVar5 & 0xffff0000 | puVar8 >> 0x10);
  ...
  puVar8 = mixed_1010_20ba(paVar5,_u16_1050_0ed0,CONCAT22(uVar6,0x3b),in_stack_0000fe8e,in_stack_0000ffb2,
                           in_stack_0000ffb8,in_stack_0000ffbc);
...
// WARNING: Globals starting with '_' overlap smaller symbols at the same address
pub unsafe fn pass1_1018_078e(param_1: *mut StructD)
...
// WARNING: Globals starting with '_' overlap smaller symbols at the same address
pub unsafe fn pass1_1018_0902(param_1: u32,mut param_2: u32)
...

{
  ...
  puVar7 = mixed_1010_20ba(paVar4,_u16_1050_0ed0,CONCAT22(piVar8,0x48),in_stack_0000fe7c,in_stack_0000ffa0
                           ,in_stack_0000ffa6,in_stack_0000ffaa);
  pass1_1008_3e94((puVar7 & 0xffff0000 | (puVar7 + 0xe)),CONCAT22(uVar9,piVar8),pcVar10
                 );
...
pub unsafe fn pass1_1018_0a50(mut param_1: u32) -> u32
...
pub unsafe fn pass1_1018_0a76(mut param_1: u32)
...
pub unsafe fn pass1_1018_0ac0(mut param_1: u32,param_2: *mut StructA)
...
pub unsafe fn pass1_1018_0ad4(mut param_1: u32) -> u32
...
pub unsafe fn pass1_1018_0ae8(mut param_1: u32,mut param_2: u16 )
...
pub unsafe fn pass1_1018_0afa(mut param_1: u32) -> u16
...
pub unsafe fn pass1_1018_0b08(mut param_1: u32) -> u32
...
pub unsafe fn pass1_1018_0b1e(param_1: *mut astruct_74,param_2: *mut u16)

{
  ...
  pass1_1008_3eb4((param_1 & 0xffff0000 | ZEXT24(iVar3)),CONCAT22(0x1050,&local_8),
  ...
  pass1_1008_6cec((param_1 & 0xffff0000 | ZEXT24(&iVar3.field_0x40)),local_8,
...
pub unsafe fn pass1_1018_0bf4(mut param_1: i16,mut param_2: u32,mut param_3: i16,mut param_4: u32,mut param_5: u16 )

{
  ...
  0x1 =>
    ...
    return;
  0x4 =>
    pass1_1008_3eb4((param_2 & 0xffff0000 | (param_2 + 0x10)),
                    CONCAT22(0x1050,&local_8),CONCAT22(0x1050,&local_6),
                    CONCAT22(0x1050,&local_6 + 0x2));
    uVar1 = (param_2 + 0xc);
    local_8 = (uVar1 + 0x1e);
    pass1_1008_3e76((param_2 & 0xffff0000 | (param_2 + 0x10)),local_8,local_6,
                    (local_6 >> 0x10));
    pass1_1008_6c90(CONCAT22(0x1050,local_14));
    pass1_1018_0b1e((param_2 & 0xffff0000 | (param_2 - 0x20)),
...
pub unsafe fn pass1_1018_0d9a(mut param_1: u32,param_2: *mut u16,param_3: *mut u32)
  ...
  loop {
    ...
    if (pcVar5 == 0x8000001) {
      ...
      *puVar1 = *puVar1 + 1;
            ...
            (pass1_1008_dfa6(iVar13.field154_0xa2,paVar2.field3_0x4,0x4000001), pcVar5 != 0)) {
...
// LAB_1018_0ffc:
  if ((iVar13.field157_0xa8 != 0) ||
     (pass1_1008_dfa6(iVar13.field154_0xa2,(uStack24 + 0x4),0x4000001), puVar4.is_null() == false)) {
...
// LAB_1018_0fe8:
    uVar8 = uVar6;
    pass1_1008_3f62(CONCAT22(uVar6,iVar3 + uStack28 * 0x6),CONCAT22(0x1050,&local_32));
  }
  goto LAB_1018_0f74;
}
