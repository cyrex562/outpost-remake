...
pub fn pass1_1020_808e(param_1: *mut StructD)
...
pub fn pass1_1020_8288(param_1: *mut StructD,param_2: u8) -> *mut StructD
...
pub fn FUN_1020_8296(mut param_1: u16 ,param_2: *mut StructD,param_3: u8) -> *mut StructD
...

{
  ...
  puVar5 = mixed_1010_20ba(CONCAT22(uVar3,(puVar4 >> 0x10)),_u16_1050_0ed0,
                           CONCAT22(unaff_SI,0x29),in_stack_0000fe96,in_stack_0000ffba,in_stack_0000ffc0,
                           in_stack_0000ffc4);
  uVar2 = (puVar5 >> 0x10);
  ...
  pass1_1020_8712(param_1 & 0xffff | uVar6 << 0x10,&iVar4.field3_0x8,
                  (uVar1 + 0x2a),(param_1 & 0xffff0000 | ZEXT24(&iVar4.field9_0x16))
                 );
  return;
}
...

{
  ...
  if ((iVar3 + 0x4) != 0) {
    uVar1 = (iVar3 + 0x1c);
    uVar2 = (iVar3 + 0x1c);
    pass1_1008_4480((uVar1 + 0xa),(param_1 & 0xffff0000 | (iVar3 + 0x16)),
                    (uVar2 + 0x2a));
  }
  return;
}
...
pub fn pass1_1020_843c(param_1: *mut StructD,param_2: u8) -> *mut StructD
...

{
  ...
  puVar7 = mixed_1010_20ba(paVar3,_u16_1050_0ed0,CONCAT22(unaff_SI,0x48),in_stack_0000fe92,
...
pub fn pass1_1020_8556(param_1: *mut StructD)
...

{
  ...
  let mut uVar4: u32;
  let mut iVar5: i16;
  iVar7: *mut astruct_592;
  iVar6: *mut astruct_591;
  let mut iVar8: i16;
  let mut uVar9: u16;
  let mut uVar10: u16;
  let mut iStack4: i16;
...
pub fn pass1_1020_8784(param_1: *mut StructD,param_2: u8) -> *mut StructD
...

{
  ...
  puVar5 = mixed_1010_20ba(CONCAT22(uVar2,(puVar4 >> 0x10)),_u16_1050_0ed0,
                           CONCAT22(unaff_SI,0x29),in_stack_0000fe80,in_stack_0000ffa4,in_stack_0000ffaa,
                           in_stack_0000ffae);
  ...
  pass1_1020_8712(param_1 & 0xffff | uVar3 << 0x10,CONCAT22(0x1050,local_12),
                  iVar2.field_0x38,(param_1 & 0xffff0000 | ZEXT24(&iVar2.field_0x32)));
  return;
}
...

{
  ...
  let mut uVar6: u16;
  let mut uVar7: u16;
  pstruct284_8: *mut astruct_284;
  let mut iVar9: i16;
  let mut iVar10: i16;
  let mut uVar11: u16;
  let mut uVar12: u16;
  let mut uVar13: u32;
  paStack28: *mut astruct_110;
  let mut iStack4: i16;
      ...
      if ((uVar2 + iVar10) == 0) {
        ...
        if ((uVar7 | uVar4) == 0) {
          ...
          pass1_1008_50c2(paStack28,(uVar3 + 0x8),(uVar3 + 0x4),
                          (param_1 & 0xffff0000 | ZEXT24(puVar5)),param_2);
          uVar2 = pstruct284_8.field11_0xc;
          uVar12 = (uVar2 >> 0x10);
          iVar9 = uVar2;
          (iVar9 + iVar10) = puVar5;
  ...
  if (pstruct284_8.field4_0x4 != 0) {
    pass1_1008_4480(param_2,(param_1 & 0xffff0000 | ZEXT24(&pstruct284_8.field_0x32)),
...
pub fn pass1_1020_8a5e(param_1: *mut StructD,param_2: u8) -> *mut StructD
...

{
  ...
  puVar8 = mixed_1010_20ba(paVar6,_u16_1050_0ed0,CONCAT22(unaff_SI,0x29),param_6,param_5,param_3,param_4);
  uVar4 = (paVar6 >> 0x10);
  ...
  struct_op_1008_48fe(paVar6,CONCAT22(0x1050,local_2a),0x1,CONCAT22(paVar6,uVar4));
  ...
  pass1_1020_8712(param_1,(uVar2 & 0xffff0000 | (uVar2 + 0x8)),
                  CONCAT22(0x1050,local_48),puStack76);
...
{
  let mut uVar1: u32;
  paVar2: *mut astruct_109;
  let mut puVar3: *mut u16;
  let mut puVar4: *mut u16;
  let mut uVar5: u16;
  let mut uVar6: u16;
  let mut paVar7: *mut Struct57;
  iVar9: *mut astruct_285;
  iVar10: *mut astruct_286;
  let mut uVar9: u16;
  let mut uVar10: u16;
  ...
  paStack10: *mut astruct_76;
  paStack6: *mut astruct_76;
  let mut paVar8: *mut Struct57;
  ...
  if (iVar9.field4_0x4 != 0) {
    ...
    if (iVar9.field11_0xc == 0) {
      ...
      if (uVar5 == 0) {
        ...
        pass1_1008_50c2(CONCAT22(paVar7,uVar6),(uStack20 + 0x8),
      ...
      struct_op_1008_48fe(paVar8,CONCAT22(0x1050,local_3a),0x1,CONCAT22(paVar8,uVar10));
      uVar10 = (paVar8 >> 0x10);
      ...
      if (uVar6 == 0) {
        ...
        puVar3 = (param_1 & 0xffff0000 | ZEXT24(&iVar9.field_0x16));
        uVar10 = (uStack20 >> 0x10);
        pass1_1008_50c2(CONCAT22(paVar7,(paStack6 >> 0x10)),
  ...
  if (uVar2 != 0) {
    ...
    if ((uStack4 | uStack6) != 0) {
      ...
      file_and_draw_op_1008_4f20
                (uVar3,CONCAT22(0x1050,&local_38),(uVar1 + 0xe),0x25,
                 CONCAT22(0x1050,local_10),param_6,param_7);
      pass1_1008_4480(param_5,(param_3 & 0xffff0000 | (iVar4 + 0x1c)),
...
pub fn pass1_1020_8e6c(param_1: *mut StructD,param_2: u8) -> *mut StructD
...

{
  ...
  iVar4.base_0x2 = 0x1020;
  puVar9 = mixed_1010_20ba(paVar6,_u16_1050_0ed0,CONCAT22(unaff_SI,0x29),in_stack_0000fe9a,
  ...
  puVar9 = mixed_1010_20ba(paVar6,_u16_1050_0ed0,CONCAT22(unaff_DI,0x2),in_stack_0000fe9c,
                           in_stack_0000ffc0,in_stack_0000ffc6,in_stack_0000ffca);
  iVar4.field144_0xba = puVar9;
  iVar4.field145_0xbc = (puVar9 >> 0x10);
  return;
}
pub fn pass1_1020_8f74(param_1: *mut StructD)
