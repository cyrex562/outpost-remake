...

{
  ...
  iVar10: *mut astruct_743;
  iVar11: *mut astruct_744;
  iVar12: *mut astruct_745;
  puVar14: *mut astruct_735;
  let mut iVar13: i16;
  let mut uVar12: u16;
  let mut uVar15: u16;
  let mut uVar14: u16;
  ...
  let mut uVar23: u16;
  let mut uVar24: u16;
  iVar14: *mut astruct_746;
  iVar15: *mut astruct_748;
  let mut uVar1: u32;
  let mut uVar4: u32;
  let mut uVar5: u32;
  let mut iVar16: i16;
  ...
  while (&puVar14[-0x6].field_0x4 < (puVar14 + -0x4)) {
    ...
    uVar6 = puVar14[-0x5].field6_0x6;
    pass1_1008_4480(&puVar14[-0x4].field_0x2,CONCAT22(0x1050,&puVar14[-0x6].field6_0x6),
                    (iVar11 + uVar6));
  ...
  DeleteObject16(hgdiobj16_var10);
  uVar6 = puVar14.field6_0x6;
  EndPaint16(CONCAT22(0x1050,(&puVar14[-0x4].field6_0x6 + 0x2)),
             (uVar6 + 0x4));
  return;
}
  ...
  if ((param_2 | param_1) != 0) {
    ...
    for (iStack12 = 0; iStack12 < 0x9; iStack12 += 1) {
      ...
      set_win_tet_1020_1d2a
                (uVar1,(uVar1 >> 0x10),CONCAT22(param_2,uStack10),uVar2,
                 in_stack_0000fff2);
...
pub fn pass1_1020_24f2(param_1: *mut StructD,param_2: u8) -> *mut StructD
...
pub fn pass1_1020_26d8(param_1: *mut StructD,param_2: u8) -> *mut StructD
...
pub fn FUN_1020_26e6(mut param_1: u16 ,param_2: *mut StructD,param_3: u8) -> *mut StructD
...

{
  ...
  puVar6 = mixed_1010_20ba(paVar5,_u16_1050_0ed0,CONCAT22(in_stack_0000fff2,0x2a),in_stack_0000fe9a,
...
pub fn pass1_1020_2868(param_1: *mut StructD,param_2: u8) -> *mut StructD
...

{
  let mut uVar1: u16;
  let mut in_register_0000000a: u16;
  iVar3: *mut astruct_665;
  let mut unaff_BP: u16;
  uVar2: *mut astruct_665;
  ...
  puVar2 = mixed_1010_20ba(CONCAT22(in_register_0000000a,param_1),_u16_1050_0ed0,
                           CONCAT22(unaff_BP,param_4),in_stack_0000fea6,in_stack_0000ffca,
...

{
  ...
  paVar2 =
           mixed_1010_20ba(param_2,_u16_1050_0ed0,CONCAT22(param_6,0x29),in_stack_0000fe9e,
...
// WARNING: Globals starting with '_' overlap smaller symbols at the same address
pub fn invalidate_rect_1020_2ae4(mut param_1: u16 ,param_2: *mut u32,mut param_3: u16 ,mut param_4: u16 )

{
  ...
  if (param_3 != 0x129) {
    ...
    if (param_3 == 0xfb) {
      puVar11 = mixed_1010_20ba(paVar7,_u16_1050_0ed0,CONCAT22(param_4,0x30),in_stack_0000fe9c,
      ...
      uVar2 = (uVar12 >> 0x10);
      pass1_1018_181c(CONCAT22(uVar12,uVar2),(uVar8 + 0xf2),
    ...
    if (param_3 < 0xfc) {
      ...
      if (cVar3 == 'r') {
        ...
        uVar5 = uVar9;
        paVar10 =
                  mixed_1010_20ba(paVar7,_u16_1050_0ed0,CONCAT22(iVar4,0x30),in_stack_0000fe98,
...

{
  ...
  puVar9 = mixed_1010_20ba(param_1,_u16_1050_0ed0,CONCAT22(unaff_SI,pSVar11[0x1].field26_0x30),param_3,
...
pub fn pass1_1020_2e24(param_1: *mut StructD,param_2: u8) -> *mut StructD
...

{
  ...
  puVar5 = mixed_1010_20ba(param_1,_u16_1050_0ed0,CONCAT22(param_2,param_4[0x1].field26_0x30),
