...
pub unsafe fn pass1_1020_61c4(mut param_1: u16 ,mut param_2: u16 ,mut param_3: u32,param_4: *mut u16)

{
  ...
  puVar3 = mixed_1010_20ba(in_EDX,_u16_1050_0ed0,CONCAT22(in_stack_0000fff2,0x2f),in_stack_0000fe9a,
...

{
  ...
  set_struct_op_1020_921c(in_EDX,CONCAT22(param_2,param_1),param_3,in_stack_0000ffc6);
  (param_1 + 0x14) = 0;
  (param_1 + 0x2c) = 0;
  ...
  if (uVar5 == 0) {
    ...
    pass1_1020_8a9c(CONCAT22(paVar7,puVar3),paVar8,in_stack_0000ff68,in_stack_0000ff6c,
  ...
  (param_1 + 0x12) = uVar4;
  (param_1 + 0x10) = 0x1;
  puVar10 = mixed_1010_20ba(paVar7,_u16_1050_0ed0,CONCAT22(uVar11,0x2),in_stack_0000fe84,in_stack_0000ffa8
...

{
  ...
  puStack6 = (uVar2 + 0xa);
  if ((struct_1.field8_0x10 != 0) ||
     (uVar2 = &struct_1.field10_0x14, (uVar2 + 0x24) != 0)) {
...

{
  ...
  if (param_2 == 0x2) {
    for (iStack4 = 0; iStack4 < 0x5; iStack4 += 1) {
      iVar6 = iStack4 * 0x4;
...
pub unsafe fn unk_win_ui_op_1020_67ce(in_struct_1: *mut StructA,mut param_2: u16 ,mut param_3: u32,mut param_4: u32)
...
pub unsafe fn unk_destroy_win_op_1020_694c(mut param_1: u16 ,param_2: *mut StructA,mut param_3: u16 ) -> u16
...
pub unsafe fn win_ui_op_1020_6ae6(param_1: *mut astruct_877,mut param_2: u16 ,mut param_3: i16,mut param_4: i16,param_5: u16,param_6: u16)
    ...
    if (hwnd != 0) {
      if (param_3 == 0x2) {
        ...
        if (LVar4 != -1) {
          ...
          puVar2 = &stack0xffa8;
          pass1_1018_30ca((LVar4 >> 0x10),iVar3.field241_0xf2,
...
pub unsafe fn enable_menu_item_1020_6b9a(mut param_1: u16 ,mut param_2: u16 ,mut param_3: u16 ,mut param_4: i16,HMENmut param_5: u16 )
...
// WARNING: Globals starting with '_' overlap smaller symbols at the same address
pub unsafe fn window_op_1020_6c3a(param_1: *mut astruct_57,struct_param_1: *mut StructA,mut param_3: u16 ,mut param_4: u16 ,mut param_5: u16 ,
...

{
  ...
  puVar11 = mixed_1010_20ba(param_1,_u16_1050_0ed0,CONCAT22(unaff_SI,0x4),param_3,param_5,param_6,param_7)
  ;
  ...
  if (uVar8 != 0) {
    pass1_1008_3bd6(paVar10,paVar4,paVar9,0x0,local_6,0x0,0x7c007d,
  ...
  if (uVar8 != 0) {
    pass1_1008_3bd6(paVar9,paVar4,paVar10,0x0,local_6,0x0,0x7e007f,
  ...
  paVar10 = (paVar9 & 0xffff0000 | uVar8);
  if (uVar8 != 0) {
    pass1_1008_3bd6(paVar10,paVar4,paVar9,0x0,local_6,0x1b2,0x1b001b1,
...
// WARNING: Globals starting with '_' overlap smaller symbols at the same address
pub unsafe fn pass1_1020_6e52(mut param_1: u16 ,mut param_2: u16 ,mut param_3: i16,mut param_4: u16 ,mut param_5: i16)
