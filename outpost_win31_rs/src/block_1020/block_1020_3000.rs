...

{
  ...
  if (is_iconic == 0) {
    ...
    (**fn_ptr_1)(0x1018,pHVar2,IVar4,0x0,0x0,&local_24,&DAT_1050_1050,pHVar1);
...

{
  ...
  uVar3 = struct_a.field19_0x14;
  draw_op_1020_33c0(in_DX,astruct762_param_1,*(uVar3 + 0x6c),local_c,local_a,0x1,hdc_var4);
  pass1_1018_1054(struct_a.field19_0x14,CONCAT22(0x1050,&local_c),CONCAT22(0x1050,&local_a));
  uVar3 = struct_a.field19_0x14;
  draw_op_1020_33c0(in_DX,astruct762_param_1,*(uVar3 + 0x74),local_c,local_a,0x2,hdc_var4);
  pass1_1018_1320(struct_a.field19_0x14,CONCAT22(0x1050,&local_c),CONCAT22(0x1050,&local_a));
  uVar3 = struct_a.field19_0x14;
  draw_op_1020_33c0(in_DX,astruct762_param_1,*(uVar3 + 0x68),local_c,local_a,0x1,hdc_var4);
  pass1_1018_15f6(struct_a.field19_0x14,CONCAT22(0x1050,&local_c),CONCAT22(0x1050,&local_a));
  if (local_c != 0) {
    uVar3 = struct_a.field19_0x14;
    draw_op_1020_33c0(in_DX,astruct762_param_1,*(uVar3 + 0x70),local_c,local_a,0x1,hdc_var4);
  }
  pass1_1018_108c(struct_a.field19_0x14,CONCAT22(0x1050,&local_c),CONCAT22(0x1050,&local_a));
  if (local_c != 0) {
    uVar3 = struct_a.field19_0x14;
    draw_op_1020_33c0(in_DX,astruct762_param_1,*(uVar3 + 0x78),local_c,local_a,0x0,hdc_var4);
  }
  uVar3 = struct_a.field19_0x14;
  if ((uVar3 + 0x84) == 1) {
...
pub unsafe fn draw_op_1020_33c0(mut param_1: u16 ,mut param_2: u32,COLORREF colorref_param_2,mut param_4: i16,mut param_5: u32,mut param_6: i16,
                      hdc16_param_6: HDC16)

{
  ...
  if (param_4 != 0) {
    ...
    puStack14 = param_5;
    for (iStack20 = 0; iStack20 < param_4; iStack20 += 1) {
      uVar6 = (param_2 >> 0x10);
      uVar1 = param_4;
...
pub unsafe fn pass1_1020_3540(mut param_1: u16 ,mut param_2: u16 ,mut param_3: u16 ,mut param_4: i16,param_5: *mut u16)

{
  ...
  for (iStack18 = 0; iStack18 < iStack12; iStack18 += 1) {
    iVar2 = (iStack18 * 0x4);
...
pub unsafe fn draw_polygon_1020_3602(mut param_1: u16 ,mut param_2: u16 ,mut param_3: u16 ,mut param_4: u16 ,mut param_5: u16 )
...
pub unsafe fn struct_1020_3644(mut param_1: u32,param_2: *mut StructA,mut param_3: u16 ,mut param_4: u32,mut param_5: u16 ,
                     mut param_6: u16 )

{
  ...
  window_op_1020_38aa(param_1,(param_2 & 0xffff | in_buf_len_5 << 0x10),param_6,param_5,
...
// WARNING: Globals starting with '_' overlap smaller symbols at the same address
pub unsafe fn window_op_1020_38aa(param_1: *mut astruct_57,param_2: *mut StructA,mut param_3: u16 ,mut param_4: u16 ,mut param_5: u16 ,
...

{
  ...
  puVar13 = mixed_1010_20ba(param_1,_u16_1050_0ed0,CONCAT22(unaff_SI,0x6),param_7,param_8,param_5,param_6)
  ;
  ...
  if (uVar7 == 0) {
    ...
    pass1_1008_3bd6(paVar9,paVar4,paVar10,0x0,0xf1,0x0,0x1ac01ad,
  ...
  if (uVar7 == 0) {
    ...
    uVar12 = 0x1008;
    pass1_1008_3bd6(uVar11,paVar4,paVar9,0x0,0xf500f1,0x0,0x1ae01af,CONCAT22(pstructa_1.field4_0x8,0xf5),
  ...
  if (uVar8 == 0) {
    ...
    get_sys_metrics_1040_7728(CONCAT22(paVar9,uVar7),0x1,0x0,0xfc0,pstructa_1.field4_0x8);
  ...
  if (((&pstructa_1[0x1].field37_0x3e + 0x2) | &pstructa_1[0x1].field37_0x3e) != 0) {
    uVar2 = pstructa_1[0x1].field37_0x3e;
    hwnd = (uVar2 + 0x6);
    GetWindowRect16(CONCAT13(0x10,CONCAT12(0x50,local_a)),pstructa_1.field4_0x8);
...

{
  ...
  struct_5: *mut astruct_30;
  struct_6: *mut astruct_30;
...
// WARNING: Globals starting with '_' overlap smaller symbols at the same address
pub unsafe fn pass1_1020_3d08(mut param_1: u16 ,mut param_2: u16 ,mut param_3: u16 ,mut param_4: u16 ,mut param_5: u16 ,mut param_6: u16 ,
                    mut param_7: u16 ,mut param_8: u16 ,mut param_9: u16 ,param_1: u80,param_1: u81,param_1: u82,
                    param_1: u83,param_1: u84,mut param_15: u32,mut param_16: u16 ,mut param_17: u16 ,mut param_18: u16 ,
                    mut param_19: u16 )

{
  ...
  *param_6 = 0x3c;
  paVar23 =
            CONCAT22(in_register_0000000a,
                     CONCAT11((param_2 >> 0x8) + '<' + (*(param_3 + param_5) < 0x20),bVar20));
  pcStack4 = caseD_a7;
  iVar13 = 0x203d;
  ...
  *pbVar2 = *pbVar2 | bVar20;
  ...
  uVar19 = CONCAT11((param_6 + 0x2 >> 0x8) + bVar12 + bVar10,bVar11 + bVar10 * '\x06') & 0xff0f;
  loop {
...
//      if ((POPCOUNT(*pcVar1) & 1) == 0) goto code_r0x10203db1;
    ...
    *pbVar2 = *pbVar2 | bVar11;
    pbVar2 = (param_3 + iVar13);
    *pbVar2 = *pbVar2 | bVar11;
    param_16 = (param_14 & 1) * 0x4000 | (param_13 & 1) * 0x200 | (param_12 & 1) * 0x100 |
               (*pbVar2 < '\0') * 0x80 | (*pbVar2 == 0) * 0x40 |
               (bVar4 | bVar3 | bVar10 & 1) * 0x10 | ((POPCOUNT(*pbVar2) & 1) == 0) * 0x4;
    pbVar2 = (param_3 + iVar13);
    *pbVar2 = *pbVar2 | bVar11;
    bVar12 = in(0x79);
    pbVar2 = (param_3 + iVar13);
  ...
  // TODO: goto code_r0x10203db1;
    ...
    *pbVar2 = *pbVar2 + bVar12;
    ...
    pcStack4._0_3_ =
         CONCAT21((param_14 & 1) * 0x4000 | (SCARRY1(bVar17,bVar12) != SCARRY1(bVar21,bVar28)) * 0x800 |
                  (param_13 & 1) * 0x200 | (param_12 & 1) * 0x100 | (cVar18 < '\0') * 0x80 |
                  (cVar18 == '\0') * 0x40 | (bVar4 | bVar3 | bVar10 & 1) * 0x10 |
...
// WARNING: Unable to use type for symbol uVar4
// WARNING: Globals starting with '_' overlap smaller symbols at the same address
pub unsafe fn unk_draw_op_1020_3da4(mut param_1: u16 ,mut param_2: u16 ,param_3: *mut astruct_24,param_4: *mut StructA)
...

{
  ...
  uStack54 = uStack44;
  for (iStack56 = 0; iStack56 < iStack46; iStack56 += 1) {
