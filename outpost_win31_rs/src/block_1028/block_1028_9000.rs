...
pub unsafe fn pass1_1028_93d4(mut param_1: u16, mut param_2: u32) {
    ...
    pass1_1028_e1ec(
        _PTR_LOOP_1050_65e2,
        uStack6 & 0xffff | ZEXT24(puVar4) << 0x10,
    );
    (iVar5 + 0x11e) = uVar2;
    (iVar5 + 0x120) = puVar4;
    uVar3 = iVar5 + 0x114;
