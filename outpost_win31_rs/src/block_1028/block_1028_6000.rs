...
pub unsafe fn struct_1028_60bc(param_1: *mut astruct_180,param_2: *mut astruct_57,mut param_3: u16 ) -> *mut u16
...
pub unsafe fn pass1_1028_611e(param_1: *mut StructD,param_2: *mut astruct_12,mut param_3: i16,mut param_4: u32) -> u32
...
pub unsafe fn pass1_1028_6228(mut param_1: u32,mut param_2: u16 ,mut param_3: i16,mut param_4: i16)

{
  ...
  loop {
    ...
    uVar1 = (iVar4 + 0xa);
    if ((param_3 == 0) && (param_2 < uVar1)) { break; }
    bVar8 = param_2 < uVar1;
    param_2 -= uVar1;
    param_3 -= bVar8;
...
pub unsafe fn pass1_1028_6356(mut param_1: u32,mut param_2: i16,mut param_3: u16 ,mut param_4: i16)

{
  ...
  loop {
    ...
    } while ((((iVar5 + 0x8) == 0) || ((param_2 != 0x0 && ((iVar5 + 0x8) != param_2)))) ||
            (((iVar5 + 0x8) == 0xf && (param_2 != 0xf))));
    uVar2 = (iVar5 + 0xa);
    if ((param_4 == 0) && (param_3 < uVar2)) { break; }
    bVar9 = param_3 < uVar2;
    param_3 -= uVar2;
    param_4 -= bVar9;
...
pub unsafe fn pass1_1028_65e2(mut param_1: i16,param_2: *mut u8,param_3: *mut astruct_373,param_4: *mut HFILE16)
...

{
  ...
  if ((puVar7 | uVar5) != 0) {
    ...
    uVar1 = (param_3 + 0x10c);
    uVar10 = 0x1030;
    pass1_1030_7ddc(uVar1,paVar8,CONCAT22(paVar8,uVar5),CONCAT13((uVar1 >> 0xf),(int3)uVar1),
                    0x1f);
  }
...
pub unsafe fn pass1_1028_69cc(param_1: *mut astruct_317,param_2: *mut astruct_57,param_3: *mut astruct_316)
...

{
  ...
  pstruct15_10: *mut astruct_15;
  let mut local_6: [u8;0x2] = [0;0x2];
  let mut local_4: i16;

  puVar2 = local_6;
  pass1_1028_6daa(CONCAT22(puVar2,param_1),param_2,CONCAT22(0x1050,puVar2),
...
// WARNING: Globals starting with '_' overlap smaller symbols at the same address
pub unsafe fn pass1_1028_6d24(mut param_1: u16 ,mut param_2: u16 ,mut param_3: u16 ,param_4: *mut u16,param_5: i32)
...
// WARNING: Globals starting with '_' overlap smaller symbols at the same address
pub unsafe fn pass1_1028_6daa(param_1: *mut astruct_15,mut param_2: u32,param_3: *mut u16,param_4: *mut u16,mut param_5: u16 )
...
//      if ((uVar7 | paVar4) == 0) goto LAB_1028_7066;
    ...
    pass1_1030_38b8();
  } while ((param_1 < 0x0) || ((param_1 < 0x1 && (iVar16 == 0))));
  bVar3 = false;//
// LAB_1028_7066:
  ...
  if (!bVar1) {
    ...
    if (uVar7 != 0) {
      ...
      iVar16 = 0x1;
      paVar10 =
                mixed_1010_20ba(paVar8,_u16_1050_0ed0,0x2b,in_stack_0000fe5c,in_stack_0000ff80,
  ...
  if ((bVar2) && (bVar3)) {
    ...
    uVar14 = 0;
    paVar11 =
              mixed_1010_20ba(paVar8,_u16_1050_0ed0,0x37,in_stack_0000fe52,in_stack_0000ff76,
  ...
  paVar5 = paVar4;
  if ((((((uVar7 | paVar4) != 0) &&
        (paVar5 = pass1_1030_2242(CONCAT22(uVar7,paVar4),0x4), paVar5.is_null())) &&
       (paVar5 = pass1_1030_2242(CONCAT22(uVar7,paVar4),0x2a), paVar5.is_null())) &&
      ((paVar5 = pass1_1030_2242(CONCAT22(uVar7,paVar4),0x4b), paVar5.is_null() &&
       (paVar5 = pass1_1030_2242(CONCAT22(uVar7,paVar4),0x54), paVar5.is_null())))) &&
     ((paVar5 = pass1_1030_2242(CONCAT22(uVar7,paVar4),0x2c), paVar5.is_null() &&
      ((paVar5 = pass1_1030_2242(CONCAT22(uVar7,paVar4),0x3c), paVar5.is_null() &&
       (paVar5 = pass1_1030_2242(CONCAT22(uVar7,paVar4),0x3d), paVar5.is_null())))))) {
    if (local_14.field6_0x10 == 0) {
...
//        if ((uVar7 | paVar5) == 0) goto LAB_1028_72d3;
      ...
      uVar20 = (param_2 >> 0x10);
      paVar4 = paVar5;
      if ((!bVar2) && (pass1_1028_740c(param_2,uVar20,0x22,CONCAT22(uVar7,paVar5)), paVar4.is_null() == false)) {
        bVar2 = true;
      }
      if ((!bVar3) && (pass1_1028_740c(param_2,uVar20,0x24,CONCAT22(uVar7,paVar5)), paVar4.is_null() == false)) {
        bVar3 = true;
      }
    } while ((!bVar2) || (!bVar3));
    uVar21 = 0;
...
// LAB_1028_72d3:
  ...
  if (uVar7 != 0) {
    paVar12 =
              mixed_1010_20ba(paVar8,_u16_1050_0ed0,CONCAT22(param_3,0x3b),in_stack_0000fe60,
    ...
    paVar13 =
              mixed_1010_20ba(paVar8,_u16_1050_0ed0,CONCAT22(param_3,0x3c),in_stack_0000fe60,
                              in_stack_0000ff84,in_stack_0000ff8a,in_stack_0000ff8e);
    uVar9 = paVar13 >> 0x10;
