...
pub unsafe fn pass1_1028_6356(
    ...
    loop {
        loop {
            ...
            if !((((iVar5 + 0x8) == 0) || (param_2 != 0x0 && ((iVar5 + 0x8) != param_2)))
...
pub unsafe fn pass1_1028_64d6(mut param_1: u32, mut param_2: u32) -> u16 {
    ...
    if (BVar2 != 0) {
        ...
        loop {
            BVar2 =
                write_to_file_1008_7e1c(param_2, CONCAT22(0x1050, puVar3), 0x2, in_stack_0000ffc4);
            if (BVar2 == 0) {
                break;
            }
    ...
    if (param_1 != 0) {
        ...
        if (BVar3 != 0) {
            ...
            loop {
                ...
                BVar3 =
                    read_file_1008_7dee(param_4, (paStack20 & 0xffff0000 | (paStack20 + 0xa)), 0x2);
                if (BVar3 == 0) {
                    break;
                }
                BVar3 =
                    read_file_1008_7dee(param_4, (paStack20 & 0xffff0000 | (paStack20 + 0xc)), 0x2);
                if (BVar3 == 0) {
                    break;
                }
