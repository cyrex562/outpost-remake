...

{
  ...
  if (uVar7 != 0) {
    ...
    if (uVar1 != param_6) {
      ...
      if (((puVar3 == NULL) || ((uVar8 | uVar5) == 0)) || (*(i32 *)(uVar5 + 0x200) != *(i32 *)(uVar4 + 0x200))) {
        return;
      }
  ...
  if (uVar7 != 0) {
    ...
    if ((((pSVar5 + 0x30) | uStack14) != 0) &&
      ...
      if (BVar3 == 0) {
        ...
        if ((BVar3 != 0) && (((qword)*_PTR_LOOP_1050_65e2 % 0x5) == 0)) {
          return;
        }
      }
      else if (((qword)*_PTR_LOOP_1050_65e2 % 0xa) == 0) {
        return;
      }
      uVar12 = (uVar1 >> 0x10);
      if ((uStack14 + 0x204) == 0) {
