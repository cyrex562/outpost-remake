...

{
  ...
  if (((uStack16 | uVar2) == 0x0) && (*(i32 *)(iVar7 + 0x200) != 0x8000002)) {
    pass1_1030_38b8();
    if ((-0x1 < paVar4) && ((0x0 < paVar4 || (uVar2 != 0x0)))) {
      paVar6 = (astruct_27 *)
...

{
  ...
  if (((param_2 + 0x204) != 0x0) &&
     (BVar4 = pass1_1030_25b2(CONCAT13((uVar3 >> 0x8),CONCAT12(uVar3,uVar5)),0x80), BVar4 != 0x0)) {
    return;
  }
  uVar9 = (uVar1 >> 0x10);
  uVar5 = uVar1 + 0x180;
...

{
  ...
  if ((param_2 < 0x3fff) || ((param_2 < 0x4000 && (param_1 != 0xffff)))) {
    ...
    uStack14 = (uVar2 >> 0x10);
    uStack14 |= uVar2;
    if ((uStack14 != 0x0) && (uVar4 = (param_6 >> 0x10), *(i32 *)(param_6 + 0x200) != 0x8000002)
       ) {
      paVar5 = (astruct_27 *)
               mixed_1010_20ba((astruct_57 *)(uStack14 % (long)uStack16 & 0xffff0000U | uStack14),
...

{
  ...
  pass1_1030_375a((param_1 + 0x1f6),0x0,(long)(param_3 + 0x114));
  return;
}
