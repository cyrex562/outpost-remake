...
pub unsafe fn write_to_file_1028_3d0e(
    ...
    if (BVar1 != 0) {
        ...
        BVar1 =
            write_to_file_1008_7e1c(param_3, CONCAT22(0x1050, local_10), 0x4, in_stack_0000ffd8);
        if (BVar1 != 0) {
            local_8 = (iVar2 + 0x24);
