...
pub unsafe fn pass1_1028_2418(mut param_1: u32, mut param_2: u32) -> BOOL16 {
    ...
    if (BVar2 != 0) {
        ...
        uStack16 = local_1c[0];
        BVar2 =
            write_to_file_1008_7e1c(param_2, CONCAT22(0x1050, local_1c), 0x2, in_stack_0000ffce);
        if (BVar2 == 0) {
            u16_1050_0310 = 0x6d0;
            return BVar2;
        }
