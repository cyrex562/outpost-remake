...
{
  paVar1: *mut astruct_21;
  let mut uVar2: u16;
  let mut ppcVar3: *mut *mut code;
  let mut uVar4: u32;
  iVar5: *mut astruct_15;
  uVar5: *mut astruct_15;
  let mut uVar6: u32;
...
pub unsafe fn pass1_1028_20b0() -> u16
...

{
  ...
  if ((uVar3 + 0x12) == 0x5) {
    ...
    pass1_1008_3eb4(CONCAT22(0x1050,&uStack16),CONCAT22(0x1050,auStack22),
                    CONCAT22(0x1050,&iStack20),CONCAT22(0x1050,&iStack18));
    uStack16 = uStack16 & 0xffff | (iStack20 - 1) << 0x10;
    uVar1 = pass1_1028_21ba(&uStack16,puVar2,uVar3,uVar4,CONCAT22(0x1050,&uStack16),uStack6);
    if (uVar1 == 0) {
      uStack16 = uStack16 & 0xffff | (iStack20 + 1) << 0x10;
      uVar1 = pass1_1028_21ba(&uStack16,puVar2,uVar3,uVar4,CONCAT22(0x1050,&uStack16),uStack6);
      if (uVar1 == 0) {
...
pub unsafe fn pass1_1028_21ba(mut param_1: u16 ,mut param_2: u16 ,mut param_3: u16 ,mut param_4: u16 ,param_5: *mut u16,param_6: i32) -> u16
...
u16
pass1_1028_2220(mut param_1: u16 ,mut param_2: u16 ,mut param_3: u16 ,mut param_4: u16 ,mut param_5: i16,param_6: *mut u16,param_7: i32
               )
...
pub unsafe fn pass1_1028_2290(mut param_1: u32,param_2: *mut u32,mut param_3: u16 ,mut param_4: u16 ,mut param_5: u16 ,param_6: i32) -> i16

{
  ...
  uVar2 = param_1;
  uVar3 = (param_1 >> 0x10);
  iVar1 = pass1_1028_2220(&local_8,param_3,uVar2,uVar3,0x16,CONCAT22(0x1050,&local_8),param_6);
  if (iVar1 == 0) {
    local_8 = local_8 & 0xffff | (local_c + 1) << 0x10;
    iVar1 = pass1_1028_2220(&local_8,param_3,uVar2,uVar3,0x16,CONCAT22(0x1050,&local_8),param_6);
    if (iVar1 == 0) {
      local_8 = local_a + -0x1;
      local_8 = local_c;
      iVar1 = pass1_1028_2220(&local_8,param_3,uVar2,uVar3,0x17,CONCAT22(0x1050,&local_8),param_6);
      if (iVar1 == 0) {
...
// WARNING: Globals starting with '_' overlap smaller symbols at the same address
pub fn pass1_1028_23a8(mut param_1: u16 ,mut param_2: u16 ,param_3: *mut u16,mut param_4: u32,param_5: i32)
...
pub fn pass1_1028_2418(mut param_1: u32,mut param_2: u32) -> BOOL16
...
pub fn file_1028_24a2(mut param_1: i16,param_2: *mut u8,param_3: *mut astruct_373,param_4: *mut HFILE16) -> BOOL16
...
pub fn pass1_1028_254c(param_1: *mut StructD,param_2: u8) -> *mut StructD
...
pub fn pass1_1028_25fc(mut param_1: u16 ,param_2: *mut astruct_12,mut param_3: i16,mut param_4: u32) -> *mut u16
...
pub fn pass1_1028_2626(param_1: *mut StructD,param_2: u8) -> *mut StructD
...
pub fn pass1_1028_26d6(param_1: *mut StructD,param_2: *mut astruct_12,mut param_3: i16,mut param_4: u32) -> *mut u16
...
pub fn pass1_1028_2762(param_1: *mut StructD,param_2: u8) -> *mut StructD
...
pub fn pass1_1028_2812(mut param_1: u16 ,param_2: *mut astruct_12,mut param_3: i16,mut param_4: u32) -> *mut u16
...
pub unsafe fn pass1_1028_2844(mut param_1: u32,param_2: *mut u32,mut param_3: u16 ,mut param_4: u16 ,mut param_5: u16 ,param_6: i32) -> u16

{
  ...
  uVar3 = param_1;
  uVar4 = (param_1 >> 0x10);
  BVar1 = pass1_1028_c5a6(&local_8,param_3,uVar3,uVar4,0x7b,CONCAT22(0x1050,&local_8),param_6);
  if (BVar1 == 0) {
    uVar2 = pass1_1028_297c(&local_8,param_3,param_1,CONCAT22(0x1050,&local_8),param_6);
    if (uVar2 == 0) {
      local_8 = local_8 & 0xffff | (local_c + 1) << 0x10;
      BVar1 = pass1_1028_c5a6(&local_8,param_3,uVar3,uVar4,0x7b,CONCAT22(0x1050,&local_8),param_6);
      if (BVar1 == 0) {
        ...
        if (uVar2 == 0) {
          local_8 = local_a + -0x1;
          local_8 = local_c;
          BVar1 = pass1_1028_c5a6(&local_8,param_3,uVar3,uVar4,0x7c,CONCAT22(0x1050,&local_8),param_6);
          if (BVar1 == 0) {
            uVar2 = pass1_1028_297c(&local_8,param_3,param_1,CONCAT22(0x1050,&local_8),param_6);
            if (uVar2 == 0) {
              local_8 = CONCAT22(local_8,local_a + 1);
              BVar1 = pass1_1028_c5a6(&local_8,param_3,uVar3,uVar4,0x7c,CONCAT22(0x1050,&local_8),
                                      param_6);
              if (BVar1 == 0) {
                uVar3 = pass1_1028_297c(&local_8,param_3,param_1,CONCAT22(0x1050,&local_8),param_6);
                if (uVar3 == 0) {
                  return uVar3;
                }
              }
...
pub unsafe fn pass1_1028_297c(mut param_1: u16 ,mut param_2: u16 ,mut param_3: u32,param_4: *mut u16,param_5: i32) -> u16
...
pub fn pass1_1028_2a6c(param_1: *mut StructD,param_2: u8) -> *mut StructD
...
pub fn pass1_1028_2b1c(mut param_1: u16 ,mut param_2: i16,mut param_3: u16 ,mut param_4: i16,mut param_5: u32) -> *mut u16
...
pub fn pass1_1028_2b4e(mut param_1: u16 ,param_2: *mut StructD,param_3: u8) -> *mut StructD
...
pub fn pass1_1028_2bfe(mut param_1: u16 ,param_2: *mut astruct_179,mut param_3: u16 ,mut param_4: i16,mut param_5: u32) -> *mut u16
...
pub unsafe fn pass1_1028_2c28(mut param_1: u16 ,mut param_2: u16 ,mut param_3: u32,param_4: *mut u32,mut param_5: u32,mut param_6: u32) -> u16

{
  ...
  if (param_1 != 0) {
    ...
    uStack4 = (param_4 + 0x4);
    puVar2 = &local_e;
    pass1_1008_3eb4(CONCAT22(0x1050,&local_8),CONCAT22(0x1050,puVar2),
                    CONCAT22(0x1050,&local_c),CONCAT22(0x1050,&local_a));
    pass1_1008_3e76(CONCAT22(0x1050,&local_8),local_e,local_c - 0x1,local_a - 1);
    puVar1 = &local_8;
    uVar3 = param_3;
    uVar4 = (param_3 >> 0x10);
...
// WARNING: Globals starting with '_' overlap smaller symbols at the same address
pub fn pass1_1028_2e40(param_1: u8,mut param_2: i16,param_3: *mut u8,param_4: *mut u32)

{
  let mut in_register_0000000a: u16;
  let mut paVar1: *mut Struct57;
  paVar2: *mut astruct_27;
  ...
  if ((param_4 + 0x12) == 0x5) {
    ...
    iVar4 = 0x5;
    paVar2 =
             mixed_1010_20ba(paVar1,_u16_1050_0ed0,0x1002b,in_stack_0000fe9e,in_stack_0000ffc2,
...
// WARNING: Globals starting with '_' overlap smaller symbols at the same address
pub fn pass1_1028_2e84(param_1: *mut StructD,param_2: *mut astruct_15,mut param_3: u16 ,mut param_4: i16)

{
  let mut paVar1: *mut Struct57;
  paVar2: *mut astruct_67;
  paVar3: *mut astruct_27;
  ...
  if (param_4 == 0) {
    ...
    uVar5 = 0;
    paVar2 =
             mixed_1010_20ba(param_1,_u16_1050_0ed0,0x37,in_stack_0000fe88,in_stack_0000ffac
    ...
    uVar5 = 0x1;
    paVar3 =
             mixed_1010_20ba(paVar1,_u16_1050_0ed0,0x1002b,in_stack_0000fe90,in_stack_0000ffb4,
    ...
    puVar4 = mixed_1010_20ba(paVar1,_u16_1050_0ed0,CONCAT22(param_3,0x2f),in_stack_0000fe96,
                             in_stack_0000ffba,in_stack_0000ffc0,in_stack_0000ffc4);
    paVar1 = (paVar1 & 0xffff0000 | puVar4 >> 0x10);
    pass1_1010_ec84(puVar4);
    puVar4 = mixed_1010_20ba(paVar1,_u16_1050_0ed0,CONCAT22(param_3,0x8),in_stack_0000fe96,
                             in_stack_0000ffba,in_stack_0000ffc0,in_stack_0000ffc4);
...

{
  ...
  local_18 = (iVar1 + 0xc);
  uStack20 = (iVar1 + 0x10);
  pass1_1008_3eb4(CONCAT22(0x1050,&local_18),CONCAT22(0x1050,&local_1e),
                  CONCAT22(0x1050,&local_1e + 0x2),CONCAT22(0x1050,&local_1a));
  pass1_1008_3e76(CONCAT22(0x1050,&local_18),local_1e,local_1e - 0x1,local_1a - 1);
  struct_op_1028_87f0(CONCAT22(0x1050,local_142),0x0,0x0,0xd,&local_18,&DAT_1050_1050,uStack18,
                      uStack6);
  fn_ptr_1030_835a(_u16_1050_5748,CONCAT22(0x1050,local_142));
  pass1_1008_3e76(CONCAT22(0x1050,&local_18),local_1e,local_1e + 0x1,local_1a + 1);
  struct_op_1028_87f0(CONCAT22(0x1050,local_266),0x0,0x0,0xc,&local_18,&DAT_1050_1050,uStack18,
                      uStack6);
  fn_ptr_1030_835a(_u16_1050_5748,CONCAT22(0x1050,local_266));
  pass1_1008_3e76(CONCAT22(0x1050,&local_18),local_1e,local_1e + 0x1,local_1a - 1);
  struct_op_1028_87f0(CONCAT22(0x1050,local_38a),0x0,0x0,0xe,&local_18,&DAT_1050_1050,uStack18,
                      uStack6);
  fn_ptr_1030_835a(_u16_1050_5748,CONCAT22(0x1050,local_38a));
  puVar5 = pass1_1008_3e54(CONCAT22(0x1050,&local_390),local_1e,local_1e - 0x1,local_1a + 1);
  uVar3 = (puVar5 >> 0x10);
  struct_op_1028_87f0(CONCAT22(0x1050,local_4b4),0x0,0x0,0xb,&local_390,&DAT_1050_1050,uStack18,
                      uStack6);
  fn_ptr_1030_835a(_u16_1050_5748,CONCAT22(0x1050,local_4b4));
  pass1_1008_3e76(CONCAT22(0x1050,&local_18),local_1e,local_1e - 0x1,local_1a);
  struct_op_1028_87f0(CONCAT22(0x1050,local_5d8),0x0,0x0,0x7a,&local_18,&DAT_1050_1050,uStack18,
                      uStack6);
  fn_ptr_1030_835a(_u16_1050_5748,CONCAT22(0x1050,local_5d8));
  pass1_1008_3e76(CONCAT22(0x1050,&local_18),local_1e,(local_1e >> 0x10),local_1a + 1);
  struct_op_1028_87f0(CONCAT22(0x1050,local_6fc),0x0,0x0,0x7a,&local_18,&DAT_1050_1050,uStack18,
                      uStack6);
  fn_ptr_1030_835a(_u16_1050_5748,CONCAT22(0x1050,local_6fc));
  pass1_1008_3e76(CONCAT22(0x1050,&local_18),local_1e,local_1e + 0x1,local_1a);
  struct_op_1028_87f0(CONCAT22(0x1050,local_820),0x0,0x0,0x7a,&local_18,&DAT_1050_1050,uStack18,
                      uStack6);
  fn_ptr_1030_835a(_u16_1050_5748,CONCAT22(0x1050,local_820));
  pass1_1008_3e76(CONCAT22(0x1050,&local_18),local_1e,(local_1e >> 0x10),local_1a - 1);
  struct_op_1028_87f0(CONCAT22(0x1050,local_944),0x0,0x0,0x7a,&local_18,&DAT_1050_1050,uStack18,
                      uStack6);
  fn_ptr_1030_835a(_u16_1050_5748,CONCAT22(0x1050,local_944));
  puVar2 = &local_390;
  pass1_1030_627e(puVar2,uVar3,_PTR_LOOP_1050_5740,CONCAT22(0x1050,puVar2),uStack6);
  uVar4 = (uStack14 >> 0x10);
