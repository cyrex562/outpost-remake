...
u16 write_to_file_1028_1452(param_1: *mut astruct_731,param_2: *mut u8)
...

{
  ...
  if (paVar1 < (astruct_409 *)(&u16_1050_0008 + 1)) {
    switch(paVar1) {
    case NULL:
...

{
  ...
  *piVar1 = *piVar1 + -0x1;
  if (*piVar1 == 0) {
    ...
    struct_op_1028_87f0((astruct_97 *)CONCAT22(0x1050,&local_15e),0x0,0x0,(-(local_16 == 0) & 0xffd3) + 0x60,
