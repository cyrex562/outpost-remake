...

{
  ...
  while( true ) {
    ...
    uVar2 = uVar4;
    uVar6 = uVar5;
    paVar7 = (astruct_670 *)(uVar4 & 0xffff | uVar5 << 0x10);
    pass1_1028_b58e(param_3);
    puVar3 = local_a;
...

{
  ...
  struct_op_1028_87f0((astruct_97 *)CONCAT22(0x1050,local_12e),0x0,0x0,0x65,(iStack6 + 0xc),uStack4,
                      (uStack10 + 0x4),uVar1);
...

{
  ...
  pass1_1028_b58e(param_3);
  uVar1 = (param_1 + 0x2e);
  pass1_1028_68de((astruct_97 *)CONCAT22(0x1050,local_11c),0x1,(uVar1 + 0x4));
...

{
  ...
  if (pstruct15_5.field15_0x12 == 0x5) {
    pstruct15_5.field24_0x20 = (astruct_21 *)(s_New_failed_in_Op__Op__DialogCtr_1050_0053 + 0x11);
    pass1_1028_b58e(param_3);
    uVar3 = (param_1 + 0x2e);
    iVar3 = 0x61;
    uVar2 = extraout_DX;
