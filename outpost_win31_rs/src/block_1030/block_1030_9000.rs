...
pub unsafe fn pass1_1030_9048(mut param_1: u32, mut param_2: i16, mut param_3: u32) {
    let mut uVar1: u32;
    ...
    if ((uStack12 | puVar12) != 0) {
        ...
        ppcVar2 = *puVar12;
        (**ppcVar2)(
            0x1030, puVar12, uVar20, 0x1, uVar11, uVar13, uStack12, uStack12,
        );
    }
    return;
}
...
pub unsafe fn pass1_1030_9296(
    ...
    let mut in_EAX: *mut astruct_99;
    let mut uVar3: u32;
    let mut uVar4: u16;
    let mut uVar6: u16;
    let mut in_register_0000000a: u16;
    let mut paVar7: *mut Struct57;
    let mut iVar11: *mut astruct_99;
    let mut pstruct99_10: *mut astruct_99;
    let mut iVar9: *mut astruct_99;
    ...
    let mut pstruct99_18: *mut astruct_99;
    ...
    puStack10 = mixed_1010_20ba(
        paVar7,
        _u16_1050_0ed0,
        CONCAT22(in_stack_0000ffc2, 0x8),
        in_stack_0000fe6a,
        in_stack_0000ff8e,
        in_stack_0000ff94,
        in_stack_0000ff98,
...
pub unsafe fn pass1_1030_951a(
    ...
    let mut paStack58: *mut astruct_99;
    ...
    let mut puStack10: *mut u32;
    let mut paStack6: *mut astruct_99;
    let mut uVar2: *mut astruct_99;
    let mut uVar3: *mut astruct_99;
    let mut uVar4: *mut astruct_99;
    let mut uVar5: *mut astruct_99;
...
pub unsafe fn pass1_1030_9adc(
    ...
    let mut ppcVar1: *mut *mut code;
    let mut pstruct99_2: *mut astruct_99;
    let mut uVar2: u16;
    let mut extraout_DX: u16;
    let mut extraout_DX_00: u16;
    let mut pstruct99_7: *mut astruct_99;
    let mut iVar6: *mut astruct_99;
    let mut pstruct99_6: *mut astruct_99;
    let mut pstruct99_3: *mut astruct_99;
...
pub unsafe fn pass1_1030_9c1c(mut param_1: u32, param_2: *mut u32, mut param_3: u32) {
    let mut ppcVar1: *mut *mut code;
    let mut uVar2: u16;
    let mut uVar3: u16;
    let mut uVar4: u16;
    ...
    if ((param_5 + 0x206) == 0) {
        ...
        loop {
            ...
            if (iStack4 == 0) {
                ...
                for iStack154 in 0x11..0x25 {
                    iVar10 = iStack154 * 0x4;
                    if (((pcVar7 + iVar10) != 0)
                        && (
                            pSVar3 = (&local_98)[iStack154],
                            ppSVar2 = (pcVar7 + iVar10),
...
pub unsafe fn pass1_1030_9f40(param_1: u8, mut param_2: u32, mut param_3: u16) {
    let mut uVar1: u16;
...
pub unsafe fn pass1_1030_9f64(param_1: u32) {
    (param_1 + 0x8) = 0;
    *param_1 = 0;
    return;
}
...
pub unsafe fn pass1_1030_9f7a(param_1: *mut u16, mut param_2: u16) {
    let mut uVar1: u32;
    let mut BVar2: bool;
    ...
    let mut paStack16: *mut astruct_15;
    let mut uStack12: u32;
    let mut local_8: u32;
    let mut iStack4: i16;
