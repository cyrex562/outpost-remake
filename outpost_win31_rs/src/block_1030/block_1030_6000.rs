...
u16 pass1_1030_6222(mut param_1: u16 ,param_2: *mut u8,mut param_3: u32,mut param_4: i16,mut param_5: u32,mut param_6: u32)
...

{
  ...
  if (uVar3 == 0) {
    ...
    struct_op_1030_1cd8((astruct_75 *)CONCAT13((paVar5 >> 0x8),CONCAT12(paVar5,puVar2)),0x5,0x5);
  }
  param_1 = puVar2;
  (param_1 + 0x2) = uVar3;
...

{
  ...
  if ((*(i32 *)(iVar3 + 0x22) != 0) && (pass1_1020_ba94(*(i32 **)(iVar3 + 0x22)), (param_2 | param_1) != 0)) {
    return;
  }
...
u16 pass1_1030_6db4(param_1: *mut u8)
...

{
  ...
  if ((*(i32 *)(iVar2 + 0x1a) != 0) && (uVar1 = (iVar2 + 0x1a), (uVar1 + 0x12) == 0x4)) {
    return;
  }
  return;
}
