...

{
  ...
  while( true ) {
    ...
    if (*(i32 *)(uVar2 + uStack6 * 0x4) == 0) break;
    uStack6 += 0x1;
  }
  return;
}
...
u16 file_1030_1b18(mut param_1: i16,param_2: *mut u8,mut param_3: u32,mut param_4: u32)
...

{
  ...
  iVar5 = param_1;
  puVar1 = (iVar5 + 0x8);
  if ((*puVar1 < param_4 || *puVar1 == param_4) || (*(i32 *)(iVar5 + 0x4) == 0)) {
    puVar2 = (iVar5 + 0x12);
...

{
  ...
  while( true ) {
    ...
    puVar1 = (param_1 + 0x8);
    if ((*puVar1 < uStack6 || *puVar1 == uStack6) ||
       (uVar3 = (param_1 + 0x4), *(i32 *)(uVar3 + uStack6 * 0x4) == 0)) break;
    uStack6 += 0x1;
  }
...

{
  ...
  uVar5 = (param_1 >> 0x10);
  iVar4 = param_1;
  if ((*(i32 *)(iVar4 + 0x4) == 0) || ((iVar4 + 0x10) <= (iVar4 + 0x8))) {
