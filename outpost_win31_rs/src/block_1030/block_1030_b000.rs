...
pub unsafe fn pass1_1030_b454(mut param_1: u32, mut param_2: u32) {
    ...
    pass1_1030_b13c();
    uStack30 = CONCAT22(
        -((s_Unsupported_FileStructType_in_Op_1050_01ca + 0x2a) < puVar3) - iVar4,
        0x1f4 - puVar3,
    );
    loop {
        puVar3 = local_12;
...
pub unsafe fn pass1_1030_b578(mut param_1: u32) {
    ...
    if (iVar1 == 1) {
        ...
        pass1_1030_b2aa(
            puVar4,
            param_1 & 0xffff | ZEXT24(param_1) << 0x10,
...
pub unsafe fn pass1_1030_b936(
    mut param_1: u16,
    param_2: *mut astruct_365,
    mut param_3: u16,
    mut param_4: u16,
    mut param_5: u32,
) {
