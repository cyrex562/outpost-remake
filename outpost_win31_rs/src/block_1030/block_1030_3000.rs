...
pub unsafe fn pass1_1030_314c(mut param_1: u16, param_2: *mut astruct_364, mut param_3: u32) {
    ...
    let mut pstruct_1: *mut astruct_364;
    ...
    pass1_1000_4906(
        (param_2 & 0xffff0000 | ZEXT24(&pstruct_1.field_0x4)),
        NULL,
        0x16c,
    );
    pass1_1000_4906(
        (param_2 & 0xffff0000 | ZEXT24(&pstruct_1.field_0x18c)),
        NULL,
        0x18,
    );
    pass1_1000_4906(
        (param_2 & 0xffff0000 | ZEXT24(&pstruct_1.field_0x174)),
        NULL,
        0xc,
    );
    pass1_1000_4906(
        (param_2 & 0xffff0000 | ZEXT24(&pstruct_1.field_0x180)),
        NULL,
        0xc,
    );
    mixed_1010_20ba(
...
pub unsafe fn write_to_file_1030_32e4(mut param_1: u32, mut param_2: u32) {
    ...
    let mut BVar2: bool;
    let mut uVar3: u16;
    let mut in_stack_0000ffd0: HFILE16;
    ...
    if (BVar2 != 0) {
        BVar2 = write_to_file_1008_7e1c(
            param_2,
            param_1 & 0xffff0000 | (iVar1 + 0x174),
            &DAT_0000_000c,
            in_stack_0000ffd0,
        );
        if (BVar2 != 0) {
            BVar2 = write_to_file_1008_7e1c(
                param_2,
                param_1 & 0xffff0000 | (iVar1 + 0x180),
                &DAT_0000_000c,
                in_stack_0000ffd0,
            );
            if (BVar2 != 0) {
                BVar2 = write_to_file_1008_7e1c(
                    param_2,
                    param_1 & 0xffff0000 | (iVar1 + 0x18c),
                    0x18,
                    in_stack_0000ffd0,
                );
                if (BVar2 != 0) {
...
pub unsafe fn read_file_1030_33f0(param_1: *mut astruct_430, param_2: *mut HFILE16) {
    ...
    if (((((BVar1 != 0)
        && (
            BVar1 = read_file_1008_7dee(
                param_2,
                (param_1 & 0xffff0000 | ZEXT24(&iVar2.field_0x174)),
                0xc,
            ),
            BVar1 != 0,
        ))
        && (
            BVar1 = read_file_1008_7dee(
                param_2,
                (param_1 & 0xffff0000 | ZEXT24(&iVar2.field_0x180)),
                0xc,
            ),
            BVar1 != 0,
        ))
        && ((
            BVar1 = read_file_1008_7dee(
                param_2,
                (param_1 & 0xffff0000 | ZEXT24(&iVar2.field_0x18c)),
                0x18,
            ),
            BVar1 != 0x0
                && (
                    BVar1 = read_file_1008_7dee(
                        param_2,
                        (param_1 & 0xffff0000 | ZEXT24(&iVar2.field_0x1a8)),
                        0x2,
                    ),
                    BVar1 != 0,
                ),
        ...
        && (
            BVar1 = read_file_1008_7dee(
                param_2,
                (param_1 & 0xffff0000 | ZEXT24(&iVar2.field_0x1aa)),
                0x4,
            ),
            BVar1 != 0,
        ))
    {
        ...
        BVar1 = read_file_1008_7dee(
            param_2,
            (param_1 & 0xffff0000 | ZEXT24(&iVar2.field_0x170)),
            0x4,
        );
        if ((BVar1 != 0)
            && (
                BVar1 = read_file_1008_7dee(
                    param_2,
                    (param_1 & 0xffff0000 | ZEXT24(&iVar2.field_0x1ae)),
                    0x2,
                ),
                BVar1 != 0,
            ))
...
pub unsafe fn pass1_1030_34da(param_1: *mut astruct_364) {
    ...
    pass1_1000_4906(
        (param_1 & 0xffff0000 | ZEXT24(&iVar1.field_0x18c)),
        NULL,
        0x18,
    );
    return;
...
pub unsafe fn pass1_1030_35a4(param_1: *mut u8, mut param_2: u32, param_3: i32) {
    ...
    pass1_1030_3948(
        ...
        CONCAT13(0x10, CONCAT12(0x50, local_c)),
        0x4,
    );
    loop {
        uVar5 = uVar6;
        ...
        *piVar2 = *piVar2 + pSVar8 + CARRY2(uVar3, uVar6);
        ...
        if !((iVar7 + pSVar8 + CARRY2(uVar5, uVar6) | uVar5 + uVar6) != 0) {
            break;
        }
    }
...
pub unsafe fn pass1_1030_3694(param_1: *mut u8, mut param_2: u32, mut param_3: i16, param_4: i32) {
        ...
        ))
    {
        ...
        pass1_1030_39dc(
            param_2,
            CONCAT22(0x1050, &param_4),
            CONCAT13((pSVar8 >> 0x8), CONCAT12(pSVar8, uVar4)),
            param_3,
        );
    }
    pass1_1000_4906((param_2 & 0xffff0000 | (param_2 + 0x18c)), NULL, 0x18);
...
pub unsafe fn pass1_1030_375a(mut param_1: u32, mut param_2: i16, param_3: i32) {
    ...
    if (param_2 == 0) {
        ...
        while (-0x1 < local_4
            && (
                pass1_1030_3a3a(param_1, CONCAT22(0x1050, &param_3), local_4),
                param_3 != 0,
            ))
        {
            local_4 += -0x1;
        ...
        uVar3 = lVar5;
        uStack18 = CONCAT22(
            ((param_3 >> 0x10) - (lVar5 >> 0x10)) - (param_3 < uVar3),
            param_3 - uVar3,
        );
        // for (iStack20 = local_6; iStack20 <= local_4; iStack20 += 1)
        for iStack20 in local_6..local_4 {
            iVar7 = iStack20 * 0x4;
            uVar8 = (param_1 >> 0x10);
...
pub unsafe fn pass1_1030_3a3a(mut param_1: u32, param_2: *mut i32, mut param_3: i16) {
    ...
    if ((iVar3 < iVar2)
        || ((
            uVar5 = *param_2,
            *piVar1 == iVar2 || iVar3 < iVar2 && ((iVar7 + iVar8) < uVar5),
        )))
    {
