...
pub unsafe fn pass1_1030_3006(mut param_1: u32,mut param_2: u32)

{
  (param_1 + 0x10) = param_2;
  return;
}
pub unsafe fn pass1_1030_301a(mut param_1: u16 ,mut param_2: u32,param_3: *mut c_char)

{
  let mut uVar1: u32;
  let mut uVar2: u16;
  let mut iVar4: i16;
  let mut iVar3: *mut astruct_608;
  let mut uVar5: u16;
...
pub unsafe fn pass1_1030_3058(mut param_1: u16 ,param_2: *mut astruct_57,param_3: *mut astruct_375) -> u16

{
  ...
  let mut uVar5: u16;
  let mut uVar6: u16;
  let mut iVar4: *mut astruct_375;
  let mut uVar7: *mut astruct_375;
  let mut uVar8: u32;
  let mut uStack4: u16;

  uVar7 = (param_3 >> 0x10);
  iVar4 = param_3;
  if (iVar4.field12_0xc.is_null()) {
  ...
  for (uStack4 = 0; uVar3 = iVar4.field13_0x10, puVar1 = (uVar3 + 0x22),
      uStack4 <= *puVar1 && *puVar1 != uStack4; uStack4 += 1) {
    uVar8 = pass1_1028_e2e0(param_2,_PTR_LOOP_1050_65e2,0x3);
    param_2 = (param_2 & 0xffff0000 | uVar8 >> 0x10);
    ppcVar2 = (*iVar4.field12_0xc + 0x8);
...
pub unsafe fn pass1_1030_310a(param_1: *mut StructD,param_2: u8) -> *mut StructD
...
// WARNING: Globals starting with '_' overlap smaller symbols at the same address
pub unsafe fn pass1_1030_314c(mut param_1: u16 ,param_2: *mut astruct_364,mut param_3: u32)

{
  let mut in_register_0000000a: u16;
  let mut paVar1: *mut Struct57;
  pstruct_1: *mut astruct_364;
  ...
  pstruct_1.field366_0x170 = 0;
  pstruct_1.field409_0x1a4 = param_3;
  pstruct_1.field410_0x1a8 = 0x5;
  pstruct_1.field411_0x1aa = 0;
  pstruct_1.field412_0x1ae = 0x10;
  param_2.field0_0x0 = 0x3af2;
  pstruct_1.field1_0x2 = 0x1030;
  pass1_1000_4906((param_2 & 0xffff0000 | ZEXT24(&pstruct_1.field_0x4)),NULL,0x16c);
  pass1_1000_4906((param_2 & 0xffff0000 | ZEXT24(&pstruct_1.field_0x18c)),NULL,0x18);
  pass1_1000_4906((param_2 & 0xffff0000 | ZEXT24(&pstruct_1.field_0x174)),NULL,0xc);
  pass1_1000_4906((param_2 & 0xffff0000 | ZEXT24(&pstruct_1.field_0x180)),NULL,0xc);
  mixed_1010_20ba(paVar1,_u16_1050_0ed0,CONCAT22(unaff_SI,0x2),in_stack_0000fe9a,in_stack_0000ffbe,
  ...
  if (PTR_LOOP_1050_13ae < 0x2) {
    ...
    for (iStack12 = 0x1; iStack12 < 0x6; iStack12 += 1) {
      (&pstruct_1.field_0x180 + iStack12 * 0x2) = 0x64;
    }
  }
  return;
}
pub unsafe fn pass1_1030_3258(mut param_1: u32,mut param_2: u16 )

{
  (param_1 + 0x1ae) = param_2;
  return;
}
pub unsafe fn pass1_1030_326a(mut param_1: u32,mut param_2: u16 ,param_3: *mut astruct_692)

{
  let mut uVar1: u16;
  let mut uVar2: u32;
  let mut uVar3: u16;
  let mut iVar4: *mut astruct_692;
  let mut uVar4: u16;
  let mut lStack6: i32;

  uVar4 = (param_3 >> 0x10);
  iVar4 = param_3;
  if (iVar4.field426_0x1aa == 0) {
...
pub unsafe fn write_to_file_1030_32e4(mut param_1: u32,mut param_2: u32)
...
pub unsafe fn read_file_1030_33f0(param_1: *mut astruct_430,param_2: *mut HFILE16)

{
  let mut iVar2: *mut astruct_430;
  let mut BVar1: bool;
...
pub unsafe fn pass1_1030_34da(param_1: *mut astruct_364)

{
  let mut iVar1: *mut astruct_364;
  let mut uVar1: u16;
  ...
  pass1_1000_4906((param_1 & 0xffff0000 | ZEXT24(&iVar1.field_0x18c)),NULL,0x18);
  return;
}
pub unsafe fn pass1_1030_3534(mut param_1: u32,mut param_2: u32)

{
  (param_1 + 0x4) = param_2;
  return;
}
pub unsafe fn pass1_1030_3548(mut param_1: u32,param_2: i32)
...
pub unsafe fn pass1_1030_355c(mut param_1: u32,mut param_2: u32)
...
// WARNING: Globals starting with '_' overlap smaller symbols at the same address
pub unsafe fn pass1_1030_35a4(param_1: *mut u8,mut param_2: u32,param_3: i32)

{
  ...
  pSVar8 = CONCAT22(in_register_0000000a,param_1);
  ...
  if (_PTR_LOOP_1050_5f2c == 0) {
    ...
    pSVar8 = (_PTR_LOOP_1050_5f2c >> 0x10);
  }
  ...
  uVar6 = (&local_a + 2);
  pass1_1030_3948(param_2,CONCAT22(0x1050,&local_a + 0x2),CONCAT13(0x10,CONCAT12(0x50,local_c)),
                  0x4);
  loop {
    uVar5 = uVar6;
    if (param_3 < 1) { break; }
...
// WARNING: Globals starting with '_' overlap smaller symbols at the same address
pub unsafe fn pass1_1030_3694(param_1: *mut u8,mut param_2: u32,mut param_3: i16,param_4: i32)

{
  ...
  uVar6 = (param_3 - 1);
  if (((param_3 < 1) || (SBORROW2(param_3,1))) ||
     (uVar6 = (param_3 - 0x5), param_3 - 0x5 != 0x0 && 0x3 < (param_3 - 1))) {
    while (uVar5 = uVar6, 0x0 < param_4) {
      pass1_1008_612e(uVar5,0x0,0x5a);
      uVar6 = ZEXT24(&param_4);
      pass1_1030_3a3a(param_2,CONCAT13(0x10,CONCAT12(0x50,&param_4)),uVar5);
      puVar1 = (uVar5 * 0x4 + uVar4);
      uVar3 = *puVar1;
      *puVar1 = *puVar1 + uVar6;
      piVar2 = (uVar5 * 0x4 + uVar4 + 2);
      *piVar2 = *piVar2 + pSVar8 + CARRY2(uVar3,uVar6);
    }
  }
  else {
    pass1_1030_39dc(param_2,CONCAT22(0x1050,&param_4),
...
pub unsafe fn pass1_1030_375a(mut param_1: u32,mut param_2: i16,param_3: i32)

{
  ...
  if (param_2 == 0) {
    local_4 = 0x5a;
    while ((-0x1 < local_4 && (pass1_1030_3a3a(param_1,CONCAT22(0x1050,&param_3),local_4), param_3 != 0))) {
      local_4 += -0x1;
    }
  }
  else {
    pass1_1030_3948(param_1,CONCAT22(0x1050,&local_4),CONCAT22(0x1050,&local_6),param_2);
    iVar2 = (local_4 - local_6) + 1;
    lVar4 = param_3 / iVar2;
    lVar5 = lVar4 * iVar2;
    uVar3 = lVar5;
    uStack18 = CONCAT22(((param_3 >> 0x10) - (lVar5 >> 0x10)) - (param_3 < uVar3),
                        param_3 - uVar3);
    for (iStack20 = local_6; iStack20 <= local_4; iStack20 += 1) {
      iVar7 = iStack20 * 0x4;
      uVar8 = (param_1 >> 0x10);
      ...
      if ((iVar6 + iStack20 * 0x4 + 0x6) < 0x0) {
        (iVar6 + iStack20 * 0x4 + 0x4) = 0;
      }
    }
  }
  pass1_1000_4906((param_1 & 0xffff0000 | (iVar6 + 0x18c)),NULL,0x18);
  return;
}
pub unsafe fn pass1_1030_387c(mut param_1: u32)
...
pub unsafe fn pass1_1030_38f2(mut param_1: u32,mut param_2: i16)

{
  ...
  for (iStack12 = local_8; iStack12 <= local_a; iStack12 += 1) {
  }
  return;
}
pub unsafe fn pass1_1030_3948(mut param_1: u32,param_2: *mut u16,param_3: *mut i16,mut param_4: i16)
...
pub unsafe fn pass1_1030_39dc(mut param_1: u32,param_2: *mut i32,mut param_3: u32,mut param_4: i16)
...
pub unsafe fn pass1_1030_3a3a(mut param_1: u32,param_2: *mut i32,mut param_3: i16)
...
pub unsafe fn pass1_1030_3ac6(param_1: *mut StructD,param_2: u8) -> *mut StructD
...
pub unsafe fn pass1_1030_3af6(param_1: u32,mut param_2: u16 ,mut param_3: u16 ,param_4: *mut u32,mut param_5: u16 ) -> *mut u32
...
pub unsafe fn pass1_1030_3b28() -> u16
