pub unsafe fn pass1_1030_d00c(param_1: *mut astruct_15, mut param_2: u16) {
    ...
    let mut local_BX_40: *mut astruct_696;
    let mut iVar2: i16;
    let mut iStack4: i16;
    ...
    loop {
        ...
        if (((iVar2 + 0x26) == 0) && (uVar1 = param_2, (iVar2 + 0x24) == param_2)) {
            break;
        }
        iStack4 += 0x1;
    }
...
pub unsafe fn pass1_1030_d180(mut param_1: u32, mut param_2: u16) {
    ...
    loop {
        ...
        uVar5 = (param_1 >> 0x10);
        uVar3 = param_1;
        if (((uVar3 + iStack4 * 0xc + 0x22) | (uVar3 + iStack4 * 0xc + 0x20)) == 0) {
            break;
        }
        iStack4 += 0x1;
    }
...
pub unsafe fn pass1_1030_da22(mut param_1: u32) {
    ...
    loop {
        ...
        if (((uVar8 != 0)
            && (
                BVar4 = pass1_1008_c6ae(_u16_1050_06e0, (uVar9 + 0xc), 0x4),
                BVar4 != 0,
            ))
            && (uVar5 = pass1_1028_6744(uVar9, 0xd), (uVar8 | uVar5) != 0))
        {
            break;
        }
        uStack18 += 0x1;
