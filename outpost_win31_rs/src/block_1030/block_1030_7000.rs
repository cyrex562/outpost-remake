...

{
  ...
  iVar4 = param_1;
  if (*(i32 *)(iVar4 + 0x1a) == 0) {
    struct_op_1030_73a8((astruct_419 *)(param_1 & 0xffff | uVar5 << 0x10),in_AX,in_DX);
  }
  uVar2 = (iVar4 + 0x1a);
  uVar1 = (uVar2 + 0xc);
...

{
  ...
  if ((BStack10 != 0) && (uVar1 = (iVar2 + 0x1a), (uVar1 + 0x12) == 0x5)) {
    ...
    for (uStack18 = 0; uStack18 < uStack14; uStack18 += 1) {
      pass1_1020_bb16((iVar2 + 0x22),CONCAT22(0x1050,&local_1a),CONCAT22(0x1050,local_16),
                      uStack18);
      if (0x0 < local_16[0]) {
        lStack6 += local_1a;
      }
...

{
  ...
  if (((BVar3 != 0) && (uVar2 = (iVar4 + 0x1a), (uVar2 + 0x12) == 0x5)) &&
     (uVar1 = (iVar4 + 0x1a), uVar2 = (uVar1 & 0xffff0000 | (uVar1 + 0x14)),
     (uVar2 + 0xa4) == 0x1e)) {
    return;
  }
  return;
...

{
  ...
  uVar3 = (astruct_292 *)(param_1 >> 0x10);
...

{
  ...
  iVar3 = write_to_file_1008_7b4c(param_3,(astruct_615 *)(param_2 & 0xffff0000 | ZEXT24(iVar2)));
  if (iVar3 == 0) {
    u16_1050_0310 = 0x6d0;
    return;
  }
  ...
  while( true ) {
    ...
    if ((extraout_DX | puVar5) == 0) {
      ...
      local_2a[0] = uStack62;
      BVar4 = write_to_file_1008_7e1c(param_3,CONCAT22(0x1050,local_2a),0x2,in_stack_0000ffac);
      if (BVar4 == 0) {
        u16_1050_0310 = 0x6d0;
        return;
      }
      ...
      while( true ) {
        ...
        BVar4 = write_to_file_1008_7e1c(param_3,CONCAT22(0x1050,&local_18),0x2,in_stack_0000ffac);
        if (BVar4 == 0) {
          u16_1050_0310 = 0x6d0;
          return;
        }
        local_14[0] = local_14[0] & 0xffff0000 | (puVar5 + 0x6);
        BVar4 = write_to_file_1008_7e1c(param_3,CONCAT22(0x1050,local_14),0x2,in_stack_0000ffac);
        if (BVar4 == 0) {
          u16_1050_0310 = 0x6d0;
          return;
        }
...
// WARNING: Could not reconcile some variable overlaps
// WARNING: Globals starting with '_' overlap smaller symbols at the same address
pub fn file_1030_778c(mut param_1: i16,param_2: *mut u8,param_3: *mut astruct_373,HFILE16 *param_4)

{
  ...
  if (param_1 != 0) {
    ...
    if ((BVar2 != 0) && (BVar2 = read_file_1008_7dee(param_4,CONCAT22(0x1050,&local_4),0x2), BVar2 != 0)) {
      uVar13 = (param_3 >> 0x10);
      iVar3->field18_0x12 = local_4;
      BVar2 = read_file_1008_7dee(param_4,CONCAT22(0x1050,&local_4),0x2);
      if (BVar2 != 0) {
        iVar3->field19_0x14 = local_4;
        BVar2 = read_file_1008_7dee(param_4,(param_3 & 0xffff0000 | ZEXT24(&iVar3->field_0x16)),0x4);
        if (BVar2 != 0) {
          plVar7 = (i32 *)(param_3 & 0xffff0000 | ZEXT24(&iVar3->field_0x1e));
          file_1008_76e4(paVar12,param_4,plVar7);
          if ((((plVar7 != 0) &&
               (iVar6 = file_1008_77cc(paVar12,param_4,
                                       (i32 *)(param_3 & 0xffff0000 | ZEXT24(&iVar3->field_0x22))), iVar6 != 0x0
               )) && (iVar6 = file_1008_77cc(paVar12,param_4,
                                             (i32 *)(param_3 & 0xffff0000 | ZEXT24(&iVar3->field_0x26))),
                     iVar6 != 0)) &&
             (BVar2 = read_file_1008_7dee(param_4,(param_3 & 0xffff0000 | ZEXT24(&iVar3->field40_0x2a)),0x4
                                         ), BVar2 != 0)) {
            ...
            BVar2 = read_file_1008_7dee(param_4,(param_3 & 0xffff0000 | ZEXT24(&iVar3->field_0x32)),0x2);
            if ((BVar2 != 0) &&
               (BVar2 = read_file_1008_7dee(param_4,(param_3 & 0xffff0000 | ZEXT24(&iVar3->field_0x34)),0x2
                                           ), BVar2 != 0)) {
              paVar8 = (astruct_169 *)(param_3 & 0xffff0000 | ZEXT24(&iVar3->field_0x36));
              pass1_1008_766e(paVar12,param_4,paVar8);
              if ((paVar8 != 0) &&
                 (BVar2 = read_file_1008_7dee(param_4,CONCAT22(0x1050,local_20),0x2), BVar2 != 0)) {
                for (uStack14 = 0; uVar15 = (paVar12 >> 0x10), uStack14 < local_20[0];
                  ...
                  if (((BVar2 == 0) ||
                      (BVar2 = read_file_1008_7dee(param_4,CONCAT22(0x1050,local_24),0x2), BVar2 == 0)) ||
                     ((BVar2 = read_file_1008_7dee(param_4,CONCAT22(0x1050,&local_2e),0x2), BVar2 == 0x0 ||
                      ((BVar2 = read_file_1008_7dee(param_4,(paStack44 & 0xffff0000 |
                                                                  (paStack44 + 0xa)),0x2), BVar2 == 0x0 ||
                       (BVar2 = read_file_1008_7dee(param_4,(paStack44 & 0xffff0000 |
                                                                  (paStack44 + 0xc)),0x2), BVar2 == 0)))))
                     ) goto LAB_1030_77be;
                  ...
                  if (iVar3->field51_0x3a == NULL) {
                    ...
                    paVar12 = (astruct_57 *)(paVar12 & 0xffff0000 | (uVar9 | uVar11));
                    if ((uVar9 | uVar11) == 0) {
                  ...
                  ppcVar1 = (code **)(*iVar3->field51_0x3a + 0x8);
                  (**ppcVar1)();
                }
                ...
                if (BVar2 != 0) {
                  ...
                  while( true ) {
                    ...
                    if ((((BVar2 == 0) ||
                         (BVar2 = read_file_1008_7dee(param_4,CONCAT22(0x1050,local_42),0x2), BVar2 == 0)) ||
                        (BVar2 = read_file_1008_7dee(param_4,CONCAT22(0x1050,local_3e),0x2), BVar2 == 0)) ||
                       ((BVar2 = read_file_1008_7dee(param_4,(paStack74 & 0xffff0000 |
                                                                   (paStack74 + 0xa)),0x2), BVar2 == 0x0 ||
                        (BVar2 = read_file_1008_7dee(param_4,(paStack74 & 0xffff0000 |
                                                                   (paStack74 + 0xc)),0x2), BVar2 == 0))))
                    break;
                    ...
                    if (iVar3->field52_0x3e == NULL) {
                      ...
                      paVar12 = (astruct_57 *)(paVar12 & 0xffff0000 | (uVar11 | local_3e[0]));
                    ...
                    ppcVar1 = (code **)(*iVar3->field52_0x3e + 0x8);
                    (**ppcVar1)();
                    uStack82 += 0x1;
                  }
                }
...

{
  ...
  if (*(i32 *)(iVar3 + 0x1a) == 0) {
    struct_op_1030_73a8((astruct_419 *)(param_1 & 0xffff | uVar4 << 0x10),in_AX,in_DX);
  }
...

{
  ...
  if (iVar8->field30_0x1e == NULL) {
    ...
    param_2 = (astruct_57 *)(param_2 & 0xffff0000 | (uVar4 | param_1));
    if ((uVar4 | param_1) == 0) {
  ...
  while (param_4 != 0) {
    ...
    param_2 = (astruct_57 *)(param_2 & 0xffff0000 | uVar6 >> 0x10);
    uVar3 = uVar6;
    puVar7 = iVar8->field30_0x1e;
    ppcVar2 = (code **)(*iVar8->field30_0x1e + 0xc);
    uVar8 = uVar6;
    (**ppcVar2)();
...

{
  ...
  uVar3 = (astruct_397 *)(param_3 >> 0x10);
...
pub fn pass1_1030_7d7c(mut param_1: u16 ,param_2: *mut u8,param_3: *mut astruct_398,mut param_4: u16 ,mut param_5: u32)

{
  ...
  paVar2 = (astruct_57 *)CONCAT22(in_register_0000000a,param_2);
  uVar3 = (astruct_398 *)(param_3 >> 0x10);
...

{
  ...
  if (*(i32 *)(iVar2 + 0x22) == 0) {
    ...
    param_2 = (astruct_57 *)(uVar2 | param_1);
    if ((uVar2 | param_1) == 0) {
      (iVar2 + 0x22) = 0;
    }
    else {
...

{
  ...
  uVar1 = (param_1 >> 0x10);
  if (*(i32 *)(param_1 + 0x1a) == 0) {
    struct_op_1030_73a8((astruct_419 *)(param_1 & 0xffff | uVar1 << 0x10),param_2,in_DX);
  }
  pass1_1028_bb96(*(astruct_295 **)(param_1 + 0x1a),&local_c,&DAT_1050_1050);
  return;
}
...

{
  ...
  iVar3 = param_2;
  if (*(i32 *)(iVar3 + 0x1a) == 0) {
    uVar5 = struct_op_1030_73a8((astruct_419 *)(param_2 & 0xffff | uVar4 << 0x10),in_AX,param_1);
    param_1 = (uVar5 >> 0x10);
  }
  uVar2 = (iVar3 + 0x1a);
  iVar1 = (uVar2 + 0xc);
