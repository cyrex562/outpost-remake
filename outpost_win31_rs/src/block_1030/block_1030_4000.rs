...

{
  ...
  *piStack6 = param_6;
  ...
  if (param_5 != 0) {
    ...
    if (param_4 != 0) {
      ppuStack160 = (u8 **)(&PTR_LOOP_1050_000e + 1);
      if (uStack14 == 0) {
      ...
      paVar8 = (astruct_57 *)(iVar10 % 0x64 & 0xffffU | uVar4 << 0x10);
      ...
      paVar8 = (astruct_57 *)(iVar10 % 0x64 & 0xffffU | uVar7 & 0xffff0000);
      uVar11 = (piStack6 >> 0x10);
