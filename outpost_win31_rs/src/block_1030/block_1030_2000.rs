...
pub unsafe fn pass1_1030_201e(param_1: *mut StructD,param_2: u8) -> *mut StructD
...
pub unsafe fn pass1_1030_2068(param_1: *mut astruct_180)
...
pub unsafe fn struct_1030_2112(mut param_1: u16 ,param_2: *mut u8,param_3: *mut astruct_366,mut param_4: u32)

{
  let mut in_register_0000000a: u16;
  pstruct_1: *mut astruct_366;
  let mut pstruct_1_hi: u16;
  let mut iStack4: i16;

  pass1_1030_183c(param_1,CONCAT22(in_register_0000000a,param_2),&param_3.field0_0x0,0x1,0x1,0x8000000,
                  param_4);
...
pub unsafe fn pass1_1030_2242(param_1: *mut astruct_168,mut param_2: i16) -> i16
...
pub unsafe fn pass1_1030_232e(mut param_1: i16,mut param_2: u16 ,mut param_3: u32,mut param_4: u32)
...
pub unsafe fn pass1_1030_23e2(mut param_1: i16,param_2: *mut u8,mut param_3: u32,mut param_4: i16,mut param_5: u16 )

{
  ...
  if ((uVar10 + 0x10 + param_5 * 0x2) < 0x0) {
    uVar7 = param_5;
    if (param_4 == 0) {
      puVar14 = mixed_1010_20ba(paVar9,_u16_1050_0ed0,CONCAT22(unaff_SI,0x31),in_stack_0000fe92,
      ...
      puVar14 = mixed_1010_20ba(paVar9,_u16_1050_0ed0,CONCAT22(unaff_SI,0x41),in_stack_0000fe92,
                                in_stack_0000ffb6,in_stack_0000ffbc,in_stack_0000ffc0);
      paVar9 = (paVar9 & 0xffff0000 | puVar14 >> 0x10);
      ppcVar1 = (*puVar14 + 0x14);
      (**ppcVar1)(0x1010,puVar14,(puVar14 >> 0x10),param_5,param_5 >> 0xf);
  ...
  if ((uVar10 + 0x10 + param_5 * 0x2) != 0) {
    ...
    if (((uVar10 + 0x10 + param_5 * 0x2) != 0) ||
       (uVar11 = uVar10 + 0x1a6, (uVar11 + param_5 * 0x2) != 0)) {
      if ((uVar10 + 0x10 + param_5 * 0x2) == 0) {
    ...
    uVar7 = param_5;
    puVar14 = mixed_1010_20ba(paVar9,_u16_1050_0ed0,CONCAT22(param_5,0x32),in_stack_0000fe90,
...
pub unsafe fn pass1_1030_25b2(mut param_1: u32,mut param_2: i16) -> BOOL16
...
pub unsafe fn pass1_1030_25d8(mut param_1: u32,mut param_2: u16 ,mut param_3: i16)

{
  (param_1 + param_3 * 0x2 + 0x10) = param_2;
  return;
}
pub unsafe fn pass1_1030_25f0(mut param_1: u32,mut param_2: i16,mut param_3: i16)
...
pub unsafe fn pass1_1030_2622(mut param_1: u32,mut param_2: i16) -> bool
...
pub unsafe fn pass1_1030_266c(mut param_1: u16 ,mut param_2: u32) -> bool
...
pub unsafe fn pass1_1030_2690(mut param_1: u32)

{
  pass1_1000_4906((param_1 & 0xffff0000 | (param_1 + 0x2ac)),NULL,0x106);
  return;
}
pub unsafe fn pass1_1030_26ac(mut param_1: u16 ,mut param_2: u32,mut param_3: u16 )
...
pub unsafe fn pass1_1030_28dc(mut param_1: u32,mut param_2: i16) -> i16
...
pub unsafe fn pass1_1030_2958(param_1: *mut astruct_180,mut param_2: u32)

{
  pstruct_1: *mut astruct_180;
  pstruct_1_hi: *mut astruct_180;
...
pub unsafe fn struct_1030_299a(mut param_1: u16 ,param_2: *mut astruct_57,param_3: *mut astruct_352,mut param_4: u32)

{
  pstruct_1: *mut astruct_352;
...
pub unsafe fn pass1_1030_29e6(param_1: *mut StructD)
...
// WARNING: Globals starting with '_' overlap smaller symbols at the same address
pub unsafe fn pass1_1030_2a2c(param_1: *mut StructD,param_2: *mut astruct_678)
...
pub unsafe fn pass1_1030_2a98(mut param_1: u32) -> u16
...
pub unsafe fn pass1_1030_2aaa(mut param_1: u32) -> u16
...

{
  ...
  if (((BVar3 != 0) &&
      (puVar1 = iVar6.field16_0x10, BVar3 = pass1_1008_7c2a(param_3,*(puVar1 + 0x2)), BVar3 != 0)) &&
...
// WARNING: Globals starting with '_' overlap smaller symbols at the same address
pub unsafe fn pass1_1030_2c8a(mut param_1: i16,param_2: *mut StructD,param_3: *mut astruct_373,param_4: *mut HFILE16)
  ...
  if (BVar3 != 0) {
    ...
    if (puVar4.is_null() == false) {
      ...
      if ((((BVar3 != 0) &&
        ...
        if (((BVar3 != 0) &&
            (BVar3 = read_file_1008_7dee(param_4,CONCAT22(0x1050,&local_404),0x2), BVar3 != 0)) &&
           ((BVar3 = read_file_1008_7dee(param_4,(param_3 & 0xffff0000 | ZEXT24(&iVar14.field_0x18)),0x2),
            BVar3 != 0x0 && (BVar3 = read_file_1008_7dee(param_4,CONCAT22(0x1050,&local_406),0x2), BVar3 != 0)))
           ) {
          iVar14.field16_0x16 = local_404;
          iVar14.field19_0x1a = local_406;
          puVar9 = mixed_1010_20ba(paVar6,_u16_1050_0ed0,CONCAT22(unaff_SI,0x2f),in_stack_0000fa72,
...
pub unsafe fn pass1_1030_2f1a(mut param_1: u32,param_2: *mut u16,param_3: *mut u16) -> i16
...
pub unsafe fn pass1_1030_2fac(param_1: *mut astruct_598) -> u16
