...
pub unsafe fn struct_1030_2112(
    mut param_1: u16,
    param_2: *mut u8,
        ...
        if (puVar4.is_null() == false) {
            ...
            if ((((BVar3 != 0)
                && (
                    puVar1 = iVar14.field13_0x10,
                    BVar3 =
                        read_file_1008_7dee(param_4, (puVar1 & 0xffff0000 | (puVar1 + 0xc)), 0x2),
                    BVar3 != 0,
                ))
                && (
                    puVar1 = iVar14.field13_0x10,
                    BVar3 =
                        read_file_1008_7dee(param_4, (puVar1 & 0xffff0000 | (puVar1 + 0xe)), 0x4),
                    BVar3 != 0,
                ))
                && ((
                    puVar1 = iVar14.field13_0x10,
                    BVar3 =
                        read_file_1008_7dee(param_4, (puVar1 & 0xffff0000 | (puVar1 + 0x12)), 0x10),
                    BVar3 != 0x0
                        && (
                            puVar1 = iVar14.field13_0x10,
                ...
                if (((BVar3 != 0)
                    ...
                    && ((
                        ...
                        BVar3 != 0x0
                            && (
                                BVar3 =
                                    read_file_1008_7dee(param_4, CONCAT22(0x1050, &local_406), 0x2),
                                BVar3 != 0,
                            ),
                    )))
                {
