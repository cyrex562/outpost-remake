...
pub fn struct_1030_2112(mut param_1: u16 ,param_2: *mut u8,param_3: *mut astruct_366,mut param_4: u32)
...
{
  let mut iVar1: i16;
  iVar2: *mut astruct_168;
  paVar2: *mut astruct_168;
  let mut uVar3: u16;
...
pub fn pass1_1030_227a(param_1: u16,mut param_2: u32,mut param_3: u32)
...
pub fn pass1_1030_23e2(mut param_1: i16,param_2: *mut u8,mut param_3: u32,mut param_4: i16,mut param_5: u16 )
...
pub fn pass1_1030_2916(param_1: *mut StructD,param_2: u8) -> *mut StructD
...
{
  let mut piVar1: *mut i16;
  iVar2: *mut astruct_678;
  let mut uVar2: u16;
  paVar3: *mut astruct_67;
...
pub fn pass1_1030_2aca(param_1: u16,param_2: *mut astruct_730,mut param_3: u32)
...

{
  ...
  iVar7: *mut astruct_374;
  iVar8: *mut astruct_371;
  iVar9: *mut astruct_372;
  let mut unaff_SI: u16;
  let mut uVar7: u16;
  ...
  uVar9: *mut astruct_373;
  iVar14: *mut astruct_373;
