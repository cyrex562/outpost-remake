...
pub unsafe fn pass1_1030_e010(param_1: *mut StructD,param_2: u8) -> *mut StructD
...
pub unsafe fn pass1_1030_e0d4(param_1: *mut u8)

{
  ...
  puVar9 = mixed_1010_20ba(CONCAT22(in_register_0000000a,param_1),_u16_1050_0ed0,
                           CONCAT22(unaff_SI,0x40),in_stack_0000fe7c,in_stack_0000ffa0,in_stack_0000ffa6,
                           in_stack_0000ffaa);
  uStack4 = (puVar9 >> 0x10);
  iStack6 = puVar9;
...
pub unsafe fn pass1_1030_e1f4(mut param_1: u16 ,param_2: *mut u8,mut param_3: u32)
...
pub unsafe fn struct_1030_e2be(param_1: *mut astruct_97,mut param_2: u16 ,mut param_3: u32,mut param_4: u32)
...

{
  ...
  paVar1 =
           mixed_1010_20ba(CONCAT22(in_register_0000000a,param_1),_u16_1050_0ed0,
                           CONCAT22((in_stack_0000fff8 >> 0x10),0x2b),in_stack_0000fea2,
...
// WARNING: Globals starting with '_' overlap smaller symbols at the same address
pub unsafe fn pass1_1030_e410(mut param_1: u16 ,mut param_2: u16 ,mut param_3: u32)
...
pub unsafe fn struct_1030_e4fa(param_1: *mut astruct_97,mut param_2: u32)
...

{
  ...
  paVar2 =
           mixed_1010_20ba(param_1,_u16_1050_0ed0,_param_3,in_stack_0000fea0,in_stack_0000ffc4,
...
pub unsafe fn pass1_1030_e8a0(param_1: *mut astruct_97,mut param_2: u32,mut param_3: u16 ,mut param_4: u32)
...
// WARNING: Could not reconcile some variable overlaps
// WARNING: Globals starting with '_' overlap smaller symbols at the same address
pub unsafe fn pass1_1030_ea50(mut param_1: u32,mut param_2: u32)
...
// WARNING: Globals starting with '_' overlap smaller symbols at the same address
pub unsafe fn pass1_1030_ecf8(param_1: u8,param_2: *mut astruct_57,mut param_3: u32)

{
  ...
  uStack12 = 0;
  puVar17 = mixed_1010_20ba(param_2,_u16_1050_0ed0,CONCAT22(in_stack_0000ff98,0x2f),in_stack_0000fe40,
  ...
  puVar17 = mixed_1010_20ba(paVar12,_u16_1050_0ed0,CONCAT22(in_stack_0000ff98,0x2),in_stack_0000fe40,
                            in_stack_0000ff64,in_stack_0000ff6a,in_stack_0000ff6e);
