...
pub unsafe fn pass1_1030_a044(mut param_1: u16 ,mut param_2: u16 ,mut param_3: u16 ,param_4: *mut u16,mut param_5: u32)
...
//            if (iVar4 != 0x9) goto LAB_1030_a1d0;
          ...
          uVar7 = 0x1028;
          struct_op_1028_87f0(CONCAT22(0x1050,&local_17e),0x0,0x0,uVar9,param_4,
...
// WARNING: Globals starting with '_' overlap smaller symbols at the same address
pub unsafe fn pass1_1030_a278(mut param_1: u16 ,mut param_2: i16,param_3: *mut u16,param_4: *mut u16)

{
  ...
  let mut uVar5: u16;
  let mut uVar6: u16;
  let mut local_134: [u8;0x120] = [0;0x120];
  let mut paStack20: *mut astruct_15;
  let mut uStack16: u32;
  let mut paStack12: *mut astruct_15;
  let mut uStack6: u16;
  let mut uStack4: u16;
  ...
  if (param_1 == 0) {
    ...
    if (param_1 == 0) {
      pass1_1030_a844(0x0,param_2,param_3,param_4);
      if (param_1 == 0) {
        uStack4 = 0;
...
// LAB_1030_a305:
  if (uStack6 != 0) {
    ...
    uStack16 = (uVar2 + 0x8);
    uVar2 = (uVar4 + 0x4);
    struct_op_1028_87f0(CONCAT22(0x1050,local_134),0x0,0x0,uStack6,puVar3,uVar5,
                        (uVar2 + 0x4),uStack16);
...
pub unsafe fn pass1_1030_a39a(mut param_1: u32,param_2: *mut u16)
...
// WARNING: Globals starting with '_' overlap smaller symbols at the same address
pub unsafe fn pass1_1030_a3ae(mut param_1: u32,param_2: *mut u16)

{
  ...
  paVar8 = CONCAT22(uVar10,uStack8);
  uVar3 = puVar15;
  uVar13 = (param_1 >> 0x10);
  uVar11 = param_1;
  uStack10 = uVar3;
  ...
  uVar2 = (uVar11 + 0x4);
  lStack22 = (uVar2 + 0x8);
  pass1_1008_3e38(CONCAT22(0x1050,&local_1c));
  puVar16 = pass1_1008_3e38(CONCAT22(0x1050,local_22));
  uVar9 = puVar16 >> 0x10;
  uStack44 = 0;
  loop {
    uVar3 = uVar9;
...
// LAB_1030_a4e7:
    ...
    if (uVar7 != 0) {
      ...
      pass1_1008_3eb4(CONCAT22(0x1050,&local_1c),CONCAT22(0x1050,&local_28),
...
// WARNING: Could not reconcile some variable overlaps
// WARNING: Globals starting with '_' overlap smaller symbols at the same address
pub unsafe fn pass1_1030_a57e(mut param_1: i16,mut param_2: i16,mut param_3: u32,param_4: *mut u16)

{
  ...
  if ((param_2 != 0) || (param_1 != 0)) {
    ...
    paVar9 = CONCAT22(in_register_0000000a,uStack10);
    uVar4 = puVar19;
    uStack12 = uVar4;
    pass1_1038_4e78(uVar4,paVar9,(uVar11 + 0x4),puVar19);
    uStack16 = CONCAT22(paVar9,uVar4);
    uVar18 = 0x1008;
    puVar20 = pass1_1008_3e38(CONCAT22(0x1050,&local_16));
    uVar10 = puVar20 >> 0x10;
    uVar3 = (uVar11 + 0x4);
    uVar1 = (uVar3 + 0x8);
...
//        if (uVar5 == 0) goto LAB_1030_a660;
        uVar21 = struct_op_1030_73a8((uVar21 & 0xffff | uVar4 << 0x10),uVar5,uVar10);
        uVar10 = uVar21 >> 0x10;
        uVar5 = (uVar21 >> 0x10);
        iVar13 = (uVar21 + 0xc);
...
// LAB_1030_a730:
            piVar6 = &local_16;
            pass1_1030_ad86(uVar10,uVar11,uVar15,CONCAT22(0x1050,piVar6),uVar1);
//            if (piVar6.is_null() == false) goto LAB_1030_a748;
...
// WARNING: Globals starting with '_' overlap smaller symbols at the same address
pub unsafe fn pass1_1030_a844(mut param_1: i16,mut param_2: i16,param_3: *mut astruct_426,param_4: *mut u16)

{
  ...
  let mut uVar9: u16;
  let mut uVar10: u16;
  let mut uVar8: *mut astruct_426;
  let mut iVar8: *mut astruct_427;
  let mut iVar11: i16;
  let mut uVar12: u16;
  let mut uVar13: u16;
...
// WARNING: Could not reconcile some variable overlaps
// WARNING: Globals starting with '_' overlap smaller symbols at the same address
pub unsafe fn pass1_1030_aa18(mut param_1: u32,param_2: *mut u16)

{
  ...
  paVar9 = CONCAT22(uVar12,uStack8);
  uVar8 = puVar19;
  uVar15 = (param_1 >> 0x10);
  uVar11 = param_1;
  uStack10 = uVar8;
  ...
  uVar18 = 0x1008;
  puVar20 = pass1_1008_3e38(CONCAT22(0x1050,&local_14));
  uVar10 = puVar20 >> 0x10;
  uVar3 = (uVar11 + 0x4);
  uVar1 = (uVar3 + 0x8);
...
// LAB_1030_aadc:
  ...
  uVar18 = 0x1008;
  pass1_1008_3eb4(CONCAT22(0x1050,&local_14),CONCAT22(0x1050,local_1a),
...
//  if (uVar4 == 0) goto LAB_1030_aadc;
  uVar21 = struct_op_1030_73a8((uVar21 & 0xffff | uVar8 << 0x10),uVar4,uVar10);
  uVar10 = uVar21 >> 0x10;
  uVar8 = (uVar21 >> 0x10);
  iVar13 = (uVar21 + 0xc);
...
pub unsafe fn pass1_1030_acbe(mut param_1: u16 ,mut param_2: u16 ,mut param_3: u16 ,mut param_4: u16 ,param_5: *mut u16,param_6: i32) -> BOOL16
...
pub unsafe fn pass1_1030_ad22(mut param_1: u16 ,mut param_2: u16 ,mut param_3: u16 ,mut param_4: u16 ,param_5: *mut u16,param_6: i32) -> BOOL16
...
// WARNING: Globals starting with '_' overlap smaller symbols at the same address
pub unsafe fn pass1_1030_ad86(mut param_1: u16 ,mut param_2: u16 ,mut param_3: u16 ,param_4: *mut u16,param_5: i32)
...
pub unsafe fn pass1_1030_ae6c(param_1: *mut astruct_399)

{
  ...
  let mut iVar4: *mut astruct_399;
  let mut uVar4: *mut astruct_399;
  ...
  iVar4.field2_0x4 = 0;
  puVar6 = pass1_1008_3e38((param_1 & 0xffff0000 | ZEXT24(&iVar4.field3_0x8)));
...
// WARNING: Unable to use type for symbol uVar1
pub unsafe fn pass1_1030_aefa(param_1: *mut astruct_400,mut param_2: u32)

{
  ...
  if (uVar4 == 0) {
    ...
    set_struct_1008_574a(CONCAT22(paVar5,uVar2));
  }
...
pub unsafe fn pass1_1030_afa6(param_1: *mut StructD)
...
// WARNING: Could not reconcile some variable overlaps
// WARNING: Globals starting with '_' overlap smaller symbols at the same address
pub unsafe fn pass1_1030_affc(mut param_1: u32)

{
  ...
  uStack10 = (uVar8 & 0xffff | ZEXT24(param_1) << 0x10);
  uVar5 = param_1 | uVar8;
  if (uVar5 != 0) {
    uVar7 = struct_op_1030_73a8((uVar8 & 0xffff | ZEXT24(param_1) << 0x10),uVar8,uVar5);
    uVar5 = (uVar7 >> 0x10);
    iVar1 = (uVar7 + 0xc);
    uVar8 = (iVar1 - 0x16U);
...
//    if (uVar6 == 0) goto LAB_1030_b0fc;
    ...
    uVar8 = struct_op_1030_73a8(CONCAT22(uVar5,uVar3),uVar3,uVar5);
    uVar6 = (uVar8 >> 0x10);
    iVar1 = (uVar8 + 0xc);
