        ...
        while uStack40 < uVar7 {
            ...
            if (uVar8 != 0) {
                ...
                if ((uStack16 | puVar14) != 0) {
                    ...
                    ppcVar2 = *puVar14;
                    (**ppcVar2)(
                        0x1008, puVar14, uVar22, 0x1, uVar12, uVar16, uStack16, uStack16,
                    );
                }
                return;
            } //
...
// WARNING: Globals starting with '_' overlap smaller symbols at the same address
pub unsafe fn pass1_1030_a844(
    mut param_1: i16,
    mut param_2: i16,
    param_3: *mut astruct_426,
    param_4: *mut u16,
) {
    let mut iVar1: i16;
    let mut uVar2: u32;
    ...
    if ((param_2 != 0) || (param_1 != 0)) {
        ...
        for uStack34 in 0..uStack10 {
            ...
            if ((uVar10 != 0)
                && (
                    uVar4 = pass1_1008_c6ae(_u16_1050_06e0, (uVar15 + 0xc), 0x46),
                    uVar9 = uVar10,
                    uVar4 != 0x0,
                ))
            {
...
pub unsafe fn pass1_1030_aa18(mut param_1: u32, param_2: *mut u16) {
    ...
    if ((uStack14 | puVar14) != 0) {
        ...
        ppcVar2 = *puVar14;
        (**ppcVar2)(
            0x1008, puVar14, uVar22, 0x1, uVar12, uVar16, uStack14, uStack14,
        );
    }
    return;
}
