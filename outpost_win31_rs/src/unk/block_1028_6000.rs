...
pub fn pass1_1028_6744(mut param_1: u32, mut param_2: i16) -> u16 {
    let mut uVar1: u16;
    let mut lVar2: i32;
    let mut local_a: [u8; 0x8] = [0; 0x8];
...
pub fn pass1_1028_678c(mut param_1: u32, mut param_2: i16) -> u16 {
    let mut uVar1: u16;
    let mut lVar2: i32;
    let mut local_a: [u8; 0x8] = [0; 0x8];
...
pub fn pass1_1028_6b2c(mut param_1: u32) -> u16 {
    let mut in_DX: u16;
