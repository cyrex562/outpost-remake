...
pub fn pass1_1028_c00a(mut param_1: i16, param_2: *mut astruct_15, param_3: i32) {
...
pub fn pass1_1028_c0f0(mut param_1: i16, param_2: *mut astruct_15, param_3: i32) {
    let mut paVar1: *mut astruct_691;
    let mut ppcVar2: *mut *mut code;
    let mut uVar3: u16;
    let mut uVar4: u16;
    ...
    if (((paVar1 + 0x204) == 0) && ((paVar1 + 0x206) == 0)) {
        ...
        for uStack28 in 0..uStack24 {
            ...
            pass1_1028_e1ec(
                _PTR_LOOP_1050_65e2,
                uVar10 & 0xffff | extraout_DX_01 << 0x10,
            );
            uVar8 = 0x1030;
...
pub fn pass1_1028_c23e(
    ...
    if (uVar7 != 0) {
        ...
        if (uVar1 != param_6) {
            ...
            if (((puVar3.is_null()) || ((uVar8 | uVar5) == 0))
...
pub fn pass1_1028_c3aa(
    ...
    pass1_1030_bcde(
        puStack24,
        0x1050,
        uVar8 & 0xffff | paVar12 << 0x10,
        CONCAT22(uVar14, CONCAT11(uVar20, uVar19)),
        uVar15,
    );
    if (puStack24 < 0x0) {
    ...
    if (0x1e < puStack24) {
        ...
        if (uVar3 == 0) {
            ...
            loop {
                if (uStack36 <= uStack40) {
                    if (puStack32.is_null() == false) {
                        ppcVar1 = *puStack32;
                        (**ppcVar1)(
                            uVar14, uVar4, uVar15, 0x1, uVar22, uVar10, puStack32, puStack32,
                        );
                    }
                ...
                pass1_1030_bcde(
                    puVar7,
                    0x1050,
                    uVar9 & 0xffff | uVar13 << 0x10,
                    puVar18,
                    CONCAT22(uVar21, CONCAT11(uVar20, uVar19)),
                );
                if ((0x0 < puVar7) && (puVar7 < 0x1f)) {
                    break;
                }
                if (puVar7 < puStack24) {
                    puStack24 = puVar7;
            ...
            ppcVar1 = *puStack32;
            (**ppcVar1)(
                0x1030, uVar4, uVar15, 0x1, uVar22, uVar10, puStack32, puStack32, uVar6, uVar11,
            );
            return;
        }
    }
...
pub fn pass1_1028_c952(param_1: *mut astruct_15) {
    ...
    let mut iVar8: i16;
    let mut uVar9: u16;
    let mut pstruct15_9: *mut astruct_15;
                ...
                for uStack16 in 0..0x25 {
                    ...
                    if (uVar9 != 0) {
                        ...
                        if ((uVar6 & 0xffff | uVar9 << 0x10) < uStack30) {
                            ...
                            uStack30 =
                                CONCAT22((uStack30 - iVar8) - (uVar7 < uVar4), uVar7 - uVar4);
                        }
            ...
            if ((uStack14 + 0x204) != 0) {
                ...
                if ((puVar8 <= puStack36)
                    && ((
                        uVar4 = uVar6,
                        uStack38 = uVar2,
                        puVar8 < puStack36 || (uVar4 < uStack38),
                    )))
                {
                    pass1_1030_7d7c(
                        uVar4,
...
pub fn pass1_1028_cfd2(param_1: u32, mut param_2: u32) {
    *param_1 = param_2;
    (param_1 + 0x4) = 0;
    return;
}
...
pub fn pass1_1028_d01a(param_1: u32) {
    let mut puVar1: *mut u32;
    let mut ppcVar2: *mut *mut code;
    let mut uVar3: u32;
    let mut uVar4: u16;
