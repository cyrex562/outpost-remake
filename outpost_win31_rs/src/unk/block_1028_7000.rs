...
pub fn pass1_1028_78b8(param_1: u8, param_2: i32, mut param_3: u32) {
    ...
    let mut local_1e: [*mut u8; 3] = [null_mut(); 3];
    ...
    if ((0xe < uStack6) && (uStack6 < 0x16)) {
        ...
        pass1_1020_a54c((puVar18 >> 0x10), local_1e, 0x1050, local_18);
    }
    ...
    if (uStack6 == 0x5) {
        ...
        local_30 = puVar5;
        pass1_1038_4d3c(
            CONCAT22(local_30.field2_0x2, puVar5),
            CONCAT22(uVar23, uVar22),
            local_30.field2_0x2,
        );
    }
    if (uStack6 == 0x12c) {
    ...
    if (0x2 < PTR_LOOP_1050_13ae) {
        puStack74 = mixed_1010_20ba(
            (paVar14 & 0xffff0000 | puVar20 >> 0x10),
            _u16_1050_0ed0,
...
pub fn pass1_1028_7c4e(param_1: *mut Struct57, mut param_2: u32) {
    let mut ppcVar1: *mut *mut code;
    ...
    mixed_1010_20ba(
        param_1,
        _u16_1050_0ed0,
        CONCAT22(in_stack_0000fe8a, 0x2),
        in_stack_0000fd32,
        in_stack_0000fe56,
        in_stack_0000fe5c,
        in_stack_0000fe60,
    ...
    if (0x2 < PTR_LOOP_1050_13ae) {
        ...
        if ((0x2 < uVar6)
            && (
                uVar6 = CONCAT22(iStack10 - (uVar6 < 0x2), uVar6 - 0x2) % 0x14,
                uVar6 == 0,
            ))
        {
...
pub fn pass1_1028_7dfc(param_1: u8, param_2: *mut u8, mut param_3: u32) {
    ...
    mixed_1010_20ba(
        ...
        _u16_1050_0ed0,
        CONCAT22(in_stack_0000fe88, 0x2),
        in_stack_0000fd30,
        in_stack_0000fe54,
        in_stack_0000fe5a,
        in_stack_0000fe5e,
        ...
        loop {
            ...
            if (paVar3[0x1c].field4_0x8 != 0x8000002) {
                ...
                for uStack60 in 0..uStack50 {
                    ...
                    if ((uVar4 <= iStack52)
                        && (
                            pass1_1028_7742(param_3, (param_3 >> 0x10), 0x4, paStack68),
                            uStack72 = uVar4,
                            uVar4 == 0,
                        ))
                    {
                        paVar10 = pass1_1028_b0de(
                            CONCAT13(0x10, CONCAT12(0x50, &local_158)),
                            (paStack68 + 0x4),
                            (paStack38 + 0x4),
                        );
