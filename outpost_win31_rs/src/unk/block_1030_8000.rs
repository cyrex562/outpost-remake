...
pub fn struct_1030_8128(param_1: *mut Struct57, param_2: *mut astruct_135) {
    let mut uVar1: u16;
    let mut uVar2: u16;
...
pub fn fn_ptr_1030_835a(param_1: *mut *mut u32, param_2: *mut c_char) {
    fn_ptr_1028_d566(*param_1, param_2);
    return;
}
pub fn pass1_1030_8372(param_1: *mut *mut u32, mut param_2: u32, param_3: *mut u32) {
...
pub fn pass1_1030_83ba(param_1: u8, param_2: *mut *mut u32, param_3: i32) {
    let mut lVar1: i32;
...
pub fn struct_1030_8544(param_1: *mut astruct_355, param_2: *mut astruct_356) {
    ...
    pass1_1008_3f62(
        (param_1 & 0xffff0000 | ZEXT24(&iVar2.field_0x8)),
...
pub fn pass1_1030_8aa0(
    ...
    pass1_1008_3eb4(
        param_3,
        CONCAT13(0x10, CONCAT12(0x50, puStack14)),
...
pub fn pass1_1030_8b00(mut param_1: u32, param_2: *mut u16, param_3: *mut u16) {
    ...
    pass1_1008_3eb4(
        param_2,
        CONCAT13(0x10, CONCAT12(0x50, piVar2)),
...
pub fn pass1_1030_8bdc(mut param_1: u32, mut param_2: u32, param_3: *mut u16) {
    ...
    pass1_1008_3eb4(
        param_3,
        CONCAT13(0x10, CONCAT12(0x50, puVar1)),
        CONCAT22(0x1050, local_6),
        CONCAT22(0x1050, puStack14),
    );
    bad_1030_8cd2();
...
pub fn pass1_1030_8f04(
    ...
    if ((((param_2 != 0) || (0x1 < param_1))
        && ((
            pass1_1038_53ba(param_5, 0x2),
            param_2 != 0x0 || (0x1 < param_1),
        )))
        && ((
            pass1_1038_53ba(param_5, 0x3),
            param_2 != 0x0 || (0x1 < param_1),
        )))
    {
            ...
            loop {
                ...
                if (0x0 < (iStack8 * 0x2 + _PTR_LOOP_1050_580e)) {
                    ...
                    if ((uVar3 <= uVar4) && (uVar3 < uVar4 || (uVar2 < uVar1))) {
                        ...
                        uStack6 = CONCAT22(
                            ((uStack6 >> 0x10) - (uVar2 >> 0xf)) - (uStack6 < uVar2),
                            uStack6 - uVar2,
                        );
                    }
                }
