...
pub fn pass1_1030_5164(param_1: *mut astruct_117, mut param_2: u32) -> *mut c_char {
    let mut uVar1: u16;
    let mut uVar2: u16;
    let mut uVar3: u16;
    let mut lVar4: i32;
...
pub fn pass1_1030_5b00(mut param_1: u32) -> i16 {
...
pub fn pass1_1030_5ff6(mut param_1: u16, param_2: *mut Struct57, mut param_3: u32) {
