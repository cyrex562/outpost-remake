...
pub fn pass1_1010_8096(param_1: u32, mut param_2: i16) {
    ...
    uVar2 = (pcVar5 >> 0x10);
    if ((pcVar5 == local_106) && (uVar2 == 0x1050)) {
        msg_box::msg_box_op_1010_8bb4(uVar3, uVar4, pcVar5 & 0xffff | 0x10500000);
    }
...
pub fn FUN_1010_830a(
    ...
    if ((iVar6 + 0x10) == 1) {
        ...
        if (((iVar6 + 0x12) == iStack10) && ((iVar6 + 0x14) == iStack8)) {
            msg_box::msg_box_op_1010_8bb4(uVar9, uVar10, pcVar7);
            return 0x0;
        }
        puVar2 = &local_2e;
        ...
        if ((param_5 * 0x10 + 0x10) == 0x2) {
            ...
            if ((iVar6 + 0x10) == 0x3) {
                ...
                if (((iVar6 + 0x12) == param_1) && ((iVar6 + 0x14) == local_2e.field1_0x2)) {
                    ...
                    msg_box::msg_box_op_1010_8bb4(uVar9, uVar10, uVar8);
...
pub fn pass1_1010_878c(param_1: *mut *mut astruct_87, mut param_2: i16) {
    ...
    if ((param_2 == 1) || (param_2 == 0x2)) {
        ...
        if (((iVar4 + 0x172a) == uVar4) && ((iVar4 + 0x172c) == uVar1)) {
            msg_box::msg_box_op_1010_8bb4(uVar6, uVar5, paVar6 & 0xffff | uVar1 << 0x10);
        }
        mem_op_1000_179c(0x8, paVar3);
        uVar1 = paVar3;
        paVar3 = (paVar3 & 0xffff0000 | (uVar1 | uVar4));
