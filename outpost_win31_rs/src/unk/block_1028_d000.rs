...
pub unsafe fn pass1_1028_d078(mut param_1: u32, mut param_2: u32) {
    ...
    if ((uStack4 | puStack6).is_null()) {
        ...
        uVar7 = pass1_1018_dd1e(
            local_16,
            (uVar7 & 0xffff0000 | puVar6 >> 0x10),
            local_16,
            0x1050,
            0x0,
            0xa0000,
...
pub unsafe fn pass1_1028_d172(mut param_1: u32, mut param_2: u32) {
    let mut uVar1: u16;
    let mut uVar2: u16;
    let mut in_EDX: u32;
    let mut uVar5: u16;
...
pub unsafe fn pass1_1028_d282(param_1: *mut astruct_446) {
...
pub unsafe fn struct_1028_d2b0(param_1: u32) {
...
pub unsafe fn pass1_1028_d52c(param_1: u32, mut param_2: u32, param_3: *mut u32) -> BOOL16 {
    let mut ppcVar1: *mut *mut code;
    let mut iVar2: i16;
    let mut BVar3: bool;
...
pub unsafe fn fn_ptr_1028_d566(param_1: u32, param_2: *mut astruct_97) -> BOOL16 {
    let mut ppcVar1: *mut *mut code;
    let mut iVar2: i16;
    let mut uVar3: u16;
...
pub unsafe fn struct_1028_d59c(param_1: *mut StructD, param_2: *mut astruct_158) {
    ...
    let mut iVar5: *mut astruct_158;
    let mut uVar5: *mut astruct_158;
...
pub unsafe fn pass1_1028_d658(param_1: *mut astruct_446) {
    let mut puVar1: *mut u32;
    let mut uVar2: u16;
    let mut ppcVar3: *mut *mut code;
    let mut iVar4: *mut astruct_446;
    let mut uVar4: *mut astruct_446;
...
pub unsafe fn fn_ptr_1028_d728(mut param_1: u32) {
    let mut ppcVar1: *mut *mut code;
...
pub unsafe fn pass1_1028_d776(mut param_1: u32, mut param_2: u32, param_3: *mut u32) -> BOOL16 {
    let mut ppcVar1: *mut *mut code;
    let mut uVar2: u32;
...
pub unsafe fn pass1_1028_d7a0(mut param_1: u16, mut param_2: u16, mut param_3: u32) -> BOOL16 {
    let mut BVar1: bool;
...
pub unsafe fn read_file_1028_d7ba(
    param_1: u16,
    mut param_2: u16,
    mut param_3: u16,
    mut param_4: u32,
...
pub unsafe fn pass1_1028_d81c(
    ...
    puVar1 = pass1_1000_4906(
        (param_2 & 0xffff0000 | ZEXT24(&iVar6.field_0xa)),
        NULL,
        0x24,
    );
...
pub unsafe fn write_to_file_1028_dce2(param_1: u16, param_2: *mut u32, param_3: *mut u8) -> u32 {
    ...
    if (BVar2 != 0) {
        local_26[0] = *param_2;
        BVar2 =
            write_to_file_1008_7e1c(param_3, CONCAT22(0x1050, local_26), 0x4, in_stack_0000ffc0);
        if (BVar2 != 0) {
            uVar6 = (param_2 >> 0x10);
            iVar5 = param_2;
            ...
            if (BVar2 != 0) {
                ...
                if (BVar2 != 0) {
                    ...
                    if (BVar2 != 0) {
                        param_1 =
                            write_file_fn_1028_e56c(param_1, iVar5, uVar6, param_3, 0x1000000);
                        if (BVar2 != 0) {
                            BVar2 = write_to_file_1008_7cac(param_3);
                            if (BVar2 != 0) {
                                param_1 = write_file_fn_1028_e56c(
                                    param_1, iVar5, uVar6, param_3, 0x2000000,
                                );
                                if (BVar2 != 0) {
                                    BVar2 = write_to_file_1008_7cac(param_3);
                                    if (BVar2 != 0) {
                                        param_1 = write_file_fn_1028_e56c(
                                            param_1, iVar5, uVar6, param_3, 0x3000000,
                                        );
                                        if (BVar2 != 0) {
                                            BVar2 = write_to_file_1008_7cac(param_3);
                                            if (BVar2 != 0) {
                                                param_1 = write_file_fn_1028_e56c(
                                                    param_1, iVar5, uVar6, param_3, 0x4000000,
                                                );
                                                if (BVar2 != 0) {
                                                    BVar2 = write_to_file_1008_7cac(param_3);
                                                    if (BVar2 != 0) {
                                                        param_1 = write_file_fn_1028_e56c(
                                                            param_1, iVar5, uVar6, param_3,
                                                            0x5000000,
                                                        );
                                                        if (BVar2 != 0) {
                                                            BVar2 =
                                                                write_to_file_1008_7cac(param_3);
                                                            if (BVar2 != 0) {
                                                                param_1 = write_file_fn_1028_e56c(
                                                                    param_1, iVar5, uVar6, param_3,
                                                                    0x6000000,
                                        ...
                                        if (BVar2 != 0) {
                                            ...
                                            if (BVar2 != 0) {
                                                ...
                                                if (BVar2 != 0) {
                                                    ...
                                                    if (BVar2 != 0) {
                                                        pass1_1028_e628(
                                                            param_2, uVar3, uVar4, 0x0, 0x500,
                                                        );
                                                        if (BVar2 != 0) {
                                                            read_file_1008_7cfe(uVar3, uVar4, 0x11);
                                                            if (BVar2 != 0) {
                                                                pass1_1028_e628(
                                                                    param_2, uVar3, uVar4, 0x0,
                                                                    0x600,
                                                                );
                                                                if (BVar2 != 0) {
                                                                    read_file_1008_7cfe(
