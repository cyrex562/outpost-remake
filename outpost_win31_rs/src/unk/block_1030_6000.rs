...
pub fn pass1_1030_62e4(param_1: u32, param_2: *mut u16, param_3: i32) {
    ...
    if (uVar3 == 0) {
        ...
        struct_op_1030_1cd8(
            CONCAT13((paVar5 >> 0x8), CONCAT12(paVar5, puVar2)),
            0x5,
            0x5,
        );
    }
    ...
    if ((uVar3 | puVar2) != 0) {
        ...
        pass1_1008_3eb4(
            CONCAT22(0x1050, local_c),
            CONCAT13(0x10, CONCAT12(0x50, &local_1e)),
            CONCAT22(0x1050, &local_1c),
            CONCAT22(0x1050, &local_1a),
        );
        pass1_1008_3eb4(
            CONCAT22(0x1050, local_12),
            CONCAT13(0x10, CONCAT12(0x50, &local_24)),
        ...
        pass1_1008_3eb4(
            ...
            CONCAT13(0x10, CONCAT12(0x50, local_2a)),
        ...
        if (local_24 == local_1e) {
            ...
            loop {
                ...
                for uStack56 in local_1a..(local_26 + local_1a) {
                    uStack88 = local_1e;
                    pass1_1008_3e54(
...
pub fn pass1_1030_69cc(mut param_1: u16, mut param_2: u16, mut param_3: u32) {
    ...
    if (((iVar3 + 0x22) != 0) && (pass1_1020_ba94((iVar3 + 0x22)), (param_2 | param_1) != 0)) {
        return;
    }
    ...
    if ((BVar2 != 0)
        && (
            uVar5 = pass1_1028_67d4((iVar3 + 0x1a)),
            ((uVar5 >> 0x10) | uVar5) != 0,
        ))
    {
        return;
...
pub fn pass1_1030_6a2c(
    mut param_1: u16,
    param_2: *mut StructD,
    param_3: *mut astruct_382,
    param_4: *mut astruct_383,
) {
    let mut ppcVar1: *mut *mut code;
    let mut uVar3: u16;
    ...
    loop {
        loop {
            ...
            uVar2 = (param_4 >> 0x10);
            iVar5 = param_4;
            if !((iVar2.field5_0x6 != iVar5.field5_0x6) || (iVar2.field4_0x4 != iVar5.field4_0x4)) {
                break;
            }
        }
        if !(iVar2.field6_0x8 != iVar5.field6_0x8) {
            break;
        }
    }
...
pub fn pass1_1030_6c66(
    mut param_1: u16,
    param_2: *mut u8,
    param_3: *mut astruct_386,
    mut param_4: i16,
    param_5: *mut astruct_385,
) {
    let mut ppcVar1: *mut *mut code;
    let mut uVar2: u16;
    let mut BVar3: bool;
    ...
    if (param_4 != 0) {
        ...
        if (iVar6.field4_0x4 != 0) {
            ...
            pass1_1030_7ddc(
                uVar4,
                (paVar6 & 0xffff0000 | uVar5),
                param_3,
                CONCAT13((uVar5 >> 0x8), CONCAT12(uVar5, uVar4)),
                iVar6.field4_0x4,
            );
            return;
        }
...
pub fn pass1_1030_6db4(param_1: *mut u8) -> u16 {
    let mut iVar1: i16;
    let mut uVar2: u16;
    let mut in_register_0000000a: u16;
    let mut puVar3: *mut u32;
...
pub fn pass1_1030_6fa0(mut param_1: u32) -> u16 {
    let mut uVar1: u32;
    let mut in_AX: u16;
    let mut in_DX: u16;
    let mut iVar2: i16;
