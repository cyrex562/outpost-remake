...
pub fn pass1_1030_4538(param_1: u32) {
    let mut uVar1: u16;
...
pub fn pass1_1030_4782(
    ...
    let mut ppuStack160: *mut *mut u8;
    ...
    *piStack6 = param_6;
    ...
    if (param_5 != 0) {
        puVar13 = mixed_1010_20ba(
            paVar8,
            _u16_1050_0ed0,
            CONCAT13(uVar16, CONCAT12(uVar15, 0x2f)),
            in_stack_0000fdc8,
            in_stack_0000feec,
            in_stack_0000fef2,
            in_stack_0000fef6,
        ...
        if (param_4 != 0) {
            ...
            if (uStack14 == 0) {
                ...
                pass1_1030_2f1a(
                    uStack18,
                    CONCAT22(0x1050, &local_c0),
                    CONCAT22(0x1050, ppuVar3),
                );
            ...
            paVar8 = (iVar10 % 0x64 & 0xffff | uVar4 << 0x10);
            (piStack6 + 0x1c) = iVar10 / 0x64;
            puVar13 = mixed_1010_20ba(
                paVar8,
                _u16_1050_0ed0,
                CONCAT22(param_7, 0x2),
                in_stack_0000fdcc,
                in_stack_0000fef0,
                in_stack_0000fef6,
                in_stack_0000fefa,
            ...
            paVar8 = (iVar10 % 0x64 & 0xffff | uVar7 & 0xffff0000);
            uVar11 = (piStack6 >> 0x10);
            ...
            uVar2 =
                fn_ptr_op_1000_1708(uStack170, 0x0, 0x1, PTR_LOOP_1050_5f2c, PTR_LOOP_1050_5f2e);
                ...
                loop {
                    ...
                    loop {
                        ...
                        if (iStack180 <= param_7) {
                            ...
                            uVar7 = (piStack6 + 0x16);
                            pass1_1008_3e76(
                                (uVar7 & 0xffff0000 | (uVar7 + iStack180 * 0x6)),
                                0x0,
                                uVar4,
                                (iVar1 + iVar10),
                            );
                        ...
                        if (((param_7 * 0x2 + iVar10) == uStack166)
                            && ((param_7 * 0x2 + pcStack178) == uVar4))
                        {
                            break;
                        }
                        param_7 += 0x1;
...
pub fn pass1_1030_4c06(param_1: *mut astruct_117, mut param_2: i16, param_3: u16) {
    let mut plVar1: *mut i32;
    let mut plVar2: *mut i32;
    let mut uVar3: u16;
    let mut iVar4: i16;
    let mut iVar5: *mut astruct_117;
    let mut plVar5: *mut i32;
...
pub fn pass1_1030_4d3a(
    mut param_1: u16,
    param_2: *mut astruct_117,
    param_3: *mut astruct_118,
    mut param_4: u32,
) {
    let mut uVar1: u16;
    let mut iVar2: i16;
    let mut pstruct118_3: *mut astruct_118;
    let mut pstruct118_4: *mut astruct_118;
    let mut pcStack8: *mut c_char;
    let mut iStack4: i16;
...
pub fn pass1_1030_4dbc(param_1: *mut astruct_117, mut param_2: u32, param_3: i32) {
    let mut plVar1: *mut i32;
...
pub fn pass1_1030_4f5a(mut param_1: u16, param_2: *mut astruct_117) {
    ...
    let mut pstruct117_7: *mut astruct_117;
    let mut pstruct117_8: *mut astruct_117;
    ...
    if (plVar2.is_null() == false) {
        ...
        for uStack22 in 0..pcVar4 {
            ...
            pass1_1030_4d3a(
                uVar6,
                (param_2 & 0xffff | ZEXT24(paVar9) << 0x10),
                CONCAT22(uVar6, iVar4),
                uStack20,
            );
