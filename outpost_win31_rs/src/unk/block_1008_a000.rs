...
pub fn pass1_1008_a9ec(mut param_1: u32) -> u16 {
    let mut uVar1: u32;
    let mut in_AX: u16;
    let mut iVar2: i16;
    let mut uVar3: u16;
...
pub fn pass1_1008_aaa8(mut param_1: u16, mut param_2: u16, mut param_3: u16) -> u16 {
...
pub fn pass1_1008_ab12(mut param_1: u16, mut param_2: u16, mut param_3: u16) -> u16 {
    if (param_3 == 0x37) {
        return 0x22;
    }
    if (param_3 < 0x38) {
...
pub fn pass1_1008_ab54(mut param_1: u32) -> u16 {
    let mut uVar1: u32;
    let mut uVar2: u16;
    let mut uStack4: u16;
...
pub fn pass1_1008_ab80(mut param_1: u16, mut param_2: u16, mut param_3: u16) -> u16 {
    let mut uStack4: u16;
...
pub fn pass1_1008_adf2(mut param_1: u32) -> u16 {
    return ((param_1 + 0x4) * 0x6 + 0x3a4);
}

pub fn pass1_1008_ae0c(mut param_1: u32) -> u16 {
...
pub fn pass1_1008_aefe(param_1: *mut u8, param_2: *mut Struct19, mut param_3: u16) -> u32 {
...
pub fn pass1_1008_af94(param_1: *mut Struct19, mut param_2: u16, mut param_3: u16) {
