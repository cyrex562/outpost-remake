...
pub unsafe fn pass1_1020_a43e(param_1: *mut u8, param_2: *mut u16) -> *mut u16 {
    ...
    *param_2 = 0xba36;
    ...
    mixed_1010_20ba(
        ...
        _u16_1050_0ed0,
        CONCAT22((in_stack_0000fff2 >> 0x10), 0x2),
        in_stack_0000fe9c,
        in_stack_0000ffc0,
        in_stack_0000ffc6,
        in_stack_0000ffca,
...
pub unsafe fn pass1_1020_a6ee(
    ...
    if (((param_2 | param_1) == 0) || ((param_1 + 0x200) == 0x8000002)) {
        puStack10 = mixed_1010_20ba(
            CONCAT22(in_register_0000000a, param_2 | param_1),
            _u16_1050_0ed0,
...
pub unsafe fn pass1_1020_ac6e(
    ...
    puStack18 = mixed_1010_20ba(
        CONCAT22(uVar5, (puVar6 >> 0x10)),
        _u16_1050_0ed0,
        CONCAT22(param_1, 0x2f),
        in_stack_0000fd56,
        in_stack_0000fe7a,
        in_stack_0000fe80,
        in_stack_0000fe84,
...
pub unsafe fn pass1_1020_ad90(
    ...
    if ((uVar6 | puVar3) != 0) {
        ...
        for uStack70 in uStack12..iStack16 {
            //   for (puStack78 = uStack12; puStack78 <= iStack14; puStack78 = (puStack78 + 1))
            for puStack78 in uStack12..iStack14 {
