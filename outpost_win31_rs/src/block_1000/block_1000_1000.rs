...
pub unsafe fn mem_op_1000_131c(mut param_1: u16,
                        mut param_2: u32)
{
...
pub unsafe fn pass1_1000_15ce(param_1: *mut u16,
                     mut param_2: u16 )
{
...
pub unsafe fn pass1_1000_16ee(mut param_1: u16,
                       mut param_2: u16 )
{
...
pub unsafe fn mem_op_1000_179c(mut param_1: i16,
...
pub unsafe fn pass1_1000_18d2(mut param_1: u16,
                       mut param_2: u16 )
{
    if ((param_2 | param_1) != 0x0) {
        call_fn_ptr_1000_0dc6( CONCAT22(param_2,
                                                                 param_1));
    }
    return;
}
...
pub unsafe fn mem_1000_167a(mut param_1: u16,
                     mut param_2: u16 ) -> u16
{
    let mut puVar1: *mut u8;
...
pub unsafe fn pass1_1000_16aa(mut param_1: u16,
                       param_2: *mut u16,
                       mut param_3: u16,
                       mut param_4: u16 ) -> u16
{
...
//    LAB_1000_1724:
    loop {
        if ((param_5 | param_4) != 0x0) {
            lVar3 = mem_op_1000_0a48( param_3,
                                     param_1,
                                     param_2,
                                     CONCAT22(param_5,
                                              param_4));
...
pub unsafe fn pass1_1000_188e(mut param_1: u16,
                       param_2: *mut u16,
                       mut param_3: u16,
                       mut param_4: u16 ) -> u16
{
...
pub unsafe fn mem_op_1000_18ec(mut param_1: u16,
                        mut param_2: u16 ) -> u32
{
    let mut uVar1: u32;
...
pub unsafe fn mem_op_1000_1902(mut param_1: u16,
                        mut param_2: u16,
                        mut param_3: u16,
                        mut param_4: u16,
                        mut param_5: u16 ) -> u32
...
pub unsafe fn pass1_1000_1a54(mut param_1: u16,
                       mut param_2: i16,
                       mut param_3: u16 ) -> u16
{
    let mut uVar1: u16;
...
pub unsafe fn pass1_1000_1afe(mut param_1: u16,
                       mut param_2: u16,
...
pub unsafe fn mem_op_1000_1b68(mut param_1: u16,
                        mut param_2: u16,
                        mut param_3: u16 ) -> u32
{
    let mut unaff_CS: u16;
...
pub unsafe fn mem_op_1000_1b9a(mut param_1: u16,
                        mut param_2: u16,
                        mut param_3: u16 ) -> u32
{
    let mut uVar1: u16;
...
pub unsafe fn msg_box_op_1000_1f24(mut param_1: i16,
                            mut param_2: u16,
                            mut param_3: u16 ) -> bool
{
