...
pub fn pass1_1000_3038(mut param_1: i16) -> i16
{
    ...
    for puVar2 in (PTR_LOOP_1050_6210 .. PTR_LOOP_1050_5ff0).step_by(0xc) {
        ...
        } else if ((param_1 == 0) && (((puVar2[0xa] & 0x2) != 0x0 && (uVar1 = pass1_1000_2f48(CONCAT22(0x1050,
                                                                                                         puVar2)), uVar1
            == 0xffff)))) {
            iStack4 = -0x1;
        }
...
pub unsafe fn FUN_1000_30b4() -> u16
{
    ...
    uVar4 =  ( (*  ( (bVar2 * '\x0b') + 0x5ffe) >> 0x4) * 0x2 + 0x30a4)(unaff_SI & 0xff00 |  bVar1, uVar4, iVar3);
    return uVar4;
}
...
//        LAB_1000_33d4:
        ...
        if (((* (unaff_BP + -0x6) & 0x40) != 0) && ( uVar13 < 0x0)) {
            pbVar2 =  (unaff_BP + -0x5);
            *pbVar2 = *pbVar2 | 0x1;
            uVar13 = CONCAT22(-( (uVar13 >> 0x10) +  ( uVar13 != 0)),
                              - uVar13);
        }
        param_1 =  (uVar13 >> 0x10);
        if ((unaff_BP + -0xe) < 0x0) {
...
pub unsafe fn pass1_1000_3503(mut param_1: u16 ,
                    mut param_2: u16 ) -> i16
{
    let mut piVar1: *mut i16;
    let mut pcVar2: *mut c_char;
...
pub unsafe fn pass1_1000_3534(param_1: u8,
                     mut param_2: i16,
                     mut param_3: u16 )
{
    let mut piVar1: *mut i16;
...
pub unsafe fn pass1_1000_356e(mut param_1: u16 ,
                     mut param_2: u16 ,
                     mut param_3: u16 )
{
    let mut pbVar1: *mut u8;
...
pub unsafe fn mixed_dos3_call_1000_3636(mut param_1: u16 ,
                               mut param_2: u16 ,
                               mut param_3: u16 ,
                               mut param_4: u16 )
{
...
pub unsafe fn mixed_dos3_call_1000_370a(mut param_1: u16 ,
                              mut param_2: u16 ,
                              mut param_3: u16 ,
                              mut param_4: u16 ,
                              param_5: u8,
...
pub unsafe fn mixed_dos3_call_1000_39f2(param_1: *mut u8,
                              param_2: *mut c_char,
                              param_3: *mut u8) -> *mut u8
{
    let mut pbVar2: *mut u8;
    ...
    if ((u16_1050_61ec != 0)
        && (puVar6 = PTR_s_ed_in_Op_Op_1050_0028_1050_5f8e, param_1 <  ( &u16_1050_0002 + 1))) {
...
pub unsafe fn mixed_dos3_call_1000_3ad9(mut param_1: u16 ,
                              mut param_2: i16,
                              param_3: *mut i16,
                              mut param_4: u16 ) -> u16
{
...
pub unsafe fn pass1_1000_3bc0(mut param_1: i16,
                     mut param_2: i16)
{
    let mut piVar1: *mut i16;
    let mut u_var2: u16;
...
pub unsafe fn pass1_1000_3cea(mut param_1: u32,
                     param_2: *mut c_char) -> *mut u16
{
    let mut pUVar1: *mut u16;
    let mut pcVar2: *mut c_char;
    let mut pUVar3: *mut u16;
...
pub unsafe fn unk_str_op_1000_3d3e(param_1: *mut c_char,
...
pub unsafe fn pass1_1000_3d7a(param_1: *mut c_char,
                    param_2: *mut c_char) -> i16
{
...
pub unsafe fn str_op_1000_3dbe(param_1: *mut c_char,
                       param_2: *mut c_char,
                       mut param_3: u16 ) -> u8
{
...
pub unsafe fn pass1_1000_3de8(param_1: *mut c_char,
                    param_2: *mut c_char,
                    mut param_3: u16 ,
                    param_4: u16,
                    param_5: u16) -> u16
...
pub unsafe fn pass1_1000_3e82(mut param_1: u16 ,
                    param_2: *mut u8,
                    mut param_3: u16 ) -> *mut u8
{
    let mut pb_var1: *mut u8;
    let mut u_var2: u32;
    let mut b_var3: u8;
...
pub unsafe fn pass1_1000_3ec0(mut param_1: u16 ,
                    mut param_2: u16 ) -> i16
{
    let mut u_var1: u16;
    let mut u_var2: u16;
    ...
    pu_var4 =  CONCAT22(PTR_LOOP_1050_5fc0,
                              PTR_LOOP_1050_5fbe);
    if ((( PTR_LOOP_1050_5fc0 |  PTR_LOOP_1050_5fbe) != 0) && ((param_2 | param_1) != 0)) {
        u_var1 = str_op_1000_3da4( CONCAT22(param_2,
                                                   param_1));
        loop {
            u_var4 = ( pu_var4 >> 0x10);
            u_var3 =  pu_var4;
            ...
            u_var2 = str_op_1000_3da4( CONCAT22((u_var3 + 0x2),
                                                       pu_var4));
            if (((u_var1 < u_var2) && (( *pu_var4 + u_var1) == '=')) && (u_var2 =
                                                                                        pass1_1000_3de8( CONCAT22((u_var3
                                                                                                                              + 0x2),
                                                                                                                          pu_var4),
                                                                                                         CONCAT22(param_2,
                                                                                                                          param_1),
...
pub unsafe fn sys_1000_3f9c(param_1: *mut c_char,
                  param_2: *mut c_char,
                  mut param_3: u16 ) -> u16
{
    let mut pc_var1: *mut c_char;
