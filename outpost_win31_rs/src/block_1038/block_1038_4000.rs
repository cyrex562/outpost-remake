...
pub unsafe fn pass1_1038_42cc(mut param_1: u32)

{
  ...
  puVar7 = (puVar12 >> 0x10);
  uVar4 = puVar12;
  pass1_1038_4d6e(uVar4,puVar7,param_1,puVar12);
  ...
  if (bVar3) {
    ...
    if (uVar8 != 0) {
      uVar11 = 0x1030;
      pass1_1030_326a(uStack18,uVar8,(iVar9 + 0x1f6));
    }
  }
  if (puStack10.is_null() == false) {
    ppcVar1 = *puStack10;
    (**ppcVar1)(uVar11,uVar4,puVar7,1);
  }
  return;
}
...
// WARNING: Globals starting with '_' overlap smaller symbols at the same address
pub unsafe fn pass1_1038_43cc(mut param_1: i16,mut param_2: i16,mut param_3: i16,mut param_4: u16 ,mut param_5: u16 ,mut param_6: u16 )

{
  ...
  let mut paVar12: *mut astruct_15;
  ...
  if ((param_2 != 0) || (param_1 != 0)) {
    ...
    if (iVar9 < 0x0) {
      (param_3 + iVar8 + 0x14e) = 0;
    }
    uVar10 = 0x1008;
    puVar11 = pass1_1008_c6fa(_u16_1050_06e0,0x1e);
    paVar6 = CONCAT22(in_register_0000000a,(puVar11 >> 0x10));
    uVar2 = puVar11;
    ...
    for uStack22 in 0 .. uStack18 {
      paVar12 = pass1_1030_1d7c(uVar3,paVar7,puStack14);
      paVar7 = (paVar12 >> 0x10);
...
// WARNING: Globals starting with '_' overlap smaller symbols at the same address
pub unsafe fn pass1_1038_44d8(mut param_1: i16,mut param_2: i16,mut param_3: i16,mut param_4: u16 ,mut param_5: u16 ,mut param_6: u16 )

{
  ...
  if ((param_2 != 0) || (param_1 != 0)) {
    ...
    if (iVar8 < 0x0) {
      (iVar9 + param_3 + 0x14e) = 0;
    }
    uVar9 = 0x1008;
    puVar10 = pass1_1008_c6fa(_u16_1050_06e0,0x1e);
    paVar6 = CONCAT22(in_register_0000000a,(puVar10 >> 0x10));
    uVar2 = puVar10;
    ...
    uStack18 = CONCAT22(paVar7,uVar3);
    for uStack22 in 0 .. uStack18 {
      paVar11 = pass1_1030_1d7c(uVar3,paVar7,puStack14);
      paVar7 = (paVar11 >> 0x10);
...
// WARNING: Globals starting with '_' overlap smaller symbols at the same address
pub unsafe fn pass1_1038_45e4(mut param_1: u16 ,mut param_2: i16,mut param_3: u32)

{
  ...
  iVar8 = param_2;
  uVar4 = param_1;
  pass1_1030_38f2((iVar12 + 0x1f6),1);
  ...
  if ((iVar10 < 0x0) || ((iVar10 < 0x1 && (uVar6 + uVar13 == 0)))) {
    iVar10 = -0x1;
  }
  else {
    iVar10 = 0x1;
  ...
  *piVar1 = *piVar1 + iVar10;
  ...
  uVar7 = puVar16;
  pass1_1038_4d6e(uVar7,puVar11,param_3,puVar16);
  ...
  if (puStack22.is_null() == false) {
    ppcVar2 = uVar3;
    (**ppcVar2)(0x1008,uVar7,puVar11,1);
  }
  piVar1 = (iVar12 + 0x24);
...
// WARNING: Globals starting with '_' overlap smaller symbols at the same address
pub unsafe fn pass1_1038_4760(mut param_1: u32)

{
  ...
  let mut uVar9: u16;
  let mut iVar10: *mut astruct_700;
  let mut uVar10: u16;
  let mut uVar11: u16;
  let mut puVar12: *mut u32;
  let mut uVar13: u32;
  ...
  *puVar1 = *puVar1 + iVar10.field521_0x20c;
  ...
  puVar7 = (puVar12 >> 0x10);
  uVar6 = puVar12;
  pass1_1038_4d6e(uVar6,puVar7,param_1,puVar12);
  puStack10 = CONCAT22(puVar7,uVar6);
  uVar11 = 0x1008;
  puVar12 = pass1_1008_c6fa(_u16_1050_06e0,0x1a);
  puVar8 = (puVar12 >> 0x10);
  uVar3 = puVar12;
  pass1_1038_4d6e(uVar3,puVar8,param_1,puVar12);
...
pub unsafe fn pass1_1038_48e0(mut param_1: u32,mut param_2: i16)
...
pub unsafe fn pass1_1038_4900(mut param_1: u32)
...
// WARNING: Globals starting with '_' overlap smaller symbols at the same address
pub unsafe fn pass1_1038_4918(mut param_1: i16,mut param_2: u16 ,mut param_3: u32)

{
  ...
  let mut local_14a: [u8;0x4] = [0;0x4];
  let mut puStack326: *mut u32;
  let mut local_144: [u8;0x124] = [0;0x124];
  ...
  if ((uStack14 != 0) &&
    ...
    *piVar1 = *piVar1 + 1;
    ...
    if (bStack347 != 0) {
      ...
      uVar10 = struct_op_1030_73a8(CONCAT22(uVar5,uVar4),uVar4,uVar5);
      uVar5 = (uVar10 >> 0x10);
      if ((uVar5 | uVar10) != 0) {
        iVar7 = (uVar10 + 0xc);
        if (iVar7 < 1) {
    ...
    struct_op_1028_87f0(CONCAT22(0x1050,local_144),0x0,0x0,0x10,&local_20,&DAT_1050_1050,
                        (iVar6 + 0x4),(iVar6 + 0x8));
    fn_ptr_1030_835a(_u16_1050_5748,CONCAT22(0x1050,local_144));
  }
  return;
}
pub unsafe fn pass1_1038_4b20(mut param_1: u16 ,mut param_2: u32,mut param_3: u32,mut param_4: u32)

{
  let mut paVar1: *mut astruct_360;

  paVar1 = (param_2 + 0xc);
  pass1_1020_c4f4(paVar1,param_1,paVar1,param_3,(param_3 >> 0x10),param_4);
  return;
}
...
pub unsafe fn pass1_1038_4d0e(param_1: *mut astruct_685,mut param_2: u16 )

{
  let mut iVar1: *mut astruct_686;
  let mut uVar1: u16;
...
pub unsafe fn pass1_1038_4d3c(mut param_1: u32,param_2: *mut c_char,mut param_3: u16 )
...
// WARNING: Globals starting with '_' overlap smaller symbols at the same address
pub unsafe fn pass1_1038_4d6e(mut param_1: u16 ,param_2: *mut u8,param_3: *mut astruct_691,param_4: *mut u32)

{
  ...
  if (uVar5 == 0) {
    ...
    struct_op_1030_1cd8(CONCAT22(paVar6,param_1),0x5,0x5);
  }
...
// WARNING: Globals starting with '_' overlap smaller symbols at the same address
pub unsafe fn pass1_1038_4f54(mut param_1: u16 ,mut param_2: u32,mut param_3: u16 )
...
pub unsafe fn pass1_1038_4fd8(mut param_1: u16 ,mut param_2: u32,mut param_3: u16 )
