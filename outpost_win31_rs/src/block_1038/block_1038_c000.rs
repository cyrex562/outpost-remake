...

{
  ...
  SetFocus16(*(HWND16 *)(struct_b_param_1 + 0x6));
  return;
}
...

{
  ...
  if (param_4 == 0x177) {
    pass1_1008_e05e(*(astruct_102 **)(param_1 + 0x8e),0x2,CONCAT22(param_2,param_1 + 0x19eU),
    ...
    ;
    MessageBox16(0x30,CONCAT22(0x1050,local_50c),CONCAT22(0x1050,local_70c),*(HWND16 *)(param_1 + 0x6));
  }
  else {
    if (param_4 != 0x178) {
    ...
    uVar2 = param_2;
    iVar1 = pass1_1008_e10c(*(astruct_102 **)(param_1 + 0x8e),CONCAT22(param_2,param_1 + 0x19e),
    ...
    if (iVar1 == 0) {
      ...
      MessageBox16(0x30,CONCAT22(0x1050,local_50c),CONCAT22(0x1050,local_40c),*(HWND16 *)(param_1 + 0x6)
                  );
      return;
    }
...

{
  ...
  LVar3 = SendMessage16(param_1 & 0xffff0000 | (iVar1 + 0x19e),wparam_00,0x408,*(HWND16 *)(iVar1 + 0x94));
  return LVar3;
}
...

{
  ...
  uVar3 = param_1;
  pass1_1008_e320(*(astruct_102 **)(param_1 + 0x8e),(param_1 & 0xffff0000 | (param_1 + 0x19eU))
                  ,(param_1 & 0xffff0000 | uVar1));
  SetWindowText16(CONCAT22(uVar3,uVar1),*(HWND16 *)(param_1 + 0x9a));
  uVar2 = pass1_1008_e2a4(*(astruct_102 **)(param_1 + 0x8e),
                          (param_1 & 0xffff0000 | (param_1 + 0x19eU)),pcStack12);
  EnableWindow16(uVar2 & 0x1,*(HWND16 *)(param_1 + 0x96));
  EnableWindow16(uVar2 & 0x2,*(HWND16 *)(param_1 + 0x98));
  return;
}
...
LAB_1038_c8da:
    ...
    if (iVar1 != (astruct_910 *)&u16_1050_0008 && 0x0 < (iVar1 + -0x7)) {
      if (iVar1 != (astruct_910 *)(&u16_1050_0008 + 1)) goto LAB_1038_c93c;
...
astruct_57 * pass1_1038_cad8(param_1: *mut u8,param_2: *mut astruct_57,mut param_3: u16 )
...

{
  ...
  for (iStack10 = 0; iStack10 < uVar3; iStack10 += 1) {
