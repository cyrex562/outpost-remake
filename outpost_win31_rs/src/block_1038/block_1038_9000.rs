...

{
  ...
  if ((-0x1 < iStack8) &&
     (UStack6 = GetDlgItemInt16(0x1,&local_c,(INT16)&DAT_1050_1050,*(HWND16 *)(iStack8 * 0xe + 0x5a72)), local_c != 0)
     ) {
    if (param_5 == 0) {
      UStack6 += 0x1;
    }
...
pub fn enable_win_1038_9a66(param_1: *mut u8,astruct_903 *pstruct903_param_2,u16 in_b_enable_3,mut param_4: u32)
...

{
  ...
  paVar3 = (astruct_57 *)CONCAT22(uVar4,((IVar2 * PTR_LOOP_1050_5ef8) >> 0x10));
  ...
  uVar7 = (puVar5 >> 0x10);
  iStack36 = 0;
  while (iVar3 = (astruct_778 *)(iStack36 * 0x2), (&iVar3[0x52].field_0x0 + puVar5) != 0) {
...

{
  ...
  if (param_5 == 0xeb) {
    ...
    uVar2 = (puVar5 >> 0x10);
    iStack12 = 0;
    while (iVar2 = (astruct_905 *)(iStack12 * 0x2), (iVar2 + iVar3) != 0) {
