...
pub fn pass1_1038_354a(param_1: *mut astruct_424,mut param_2: u16 ,param_3: *mut u8)
...
pub fn pass1_1038_35a8(mut param_1: u16 ,param_2: *mut u8,mut param_3: u16 ,param_4: *mut astruct_425)
...

{
  ...
  if (param_3 != param_4) {
    ...
    if (param_3 < param_4) {
      ...
      if ((iVar10.field525_0x210 == 0) || (lVar2 = iVar10.field525_0x210, *(i32 *)(lVar2 + 0xa) == 0)) {
        ...
        for (uStack10 = 0; uStack10 < uStack6; uStack10 += 1) {
          ...
          if ((uVar7 != 0) && (uVar3 = pass1_1030_6fa0(uVar5 & 0xffff | param_1 << 0x10), uVar3 == 0xb)) {
            pass1_1030_7c50(uStack12,paVar9,
                            (astruct_305 *)CONCAT13((param_1 >> 0x8),CONCAT12(param_1,uVar5)),
                            uStack12,0x4);
            return;
          }
          param_1 = paVar9;
      ...
      if ((iVar10->field525_0x210 == 0) || (lVar2 = iVar10->field525_0x210, *(i32 *)(lVar2 + 0xa) == 0)) {
        ...
        for (uStack10 = 0; uVar7 = param_1, uStack10 < uStack6; uStack10 += 1) {
          ...
          if ((uVar8 != 0) && (uVar3 = pass1_1030_6fa0(uVar5 & 0xffff | uVar7 << 0x10), uVar3 == 0xb)) {
            pass1_1030_6e9c((astruct_301 *)CONCAT13((uVar7 >> 0x8),CONCAT12(uVar7,uVar5)),
                            iStack22,0x4);
            return;
          }
        }
...

{
  ...
  uVar9 = (param_3 >> 0x10);
  iVar8 = param_3;
  if ((*(i32 *)(iVar8 + 0x210) == 0) || (uVar2 = (iVar8 + 0x210), *(i32 *)(uVar2 + 0xa) == 0))
  {
    if (*(i32 *)(iVar8 + 0xc) == 0) {
      param_1 = 0;
      uVar6 = 0;
    ...
    uVar2 = (iVar8 + 0x210);
    uVar4 = (uVar2 + 0xa);
    for (uStack12 = 0; uStack12 < uVar4; uStack12 += 1) {
      uVar5 = uVar4;
      bad_1030_1312();
      uVar6 = param_2 | uVar5;
      if (uVar6 != 0) {
...

{
  ...
  if (uVar9 == 0) {
    ...
    uVar12 = (uVar5 >> 0xf);
    uVar14 = 0x1030;
    struct_1030_11aa((astruct_156 *)CONCAT22(paVar11,uVar10),0x5,uVar5);
  ...
  for (uStack20 = 0; uStack20 < (uVar6 & 0xffff | ZEXT24(puVar8) << 0x10); uStack20 += 1) {
    ...
    uVar12 = uVar10;
    if (uVar10 != 0) {
      pass1_1030_1358((astruct_291 *)iVar13->field528_0x210,uVar16,uVar5,uStack20 + 1);
    }
    uVar14 = 0x1030;
  }
  if (puVar3 != NULL) {
...
// WARNING: Globals starting with '_' overlap smaller symbols at the same address
pub fn pass1_1038_3cc0(mut param_1: u32,mut param_2: u16 ,param_3: *mut u8,mut param_4: u16 )
...
LAB_1038_3e67:
  ...
  // TODO: goto LAB_1038_3e6c;
    ...
    (**ppcVar2)(0x1008,uVar6,paVar10);
    uStack22 = CONCAT22(paVar10,uVar6);
    for (uStack18 = 0; uStack18 < uStack22; uStack18 += 1) {
      uVar13 = 0x1030;
      paVar15 = (astruct_15 *)pass1_1030_1d7c(uVar6,paVar10,puStack26);
...

{
  ...
  if (uVar4 != 0) {
    ...
    for (uStack22 = 0; uStack22 < uStack6; uStack22 += 1) {
      uVar1 = (uVar7 + 0xc);
