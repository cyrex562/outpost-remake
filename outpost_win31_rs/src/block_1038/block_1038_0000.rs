    ...
    for uStack22 in 0 .. uStack18 {
      ...
      if (uVar7 != 0) {
        ...
        uVar8 = 0x1030;
        uVar10 = struct_op_1030_73a8(CONCAT22(uVar7,uVar4),uVar4,uVar7);
...
pub unsafe fn pass1_1038_0f8c(mut param_1: u16 ,mut param_2: u32,mut param_3: u16 ,mut param_4: u16 ,param_5: *mut u32,mut param_6: u32)

{
  ...
  let mut paStack80: *mut astruct_99;
  ...
  loop {
    ...
    uVar9 = uStack12;
    uVar11 = param_2;
    (**ppcVar5)(unaff_CS,param_5,uStack16,(uStack16 >> 0x10),puVar15);
    uStack18 = uVar11;
    uVar12 = uVar9;
    ...
    if (uVar11 != 0) {
      ...
      unaff_CS = 0x1030;
      uStack24 = uVar12;
      puStack28 = struct_op_1030_73a8(CONCAT22(uStack22,uVar12),uVar12,uStack22);
      param_2 = puStack28 >> 0x10;
      puVar8 = local_20;
      ppcVar5 = (*puStack28 + 0x40);
      (**ppcVar5)(0x1030,puStack28,(puStack28 >> 0x10),puVar8,&DAT_1050_1050);
      if (puVar8.is_null()) {
        ...
        loop {
          ...
          (iVar13 + 0x6) = uVar3;
          (iVar13 + 0x8) = uVar4;
          pass1_1028_6408(puStack28,paStack80);
        }
      }
      else {
        ppcVar5 = (*param_5 + 0x8);
        (**ppcVar5)(0x1030,param_5,0x0,0x0,uStack16,(uStack16 >> 0x10));
      }
    }
    uStack16 += 0x1;
  }
