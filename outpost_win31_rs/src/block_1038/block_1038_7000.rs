  ...
  if (((&iVar8->field13_0xe + 0x2) | &iVar8->field13_0xe) == 0) {
    ...
    for (uStack12 = 0; uStack12 < uStack4; uStack12 += 1) {
      ...
      if (local_a != 0) {
        ...
        uVar8 = lVar2;
        (iVar10 + 0xc) = uVar8;
        pass1_1030_6a2c(uVar8,(lVar2 >> 0x10),(astruct_382 *)param_3,(astruct_383 *)paStack16);
      }
    }
  }
  return;
...
code_r0x10387545:
  ...
  // TODO: goto LAB_1038_7549;
    ...
    if ((iVar9->field9_0xc != 0) || (*(i32 *)&iVar9->field_0xe != 0)) {
...
pub fn pass1_1038_7dc6(param_1: *mut u8,astruct_903 *pstruct903_param_2,mut param_3: u16 ,mut param_4: u32)
