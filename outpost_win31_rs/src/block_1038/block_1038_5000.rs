    ...
    if (uVar5 != 0) {
      ...
      for (uStack30 = 0; uStack30 < uStack28; uStack30 += 1) {
        ...
        if (uVar5 != 0) {
          ...
          iVar7 = (uVar3 + 0xc) * 0x4;
          *(i32 *)(iVar6 + iVar7 + 0x14e) = *(i32 *)(iVar6 + 0x14e + iVar7) + 1;
        }
      }
    }
  }
