...
pub fn FUN_1010_9900(mut param_1: u16, mut param_2: u32, param_3: *mut u8) -> u16 {
    let mut uVar1: u32;
    let mut BVar2: bool;
    let mut uVar3: u16;
    let mut iVar4: i16;
...
pub fn pass1_1010_4f20(mut param_1: u16, mut param_2: u16, mut param_3: i16) -> u16 {
    return (param_3 * 0x2 + 0x139a);
}

pub fn pass1_1010_4f30(
    mut param_1: u16,
    mut param_2: u16,
    param_3: *mut u16,
    param_4: *mut u16,
