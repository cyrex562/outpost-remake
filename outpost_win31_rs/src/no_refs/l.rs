...
pub unsafe fn load_string_1010_ac92(
    mut param_1: u16,
    mut param_2: u16,
    mut param_3: i16,
) -> *mut c_char {
...
pub unsafe fn string_op_1010_ada6(
    mut param_1: u16,
    mut param_2: u16,
    mut param_3: u16,
    mut param_4: i16,
