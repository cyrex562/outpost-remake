use crate::block_1010::block_1010_8000::{load_string_1010_847e, load_string_1010_84e0, msg_box_op_1010_8bb4, pass1_1010_878c, set_err_mode_1010_8b14};
...
pub unsafe fn pass1_1010_8c78(param_1: *mut u16) {
    *param_1 = 0x8ee2;
    (param_1 + 0x2) = 0x1010;
...
pub unsafe fn unk_load_str_op_1010_8c96(
    param_1: *mut u8,
    mut param_2: u32,
    mut param_3: u32,
    mut param_4: u32,
...
pub unsafe fn pass1_1010_8f78(param_1: *mut StructD) {
...
pub unsafe fn pass1_1010_8fba(mut param_1: u16, param_2: *mut astruct_411) {
