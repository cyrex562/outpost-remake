...
pub fn pass1_1020_bd6c(mut param_1: u32, mut param_2: u32) -> i16 {
...
pub fn pass1_1020_c7fa(mut param_1: u32, mut param_2: u32) -> i16 {
    return (param_1 + 0x4) - (param_2 + 0x4);
}
...
pub fn pass1_1020_cd30(mut param_1: u32) -> u16 {
    let mut iVar1: i16;
    let mut uVar2: u16;
