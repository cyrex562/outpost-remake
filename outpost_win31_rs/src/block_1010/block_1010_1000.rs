...

{
  ...
  uVar5 = (param_1 >> 0x10);
  pcVar1 = pass1_1010_b038(*(u8 **)(param_1 + 0x6e),uVar6,in_EDX,0x1770,
                           in_stack_0000ffee);
...

{
  ...
  uVar2 = uVar3;
  pcVar1 = pass1_1010_b038(*(u8 **)(param_1 + 0x6e),uVar4,uVar3,0x178a,param_3);
...

{
  ...
  pass1_1010_1f62((astruct_27 *)(param_1 & 0xffff | ZEXT24(uVar4) << 0x10),0x1);
