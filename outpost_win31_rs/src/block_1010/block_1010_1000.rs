...

{
  ...
  paVar15 = (astruct_57 *)(param_2 & 0xffff0000);
  if ((param_2 | param_1) == 0) {
    iVar6 = NULL;
  }
  else {
    paVar24 = pass1_1010_37d4((astruct_223 *)CONCAT22(param_2,param_1));
    paVar15 = (astruct_57 *)(paVar15 & 0xffff0000 | paVar24 >> 0x10);
  ...
  paVar15 = (astruct_57 *)(paVar15 & 0xffff0000 | paVar25 >> 0x10);
  iVar7 = 0;
  ...
  loop {
    ...
    paVar25 = (astruct_57 *)(paVar15 & 0xffff0000 | uVar9);
    ...
    paVar15 = (astruct_57 *)(paVar25 & 0xffff0000 | uVar14);
    if (uVar14 == 0) {
    ...
    while( true ) {
      ...
      paVar15 = (astruct_57 *)(paVar15 & 0xffff0000 | uVar10);
      ...
      paVar15 = (astruct_57 *)(uVar16 & 0xffff0000 | uVar10);
      iStack42 += 0x1;
      uVar4 = (uStack14 * 0x4 + iVar7);
      ppcVar3 = (code **)((uStack14 * 0x4 + iVar7) + 0x1c);
      ...
      while( true ) {
        ...
        ppcVar3 = (code **)((iStack40 * 0x4 + iVar5) + 0x1c);
        (**ppcVar3)(0x1000,uVar4,(uVar4 >> 0x10),iStack42,
...

{
  ...
  if ((param_4 + 0x16) == 0x3) {
    ...
    iVar6 = uVar1;
    uVar1 = (iVar6 + 0x16);
    paVar9 = (astruct_15 *)struct_op_1030_73a8(*(astruct_419 **)(uVar1 + 0x4),iVar6,(paVar8 >> 0x10));
    uVar5 = uVar5 & 0xffff0000 | paVar9 >> 0x10;
    uVar2 = pass1_1010_7818(paVar8,paVar9);
    uVar1 = (iVar6 + 0x16);
    uVar3 = uVar2;
    ui_op_1010_79aa(paVar8,0x0,*(i32 *)(uVar1 + 0x4));
    if (uVar3 == 0) {
      uVar1 = (iVar6 + 0x16);
...

{
  ...
  if (uVar1 != 0) {
    pass1_1040_c54a((astruct_65 *)CONCAT22(paVar2,param_5),0x0,CONCAT22(param_4,param_3),
...

{
  ...
  ppuVar6 = (u8 **)CONCAT22((in_stack_0000fff4 >> 0x10),0x3);
...

{
  ...
  struct_1_hi = (astruct_455 *)(param_1 >> 0x10);
...

{
  ...
  puVar3 = mixed_1010_20ba(in_EDX,_u16_1050_0ed0,(u8 **)CONCAT22(param_2,0x32),in_stack_0000fe8e,
...

{
  ...
  uVar5 = (astruct_15 *)(param_2 >> 0x10);
  if (((param_2 + 0x1c) != 0x2) || (((param_2 + 0x1e) & 0xff) != 0)) {
    uVar7 = pass1_1028_b58e((astruct_15 *)(param_2 & 0xffff | ZEXT24(uVar5) << 0x10));
    uVar6 = (param_1 >> 0x10);
    uVar1 = (param_1 + 0x6e);
...

{
  ...
  pass1_1010_1f62((astruct_27 *)(param_1 & 0xffff | ZEXT24(uVar4) << 0x10),1);
...

{
  ...
  if (iVar3.field4_0x4 == NULL) {
    ...
    uVar2 = param_5;
    uVar3 = uVar2 | in_AX;
    param_5 = (astruct_57 *)(param_5 & 0xffff0000 | uVar3);
    if (uVar3 == 0) {
...

{
  ...
  while( true ) {
    ...
    if (*(StructD **)(puVar5 + 0x4) == param_2) {
      uStack4 = 0x1;
      ppcVar3 = (code **)(*iVar6.field4_0x4 + 0xc);
      (**ppcVar3)(0x1008);
      uStack8 = 0;
    }
  }
