...

{
  ...
  uVar2 = (param_1 >> 0x10);
  uVar1 = (param_1 + 0x66);
  pass1_1000_4aea((param_1 + 0x64),uVar1,(uVar1 >> 0x10),0x4,
                  (s_dibtext_bmp_1050_1844 + 0x6));
  return;
}
pub fn pass1_1010_116c(param_1: u32,mut param_2: i16,mut param_3: u16 )
...

{
  ...
  iVar18: *mut astruct_234;
  let mut iVar19: i16;
  let mut iVar21: i16;
  iVar20: *mut astruct_238;
  let mut uVar22: u16;
  let mut uVar23: u16;
  paVar24: *mut astruct_223;
  ...
  loop {
    ...
    while( true ) {
      ...
      (**ppcVar3)(0x1000,uVar4,(uVar4 >> 0x10),iStack42,
    ...
    iVar21 = iVar7;
    uVar23 = uVar12;
    paVar25 = struct_1010_38f8(uVar10,paVar15,*(astruct_240 **)(uVar4 + uStack14 * 0x4),uStack14);
...
pub fn pass1_1010_1656(mut param_1: u16 ,param_2: *mut u8,mut param_3: u16 ,param_4: *mut astruct_27,mut param_5: u16 ,mut param_6: u32)

{
  ...
  if ((param_4 + 0x16) == 0x3) {
    paVar8 =
             mixed_1010_20ba(paVar4,_u16_1050_0ed0,CONCAT22(param_3,0x32),in_stack_0000fe88,
    ...
    iVar6 = uVar1;
    uVar1 = (iVar6 + 0x16);
    paVar9 = struct_op_1030_73a8(*(astruct_419 **)(uVar1 + 0x4),iVar6,(paVar8 >> 0x10));
...

{
  ...
  if (uVar1 != 0) {
    pass1_1040_c54a(CONCAT22(paVar2,param_5),0x0,CONCAT22(param_4,param_3),
...
// WARNING: Globals starting with '_' overlap smaller symbols at the same address
pub fn pass1_1010_1788(param_1: *mut c_char,mut param_2: u16 ,mut param_3: u16 ,param_4: *mut astruct_15)

{
  ...
  puVar4 = mixed_1010_20ba(CONCAT22(in_register_0000000a,param_1),_u16_1050_0ed0,ppuVar6,in_stack_0000fe9e
...

{
  ...
  let mut uVar2: u16;
  struct_1: *mut astruct_455;
  struct_1_hi: *mut astruct_455;
...
pub fn pass1_1010_184a(param_1: u32,param_2: *mut u32)
...

{
  ...
  puVar1 = mixed_1010_20ba(param_1,_u16_1050_0ed0,CONCAT22(unaff_BP,0x3),in_stack_0000fea6,
...
pub fn pass1_1010_19a4(mut param_1: u16 ,param_2: *mut u32)
...

{
  ...
  uVar5 = (param_1 >> 0x10);
  pcVar1 = pass1_1010_b038((param_1 + 0x6e),uVar6,in_EDX,0x1770,
                           in_stack_0000ffee);
  iVar2 = pass1_1000_3e2c(CONCAT22(in_EDX,pcVar1));
  puVar3 = mixed_1010_20ba(in_EDX,_u16_1050_0ed0,CONCAT22(param_2,0x32),in_stack_0000fe8e,
...
pass1_1010_1a66: u8(mut param_1: u32,param_2: *mut astruct_15)

{
  ...
  if (((param_2 + 0x1c) != 0x2) || (((param_2 + 0x1e) & 0xff) != 0)) {
    ...
    if ((uVar7 != 0x2) || ((uVar7 & 0xff0000) != 0)) {
      ...
      if ((BVar4 == 0) && (BVar4 = pass1_1008_c6ae(_u16_1050_06e0,uVar4,0x6), BVar4 == 0)) {
        uVar3 = '\0';
      }
      else {
        uVar3 = '\x01';
...
astruct_19 * pass1_1010_1b6e(param_1: *mut StructD,param_2: *mut astruct_19,param_3: *mut astruct_19,mut param_4: u16 )
...
pub fn pass1_1010_1bb4(mut param_1: u16 ,param_2: *mut u32)
...
{
  let mut pcVar1: *mut c_char;
  uVar3: *mut astruct_15;
  uVar2: *mut astruct_15;
  let mut uVar4: u32;
...

{
  ...
  if (((param_2 + 0x1c) != 0x2) || (((param_2 + 0x1e) & 0xff) != 0)) {
    ...
    if ((uVar7 != 0x2) || ((uVar7 & 0xff0000) != 0)) {
      ...
      if ((BVar5 == 0) && (BVar5 = pass1_1008_c6ae(_u16_1050_06e0,uVar3,0x12), BVar5 == 0)) {
        uVar2 = '\0';
      }
      else {
        uVar2 = '\x01';
...
{
  iVar1: *mut astruct_19;
  uVar1: *mut astruct_19;
...
pub fn pass1_1010_1d80(param_1: *mut StructD)
...
{
  let mut ppcVar1: *mut *mut code;
  in_AX: *mut astruct_241;
  let mut uVar2: u16;
  let mut uVar3: u16;
  iVar3: *mut astruct_242;
  let mut uVar4: u16;
...
pub fn pass1_1010_1ea6(mut param_1: u32,param_2: *mut StructD)
