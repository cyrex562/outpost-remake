...

{
  ...
  if ((iVar6 + 0x10) == 1) {
    ...
    if ((param_5 * 0x10 + 0x10) == 0x2) {
      ...
      if (*(i32 *)&uVar9->field1660_0x67c == 0) {
        return 0x0;
      }
      uVar2 = 0x63f0;
      iVar6 = param_5 * 0x10;
...

{
  ...
  loop {
    ...
    iVar2 = lVar5;
    bVar3 = false;
    for (lStack20 = 0; plVar1 = (i32 *)(uVar6 + 0x4), *plVar1 != lStack20 && lStack20 <= *plVar1;
        lStack20 += 1) {
      if (bVar3) {//
LAB_1010_86fc:
        if (bVar3) {
...

{
  ...
  if (*(i32 *)(param_1 + 0x67c) != 0) {
    ...
    uVar9 = (uStack16 >> 0x10);
    iVar6 = uStack16;
    if (uVar2 < *(i32 *)(iVar6 + 0x4)) {
      uVar2 = (iVar6 + 0x4);
    }
    uVar3 = (uStack20 + 0x8);
    if (uVar3 < *(i32 *)(iVar6 + 0x8)) {
      uVar3 = (iVar6 + 0x8);
    }
    uVar1 = uVar3;
...

{
  ...
  if (((param_1 + 0x67e) | (param_1 + 0x67c)) != 0) {
    for (uStack8 = 0x1; puVar3 = paVar5, uStack8 < 0xa; uStack8 += 1) {
      ...
      pass1_1010_86de(param_1,param_2,param_3,(astruct_76 *)CONCAT22(puVar3,uVar1));
