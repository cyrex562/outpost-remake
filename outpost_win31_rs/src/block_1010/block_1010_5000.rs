...
u16 * pass1_1010_5004(param_1: *mut StructD,param_2: u8,mut param_3: u16 )
...
pub fn pass1_1010_503e(param_1: *mut u8,param_2: *mut astruct_19,mut param_3: u16 )
...

{
  ...
  iVar5: *mut astruct_246;
  iVar6: *mut astruct_247;
  let mut iVar7: i16;
  let mut uVar8: u16;
  let mut uVar9: u16;
...
pub fn string_1010_5286(param_1: *mut c_char,mut param_2: u16 ,mut param_3: u16 ,mut param_4: u16 ,mut param_5: u32) -> u32
...
pub fn pass1_1010_52fc(mut param_1: u16 ,param_2: *mut u8,mut param_3: u32,mut param_4: u32)
...
pub fn pass1_1010_531c(mut param_1: u16 ,param_2: *mut u8,mut param_3: u32,mut param_4: u32)
...
pub fn pass1_1010_533c(param_1: *mut u8,mut param_2: u32,param_3: *mut c_char)
...

{
  ...
  if (**(param_2 + 0xe) != '\0') {
    ...
    puVar21 = mixed_1010_20ba(paVar13,_u16_1050_0ed0,CONCAT22(param_1,0x48),in_stack_0000fd74,
  ...
  if ((**(param_2 + 0xe) != '\0') &&
     (iVar8 = pass1_1000_475e((param_2 + 0xe),s_on_1050_13c4), iVar8 == 0)) {
    (param_2 + 0x7a) = 0x1;
  }
  pcVar20 = *(param_2 + 0xe);
...

{
  ...
  puVar10 = mixed_1010_20ba(CONCAT22(in_register_0000000a,param_1),_u16_1050_0ed0,
                            CONCAT22(unaff_SI,0x48),in_stack_0000fe76,in_stack_0000ff9a,in_stack_0000ffa0,
                            in_stack_0000ffa4);
...
// WARNING: Globals starting with '_' overlap smaller symbols at the same address
pub fn pass1_1010_5d9c(param_1: *mut u8,mut param_2: u32,mut param_3: i16)

{
  ...
  if (param_3 == 0) {
    puVar1 = mixed_1010_20ba(CONCAT22(in_register_0000000a,param_1),_u16_1050_0ed0,
                             CONCAT22(in_stack_0000fffa,0x2e),in_stack_0000fea2,in_stack_0000ffc6,
...
pub unsafe fn pass1_1010_5dc6(mut param_1: u32,mut param_2: u32) -> u16

{
  let mut BVar1: bool;
  let mut iVar2: i16;
  let mut uVar3: u16;
  in_stack_0000ffdc: mut HFILE16;
  local_c: *mut u8 [0x3];
  u16 local_6 [0x2];
...
{
  let mut uVar1: u16;
  iVar3: *mut astruct_73;
  uVar3: *mut astruct_73;
...
{
  let mut uVar1: u16;
  iVar3: *mut astruct_484;
  uVar2: *mut astruct_484;
...
pub fn pass1_1010_5fb0(mut param_1: u32,mut param_2: u16 ,param_3: *mut u32,mut param_4: u16 ,mut param_5: i16)

{
  let mut uVar1: u16;
  iVar1: *mut astruct_656;
...
{
  let mut uVar1: u16;
  iVar3: *mut astruct_485;
  uVar2: *mut astruct_485;
