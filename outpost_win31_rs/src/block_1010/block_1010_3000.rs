...
pub unsafe fn unk_destroy_win_op_1010_305a(mut param_1: u16 ,param_2: *mut astruct_27,mut param_3: i16,param_4: *mut astruct_65)
...
// LAB_1010_30ad:
      iVar7 = paStack6;
      if (bVar6) {
        while (paStack8 = iVar7 + 0x1, ppaVar1 = &iVar4.field20_0x16,
...

{
  ...
  if ((param_2.is_null() == false) &&
     (ppcVar5 = (param_1 + 0x24), (**ppcVar5)(unaff_CS,param_1,param_2), uVar8 != 0)) {
    ppcVar5 = (param_2 + 0x4);
...
pub fn pass1_1010_35a4(mut param_1: u16 ,param_2: *mut u32,mut param_3: u32)

{
  ...
  if (param_3 != 0) {
    ...
    if (uVar5 == 0) {
      ...
      pass1_1040_c54a((param_3 & 0xffff | paVar6 << 0x10),0x1,puStack8,in_stack_0000ffb0,paVar7);
      paVar8 = paVar7;
    }
    ...
    for (; (uStack12 & 0xf) != 0; uStack12 >>= 0x4) {
      ...
      if (uVar5 == 0) {
        ...
        uVar9 = SUB42(&PTR_LOOP_1050_1040,0x0);
        pass1_1040_c54a((puVar4 & 0xffff | paVar8 << 0x10),0x1,puStack8,in_stack_0000ffa6,
                        paVar6);
        paVar8 = paVar6;
      }
      ppcVar1 = (*param_2 + 0x18);
...
pub fn pass1_1010_3680(mut param_1: u16 ,param_2: *mut u8,mut param_3: u16 ,mut param_4: u16 ,mut param_5: u16 ,mut param_6: u16 )

{
  ...
  if (uVar1 != 0) {
    pass1_1040_c54a(CONCAT22(paVar2,param_1),0x1,CONCAT22(param_6,param_5),
...
pub fn pass1_1010_36b4(param_1: *mut StructD,param_2: u8) -> *mut StructD
...
pub fn pass1_1010_3770(mut param_1: u16 ,param_2: *mut astruct_477,param_3: *mut c_char)

{
  let mut uVar1: u16;
  iVar3: *mut astruct_477;
  uVar2: *mut astruct_477;
...
pub fn pass1_1010_3800(param_1: *mut StructD)
...
pub fn pass1_1010_3880(param_1: *mut StructD)
...
{
  let mut uVar1: u16;
  iVar2: *mut astruct_240;
  uVar2: *mut astruct_240;
  let mut paVar2: *mut Struct57;
...
pub fn pass1_1010_398e(mut param_1: u16 ,param_2: *mut u32,mut param_3: u16 ,mut param_4: u16 ,mut param_5: u32)
...
pub fn pass1_1010_3af2(param_1: *mut StructD,param_2: u8) -> *mut StructD
...
pub fn pass1_1010_3b18(param_1: *mut StructD,param_2: u8) -> *mut StructD
...
pub fn pass1_1010_3d38(param_1: *mut StructD,param_2: u8) -> *mut StructD
...
pub fn FUN_1010_3d44(mut param_1: u16 ,param_2: *mut StructD,param_3: u8) -> *mut StructD
...
pub fn pass1_1010_3e06(param_1: *mut StructD,param_2: u8) -> *mut StructD
...
pub fn pass1_1010_3f00(param_1: *mut StructD)
