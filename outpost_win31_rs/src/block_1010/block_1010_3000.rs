      ...
      if (param_3 == 0) {
        if (iVar4.field69_0x52 != 0) {
          ...
          loop {
            ...
            paStack8 = (astruct_874 *)(paStack8 + 1);
          } while (paStack8 < 0xa);
        }
...

{
  ...
  if (iVar3.field20_0x16 == 0) {
    pass1_1010_32f4(param_1,*(astruct_65 **)(iVar3 + 1));
  }
  else {
...

{
  ...
  if ((param_2 != NULL) &&
     (ppcVar5 = (code **)(param_1 + 0x24), (**ppcVar5)(unaff_CS,param_1,param_2), uVar8 != 0)) {
...

{
  ...
  if (param_3 != 0) {
    ...
    if (uVar5 == 0) {
      ...
      pass1_1040_c54a((astruct_65 *)(param_3 & 0xffff | paVar6 << 0x10),0x1,puStack8,in_stack_0000ffb0,paVar7);
      paVar8 = paVar7;
    }
    ...
    for (; (uStack12 & 0xf) != 0; uStack12 >>= 0x4) {
      ...
      if (uVar5 == 0) {
        ...
        uVar9 = SUB42(&PTR_LOOP_1050_1040,0x0);
        pass1_1040_c54a((astruct_65 *)(puVar4 & 0xffff | paVar8 << 0x10),0x1,puStack8,in_stack_0000ffa6,
                        paVar6);
        paVar8 = paVar6;
      }
      ppcVar1 = (code **)(*param_2 + 0x18);
...

{
  ...
  if (*(i32 *)(&iVar2.field12_0x14 + 0x2) != 0) {
...
u16 FUN_1010_3fc2(mut param_1: u16 ,mut param_2: u32,param_3: *mut u8)
