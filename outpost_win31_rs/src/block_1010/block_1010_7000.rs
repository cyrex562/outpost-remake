...

{
  ...
  uVar8 = (paVar11 >> 0x10);
  uVar4 = paVar11;
  if (((uVar8 | uVar4) != 0) && (*(i32 *)(uVar4 + 0x1c) == 0x8000002)) {
    return;
  }
  uVar3 = (param_1 + 0x2e);
  uVar1 = (param_1 + 0x30);
  ...
  uStack14 = uVar3;
  if (((uVar1 | uStack14) != 0) && (*(i32 *)(uStack14 + 0x200) == 0x8000002)) {
    return;
  }
  uVar3 = (param_3 + 0x14);
...
LAB_1010_73fe:
  ...
  case 0xa:
    mem_op_1000_179c(0x94,param_1);
    paVar10 = (astruct_57 *)(param_1 & 0xffff0000);
    if (((astruct_57 *)param_1 | paVar5) == 0) goto LAB_1010_73fe;
    uVar12 = SUB42(&u16_1050_1038,0x0);
...

{
  ...
  uVar3 = (param_1 >> 0x10);
  if ((*(i32 *)(param_1 + 0x1c) != 0) && ((param_3 != 0x0 || (param_2 != 0)))) {
    ...
    loop {
      ...
      if (((param_2 == 0) && (*(i32 *)(puVar2 + 0x4) == param_3)) ||
