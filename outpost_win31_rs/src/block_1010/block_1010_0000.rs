...

{
  ...
  puVar3 = mixed_1010_20ba(CONCAT22(uVar1,(paVar2 >> 0x10)),_u16_1050_0ed0,
                           CONCAT22(iVar4,0x48),in_stack_0000fe86,in_stack_0000ffaa,in_stack_0000ffb0,
                           in_stack_0000ffb4);
...

{
  ...
  uStack4 = 0;
  uVar5 = param_3;
  GetWindowPlacement16((WINDOWPLACEMENT16 *)local_18,&DAT_1050_1050);
  if ((iStack16 == -1) || (param_2 != 0)) {
    ...
    SetWindowPlacement16((WINDOWPLACEMENT16 *)local_18,&DAT_1050_1050);
  }
  return;
}
...
pub fn win_ui_op_1010_0240(mut param_1: u16 ,mut param_2: u16 ,mut param_3: u16 ,mut param_4: u16 ) -> BOOL16

{
  ...
  if (BVar2 != 0) {
    ...
    if (WVar3 == HINSTANCE16_1050_038c) {
      ...
      if (BVar2 != 0) {
        puVar5 = mixed_1010_20ba(paVar4,_u16_1050_0ed0,CONCAT22(uVar6,0x45),in_stack_0000fea2,
...
pub fn pass1_1010_02a2(param_1: *mut u16,param_2: u8) -> *mut u16
...
pub fn pass1_1010_043a(param_1: *mut astruct_27,param_2: i32,mut param_3: i16)

{
  ...
  iVar4: *mut astruct_27;
  iVar5: *mut astruct_227;
  uVar3: *mut astruct_27;
  let mut uVar4: u16;
  ...
  } while (((pchar_1 + 0x4) != param_3) || ((pchar_1 + 0x6) != param_2));
  return;
}
...

{
  ...
  uVar10: *mut astruct_27;
  uVar11: *mut astruct_27;
  let mut uVar12: u16;
  ...
  *param_2 = NULL;
  ...
  param_3 = uVar6;
  (param_3 + 0x2) = puVar9;
  while (pcVar7 = pass1_1000_472c(*param_3,'%'), (puVar9 | pcVar7) != 0) {
...
// LAB_1010_0621:
  ...
  (param_2 + 0x2) = puVar9;//
// LAB_1010_0850:
  while (pcVar7 = pass1_1000_472c(*param_2,'%'), (puVar9 | pcVar7) != 0) {
...
pub fn pass1_1010_0946(mut param_1: u16 ,mut param_2: u16 ,mut param_3: i16,param_4: *mut u8,mut param_5: i16,mut param_6: u16 ) -> u32

{
  ...
  uVar4 = 0x2;
  uVar5 = 0x400;
  puVar3 = mixed_1010_20ba(CONCAT22(in_register_0000000a,param_4),_u16_1050_0ed0,0x2003b,
...
// WARNING: Globals starting with '_' overlap smaller symbols at the same address
pub fn pass1_1010_09b4(mut param_1: u16 ,mut param_2: u16 ,mut param_3: u16 ,param_4: *mut u8,char **param_5,mut param_6: u32)
...
// LAB_1010_09db:
  ...
  uStack8 = 0;
  if (bVar2) {
    puVar9 = mixed_1010_20ba(paVar8,_u16_1050_0ed0,CONCAT22(in_stack_0000ffde,0x2),in_stack_0000fe86,
...
pub fn file_1010_0c7c(mut param_1: i16,param_2: *mut u8,param_3: *mut astruct_228,mut param_4: u32)

{
  let mut ppcVar1: *mut *mut code;
  let mut BVar2: bool;
  uVar4: *mut astruct_229;
  let mut uVar3: u16;
  let mut uVar5: u16;
  let mut in_register_0000000a: u16;
  let mut paVar6: *mut Struct57;
  iVar6: *mut astruct_228;
  let mut uVar7: u16;
  ...
  paStack8: *mut astruct_229;
  local_6: *mut astruct_229;
  let mut uStack4: u16;
  ...
  if (param_1 == 0) {
    ...
    if (BVar2 != 0) {
      ...
      BVar2 = read_file_1008_7dee(param_4,(param_3 & 0xffff0000 | ZEXT24(&iVar6.field_0xe)),0x2
                                 );
      if ((BVar2 != 0) &&
         (BVar2 = read_file_1008_7dee(param_4,
...
pub fn pass1_1010_0e46(param_1: *mut u16,param_2: u8,mut param_3: u16 ) -> *mut u16
...
pub fn pass1_1010_0e6c(param_1: *mut u16,param_2: u8) -> *mut u16
...
astruct_19 * pass1_1010_0eac(param_1: *mut u8,param_2: *mut astruct_19,mut param_3: u16 )
...

{
  ...
  (param_2 + 0x2) = 0x1010;
  puVar2 = mixed_1010_20ba(paVar1,_u16_1050_0ed0,CONCAT22(unaff_BP,0x3),in_stack_0000fea6,
...

{
  ...
  let mut uVar7: u32;
  let mut uVar8: u16;
  iVar8: *mut astruct_232;
  iVar9: *mut astruct_231;
  iVar10: *mut astruct_230;
  iVar11: *mut astruct_233;
  uVar9: *mut astruct_232;
  let mut uVar10: u16;
  paVar11: *mut astruct_232;
  let mut uVar12: u8;
  let mut uStack36: u32;
  let mut iStack32: i16;
  let mut uStack30: u16;
  astruct_92 **ppaStack28;
  paStack24: *mut astruct_15;
  astruct_92 local_14;
  ...
  loop {
    ...
    *ppaStack28 = paVar5;
    ...
    ppaStack28 = (astruct_92 **)(ppaStack28 & 0xffff0000 | ZEXT24(iVar10 + 1));
    uStack30 -= 1;
  } while (uStack30 != 0);//
// LAB_1010_10ca:
