...
pub unsafe fn pt_in_rect_1010_40f8(param_1: *mut astruct_57,mut param_2: u32,POINT16 *param_3,mut param_4: u16 ) -> i16
...
// LAB_1010_413e:
      if ((uStack4 != 0) && (0x3 < PTR_LOOP_1050_3960)) {
        puVar12 = mixed_1010_20ba(param_1,_u16_1050_0ed0,CONCAT22(param_4,iStack6 + 0xcU),
        ...
        if (uVar4 == 0) {
          ...
          if (uVar6 == 0) {
            ...
            iVar10 = string_1040_8520(uVar9,CONCAT22(paVar8,uVar5),HWND16_1050_0396,0x20030,
                                      0x6450643);
            uVar7 = uVar9;
          }
    ...
    BVar3 = PtInRect16(*param_3,((iStack6 * 0x10 + (iVar10 + 0x24)) * 0x8 + (iVar10 + 0x70)));
    if (BVar3 != 0) {
      uStack4 = 0x1;
...

{
  ...
  let mut paVar8: *mut Struct57;
  let mut uVar9: u32;
  iVar9: *mut astruct_243;
  let mut iVar11: i16;
  iVar10: *mut astruct_244;
  ...
  puVar14 = mixed_1010_20ba(param_1,_u16_1050_0ed0,CONCAT22(unaff_SI,0x2f),in_stack_0000fe6e,
...

{
  ...
  puVar3 = mixed_1010_20ba(CONCAT22(in_register_0000000a,param_1),_u16_1050_0ed0,
                           CONCAT22(in_stack_0000fff6,0x2f),in_stack_0000fe9e,in_stack_0000ffc2,
...

{
  ...
  puVar5 = mixed_1010_20ba(param_2,_u16_1050_0ed0,CONCAT22(piVar7,0x48),in_stack_0000fe7c,
...
// WARNING: Globals starting with '_' overlap smaller symbols at the same address
pub fn pass1_1010_4788(mut param_1: u16 ,mut param_2: u16 ,mut param_3: u32,param_4: *mut c_char)
...

{
  ...
  iVar4: *mut astruct_797;
  let mut uVar5: u16;
  let mut extraout_DX: *mut u8;
  let mut puVar5: *mut u8;
  let mut iVar7: i16;
  iVar8: *mut astruct_739;
  let mut uVar11: u16;
  let mut uVar12: u32;
  ...
  while( true ) {
    ...
    if (uVar5 != 0) {
      ...
      uVar11 = (uVar4 >> 0x10);
      iVar7 = uVar4;
      Rectangle16((iVar4 + iVar7 + 0x6),(iVar4 + iVar7 + 0x4),(iVar4 + iVar7 + 0x2),
                  (iVar4 + iVar7),hdc16_var_1);
    }
    iStack32 += 0x1;
  }
...
pub unsafe fn pass1_1010_49c0(mut param_1: u32) -> u16
...
pub unsafe fn pass1_1010_49e0(mut param_1: u32) -> u16
...
pub unsafe fn pass1_1010_4a12(mut param_1: u32) -> u16
...

{
  ...
  puVar5 = mixed_1010_20ba(paVar2,_u16_1050_0ed0,CONCAT22(uStack4,0x3),param_6,param_7,param_8,param_9);
...
// WARNING: Globals starting with '_' overlap smaller symbols at the same address
pub fn pass1_1010_4c3e(mut param_1: u32,mut param_2: i16,mut param_3: i16,param_4: *mut u8,mut param_5: u16 )
...

{
  ...
  iVar3: *mut astruct_245;
  iVar5: *mut astruct_747;
  let mut uVar6: u16;
  let mut uVar2: u32;
  let mut uVar1: u32;
...

{
  ...
  let mut uVar6: u16;
  let mut uVar5: u32;
  iVar6: *mut astruct_482;
  iVar7: *mut astruct_483;
  uVar7: *mut astruct_482;
  let mut uVar8: u16;
  let mut unaff_CS: u16;
