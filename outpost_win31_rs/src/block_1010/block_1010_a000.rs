...
pub unsafe fn pass1_1010_a0a0(mut param_1: u16 ,param_2: *mut astruct_252)

{
  ...
  iStack12 = 0x4;
  puVar12 = mixed_1010_20ba(paVar8,_u16_1050_0ed0,CONCAT22(in_stack_0000ffe4,0x2),in_stack_0000fe8c,
...

{
  ...
  (param_1 + 0xa) = 0xe9dc;
  (param_1 + 0xc) = 0x1010;
  puVar5 = mixed_1010_20ba(CONCAT22(uVar3,(paVar4 >> 0x10)),_u16_1050_0ed0,
                           CONCAT22(unaff_SI,0x2f),in_stack_0000fe4e,in_stack_0000ff72,in_stack_0000ff78,
                           in_stack_0000ff7c);
...
pub unsafe fn pass1_1010_a50c(param_1: *mut astruct_20,u8 **param_2,param_3: *mut StructD)
...
// WARNING: Globals starting with '_' overlap smaller symbols at the same address
pub unsafe fn pass1_1010_a568(mut param_1: u16 ,mut param_2: u16 ,mut param_3: u16 ,mut param_4: u16 ,mut param_5: u16 )
...
// WARNING: Globals starting with '_' overlap smaller symbols at the same address
pub unsafe fn pass1_1010_a58a(mut param_1: u16 ,mut param_2: u16 ,mut param_3: u16 ,mut param_4: u16 ,mut param_5: u16 )
...
pub unsafe fn pass1_1010_a5ac(mut param_1: u16 ,mut param_2: u16 ,mut param_3: u32) -> u16
...
// WARNING: Globals starting with '_' overlap smaller symbols at the same address
pub unsafe fn pass1_1010_a5ca(mut param_1: u16 ,mut param_2: u16 ,mut param_3: u16 ,mut param_4: u16 ,mut param_5: u16 )
...
// WARNING: Globals starting with '_' overlap smaller symbols at the same address
pub unsafe fn pass1_1010_a5ec(mut param_1: u16 ,mut param_2: u16 ,mut param_3: u16 ,mut param_4: u16 ,mut param_5: u32)
...
// WARNING: Globals starting with '_' overlap smaller symbols at the same address
pub unsafe fn pass1_1010_a69c(mut param_1: i16,mut param_2: u16 ,mut param_3: u32,mut param_4: u16 )
...
// TODO: goto switchD_1010_aaef_caseD_b;
  ...
  puVar6 = mixed_1010_20ba(paVar5,_u16_1050_0ed0,CONCAT22(in_stack_0000ffd2,0x35),in_stack_0000fe7a,
...
// TODO: goto LAB_1010_a91f;
  0x1e =>
    uVar2 = 0x1;
    iVar1 = 0x2;
    puVar6 = mixed_1010_20ba(paVar5,_u16_1050_0ed0,0x1002b,in_stack_0000fe76,in_stack_0000ff9a,
                             in_stack_0000ffa0,in_stack_0000ffa4);
    paVar5 = (paVar5 & 0xffff0000 | puVar6 >> 0x10);
    pass1_1010_08c0(puVar6,uVar2,iVar1);
    paVar7 =
             mixed_1010_20ba(paVar5,_u16_1050_0ed0,CONCAT22(in_stack_0000ffd2,0x40),in_stack_0000fe7a,
                             in_stack_0000ff9e,in_stack_0000ffa4,in_stack_0000ffa8);
...
switchD_1010_aaef_caseD_b:
  paVar8 =
           mixed_1010_20ba(paVar5,_u16_1050_0ed0,CONCAT22(param_4,0x37),in_stack_0000fe78,
  ...
  uVar3 = 0x1;
  paVar9 =
           mixed_1010_20ba(paVar5,_u16_1050_0ed0,0x1002b,in_stack_0000fe74,in_stack_0000ff98,
...
// WARNING: Could not reconcile some variable overlaps
// WARNING: Globals starting with '_' overlap smaller symbols at the same address
pub unsafe fn pass1_1010_abd2(param_1: *mut u8,mut param_2: u16 ,mut param_3: u16 ,mut param_4: i16)

{
  ...
  puVar3 = mixed_1010_20ba(CONCAT22(in_register_0000000a,param_1),_u16_1050_0ed0,
                           CONCAT22(unaff_SI,0x35),in_stack_0000fe8a,in_stack_0000ffae,in_stack_0000ffb4,
                           in_stack_0000ffb8);
  bVar1 = false;
  iStack16 = param_4;
...
pub unsafe fn pass1_1010_ac62(mut param_1: u16 ,mut param_2: u16 ,mut param_3: u16 ,mut param_4: u16 ,mut param_5: i16) -> u16
...
pub unsafe fn pass1_1010_acc0(mut param_1: u16 ,mut param_2: u16 ,mut param_3: u32) -> u16
...
pub unsafe fn pass1_1010_acec(mut param_1: u32,mut param_2: i16)
...
// WARNING: Globals starting with '_' overlap smaller symbols at the same address
pub unsafe fn pass1_1010_ad22(mut param_1: u16 ,mut param_2: u16 ,mut param_3: u16 ,mut param_4: u16 )
...
pub unsafe fn pass1_1010_ad64(mut param_1: u32,mut param_2: u16 ,mut param_3: u16 ,mut param_4: u32,mut param_5: u32)

{
  ...
  pass1_1010_c58as(param_1,param_2,CONCAT22(param_4,param_3),(param_4 >> 0x10),
                   param_5);
  return;
}
...
pub unsafe fn pass1_1010_ae12(param_1: *mut c_char,mut param_2: u16 ,mut param_3: u16 ,param_4: *mut c_char,mut param_5: i16) -> u16
...
// WARNING: Globals starting with '_' overlap smaller symbols at the same address
pub unsafe fn pass1_1010_ae92(mut param_1: u32,mut param_2: u16 ,mut param_3: u16 ,mut param_4: u32,mut param_5: u32)
  ...
  if (param_3 == 0x15) {
    ...
    if (bVar1 == 0) {
      ...
      if (((uVar2 == 0xe) && ((iVar4 != 0x0 || (0x32 < uVar7)))) &&
        ...
        uVar9 = 0;
        paVar8 =
                 mixed_1010_20ba(CONCAT22(uVar5,iVar4),_u16_1050_0ed0,0x37,in_stack_0000fe88
...
// WARNING: Globals starting with '_' overlap smaller symbols at the same address
pub unsafe fn pass1_1010_af66(mut param_1: u16 ,mut param_2: u32,mut param_3: u16 )
...
// WARNING: Globals starting with '_' overlap smaller symbols at the same address
pub unsafe fn pass1_1010_afa2(mut param_1: u16 ,mut param_2: u32,mut param_3: u16 )
...

{
  ...
  pass1_1038_4e78(puVar4,(uVar3 & 0xffff0000 | puVar4 >> 0x10),
