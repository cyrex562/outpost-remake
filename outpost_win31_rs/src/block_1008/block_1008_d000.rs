...

{
  ...
  for (uStack20 = 0; uStack20 < uStack14; uStack20 += 1) {
    ...
    if ((((uVar11 | uVar13) != 0) && ((uVar13 + 0x1c) != 0x8000002)) &&
      ...
      if (uVar12 == 0) {
        ...
        uVar20 = 0x1018;
        pass1_1018_4808(CONCAT22(paVar18,uVar7),0x1,
                        CONCAT13((paVar17 >> 0x8),CONCAT12(paVar17,uVar8)),(uVar13 + 0x4));
        uVar23 = uVar7;
  ...
  if (!bVar4) {
    ...
    if (uVar13 == 0) {
      ...
      uVar20 = 0x1018;
      pass1_1018_4808(CONCAT22(paVar18,uVar6),0x0,
                      CONCAT13((paVar14 >> 0x8),CONCAT12(paVar14,uStack14)),0x0);
      uVar23 = uVar6;
    }
    puVar2 = iVar15.field18_0x12;
    ppcVar3 = (*iVar15.field18_0x12 + 0x4);
...

{
    ...
    if ((((uVar14 | uVar12) != 0) && ((uVar12 + 0x1c) != 0x8000002)) &&
      ...
      if ((BVar7 == 0) && ((uVar12 + 0x1c) != lVar2)) {
        ...
        if (uVar13 == 0) {
          ...
          uVar20 = 0x1018;
          struct_1018_47c8(CONCAT22(paVar15,uVar8),0x1,CONCAT22(uVar19,uVar9),
  ...
  if (!bVar5) {
    ...
    if (uVar14 == 0) {
      ...
      uVar19 = 0x1018;
      struct_1018_47c8(CONCAT22(paVar18,uVar12),0x0,uVar11 & 0xffff | paVar15 << 0x10,0x0,0x0
                      );
      uVar22 = uVar12;
    }
    uVar4 = &structd_v20.field8_0xe;
...
// WARNING: Globals starting with '_' overlap smaller symbols at the same address
pub fn pass1_1008_d99e(param_1: *mut u8,param_2: *mut astruct_19,mut param_3: u16 )
...
pub fn pass1_1008_d9d4(param_1: *mut StructD,param_2: u8) -> *mut StructD
...

{
  ...
  (param_1 + 0xc) = 0;
  pass1_1008_3e38(
                  (param_1 & 0xff000000 | CONCAT12((param_1 >> 0x10),param_1 + 0xeU)));
  (param_1 + 0x14) = 0;
  (param_1 + 0x16) = 0;
  (param_1 + 0x18) = 0;
  ...
  if ((raster_caps & 0x100) != 0) {
    ...
    entries = (PALETTEENTRY *)
              fn_ptr_op_1000_1708((num_reserved + 1) * 0x4,0x0,0x1,PTR_LOOP_1050_5f2c,pSVar2);
    count_00 = pSVar2;
    ...
    uVar4 = fn_ptr_op_1000_1708((iVar6 + 1) * 0x4,0x0,0x1,PTR_LOOP_1050_5f2c,PTR_LOOP_1050_5f2e);
    (param_1 + 0x18) = uVar4;
...
pub fn pass1_1008_dc80(mut param_1: u16 ,mut param_2: i16,param_3: u8,param_4: u8,mut param_5: u16 ,param_6: *mut u16,mut param_7: u32,
...
// WARNING: Globals starting with '_' overlap smaller symbols at the same address
pub fn pass1_1008_de58(param_1: *mut astruct_211,param_2: i32,param_3: i32)

{
  ...
  pstruct211_1: *mut astruct_211;
  let mut pcVar4: *mut c_char;
  pstruct211_2: *mut astruct_211;
  let mut uVar5: u32;
  ...
  } while ((((pstring_1 + 0x4) != param_3) || ((pstring_1 + 0x8) != param_2)) &&
...
pub fn pass1_1008_dfa6(mut param_1: u32,param_2: i32,param_3: i32)
