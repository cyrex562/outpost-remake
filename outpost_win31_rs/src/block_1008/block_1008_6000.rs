...
u16 str_op_1008_60e8(mut param_1: u16 ,param_2: *mut c_char)
...
pub fn pass1_1008_64c8(mut param_1: u16 ,param_2: *mut u8,u32 *param_3,mut param_4: u32,mut param_5: i16)
...

{
  ...
  *(i32 *)(uVar1 + 0x4) = param_3;
  ...
  (uVar1 + 0x10) = 0;
  uVar1 = pstruct76_4->field8_0x10;
  *(i32 *)(uVar1 + 0x14) = *(i32 *)&pstruct76_4->field11_0x18 * param_2;
  uVar1 = pstruct76_4->field8_0x10;
  (uVar1 + 0x20) = 0x100;
  uVar1 = pstruct76_4->field8_0x10;
  (uVar1 + 0x24) = 0x100;
...
pub fn pass1_1008_6978(mut param_1: u16 ,param_2: *mut u8,mut param_3: u32,mut param_4: i16,mut param_5: u32)
