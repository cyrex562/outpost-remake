...

{
  ...
  iVar5 = (iVar6 + 0x8);
  iVar2 = (iVar6 + 0xa);
  lVar4 = CONCAT22(iVar2 - (iVar5 == 0),iVar5 + -1) * *(i32 *)(iVar6 + 0x4);
  puVar1 = (iVar6 + 0x10);
  uVar3 = lVar4;
...

{
  ...
  lVar4 = CONCAT22(iVar2 - (iVar5 == 0),iVar5 + -1) * *(i32 *)&pstruct109_6->field_0x4;
...

{
  ...
  if ((*(i32 *)param_1 != 0) && ((param_1 + 0x8) != 0)) {
    uVar4 = (param_1 >> 0x10);
    iVar2 = param_1;
    if (*(i32 *)(iVar2 + 0x4) == 0) {
      uVar5 = (param_1 >> 0x10);
...
pub fn win_ui_op_1008_5cfe(param_1: *mut astruct_27,param_2: *mut c_char,WNDCLASS16 *in_wnd_class)
...
u8 * pass1_1008_5fd8(param_1: *mut u8)
