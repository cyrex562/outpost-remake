...
// WARNING: Globals starting with '_' overlap smaller symbols at the same address
pub unsafe fn win_ui_op_1008_1414(mut param_1: u32,param_2: *mut astruct_20,mut param_3: u32,mut param_4: u16 ,mut param_5: u16 ,
                        mut param_6: u16 )

{
  ...
  puStack12 = mixed_1010_20ba(paVar7,_u16_1050_0ed0,CONCAT22(unaff_DI,0x2f),in_stack_0000fe4e,
  ...
  uVar14 = (&local_2a >> 0x8);
  puVar11 = mixed_1010_20ba(paVar7,_u16_1050_0ed0,CONCAT13(uVar14,CONCAT12(uVar13,puVar5)),
  ...
  iVar5 = 0x1b;
  paVar12 =
            mixed_1010_20ba(paVar7,_u16_1050_0ed0,0x1002b,in_stack_0000fe3c,in_stack_0000ff60,
...
// WARNING: Globals starting with '_' overlap smaller symbols at the same address
pub unsafe fn big_switch_1008_15d4(param_1: *mut astruct_20,param_2: *mut astruct_72,param_3: i32)
...
0x2 =>{
    ...
    piVar1 = (var3 + 0xcc);
    *piVar1 = *piVar1 + 1;
    pass1_1018_e91e(puVar1,CONCAT22(in_edx,param_1),(var3 + 0xcc),var3,uVar5);}
    // break;
//   case 0x3:
0x3 =>{
    ...
    piVar1 = (var3 + 0xcc);
    *piVar1 = *piVar1 + 1;
    pass1_1018_e230(puVar1,CONCAT22(in_edx,param_1),(var3 + 0xcc),var3,uVar5);}
    // break;
//   case 0x4:
0x4 =>{
    mem_op_1000_179c(0xf6,in_edx);
    ...
    piVar1 = (var3 + 0xcc);
    *piVar1 = *piVar1 + 1;
    struct_1020_7554(puVar1,CONCAT22(in_edx,param_1),(var3 + 0xcc),var3,uVar5);}
    // break;
//   case 0x5:
0x5 =>{
    ...
    piVar1 = (var3 + 0xcc);
    *piVar1 = *piVar1 + 1;
    struct_1018_5840(uVar4,CONCAT22(in_edx,param_1),(var3 + 0xcc),var3,uVar5,
...
0x6 =>{
    ...
    piVar1 = (var3 + 0xcc);
    *piVar1 = *piVar1 + 1;
    struct_1020_2524(puVar1,CONCAT22(in_edx,param_1),(var3 + 0xcc),var3,uVar5);}
    // break;
//   case 0x7:
0x7 =>{
...
0x8 =>{
    ...
    piVar1 = (var3 + 0xcc);
    *piVar1 = *piVar1 + 1;
    pass1_1018_e5dc(puVar1,CONCAT22(in_edx,param_1),(var3 + 0xcc),var3,uVar5);}
    // break;
//   case 0x9:
0x9 =>{
mem_op_1000_179c(0xf6,in_edx);
    ...
    piVar1 = (var3 + 0xcc);
    *piVar1 = *piVar1 + 1;
    struct_1018_66cc(puVar1,CONCAT22(in_edx,param_1),(var3 + 0xcc),var3,uVar5);}
    // break;
//   case 0xa:
0xa =>{
...
0x1e =>{
    ...
    piVar1 = (var3 + 0xcc);
    *piVar1 = *piVar1 + 1;
    paVar2 = struct_1018_713a(CONCAT22(in_edx,param_1),(var3 + 0xcc),param_2,
                              &DAT_1050_1050);
    puVar1 = (paVar2 >> 0x10);
    param_1 = paVar2;}
    // break;
