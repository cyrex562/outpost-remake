...

{
  ...
  puVar4 = mixed_1010_20ba(paVar1,_u16_1050_0ed0 & 0xffff,CONCAT22(param_1,0x48),in_stack_0000feac,
  ...
  puVar4 = mixed_1010_20ba(paVar1,_u16_1050_0ed0 & 0xffff,CONCAT22(param_1,0x32),in_stack_0000feac,
                           in_stack_0000ffd0,in_stack_0000ffd6,in_stack_0000ffda);
  (param_1 + 0xf4) = puVar4;
...
// WARNING: Globals starting with '_' overlap smaller symbols at the same address
pub unsafe fn win_ui_cursor_op_1008_06c0(param_1: u32,mut param_2: u32,mut param_3: u16 ,mut param_4: i16)
  ...
  if (param_4 == 0x400) {
    ...
    if (in_AX != 0) {
      ...
      if (PTR_LOOP_1050_4fe8.is_null() == false) {
        ...
        MessageBox16(0x10,pcVar6,s_You_may_not_run_a_turn__The_game_1050_00df,(iVar4 + 0x8));
        return;
      }
      ...
      puVar7 = mixed_1010_20ba(paVar2,_u16_1050_0ed0,CONCAT22(in_stack_0000ff9c,0x29),in_stack_0000fe44,
      ...
      puVar7 = mixed_1010_20ba(paVar2,_u16_1050_0ed0,CONCAT22(iVar8,0x37),in_stack_0000fe3a,
...
pub unsafe fn pass1_1008_07d8(mut param_1: u16 ,param_2: *mut astruct_57,param_3: *mut astruct_72) -> BOOL16

{
  ...
  if (_u16_1050_5748.is_null()) {
    ...
    uVar4 = pass1_1028_e2e0(paVar3,_PTR_LOOP_1050_65e2,0x8);
    pass1_1028_e2e0((paVar3 & 0xffff0000 | uVar4 >> 0x10),_PTR_LOOP_1050_65e2,0xff);
...

{
  ...
  pass1_1028_e2e0((paVar1 & 0xffff0000 | uVar2 >> 0x10),_PTR_LOOP_1050_65e2,0x8);
...
pub unsafe fn mixed_win_op_1008_0c60
                 (mut param_1: u16 ,param_2: *mut StructD,mut param_3: u16 ,mut param_4: u16 ,param_5: *mut astruct_72,mut param_6: u16 ,
                 mut param_7: u16 ,mut param_8: u16 ) -> BOOL16
...
0x68 =>{
    ...
    puVar17 = mixed_1010_20ba(paVar9,_u16_1050_0ed0,CONCAT22(param_3,0x29),in_stack_0000fe3a,
                              in_stack_0000ff5e,in_stack_0000ff64,in_stack_0000ff68);
    uVar15 = (paVar9 >> 0x10);
    ...
    puVar17 = mixed_1010_20ba(paVar9,_u16_1050_0ed0,CONCAT22(uVar12,0x37),in_stack_0000fe34,
