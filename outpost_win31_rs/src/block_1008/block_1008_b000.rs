...
pub fn pass1_1008_b4a0(mut param_1: u16 ,param_2: *mut u8,mut param_3: u32,i32 param_4)

{
  ...
  if ((uVar1 + 0x8) != 0) {
    ...
    uVar6 = pass1_1008_b38c(CONCAT22(uVar6,param_2),(astruct_196 *)param_3);
    uVar3 = (uVar6 >> 0x10);
    uVar2 = uVar6;
    uVar1 = (iVar4 + 0x16);
...

{
  ...
  if (param_1 == 0) {
    ...
    if ((BVar2 != 0) &&
       (uVar3 = read_file_1008_7dee((HFILE16 *)param_4,CONCAT22(0x1050,local_10),0x2), uVar3 != NULL))
    {
      if (local_10[0] == NULL) {
        return;
      }
