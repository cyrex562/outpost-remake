...

{
  ...
  uVar3 = (puVar5 >> 0x10);
  puVar6 = mixed_1010_20ba(CONCAT22(uVar4,uVar3),_u16_1050_0ed0,CONCAT22(unaff_SI,0x35),
  ...
  while ((piVar1 = (puVar5 + 0x4), iVar2 = iStack16, *piVar1 != iStack18 && iStack18 <= *piVar1 &&
         (iVar2 = (*puVar5 + iStack18 * 0x2), (iVar2 * 0x2 + puVar6 + 0xa) == 0))) {
    iStack18 += 0x1;
  }
  iStack16 = iVar2;
  return iStack16;
...

{
  ...
  puVar16 = mixed_1010_20ba(paVar13,_u16_1050_0ed0,CONCAT22(unaff_SI,0x35),in_stack_0000fe7e,
  ...
  while( true ) {
    ...
    if ((uVar2 * 0x2 + puVar16 + 0xa) != 0) {
      ...
      if (uVar9 == 0) {
        ...
        uVar15 = 0x18;
        struct_1018_47c8(CONCAT22(paVar10,uVar7),0x1,CONCAT22(uVar6,uVar8),uVar2,0x0);
        paVar10 = paVar13;
      }
...

{
  ...
  let mut in_EDX: u32;
  let mut paVar13: *mut Struct57;
  iVar10: *mut astruct_263;
  uVar16: *mut astruct_263;
  let mut uVar17: u8;
    ...
    while( true ) {
      ...
      if ((paVar7[0x1c].field4_0x8 == lVar1) && (paVar7.field3_0x4 != 0x4000001)) {
        ...
        if (uVar12 == 0) {
          ...
          uVar17 = 0x18;
          struct_1018_4920((uVar8 & 0xffff | paVar13 << 0x10),0x1,CONCAT22(uVar11,uVar6),
                           paVar7.field3_0x4);
...

{
  ...
  let mut paVar10: *mut Struct57;
  let mut uVar11: u32;
  iVar15: *mut astruct_263;
  let mut uVar12: u16;
  let mut uVar13: u16;
  let mut uVar14: u8;
  paVar15: *mut astruct_203;
...

{
  ...
  iVar15: *mut astruct_4;
  let mut uVar17: u16;
  let mut uVar18: u8;
  paVar19: *mut astruct_203;
  let mut paVar15: *mut Struct57;
  ...
  if ((-0x1 < paVar16) && ((0x0 < paVar16 || (uVar10 != 0)))) {
    ...
    if ((paVar15 | uVar6) == 0) {
      ...
      uVar18 = 0x18;
      paVar19 = struct_1018_4842(CONCAT22(paVar15,uVar6),uVar9 & 0xffff | paVar16 << 0x10,
  ...
  if ((-0x1 < iVar11) && ((0x0 < iVar11 || (uVar10 != 0)))) {
    ...
    if ((uVar12 | uVar6) == 0) {
      ...
      uVar18 = 0x18;
      paVar19 = struct_1018_4842(CONCAT22(uVar12,uVar6),CONCAT22(iVar11,uVar10),CONCAT22(uVar13,uVar7),
                                 0x3);
  ...
  if (!bVar4) {
    ...
    if ((paVar16 | uVar6) == 0) {
      ...
      uVar18 = 0x18;
      paVar19 = struct_1018_4842(CONCAT22(paVar16,uVar6),0x0,CONCAT22(uVar13,uVar10),0x0);
      uVar13 = (paVar19 >> 0x10);
