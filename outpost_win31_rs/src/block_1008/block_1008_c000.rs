...

{
  ...
  while( true ) {
    ...
    if (iVar1 == 0) {
      ...
      *(i32 *)(param_1 + 0xe) = (pstruct117_2 + 0x94) + *_PTR_LOOP_1050_65e2;
    }
  }
  return;
}
    ...
    while( true ) {
      ...
      if ((paVar7[0x1c].field4_0x8 == lVar1) && (paVar7->field3_0x4 != 0x4000001)) {
        ...
        if (uVar12 == 0) {
          ...
          uVar17 = 0x18;
          struct_1018_4920((astruct_203 *)(uVar8 & 0xffff | paVar13 << 0x10),0x1,CONCAT22(uVar11,uVar6),
                           paVar7->field3_0x4);
...

{
  ...
  if ((-0x1 < paVar16) && ((0x0 < paVar16 || (uVar10 != 0)))) {
    ...
    if ((paVar15 | uVar6) == 0) {
      ...
      uVar18 = 0x18;
      paVar19 = struct_1018_4842((astruct_203 *)CONCAT22(paVar15,uVar6),uVar9 & 0xffff | paVar16 << 0x10,
