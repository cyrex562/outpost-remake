...

{
  ...
  iVar2->field2_0x4 = 0;
  set_struct_1008_574a((astruct_57 *)(param_1 & 0xffff0000 | ZEXT24(iVar2 + 1)));
...
pub fn unk_win_op_1008_97f2(u32 *param_1,param_2: *mut i16,param_3: WPARAM16,u8 *param_4,mut param_5: u16 ) -> u32
...
// TODO: goto LAB_1008_9a95;
  ...
  // TODO: goto LAB_1008_9ada;
    ...
    if ((PTR_LOOP_1050_039a == NULL) && (ppcVar1 = (code **)(*param_1 + 0x48), iVar4 = (**ppcVar1)(), iVar4 != 0)
       ) {
