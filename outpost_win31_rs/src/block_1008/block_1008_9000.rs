...
pub unsafe fn pass1_1008_9004(param_1: *mut astruct_78,mut param_2: u16 ,mut param_3: u16 ,mut param_4: u32)
...

{
  ...
  if (iVar5.field3_0x6.is_null()) {
    ...
    lVar8 = pass1_1000_0ed4(0x1,uVar6 * 0x4,
                            ...
                            CARRY2(uVar6 * 0x2,uVar6 * 0x2),paVar3,
                            (paVar3 >> 0x10));
...
pub fn pass1_1008_92b2(mut param_1: u32,param_2: i32,param_3: i32)
...
pub fn pass1_1008_93c0(param_1: *mut u16,param_2: u8) -> *mut u16
...
pub fn pass1_1008_93ec(param_1: *mut StructD,param_2: u8) -> *mut StructD
...
pub fn pass1_1008_941a(param_1: *mut u16,mut param_2: u16 ,mut param_3: u16 ) -> *mut u16
...
pub fn pass1_1008_9436(param_1: *mut u16) -> *mut u16
...
// LAB_1008_94dc:
    if (PTR_LOOP_1050_0398.is_null() == false) {
      IVar2 = TranslateAccelerator16(&local_msg_1,(HACCEL16)&DAT_1050_1050,PTR_LOOP_1050_0398);
...
// LAB_1008_9547:
    if (PTR_LOOP_1050_0398.is_null() == false) {
      IVar1 = TranslateAccelerator16(&local_14,(HACCEL16)&DAT_1050_1050,PTR_LOOP_1050_0398);
...

{
  ...
  SetWindowText16(param_1 & 0xffff0000 | (param_1 + 0xaU),(param_1 + 0x8));
  return;
}
...

{
  ...
  if (struct_1.field4_0x8 == 0) {
    window_handle =
         CreateWIndowEx16((in_struct_1 & 0xffff | uVar1 << 0x10),HINSTANCE16_1050_038c,
...
pub fn unk_win_op_1008_97f2(param_1: u32,param_2: *mut i16,param_3: WPARAM16,param_4: *mut u8,mut param_5: u16 ) -> u32
...
// TODO: goto LAB_1008_9a95;
  ...
  // TODO: goto LAB_1008_9ada;
    ...
    if ((PTR_LOOP_1050_039a.is_null()) && (ppcVar1 = (*param_1 + 0x48), iVar4 = (**ppcVar1)(), iVar4 != 0)
       ) {
      make_def_wnd_proc_1008_9ce6
                (paVar6,UVar7,CONCAT13((param_3 >> 0x8),CONCAT12(param_3,param_2)),param_4,0x112);
    }
  }
...
switchD_1008_9b30_caseD_4:
      ...
      (**ppcVar1)(unaff_CS,uVar9,uVar10,param_2,param_3,CONCAT22(param_5,param_4));
    }
...

{
  ...
  LVar1 = make_def_wnd_proc_1008_9ce6
                    (param_1,param_2,CONCAT22(param_3,(param_2 >> 0x10)),
                     (param_3 >> 0x10),0x85);
  return LVar1;
}
...
pub fn pass1_1008_9c60(mut param_1: u16 ,mut param_2: u16 ,param_3: *mut u32,mut param_4: i16)
...
// WARNING: Globals starting with '_' overlap smaller symbols at the same address
pub fn pass1_1008_9e5a(structd_param_1: *mut StructD)
