...
u32 * pass1_1008_80d2(param_1: u32)
...

{
  ...
  iVar3: *mut astruct_23;
  uVar3: *mut astruct_23;
...
pub unsafe fn win_ui_op_1008_8214(mut param_1: u16 ,mut param_2: u16 ,mut param_3: u16 ,mut param_4: i16,mut param_5: u16 ,mut param_6: u32) -> u16
...
pub fn draw_op_1008_8288(mut param_1: u16 ,mut param_2: u32,hdc16_param_1: HDC16,mut param_4: u32)

{
  paint_handle_1: HDC16;
  HPEN16 pen_handle_1;
  HPEN16 pen_handle_3;
...
pub fn win_sys_op_1008_84f2(LPARAM lparam_param_1,wparam_param_2: WPARAM16,msg_param_3: u16,HWND16 hwnd_param_4)
...

{
  ...
  if (_PTR_LOOP_1050_0382.is_null()) {
    _PTR_LOOP_1050_0382 =
         mixed_1010_20ba(paVar6,_u16_1050_0ed0,CONCAT22(unaff_SI,0x2e),in_stack_0000fe70,in_stack_0000ff94
  ...
  if ((iVar5 + 0x8) != 0) {
    ...
    *piVar2 = *piVar2 + 1;
    ...
    if (uVar4 == 0) {
      ...
      pass1_1008_8d8a((param_1 & 0xffff | uVar6 << 0x10),paStack6,(iVar5 + 0x4),uVar4);
      pass1_1008_4480((iVar5 + 0x4),(param_1 & 0xffff0000 | (iVar5 + 0x28U)),paStack6);
      return;
    }
  }
  return;
...

{
  ...
  pass1_1008_3e94((param_2 & 0xffff0000 | (iVar3 + 0x28U)),CONCAT22(0x1050,local_a),
                  CONCAT22(0x1050,local_8));
  pass1_1008_8d8a((param_2 & 0xffff | uVar4 << 0x10),paStack6,(iVar3 + 0x4),uVar2);
  pass1_1008_4480((iVar3 + 0x4),(param_2 & 0xffff0000 | (iVar3 + 0x28U)),paStack6);
  return;
}
...

{
  ...
  if (uVar2 == 0) {
    ...
    uVar6 = (uStack6 >> 0x10);
    pass1_1008_50c2(CONCAT22(paVar3,puVar1),(uStack6 + 0x8),
...

{
  ...
  let mut uVar5: u16;
  let mut uVar8: u16;
  pstruct76_var7: *mut astruct_76;
  uVar7: *mut astruct_76;
  let mut uVar9: u32;
  paStack10: *mut astruct_110;
  let mut paVar6: *mut Struct57;
...
{
  iVar1: *mut astruct_78;
  uVar1: *mut astruct_78;
