...
pub unsafe fn read_file_1008_7146(mut param_1: u16 ,struct_param_1: *mut astruct_806,mut param_3: u16 ,mut param_4: u16 ,mut param_5: u16 ) -> BOOL16
...

{
  ...
  if (BVar1 != 0) {
    ...
    while( true ) {
      ...
      if ((BVar1 == 0) ||
         (BVar1 = read_file_1008_7dee(param_1,CONCAT22(0x1050,local_10),0x4), BVar1 == 0)) {break;}
...

{
  ...
  loop {
    ...
    iVar3 = WIN16_hread(0x400,CONCAT22(0x1050,local_406),*CONCAT22(param_2,param_1));
...
pub fn read_file_1008_7dee(hfile_param_1: *mut HFILE16,buffer_param_2: *mut u8,count_param_3: u32) -> BOOL16
...
pub fn write_to_file_1008_7e1c(buffer: *mut u8,count: u32,buf_to_write: *mut c_char,param_4: HFILE16) -> BOOL16
