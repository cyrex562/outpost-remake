...
void pass1_1038_9a48(globals: &mut Globals, Struct18 *param_1)
...
void pass1_1038_7d5c(globals: &mut Globals, Struct18 *param_1)
...
void unk_draw_op_1018_cda8(globals: &mut Globals, Struct36 *param_1, u16 param_2)

{
    ...
    if(uVar5 == 0x0)
    {
        ...
        PostMessage16((HWND16)LAST_SEGMENT, 0x0, 0x0, str_var1(0x111, (iVar10 + 0xea)));
        return;
    }
    if((iVar10 + 0xf0) == 0x0)
    {
...
void unk_draw_op_1018_cfc0(globals: &mut Globals, Struct36 *param_1, u16 param_2)
...

{
    ...
    u_stack6 = str_var1(u_var2, (u16)u_stack6);
...
void pass1_1020_79e4(globals: &mut Globals, u32 param_1, u16 hwnd_arg2, u16 param_3)
...
void pass1_1020_6466(u16 *param_1, param_2: u16, u16 param_3)
...
void pt_in_rect_1020_68fc(u32 *param_1, param_2: u16, u16 param_3)
...
HGDIOBJ16 draw_op_1020_7070(param_1: u16, u16 param_2)
...

{
    ...
    SelectObject16((HDC16)LAST_SEGMENT, param_1->field_0x1a_addr_offset);
    SelectPalette16((HDC16)LAST_SEGMENT, 0x0, param_1->field_0x1c_addr_base);
    DeleteObject16((HGDIOBJ16)LAST_SEGMENT);
    SetMapMode16((HDC16)LAST_SEGMENT, param_1->field_0x1e);
    param_1->field_0x0 = addr_table_1008_3aa0[4]; // 0x3ab0;
    param_1->field_0x2 = SEG_1008;
    param_1->field_0x0 = addr_table_1008_380a[36]; // 0x389a;
    param_1->field_0x2 = SEG_1008;
...
void pass1_1020_2c72(u32 param_1, param_2: u16, u16 param_3)
...
void draw_polygon_1020_3602(param_1: u16, param_2: u16, u32 param_3, HDC16 param_4)
...
void pass1_1020_3bd6(u32 param_1, param_2: u16, param_3: u16, u16 param_4)
...
void draw_polygon_1020_2474(param_1: u16, param_2: u16, u32 param_3, HDC16 param_4)
...
void struct_1020_2524(param_1: &mut Struct20, param_2: u16, param_3: u16, u16 param_4)
