...

{
    ...
    if(param_2 != 0x129)
    {
        ...
        if(param_2 == 0xfb)
        {
            ...
            uVar4 = (uVar7 >> 0x10);
            pass1_1018_181c(*(uVar5 + 0xf2), (uVar7 & 0xffff | uVar4 << 0x10), (uVar7 & 0xffff), uVar4);
            return;
        }
        if(param_2 < 0xfc)
        {
...
//    iVar5    = param_1;
    ...
    if(BVar3 == 0x0)
    {
        ...
        unsafe{(**ppcVar2)(hwnd, (param_1 + 0x18), 0x0, &local_24, unaff_SS, uVar8, uVar9)};
    }
    else
    {
...

{
    ...
    puVar3                = mixed_1010_20ba(
      globals.data_1050_0ed0, 0xa, param_1, extraout_DX, unaff_DI);
    uVar1                         = (puVar3 >> 0x10);
...

{
    ...
    puVar5                     = mixed_1010_20ba(globals.data_1050_0ed0, 0xa, param_5, extraout_DX, param_4);
    uVar4                      = (puVar5 >> 0x10);
...
//    uVar7 = (param_1 >> 0x10);
    ...
    puVar6                     = mixed_1010_20ba(globals.data_1050_0ed0, 0x28, param_4, extraout_DX, unaff_DI);
    puVar4                     = (puVar6 >> 0x10);
    param_1.field_0xf2          = puVar6;
    param_1.field_0xf4          = puVar4;
    param_1.field_0xe6          = param_1.field_0xf2;
    param_1.field_0xe8          = puVar4;
    puVar6                     = mixed_1010_20ba(globals.data_1050_0ed0, 0x32, param_4, puVar4, unaff_DI);
...

{
    ...
    puVar3             = mixed_1010_20ba(globals.data_1050_0ed0, 0x26, param_1, extraout_DX, unaff_DI);
    uVar1              = (puVar3 >> 0x10);
...

{
    ...
    param_1.field_0x2         = SEG_1018;
    puVar5                     = mixed_1010_20ba(globals.data_1050_0ed0, 0x26, param_5, extraout_DX, param_4);
    uVar4                      = (puVar5 >> 0x10);
    param_1.field_0x14        = puVar5;
    param_1.field_0x16        = uVar4;
    param_1.field_0x6         = param_1.field_0x14;
...
pub fn draw_text_1018_c742(param_1: *mut Struct36, param_2: HDC16, RECT16 *param_3, param_4: u16)
...
pub fn set_window_text_1018_6066(param_1: u16, param_2: u16, SEGPTR in_win_text_3, param_4: u16, dialog_id_5: u16, in_hwnd_6: HWND16)
...
//    iVar2                                    = param_1;
    ...
    pu_var2                                   = mixed_1010_20ba(globals.data_1050_0ed0, 0xb, param_4, extraout_DX, unaff_DI);
    uVar1                                    = (pu_var2 >> 0x10);
...

{
    ...
    param_1.field_0x2         = SEG_1018;
    puVar5                     = mixed_1010_20ba(globals.data_1050_0ed0, 0xb, param_5, extraout_DX, param_4);
    uVar4                      = (puVar5 >> 0x10);
    param_1.field_0x14        = puVar5;
    param_1.field_0x16        = uVar4;
    param_1.field_0x6         = param_1.field_0x14;
...
pub fn clenaup_win_ui_1018_4d22(in_struct_1: *mut Struct11, in_hdc_2: HDC16)
...
pub fn create_dc_1018_4e04(param_1: *mut Struct8, param_2: u16, param_3: i16, param_4: i16, LPCSTR in_string_5, in_string_6: u16)

{
    ...
    p_var2            = CreateDC16(SEG_1008, uVar4, (uVar4 >> 0x10), 0x0);
...
//    iVar2              = param_1;
    ...
    param_1.field_0xe4  = SEG_1018;
    puVar3             = mixed_1010_20ba(globals.data_1050_0ed0, 0x27, param_4, extraout_DX, unaff_DI);
    uVar1              = (puVar3 >> 0x10);
...
pub fn invalidate_rect_1018_58e2(param_1: *mut Struct58, param_2: i16, param_3: HWND16)
...
pub fn pt_in_rect_1010_4e08(param_1: u32, param_2: u16, param_3: u16, param_4: *mut RECT16)
...

{
    ...
    do
    {
        ...
        // LAB_1010_413e:
            ...
            {
                puVar10 = mixed_1010_20ba(globals.data_1050_0ed0, iStack6 + 0xcU, unaff_SS, in_DX, unaff_DI);
                puVar7  = (puVar10 >> 0x10);
                ...
                if(uVar4 == 0x0)
                {
                    ...
                    pass1_1010_209e(globals.data_1050_0ed0, iStack6 + 0xcU);
                    uStack4 = uVar4;
                }
            }
            if(uStack4 != 0x0)
...

{
    ...
    0x7 =>
        ...
        puVar17 = extraout_DX;
        pass1_1010_8170(globals.dat_1050_14cc, iVar15, extraout_DX, SEG_1010);
        iVar19                                   = param_5 * 0x4;
