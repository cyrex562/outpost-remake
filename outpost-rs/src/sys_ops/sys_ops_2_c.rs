...
void  pass1_1030_9c1c(param_1: u32, param_2: *mut u32, param_3: u32) {
    ...
    puVar7 = mixed_1010_20ba(globals.data_1050_0ed0, 0x35, unaff_SS, in_DX, unaff_DI);
    iVar4  = puVar7 + 0xa;
    uVar3  = (puVar7 >> 0x10);
    iVar5  = iVar4;
...
u16  pass1_1030_538a(param_1: *mut Struct694, param_2: i16, param_3: u16) {
    ...
    u_var2  = puVar1 >> 0x8;
    puVar4 = mixed_1010_20ba(globals.data_1050_0ed0, 0x2f, param_3, puVar1, param_2);
    if(u_var2 == 0x1) {
...
void  pass1_1030_4782(param_1: *mut u8, param_2: u8, param_3: *mut u8, param_4: u16, param_5: u16, param_6: i16, param_7: i16, i16 param_8) {
    ...
    *piStack6 = param_8;
    ...
    if(param_7 != 0x0) {
        puVar10  = mixed_1010_20ba(globals.data_1050_0ed0, 0x2f, param_1, puVar4, unaff_DI);
...
u16 * pass1_1030_183c(param_1: *mut u16, param_2: u32, param_3: u32, param_4: u32, param_5: u32, param_6: u16, u8 *param_7) {
    let mut uVar1: u32;
    let mut u_var2: u16;
