...
void pass1_1030_1be2(u32 param_1, param_2: u16, u8 *param_3) {
    void **ppcVar1;
    u16 *pu_var2;
    u8 *puVar3;
    u8 *extraout_DX;
...
void  pass1_1028_ef00(param_1: u16, u8 *param_2, u32 param_3, u16 param_4, u16 param_5, u16 param_6, u16 param_7) {
    u16  uVar1;
    u16 *pu_var2;
...
u16 * switch_1030_07ac(param_1: u16, param_2: u16, param_3: u16, u16 param_4, u16 param_5, u32 param_6, u8 *param_7, Struct179 *param_8, u16 param_9, u16 param_10, u16 param_11) {
    u16  uVar1;
    u8  *pu_var2;
    u16  uVar3;
    u16 *puVar4;
...
void  pass1_1028_e628(Struct349 *param_1, param_2: u16, param_3: u16, i16 param_4, i16 param_5, u16 param_6, u16 param_7, u16 param_8, u16 param_9, u8 param_10) {
    char        *pcVar1;
    i16         *piVar2;
    char         cVar3;
    u32          uVar4;
            ...
            case0x3:
                ...
                *(u16 **)(&u_var20->field_0x110 + 0x2) = puVar17;
                ...
                if(str_var1(uStack28, puStack30) != 0x0) {
                    struct_1030_e4fa((Struct100 *)str_var1(param_9, &local_14c),
...
u32  pass1_1028_ebee(u32 param_1, param_2: u16, u16 param_3) {
    i16 iVar1;
    u16 u_var2;
    u32 uVar3;
...
void  pass1_1028_ec36(u32 param_1, param_2: u16, i16 param_3, u16 param_4, u32 param_5, u16 param_6, u8 *param_7, u16 param_8) {
    u32 uVar1;
    u16        u_var2;
    u16        uVar3;
    u8        *puVar4;
...
void  pass1_1028_ecac(u32 param_1, param_2: u16, i16 *param_3, u16 param_4, u32 param_5, u16 param_6, u8 *param_7, u16 param_8) {
    u32 uVar1;
    i16      **ppiVar2;
    u8        *puVar3;
    u8        *puVar4;
...
void  pass1_1028_ed2c(u32 param_1, param_2: u16, i16 param_3, u16 param_4, u32 param_5, u16 param_6, u8 *param_7, u16 param_8, u8 param_9) {
    u32        u_var2;
    u16        uVar3;
    u16        uVar4;
    u8        *puVar5;
...
void  pass1_1028_edc4(u32 param_1, param_2: u16, u16 *param_3, long param_4, u8 *param_5, u16 param_6) {
    u16        uVar1;
    u32        u_var2;
    u8        *puVar3;
    u8         in_AF;
...
void  pass1_1028_e100(u32 param_1, param_2: u16, u8 *param_3) {
    u32  *puVar1;
    u32  *pu_var2;
    Struct311 *uVar4;
    i16          iVar4;
...
void  pass1_1028_c3aa(param_1: u16, param_2: u16, u16 *param_3, param_4: u32, u32 param_5, u16 param_6) {
    void **ppcVar1;
    i16         iVar2;
    u16         uVar3;
    u16         uVar4;
...
void  pass1_1028_ccd0(u8 param_1, param_2: u16, u32 param_3, u16 *param_4) {
    void **ppcVar1;
    u16        *pu_var2;
    u8         *puVar3;
    i16         iVar4;
        ...
        for(u_stack64 = uStack12; u_stack64 <= iStack16; u_stack64 = u_stack64 + 0x1) {
            for(uStack72 = uStack10; iVar4 = iStack62, uStack72 <= iStack14; uStack72 = uStack72 + 0x1) {
                ...
                if(u_stack60._3_1_ == '\0') {
                    ...
                    struct_op_1028_87f0(param_2, param_1, (Struct97 *)str_var1(param_2, &local_178), 0x0, 0x0, uVar8, param_4, (param_4 >> 0x10),
...
void  pass1_1028_d078(param_1: u16, u32 param_2, param_3: u32) {
    void **ppcVar1;
    u8         *extraout_DX;
    u8         *pu_var2;
    i16         iVar3;
    ...
    if(uStack4 == 0x0) {
        ...
        struct_op_1008_8e9e((Struct78 *)str_var1(pu_var2, pu_stack6), 0x6, 0x24);
    }
    (iVar3 + 0x4) = pu_stack6;
    (iVar3 + 0x6) = uStack4;
...
Struct100 * struct_op_1028_d1dc(param_1: u16, u8 param_2, Struct100 *param_3, u16 param_4) {
    Struct101 *iVar1;
    u8 *puVar1;
