...
pub fn pass1_1028_a79c(param_1: u32, param_2: u16, param_3: u8) {
    u32 * puVar1;
    u32 * pu_var2;
    u32 * puVar3;
    let mut iVar4: i16;
...
pub fn pass1_1028_a8f4(param_1: u32, param_2: *mut Struct335, param_3: u8) {
...
pub fn pass1_1028_aa68(param_1: u32, param_2: *mut Struct336, param_3: u8) {
    let mut puVar1: *mut u32;
    let mut pu_var2: *mut u32;
    let mut puVar3: *mut u32;
    let mut iVar4: i16;
...
pub fn pass1_1028_abec(param_1: u32, param_2: *mut Struct337, param_3: u8) {
    let mut puVar1: *mut u32;
    let mut pu_var2: *mut u32;
    let mut puVar3: *mut u32;
    let mut iVar4: i16;
...
pub fn pass1_1028_ad9c(param_1: u32, param_2: *mut Struct338, param_3: u8) {
    let mut puVar1: *mut u32;
    let mut pu_var2: *mut u32;
    let mut puVar3: *mut u32;
    let mut iVar4: i16;
...
// LAB_1028_af42:
    ...
    paVar8             = mixed_1010_20ba(globals.data_1050_0ed0, 0x37, param_4, pu_var4, param_3);
    ...
    puVar7 = mixed_1010_20ba(globals.data_1050_0ed0, 0x2b, param_4, pu_var4, param_3);
    pass1_1010_043a(puVar7, (paVar9 + 0x4), 0xd, param_4);
    return 0x1;
}


pub fn pass1_1028_afce(param_1: *mut Struct340, param_2: *mut Struct339, param_3: u8) {
    let mut puVar1: *mut u32;
    let mut pu_var2: *mut u32;
    let mut iVar3: i16;
...
pub fn pass1_1028_b108(param_1: *mut Struct342, param_2: *mut Struct341, param_3: u8) {
    let mut puVar1: *mut u32;
    let mut pu_var2: *mut u32;
    let mut iVar3: i16;
...
pub fn pass1_1028_94e4(param_1: *mut Struct329, param_2: *mut Struct328, param_3: u8) {
    let mut puVar1: *mut u32;
    let mut pu_var2: *mut u32;
    let mut iVar3: i16;
...
pub fn pass1_1028_9b48(param_1: *mut Struct331, param_2: *mut Struct330, param_3: u8) {
    let mut puVar1: *mut u32;
    let mut pu_var2: *mut u32;
    let mut iVar3: i16;
...
pub fn pass1_1028_9dee(param_1: *mut Struct333, param_2: *mut Struct332, param_3: u8) {
    let mut puVar1: *mut u32;
    let mut pu_var2: *mut u32;
    let mut iVar3: i16;
...
pub fn pass1_1028_a0fa(param_1: u32, param_2: *mut Struct334, param_3: u8) {
    let mut puVar1: *mut u32;
    let mut pu_var2: *mut u32;
    let mut puVar3: *mut u32;
    let mut iVar4: i16;
...
pub fn pass1_1028_8400(param_1: u32, param_2: u16, param_3: u8) {
    let mut puVar1: *mut u32;
    let mut pu_var2: *mut u32;
    let mut puVar3: *mut u32;
    let mut iVar4: i16;
...
pub fn pass1_1028_86f4(param_1: *mut Struct321, param_2: *mut Struct320, param_3: u8) {
    let mut puVar1: *mut u32;
    let mut pu_var2: *mut u32;
    let mut iVar3: i16;
...
pub fn pass1_1028_8c46(param_1: *mut Struct323, param_2: *mut Struct322, param_3: u8) {
    let mut puVar1: *mut u32;
    let mut pu_var2: *mut u32;
    let mut iVar3: i16;
...
pub fn pass1_1028_8ea6(param_1: *mut Struct325, param_2: *mut Struct324, param_3: u8) {
    let mut puVar1: *mut u32;
    let mut pu_var2: *mut u32;
    let mut iVar3: i16;
...
pub fn pass1_1028_8fea(param_1: *mut Struct327, param_2: *mut Struct326, param_3: u8) {
    let mut pu_var2: *mut u32;
    let mut iVar3: i16;
...
pub fn pass1_1028_9264(param_1: u32, param_2: u16, param_3: u8) {
    let mut puVar1: *mut u32;
    let mut pu_var2: *mut u32;
    let mut puVar3: *mut u32;
    let mut iVar4: i16;
...
pub fn pass1_1028_752e(param_1: u32, param_2: u16, param_3: u8) {
    let mut puVar1: *mut u32;
    let mut pu_var2: *mut u32;
    let mut puVar3: *mut u32;
    let mut iVar4: i16;
    ...
    if(0x2 < globals.PTR_LOOP_1050_13ae) {
        ...
        for(puStack70 = 0x1; puStack70 < 0x9; puStack70 = (puStack70 + 0x1)) {
            ...
            if(local_42[0] == pu_stack6) {
                ...
                pass1_1008_612e(0x0, 0xa, pu_var4);
                local_18 = local_18 & 0xffff0000 | ZEXT24(pu_var4);
                if(puStack70 == 0x7) {
                    iVar17 = 0x7;
                    puVar3 = pu_var4 + 0x37;
                    iVar9  = puVar3 >> 0xf;
                    ...
                    iVar17 = 0x8;
                    puVar3 = pu_var4 + 0x32;
                    iVar9  = (pu_var4 >> 0xf) + (0xff9b < pu_var4);
                }
        ...
        if(0x2 < uStack12) {
            ...
            if(uVar5 == 0x0) {
                ...
                while(true) {
                    ...
                    uStack38 = str_var1(u_var4, pu_var2);
                    ...
                    if((pu_var2 + 0x200) != 0x8000002) {
                        ...
                        puStack46 = str_var1(uVar5, u_var4);
                        ppcVar1   = (*puStack46 + 0x10);
                        (**ppcVar1)(SEG_1038, u_var4, uVar5);
                        uStack50 = str_var1(uVar5, u_var4);
            ...
            if(uVar5 == 0x0) {
                ...
                while(true) {
                    ...
                    if((pu_var2 + 0x200) != 0x8000002) {
                        ...
                        uStack42  = uVar3;
                        puStack40 = pu_var4;
                        pass1_1038_4d6e(uStack38, puVar8, uVar3, pu_var4);
                        puStack46 = str_var1(pu_var4, uVar3);
                        ppcVar1   = (*puStack46 + 0x10);
                        (**ppcVar1)(SEG_1038, uVar3, pu_var4);
                        uStack50 = str_var1(pu_var4, uVar3);
                        uVar6    = 0x10;
                        puVar7   = mixed_1010_20ba(globals.data_1050_0ed0, 0x2, param_4, pu_var4, param_3);
                        uVar5    = puVar7 >> 0x10;
        ...
        if(uVar5 == 0x0) {
            ...
            while(true) {
                ...
                if((pu_var2 + 0x200) != 0x8000002) {
                    ...
                    uStack36  = uVar3;
                    puStack34 = pu_var4;
                    pass1_1038_4d6e(uStack32, puVar7, uVar3, pu_var4);
                    puStack40 = str_var1(pu_var4, uVar3);
                    ppcVar1   = (*puStack40 + 0x10);
                    (**ppcVar1)(SEG_1038, uVar3, pu_var4);
                    uStack44  = str_var1(pu_var4, uVar3);
                    uVar6     = 0x10;
                    puVar8    = mixed_1010_20ba(globals.data_1050_0ed0, 0x2, param_3, pu_var4, param_2);
                    uVar5     = puVar8 >> 0x10;
...
pub fn pass1_1028_82b4(param_1: u32, param_2: u16, param_3: u8) {
    let mut puVar1: *mut u32;
    let mut pu_var2: *mut u32;
    let mut puVar3: *mut u32;
    let mut iVar4: i16;
...
pub fn pass1_1028_69cc(param_1: *mut Struct316, param_2: *mut Struct317, param_3: u8) {
    let mut puVar1: *mut u32;
    let mut pu_var2: *mut u32;
    let mut iVar3: i16;
...
pub fn pass1_1028_6ef6(param_1: u32, param_2: u16, param_3: u8) {
    let mut puVar1: *mut u32;
    let mut pu_var2: *mut u32;
    let mut puVar3: *mut u32;
    let mut iVar4: i16;
...
u32 pass1_1028_611e(param_1: i16, param_2: u16, param_3: i16, param_4: u32, param_5: u16, param_6: u8) {
    let mut uVar1: u32;
...
pub fn pass1_1028_43f6(param_1: u32, param_2: i16, param_3: *mut u8, param_4: u16, param_5: i16, param_6: u16) {
    ...
    if(0x0 < uVar1) {
        ...
        pass1_1030_7d1c(uVar3, u_var4, 0x230000, uVar3, (uVar3 >> 0x10), param_4, param_5, param_6);
    }
    return;
}
...
pub fn pass1_1028_45fe(param_1: *mut Struct312, param_2: i16, param_3: u16) {
    ...
    pu_var4    = (&iVar6.field_0x20 + 0x2);
    paStack30 = str_var1(pu_var4, puVar3);
    puStack34 = puVar3;
    puStack32 = pu_var4;
    ...
    if((pu_var4 | puVar3) == 0x0) {
        ...
        set_struct_1008_574a(str_var1(pu_var4, puVar3));
        uVar7 = dx_var1_01;
    }
