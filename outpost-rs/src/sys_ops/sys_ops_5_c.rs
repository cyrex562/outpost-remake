...

{
    ...
    if((param_1 + 0x20) != 0x0)
    {
        puVar1 = mixed_1010_20ba(globals._1050_0ed0: u16, 0x2f, param_4, param_2, param_3);
...

{
    ...
    if((param_2 >> 0x10) == 0x0)
    {
        ...
        iVar6  = 0x0;
        uVar4  = 0x0;
        p_var2 = mixed_1010_20ba(globals._1050_0ed0: u16, 0x37, param_5, param_3, param_4);
        puVar1 = (p_var2 >> 0x10);
        ...
        iVar6  = 0x3;
        uVar4  = 0x1;
        puVar3 = mixed_1010_20ba(globals._1050_0ed0: u16, 0x2b, param_5, puVar1, param_4);
        puVar1 = (puVar3 >> 0x10);
        pass1_1010_043a(puVar3, str_var1(uVar5, uVar4), iVar6, param_5);
        pass1_1010_043a(puVar3, 0x4000001, 0x4, param_5);
        puVar3 = mixed_1010_20ba(globals._1050_0ed0: u16, 0x2f, param_5, puVar1, param_4);
        puVar1 = (puVar3 >> 0x10);
        pass1_1010_ec84(puVar3, param_5, param_6);
        puVar3 = mixed_1010_20ba(globals._1050_0ed0: u16, 0x8, param_5, puVar1, param_4);
...

{
    ...
    if((puVar5 >> 0x8) != '\0')
    {
        ...
        {
            puStack22 = mixed_1010_20ba(globals._1050_0ed0: u16, 0x2f, param_8, puVar5, param_7);
...
// LAB_1020_eb4e:
    ...
    if(iStack14 != 0x7)
    {
        ...
        if(uStack34._3_1_ != 0x0)
        {
            ...
            puStack46 = mixed_1010_20ba(globals._1050_0ed0: u16, 0x2f, param_6, uStack8, unaff_DI);
...

{
    ...
    pu_var2 = mixed_1010_20ba(globals._1050_0ed0: u16, 0x2f, unaff_SS, extraout_DX, unaff_DI);
...

{
    ...
    puVar1 = mixed_1010_20ba(globals._1050_0ed0: u16, 0x2f, param_6, (puVar1 >> 0x10), unaff_DI);
...

{
    ...
    puVar8   = mixed_1010_20ba(globals._1050_0ed0: u16, 0x2, param_5, param_2, param_4);
    ...
    puStack12 = mixed_1010_20ba(globals._1050_0ed0: u16, 0x8, param_5, puStack4, param_4);
...

{
    ...
    {
        puVar3 = mixed_1010_20ba(globals._1050_0ed0: u16, 0x8, param_4, puVar1, param_3);
        puVar1 = (puVar3 >> 0x10);
        ...
        iVar7  = 0x0;
        uVar5  = 0x0;
        paVar4 = mixed_1010_20ba(globals._1050_0ed0: u16, 0x37, param_4, puVar1, param_3);
...

{
    ...
    if((param_1 + 0x12) == 0x5)
    {
        ...
        if((u_var2 + 0x200) != 0x8000002)
        {
            puVar3 = mixed_1010_20ba(globals._1050_0ed0: u16, 0x2b, param_3, puVar1, param_2);
...

{
    ...
    {
        puVar3   = mixed_1010_20ba(globals._1050_0ed0: u16, 0x8, param_3, puVar1, param_2);
...

{
    ...
    {
        uVar4   = 0x87;
        puVar13 = mixed_1010_20ba(globals._1050_0ed0: u16, 0x9, param_3, puVar8, param_2);
...

{
    ...
    *param_3        = addr_table_1020_ba36;//0xba36;
    ...
    mixed_1010_20ba(globals._1050_0ed0: u16, 0x2, param_1, param_2, unaff_DI);
...

{
    ...
    pu_stack6 = mixed_1010_20ba(globals._1050_0ed0: u16, 0x2f, param_1, param_3, unaff_DI);
...

{
    ...
    {
        puStack10 = mixed_1010_20ba(globals._1050_0ed0: u16, 0x2f, param_6, (param_4 | param_3), param_5);
...

{
    ...
    {
        puVar4 = mixed_1010_20ba(globals._1050_0ed0: u16, 0x2f, param_6, (param_5 | param_4), param_8);
        uVar3  = (puVar4 >> 0x10);
        u_var2  = *(puVar4 + 0x20);
...

{
    ...
    pu_stack6 = mixed_1010_20ba(globals._1050_0ed0: u16, 0x2f, param_1, in_DX, unaff_DI);
    ...
    pass1_1020_ad90(param_1, puVar7, uVar8, uVar9, str_var1(param_1, &local_14), uStack10);
    puStack1196 = mixed_1010_20ba(globals._1050_0ed0: u16, 0x8, param_1, puVar7, &uStack14);
...

{
    ...
    puStack18 = mixed_1010_20ba(globals._1050_0ed0: u16, 0x2f, param_1, (puVar5 >> 0x10), unaff_DI);
...

{
    ...
    iVar2.field_0x2 = SEG_1020;
    puVar3 = mixed_1010_20ba(globals._1050_0ed0: u16, 0x29, param_2, (puVar3 >> 0x10), param_3);
...

{
    ...
    (iVar8 + 0x2) = SEG_1020;
    puVar5 = mixed_1010_20ba(globals._1050_0ed0: u16, 0x29, unaff_SS, (puVar5 >> 0x10), uVar9);
    uVar4 = (puVar5 >> 0x10);
    (iVar8 + 0x22) = puVar5;
    (iVar8 + 0x24) = uVar4;
...

{
    ...
    puVar5 = mixed_1010_20ba(globals._1050_0ed0: u16, 0x29, param_2, (puVar5 >> 0x10), uVar4);
    u_var2 = (puVar5 >> 0x10);
    ...
    puVar5            = mixed_1010_20ba(globals._1050_0ed0: u16, 0x2, param_2, puVar3, uVar4);
...

{
    ...
    puVar3 = mixed_1010_20ba(globals._1050_0ed0: u16, 0x2f, param_4, param_2, param_3);
    iVar1  = (puVar3 + 0x1e);
    u_var2  = (param_1 >> 0x10);
    iVar2  = param_1;
...

{
    ...
    puVar3 = mixed_1010_20ba(globals._1050_0ed0: u16, 0x29, param_2, (puVar3 >> 0x10), uVar4);
    u_var2 = (puVar3 >> 0x10);
...
void  struct_1020_847a(u16 *param_1, param_2: i16, param_3: u16) {
    ...
    iVar3.field_0x2 = SEG_1020;
    puVar5 = mixed_1010_20ba(globals._1050_0ed0: u16, 0x48, param_3, (puVar5 >> 0x10), iVar4);
    pu_var2 = (puVar5 >> 0x10);
...

{
    ...
    *(u16 **)(param_1 + 0x28) = puVar3;
    ...
    puVar8           = mixed_1010_20ba(globals._1050_0ed0: u16, 0x29, param_4, puVar6, unaff_DI);
    uVar7            = (puVar8 >> 0x10);
    (param_1 + 0x14) = puVar8;
    (param_1 + 0x16) = uVar7;
    uVar10           = 0x0;
    ...
    (param_1 + 0x12) = uVar4;
    (param_1 + 0x10) = 0x1;
    puVar8           = mixed_1010_20ba(globals._1050_0ed0: u16, 0x2, param_4, extraout_DX_00, unaff_DI);
    (param_1 + 0x2c) = puVar8;
...

{
    ...
    puVar3 = mixed_1010_20ba(globals._1050_0ed0: u16, 0x2f, param_7, param_5, param_6);
    u_var2  = (puVar3 >> 0x10);
    uVar1  = *(puVar3 + 0x20);
...
void  pass1_1020_1eea(u16 *param_1, param_2: u32, param_3: u16, param_4: *mut u8, param_5: i16, param_6: u16) {
    ...
    puVar4 = mixed_1010_20ba(globals._1050_0ed0: u16, 0x39, param_6, param_4, param_5);
    u_var2 = (puVar4 >> 0x10);
...

{
    ...
    puVar3            = mixed_1010_20ba(globals._1050_0ed0: u16, param_3, param_6, param_4, param_5);
    uVar1             = (puVar3 >> 0x10);
