...
u16 pass1_1000_2a00(param_1: *mut u16, param_2: i16, param_3: u16, param_4: u16, param_5: u16, param_6: u8)

{
    ...
    if(!bVar1)
    {
        ...
        u_var4 = dos3_call_1000_514e(&iStack2);
        if(u_var4 == 0x0)
            //goto LAB_1000_2af2;
    }
    uVar5 = 0xffff;
...

{
    ...
    u_var2   = sys_1000_30b4(param_1, SEG_1050, str_var1(param_4, param_3), &iStack2, param_1, param_5, param_7, param_8);
    pass1_1000_2f00(uVar1, param_1, param_5, param_7, param_8, in_AF);
    return u_var2;
}


u16 mem_1000_2bb6(param_1: u16, param_2: *mut i16, param_3: i16, param_4: u16, param_5: u16, param_6: u16, param_7: u8, param_8: u16)
...
pub fn mem_1000_2ce8(param_1: *mut i16, param_2: u16, param_3: u16)
...
// LAB_1000_2d71:
    ...
    {
        u_var4 = mixed_dos3_call_1000_370a(param_1, param_2, u_var4, param_4, 0x1a4, &iStack2);
        if(u_var4 < 0x0)
        {
            return 0x0;
        }
...

{
    ...
    while(true)
    {
        puStack8 = str_var1(u_var4, uVar3);
        if((u_var4 | uVar3) == 0x0)
            break;
        uVar1 = *puStack8;
        u_var4 = (uVar3 + 0x2);
...

{
    ...
    if((param_4 == 0x0) || ((param_4 & 0xff00 & (((-((param_2 & 0x4) == 0x0) >> 0x8) & 0x82) + 0x18) << 0x8) != u_var2))
    {
        return 0x1;
    }
    if(param_1 != 0x0)
...
//        globals.data_1050_5f84 = uVar11;
//    } while(true);
//    interrupt_vector_op_1000_23ea(NULL, param_2, param_5, 0x0, ss_var1);
//    globals.data_1050_5f84 = uVar11;
//    pass1_1000_262c(globals, 0x238d, LAST_SEGMENT, ss_var1, LAST_SEGMENT);
//    globals.data_1050_5f84 = uVar11;
//    pass1_1000_27d6(NULL, (uVar11 >> 0x10));
//    uVar11 = ret_op_1000_55ac(hinst_var15);
//    uVar5  = uVar11;
//    init_1000_23be(param_1, (uVar11 >> 0x10), ss_var1);
...
pub fn set_interrupt_vector_1000_256b(Globals *globals)
...

{
    ...
    {
        pu_var4  = (puVar5 - (param_1 + -0x4));
        puVar1  = pu_var4;
        *puVar1 = *puVar1 + (*puVar5 & 0xfffc);
        puVar5  = pu_var4;
    }
    pu_var4 = ((*puVar5 & 0xfffc) + puVar5);
    if((pu_var4 & 0x1) == 0x0)
    {
        puVar1  = puVar5;
        *puVar1 = *puVar1 + (*pu_var4 & 0xfffc);
        if(pu_var4 == PTR_LOOP_1050_000e)
        {
...

{
    ...
    if((&u16_1050_000c & 0xfff8) == 0xcad0)
    {
        ...
        uVar5 = pass1_1000_0fb8(param_1, param_4, param_6, param_5, param_3, ppu_var4, param_2);
        if(uVar5 == 0x0)
        {
        ...
        if((param_3 & 0x8) == 0x0)
        {
            lVar9  = mem_op_1000_0a48(param_3, param_4, param_5, str_var1(UVar12, UVar11), param_1);
            uVar3  = (lVar9 >> 0x10);
            puVar8 = lVar9;
            if(lVar9 != 0x0)
            {
...

{
    ...
    bVar2 = u16_1050_000c & 0x7;
    if((u16_1050_000c & 0x7) != 0x0)
    {
        if(bVar2 == 0x1)
        {
...
pub fn pass1_1000_15ce(param_1: *mut u16, param_2: u16, WORD param_3)
...

{
    ...
    if((globals.dat_1050_5f2e | globals.dat_1050_5f2c) == 0x0)
    {
        ...
        if(globals.dat_1050_5f2c != 0x0)
        {
            ...
            {
                pass1_1000_1afe(globals.dat_1050_5f44, globals.dat_1050_5f2c, globals.dat_1050_5f2e);
            }
        }
    }
    empty_fn_1000_214a();
...

{
    ...
    if((uVar3 | pv_var1) != 0x0)
    {
        ...
        pv_var1[0x20] = 0x0;
        pv_var1[0x1f] = 0x0;
        BVar3        = pass1_1000_1afe(param_4, pv_var1, uVar3);
        if(BVar3 != 0x0)
        {
            if((param_3 | param_2) != 0x0)
            {
                ...
                pass1_1000_010c(NULL, 0x1, uVar8, (uVar8 >> 0x10), _var6: u16, UVar5, param_5);
            }
            return str_var1(uVar3, pv_var1);
        }
        mem_op_1000_1b9a(0x0, pv_var1, uVar3, param_5);
    }
    return 0x0;
}
...
i16 mem_op_1000_0308(param_1: i16, param_2: i16)
...

{
    ...
    puVar1 = (param_4 + 0x28);
    bVar8  = uVar3 < *puVar1;
    if((bVar8) || ((bVar8 || uVar3 == *puVar1 && (puVar1 = (param_4 + 0x26), u_var4 < *puVar1 || u_var4 == *puVar1))))
    {
        if(param_3 == 0x3)
        {
...
//                *(u32 *)0x0           = param_4;
                ...
                *puVar1     = *puVar1 + UVar6;
                piVar2      = (param_4 + 0x20);
                *piVar2     = *piVar2 + param_2 + CARRY2(u_var4, UVar6);
                return uVar3;
            }
...

{
    ...
    do
    {
        ...
        if((UVar6 | uVar3) != 0x0)
        {
            return str_var1(UVar6, uVar3 + 0x14);
        }
        ...
        puVar1 = (param_4 + 0x28);
        bVar5  = uVar3 < *puVar1;
    } while(((bVar5 || uVar3 == *puVar1) && ((bVar5 || (puVar1 = (param_4 + 0x26), u_var4 < *puVar1 || u_var4 == *puVar1)))) && ((uVar6 != 0x0 || (UVar5 = pass1_1000_1e61(NULL, param_5, 0x2, param_4, SEG_1050), UVar5 != 0x0))));
    return 0x0;
}
...
u16 mem_1000_0670(param_1: u16, param_2: *mut i16, param_3: u16, param_4: *mut u32, param_5: i16, WORD param_6)
...
u16  pass1_1000_093a(param_1: *mut i16, param_2: u16, param_3: u16)
...
u8 *pass1_1000_09a0(param_1: *mut u16, param_2: u16)
        ...
        if((param_3 == 0x0) && (param_2 <= (s_version__d__d_1050_0012 + 0x6)))
        {
            ...
            else
            {
                ...
                if((uVar5 != 0x0) && ((param_1 & 0x1) != 0x0))
                {
                    ...
                    for(u_var4 = uVar1 >> 0x1; u_var4 != 0x0; u_var4 = u_var4 - 0x1)
                    {
                        puVar1  = pu_var2;
                        pu_var2  = pu_var2 + 0x1;
                        *puVar1 = 0x0;
        ...
        // LAB_1000_0b9e:
            if(((uStack20 & 0x10) != 0x0) || (uVar3 = u_var2, UVar6 = mem_op_1000_03c6(NULL, (param_2 + 0x1a), 0x0, u_var2, param_2, param_4, 0x0, '\0'), (UVar6 | uVar3) == 0x0))
            {
                if((uStack20 & 0x20) == 0x0)
                {
                    ...
                    puVar1 = (param_2 + 0x1e);
                    u_var4  = u_var2 + *puVar1;
                    u_var2  = (param_2 + 0x20) + CARRY2(u_var2, *puVar1);
                    puVar1 = (param_2 + 0x28);
                    bVar9  = u_var2 < *puVar1;
                    if((bVar9 || u_var2 == *puVar1) && ((bVar9 || (puVar1 = (param_2 + 0x26), u_var4 < *puVar1 || u_var4 == *puVar1))))
                    {
