...
void post_win_msg_1018_ea0a(param_1: u16, param_2: u16, i16 param_3, HWND16 param_4)
...

{
    ...
    create_window_ex_1008_9760(param_1, SEG_1008);
    puVar6            = mixed_1010_20ba(globals.u16_1050_0ed0, 0x1, param_3, param_2, unaff_DI);
    puVar3            = (puVar6 >> 0x10);
    uVar5             = (param_1 >> 0x10);
...
void pass1_1020_08b6(WNDCLASS16 *param_1, Struct20 *param_2, param_3: u16, u32 param_4)
...
void win_1018_df40(Struct0 *param_1, param_2: u16, u8 *param_3, u16 param_4)
...
void pass1_1018_e2cc(Struct269 *param_1, u16 param_2)
...
void win_1018_598c(Struct0 *param_1, param_2: u16, u16 param_3)
...
void win_op_1018_294a(i16 param_1, param_2: u16, param_3: u16, param_4: u32, u16 param_5, LPCSTR in_string_6)
...
void pass1_1010_71c2(param_1: u16, param_2: u16, i16 param_3, u16 param_4)
...
void unk_win_op_1010_7300(u32 param_1, u32 param_2, param_3: u16, u32 param_4)
...
void pass1_1010_1656(i16 param_1, param_2: u16, param_3: u16, param_4: u32, u16 param_5, u8 *param_6, i16 param_7, u16 param_8)

{
    ...
    unk_destroy_win_op_1010_305a((Struct27 *)str_var1(param_2, param_1), param_3, param_4, param_5);
    if((param_1 + 0x16) == 0x3)
    {
        puVar6 = mixed_1010_20ba(globals.u16_1050_0ed0, 0x32, param_8, param_6, param_7);
        uVar1  = (param_1 + 0x32);
        uVar1  = (uVar1 + 0x42);
        uVar5  = (uVar1 >> 0x10);
        iVar4  = uVar1;
...
void set_window_placement_1010_0070(u32 param_1, i16 param_2, param_3: u16, HWND16 param_4, u16 param_5)

{
    ...
    if((iStack16 == -0x1) || (param_2 != 0x0))
    {
        ...
        lVar4          = GetWindowLong16((HWND16)LAST_SEGMENT, 0x0);
        u_var2          = (lVar4 >> 0x10);
        puVar3         = (lVar4 + 0xe0);
        ppcVar1        = (*puVar3 + 0x38);
        (**ppcVar1)(LAST_SEGMENT, puVar3, (lVar4 + 0xe2), param_3);
        pass1_1010_01f8(param_1, str_var1(param_5, local_18), puVar3);
        SetWindowPlacement16((HWND16)LAST_SEGMENT, (WINDOWPLACEMENT16 *)local_18);
    }
    return;
}


void set_win_placement_1010_010e(param_1: u16, param_2: u16, param_3: u16, HWND16 param_4)

{
    ...
    {
        lVar6   = GetWindowLong16((HWND16)LAST_SEGMENT, 0x0);
        uVar4   = (lVar6 >> 0x10);
        puVar5  = (lVar6 + 0xe0);
        ppcVar1 = (*puVar5 + 0x1c);
        ...
        SetWindowPlacement16((HWND16)LAST_SEGMENT, &local_18);
    }
    return;
}
...

{
    ...
    if(globals.PTR_LOOP_1050_0010 == 0x0)
    {
        ...
        EnumChildWindows1((HWND16)LAST_SEGMENT, 0x0, ZEXT24(pvVar1) << 0x10);
        FreeProcInstance16(LAST_SEGMENT);
    }
    return;
}

void pass1_1008_aa28(u32 param_1, param_2: u16, WNDCLASS16 *param_3)
...
WPARAM16 main_win_msg_loop_1008_9498(globals: &mut Globals, u16 u16_arg1, u16 u16_arg2)
...
LAB_1008_94cd:
    ...
    // window.
    b_var1   = IsDialogMessage16((HWND16)LAST_SEGMENT, &local_msg);
...
LAB_1008_94dc:
        if(globals.PTR_LOOP_1050_0398 != 0x0)
        {
            ...
            result = TranslateAccelerator16((HWND16)LAST_SEGMENT, (HACCEL16)u16_arg2, &local_msg);
            if(result != 0x0)
                goto LAB_1008_949c;
        }
...
code_rSEG_10089538:
    ...
    has_message = IsDialogMessage16((HWND16)LAST_SEGMENT, &local_14);
    if(has_message == 0x0)
    {
    LAB_1008_9547:
        if(globals.PTR_LOOP_1050_0398 != 0x0)
        {
            param_2 = LAST_SEGMENT;
            IVar1   = TranslateAccelerator16((HWND16)LAST_SEGMENT, (HACCEL16)&local_14, param_3);
            if(IVar1 != 0x0)
                goto LAB_1008_9578;
        }
...
void send_msg_1008_9640(u32 param_1, param_2: u16, HWND16 param_3)
...

{
    ...
    if(param_5 < 0x2c)
    {
        ...
        case 0x2:
            ...
            BVar2 = IsWindow16((HWND16)LAST_SEGMENT);
            if(BVar2 != 0x0)
            {
                PostMessage16((HWND16)LAST_SEGMENT, msg, wparam, 0x11100c7);
            }
            break;
        case 0x3:
        ...
        else
        {
            if(param_5 < 0x113)
            {
                ...
                switchD_1008_9b30_caseD_4:
                    ...
                    {
                        uVar6 = make_def_wnd_proc_1008_9ce6(msg, wparam, (u16)param_2, param_3,
...
LRESULT  make_def_wnd_proc_1008_9ce6(param_1: u16, param_2: u16, u16 in_msg_3, WPARAM16 param_4, LPARAM param_5, HWND16 in_hwnd_5)
...
void send_msg_1008_84ba(param_1: u16, u32 param_2, HWND16 param_3)
...
void win_1008_5c9e(u32 param_1, u32 *param_2, param_3: u16, u16 param_4, WNDCLASS16 *param_5)
...
HWND16
create_window_1008_5e7e(globals: &mut Globals, u16 in_stock_obj_id, WNDCLASS16 *in_wnd_class)
...
LRESULT make_def_win_proc_1008_5f44(param_1: u16, WPARAM16 in_wparam_2, LPARAM param_3, HWND16 in_hwnd_4)

{
    ...
    if(param_3 == 0x2)
    {
        ...
        puVar3 = mixed_1010_20ba(globals.u16_1050_0ed0, 0x37, unaff_SS, in_DX, unaff_DI);
