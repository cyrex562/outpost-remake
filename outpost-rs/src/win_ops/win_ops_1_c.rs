...

{
    ...
    if(param_3 == 0x19)
    {
        pu_var4  = globals.dat_1050_5ee0;
        ppcVar2 = (*pu_var4 + 0x34);
        u_stack6 = (**ppcVar2)(param_5, pu_var4, (pu_var4 >> 0x10), param_1, param_2, SEG_1050);
    ...
    else
    {
        ...
        {
            pu_var4  = globals.dat_1050_5ee0;
            ppcVar2 = (*pu_var4 + 0x20);
            uVar7   = (**ppcVar2)(param_5, pu_var4, (pu_var4 >> 0x10), wparam);
            return uVar7;
        }
        if(param_3 == 0x110)
        {
...
ATOM reg_class_1040_98c0(globals: &mut Globals, param_1: u32, param_2: HINSTANCE16, WNDCLASS16 *in_wnd_class_3)
...
pub fn win_op_1040_9cde(globals: &mut Globals,
                      param_1: u16,
                      WPARAM16 param_2,
                      param_3: i16,
                      param_4: u32,
...

{
    ...
    else
    {
            ...
            else
            {
                if(bVar16 < 0x9)
                {
                    ...
                    *pbVar1 = *pbVar1 | 0x8;
                    ...
                    {
                        SendDlgItemMessage16(LAST_SEGMENT, 0x1, 0x0, 0x0, str_var1(u_var4, 0x404));
                    }
                    HVar11 = LAST_SEGMENT;
        ...
        if(param_4 == 0x200)
        {
            ...
            iVar2 = (iVar5 + 0x4);
            BVar7 = PtInRect16(LAST_SEGMENT, str_var1(param_2, param_1));
            if(BVar7 == 0x0)
            {
                pbVar1  = (iVar5 + 0x4);
                *pbVar1 = *pbVar1 & 0xfd;
...

{
    ...
    if((u_var2 + 0x10) == 0x0)
    {
        ...
        hwnd   = LAST_SEGMENT;
        SendMessage16(SEG_1010, pcVar7, (WPARAM16)(pcVar7 >> 0x10), str_var1(uVar8, u_var4));
    }
    else
    {
        hwnd   = SEG_1010;
        puVar6 = mixed_1010_20ba(globals.data_1050_0ed0, 0x3, param_4, (LVar5 >> 0x10), param_2);
...
// LAB_1040_88a5:
    ...
    puVar6       = mixed_1010_20ba(globals.data_1050_0ed0, 0x48, param_2, dx_var1, unaff_DI);
    uVar5        = (puVar6 >> 0x10);
    ...
    if((UVar10 + 0xb2) != 0x0)
    {
        puVar6 = mixed_1010_20ba(globals.data_1050_0ed0, 0x37, param_2, pu_var4, unaff_DI);
...
pub fn pass1_1040_89a4(globals: &mut Globals,
                    param_1: *mut u32,
                    param_2: *mut u16,
                     param_3: *mut u8,
                     param_4: i16,
...

{
    ...
    u_var2  = *param_2;
    uVar6  = SEG_1010;
    puVar7 = mixed_1010_20ba(globals.data_1050_0ed0, 0x2, param_5, param_3, param_4);
    uVar5  = (puVar7 >> 0x10);
    u_var4  = puVar7;
    if((u_var4 + 0x72) != 0x0)
    {
        uVar6 = SEG_1008;
        win_1008_5c7c(
          NULL, globals._PTR_LOOP_1050_02a0, str_var1(uVar1, u_var2), param_5, u_var4);
        (param_1 + 0x8c) = u_var4;
    }
...
pub fn win_1008_5c7c(globals: &mut Globals, param_1: u16, param_2: u16, param_3: u32, param_4: u32)
...
pub fn mixed_struct_op_1040_8fb8(globals: &mut Globals,
...
void  mix_win_ui_op_1040_911e(param_1: *mut u16) {
    u32 * puVar1;
    let mut u_var2: u16;
    let mut uVar3: u32;
...
void  enable_win_1040_9234(param_1: u32, param_2: bool, param_3: HWND16)
        ...
        else
        {
            if(l_param_1 == 0x201)
            {
                ...
                if(handle_1 == 0x0)
                {
                    ...
                    bool_1 = PtInRect16(LAST_SEGMENT, CONCAT13((param_2 >> 0x8), CONCAT12(param_2, win_handle_1)));
                    if(bool_1 == 0x0)
                    {
                        return;
                    }
            ...
            else
            {
                if(l_param_1 == 0x204)
                {
                    ...
                    bool_1 = PtInRect16(LAST_SEGMENT, str_var1(param_2, win_handle_1));
                    if(bool_1 == 0x0)
                    {
                        return;
                    }
...
u16 * pass1_1040_97da(param_1: *mut u16, param_2: u8)
    ...
    if(param_3 == 0x2)
    {
        ...
        if((iVar5 + 0x76) != 0x0)
        {
            ...
            if(BVar3 != 0x0)
            {
                ...
                (**ppcVar1)(LAST_SEGMENT, param_1, 0x0, u_var4, uVar7, uVar6);
            }
        }
    }
    return;
...
void  ui_cleanup_op_1040_782c(param_1: *mut Struct18, param_2: HGDIOBJ16)
...
pub fn create_window_1040_7620(globals: &mut Globals,
                             param_1: u32,
                             param_2: i16,
...

{
    ...
    CreateWindow16(SEG_1010, 0x0, globals.hinst_1050_038c, param_5, (param_1 + 0x6), (iVar1 + 0x6), (iVar1 + 0x4), *(HWND16 *)(iVar1 + 0x2), *in_menu_handle, h_instance, 0);
}


void  post_win_msg_1040_7f56(param_1: u32, param_2: *mut c_char)
...
pub fn win_ui_op_1040_6d1a(globals: &mut Globals,
                         param_1: i16,
                         param_2: u16,
                         param_3: u16,
                         u32      param_4)

{
    ...
    0xfa =>
        ...
        break;
    _ =>
        pass1_1040_b54a(globals, param_1, param_2, param_3, param_4, in_DX, &SEG_1040, ss_var1);
        return;
    0xfd =>
...
pub fn create_window_1040_6eae(globals: &mut Globals,
                             param_1: u32,
                             param_2: i16,
                             HMENU16 *in_menu_handle,
                             param_4: u16,
...

{
    ...
    u_var2 = (in_menu_handle >> 0x10);
    iVar1 = in_menu_handle;
    CreateWindow16(SEG_1010, 0x0, ZEXT24(globals.hinst_1050_038c) << 0x10, param_5, (param_1 + 0x6), (iVar1 + 0x6), (iVar1 + 0x4), *(HWND16 *)(iVar1 + 0x2), *in_menu_handle, h_instance, 0);
}
...

{
    ...
    LVar2 = SendMessage16(LAST_SEGMENT, u_var2, (WPARAM16)(u_var2 >> 0x10), str_var1(u_var4, uVar3));
    return LVar2;
}
...
u16  pass1_1040_4f28(param_1: *mut u32, param_2: *mut i16, param_3: u16, param_4: u16, param_5: i16, param_6: u16)
...
void  set_win_pos_1040_4f96(param_1: *mut Struct1, param_2: u16, param_3: u16, param_4: u8)

{
    ...
    puVar15                              = mixed_1010_20ba(globals.data_1050_0ed0, 0x41, param_3, param_4, unaff_DI);
    uVar14                               = (puVar15 >> 0x10);
    paVar5                               = puVar15;
    uVar13                               = (param_1 >> 0x10);
    iVar11                               = param_1;
    ...
    puVar15 = mixed_1010_20ba(globals.data_1050_0ed0, 0x3, param_3, puVar9, unaff_DI);
    uVar11  = (puVar15 >> 0x10);
    uVar3   = puVar15;
    uVar12  = uVar11;
    ...
    iVar8  = puVar1;
    u_var4  = puVar1 & 0xffff0000;
    uVar14 = (u_var4 >> 0x10);
    SetWindowPos16(SEG_1010, 0x40, (iVar8 + 0x10), (iVar8 + 0xe), (iVar8 + 0xc), (u_var4 | iVar8 + 0xa), 0x0);
    return;
}
    ...
    if(param_4 != 0x10c)
    {
        ...
        else
        {
            if(param_4 != 0x10d)
            {
                if(param_4 == 0x10e)
                {
                    puVar8 = mixed_1010_20ba(globals.data_1050_0ed0, 0x32, param_6, in_DX, unaff_DI);
                    iVar3  = puVar8;
...

{
    ...
    ppcVar1 = (*param_1 + 0x74);
    (**ppcVar1)();
    pu_var4 = mixed_1010_20ba(globals.data_1050_0ed0, 0x3, ss_var1, dx_var1, unaff_DI);
    u_var2  = (param_1 + 0x90);
    uVar3  = pass1_1010_acc0(pu_var4, (pu_var4 >> 0x10), *(u_var2 + 0x6));
    if(uVar3 != 0x0)
    {
...

{
    ...
    if(iStack10 == 0x0)
    {
        ...
        pcVar8 = string_op_1010_ada6(
          NULL, SEG_1010, uVar5, uVar3, (uVar3 >> 0x10), 0x0, (u_var4 + 0xa));
...

{
    ...
    u_stack6  = str_var1(dx_var1, u_var2);
    uStack10 = 0x0;
    while(true)
    {
        ...
        ppcVar1 = (*param_2 + 0x4);
        uVar3   = u_stack6;
        (**ppcVar1)(uVar5, param_2, uStack10, (uStack10 >> 0x10), u_var4);
        paVar7 = pass1_1018_3a7a(*(param_1 + 0x96), uVar3 & 0xffff | dx_var1_00 << 0x10, uVar3, dx_var1_00);
        u_var4  = param_3;
...

{
    ...
    else
    {
        ...
        else
        {
            ...
            pu_var4 = mixed_1010_20ba(globals.data_1050_0ed0, 0x32, param_8, param_5, param_6);
            iVar3  = pu_var4;
            uVar1  = (param_1 + 0x92);
            ui_op_1010_79aa(pu_var4, 0xfb6, (uVar1 + 0x6), param_8);
            if(iVar3 == 0x0)
            {
                uVar1 = (param_1 + 0x92);
                unk_win_op_1010_7300(pu_var4, 0x0, 0xc, *(uVar1 + 0x6));
            }
        }
    }
    if(bVar2)
...

{
    ...
    if((param_1 + 0x92) != 0x0)
    {
        u_var2   = (param_1 + 0x8e);
        uVar1   = (u_var2 + 0xa);
        puVar5  = mixed_1010_20ba(globals.data_1050_0ed0, 0x3, param_6, param_3, param_4);
        u_var2   = (param_1 + 0x92);
        u_var4   = (u_var2 >> 0x10);
        iVar3   = u_var2;
        param_5 = SEG_1010;
...

{
    ...
    puVar3  = &local_4;
    uVar6   = (param_1 >> 0x10);
    pass1_1010_519a(*(param_1 + 0x8e), str_var1(param_3, puVar3), pu_var4, param_3);
    puVar5 = pu_var4;
