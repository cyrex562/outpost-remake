...
Struct18 *pass1_1040_d89e(globals: &mut Globals, Struct18 *param_1, u8 param_2)
...
Struct18 *pass1_1040_d056(globals: &mut Globals, Struct18 *param_1, u8 param_2)
...
//    iVar4  = (Struct258 *)param_1;
    ...
    if((u_var2 | uVar1) != 0x0)
    {
        ...
        fn_ptr_1000_17ce((Struct18 *)str_var1(u_var2, uVar1 - 0x2), SEG_1000);
    }
    fn_ptr_1000_17ce((Struct18 *)param_1->field_0xc, SEG_1000);
}
...
Struct18 *pass1_1040_8db6(Struct18 *param_1, globals: &mut Globals, u8 param_2)
...
Struct31 *pass1_1040_0656(globals: &mut Globals, Struct31 *param_1, u8 param_2)
...
Struct18 *pass1_1038_9ed4(globals: &mut Globals, Struct18 *param_1, u8 param_2)
...
void pass1_1038_7964(globals: &mut Globals, u16 *param_1)
...
void pass1_1038_6912(globals: &mut Globals, u16 *param_1)
...
void pass1_1038_5a16(globals: &mut Globals, param_1: u16, param_2: u16, u32 param_3, u32 param_4)
...
void pass1_1038_5a96(globals: &mut Globals, param_1: u16, param_2: u16, u32 param_3, u32 param_4)
...
void pass1_1038_5b3c(globals: &mut Globals, param_1: u16, param_2: u16, u32 param_3, u32 param_4)
...
void pass1_1038_5860(u32 param_1, param_2: u16, u32 param_3, i16 param_4)
           ...
           == 0x0))
    {
        ...
        *pi_var1   = *pi_var1 + 0x1;
        ...
        struct_op_1028_87f0(param_4,
                            param_5,
                            (Struct97 *)str_var1(param_4, local_144),
                            0x0,
                            0x0,
                            0x10,
                            &local_20,
...
void pass1_1038_3fca(globals: &mut Globals, u32 param_1, param_2: u16, u16 param_3)

{
    ...
    if(globals.dat_1050_5f2e != 0x0)
    {
        ...
        uVar3     = fn_ptr_op_1000_1708(u_stack6 << 0x2,
                                    ...
                                    SEG_1000);
        paStack10 = (Struct18 *)str_var1(globals.dat_1050_5f2e, uVar3);
        if(globals.dat_1050_5f2c == 0x0)
        {
            globals.dat_1050_5f2c = mem_op_1000_160a(globals.dat_1050_5f2e, SEG_1000);
        }
        ...
        uVar3     = fn_ptr_op_1000_1708(u_stack6 << 0x2,
                                    ...
                                    globals.dat_1050_5f2e,
                                    SEG_1000);
        paStack14 = (Struct18 *)str_var1(globals.dat_1050_5f2e, uVar3);
        ...
        (uVar5 + 0x204) = 0x0;
        puVar11         = mixed_1010_20ba(globals.u16_1050_0ed0,
                                  0x2,
                                  param_3,
                                  globals.dat_1050_5f2e,
                                  unaff_DI);
...
void pass1_1038_42cc(globals: &mut Globals, u32 param_1, u16 param_2)
...

{
    ...
    paStack28 = (Struct18 *)str_var1(puVar3, uVar1);
...

{
    ...
    if(puVar4 == 0x0)
    {
        if((puStack18 | uStack20) != 0x0)
        {
            ...
            fn_ptr_1000_17ce((Struct18 *)str_var1(puStack18, uStack20), SEG_1000);
        }
    }
    else
    {
            ...
            else
            {
                ...
                if(iVar10 == 0x0)
                {
                    ...
                    pu_var20 = mixed_1010_20ba(
                      globals.u16_1050_0ed0, 0x3b, param_9, puVar12, param_7);
                    puVar13 = (pu_var20 >> 0x10);
                    pass1_1008_de58(pu_var20, iVar15->field_0xe, 0x4000001, param_9);
                    pu_var20 = mixed_1010_20ba(
                      globals.u16_1050_0ed0, 0x2f, param_9, puVar13, param_7);
                    puVar13 = (pu_var20 >> 0x10);
                    ...
                    puStack14 = mixed_1010_20ba(
                      globals.u16_1050_0ed0, uVar14, param_9, puVar13, param_7);
