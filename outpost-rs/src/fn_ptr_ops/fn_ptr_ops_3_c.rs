...

{
    ...
    {
        puVar8   = mixed_1010_20ba(globals._1050_0ed0: u16, 0x2b, param_6, puVar6, param_5);
...

{
    ...
    if(uStack14 == 0x0)
    {
        ...
        if(((iVar11 + 0x11a) == 0xa) || ((iVar11 + 0x11a) == 0x37))
        {
            ...
            puStack46        = mixed_1010_20ba(globals._1050_0ed0: u16, 0x2f, param_3, u_stack6, iVar13);
