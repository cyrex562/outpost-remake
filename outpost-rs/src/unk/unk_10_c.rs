...

{
    ...
    if(uVar1 != 0x0)
    {
        ...
        puVar4           = mixed_1010_20ba(globals._1050_0ed0: u16, 0x3a, unaff_SS, pu_var2, param_7);
...

{
    ...
    {
        puVar11 = mixed_1010_20ba(globals._1050_0ed0: u16, 0x2f, param_6, param_5, unaff_DI);
        puVar8  = (puVar11 >> 0x10);
        if((puVar11 + 0x1e) == 0x0)
        {
            uStack20 = param_4;
