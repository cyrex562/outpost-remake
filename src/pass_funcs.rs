...
pub unsafe fn pass1_fn_1000_2913(param_1: *mut char) {
    ...
    if (PTR_LOOP_1050_61ec != 0x0) {
        pc_var2 = process_string_1000_28dc(param_1);
        if (pc_var2 != 0x0) {
            i_var3 = -1;
            while {
                if (i_var3 == 0) {
...
pub unsafe fn pass1_fn_1000_3038(param_1: i32, param_2: u32, param_3: u32) -> u16 {
    ...
    while (paVar2 <= PTR_LOOP_1050_5ff0) {
        if ((param_1 == 1) && ((paVar2.field_0xa & 0x83) != 0)) {
            i_var1 = pass1_fn_1000_2f48(paVar2, &g_alloc_addr_1050_1050);
            if (i_var1 != -1) {
                uVar3 = uVar3 + 1;
            }
        } else {
...
pub unsafe fn pass1_fn_1000_455a(param_1: *mut Struct170) -> u16 {
    ...
    if ((local_bx_9.field_0x8 < 4) || (8 < local_bx_9.field_0x8)) {
        ...
        i_var4 = pass1_fn_1000_52f0(uVar3 - 0xd, (uVar3 >> 0xf) - (uVar3 < 0xd), 7, 0);
...
pub unsafe fn pass1_1000_49c6(
    ...
    while (true) {
        ...
        local_e = param_5 >> 1;
        if (local_e == 0) {
            if ((param_5 != 0) && (i_var5 = (*fn_ptr_7)(), i_var5 == 0)) {
                return local_14;
            }
            return 0;
        }
        ...
        u_var4 = uVar3 + local_14;
        local_a = ((u_var2 * param_6 >> 0x10) + CARRY2(uVar3, local_14)) * 0x100 + local_12;
        local_c = u_var4;
        i_var5 = (*fn_ptr_7)();
        if (i_var5 == 0) {
            break;
...
pub unsafe fn pass1_fn_1000_5026(param_1: i32, in_mem_buf_ptr: u32, uparam_3: i32, param_4: u16) {
    ...
    if (local_118 == 0) {
        u_var1 = get_string_index_1000_3da4(CONCAT22(local_SS__1, &local_108));
        u_var2 = u_var1 + 1;
...
pub unsafe fn pass1_fn_1000_52f0(uparam_1: i32, uparam_2: i32, uparam_3: i32, uparam_4: i32) {
    ...
    if (param_4 == 0) {
        ...
        while {
            ...
            u_var7 = u_var8 >> 1;
            uVar3 = uVar3 >> 1 | ((u_var8 & 1) != 0) << 0xf;
            u_var8 = u_var7;
            u_var9 = u_var10;
            u_var10 != 0
        } {}
        u_var1 = CONCAT22(u_var7, uVar3) / u_var4;
        uVar3 = u_var1 * param_4;
        lVar2 = (u_var1 & 0xffff) * param_3;
        u_var8 = (lVar2 >> 0x10);
        u_var4 = lVar2;
        u_var9 = u_var8 + uVar3;
        if (((CARRY2(u_var8, uVar3)) || (param_2 < u_var9))
...
pub unsafe fn pass1_fn_1000_5390(uparam_1: i32, uparam_2: i32, uparam_3: i32, uparam_4: i32) {
    ...
    if (param_4 == 0) {
        ...
        while {
            ...
            u_var7 = u_var6 >> 1;
            uVar3 = uVar3 >> 1 | ((u_var6 & 1) != 0) << 0xf;
            u_var8 = u_var5;
            u_var6 = u_var7;
            u_var5 != 0
        } {}
        u_var1 = CONCAT22(u_var7, uVar3) / u_var9;
        i_var4 = u_var1;
        lVar2 = param_3 * (u_var1 & 0xffff);
        uVar3 = (lVar2 >> 0x10);
        u_var8 = uVar3 + i_var4 * param_4;
        if (((CARRY2(uVar3, i_var4 * param_4)) || (param_2 < u_var8))
...
pub unsafe fn pass1_fn_1000_53f0(uparam_1: i32, uparam_2: i32, uparam_3: i32, uparam_4: i32) {
    ...
    if (param_4 == 0) {
        ...
        while {
            ...
            u_var8 = u_var9 >> 1;
            uVar3 = uVar3 >> 1 | ((u_var9 & 1) != 0) << 0xf;
            u_var4 = u_var5;
            u_var9 = u_var8;
            u_var5 != 0
        } {}
        u_var1 = CONCAT22(u_var8, uVar3) / u_var10;
        uVar3 = u_var1 * param_4;
        lVar2 = (u_var1 & 0xffff) * param_3;
        u_var9 = (lVar2 >> 0x10);
        u_var4 = lVar2;
        u_var10 = u_var9 + uVar3;
        if (((CARRY2(u_var9, uVar3)) || (param_2 < u_var10))
...
pub unsafe fn pass1_1008_5236(param_1: *mut Struct197) {
    ...
    local_es_6 = (param_1 >> 0x10);
    local_bx_6 = param_1;
    i_var6 = local_bx_6.field_0x8;
    i_var2 = local_bx_6.field_0xa;
    lVar5 = CONCAT22(i_var2 - (i_var6 == 0), i_var6 + -1) * &local_bx_6.field_0x4;
    pu_var1 = &local_bx_6.field_0x10;
    u_var4 = lVar5;
    let pu_var1_val = unsafe { *pu_var1 };
    local_6 = u_var4 + pu_var1_val;
    local_4 = ((lVar5 >> 0x10) + CARRY2(u_var4, pu_var1_val)) * 0x100 + local_bx_6.field_0x12;
    _local_a = CONCAT22(i_var2, i_var6);
    ...
    while (_local_a != 0) {
        ...
        process_struct_1008_4544(local_bx_6.field_0xc);
        pass1_fn_1000_48a8(
            CONCAT22(i_var6, local_c),
            CONCAT22(local_4, local_6),
            local_bx_6.field_0x4,
        );
        i_var6 = local_bx_6.field_0x4;
        u_var4 = -i_var6;
        b_var7 = CARRY2(local_6, u_var4);
        local_6 = local_6 + u_var4;
        local_4 = local_4 + (b_var7 - (local_bx_6.field_0x6 + (i_var6 != 0))) * 0x100;
        local_c = uVar3;
        _local_a = _local_a + -1;
    }
    return;
...
pub unsafe fn pass1_1008_52fc(param_1: *mut Struct195) {
    ...
    i_var5 = (i_var6 + 4);
    uVar3 = i_var5 - 1;
    i_var5 = (i_var6 + 6) - (i_var5 == 0);
    lVar4 = (i_var6 + 8) + -1;
    u_var2 = param_1.field_0x0;
    temp_87f1a411929 = &local_bx_5.field_0x4;
    i_var6 = (u_var2 >> 0xf) + (&local_bx_5.field_0x4 + 2) + CARRY2(u_var2, temp_87f1a411929);
    if ((i_var5 <= i_var6) && (i_var5 < i_var6 || (uVar3 < u_var2 + temp_87f1a411929))) {
        &local_bx_5.field_0x4 = uVar3 - u_var2;
        (&local_bx_5.field_0x4 + 2) = (i_var5 - (u_var2 >> 0xf)) - (uVar3 < u_var2);
    }
...
pub unsafe fn pass1_1008_7f06(
    ...
    while (true) {
        ...
        *(&PTR_LOOP_1050_1008 + unaff_DI) = param_4;
        u_var21 = *(&PTR_LOOP_1050_1008 + unaff_DI);
...
pub unsafe fn pass1_1008_8aa2(param_1: *mut u16) {
    ...
    u_var2 = (i_var5 + 0x3a);
    uVar3 = (i_var5 + 0x3c);
    _local_10 = CONCAT22(uVar3, u_var2);
    if ((uVar3 | u_var2) != 0) {
...
pub unsafe fn pass1_1008_8c4e(in_struct: *mut Struct207, param_2: u32) {
    ...
    if ((struct_1.field_0xc == 0) || (struct_1.field_0xe == 0)) {
        ...
        if ((paVar4 | u_var1) == 0) {
            ...
            process_struct_1008_50c2(_local_e, (u_var6 + 8), (u_var6 + 4), uVar3, param_2);
            u_var2 = uVar3;
            u_var5 = local_DX_97;
        }
...
pub unsafe fn pass1_1008_9e5a(param_1: *mut u16) {
    ...
    (i_var5 + 2) = &PTR_LOOP_1050_1008;
    (i_var5 + 0x1c) = 0x9fca;
    (i_var5 + 0x1e) = &PTR_LOOP_1050_1008;
    ...
    if ((i_var6 + 0x12) == 0) {
        ...
        while (u_var5 = (lVar9 >> 0x10), local_4 < 0x6e7) {
            if (local_4 == 0x6e3) {
                ...
                u_var8 = (i_var6 + 0x12);
                pp_var1 = ((i_var6 + 0x12) + 8);
                lVar9 = (**pp_var1)(0x1010, u_var8, (u_var8 >> 0x10), u_var10);
            }
            local_4 = local_4 + 1;
        }
    }
    return CONCAT22((i_var6 + 0x14), (i_var6 + 0x12));
}
...
pub unsafe fn pass1_1008_cfa0(param_1: *mut Struct298, param_2: u32) {
    ...
    u_var9 = u_var8;
    if ((-1 < extraout_dx_00) && (0 < extraout_dx_00 || (u_var9 != 0))) {
        u_var7 = u_var9;
        load_str_1010_84ac(
            _g_struct_73_1050_14cc,
            (_g_struct_73_1050_14cc >> 0x10),
        ...
        if ((pa_var5 | u_var9) == 0) {
            ...
            pass1_1018_4842(
                ...
                u_var8 & 0xffff | extraout_dx_00 << 0x10,
    ...
    if ((-1 < extraout_dx_02) && (0 < extraout_dx_02 || (u_var9 != 0))) {
        u_var6 = u_var9;
        load_str_1010_84ac(
            _g_struct_73_1050_14cc,
            (_g_struct_73_1050_14cc >> 0x10),
        ...
        if ((pa_var5 | u_var7) == 0) {
            ...
            u_var14 = 0x18;
            u_var8 = CONCAT22(extraout_dx_02, u_var9);
            u_var9 = u_var7;
            pass1_1018_4842(
...
pub unsafe fn pass1_1050_3344() {
    ...
    unsafe { *pi_var3 = (*pi_var3 - (in_AX & 0xff00 | b_var5)) - CARRY1(b_var4, *pb_var2) };
    pc_var1 = unaff_s_i + in_b_x;
...
pub unsafe fn pass1_1008_df4a(param_1: u32) {
    ...
    while (true) {
        ...
        if (((uVar3 + 0xc) == 2) || ((uVar3 + 0xc) == 3)) {
            pass1_1008_e9a4(param_1, u_var2, uVar3);
        }
    }
    return;
}
