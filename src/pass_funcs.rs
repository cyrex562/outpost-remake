...
pub unsafe fn pass1_fn_1000_30b4(ctx: &mut AppContext, param_1: &String, param_2: &Vec<u8>, param_1_00: &String) -> u16 {
    let mut b_var1: u8;
    let mut u_var2: u16;
    // let mut unaff_bp: i32;
...
pub unsafe fn pass1_fn_1008_60e8(ctx: &mut AppContext, param_1: &String) -> uint {
    let mut u_var1: i32;
    // let in_dx: *mut Struct199;
    let mut local_8: u16;
    let mut local_6: u16;
