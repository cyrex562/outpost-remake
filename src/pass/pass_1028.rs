...

{
  ...
  local_8 = *param_2;
  uStack4 = (param_2 + 0x1);
  pass1_1008_3eb4((u16 *)CONCAT22(param_7,&local_8),CONCAT22(param_7,local_e)
...
fn pass1_1028_6ff6(param_1: u32,param_2: u16,param_3: i16,param_4: u16)
{
  ...
  pass1_1028_dc52((astruct_92 *)CONCAT13(uVar13,CONCAT12(param_4,local_14)),0x1,0x0,
                  0x400);
  iStack26 = 0x1;
  iStack28 = 0x0;
  do {
...
//LAB_1028_72d3:
  ...
  if ((uchar *)(puVar4 | puVar2) != 0x0) {
    ...
    pass1_1028_dc52((astruct_92 *)CONCAT13(uVar13,CONCAT12(param_4,local_46)),0x1,
                    0x0,0x400);
    while( true ) {
      uVar6 = uVar7;
      puVar2 = local_46;
  ...
  if (0x2 < ctx.PTR_LOOP_1050_13ae) {
    ...
    if (0x2 < uStack12) {
      ...
      if (uVar5 == 0x0) {
        ...
        pass1_1028_dc52((astruct_92 *)CONCAT13(uVar10,CONCAT12(param_4,local_22)),
                        0x1,0x0,0x400);
        while( true ) {
          uVar4 = uVar5;
          puVar2 = local_22;
...
fn pass1_1028_7fb6(param_1: u32,param_2: i16,param_3: u16,param_4: u8)
{
  ...
  if (0xb < uStack6) {
    ...
    if (uVar5 == 0x0) {
      ...
      pass1_1028_dc52((astruct_92 *)CONCAT13(uVar10,CONCAT12(param_3,local_1c)),0x1,
                      0x0,0x400);
      while( true ) {
        uVar3 = uVar5;
        puVar2 = local_1c;
...
fn pass1_1028_8920(param_1: u32,param_2: u16,param_3: u16,param_4: u8)
{
  ...
  if ((uVar9 | uStack26) != 0x0) {
    struct_1030_e4fa((astruct_100 *)CONCAT13(uVar15,CONCAT12(param_3,local_156)),
...
fn pass1_1028_9a02(param_1: u32,param_2: i16,param_3: u16,param_4: u16,param_5: i16)
{
  ...
  uVar3 = (param_2 + 0x1f6);
  uStack10 = uVar3;
  pass1_1030_3694(uVar3,0x0,*(long *)(iVar6 + 0x110),param_3,0x1030,param_4);
  uVar4 = uVar3;
  (iVar6 + 0x114) = uVar4;
  *(uchar **)(iVar6 + 0x116) = param_3;
  ...
  if ((param_3 | uVar4) == 0x0) {
    ...
    if (iStack30 == 0x0) {
      ...
      uVar7 = 0x0;
      paVar9 = (astruct_67 *)
               mixed_1010_20ba(_PTR_LOOP_1050_0ed0,0x37,param_4,0x0,param_5);
      post_win_msg_1008_a0e4
...

{
  ...
  uStack18 = uVar4;
  if ((((puVar6 == 0x0) && (*(long *)(iVar9 + 0x200) != 0x8000002)) &&
  ...
  if (((param_4 == 0x0) && ((param_5 - 0x100) == '\0')) &&
    ...
    default:
      ...
      while( true ) {
        ...
        pass1_1030_671c(_PTR_LOOP_1050_5740,uVar5,CONCAT22(param_9,&stack0xffca)
...
//LAB_1028_7ba0:
    ...
    case 0xd:
      ...
      pcStack12 = *(code **)&ctx.PTR_LOOP_1050_0010;
      ppuStack24 = &local_10;
      pass1_1008_3eb4((u16 *)CONCAT13(uVar34,CONCAT12(param_9,&local_10)),
      ...
      if (uVar16 == 0x0) {
        ...
        uVar16 = pass1_1028_21ba(uVar20,uVar37,
                                 CONCAT22(param_9,&local_10),(long)local_6,
