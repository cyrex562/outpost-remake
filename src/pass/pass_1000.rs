...
use crate::defines::{Struct18, Struct197, Struct20, Struct79, Struct99, Struct_1000_2cb0, Struct_1000_34cf, StructA, U32Ptr, Struct_1000_09ca, Struct_160, Struct_211, Struct_1000_0c32};
...
use crate::sys_api::{dos3_call_1000_514e, dos3_call_1000_5174, dos3_call_op_1000_35fe, dos3_op_1000_256b, mixed_dos3_call_1000_39f2, mixed_dos3_call_1000_370a};
use crate::util::{CARRY2, CARRY4, CONCAT11, CONCAT12, CONCAT13, CONCAT22, get_string_from_addr, get_struct_from_addr, SBORROW2, SEXT24, SUB42, ZEXT24, address_of};
...

{
    ...
    pu_var4 = get_struct_from_addr::<Struct_160>((param_2 + (param_1 - pu_var1) - 6 & 0xfffc) + pu_var1);
...

{
    ...
    loop {
        ...
        pu_var6 = (param_3 + 0xe);
        if (u_stack6 < param_1) || (pu_var6 == 0x0) { break; }
    }
...
pub unsafe fn pass1_1000_0ed4(
    ...
    if (ctx.PTR_LOOP_1050_000c & 0xfff8) == 0xcad0 {
        ...
        u_stack8 = pass1_1000_0fb8(ctx, param_1, param_4, param_6, param_5, param_3 as u16, struct_1, param_2);
        if u_stack8 == 0x0 {
            return CONCAT22(param_7, param_6.field_0x0) as i32;
        }
        if (param_3 & 0x8) == 0x0 {
            l_stack12 = mem_op_1000_0a48(ctx, param_3 as u8, param_4 as u32, param_5 as u32, CONCAT22(ustack4 as u16, u_stack6) as u16, param_1 as u8);
...

{
    ...
    if (param_4 | param_2) == 0x0 {
        pass1_1000_1e61(ctx,
                        param_1,
                        0x4,
                        Some(get_struct_from_addr(ctx.PTR_LOOP_1050_0000)),
    ...
    if (ctx.PTR_LOOP_1050_000c & 0x7) != 0x0 {
        ...
        if b_var2 != 0x2 {
            ...
            if (((param_7 | param_6) != 0x0) && (param_4 == 0x0)) && (false || (param_2 <= (ctx.PTR_LOOP_1050_0000 + 0x1c) as u16)) {
...
pub unsafe fn pass1_1000_183c(
    ...
    if ((ctx.PTR_LOOP_1050_5f2e | ctx.PTR_LOOP_1050_5f2c) == 0x0)
        && (ctx.PTR_LOOP_1050_5f2c = mem_op_1000_160a(ctx, None, param_3) as u32, ctx.PTR_LOOP_1050_5f2e = pu_var1, (pu_var1 | ctx.PTR_LOOP_1050_5f2c) == 0x0) {
        return 0x0;
    }
    l_var2 = mem_op_1000_0a48(ctx, 0x1, ((param_2 * param_1) as u32), 0x0,
...
pub fn pass1_1000_1e61(
    ...
    if true {
        ...
        if (ctx.PTR_LOOP_1050_5f1c | ctx.PTR_PTR_1050_5f1a) == 0x0 {
            ...
            i_var1 = mem_op_1000_21b6(ctx.PTR_PTR_1050_5f1a as u16, ctx.PTR_LOOP_1050_5f1c as u16);
            pc_stack6 = ctx.PTR_PTR_1050_5f1a;
...
pub unsafe fn pass1_1000_201c(param_1: i16, param_2: i16, param_3: u16) {
    ...
    while u_var3 != 0x0 {
        BVar4 = pass1_1000_206c(((param_2 + 0x4) as u16), ((param_2 + 0x6) as u16));
        if BVar4 == 0x0 {
            ...
            mem_op_1000_1b9a(0x1, ((param_2 + 0x4) as u32), ((param_2 + 0x6) as u16),
                             param_3);
        }
        u_var3 = ((param_2 + 0x6) | (param_2 + 0x4)) as u16;
    }
...

{
    ...
    b_var2 = pass1_1000_22c0(param_3, param_4, param_2 as u16, param_2._2_2_, _param_1);
    if b_var2 == 0x0 {
        return 0x0;
    }
    return 0x1;
...
pub unsafe fn pass1_1000_24db(
    ...
    if (c_var4 == '\0') {
        if (true) {
            ...
            DOS3Call(get_struct_from_addr::<CONTEXT>(ctx.PTR_LOOP_1050_1000));
        }
    }
    return;
}
...
pub unsafe fn pass1_1000_25a8(param_1: u16, param_2: u16) {
...

{
    ...
    *param_2 = 0x263d;
    *param_1 = pass1_1000_2950(ctx,0x8, in_dx, unaff_es, param_4);
    p_cstack2 = get_string_from_addr(ctx.PTR_LOOP_1050_5f4c);
    pu_stack4 = in_dx;
...
//LAB_1000_26e8:
    ...
    i_var9 = -((ctx.PTR_LOOP_1050_5fb8 + (ctx.PTR_LOOP_1050_5fb8 + 0x1) * 0x4 + i_var9 + 0x1) & 0xfffe) as i16;
...
//LAB_1000_27c1:
        ...
        *ppc_var10 = 0x0;
        ...
        ctx._PTR_LOOP_1050_5fc2 = CONCAT22(ctx.PTR_LOOP_1050_5fc4 as u16, ctx.PTR_LOOP_1050_5fc2 as u16);
        return;
    }
    *ppc_var10 = pc_var13;
...
pub unsafe fn pass1_1000_27d6(ctx: &mut AppContext, param_1: &mut u16) {
    ...
    u_var10 = 0x9;
    pu_var11 = param_1;
    pu_var7 = pass1_1000_2950(ctx, 0x9, param_1, param_1, ctx.s_tile2_bmp_1050_1538 as u16);
    pu_var18 = pu_var11;
    ppu_var8 = pass1_1000_2950(ctx, u_var10 as i16, pu_var11, param_1, ctx.s_tile2_bmp_1050_1538 as u16);
    pi_var13 = 0x0;
...
pub fn pass1_1000_29af(param_1: u16) {
    pass1_1000_29b5(ctx, param_1 & 0xff);
    return;
}


pub fn pass1_1000_29b5(
    ctx: &mut AppContext,
    param_1: &mut u16) {
    let c_var1: char;
...
pub unsafe fn pass1_1000_2a00(ctx: &mut AppContext, param_1: &mut Struct_1000_2cb0, param_2: i16, param_3: u16, param_4: u16, param_5: u16,
                       param_6: u8) -> u16
...

{
    ...
    pass1_1000_2b02(ctx, param_1, param_2, param_3, param_4, 0x0, param_5, i_stack2);
    return;
}
...
pub unsafe fn pass1_1000_2e74(param_1: &mut Struct_1000_2cb0, param_2: u16) -> u16
...

{
    ...
    if (((b_var2 & 0x3) == 0x2) && (((b_var2 & 0x8) != 0x0 || (((param_1 + 0x78) & 0x1) != 0x0)))) {
        pu_var4 = (param_1.field_0x0 - param_1.field_0x3.field_0x0);
        if 0x0 < pu_var4 {
...
//LAB_1000_33d4:
        ...
        pass1_1000_356e(&mut u_var16, *pu_var11, param_2,
...
//               TODO: goto LAB_1000_3444;
                    ...
                    *(param_2 + -0x3) = 0x7;
                    pass1_1000_356e(u_var16, 0x10, param_2, 0x4, (param_2 + -0x213),
                                    param_5, param_5);
                    pu_var11 = &mut ctx.DAT_1050_0004;
                } else {
...
//LAB_1000_3444:
    ...
    if ((param_2 + -0x6) & 0xc) == 0x0 {
        pass1_1000_3552(&mut i_var9, param_2, param_5);
    }
...
//LAB_1000_30cf:
    pc_var5 = get_string_from_addr((param_2 + 0xa) as u32).clone();
    c_var4 = pc_var5[0];
...
pub unsafe fn pass1_1000_34cf(param_1: &mut Struct_1000_34cf, param_2: u16) -> u16
...
pub unsafe fn pass1_1000_34d8(param_1: &mut Struct_1000_34cf, param_2: u16) -> u32
...
pub unsafe fn pass1_1000_34e6(param_1: u16, param_2: &mut Struct_1000_34cf, param_3: u16) -> u32
...
in_af: u8) {
    ...
    if (param_1 != 0x0) {
        ...
        *pi_var1 = *pi_var1 + param_1;
        u_var3 = 0x0;
        loop {
            u_var2 = pass1_1000_3503(in_dx as u8, in_dx, param_2, unaff_cs, param_3, in_af);
            u_var3 |= u_var2;
            *param_1 += -0x1;
            if pram_1 == 0 { break; }
        }
...
pub fn pass1_1000_356e(param_1: &mut u16, param_2: i16, param_4: &mut Struct_1000_34cf, param_5: &mut i16,
                       param_6: &mut U32Ptr, param_7: u16, param_8: u16)
...
pub unsafe fn pass1_1000_3cea(param_1: i32, param_2: i32) -> u16
...
pub unsafe fn pass1_1000_3d7a(param_1: u32, param_2: u32) -> i16
...
pub unsafe fn pass1_1000_3de8(param_1: &mut String, param_2: &mut String, param_3: &mut u16, param_4: u16, param_5: u16,
) -> u16
...
pub unsafe fn pass1_1000_3e2c(param_1: u32) -> i16
...
pub unsafe fn pass1_1000_3ec0(param_1: u16, param_2: u16) -> i16
        ...
        if (ctx.PTR_LOOP_1050_6190 + (ctx.PTR_LOOP_1050_6194 & 0xfffc) <= pi_stack6) {
            ...
            if ((pu_var4 | pu_var3) == 0x0) {
                ...
                *pi_stack6 = param_1;
                ...
                pass1_1000_4906(CONCAT22(pu_var4, pu_var1 + 0x4), None, 0x24,
                );
            }
            return param_1;
        }
...
pub unsafe fn pass1_1000_43f0(param_1: u16, param_2: u16) {
...
pub unsafe fn pass1_1000_440c(param_1: u16) {
    let c_var1: u8;
    let mut pc_var2: String;
    let u_var3: u16;
    let i_var4: i16;
    ...
    u_var3 = pass1_1000_3ec0(0x61ca, ctx.data_seg) as u16;
    ...
    if (((param_1 | u_var3) != 0x0) && (_DAT_1050_61ce = CONCAT22(ctx.PTR_LOOP_1050_61d0, DAT_1050_61ce), *pc_stack8 != '\0')) {
        ...
        _DAT_1050_61ce = pass1_1000_52be(i_var4 as u16, u_var5, u_var7, u_var8);
    ...
    if (*pc_stack8 == ':') {
        ...
        l_var6 = pass1_1000_52be(i_var4 as u16, u_var5, u_var7, u_var8);
        // u_var5 = (l_var6 >> 0x10);
        ...
        if (*pc_stack8 == ':') {
            pc_stack8 = (pc_stack8 & 0xffff0000 | (pc_stack8 + 0x1));
            i_var4 = pass1_1000_3e2c(pc_var2 & 0xffff0000 | (pc_stack8 + 0x1));
            _DAT_1050_61ce += CONCAT22(u_var5, i_var4 as u16);
            // TODO: refactor for loop
...
pub unsafe fn pass1_1000_455a(param_1: u32, param_2: u16) -> u16
...
//       TODO: goto LAB_1000_460e;
            ...
            pi_var1 = (param_1 + 0xe);
            i_var2 = *pi_var1;
            if ((SBORROW2(*pi_var1 as u32, i_var4 as u32) != i_var2 as u32) + (i_stack6 < 0x0)) || ((i_var2 == i_var4) && ((param_1 + 0x4) < 0x1)) {
                // goto
                // LAB_1000_460e;
            }
        }
...
pub unsafe fn pass1_1000_462e(param_1: u16, param_2: i16, param_3: u16, param_4: u16, param_5: u16,
...

{
    ...
    u_var9 = pass1_1000_52be((u_var9 + param_4) as u16,
                             (u_var9 >> 0x10) + (param_4 >> 0xf) + CARRY2(u_var9 as u16, param_4), u_var10, u_var11);
    i_var4 = pass1_1000_52be((u_var9 + param_5) as u16,
                             (u_var9 >> 0x10) + (param_5 >> 0xf) + CARRY2(u_var9 as u16, param_5), u_var12, u_var13);
...

{
    ...
    loop {
        ...
        *param_1 = CONCAT22(i_var3 as u16, pb_var6);
        if pb_var7 == 0x0 {
...

{
    ...
    if param_3 != 0x0 {
        loop {
            ...
            *param_2 = CONCAT22(i_var3 as u16, pu_var6);
            if pu_var7 == 0x0 {
...
//LAB_1000_4c58:
    *param_1 = u_var7;
    *param_2 = u_var11;
    pass1_1000_4ceb(pu_var11.field_0x14, u_var7, u_var10 as i16, u_var9);
...

{
    ...
    string_1 = poss_str_op_1000_28dc(ctx, i_var7);
    if string_1 != 0x0 {
        i_var6 = 0x9;
        if string_1[0] == 'M' {
            i_var6 = 0xf;
    ...
    FatalAppExit16(param_3, string_1.as_str());
    FatalExit();
...

{
    ...
    if (param_4 == 0x0) {
        ...
        if (((CARRY2(u_var3, (i_var4 * param_4) as u16)) || (param_2 < u_var5)) || ((param_2 <= u_var5 && (param_1 < l_var2 as u16)))) {
            i_var4 += -0x1;
        }
        u_var3 = 0x0;
    }
...

{
    ...
    return (param_1 * param_3 & 0xffff | ((param_1 * param_3 >> 0x10) + param_2 * param_3 + param_1 * param_4) << 0x10) as u32;
}
...

{
    ...
    if param_4 == 0x0 {
        ...
        if (((CARRY2(u_var3, (i_var4 * param_4) as u16)) || (param_2 < u_var8)) || ((param_2 <= u_var8 && (param_1 < l_var2 as u16)))) {
            i_var4 += -0x1;
        }
        u_var3 = 0x0;
    }
...
pub unsafe fn pass1_1000_545a(param_1: u32, param_2: u32) -> i16
...
pub unsafe fn pass1_1000_54e8(param_1: *mut u8, param_2: u16, param_3: i16, param_4: i16, param_5: i16,
                       param_6: u16)
...
pub unsafe fn pass1_1000_5586(param_1: *mut u8, param_2: u16, param_3: i16, param_4: i16, param_5: i16,
                       param_6: u16)
...

{
    ...
    string_1 = poss_str_op_1000_28dc(ctx, i_var8);
    if string_1 != 0x0 {
        i_var7 = 0x9;
        if *string_1 == 'M' {
            i_var7 = 0xf;
        }
        string_1 = string_1 + i_var7;
        i_var7 = 0x22;
        string_3 = string_1;
        loop {
            if (i_var7 == 0x0) { break; }
