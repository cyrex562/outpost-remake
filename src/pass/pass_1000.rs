...
use crate::defines::{Struct18, Struct20, StructA};
use crate::exit::exit_1000_25f2;
use crate::fn_ptr::fn_ptr_1000::{call_fn_ptr_1000_0dc6, fn_ptr_op_1000_2594};
use crate::global::AppContext;
use crate::mem_1000::{free_mem_1000_407a, mem_1000_0670, mem_1000_167a, mem_op_1000_0510, mem_op_1000_0838, mem_op_1000_0a48, mem_op_1000_1532, mem_op_1000_160a, mem_op_1000_1b9a, mem_op_1000_1dfa, mem_op_1000_21b6, mixed_mem_op_1000_3c51};
...

{
    ...
    loop {
        ...
        if ((u_stack6 < param_1) || (pu_var6 = (param_3 + 0xe), pu_var6 == 0x0)
        ) { break; }
    }
...
pub unsafe fn pass1_1000_25d2(param_1: i16, param_2: i16, param_3: u16, param_4: u16, param_5: u16, param_6: *mut u8) -> *mut i16

{
    ...
    pass1_1000_2913(i_var9, param_3, param_4);
...

{
    ...
    pc_var11 = (s_New_failed_in_Op__Op__DialogHand_1050_0073 + 0xe);
//LAB_1000_266c:
    loop {
        loop {
            pc_var1 = pc_var11;
...

{
    ...
    str = poss_str_op_1000_28dc(ctx, i_var5);
    if (str != 0x0) {
        i_var5 = 0x9;
        if (*str == 'M') {
            i_var5 = 0xf;
...

{
    ...
    l_var1 = pass1_1000_52be(ctx.DAT_1050_61e8, PTR_LOOP_1050_61ea,
...

{
    ...
    i_var7 = 0x14;
    pass1_1000_25a8(param_2, param_3);
    pass1_1000_2913(i_var7, param_2, param_3);
