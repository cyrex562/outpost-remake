    ...
    if ((local_1e | local_1e) != 0) {
        ...
        loop {
            ...
            if (local_bx_4.field_0x3c == (pu_var2 + 4)) {
                ...
                u_var4 = u_var3;
                (**pp_var1)(&ctx.PTR_LOOP_1050_1038, u_var3, extraout_dx_04);
...
pub fn pass1_1018_2440(param_1: &mut  Struct535) {
  ...
  // u_var6 = (param_1  >> 0x10);
    ...
    if (ctx._PTR_LOOP_1050_0388 != 0) {
        ...
        pass1_1008_92b2(ctx._PTR_LOOP_1050_0388, 0x73, pu_var4, u_var5);
    }
...
pub fn pass1_1018_331c(in_struct_1: &mut  Struct295, param_2: u32) {
    ...
    CONCAT22(param_2, in_struct_1) = &ctx.PTR_LOOP_1050_470c;
...
pub fn pass1_1018_33b4(param_1: &mut  Struct376) {
  ...
  // u_var3 = (param_1  >> 0x10);
    local_struct_1 = param_1;
    param_1.ptr_a_lo = &ctx.PTR_LOOP_1050_470c;
...
pub fn pass1_1018_4720(param_1: &mut  Struct568, param_2: u32, param_3: u32) {
  ...
  // u_var1 = (param_1  >> 0x10);
    ...
    local_bx_4.u32_xc = 0;
    param_1.u16_x0 = &ctx.PTR_LOOP_1050_4aa6;
...
pub fn pass1_1018_4760(in_struct_569_1: &mut  Struct569) {
  ...
  // u_var1 = (in_struct_569_1  >> 0x10);
    ...
    in_struct_569_1.u16_x0 = &ctx.PTR_LOOP_1050_4aa6;
...
pub fn pass1_1018_47c8(
  ...
  // u_var1 = (in_Struct568_ptr_1  >> 0x10);
    ...
    in_Struct568_ptr_1 = &ctx.PTR_LOOP_1050_4a9a;
...
pub fn pass1_1018_4808(param_1: &mut  Struct568, param_2: u32, param_3: u32, param_4: u32) {
  ...
  // u_var1 = (param_1  >> 0x10);
    ...
    param_1.u16_x0 = &ctx.PTR_LOOP_1050_4aa2;
    Struct568_ptr_1.u16_x2 = 0x1018;
...
pub fn pass1_1018_4842(
  ...
  // u_var1 = (in_Struct568_ptr_1  >> 0x10);
    ...
    in_Struct568_ptr_1.u16_x0 = &ctx.PTR_LOOP_1050_4a8e;
    Struct568_ptr_1.u16_x2 = 0x1018;
...
pub fn pass1_1018_4882(param_1: &mut  Struct569) {
  ...
  // u_var1 = (param_1  >> 0x10);
    param_1.u16_x0 = &ctx.PTR_LOOP_1050_4a8e;
    (param_1 + 2) = 0x1018;
...
pub fn pass1_1018_48b0(
  ...
  // u_var1 = (param_1  >> 0x10);
    local_bx_23 = param_1;
    &local_bx_23.u32_xe = param_4;
    param_1.u16_x0 = &ctx.PTR_LOOP_1050_4a96;
    local_bx_23.u16_x2 = 0x1018;
...
pub fn pass1_1018_4920(param_1: &mut  Struct568, param_2: u32, param_3: u32, param_4: u32) {
  ...
  // u_var1 = (param_1  >> 0x10);
    ...
    param_1.u16_x0 = &ctx.PTR_LOOP_1050_4a8a;
...
pub fn invalidate_rect_1018_58e2(param_1: u32, param_2: i32) {
    ...
    if (param_2 == 0x105) {
      // u_var3 = (param_1  >> 0x10);
        ...
        if (ctx.PTR_PTR_DAT_0005_0000_1050_0004_1050_4240 <= (i_var2 + 0xf6)) {
...
pub fn pass1_1018_5b06(param_1: &mut  Struct595, param_2: u32) {
    ...
    CONCAT22(u_var9, param_1) = &ctx.PTR_LOOP_1050_5e1a;
    param_1.field_0x2 = 0x1018;
