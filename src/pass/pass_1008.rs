...
use crate::win_struct::{HINSTANCE16, WNDCLASS16, ATOM, HFILE16, LRESULT, HWND16};
use crate::winapi::{GetClassInfo16, RegisterClass16, SetTimer16};
use crate::global::AppContext;
use crate::fn_ptr::fn_ptr_1000::{fn_ptr_op_1000_24cd, fn_ptr_1000_17ce, fn_ptr_op_1000_1708, call_fn_ptr_1000_0dc6};
use crate::util::{struct_from_addr, CONCAT22, CONCAT12, CONCAT13, ZEXT24, CARRY2, SUB42};
use crate::pass::pass_1010::{pass1_1010_398e, pass1_1010_2db2, pass1_1010_3880, pass1_1010_1d80, pass1_1010_c312, pass1_1010_1f62, pass1_1010_8ef2, pass1_1010_5f4c, pass1_1010_7fd6, pass1_1010_7efc, pass1_1010_2050};
use crate::struct_ops::struct_1008::{struct_1008_ec72, struct_1008_dc90, pass1_1008_caa0, set_struct_1008_574a, struct_op_1008_6604, struct_op_1008_4214, struct_op_1008_4c98, struct_op_1008_56b4};
use crate::mixed::mixed_1010_20ba;
use crate::pass::pass_1030::{pass1_1030_8326, pass1_1030_8372, pass1_1030_8344, pass1_1030_8334, pass1_1030_838e, fn_ptr_1030_835a, pass1_1030_532e, struct_1030_8128, pass1_1030_8210};
use crate::pass::pass_1038::{pass1_1038_4d28, empty_1038_540a, pass1_1038_3608, pass1_1038_af34};
use crate::pass::pass_1028::{pass1_1028_e4ec, pass1_1028_dc52, pass1_1028_e2e0};
use crate::file::file_1008::{write_to_file_1008_7cac, read_file_1008_7dee, file_1008_76e4};
...
use crate::pass::pass_1018::{pass1_1018_4dce, pass1_1018_20ee};
use crate::struct_ops::struct_1018::{struct_op_1018_4cda, struct_1018_4790};
use crate::string::string_1008::str_op_1008_60e8;
use crate::pass::pass_1020::string_1020_c0ca;
use crate::ui::ui_1008::{pass1_1008_b08c, pass1_1008_afde, pass1_1008_b11e, pass1_1008_b0f2, show_win_1008_96ae, message_box_op_1008_12dc, save_file_1008_3178, post_quit_msg_1008_3af4, set_sys_color_1008_357e};
use crate::cleanup::{clenaup_win_ui_1018_4d22, cleanup_ui_op_1008_0618};
use crate::defines::{Struct11, Struct18, Struct79};
use crate::pass::pass_1000::{pass1_1000_4906, pass1_1000_0ed4, pass1_1000_48a8, pass1_1000_4d24, pass1_1000_093a, pass1_1000_07fc, pass1_1000_3cea, pass1_1000_545a};
...
pub fn pass1_1008_0036(param_1: *mut u16, param_2: u16)
{
  let uVar1: u16;
  let puVar2: u32;
  ...
  *param_1 = 0x51e;
  ...
  paVar3 = ctx._PTR_LOOP_1050_5748;
  ...
  if (ctx.PTR__LOOP_1050_5bc8 != 0x0) {
    ...
    (**ppcVar4)(param_2,_PTR_LOOP_1050_5bc8,(ctx.PTR__LOOP_1050_5bc8 >> 0x10)
                ,0x1);
  }
  if (ctx.PTR__LOOP_1050_02a0 != 0x0) {
    ppcVar4 = *_PTR_LOOP_1050_02a0;
    (**ppcVar4)(param_2,_PTR_LOOP_1050_02a0,(ctx.PTR__LOOP_1050_02a0 >> 0x10)
                ,0x1);
  }
...
pub fn pass1_1008_087e(param_1: u16,param_2: *mut u8,param_3: u16,param_4: u8)
{
  ...
  if (ctx.PTR__LOOP_1050_5748 == (u32 **)0x0) {
    debug_print_1008_6048
...
pub fn pass1_1008_0a92(param_1: u32,short param_2)
{
  ...
  if (ctx.PTR__LOOP_1050_0388 != 0x0) {
    ...
    (**ppcVar1)(param_2,_PTR_LOOP_1050_0388,(ctx.PTR__LOOP_1050_0388 >> 0x10)
                ,0x1);
  }
...
pub fn
pass1_1008_3bd6(param_1: &mut Struct160,param_2: u16,param_3: u16,param_4: u32,
               param_5: u16,param_6: u32,param_7: u32,param_8: u16,param_9: u16)

{
  mixed_struct_op_1040_8fb8
            (CONCAT22(param_2,param_1),param_3,0x0,param_5,
  ...
  mov_update_win_1040_93aa
            ((Struct65 *)CONCAT22(param_2,param_1),param_4,
...
pub fn pass1_1008_3e94(param_1: *mut u16,param_2: *mut u16,param_3: *mut u16)
{
  *param_3 = *param_1;
  *param_2 = (param_1 + 0x2);
  return;
...
pub fn pass1_1008_4480(param_1: u32,param_2: *mut u16,param_3: &mut Struct76,param_4: u16)
{
  let iVar1: i16;
  let iVar2: i16;
  let iVar3: i16;
...

{
  ...
  uVar6 = param_4 & 0xff |
          ((param_4 >> 0x8) + param_4 + param_11) << 0x8;
  puVar7 = (param_6 + 0x1);
...
pub fn pass1_1008_4b8e(param_1: u32,param_2: *mut u8,param_3: i16,param_4: u16)
{
  let uVar1: u32;
  let uVar2: u16;
  let puVar3: *mut u16;
  ...
  puVar3 = mixed_1010_20ba(ctx.PTR__LOOP_1050_0ed0,0x48,param_4,param_2,param_3);
  uVar2 = (puVar3 >> 0x10);
  uVar1 = (puVar3 + 0x18);
...
pub fn pass1_1008_4cdc(param_1: *mut u16)
{
  ...
  *param_1 = 0x4f1c;
  ...
  fn_ptr_1000_17ce(iVar2.field_0xe,0x1000);
  if (iVar2.field_0x12 != 0x0) {
    fn_ptr_1000_17ce(iVar2.field_0x4,0x1000);
  }
  *param_1 = 0x389a;
  iVar2.field_0x2 = 0x1008;
  return;
...
pub fn pass1_1008_4d26(param_1: u32,param_2: *mut u16,param_3: i16) -> u16

{
  let piVar1: *mut i16;
  let uVar2: u16;
  let lVar3: i32;
  let iVar5: &mut Struct650;
  let iVar4: &mut Struct649;
  let uVar4: u16;
...
pub fn pass1_1008_4d84(param_1: &mut Struct90,param_2: u32,param_3: *mut u8)
{
  let uVar1: u16;
  let iVar3: &mut Struct90;
  let uVar2: u16;
  let uVar3: u16;
  ...
  if (iVar3.field_0x12 != 0x0) {
    ...
    fn_ptr_1000_17ce(iVar3.field_0x4,0x1000);
    iVar3.field_0x4 = 0x0;
...
pub fn pass1_1008_4ef6(param_1: *mut u16,param_2: u8) -> u16
...
pub fn
pass1_1008_50c2(Struct110 *param_1,param_2: u32,param_3: u32,param_4: *mut u16,
               param_5: u32)
...
uchar *  pass1_1008_5fd8(param_1: u16,param_2: *mut u8)
...
pub fn pass1_1008_6562(param_1: *mut u32,param_2: u32,param_3: i16,param_4: u16,param_5: *mut u8)
{
  ...
  if (uVar3 == 0x0) {
    ...
    pass1_1008_405c(CONCAT22(param_5,param_4),(param_1 + 0x4)
...
pub fn
pass1_1008_87cc(param_1: &mut Struct86,param_2: i16,param_3: i16,param_4: u16,param_5: u32,
...

{
  ...
  if (ctx.PTR__LOOP_1050_0382 == 0x0) {
    ctx._PTR_LOOP_1050_0382 =
         mixed_1010_20ba(ctx.PTR__LOOP_1050_0ed0,0x2e,param_7,(puVar9 >> 0x10)
                         ,unaff_DI);
  }
...
pub fn pass1_1008_9466(param_1: *mut u16)
{
  *param_1 = 0x52a;
  (param_1 + 0x2) = 0x1008;
  fn_ptr_1000_17ce(ctx.PTR__LOOP_1050_0392,0x1000);
...
pub fn pass1_1008_9d36(param_1: *mut u8,param_2: *mut u8,param_3: u16,param_4: u16)
{
  let puVar1: *mut u8;
  let uVar2: u16;
  let puVar3: *mut u16;
...
pub fn pass1_1008_9fb2(param_1: u16,param_2: i16,param_3: u16,param_4: u16,param_5: u16
...
pub fn pass1_1008_b200(param_1: u32,param_2: u16)
{
  let uVar1: u32;
  let ppcVar2: u32;
  let puVar3: u32;
  let puVar4: *mut u8;
  let uVar5: &mut Struct195;
  let uVar6: u16;
  let uVar7: u32;
  let extraout_DX: *mut u8;
  ...
  *(u32 **)&iVar12.field_0xe = puVar3;
  ...
  loop {
    ...
    if ((puVar4 + 0x200) == 0x8000001) {
      ...
      (**ppcVar2)(&ctx.PTR_LOOP_1050_1038,iVar12.field_0xe,uVar5,uVar10);
...
pub fn pass1_1008_d72e(param_1: i16,param_2: u16,param_3: u16) -> u16
...
pub fn pass1_1008_dfa6(param_1: u32,param_2: i32,param_3: i32,param_4: u16)
{
  ...
  } while ((((puVar1 + 0x4) != param_3) || ((puVar1 + 0x8) != param_2))
  ...
  if (lStack6 == 0x0) {
    ...
    if (uVar8 == 0x0) {
      ...
      struct_1008_dc90(CONCAT22(puVar7,paVar9),
                       CONCAT13((puVar6 >> 0x8),CONCAT12(puVar6,paVar3))
...
pub fn pass1_1008_e320(param_1: &mut Struct102,param_2: u32,param_3: u32,param_4: u16)
{
  ...
  if ((uVar2 != 0x0) &&
     (uVar2 = pass1_1000_3d7a(param_3,param_2), uVar2 != 0x0
     )) {
    ...
    uVar4 = uVar3 | uVar2;
    if ((uVar4 != 0x0) &&
       (((paVar1 = uVar2.field_0xc, uVar2 = paVar1,
         paVar1 != 0x0 &&
         (uVar2 = (&paVar1[-0x1].field_0xc + 0x1),
         uVar2 != 0x0)) &&
        (uVar2 = &paVar1[-0x1].field_0xc, uVar2 != 0x0)))) {
...
//LAB_1008_ea20:
    ...
    if (ctx.PTR_LOOP_1050_13ae == (&ctx.PTR_LOOP_1050_0002 + 0x1)) {
      ...
      if (ctx.PTR_LOOP_1050_13ae != &DAT_1050_0004) goto LAB_1008_ea2b;
...
pub fn pass1_1008_eabc(param_1: i16,param_2: u16,param_3: u16) -> u16
...
pub fn pass1_1008_ec10(param_1: i16,param_2: u16,param_3: u16) -> u16
...

{
  ...
  if (0x0 < param_4) {
    if (ctx.PTR__LOOP_1050_0df6 == 0x0) {
      ...
      uVar6 = (**ppcVar1)();
      ctx._PTR_LOOP_1050_0df6 =
           mixed_1010_20ba(ctx.PTR__LOOP_1050_0ed0,uVar6,param_7,
                           (uVar6 >> 0x10),param_6);
    }
    uVar6 = (param_1 + 0xc);
