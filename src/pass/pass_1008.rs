...
pub fn pass1_1008_0036(ctx: &mut AppContext, param_1: &mut Struct18, param_2: &mut u16) {
    ...
    if ctx.PTR__LOOP_1050_5bc8 != 0x0 {
        ...
        (**ppc_var4)(
            param_2,
            ctx._PTR_LOOP_1050_5bc8,
            (ctx.PTR__LOOP_1050_5bc8 >> 0x10),
            0x1,
        );
    }
...
pub fn pass1_1008_07d8(
    ...
    if ctx.PTR__LOOP_1050_5748 == 0x0 {
        ...
        u_var3 = pass1_1028_e2e0(ctx.PTR__LOOP_1050_65e2, u_var2, 0x8);
        u_var3 = pass1_1028_e2e0(ctx.PTR__LOOP_1050_65e2, ((u_var3 >> 0x10) as u16), 0x8);
        pass1_1028_e2e0(ctx.PTR__LOOP_1050_65e2, ((u_var3 >> 0x10) as u16), 0xff);
        pass1_1030_838e(ctx.PTR__LOOP_1050_5748, param_4, in_af);
        *param_2 = pass1_1030_8334(ctx, ctx.PTR__LOOP_1050_5748);
    }
    return param_2;
}
...
pub fn pass1_1008_087e(
    ...
    u_var3 = pass1_1028_e2e0(ctx.PTR__LOOP_1050_65e2, u_var1, 0x8);
    pass1_1028_e2e0(ctx.PTR__LOOP_1050_65e2, ((u_var3 >> 0x10) as u16), 0x8);
    ...
    local_112 = 0x389a;
    u_stack272 = 0x1008;
    pass1_1030_8334(ctx, ctx.PTR__LOOP_1050_5748);
    return;
}
...
pub fn pass1_1008_30cc(
    ...
    if pu_var1 != 0x0 {
        ...
        string_4 = string_2;
        u_var4 = param_5;
        pu_var2 = mixed_1010_20ba(ctx, ctx.PTR__LOOP_1050_0ed0, 0x2, param_5, pu_var1, param_4);
        pass1_1010_5f4c(
            pu_var2,
...
pub fn pass1_1008_3ee2(param_1: &mut i16, param_2: &mut i16) {
    ...
    *param_1 = i_var1 + 0x1;
    ...
    // uVar4 = (param_1 >> 0x10);
    iVar2 = param_1;
    i_var1 = (param_2 + 0x2) - (iVar2 + 0x2);
    if (i_var1 < 0x0) {
        i_var1 = -i_var1;
    }
    (iVar2 + 0x2) = i_var1 + 0x1;
    i_var1 = (param_2 + 0x4) - (iVar2 + 0x4);
    if (i_var1 < 0x0) {
        i_var1 = -i_var1;
    }
    (iVar2 + 0x4) = i_var1 + 0x1;
    return;
}
...
pub fn pass1_1008_4d84(param_1: &mut Struct_1008_4d84, param_2: u32, param_3: &mut Struct19) {
    let u_var1: u16;
...
pub fn pass1_1008_5134(ctx: &mut AppContext, param_1: u32) {
    ...
    while l_stack14 != 0x0 {
        ...
        pass1_1000_48a8(
            u_stack10,
            CONCAT22(i_var5 as u16, i_stack16 as u16),
            (i_var6 + 0x4),
        );
        i_var5 = (i_var6 + 0x4);
...
pub fn pass1_1008_5236(param_1: u32) {
    ...
    while l_stack10 != 0x0 {
        ...
        pass1_1000_48a8(
            CONCAT22(i_var5 as u16, i_stack12 as u16),
            CONCAT22(i_stack4 as u16, u_stack6),
            &i_var6.field_0x4,
        );
...
pub fn pass1_1008_5bdc(param_1: &mut Struct79, param_2: i16, param_3: u16) {
    ...
    pu_var1.field_0xc = puVar3;
    pu_var1.field_0xe = (puVar3 >> 0x10);
    return;
}
...
pub fn pass1_1008_64c8(param_1: U32Ptr, param_2: u32, param_3: i16, param_4: u16, param_5: U32Ptr) {
    ...
    while (
        ...
        pass1_1000_48a8(
            CONCAT22(iVar5 as u16, iStack8 as u16),
            CONCAT22(iVar4 as u16, param_3 as u16),
            param_2._2_2_,
        );
        param_3 = i_var1;
        iStack8 = iVar2;
    ...
    *param_2 = 0x0;
    ...
    if (pu_var1 != 0x0) {
        if (local_6 != 0x0) {
            ...
            puVar2 = (param_5 | pu_var1);
            if (puVar2 == 0x0) {
                pu_var1 = 0x0;
                puVar2 = 0x0;
            } else {
                pass1_1010_8ef2(CONCAT22(param_5 as u16, pu_var1 as u16), puVar2, param_3);
            }
            param_2 = pu_var1;
            (param_2 + 0x2) = puVar2;
...
pub fn pass1_1008_87cc(
    ...
    if (ctx.PTR__LOOP_1050_0382 == 0x0) {
        ctx._PTR_LOOP_1050_0382 = mixed_1010_20ba(
            ctx.PTR__LOOP_1050_0ed0,
            0x2e,
            param_7,
            (puVar9 >> 0x10),
...
pub fn pass1_1008_8b20(param_1: u32, param_2: u16) {
    ...
    if ((iVar4 + 0x8) != 0x0) {
        ...
        *piVar2 = *piVar2 + 0x1;
        uVar3 = (i_var1 % (iVar4 + 0x3e)) as u16;
        if (uVar3 == 0x0) {
            (iVar4 + 0x40) = 0x1;
            ...
            pass1_1008_3e94(
                (param_1 & 0xffff0000 | (iVar4 + 0x28)),
                CONCAT22(param_2, local_a),
                CONCAT22(param_2, local_8),
            );
            pass1_1008_8d8a(
                param_1 & 0xffff | uVar5 << 0x10,
                paStack6,
                ((iVar4 + 0x4) as u32),
            );
            pass1_1008_4480(
...
pub fn pass1_1008_8bc6(param_1: u16, param_2: u16, param_3: u32) {
    ...
    pass1_1008_3e94(
        (param_3 & 0xffff0000 | (iVar2 + 0x28)),
        CONCAT22(param_1, local_a),
        CONCAT22(param_1, local_8),
    );
    pass1_1008_8d8a(
        param_3 & 0xffff | uVar3 << 0x10,
        paStack6,
        ((iVar2 + 0x4) as u32),
    );
    pass1_1008_4480(
...
pub fn pass1_1008_8c4e(param_1: u32, param_2: u32, param_3: u16) {
    ...
    if (((iVar6 + 0xc) == 0x0) || ((iVar6 + 0xe) == 0x0)) {
        ...
        paStack14 = CONCAT22(puVar4 as u16, uVar5);
...
pub fn pass1_1008_8ce4(param_1: u32, param_2: U32Ptr, param_3: u32, param_4: u16) {
    ...
    if (uVar3 == 0x0) {
        ...
        // uVar6 = (uStack6 >> 0x10);
        pass1_1008_50c2(
            CONCAT22(puVar2 as u16, pu_var1 as u16),
            (uStack6 + 0x8),
            (uStack6 + 0x4),
            param_2,
            param_3,
    ...
    uStack10 = CONCAT22(uVar3, pu_var1 as u16);
    pass1_1008_5134(CONCAT22(uVar3, pu_var1 as u16));
...
pub fn pass1_1008_8d8a(param_1: u32, param_2: &mut Struct76, param_3: u32) {
    ...
    if (iVar7.field_0x3a == 0x0) {
        ...
        paStack10 = CONCAT22(puVar5 as u16, uVar6);
...
pub fn pass1_1008_909c(param_1: u32, param_2: u16) {
    ...
    if (&iVar5.field_0x12 == 0x0) {
        ...
        uVar3 = uVar2 + *pu_var1;
        ctx.PTR_LOOP_1050_5f2e = (iVar5.field_0x14 + iVar5.field_0x18 + CARRY2(uVar2, *pu_var1));
    }
    ...
    if (iVar5.field_0x6 == 0x0) {
        ...
        lVar5 = pass1_1000_0ed4(
            ...
            0x1,
            uVar3 * 0x4,
            (ctx.PTR_LOOP_1050_5f2e * 0x2 + CARRY2(uVar3, uVar3)) * 0x2
                + CARRY2(uVar3 * 0x2, uVar3 * 0x2),
            lVar5,
            ((lVar5 >> 0x10) as u16),
        );
...
pub fn pass1_1008_932a(param_1: u32, param_2: u16) {
    ...
    if ((iVar5 + 0x4) == 0x0) {
        ...
        loop {
            ...
            if ((iVar4 < 0x1)
                && ((iVar4 < 0x0 || ((puVar3 + 0xc) == 0x0)) && ((puVar3 + 0x10) == 0x0)))
            {
...
pub fn pass1_1008_9e5a(param_1: &mut Struct18) {
    ...
    if (ctx.PTR__LOOP_1050_0388 != 0x0) {
        ...
        pass1_1008_92b2(
            ctx.PTR__LOOP_1050_0388,
            0x50,
            CONCAT22(uVar6, puVar4 as u16),
        );
    }
    iStack4 = 0x0;
    loop {
        pu_var1 = (&uVar5[0x1].field_0x0 + iStack4 * 0x4);
...
pub fn pass1_1008_9f48(param_1: u32) -> u32 {
    ...
    // uVar3 = (param_1 >> 0x10);
    i_var1 = param_1;
    iVar2 = i_var1.field_0x20 * 0x4;
    return CONCAT22(
        (&i_var1[0x1].field_0x2 + iVar2),
        (&i_var1[0x1].field_0x0 + iVar2),
    );
}
...
pub fn pass1_1008_b38c(param_1: u32, param_2: u16, param_3: U32Ptr) -> u32 {
    ...
    if (iVar4.field_0x12 == 0x0) {
        ...
        //         puVar5 =
        //                  (**ppcVar2)(0x1010,pu_var1,(pu_var1 >> 0x10),iVar5,uVar3);
        //       }
        //     }
    }
...
pub fn pass1_1008_b544(param_1: u32, param_2: i16, param_3: u16, param_4: u16) {
    ...
    if (param_2 != 0x0) {
        if ((iVar7 + 0x1a) != 0x0) {
            ...
            uVar4 = (iVar7 + 0x16) as u32;
            pass1_1030_8344(ctx, ctx.PTR__LOOP_1050_5748, (uVar4 + 0xa));
    ...
    if ((uVar2 | pu_var1) != 0x0) {
        ppcVar3 = *pu_var1;
        (**ppcVar3)(param_4, pu_var1, uVar2, 0x1);
    }
    (iVar7 + 0xe) = 0x0;
...
pub fn pass1_1008_b820(param_1: u32, param_2: i16, param_3: u16) -> u32 {
    ...
    pass1_1030_8344(ctx, ctx.PTR__LOOP_1050_5748, 0x8000001);
...
pub fn pass1_1008_b8fa(param_1: u32, param_2: u32, param_3: u16, param_4: u16) {
    ...
    loop {
        ...
        iVar2 = pass1_1000_3d7a((pu_var1 + 0x4), param_2);
        if (iVar2 != 0x0) == false {
            break;
        }
    }
...
pub fn pass1_1008_d3ae(ctx: &mut AppContext, param_1: u32) {
    ...
    paVar12 = CONCAT22(uVar5, pu_var1 as u16);
    if ((uVar5 | pu_var1) != 0x0) {
        ppcVar3 = *pu_var1;
        paVar12 = (**ppcVar3)();
    }
...
pub fn pass1_1008_e05e(
    ...
    if (lStack6 != 0x0) {
        ...
        (i_var1 + 0xe) = uVar3 as i16;
        (i_var1 + 0x10) = (uVar3 >> 0x10) as i16;
...
pub fn pass1_1008_e10c(
    ...
    i_var1 = (uVar3 + 0xc) as i16;
    if ((-0x1 < i_var1) & &(true)) {
        if (i_var1 < 0x2) {
            return 0x1;
        }
        if ((0x0 < i_var1 + -0x1) & &(iVar2 = i_var1 + -0x3, iVar2 == 0x0 || i_var1 + -0x2 < 0x1)) {
            pass1_1008_e9a4(param_1 as u16, (param_1 >> 0x10), uVar3, param_4, param_5);
            return iVar2;
        }
    }
    return 0x0;
...
pub fn pass1_1008_e2a4(param_1: u32, param_2: u32, param_3: u32) -> u16 {
    ...
    i_var1 = pass1_1000_3d7a(pcVar3, uVar5);
...
pub fn pass1_1008_e320(param_1: &mut Struct102, param_2: u32, param_3: u32, param_4: u16) {
    ...
    if ((uVar2 != 0x0) && (uVar2 = pass1_1000_3d7a(param_3, param_2), uVar2 != 0x0)) {
        ...
        if ((uVar4 != 0x0)
            && ((
                paVar1 = uVar2.field_0xc,
                uVar2 = paVar1,
                paVar1 != 0x0 && (uVar2 = (&paVar1[-0x1].field_0xc + 0x1), uVar2 != 0x0),
...
pub fn pass1_1008_e3ec(param_1: u32, param_2: U32Ptr, param_3: U32Ptr, param_4: u16) {
    ...
    if ((puVar8 | puVar5) == 0x0) {
        ...
        struct_op_1030_1cd8(
            CONCAT13(
                ((puVar8 >> 0x8) as u16),
                CONCAT12(puVar8 as u8, puVar5 as u16),
            ),
            0x5,
            0x5,
        );
...
pub fn pass1_1008_ed8a(
    ...
    if (0x0 < param_4) {
        if (ctx.PTR__LOOP_1050_0df6 == 0x0) {
            ...
            uVar6 = (**ppcVar1)();
            ctx._PTR_LOOP_1050_0df6 = mixed_1010_20ba(
                ctx.PTR__LOOP_1050_0ed0,
                uVar6,
                param_7,
                (uVar6 >> 0x10),
