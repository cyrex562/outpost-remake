...
pub unsafe fn pass1_1008_ed8a(
    ...
    ppRam10500df6 = (ZEXT24(ctx.PTR_LOOP_1050_0df8) << 0x10);
    if (0 < param_4) {
        unsafe {
  ...
  // u_var2 = (param_1  >> 0x10);
    ...
    if (param_2 == false) {
        if (local_bx_13.d != 0) {
          ...
          ctx.PTR_LOOP_1050_0e30 = local_bx_13.b;
          ctx.PTR_LOOP_1050_0ea8 = local_bx_13.c;
            local_bx_13.d = 0;
            bVar1 = true;
        }
    }
  ...
  // u_var2 = (u_var4  >> 0x10);
    if (u_var4 != 0) {
        ...
        if (&ppVar1[1].field_0x9e == 0x8000002) {
          ctx.PTR_LOOP_1050_0ea8 = (&ctx.PTR_LOOP_1050_0000 + 1);
        }
    }
  ...
  // uVar15 = (param_1  >> 0x10);
    ...
    while {
        while {
            ...
            pp_var1 = (iVar13 + 0x40);
            pu_var7 = puVar6;
            (**pp_var1)(&ctx.PTR_LOOP_1050_1028, param_1);
            pu_var7 == 0x0
        } {}
        u_var11 = ctx.dx_reg;
...
pub unsafe fn pass1_1010_1bb4(param_1: &mut  u32) {
    ...
    loop {
        ...
        (**fn_ptr_1)(&ctx.PTR_LOOP_1050_1028, param_1);
    }
    return;
}
...
pub unsafe fn pass1_1010_2024(param_1: u32) {
  // PTR_LOOP_1050_0ed2 = (param_1  >> 0x10);
    ...
    pass1_1000_4906(
        (param_1 & 0xffff | ZEXT24(ctx.PTR_LOOP_1050_0ed2) << 0x10),
        0,
        0x124,
    );
    return param_1;
...
pub unsafe fn pass1_1010_398e(param_1: &mut  u32, param_2: u16, param_3: u16, param_3_00: u32) {
  ...
  // u_var9 = (param_1  >> 0x10);
    ...
    if (i_var5 != 0) {
        ...
        (in_ax + 8) = i_var7;
        (in_ax + 10) = ctx.dx_reg;
      ctx.PTR_LOOP_1050_11de = PTR_LOOP_1050_11de + 1;
        local_c = 0;
...
pub unsafe fn pass1_1010_3cd0(param_1: libc::c_long) {
    ...
    if (ctx._PTR_LOOP_1050_0388 != 0) {
        ...
        pass1_1008_92b2(ctx._PTR_LOOP_1050_0388, (param_1 + 0x12), 0, iVar1, u_var2);
    }
    return;
}
  ...
  // u_var6 = (param_1  >> 0x10);
    ...
    if (local_bx_5.field_0x7e != 0) {
        if (ctx._PTR_LOOP_1050_0388 != 0) {
            ...
            pass1_1008_92b2(ctx._PTR_LOOP_1050_0388, 500, i_var4, u_var5);
        }
        local_4 = 0;
        while (local_4 < 0x10) {
        ...
        *ppaVar1 = &(*ppaVar1).field_0x1;
        ...
        if (param_2 != 2) {
            ...
            *ppaVar1 = &(*ppaVar1)[-1].field_0x104;
            if (*ppaVar1 < 0) {
                local_struct_1.Struct30_field_0x24 = (&ctx.PTR_LOOP_1050_000e + 1);
            }
            // goto LAB_1010_469a;
        }
    }
