...
pub fn pass1_1038_3698(param_1: u32,param_2: u16,param_3: u16,param_4: u16)
{
  ...
  if (0x0 < uStack6) {
    ...
    for (uStack18 = 0x0; uVar12 = uVar14, uVar10 = uStack14,
      ...
      uVar14 = uVar13;
      if (uVar13 != 0x0) {
        BVar6 = pass1_1008_c6ae(ctx.PTR__LOOP_1050_06e0,(uVar17 + 0xc),
                                0x4);
        uVar8 = uVar14;
        uVar10 = BVar6;
        if (BVar6 != 0x0) {
  ...
  if (ctx.PTR_LOOP_1050_5f2e != 0x0) {
    ...
    for (uStack22 = 0x0; uStack22 < uStack6; uStack22 += 0x1) {
      ...
      if (ctx.PTR_LOOP_1050_5f2e != 0x0) {
        ...
        *(uchar **)(uStack22 + iVar6 + 0x2) = ctx.PTR_LOOP_1050_5f2e;
        uVar9 = 0x1030;
        ...
        *(uchar **)(paStack14 + uStack22 + 0x2) = ctx.PTR_LOOP_1050_5f2e;
      }
    }
    for (uStack22 = 0x0; uStack22 < uStack6; uStack22 += 0x1) {
...
pub fn pass1_1038_4d28(param_1: u32) -> *mut u8
...
pub fn pass1_1038_4d3c(param_1: u32,char *param_2,param_3: u16)
{
  let uVar1: u16;
  let iVar2: i16;
  let uVar3: u16;
...
pub fn pass1_1038_9144(param_1: *mut u16,param_2: u16,param_3: u16)
{
  ...
  *(uchar **)(iVar5 + 0x9a) = puVar3;
  ...
  if ((puVar4 | uVar2) == 0x0) {
    ...
    *piStack8 = iVar6;
    pass1_1000_5586((uchar *)0xa564,&ctx.PTR_LOOP_1050_1040,iVar6,0xa,uVar2 + 0x2,
                    puVar4);
    uVar1 = (iVar5 + 0x90);
    uVar8 = (uVar1 >> 0x10);
    iVar6 = uVar1;
