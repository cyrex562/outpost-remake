 ...
 // uVar8 = (param_3 >> 0x10);
  ...
  if (puVar4 == 0x0) {
    if ((puStack18 | uStack20) != 0x0) {
      ...
      fn_ptr_1000_17ce(CONCAT22(puStack18,uStack20),0x1000);
    }
  }
  else {
    mem_op_1000_179c(0x2a,puVar4,0x1000);
...
pub fn pass1_1038_33f8(param_1: *mut u16)
{
  ...
  *param_1 = 0x6504;
  ...
  fn_ptr_1000_17ce((iVar4 + 0x1fa),0x1000);
  puVar1 = (iVar4 + 0x210);
  uVar2 = (iVar4 + 0x212);
  if ((uVar2 | puVar1) != 0x0) {
    ppcVar3 = *puVar1;
  ...
  fn_ptr_1000_17ce((iVar4 + 0x21a),0x1000);
...
pub fn pass1_1038_4d3c(param_1: u32,param_2: &mut String,param_3: u16)
{
 ...
 // uVar3 = (param_1 >> 0x10);
  iVar2 = param_1;
  fn_ptr_1000_17ce((iVar2 + 0x1fa),0x1000);
