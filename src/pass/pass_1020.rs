...
pub fn pass1_1020_679c(param_1: &mut Struct18,param_2: u8,param_3: u16,param_4: u16) -> &mut Struct18
...
pub fn pass1_1020_808e(param_1: U32Ptr)
{
  ...
  *puStack6 = 0x389a;
  pu_var1[0x1] = 0x1008;
  pass1_1008_57c4(
                  (param_1 & 0xffff0000 | &i_var3.field_0xd2));
  *param_1 = 0x380a;
  i_var3.field_0x2 = 0x1008;
  *param_1 = 0x389a;
  i_var3.field_0x2 = 0x1008;
...
pass1_1020_b1ae(param_1: i16,param_2: u16,param_3: u16,param_4: u16,param_5: u16,
               param_6: U32Ptr,param_7: u32) -> u16
...
pub fn pass1_1020_ca0c(param_1: &mut Struct179,param_2: u16,param_3: i16,param_4: u32,
               param_5: u16) ->  u16
...
pub fn pass1_1020_ce08(param_1: &mut Struct179,param_2: u16,param_3: i16,param_4: u32,
               param_5: u16) -> u16
  ...
  *pi_var1 = *pi_var1 + -0x1;
  if (*pi_var1 == 0x0) {
    ...
    if (0x0 < (i_var3 + 0x24)) {
      ...
      pass1_1028_68de(CONCAT22(param_3,local_138),(i_var3 + 0x24)
