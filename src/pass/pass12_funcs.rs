...
use crate::struct_ops::struct_ops_2::{process_struct_1000_179c, process_struct_1008_574a, process_struct_1010_1d48, struct_fn_1000_160a};
use crate::structs::prog_structs_10::Struct252;
use crate::structs::prog_structs_12::{Struct235, Struct266};
use crate::structs::prog_structs_13::Struct279;
use crate::structs::prog_structs_16::Struct248;
use crate::structs::prog_structs_17::Struct284;
use crate::structs::prog_structs_19::Struct271;
use crate::structs::prog_structs_1::Struct283;
use crate::structs::prog_structs_2::{Struct199, Struct293};
use crate::structs::prog_structs_20::Struct253;
use crate::structs::prog_structs_21::Struct240;
use crate::structs::prog_structs_23::Struct267;
use crate::structs::prog_structs_24::{Struct2111, Struct236, Struct249};
use crate::structs::prog_structs_25::Struct272;
use crate::structs::prog_structs_26::{Struct241, Struct254};
use crate::structs::prog_structs_27::{pass1_struct_2, Struct268, Struct285};
use crate::structs::prog_structs_28::{Struct237, Struct255, Struct260, Struct273, Struct290};
use crate::structs::prog_structs_29::{Struct225, Struct226, Struct227, Struct228, Struct229, Struct238, Struct242, Struct243, Struct256, Struct269, Struct286, Struct291};
use crate::structs::prog_structs_30::{Struct230, Struct231, Struct232, Struct233, Struct234, Struct239, Struct244, Struct245, Struct246, Struct247, Struct257, Struct261, Struct274, Struct287, Struct292};
use crate::structs::prog_structs_31::{Struct250, Struct251, Struct258, Struct259, Struct262, Struct263, Struct264, Struct275, Struct276, Struct277, Struct278, Struct280, Struct281, Struct282, Struct288, Struct289};
use crate::structs::prog_structs_4::Struct270;
use crate::structs::prog_structs_7::Struct44;
use crate::structs::prog_structs_8::Struct265;
...
pub unsafe fn pass1_1008_bde0(param_1: u32) {
    ...
    if (ctx.g_struct_ptr_1 == 0) {
        u_var1 = param_1;
        struct_fn_1000_160a();
        g_struct_ptr_1 = u_var1;
        ctx.g_u16_ptr_1050_5f2e = in_dx;
    } else {
    }
    alloc_mem_1000_1708(0x1aa, 0x10000, g_struct_ptr_1, ctx.g_u16_ptr_1050_5f2e);
    param_1 = g_struct_ptr_1;
...
pub unsafe fn pass1_1008_c646(param_1: u16, param_2: u32) -> i32 {
  ...
  // pu_var4 = pass1_1008_c6fa(CONCAT22(param_2, param_1), (param_2  >> 0x10));
    ppVar5 = process_struct_1010_20ba(ctx.g_struct_var_1050_0ed0, CONCAT22(unaff_si, 0x35));
    local_12 = 0;
    loop {
        pi_var1 = (pu_var4 + 4);
