...

{
    ...
    u_var4 = param_2;
    u_var6 = param_2;
    pu_var2 = mixed_1010_20ba(ctx.PTR__LOOP_1050_0ed0, 0x48, param_4,
...
pub fn pass1_1010_038e(param_1: u32, param_2: i16, param_3: u16) {
    ...
    if (param_2 != 0x0) {
        if (iVar2.field_0x18 == 0x0) {
            iVar2.field_0x12 = ctx.DAT_1050_0e28;
...
//       TODO: goto LAB_1010_0404;
    ...
    if (param_2 == 0x0) {
        if (iVar2.field_0x18 != 0x0) {
            ctx.DAT_1050_0e28 = iVar2.field_0x12;
...
pub fn pass1_1010_043a(param_1: u32, param_2: i32, param_3: i16, param_4: u16) {
    let puVar1: u32;
    let ppcVar2: u32;
    let puVar3: &mut Struct225;
    let extraout_DX: u16;
    let uVar3: u16;
    let iVar4: &mut Struct226;
    ...
    loop {
        ...
        if ((puVar3.field_0x4 != param_3) || (puVar3.field_0x6 != param_2)) == false { break; }
    }
    return;
}
...
pub fn pass1_1010_0538(param_1: u32, char * * param_2, char * * param_3, param_4: u16, param_5: u16) {
    ...
    *param_2 = 0x0;
    ...
    iVar5 = iVar1 + 0x757;
    load_string_1010_84ac(ctx.PTR__LOOP_1050_14cc, (ctx.PTR__LOOP_1050_14cc >> 0x10), param_4);
    param_3 = iVar5;
    (param_3 + 0x2) = puVar8;
...
{
let puVar1: * mut u16; let lVar2: i32; let lVar3: i32;

ctx.PTR_LOOP_1050_0ea8 = 0x0; lVar3 = 0x4000001; lVar2 = 0x4000002; puVar1 = mixed_1010_20ba(ctx.PTR__LOOP_1050_0ed0, 0x3b, param_6, param_4, param_5); pass1_1008_dfa6(puVar1, lVar2, lVar3, param_6); if (puVar1 != 0x0) {
pass1_1030_8344(ctx.PTR__LOOP_1050_5748,
(ctx.PTR__LOOP_1050_5748 > > 0x10), 0x4000002); if ((puVar1 + 0x200) == 0x8000002) {
...
pub fn pass1_1010_09b4(param_1: u16, param_2: u16, param_3: *mut u8, char * * param_4, param_5: u32,
                       param_6: *mut u8, param_7: u16)
...
//LAB_1010_09db:
    ...
    uStack10 = 0x0;
    if (bVar2) {
        puVar8 = mixed_1010_20ba(ctx.PTR__LOOP_1050_0ed0, 0x2, param_7, param_6, unaff_DI);
        // uVar4 = (puVar8 >> 0x10);
        ...
        pass1_1030_8344(
            ctx, ctx.PTR__LOOP_1050_5748, param_5);
        uStack10 = load_string_1038_4d28(CONCAT22(param_6, uVar4));
    }
...
pub fn pass1_1010_0e6c(param_1: *mut u16, param_2: u8) -> u16
...
pub fn pass1_1010_0f24(param_1: &mut Struct79, param_2: &mut Struct79, param_3: u16, param_4: *mut u8,
                       param_5: u16)

{
    ...
    param_1.field_0x2 = 0x1010;
    puVar1 = mixed_1010_20ba(ctx.PTR__LOOP_1050_0ed0, 0x3, param_5, param_4, unaff_DI);
...
pub fn pass1_1010_11c6(param_1: u32, param_2: u16, param_3: *mut u8) {
    let piVar1: *mut i16;
    let puVar2: *mut u16;
    let ppcVar3: u32;
    let uVar4: u32;
    ...
    iStack28 = 0x0;
    pass1_1000_4906(CONCAT22(puVar13, iVar8), 0x0, 0x400);
    ...
    loop {
        ...
        loop {
            ...
            uVar10 = (iVar21 + iVar19) + (ctx.DAT_1050_0ecc * 0x6 + 0xebc) * 0x8;
...
pub fn pass1_1010_1656(param_1: i16, param_2: u16, param_3: u16, param_4: u32, param_5: u16,
                       param_6: *mut u8, param_7: i16, param_8: u16)

{
    ...
    if ((param_1 + 0x16) == 0x3) {
        puVar6 = mixed_1010_20ba(ctx.PTR__LOOP_1050_0ed0, 0x32, param_8, param_6, param_7);
        uVar1 = (param_1 + 0x32);
        uVar1 = (uVar1 + 0x42);
        // uVar5 = (uVar1 >> 0x10);
        iVar4 = uVar1;
...
pub fn pass1_1010_1788(param_1: u16, param_2: u16, param_3: u32, param_4: *mut u8, param_5: i16,
                       param_6: u16)

{
    ...
    puVar3 = mixed_1010_20ba(ctx.PTR__LOOP_1050_0ed0, 0x3, param_6, param_4, param_5);
    puVar5 = 0x1778;
...
pub fn pass1_1010_184a(param_1: *mut u32, param_2: *mut u32) {
    let iVar1: i16;
    let iVar2: i16;
...
pub fn pass1_1010_18f4(param_1: *mut u16, param_2: u8, param_3: u16) -> u16
...

{
    ...
    param_1.field_0x2 = 0x1010;
    puVar1 = mixed_1010_20ba(ctx.PTR__LOOP_1050_0ed0, 0x3, unaff_SS, in_DX, unaff_DI);
    ((param_1 + 0xb)).field_0x0 = puVar1;
    param_1[0xb].field_0x2 = (puVar1 >> 0x10);
    return CONCAT22(param_2, param_1);
}


pub fn pass1_1010_19a4(param_1: *mut u32, param_2: u16, param_3: u16) {
    let ppcVar1: u32;
    let puVar2: *mut u8;
    let extraout_DX: u16;
    let local_14: [u8; 12];
...
pub fn pass1_1010_1a06(param_1: u32, param_2: u32, param_3: i16, param_4: u16) {
    ...
    puVar8 = mixed_1010_20ba(ctx.PTR__LOOP_1050_0ed0, 0x32, param_4, puVar4, param_3);
    // uVar5 = (puVar8 >> 0x10);
...
{
let uVar1: u32; let uVar2: u8;
let uVar3: u16; let Bvar4: bool;
let uVar5: u16; let uVar6: u16;
let uVar7: u32;

// uVar5 = (param_2 >> 0x10); if (((param_2 + 0x1c) != 0x2) | | (((param_2 + 0x1e) & 0xff) != 0x0)) {
uVar7 = pass1_1028_b58e(param_2 & 0xffff | uVar5 << 0x10);
// uVar6 = (param_1 >> 0x10);
uVar1 = (param_1 + 0x6e); pass1_1010_c2d8(uVar1, (uVar1 > > 0x10), uVar7); if ((uVar7 != 0x2) | | ((uVar7 & 0xff0000) != 0x0)) {
uVar1 = (param_1 + 0x6e); uVar3 = pass1_1010_b028(uVar1, (uVar1 > > 0x10), param_2); BVar4 = pass1_1008_c6ae(ctx.PTR__LOOP_1050_06e0, uVar3, 0x5); if ((BVar4 == 0x0) & & (BVar4 = pass1_1008_c6ae(ctx.PTR__LOOP_1050_06e0, uVar3, 0x6), BVar4 == 0x0)) {
uVar2 = '\0';
}
else {
uVar2 = '\x01';
...
pub fn pass1_1010_1b04(param_1: *mut u16, param_2: u8, param_3: u16) -> u16
...
{
let unaff_DI: i16; let puVar1: * mut u16;

pass1_1010_0f24(param_1, param_2, param_3,param_5, param_4); (param_1 + 0xb) = 0x0; CONCAT22(param_2, param_1) = 0x1d04; param_1.field_0x2 = 0x1010; puVar1 = mixed_1010_20ba(ctx.PTR__LOOP_1050_0ed0, 0x3, param_4,param_5, unaff_DI); ((param_1 + 0xb)).field_0x0 = puVar1; param_1[0xb].field_0x2 = (puVar1 > > 0x10); return CONCAT22(param_2, param_1);
}



pub fn pass1_1010_1bb4(param_1: *mut u32, param_2: u16, param_3: u16) {
    let ppcVar1: u32;
    let puVar2: *mut u8;
    let extraout_DX: u16;
    let local_14: [u8; 12];
...
pub fn pass1_1010_1c16(param_1: u32, param_2: u32, param_3: i16) {
    ...
    // uVar2 = (uVar3 >> 0x10);
    pcVar1 = pass1_1010_b038((param_1 + 0x6e), uVar3, uVar2,
                             0x178a, param_3);
    str_op_1008_60e8(CONCAT22(uVar2, pcVar1), uVar2);
    return;
}
...
// uVar6 = (param_1 >> 0x10);
uVar1 = (param_1 + 0x6e); pass1_1010_c2d8(uVar1, (uVar1 > > 0x10), uVar7); if ((uVar7 != 0x2) | | ((uVar7 & 0xff0000) != 0x0)) {
uVar1 = (param_1 + 0x6e); uVar3 = pass1_1010_b028(uVar1, (uVar1 > > 0x10), param_2); BVar4 = pass1_1008_c6ae(ctx.PTR__LOOP_1050_06e0, uVar3, 0x11); if ((BVar4 == 0x0) & & (BVar4 = pass1_1008_c6ae(ctx.PTR__LOOP_1050_06e0, uVar3, 0x12), BVar4 == 0x0)) {
uVar2 = '\0';
}
else {
uVar2 = '\x01';
...
pub fn pass1_1010_1cde(param_1: *mut u16, param_2: u8, param_3: u16) -> u16
...
pub fn pass1_1010_1dda(param_1: u32) {
    pass1_1010_209e(ctx.PTR__LOOP_1050_0ed0, (param_1 + 0x8));
    return;
}
...
pub fn pass1_1010_1fbe(param_1: *mut u16, param_2: u8) -> u16
...
pub fn pass1_1010_1fea(param_1: *mut u16, param_2: u8, param_3: u16) -> u16
...

{
    ...
    pass1_1000_4906((param_1 & 0xffff | uVar1 << 0x10),
                    0x0, 0x124);
    return param_1;
}
...
pub fn pass1_1010_28e6(param_1: &mut Struct631, param_2: *mut u8, param_3: u16, param_4: *mut u8,
                       param_5: u16)

{
    ...
    paVar5 = unk_io_op_1010_830a(ctx.PTR__LOOP_1050_14cc, 0x4, param_5);
...
// TODO: refactor for loop
    ...
    //   paVar5 = unk_io_op_1010_830a(ctx.PTR__LOOP_1050_14cc,iStack6 + 0x56,param_5);
...
pub fn pass1_1010_2b50(param_1: u16, param_2: u16, param_3: *mut u16) {
...
pub fn pass1_1010_2c9c(param_1: *mut u16, param_2: u8, param_3: u16) -> u16
...
pub fn pass1_1010_2db2(param_1: *mut u16, param_2: u16) {
    let puVar1: u32;
    let uVar2: u16;
    let ppcVar3: u32;
...
pub fn pass1_1010_2ee2(param_1: *mut u32, param_2: u16, param_3: u16) {
    let uVar1: u32;
    let ppcVar2: u32;
    let iVar3: i16;
    let extraout_DX: u16;
...
pub fn pass1_1010_32f4(param_1: *mut u32, param_2: *mut u32, param_3: u16, param_4: u16) {
    let puVar1: *mut u16;
    let puVar2: u32;
    let uVar3: u32;
    let uVar4: u32;
...
pub fn pass1_1010_35a4(param_1: *mut u32, param_2: u32, param_3: *mut u8) {
    let ppcVar1: u32;
    let uVar2: u32;
    let uVar3: u16;
    let puVar4: u32;
    ...
    uVar2 = (param_1 + 0x56);
    uVar2 = (uVar2 + 0x8);
    puStack8 = (uVar2 + (param_1 + 0x5a) * 0x4);
    uStack12 = param_2;
    if (param_2 != 0x0) {
        uVar7 = 0x1000;
...
pub fn pass1_1010_36b4(param_1: *mut u16, param_2: u8) -> u16
...
pub fn pass1_1010_3770(param_1: u32, param_2: &mut String, param_3: u16) {
    let uVar1: u16;
    let iVar3: &mut Struct477;
    let uVar2: u16;

    // uVar2 = (param_1 >> 0x10);
    iVar3 = param_1;
    fn_ptr_1000_17ce(ctx, &iVar3.field_0xa, 0x1000);
...
pub fn pass1_1010_379e(param_1: *mut u16, param_2: u8, param_3: u16) -> u16
...
pub fn pass1_1010_37d4(param_1: *mut u16) -> u16
...
pub fn pass1_1010_3800(param_1: *mut u16) {
    ...
    *param_1 = 0x3b3e;
    ...
    if (iVar2.field_0x16 != 0x0) {
        fn_ptr_1000_17ce(ctx, iVar2.field_0x16, 0x1000);
    }
...
pub fn pass1_1010_3880(param_1: *mut u16) {
    let piVar1: *mut i16;
    let puVar2: u32;
    let uVar3: u16;
    let ppcVar4: u32;
...
pub fn pass1_1010_394a(param_1: u16, param_2: u16, param_3: i16, param_4: u16, param_5: *mut u8) {
    if (param_3 != 0x0) {
...
pub fn pass1_1010_398e(param_1: *mut u32, param_2: u16, param_3: u16, param_4: u32, param_5: u16) {
    let piVar1: *mut i16;
    let ppcVar2: u32;
    let uVar3: u32;
    let uVar4: u32;
...
pub fn pass1_1010_3af2(param_1: *mut u16, param_2: u8) -> u16
...
pub fn pass1_1010_3b18(param_1: *mut u16, param_2: u8) -> u16
...
pub fn pass1_1010_3bde(param_1: *mut u16, param_2: u16) {
    let puVar1: u32;
    let uVar2: u16;
    let ppcVar3: u32;
    let puVar4: *mut u16;
    let iVar4: &mut Struct479;
    let uVar5: u16;
    let puStack14: *mut u16;
...
pub fn pass1_1010_3cd0(param_1: i32) {
    ...
    if (ctx.PTR__LOOP_1050_0388 != 0x0) {
        ...
        pass1_1008_92b2(ctx.PTR__LOOP_1050_0388, (param_1 + 0x12),
...
pub fn pass1_1010_3d38(param_1: *mut u16, param_2: u8) -> u16
...

{
    ...
    param_1.field_0x2 = 0x1010;
    paVar1 = unk_io_op_1010_830a(ctx.PTR__LOOP_1050_14cc, 0x99, param_4);
...
pub fn pass1_1010_3dc8(param_1: *mut u16, param_2: u16) {
    let puVar1: u32;
    let uVar2: u16;
    let ppcVar3: u32;
    let iVar4: &mut Struct480;
    let uVar4: u16;
...
pub fn pass1_1010_3e06(param_1: *mut u16, param_2: u8) -> u16
...
pub fn pass1_1010_3e3c(param_1: &mut Struct55, param_2: u16, param_3: u16) {
    ...
    pass1_1000_4906(
        ...
        0x0, 0x40);
    paVar2 = unk_io_op_1010_830a(ctx.PTR__LOOP_1050_14cc, 0x1a1, param_3);
...
pub fn pass1_1010_3f00(param_1: *mut u16, param_2: u16) {
    let puVar1: u32;
    let uVar2: u16;
    let ppcVar3: u32;
    let piVar4: *mut i16;
...
{
    pass1_1030_8344(
        ctx, ctx.PTR__LOOP_1050_5748, (param_1 + 0x6c));
    return CONCAT22((param_2 + 0xe), (param_2 + 0xc));
}


pub fn pass1_1010_41d6(param_1: u32, param_2: u32, param_3: *mut u8, param_4: u16, param_5: u8) {
    let puVar1: *mut u16;
    let piVar2: *mut i16;
    let uVar3: u32;
    let uVar4: u16;
    ...
    puVar12 = mixed_1010_20ba(ctx.PTR__LOOP_1050_0ed0, 0x2f, param_4, param_3, unaff_DI);
    ...
    pass1_1030_8344(
        ctx, ctx.PTR__LOOP_1050_5748, iVar9.field_0x6c);
    uStack14 = CONCAT22(puVar8, uVar4);
    uStack16 = (*(uVar4 + 0x10) == 0x9);
    iStack22 = (uStack10 + 0x22);
    uVar4 = iStack22 * 0x6;
    mem_op_1000_179c(uVar4, puVar8, 0x1000);
    paStack30 = CONCAT22(puVar8, uVar4);
    puVar9 = (puVar8 | uVar4);
    if (puVar9 == 0x0) {
        uStack20 = 0x0;
    } else {
    ...
    loop {
        ...
        uVar3 = (uStack10 + 0x24);
        uVar5 = uStack24;
        pass1_1028_e0a0(ctx.PTR__LOOP_1050_65e2,
                        (uVar3 + uStack24 * 0x2) << 0x10, puVar9, param_4,
                        param_5);
        paStack34 = CONCAT22(puVar9, uVar5);
        pass1_1008_3f62(
...
pub fn pass1_1010_451a(param_1: u32, param_2: *mut u8, param_3: i16, param_4: u16) -> u32

{
    ...
    puVar3 = mixed_1010_20ba(ctx.PTR__LOOP_1050_0ed0, 0x2f, param_4, param_2, param_3);
    // uVar1 = (puVar3 >> 0x10);
...
pub fn pass1_1010_45d6(param_1: i32, param_2: u16) {
    ...
    if ((iVar6 + 0x7e) != 0x0) {
        if (ctx.PTR__LOOP_1050_0388 != 0x0) {
            ...
            param_2 = 0x1008;
            pass1_1008_92b2(ctx.PTR__LOOP_1050_0388, 0x1f4, CONCAT22(uVar5, iVar4));
        }
        // TODO: refactor for loop
...
astruct_18 *
pass1_1010_4994(param_1: u16,param_2: & mut Struct18,param_3: u8,param_4: u16)
...
pub fn pass1_1010_4a20(param_1: *mut u16, param_2: u8, param_3: u16) -> u16
...
pub fn pass1_1010_4a8a(param_1: &mut Struct637, param_2: &mut Struct19, param_3: u16, param_4: u16) {
    ...
    param_1.field_0x2 = 0x1010;
    paVar2 = unk_io_op_1010_830a(ctx.PTR__LOOP_1050_14cc, 0x1b3, param_4);
    // puVar1 = (paVar2 >> 0x10);
    &param_1.field_0x16 = paVar2;
    (&param_1.field_0x16 + 0x2) = puVar1;
    puVar3 = mixed_1010_20ba(ctx.PTR__LOOP_1050_0ed0, 0x3, param_4, puVar1, unaff_DI);
...
pub fn pass1_1010_4c3e(param_1: u32, param_2: i16, param_3: i16, param_4: *mut u8, param_5: u16) {
    let piVar1: *mut i16;
    let uVar2: u32;
    let iVar3: i16;
    let iVar4: i16;
    ...
    if ((param_4 | (iVar3 + 0x12)) != 0x0) {
        if (param_2 == 0x0) {
            ...
            if ((iVar4 == 0x5) || (iVar4 == 0x6)) {
                ...
                paVar7 = unk_io_op_1010_830a(ctx.PTR__LOOP_1050_14cc, 0x1bf, param_5);
                uVar2 = (iVar3 + 0x12);
                // uVar6 = (uVar2 >> 0x10);
                iVar4 = uVar2;
                (iVar4 + 0x4) = paVar7;
        ...
        loop {
            ...
            uVar2 = (iVar3 + 0x12);
            uVar8 = pass1_1008_4772((uVar2 + iStack14 * 0x4));
...
pub fn pass1_1010_4f30(param_1: u16, param_2: u16, param_3: *mut u16, param_4: *mut u16) {
    *param_4 = 0xa;
    *param_3 = 0x73;
    return;
}
...
pub fn pass1_1010_4f48(param_1: u32, param_2: u16) {
    ...
    paVar8 = unk_io_op_1010_830a(ctx.PTR__LOOP_1050_14cc, 0x1b3, param_2);
...
pub fn pass1_1010_5004(param_1: *mut u16, param_2: u8, param_3: u16) -> u16
...
pub fn pass1_1010_503e(param_1: &mut Struct19, param_2: &mut Struct19, param_3: u16, param_4: *mut u8, param_5: u16) {
    struct_op_1018_4cda(param_1, param_2, param_3);
...
pub fn pass1_1010_519a(param_1: u32, param_2: &mut i16, param_3: *mut u8, param_4: u16) {
    let uVar1: u32;
    let uVar2: u16;
    let puVar3: *mut u8;
    let puVar4: *mut u8;
...
pub fn pass1_1010_52fc(param_1: u32, param_2: u32, param_3: u16, param_4: *mut u8, param_5: u16) {
    let uVar1: u16;
...
pub fn pass1_1010_531c(param_1: u32, param_2: u32, param_3: u16, param_4: *mut u8, param_5: u16) {
    let uVar1: u16;
...
pub fn pass1_1010_533c(param_1: u32, param_2: u32, param_3: *mut u8, param_4: u16) {
    ...
    loop {
        ...
        paVar7 = string_1010_5286(uVar5, uVar6, uVar2, uVar2, param_3);
        // param_3 = (paVar7 >> 0x10);
...
pub fn pass1_1010_53ce(param_1: *mut u16, param_2: u8, param_3: u16) -> u16
...
pub fn pass1_1010_5d9c(param_1: u32, param_2: i16, param_3: *mut u8, param_4: i16, param_5: u16) {
    let puVar1: *mut u16;

    (param_1 + 0x1e) = param_2;
    if (param_2 == 0x0) {
        puVar1 = mixed_1010_20ba(ctx.PTR__LOOP_1050_0ed0, 0x2e, param_5, param_3, param_4);
    ...
    if (BVar1 != 0x0) {
        ...
        if (BVar1 != 0x0) {
            ...
            if (BVar1 != 0x0) {
                ...
                // uVar4 = (param_2 >> 0x10);
                BVar1 = write_to_file_1008_7e1c(param_2, uVar4, local_c, param_3, 0x2,
                                                0x1008);
                if (BVar1 != 0x0) {
                    local_6[0] = (iVar2 + 0x82);
                    BVar1 = write_to_file_1008_7e1c(param_2, uVar4, local_6, param_3, 0x2,
                                                    0x1008);
                    if (BVar1 != 0x0) {
                        return 0x1;
                    }
...
pub fn pass1_1010_5f4c(param_1: u32, param_2: &mut String, param_3: u16) {
    let uVar1: u16;
    let iVar3: &mut Struct484;
    let uVar2: u16;

    // uVar2 = (param_1 >> 0x10);
    iVar3 = param_1;
    fn_ptr_1000_17ce(ctx, &iVar3.field_0x12, 0x1000);
    uVar1 = str_op_1008_60e8(param_2, param_3);
...
pub fn pass1_1010_5fb0(param_1: u32, param_2: u16, param_3: *mut u32, param_4: u16, param_5: i16) {
    let uVar1: u16;
    let iVar1: &mut Struct656;
...
pub fn pass1_1010_5fd8(param_1: u32, param_2: &mut String, param_3: u16) {
    let uVar1: u16;
    let iVar3: &mut Struct485;
    let uVar2: u16;

    // uVar2 = (param_1 >> 0x10);
    iVar3 = param_1;
    fn_ptr_1000_17ce(ctx, &iVar3.field_0x68, 0x1000);
    uVar1 = str_op_1008_60e8(param_2, param_3);
...
pub fn pass1_1010_6006(param_1: u32, param_2: &mut String, param_3: u16) {
    let uVar1: u16;
    let iVar3: &mut Struct486;
    let uVar2: u16;

    // uVar2 = (param_1 >> 0x10);
    iVar3 = param_1;
    fn_ptr_1000_17ce(ctx, &iVar3.field_0x6c, 0x1000);
    uVar1 = str_op_1008_60e8(param_2, param_3);
...
pub fn pass1_1010_6034(param_1: u32, param_2: u16) {
    ...
    puVar1 = pass1_1000_4906((param_1 & 0xffff0000 | (iVar2 + 0x22)),
                             0x0, 0x40);
    load_string_1010_84ac(ctx.PTR__LOOP_1050_14cc, (ctx.PTR__LOOP_1050_14cc >> 0x10), 0x1000);
    (iVar2 + 0x68) = puVar1;
    (iVar2 + 0x6a) = param_2;
    load_string_1010_84ac(ctx.PTR__LOOP_1050_14cc, (ctx.PTR__LOOP_1050_14cc >> 0x10), 0x1000);
    (iVar2 + 0x6c) = puVar1;
...
pub fn pass1_1010_60cc(param_1: u32, param_2: &mut String, param_3: u16) {
    let uVar1: u16;
    let iVar3: &mut Struct487;
    let uVar2: u16;

    // uVar2 = (param_1 >> 0x10);
    iVar3 = param_1;
    fn_ptr_1000_17ce(ctx, &iVar3.field_0x1a, 0x1000);
    uVar1 = str_op_1008_60e8(param_2, param_3);
...
pub fn pass1_1010_62a4(param_1: *mut u16, param_2: u8) {
    ...
    *param_1 = 0x6322;
    ...
    fn_ptr_1000_17ce(ctx, uVar2.field_0x4, 0x1000);
    *param_1 = 0x389a;
...
pub fn pass1_1010_62ec(param_1: *mut u16, param_2: u8) -> u16
...
uVar1 = param_1;
// uVar2 = (param_1 >> 0x10);
switch_1010_6646(uVar1, uVar2, CONCAT22(param_3, &local_4), param_2); if (local_4 == 0x0) {
return 0x0;
}
...
pub fn pass1_1010_66ca(param_1: *mut u16, param_2: u8, param_3: u16) -> u16
...
pub fn pass1_1010_68c6(param_1: u32, param_2: u32, param_3: u16, param_4: *mut u8, param_5: u16) {
    let iVar2: &mut Struct248;
    let BVar1: bool;
    let iVar3: i16;
    let uVar4: u16;
    let uVar5: u16;
    ...
    if (ctx.PTR_LOOP_1050_0312 < 0x2) {
        ...
        paStack18 = CONCAT22(param_4, uVar4);
...
pub fn pass1_1010_6a86(param_1: *mut u16, param_2: u8, param_3: u16) -> u16
...
pub fn pass1_1010_6abc(param_1: &mut Struct635, param_2: &mut Struct19, param_3: u16) {
    ...
    puVar3 = mixed_1010_20ba(ctx.PTR__LOOP_1050_0ed0, 0x3, unaff_SS,
                             (paVar2 >> 0x10), unaff_DI);
    &param_1.field_0x14 = puVar3;
    (&param_1.field_0x14 + 0x2) = (puVar3 >> 0x10);
    ppcVar1 = (*param_1.field_0x14 + 0x4);
    (**ppcVar1)();
    puVar3 = mixed_1010_20ba(ctx.PTR__LOOP_1050_0ed0, 0x2f, unaff_SS, extraout_DX, unaff_DI);
...
pub fn pass1_1010_6bb2(param_1: *mut u16, param_2: u16) {
    let puVar1: u32;
    let ppcVar2: u32;
    let uVar3: u16;
    let iVar4: i16;
...
if (false) {
code_r0x1010703e: return 0x0;
}
switch(param_3) {
0x1 => pass1_1010_715c(param_2, 0x1, param_6,param_5, param_7, param_4); send_msg_1010_7c9e(param_2, 0x12, param_4); return 0x1; default:
//     TODO: goto code_r0x1010703e;
0x4 => uVar1 = 0x2; break; 0x5 => uVar1 = 0x3; break; 0x6 => uVar1 = 0x4; break; 0x7 => uVar1 = 0x5; break; 0x9 => pass1_1010_715c(param_2, 0x6, param_6, param_5, param_7, param_4);
0x2e => uVar1 = 0x38; break; 0xa =>
0x80 => uVar1 = 0x2d; break; 0xb =>
uVar1 = 0x7; break; 0xc => 0x17 =>
0x18 => 0x19 => 0x21 => 0x75 => 0x81 =>
if (param_3 == 0x75) {
pass1_1010_715c(param_2, 0x8, param_6, param_5,param_7, param_4); pass1_1010_715c(param_2, 0x9, param_6, param_5, param_7, param_4);
}
uVar1 = pass1_1010_6ca2(param_2, 0x7, param_5,param_4); if (uVar1 != 0x0) {
...
break; 0x12 => uVar1 = 0xe; break;
0x1b => 0x1f => 0x5b => 0x78 => 0x7e =>
...
uVar1 = 0x37; break; 0x1d => 0x2a =>
0x2c => 0x3c => 0x3d => 0x4b => 0x53 =>
0x54 => 0x55 => 0x5a => uVar1 = pass1_1010_6ca2(param_2, 0x2, param_5, param_4); if (uVar1 != 0x0) {
pass1_1010_715c(param_2, 0x12, uVar1, param_5,param_7, param_4);
}
uVar1 = pass1_1010_6ca2(param_2, 0x8, param_5,param_4); if (uVar1 != 0x0) {
...
uVar1 = 0x1c; break; 0x22 => uVar1 = 0x15; break; 0x25 => uVar1 = 0x16;
break; 0x26 => pass1_1010_715c(param_2, 0x17,param_6, param_5, param_7, param_4); 0x1e => uVar1 = 0x13; break; 0x27 => uVar1 = 0x18; break; 0x29 => uVar1 = 0x19; break; 0x2b => uVar1 = 0x1b; break; 0x2f => 0x36 => param_6 = pass1_1010_6ca2(param_2, 0x2, param_5, param_4); if (param_6 == 0x0) {
return 0x0;
}
uVar1 = 0x1e; break; 0x30 => uVar1 = 0x1f; break; 0x31 => uVar1 = 0x35;
break; 0x33 => uVar1 = 0x21; break;
0x34 => uVar1 = 0x22; break; 0x35 =>
pass1_1010_715c(param_2, 0x23, param_6, param_5,param_7, param_4); 0x65 => 0x66 => 0x6b => 0x6c => 0x6d => 0x6e => 0x6f => uVar1 = 0x34; break; 0x38 => pass1_1010_715c(param_2, 0x24, param_6, param_5, param_7, param_4); uVar1 = 0x3d; break; 0x39 =>
uVar1 = 0x25; break; 0x3e => pass1_1010_715c(param_2, 0x26, param_6, param_5, param_7,param_4); pass1_1010_715c(param_2, 0x28, param_6, param_5, param_7, param_4); uVar1 = 0x27; break; 0x40 => uVar1 = 0x2a;
break; 0x41 => uVar1 = 0x39; break;
0x42 => uVar1 = 0x3a; break; 0x44 =>
uVar1 = 0x36; break; 0x45 => uVar1 = 0x3b; break; 0x49 => uVar1 = 0x29;
break; 0x50 => uVar1 = 0x2b; break;
0x56 => pass1_1010_715c(param_2, 0x3c, param_6,param_5, param_7, param_4); uVar1 = 0x3e; break; 0x5d => pass1_1010_715c(param_2, 0x2f, param_6, param_5, param_7, param_4);
uVar1 = 0x40; break; 0x5e => 0x60 =>
uVar1 = 0x2f; break; 0x5f => pass1_1010_715c(param_2, 0x34, param_6, param_5, param_7,param_4); uVar1 = 0x41; break; 0x61 => uVar1 = 0x30; break; 0x63 => uVar1 = 0x31; break; 0x64 => uVar1 = 0x24; break; 0x68 => uVar1 = 0x32; break; 0x69 => uVar1 = 0x33; break; 0x76 => uVar1 = 0xa; code_r0x10106d4c: pass1_1010_715c(param_2, uVar1, param_6, param_5, param_7, param_4); uVar1 = 0xb;
}
pass1_1010_715c(param_2, uVar1, param_6, param_5,param_7, param_4); return 0x1;
}
...
pub fn pass1_1010_71d6(param_1: u32, param_2: i16, param_3: *mut u16, param_4: u16, param_5: u16,
                       param_6: u16)
...

{
    ...
    BVar3 = pass1_1008_c6ae(ctx.PTR__LOOP_1050_06e0, uVar2, 0x1e);
    if (BVar3 == 0x0) {
        BVar3 = pass1_1008_c6ae(ctx.PTR__LOOP_1050_06e0, uVar2, 0xb);
        if (((BVar3 == 0x0) && (BVar3 = pass1_1008_c6ae(ctx.PTR__LOOP_1050_06e0, uVar2, 0x20), BVar3 == 0x0)) && (BVar3 = pass1_1008_c6ae(ctx.PTR__LOOP_1050_06e0, uVar2, 0x1c), BVar3 == 0x0)) {
            BVar3 = pass1_1008_c6ae(ctx.PTR__LOOP_1050_06e0, uVar2, 0x2);
            if ((BVar3 != 0x0) || (BVar3 = pass1_1008_c6ae(ctx.PTR__LOOP_1050_06e0, uVar2, 0x13), BVar3 != 0x0)) {
                return 0x5;
            }
            BVar3 = pass1_1008_c6ae(ctx.PTR__LOOP_1050_06e0, uVar2, 0x11);
            if ((BVar3 != 0x0) || (BVar3 = pass1_1008_c6ae(ctx.PTR__LOOP_1050_06e0, uVar2, 0x12), BVar3 != 0x0)) {
                return 0x4;
            }
            BVar3 = pass1_1008_c6ae(ctx.PTR__LOOP_1050_06e0, uVar2, 0x5);
            if (BVar3 != 0x0) {
                return 0x6;
            }
            BVar3 = pass1_1008_c6ae(ctx.PTR__LOOP_1050_06e0, uVar2, 0x6);
            if (BVar3 != 0x0) {
                return 0x7;
            }
            BVar3 = pass1_1008_c6ae(ctx.PTR__LOOP_1050_06e0, uVar2, 0x4);
            if (BVar3 != 0x0) {
                return 0x10;
            }
            BVar3 = pass1_1008_c6ae(ctx.PTR__LOOP_1050_06e0, uVar2, 0x3);
            if (BVar3 != 0x0) {
                return 0x11;
            }
            BVar3 = pass1_1008_c6ae(ctx.PTR__LOOP_1050_06e0, uVar2, 0x19);
            if (BVar3 != 0x0) {
                return 0x15;
            }
            BVar3 = pass1_1008_c6ae(ctx.PTR__LOOP_1050_06e0, uVar2, 0x1d);
            if (BVar3 != 0x0) {
                return 0x16;
            }
...
pub fn pass1_1010_7b8c(param_1: u32, param_2: i16, param_3: u16) {
    ...
    if (((iVar6 + 0x1e) | (iVar6 + 0x1c)) != 0x0) {
        ...
        loop {
            ...
            if ((extraout_DX | puVar5) == 0x0) { break; }
            uVar4 = (puVar5 + 0x8);
            if ((uVar4 + 0x6) != param_2) == false { break; }
        }
...

{
    ...
    if (param_3 != 0x3) {
        ...
        BVar1 = pass1_1008_c6ae(ctx.PTR__LOOP_1050_06e0, param_4, 0x3c);
        if (BVar1 != 0x0) {
            return 0x0;
        }
...
pub fn pass1_1010_7dd2(param_1: *mut u16, param_2: u8) -> u16
...
pub fn pass1_1010_7e40(param_1: *mut u32, param_2: *mut u8, param_3: i16, param_4: u16) {
    let uVar1: u32;
    let puVar2: &mut Struct652;
    let uVar2: u16;
    let puVar3: *mut u16;
    ...
    *&puVar2.field_0xa82 = 0x0;
    ...
    puVar3 = mixed_1010_20ba(ctx.PTR__LOOP_1050_0ed0, 0x2, param_4, param_2, param_3);
...
pub fn pass1_1010_7efc(param_1: *mut u32, param_2: u16) {
    let uVar1: u16;
    let uVar2: u16;
    let puVar3: u32;
    let ppcVar4: u32;
...
pub fn pass1_1010_8018(param_1: u32, param_2: u16, param_3: *mut u8, param_4: u16) {
    let iVar1: i16;
    let uVar2: *mut u16;
...
pub fn pass1_1010_8170(astruct_87 * * param_1, param_2: i16, param_3: *mut u8, param_4: u16) {
    let uVar1: u16;
    let iVar2: i16;
    let iVar3: i16;
    let uVar4: u16;
...
pub fn pass1_1010_81f6(param_1: HINSTANCE16, param_2: u16, astruct_87 * * param_3, param_4: i32,
                       param_5: i16)
...
pub fn pass1_1010_887a(astruct_87 * * param_1, param_2: u32, param_3: i16, param_4: u16,
                       param_5: u16)

{
    ...
    if ((param_1 + 0x67c) != 0x0) {
        ...
        if ((puVar4 | uVar1) == 0x0) {
            ...
            struct_op_1008_6604(CONCAT22(puVar4, uVar1), uStack24,
                                (uStack24 >> 0x10));
            uVar7 = extraout_DX;
        }
...

{
    ...
    if ((uVar1 | uVar3) != 0x0) {
        ...
        param_5 = 0x1000;
        fn_ptr_1000_17ce(ctx, CONCAT22(uVar1, uVar3), 0x1000);
    }
...

{
    ...
    param_1.field_0x2 = 0x1010;
    puVar2 = mixed_1010_20ba(ctx.PTR__LOOP_1050_0ed0, 0x3, param_4,
...
pub fn pass1_1010_8c78(param_1: *mut u16, param_2: u16) {
    *param_1 = 0x8ee2;
    (param_1 + 0x2) = 0x1010;
    pass1_1010_1d80(param_1, param_2);
    return;
...
pub fn pass1_1010_8ef2(param_1: *mut u16, param_2: *mut u8, param_3: u16) {
    let uVar1: u16;
    let puVar2: *mut u8;
    let extraout_DX: *mut u8;
    let iVar3: &mut Struct170;
    let unaff_DI: i16;
    let uVar3: u16;
    let puVar4: *mut u16;
    ...
    *param_1 = 0x9254;
    ...
    puVar4 = mixed_1010_20ba(ctx.PTR__LOOP_1050_0ed0, 0x3, param_3, puVar2, unaff_DI);
...
pub fn pass1_1010_8f78(param_1: *mut u16) {
    let puVar1: u32;
    let uVar2: u16;
    let ppcVar3: u32;
    let iVar4: &mut Struct490;
    let uVar4: u16;
...
pub fn pass1_1010_9130(param_1: u32, param_2: *mut u8, param_3: u16, param_4: u16, param_5: u16,
                       param_6: u8)
...
pub fn pass1_1010_922e(param_1: *mut u16, param_2: u8) -> u16
...
pub fn pass1_1010_9258(param_1: *mut u16) -> u16
...
u32
pass1_1010_9298(param_1: & mut Struct79,param_2: & mut Struct79,param_3: u16,param_4: u16,
...
pub fn pass1_1010_92e6(param_1: *mut u16, param_2: u16) {
    *param_1 = 0x9566;
    (param_1 + 0x2) = 0x1010;
    pass1_1010_2db2(param_1, param_2);
    return;
...
pub fn pass1_1010_9304(param_1: u16, param_2: u16, param_3: i16, param_4: u16, param_5: *mut u8) {
    if (param_3 != 0x0) {
        mem_op_1000_179c(param_3 << 0x2, param_5, 0x1000);
        return;
    }
...
pub fn pass1_1010_9372(param_1: *mut u32, param_2: u16, param_3: i16, param_4: i16, param_5: i16) {
    let ppcVar1: u32;
    let cVar2: u8;
    let uVar3: u16;
    let uVar4: u16;
    ...
    if (0x0 < param_4) {
        if (ctx.PTR__LOOP_1050_3528 == 0x0) {
            ppcVar1 = (*param_1 + 0x18);
            uVar6 = (**ppcVar1)();
            ctx._PTR_LOOP_1050_3528 = mixed_1010_20ba(ctx.PTR__LOOP_1050_0ed0, uVar6, unaff_SS,
                                                      (uVar6 >> 0x10), unaff_DI);
        }
        uVar6 = (param_1 + 0xc);
        uVar7 = pass1_1010_2e02(ctx.PTR__LOOP_1050_3528, (uVar6 + 0x12));
        uVar3 = param_2 + 0x1;
        ...
        // }
        pass1_1010_2e30(ctx.PTR__LOOP_1050_3528, uVar3 | uVar7,
...
{
let uVar1: u16; let uVar2: u16;
let uVar3: u16; let puVar4: * mut u16; let uVar5: u16; let uStack10: u16;

uVar5 = (param_3 + 0x12);
puVar4 = mixed_1010_20ba(ctx.PTR__LOOP_1050_0ed0, 0x3,param_6, param_4, param_5);
// uVar2 = (puVar4 >> 0x10);
uVar1 = uVar5 - 0x32; uStack10 = puVar4; uVar3 = uVar2; if (uVar1 == 0x0) {
pass1_1010_a5ca(uStack10, uVar2, 0x32, 0x0,uVar2); if (uVar1 != 0x0) {
return false;
}
uVar5 = 0x4d;
}
else {
uVar1 = uVar5 - 0x3f; if (uVar1 == 0x0) {
pass1_1010_a5ca(uStack10, uVar2, 0x3f, 0x0,uVar2); if (uVar1 != 0x0) {
return false;
}
uVar5 = 0x4e;
}
}
pass1_1010_a5ca(uStack10, uVar2, uVar5, uVar1,uVar3); return uVar1 == 0x0;
}
...
pub fn pass1_1010_951a(param_1: *mut u16, param_2: u8) -> u16
...
pub fn pass1_1010_9540(param_1: *mut u16, param_2: u8, param_3: u16) -> u16
...
pub fn pass1_1010_95f8(param_1: *mut u16, param_2: u16) {
    let puVar1: u32;
    let uVar2: u16;
    let ppcVar3: u32;
    let iVar4: &mut Struct491;
    let uVar4: u16;
...
{
let piVar1: * mut i16; let iVar2: i16; let iVar3: & mut Struct690; let uVar3: u16; let uVar4: u32; let iStack8: i16;

// uVar3 = (param_1 >> 0x10);
iVar3 = param_1; if (iVar3.field_0x1a != 0x0) {
if (0x0 < iVar3.field_0x1c) {
piVar1 = & iVar3.field_0x1c; * piVar1 = * piVar1 + - 0x1;
}
if ((iVar3.field_0x1c == 0x0) && (iVar3.field_0x1e != 0x0)) {
iStack8 = 0x1; uVar4 = pass1_1030_8326();
// iVar2 = (uVar4 >> 0x10); if ((iVar2 != 0x0) | | (0x32 < uVar4)) {
iStack8 = 0x5;
}
...
piVar1 = & iVar3.field_0x1e; * piVar1 = * piVar1 - iStack8; if ( * piVar1 < 0x0) {
...
pub fn pass1_1010_988c(param_1: u32, param_2: i16) {
    ...
    loop {
        ...
        if ((iVar3 + 0x4) != param_2) == false { break; }
    }
    iVar4 = (iVar3 + 0x6) + -0x1;
    (iVar3 + 0x6) = iVar4;
    if ((iVar4 < 0x1) && (ppcVar1 = ((iVar6 + 0xe) + 0xc),
...
pub fn pass1_1010_9fee(param_1: u32, param_2: u16, param_3: u16, param_4: u16, param_5: *mut u8) {
    let ppcVar1: u32;
    let puVar2: *mut u8;
    let extraout_DX: *mut u8;
    let iVar3: &mut Struct252;
    let iVar4: &mut Struct253;
    let uVar3: u16;
    let uVar4: u16;
    let uVar5: u16;
    let puStack10: *mut u16;
...
pub fn pass1_1010_a0a0(param_1: u32, param_2: *mut u8, param_3: i16, param_4: u16) {
    let piVar1: *mut i16;
    let iVar2: i16;
    let iVar3: i16;
    let iVar4: i16;
    ...
    iStack12 = 0x4;
    mixed_1010_20ba(ctx.PTR__LOOP_1050_0ed0, 0x2, param_4, param_2, param_3);
...
pub fn pass1_1010_a172(param_1: *mut u16, param_2: u8, param_3: u16) -> u16
...
pub fn pass1_1010_a198(param_1: *mut u16, param_2: u8) -> u16
...
pub fn pass1_1010_a478(param_1: *mut u16, param_2: u16) {
    let puVar1: *mut u16;
    let uVar2: u16;
    let uVar3: &mut Struct497;
    let uVar4: u16;
    let puStack6: *mut u16;
...
pub fn pass1_1010_a50c(param_1: &mut Struct20, param_2: u32, param_3: u32) {
    let iVar1: i16;
    let iVar2: &mut Struct260;
    let local_8: u32;
    let iStack4: i16;

    iVar1 = param_1;
    pass1_1000_4906((param_1 & 0xffff0000 | (iVar1 + 0xa4)),
                    0x0, 0x94);
...
pub fn pass1_1010_a69c(param_1: u32, param_2: u16, param_3: i16, param_4: *mut u8, param_5: i16,
                       param_6: u16)
...
//     TODO: goto switchD_1010_aaef_caseD_b;
    ...
    puVar7 = mixed_1010_20ba(ctx.PTR__LOOP_1050_0ed0, 0x35, param_6, puVar3, param_5);
    // puVar3 = (puVar7 >> 0x10);
    if (false) {
        // goto
...
//     TODO: goto LAB_1010_a96c;
        0x1c => iVar1 = 0x11;
//     TODO: goto LAB_1010_a96c;
        0x1d => 0x24 => pass1_1010_abd2(uVar2, uVar8, 0x1e, puVar3, param_5, param_6);
        iVar1 = 0x5b;
//     TODO: goto LAB_1010_a91f;
        0x1e => uVar2 = 0x1;
        iVar1 = 0x2;
        puVar7 = mixed_1010_20ba(ctx.PTR__LOOP_1050_0ed0, 0x2b, param_6, puVar3, param_5);
        // puVar3 = (puVar7 >> 0x10);
        pass1_1010_08c0(puVar7, uVar2, iVar1, param_6);
        paVar5 = mixed_1010_20ba(ctx.PTR__LOOP_1050_0ed0, 0x40, param_6, puVar3, param_5);
        // puVar3 = (paVar5 >> 0x10);
...
//     TODO: goto LAB_1010_aabe;
        0x23 => iVar1 = 0xc;
//     TODO: goto LAB_1010_aabe;
        0x25 => pass1_1010_abd2(uVar2, uVar8, 0x14, puVar3, param_5, param_6);
...
//     TODO: goto LAB_1010_a96c;
        0x30 => iVar1 = 0x54;
        break;
        0x33 => pass1_1010_abd2(uVar2, uVar8, 0x31, puVar3, param_5, param_6);
        iVar1 = 0x6c;
//     TODO: goto LAB_1010_a91f;
        0x36 => iVar1 = 0x13;
//     TODO: goto LAB_1010_aabe;
...
//     TODO: goto switchD_1010_aaef_caseD_b;
        0x3c => pass1_1010_abd2(uVar2, uVar8, 0x14, puVar3, param_5, param_6);
        iVar1 = 0x62;
//     TODO: goto LAB_1010_a91f;
...
//     TODO: goto switchD_1010_aaef_caseD_b;
    ...
    pass1_1010_abd2(uVar2, uVar8, iVar1, puVar3, param_5, param_6);
    switchD_1010_aaef_caseD_b: paVar6 = mixed_1010_20ba(ctx.PTR__LOOP_1050_0ed0, 0x37, param_6, puVar3, param_5);
    // puVar3 = (paVar6 >> 0x10);
...
pub fn pass1_1010_abd2(param_1: u16, param_2: u16, param_3: i16, param_4: *mut u8, param_5: i16,
                       param_6: u16)

{
    ...
    puStack6 = mixed_1010_20ba(ctx.PTR__LOOP_1050_0ed0, 0x35, param_6, param_4, param_5);
    uVar2 = puStack6 + 0xa;
...
pub fn pass1_1010_ad22(param_1: u16, param_2: u16, param_3: u16, param_4: u16, param_5: u16) {
    ...
    pass1_1030_627e(param_3, puVar2, param_2, _PTR_LOOP_1050_5740,
                    CONCAT22(param_3, puVar2), (uVar1 + 0x20));
    if ((param_2 | puVar2) == 0x0) {
        return;
    }
    uStack8 = param_2;
    pass1_1028_e1ec(ctx.PTR__LOOP_1050_65e2, puVar2, param_2);
    return;
}
        ...
        if (param_3 < 0x16) {
            if (param_3 == '\x06') {
                ...
                if (((uVar1 == 0xe) && ((puVar2 != 0x0 || (0x32 < uVar3)))) && ((param_2 == 0x1 || (((param_2 == 0x2 || (param_2 == 0x4)) || (param_2 == 0x3)))))) {
                    ...
                    iVar7 = 0x0;
                    uVar5 = 0x0;
                    paVar4 = mixed_1010_20ba(ctx.PTR__LOOP_1050_0ed0, 0x37, param_6, puVar2, param_5);
                    post_win_msg_1008_a0e4(paVar4, CONCAT22(uVar6, uVar5), iVar7, CONCAT11(uVar9, uVar8),
...
pub fn pass1_1010_afde(param_1: u32, param_2: i16) {
    ...
    puVar3 = pass1_1008_c6fa(ctx.PTR__LOOP_1050_06e0, param_2);
...
pub fn pass1_1010_b028(param_1: u16, param_2: u16, param_3: u32) -> u16
...
pub fn pass1_1010_bf1e(param_1: u32, param_2: &mut i16, param_3: i16, param_4: *mut u8, param_5: u16) {
    let uVar1: u32;
    let uVar2: u16;
    let puVar3: *mut u8;
    let iVar4: i16;
...
pub fn pass1_1010_bffa(param_1: u32, param_2: i16, param_3: *mut u8, param_4: u16) {
    let puVar1: *mut u16;
    let uVar2: u32;
    let uVar3: u16;
    let uVar4: u16;
    let puVar5: &mut Struct257;
    let iVar6: &mut Struct254;
    let iVar7: &mut Struct255;
    let iVar8: &mut Struct256;
    let iVar5: i16;
    let uVar6: u16;
    let uVar7: u16;
    let paVar8: &mut Struct43;
    ...
    if ((param_3 | local_18._18_4_) == 0x0) {
        ...
        if ((param_3 | iVar8.field_0x4) != 0x0) {
            paVar8 = unk_io_op_1010_830a(ctx.PTR__LOOP_1050_14cc, 0x1b4, param_4);
            // uVar3 = (paVar8 >> 0x10);
            ...
            *puVar1 = paVar8;
            ...
            loop {
                ...
                paVar8 = unk_io_op_1010_830a(ctx.PTR__LOOP_1050_14cc, uStack34, param_4);
                // uVar3 = (paVar8 >> 0x10);
...
pub fn pass1_1010_c234(param_1: u16, param_2: *mut u8, param_3: i16, param_4: u16) -> *mut u8
...
pub fn pass1_1010_c25e(param_1: u16, param_2: u16, param_3: &mut String, param_4: u16, param_5: *mut u8,
...
pub fn pass1_1010_c28a(param_1: *mut u8, param_2: i16, param_3: u16) {
    let uVar1: u16;
    let uVar2: u16;
    let uVar3: u16;
    let uVar4: u16;
    ...
    puVar5 = mixed_1010_20ba(ctx.PTR__LOOP_1050_0ed0, 0x2f, param_3, param_1, param_2);
    // uVar2 = (puVar5 >> 0x10);
    uVar1 = (puVar5 + 0x24);
    uVar4 = (puVar5 + 0x26);
    uVar3 = uVar4 | uVar1;
    if (uVar3 != 0x0) {
        pass1_1028_e1ec(ctx.PTR__LOOP_1050_65e2, uVar1, uVar4);
        if ((uVar4 | uVar3) != 0x0) {
            return;
        }
    }
...
pub fn pass1_1010_c2d8(param_1: u16, param_2: u16, param_3: i32) {
    let uVar1: u16;
    let uStack6: u16;

    if ((param_3 != 0x0) && (uVar1 = (param_3 >> 0x10),
...
{
    return CONCAT22((ctx.PTR__LOOP_1050_65e2 + 0x2), *_PTR_LOOP_1050_65e2);
}


// WARNING: Globals starting with '_' overlap smaller symbols at the same address

pub fn pass1_1010_c320(param_1: u16, param_2: u16, param_3: *mut u8, param_4: u32, param_5: *mut u8) {
    let uVar1: u32;
    let puStack6: *mut u8;
    ...
    load_string_1010_84e0(0x1010, _PTR_LOOP_1050_14cc,
                          (ctx.PTR__LOOP_1050_14cc >> 0x10), 0x3ff, puStack6,
                          (short)(puStack6 >> 0x10));
    return;
}


pub fn pass1_1010_c3c2(param_1: u16, param_2: u16, param_3: u32, param_4: u32, param_5: *mut u8,
...
pub fn pass1_1010_c58as(param_1: u16, param_2: u16, param_3: u16, param_4: u32, param_5: u16, param_6: u16)

{
    ...
    if (true) {
        switch(param_3)
        {
            0x5 => ppuStack14 = (u8 * *) & USHORT_1050_352c;
            uStack18 = 0xfa4;
            iStack16 = 0x30;
            break;
            default:
//       TODO: goto switchD_1010_c717_caseD_6;
            0xa => ppuStack14 = (u8 * *) & USHORT_1050_358c;
            uStack18 = 0xfb3;
            iStack16 = 0x51;
            break;
            0xb => ppuStack14 = (u8 * *) & USHORT_1050_358c;
            uStack18 = 0xfb4;
            iStack16 = 0x51;
            break;
            0xc => ppuStack14 = (u8 * *) & USHORT_1050_362e;
            uStack18 = 0xfb6;
            iStack16 = 0x30;
            break;
            0x10 => ppuStack14 = &ctx.PTR_DAT_1050_1805_1050_368e;
            uStack18 = 0xfc4;
            iStack16 = 0x3c;
            break;
            0x11 => ppuStack14 = &ctx.PTR_DAT_1050_1805_1050_3706;
            uStack18 = 0xfc1;
            iStack16 = 0x4b;
            break;
            0x12 => ppuStack14 = (u8 * *) & USHORT_1050_379c;
            uStack18 = 0xfc5;
            iStack16 = 0x8;
            break;
            0x13 => puVar5 = puVar4;
            ...
            iStack16 = 0x1;
            break;
            0x15 => (uVar1 + 0x6) = param_4;
            (uVar1 + 0xa) = param_3;
            break;
            0x16 => ppuStack14 = (u8 * *) & USHORT_1050_37ae;
            uStack18 = 0x157;
            iStack16 = 0x4;
            break;
            0x17 => ppuStack14 = (u8 * *) & USHORT_1050_37b6;
            iStack16 = 0x2c;
            uStack18 = 0xfd8;
        }
        if (ppuStack14 != (u8 * *)
        0x0) {
            *piStack6 = iStack16;
            ...
            if ((puVar5 | uVar2) == 0x0) {
                ...
                *piStack26 = iStack16;
                pass1_1000_5586(0xa564, &ctx.PTR_LOOP_1050_1040, iStack16, 0xa,
                                uVar2 + 0x2, puVar5);
                (uVar1 + 0x2) = uVar2 + 0x2;
                (uVar1 + 0x4) = puVar5;
            }
            ...
            (uVar1 + 0xa) = param_3;
            (uVar1 + 0x12) = uStack18;
            pass1_1010_a50c(CONCAT22(param_2, param_1), ppuStack14,
                            CONCAT22(puVar4, uVar1));
        }
        return;
    }
    switchD_1010_c717_caseD_6: if (piStack6 != 0x0) {
...
pub fn pass1_1010_c864(param_1: u32, param_2: *mut u16, param_3: &mut Struct104, param_4: *mut u8,
    ...
    if (uVar9 != 0x0) {
        ...
        loop {
            ...
            if (uVar10 != 0x0) {
                ...
                pass1_1028_e1ec(ctx.PTR__LOOP_1050_65e2, uVar9, extraout_DX_00);
...
pub fn pass1_1010_cf36(param_1: u32, param_2: u32, param_3: *mut u16, param_4: u8, param_5: *mut u8) {
    let uVar1: u32;
    let puVar2: *mut u16;
    let mut pcVar3: String;
    let uVar4: u16;
    ...
    loop {
        ...
        iStack4 += 0x1;
        if (iStack4 < 0x8) == false { break; }
    }
    puStack8 = iVar9.field_0x2;
    iStack4 = 0x0;
    loop {
        uVar1 = iVar9.field_0x6;
        pcVar3 = pass1_1010_b038(param_1, uVar1, (uVar1 >> 0x10),
                                 (puStack8 + 0x4), unaff_SI);
...
pub fn pass1_1010_d24a(param_1: u32, param_2: u32, param_3: *mut u16, param_4: *mut u8, param_5: u8) {
    let uVar1: u32;
    let puVar2: *mut u16;
    let mut pcVar3: String;
    let puVar4: *mut u16;
...
pub fn pass1_1010_d448(param_1: *mut u8, param_2: u32, param_3: *mut u16, param_4: *mut u8, param_5: u8,
                       param_6: i16)

{
    ...
    if ((uVar8 | uVar1) != 0x0) {
        ...
        if ((uVar1 | uStack1034) != 0x0) {
            ...
            string_1040_a626((uVar4 & 0xffff0000 | (iVar7 + 0xa)),
...
pub fn pass1_1010_d5ae(param_1: *mut u8, param_2: u32, param_3: *mut u16, param_4: *mut u8, param_5: u8,
                       param_6: i16)

{
    ...
    if (uStack1032 != 0x0) {
        ...
        if ((uStack1032 | uStack1034) != 0x0) {
            ...
            string_1040_a626((uVar3 & 0xffff0000 | (iVar7 + 0xa)),
            ...
            string_1040_a626((uVar3 & 0xffff0000 | (iVar7 + 0x14)),
                             CONCAT22(param_4, local_402), uVar8);
...
pub fn pass1_1010_d710(param_1: u32, param_2: u32, param_3: *mut u16, param_4: *mut u8, param_5: u8) {
    let uVar1: u32;
    let lVar2: i32;
    let puVar3: *mut u16;
    ...
    loop {
        ...
        iStack4 += 0x1;
        if (iStack4 < 0x4) == false { break; }
    }
    puStack8 = iVar9.field_0x2;
    iStack4 = 0x0;
    loop {
        uVar1 = iVar9.field_0x6;
        pcVar4 = pass1_1010_b038(param_1, uVar1, (uVar1 >> 0x10),
                                 (puStack8 + 0x4), unaff_SI);
...
pub fn pass1_1010_d984(param_1: u16, param_2: u16, param_3: &mut i16, param_4: i16, param_5: u32,
                       param_6: u32, param_7: u32, param_8: *mut u8, param_9: u8)

{
    ...
    loop {
        ...
        *param_3 = *param_3 + uStack24;
        ...
        sys_1000_3f9c(local_418, param_8, 0x3935, ctx.data_seg, uStack18, &stack0xfffe, uVar5, 0x1000, param_8, param_9);
        ...
        iStack4 += 0x2;
        sys_1000_3f9c(local_418, param_8, 0x3938, ctx.data_seg, uStack24, &stack0xfffe, uVar5, 0x1000, param_8, param_9);
        string_1040_a626(puStack1052, CONCAT22(param_8, local_418), uVar5);
    }
}
...
param_6: u32,param_7: & mut i16,param_8: * mut u8,param_9: u8)

{
let uVar1: u16; let iVar2: & mut Struct493; let iVar3: i16; let uVar4: u16; let iVar4: & mut Struct492; let uVar5: u16; let uVar6: u16; let uVar7: u16; let uStack94: u16; let iStack92: i16; let uStack90: u16; let puStack88: * mut u16; ulocal_54: u8 [0x52];

uStack94 = param_3; uStack90 = param_3; iStack92 = 0x0; loop {
// uVar7 = (param_7 >> 0x10);
iVar4 = param_7; if ( * param_7 - 0x1 < uStack94) {
return uStack94;
}
uVar1 = iVar4.field_0x4; iVar2 = (iVar4.field_0x2 + uStack94 * 0xa);
// uVar5 = (param_5 >> 0x10);
// uVar6 = (param_4 >> 0x10); if (((iStack92 * 0x4 + param_5) == 0x0) & & ((iStack92 * 0x4 + param_4) == 0x0)) { break; }
uVar4 = uVar1; unk_str_op_1000_3d3e
(CONCAT22(param_8,local_54),
(iStack92 * 0x4 + param_4));
// uVar6 = (param_6 >> 0x10);
iVar2.field_0x4 = (uStack90 * 0x2 + param_6); string_1040_a626(CONCAT22(uVar1,iVar2), CONCAT22(param_8, local_54),
uVar4); sys_1000_3f9c(local_54, param_8, 0x393b, ctx.data_seg,
(param_5 + iStack92 * 0x4), & stack0xfffe,
uVar5, 0x1000,param_8, param_9); uVar1 = iVar4.field_0x4; iVar3 = iVar4.field_0x2 + (uStack94 + 0x1) * 0xa; puStack88 = CONCAT22(uVar1, iVar3); (iVar3 + 0x4) = ((uStack90 + 0x1) * 0x2 + param_6); string_1040_a626(puStack88, CONCAT22(param_8,local_54), uVar1); uStack94 += 0x2;
uStack90 += 0x2; iStack92 += 0x1;
}
return uStack94;
}
...
pub fn pass1_1010_dc36(param_1: u16, param_2: u16, param_3: u16, param_4: u32, param_5: *mut u16,
                       param_6: u16)
...
// TODO: refactor for loop
    ...
    *(puVar6 + 0x2) = 0x0;
    ...
    loop {
        ...
        uStack90 += 0x1;
        string_1040_a626((uVar3 & 0xffff0000 | uVar5),
...
pub fn pass1_1010_de78(param_1: u32, param_2: u32) {
    ...
    *(param_1 + 0x13c) = 0x0;
    ...
    load_string_1010_84e0(0x1030, _PTR_LOOP_1050_14cc,
                          (ctx.PTR__LOOP_1050_14cc >> 0x10), 0x3ff,
...
pub fn pass1_1010_debe(param_1: u32, param_2: u16, param_3: *mut u16, param_4: *mut u32, param_5: u32,
                       param_6: u16)

{
    ...
    *param_3 = 0x0;
    ...
    puVar10 = mixed_1010_20ba(ctx.PTR__LOOP_1050_0ed0, 0x35, param_6, puVar6, unaff_DI);
    // puVar6 = (puVar10 >> 0x10);
    iVar7 = param_4;
    // uVar8 = (param_4 >> 0x10);
    if (param_2 == 0x13) {
...
{
let iStack6: i16; let iStack4: i16;
...
pub fn pass1_1010_e1f4(param_1: u32, param_2: u32, param_3: u16, param_4: u16) {
    ...
    *(iVar6 + 0x13c) = 0x0;
    ...
    // uVar5 = (uVar7 >> 0x10);
    uVar1 = (uVar7 + 0xc);
    BVar2 = pass1_1008_c6ae(ctx.PTR__LOOP_1050_06e0, uVar1, 0xc);
    if ((((((((BVar2 == 0x0) && (BVar2 = pass1_1008_c6ae(ctx.PTR__LOOP_1050_06e0, uVar1, 0x14), BVar2 == 0x0)) && (BVar2 = pass1_1008_c6ae(ctx.PTR__LOOP_1050_06e0, uVar1, 0xa), BVar2 == 0x0)) && ((BVar2 = pass1_1008_c6ae(ctx.PTR__LOOP_1050_06e0, uVar1, 0x15), BVar2 == 0x0 && (BVar2 = pass1_1008_c6ae(ctx.PTR__LOOP_1050_06e0, uVar1, 0xb), BVar2 == 0x0)))) && (BVar2 = pass1_1008_c6ae(ctx.PTR__LOOP_1050_06e0, uVar1, 0x16), BVar2 == 0x0)) && (((BVar2 = pass1_1008_c6ae(ctx.PTR__LOOP_1050_06e0, uVar1, 0x17), BVar2 == 0x0 && (BVar2 = pass1_1008_c6ae(ctx.PTR__LOOP_1050_06e0, uVar1, 0x21), BVar2 == 0x0)) && ((BVar2 = pass1_1008_c6ae(ctx.PTR__LOOP_1050_06e0, uVar1, 0x1c), BVar2 == 0x0 && (((BVar2 = pass1_1008_c6ae(ctx.PTR__LOOP_1050_06e0, uVar1, 0x1d), BVar2 == 0x0 && (BVar2 = pass1_1008_c6ae(ctx.PTR__LOOP_1050_06e0, uVar1, 0x18), BVar2 == 0x0)) && (BVar2 = pass1_1008_c6ae(ctx.PTR__LOOP_1050_06e0, uVar1, 0x19), BVar2 == 0x0)))))))) && ((BVar2 = pass1_1008_c6ae(ctx.PTR__LOOP_1050_06e0, uVar1, 0x4), BVar2 == 0x0 && (BVar2 = pass1_1008_c6ae(ctx.PTR__LOOP_1050_06e0, uVar1, 0x3), BVar2 == 0x0)))) && (((BVar2 = pass1_1008_c6ae(ctx.PTR__LOOP_1050_06e0, uVar1, 0x1e), BVar2 == 0x0 && (((BVar2 = pass1_1008_c6ae(ctx.PTR__LOOP_1050_06e0, uVar1, 0x23), BVar2 == 0x0 && (BVar2 = pass1_1008_c6ae(ctx.PTR__LOOP_1050_06e0, uVar1, 0x1b), BVar2 == 0x0)) && ((BVar2 = pass1_1008_c6ae(ctx.PTR__LOOP_1050_06e0, uVar1, 0x1f), BVar2 == 0x0 && (((BVar2 = pass1_1008_c6ae(ctx.PTR__LOOP_1050_06e0, uVar1, 0x1), BVar2 == 0x0 && (BVar2 = pass1_1008_c6ae(ctx.PTR__LOOP_1050_06e0, uVar1, 0x2), BVar2 == 0x0)) && (BVar2 = pass1_1008_c6ae(ctx.PTR__LOOP_1050_06e0, uVar1, 0x13), BVar2 == 0x0)))))))) && (((BVar2 = pass1_1008_c6ae(ctx.PTR__LOOP_1050_06e0, uVar1, 0x20), BVar2 == 0x0 && (BVar2 = pass1_1008_c6ae(ctx.PTR__LOOP_1050_06e0, uVar1, 0xe), BVar2 == 0x0)) && (BVar2 = pass1_1008_c6ae(ctx.PTR__LOOP_1050_06e0, uVar1, 0x10), BVar2 == 0x0)))))) {
        pcVar3 = pass1_1008_c6ae(ctx.PTR__LOOP_1050_06e0, uVar1, 0x12);
        if ((pcVar3 == 0x0) && (pcVar3 = pass1_1008_c6ae(ctx.PTR__LOOP_1050_06e0, uVar1, 0x11),
                                pcVar3 == 0x0)) {
            BVar2 = pass1_1008_c6ae(ctx.PTR__LOOP_1050_06e0, uVar1, 0x6);
            if (BVar2 == 0x0) {
                BVar2 = pass1_1008_c6ae(ctx.PTR__LOOP_1050_06e0, uVar1, 0x5);
                if (BVar2 == 0x0) {
                    pass1_1008_c6ae(ctx.PTR__LOOP_1050_06e0, uVar1, 0x40);
...
//LAB_1010_e241:
        load_string_1010_84e0(0x1008, _PTR_LOOP_1050_14cc,
                              (ctx.PTR__LOOP_1050_14cc >> 0x10), 0x3ff, (iVar6 + 0x13c),
                              in_buf_len_5);
    }
    return;
}
...
pub fn pass1_1010_e58a(param_1: u32, param_2: u32, param_3: *mut u8, param_4: i16, param_5: u16) {
    let ppcVar1: u32;
    let uVar2: u16;
    let BVar3: bool;
    let puVar4: u32;
    ...
    *(iVar6 + 0x13c) = 0x0;
    ...
    puVar4 = (param_2 + 0x20);
    uVar7 = (param_2 + 0xc);
    BVar3 = pass1_1008_c6ae(ctx.PTR__LOOP_1050_06e0, uVar7, 0x11);
    if (BVar3 == 0x0) {
        BVar3 = pass1_1008_c6ae(ctx.PTR__LOOP_1050_06e0, uVar7, 0x12);
        if (BVar3 == 0x0) {
            return;
        }
        puVar8 = mixed_1010_20ba(ctx.PTR__LOOP_1050_0ed0, 0x31, param_5, param_3, param_4);
        ppcVar1 = (*puVar8 + 0x14);
        (**ppcVar1)(0x1008, puVar8, (puVar8 >> 0x10), puVar4, puVar4 >> 0xf);
        uVar5 = extraout_DX_01 | puVar4;
        uVar2 = extraout_DX_01;
    } else {
        puVar8 = mixed_1010_20ba(ctx.PTR__LOOP_1050_0ed0, 0x41, param_5, param_3, param_4);
        ppcVar1 = (*puVar8 + 0x14);
        (**ppcVar1)(0x1008, puVar8, (puVar8 >> 0x10), puVar4, puVar4 >> 0xf);
...
pub fn pass1_1010_e682(param_1: u32, param_2: u32, param_3: u16, param_4: u8) {
    ...
    *(uVar5 + 0x13c) = 0x0;
    ...
    uStack8 = (uStack6 + 0xc);
    uVar4 = uVar6;
    uVar1 = pass1_1008_c6ae(ctx.PTR__LOOP_1050_06e0, uStack8, 0x1);
    if (((uVar1 == 0x0) && (uVar1 = pass1_1008_c6ae(ctx.PTR__LOOP_1050_06e0, uStack8, 0x13), uVar1 == 0x0)) && (uVar1 = pass1_1008_c6ae(ctx.PTR__LOOP_1050_06e0, uStack8, 0x2), uVar1 == 0x0)) {
        BVar2 = pass1_1008_c6ae(ctx.PTR__LOOP_1050_06e0, uStack8, 0xe);
        if (BVar2 != 0x0) {
            uVar7 = (uVar5 + 0x138);
            uVar3 = (uVar7 + 0x24);
            uStack16 = uVar3;
            pass1_1028_e1ec(ctx.PTR__LOOP_1050_65e2, uVar3, (uVar3 >> 0x10));
            ...
            uStack22 = uVar8;
//LAB_1010_e76d:
            sys_1000_3f9c((uVar5 + 0x13c), in_buf_len_5, uVar9, ctx.data_seg,
                          uVar8, &stack0xfffe, uVar6, 0x1000, param_3, param_4);
            return;
        }
        BVar2 = pass1_1008_c6ae(ctx.PTR__LOOP_1050_06e0, uStack8, 0x5);
        if ((BVar2 == 0x0) && (BVar2 = pass1_1008_c6ae(ctx.PTR__LOOP_1050_06e0, uStack8, 0x6), BVar2 == 0x0)) {
            BVar2 = pass1_1008_c6ae(ctx.PTR__LOOP_1050_06e0, uStack8, 0x10);
            if (BVar2 == 0x0) {
                local_1e = pass1_1008_c6ae(ctx.PTR__LOOP_1050_06e0, uStack8, 0xc);
                if ((local_1e == 0x0) && (local_1e = pass1_1008_c6ae(ctx.PTR__LOOP_1050_06e0, uStack8, 0x14), local_1e == 0x0)
                ) {
                    BVar2 = pass1_1008_c6ae(ctx.PTR__LOOP_1050_06e0, uStack8, 0xa);
                    if (BVar2 == 0x0) {
                        uVar8 = pass1_1008_c6ae(ctx.PTR__LOOP_1050_06e0, uStack8, 0x1e);
                        if (uVar8 == 0x0) {
                            load_string_1010_84e0(0x1008, _PTR_LOOP_1050_14cc,
                                                  (ctx.PTR__LOOP_1050_14cc >> 0x10), 0x3ff,
...
//             TODO: goto LAB_1010_e76d;
    ...
    sys_1000_3f9c((uVar5 + 0x13c), in_buf_len_5, uVar8, ctx.data_seg,
                  uVar1, &stack0xfffe, uVar6, 0x1000, param_3, param_4);
    return;
}


pub fn pass1_1010_e8d0(param_1: u16, param_2: u16, param_3: *mut u16, param_4: *mut u16,
...
pub fn pass1_1010_e8f6(param_1: u16, param_2: u16, param_3: u32, param_4: u16) {
    ...
    uVar1 = (uVar4 + 0xc);
    BVar2 = pass1_1008_c6ae(ctx.PTR__LOOP_1050_06e0, uVar1, 0x13);
    if (BVar2 == 0x0) {
        BVar2 = pass1_1008_c6ae(ctx.PTR__LOOP_1050_06e0, uVar1, 0x14);
        if (BVar2 == 0x0) {
            return;
        }
...
pub fn pass1_1010_e964(param_1: *mut u8, param_2: u16, param_3: i16) {
    let uVar1: u32;
    let uVar2: u16;
    let puVar3: *mut u16;

    puVar3 = mixed_1010_20ba(ctx.PTR__LOOP_1050_0ed0, 0x2f, param_2, param_1, param_3);
    // uVar2 = (puVar3 >> 0x10);
    uVar1 = (puVar3 + 0x24);
    pass1_1028_e1ec(ctx.PTR__LOOP_1050_65e2, uVar1, (uVar1 >> 0x10));
    load_string_1038_4d28(uVar1 & 0xffff | uVar2 << 0x10);
    return;
}
...
pub fn pass1_1010_eb66(param_1: *mut u16, param_2: u16) {
    let puVar1: u32;
    let uVar2: u16;
    let ppcVar3: u32;
    let puVar4: *mut u16;
...
pub fn pass1_1010_ec84(param_1: u32, param_2: u16, param_3: u8) {
    ...
    pass1_1030_532e(CONCAT22(param_2, local_10e),
                    (param_1 + 0x20), param_2, param_3);
    fn_ptr_1030_835a(ctx.PTR__LOOP_1050_5748, CONCAT22(param_2, local_10e));
    return;
}
...
pub fn pass1_1010_ecc6(param_1: u32, param_2: *mut u16, param_3: i32, param_4: u16, param_5: u16,
                       param_6: u16)
