...
use crate::pass::pass_1000::{
    pass1_1000_472c, pass1_1000_48a8, pass1_1000_4906, pass1_1000_4aea, pass1_1000_5586,
};
use crate::pass::pass_1008::{
    pass1_1008_3e54, pass1_1008_3e94, pass1_1008_3eb4, pass1_1008_3f62, pass1_1008_4544,
    pass1_1008_4772, pass1_1008_5784, pass1_1008_5b12, pass1_1008_64a2, pass1_1008_64c8,
    pass1_1008_6562, pass1_1008_7c2a, pass1_1008_92b2,
};
use crate::pass::pass_1018::{pass1_1018_04f2, pass1_1018_209c, pass1_1018_4b78, pass1_1018_4dce};
use crate::pass::pass_1028::{
    pass1_1028_121e, pass1_1028_4faa, pass1_1028_b58e, pass1_1028_dc52, pass1_1028_e0a0,
    pass1_1028_e1ec, pass1_1028_e4ec,
};
use crate::pass::pass_1030::{
    fn_ptr_1030_84d0, pass1_1030_25d8, pass1_1030_301a, pass1_1030_38f2, pass1_1030_532e,
    pass1_1030_6ddc, pass1_1030_70f4, pass1_1030_7c28, pass1_1030_7f5a, pass1_1030_7f98,
    pass1_1030_809c, pass1_1030_8326, pass1_1030_8344,
};
use crate::pass::pass_1038::{
    load_string_1038_4d28, pass1_1038_4e78, pass1_1038_5050, pass1_1038_50e0,
};
...
use crate::struct_ops::struct_1010::{
    set_struct_fields_1010_1d48, struct_1010_2cd2, struct_1010_383a, struct_1010_38f8,
    struct_1010_dd5e,
};
...
pub fn pass1_1010_02a2(ctx: &mut AppContext, param_1: &mut Struct18, param_2: u8, param_3: u16) {
...
pub fn pass1_1010_043a(
    ...
    loop {
        ...
        if ((pu_var3.field_0x4 != param_3) || (pu_var3.field_0x6 != param_2)) == false {
            break;
        }
    }
    return;
...
pub fn pass1_1010_0538(
    ...
    *param_2 = 0x0;
    ...
    (param_3 + 0x2) = puVar8;
    while (
        pcVar6 = pass1_1000_472c(param_3, '%'),
        (puVar8 | pcVar6) != 0x0,
    ) {
        pass1_1010_09b4(
            uVar9,
            u_var10,
            CONCAT22(puVar8, pcVar6),
            param_3,
            u_var2,
            puVar8,
            param_5,
    ...
    //LAB_1010_0850:
    while (
        pcVar6 = pass1_1000_472c(param_2, '%'),
        (puVar8 | pcVar6) != 0x0,
    ) {
        pass1_1010_09b4(
            uVar9,
...
pub fn pass1_1010_08e2(ctx: &mut AppContext, param_1: u16, param_2: u16, param_3: i16) -> u32 {
...
pub fn pass1_1010_0946(
    ...
    lVar3 = 0x4000001;
    lVar2 = 0x4000002;
    pu_var1 = mixed_1010_20ba(ctx.PTR_LOOP_1050_0ed0, 0x3b, param_6, param_4, param_5);
    pass1_1008_dfa6(pu_var1, lVar2, lVar3, param_6);
    if (pu_var1 != 0x0) {
        pass1_1030_8344(
...
pub fn pass1_1010_09b4(
    ...
    if (bVar2) {
        ...
        pass1_1030_8344(ctx, ctx.PTR_LOOP_1050_5748, param_5);
...
pub fn pass1_1010_0ad2(ctx: &mut AppContext, param_1: u32, param_2: u32, param_3: u16) {
    let u_var1: u32;
    let BVar2: bool;
    let pu_var3: U32Ptr;
    let extraout_dx: u16;
                    ...
                    if (0x9 < i_stack4) {
                        ...
                        loop {
                            ...
                            BVar2 = write_to_file_1008_7e1c(
                                u_var6, uVar7, local_1e, param_3, 0x2, 0x1008,
                            );
                            if (BVar2 == 0x0) {
                                break;
                            }
...
pub fn pass1_1010_0e46(ctx: &mut AppContext, param_1: &mut Struct18, param_2: u8, param_3: u16) {
...
pub fn pass1_1010_0e6c(ctx: &mut AppContext, param_1: U32Ptr, param_2: u8) -> u16 {
    *param_1 = 0x389a;
    (param_1 + 0x2) = 0x1008;
    if ((param_2 & 0x1) != 0x0) {
        fn_ptr_1000_17ce(ctx, param_1, 0x1000);
...
pub fn pass1_1010_0f24(
    ...
    CONCAT22(param_2, param_1) = (ctx.s_648_bmp_1050_1919 + 0x1);
    param_1.field_0x2 = 0x1010;
...
pub fn pass1_1010_0f76(ctx: &mut AppContext, param_1: U32Ptr, param_2: u16) {
    let u_var1: u16;

    // u_var1 = (param_1 >> 0x10);
    *param_1 = (ctx.s_648_bmp_1050_1919 + 0x1);
    (param_1 + 0x2) = 0x1010;
...
pub fn pass1_1010_1146(
    ...
    pass1_1000_4aea(
        ...
        (u_var1 >> 0x10),
        0x4,
        (ctx.s_dibtext_bmp_1050_1844 + 0x6),
        &stack0xfffe,
        param_3,
        u_var2,
        0x1000,
...
pub fn pass1_1010_116c(ctx: &mut AppContext, param_1: U32Ptr, param_2: i16, param_3: u16) {
    let ppcVar1: u32;
    let i_var2: i16;
    let u_var3: u16;
    let i_var4: i16;
...
pub fn pass1_1010_17c0(ctx: &mut AppContext, param_1: i32, unaff_cs: u16) {
    let pu_var1: u32;
    let u_var2: u16;
    let ppc_var3: u32;

    unk_destroy_win_op_1010_2fa0(ctx, param_1, &mut unaff_cs);
...
pub fn pass1_1010_184a(ctx: &mut AppContext, param_1: U32Ptr, param_2: U32Ptr) {
    ...
    i_var1 = string_1000_475e(ctx, (i_var1 + *param_1), (i_var1 + *param_2));
    if (i_var1 == 0x0) {
...
pub fn pass1_1010_1a06(param_1: u32, param_2: u32, param_3: i16, param_4: u16) {
    ...
    uVar7 = (param_1 + 0x6e);
    pcVar9 = string_op_1010_ada6(0x1000, u_var5, uVar7, (uVar7 >> 0x10), i_var2, u_var3);
...
pub fn pass1_1010_1b6e(
    ...
    param_1.field_0x2 = 0x1010;
    pu_var1 = mixed_1010_20ba(ctx.PTR_LOOP_1050_0ed0, 0x3, param_4, param_5, unaff_DI);
    (param_1 + 0xb).field_0x0 = pu_var1;
    param_1[0xb].field_0x2 = (pu_var1 >> 0x10);
    return CONCAT22(param_2, param_1);
}
...
pub fn pass1_1010_1c16(param_1: u32, param_2: u32, param_3: i16) {
    ...
    // u_var2 = (u_var3 >> 0x10);
    pcVar1 = pass1_1010_b038((param_1 + 0x6e), u_var3, u_var2, 0x178a, param_3);
    str_op_1008_60e8(CONCAT22(u_var2, pcVar1), u_var2);
    return;
}
...
pub fn pass1_1010_1ea6(param_1: u32, param_2: i32, param_3: u16) {
    ...
    if ((puVar4 + 0x8) == 0x0) {
        ...
        if ((u_var2 | pu_var1) != 0x0) {
            ppc_var3 = *pu_var1;
            (**ppc_var3)(
                0x1008, pu_var1, u_var2, 0x1, pu_var1, u_var2, pu_var1, u_var2,
            );
        }
        iVar6.field_0x4 = 0x0;
    }
...
pub fn pass1_1010_2024(param_1: u32) -> u32 {
    ...
    // u_var1 = (param_1 >> 0x10);
    (param_1 + 0x124) = 0x0;
    ctx.PTR_LOOP_1050_0ed0 = param_1;
    pass1_1000_4906((param_1 & 0xffff | u_var1 << 0x10), 0x0, 0x124);
    return param_1;
}
...
pub fn pass1_1010_2e02(param_1: u32, param_2: i16) -> u32 {
    ...
    if ((param_1 + 0x5c) != 0x0) {
        ...
        // u_var2 = (u_var1 >> 0x10);
        i_var2 = u_var1;
        return CONCAT22((i_var2 + param_2 * 0x4 + 0x2), (i_var2 + param_2 * 0x4));
    }
    return 0x0;
}
...
pub fn pass1_1010_32f4(param_1: U32Ptr, param_2: U32Ptr, param_3: u16, param_4: u16) {
    ...
    if ((param_2 != 0x0)
        && (
            ...
            (**ppcVar5)(param_4, param_1, param_2),
            uVar8 != 0x0,
        ))
    {
        ppcVar5 = (*param_2 + 0x4);
...
pub fn pass1_1010_35a4(param_1: U32Ptr, param_2: u32, param_3: U32Ptr) {
    ...
    if (param_2 != 0x0) {
        ...
        if (u_var5 == 0x0) {
            ...
            pass1_1040_c54a(
                (param_2 & 0xffff | ZEXT24(param_3) << 0x10),
                0x1,
                puStack8,
                &ctx.PTR_LOOP_1050_1040,
                unaff_SS,
...
pub fn pass1_1010_3d82(
    param_1: &mut Struct628,
    param_2: &mut Struct19,
    param_3: u16,
    param_4: u16,
) -> u32 {
...
pub fn pass1_1010_3e3c(param_1: &mut Struct55, param_2: u16, param_3: u16) {
    ...
    pass1_1008_3e54((param_1 & 0xffff0000 | &i_var1.field_0x76), 0x0, 0x3, 0x5);
    ...
    pass1_1000_4906((param_1 & 0xffff0000 | &i_var1.field_0x26), 0x0, 0x40);
...
pub fn pass1_1010_404a(param_1: u32, param_2: u32, param_3: i16, param_4: u16) {
    ...
    if (param_3 == 0x0) {
        ...
        if (BVar3 != 0x0) {
            ...
            if (BVar3 != 0x0) {
                BVar3 =
                    read_file_1008_7dee(u_var4, u_var5, i_var2 + 0x7e, 0x0, u_var1, 0x2, 0x1008);
                if (BVar3 != 0x0) {
                    (i_var2 + 0x6a) = local_4;
                    return;
                }
...
pub fn pass1_1010_40cc(param_1: u32, param_2: i16, param_3: u16) -> u32 {
    pass1_1030_8344(ctx, ctx.PTR_LOOP_1050_5748, (param_1 + 0x6c));
...
pub fn pass1_1010_41d6(param_1: u32, param_2: u32, param_3: U32Ptr, param_4: u16, param_5: u8) {
    ...
    pass1_1030_8344(ctx, ctx.PTR_LOOP_1050_5748, i_var9.field_0x6c);
    ...
    loop {
        ...
        if (*pu_var1 < uStack24 || *pu_var1 == uStack24) {
            break;
        }
...
pub fn pass1_1010_451a(param_1: u32, param_2: U32Ptr, param_3: i16, param_4: u16) -> u32 {
    ...
    // u_var1 = (pu_var3 >> 0x10);
    u_var4 = pass1_1010_ec40(pu_var3, u_var1, (param_1 + 0x6c), pu_var3, u_var1);
    // u_var2 = (u_var4 >> 0x10);
...
pub fn pass1_1010_454a(param_1: u32) -> u32 {
    ...
    return CONCAT22((i_var1 + i_var2 + 0x28), (i_var1 + i_var2 + 0x26));
}
...
pub fn pass1_1010_4dc8(param_1: u32) -> u32 {
    ...
    return CONCAT22((i_var1 + 0x1c), (i_var1 + 0x20) * 0x8 + (i_var1 + 0x1a));
}
...
pub fn pass1_1010_4df0(param_1: u32, param_2: u16, param_3: u16) {
    ...
    // u_var2 = (param_1 >> 0x10);
    u_var1 = (param_1 + 0x26);
    pass1_1010_c1ba(u_var1, (u_var1 >> 0x10), (param_1 + 0x20), param_2, param_3);
    return;
}
    ...
    if (b_var1 != 0x0) {
        ...
        if (b_var1 != 0x0) {
            ...
            if (b_var1 != 0x0) {
                ...
                // u_var4 = (param_2 >> 0x10);
                b_var1 = write_to_file_1008_7e1c(param_2, u_var4, local_c, param_3, 0x2, 0x1008);
                if (b_var1 != 0x0) {
                    local_6[0] = (i_var2 + 0x82);
                    b_var1 =
                        write_to_file_1008_7e1c(param_2, u_var4, local_6, param_3, 0x2, 0x1008);
                    if (b_var1 != 0x0) {
                        return 0x1;
                    }
                }
        ...
        if (pu_var1 != 0x0) {
            ...
            if (pu_var1 != 0x0) {
                ...
                if (BVar3 != 0x0) {
                    ...
                    BVar3 =
                        read_file_1008_7dee(u_var6, uVar7, i_var4 + 0x82, 0x0, u_var5, 0x2, 0x1008);
                    if (BVar3 != 0x0) {
                        return;
                    }
                }
...
pub fn pass1_1010_6034(param_1: u32, param_2: u16) {
    ...
    pu_var1 = pass1_1000_4906((param_1 & 0xffff0000 | (i_var2 + 0x22)), 0x0, 0x40);
...
pub fn pass1_1010_648a(param_1: u32, param_2: u32, param_3: i16, param_4: u16) {
    ...
    if (param_3 != 0x0) {
        ...
        if (BVar3 != 0x0) {
            ...
            if (BVar3 != 0x0) {
                BVar3 =
                    read_file_1008_7dee(u_var4, u_var5, i_var2 + 0x12, 0x0, u_var1, 0x4, 0x1008);
                if (BVar3 != 0x0) {
...
pub fn pass1_1010_659a(param_1: u32, param_2: u16, param_3: u16) -> i16 {
    ...
    u_var1 = param_1;
    // u_var2 = (param_1 >> 0x10);
    switch_1010_6646(u_var1, u_var2, CONCAT22(param_3, &local_4), param_2);
    if (local_4 == 0x0) {
        return 0x0;
    }
...
pub fn pass1_1010_6700(param_1: &mut Struct636, param_2: &mut Struct19, param_3: u16) -> Struct19 {
    ...
    param_1.field_0x2 = 0x1010;
    pass1_1000_4906(CONCAT22(param_2, &param_1.field_0xa), 0x0, 0x114);
    ...
    pass1_1000_4906(CONCAT22(param_2, &param_1.field_0x11e), 0x0, 0x2a);
...
pub fn pass1_1010_68c6(param_1: u32, param_2: u32, param_3: u16, param_4: U32Ptr, param_5: u16) {
    ...
    if (ctx.PTR_LOOP_1050_0312 < 0x2) {
        ...
        if (b_var1 == 0x0) {
            //LAB_1010_692c:
            ctx.PTR_LOOP_1050_0310 = 0x6d2;
            fn_ptr_1000_17ce(ctx, (paStack18 & 0xffff | ZEXT24(param_4) << 0x10), 0x1000);
            return;
        }
        uStack4 = 0x0;
        loop {
...
pub fn pass1_1010_6cf8(
    ...
    match (param_3) {
        ...
        0x81 => {
            ...
            u_var1 = pass1_1010_6ca2(param_2, 0x7, param_5, param_4);
            if (u_var1 != 0x0) {
        ...
        0x55 => {}
        0x5a => {
            u_var1 = pass1_1010_6ca2(param_2, 0x2, param_5, param_4);
            if (u_var1 != 0x0) {
                pass1_1010_715c(param_2, 0x12, u_var1, param_5, param_7, param_4);
            }
            u_var1 = pass1_1010_6ca2(param_2, 0x8, param_5, param_4);
            if (u_var1 != 0x0) {
        ...
        0x76 => {
            u_var1 = 0xa;
            // code_r0x10106d4c:
            pass1_1010_715c(param_2, u_var1, param_6, param_5, param_7, param_4);
            u_var1 = 0xb;
        }
    }
    pass1_1010_715c(param_2, u_var1, param_6, param_5, param_7, param_4);
...
pub fn pass1_1010_7818(param_1: u32, param_2: u32) -> u16 {
    ...
    if (BVar3 == 0x0) {
        ...
        if (((BVar3 == 0x0)
            && (
                BVar3 = pass1_1008_c6ae(ctx.PTR_LOOP_1050_06e0, u_var2, 0x20),
                BVar3 == 0x0,
            ))
            && (
                BVar3 = pass1_1008_c6ae(ctx.PTR_LOOP_1050_06e0, u_var2, 0x1c),
                BVar3 == 0x0,
            ))
        {
            ...
            if ((BVar3 != 0x0)
                || (
                    BVar3 = pass1_1008_c6ae(ctx.PTR_LOOP_1050_06e0, u_var2, 0x13),
                    BVar3 != 0x0,
                ))
            {
                return 0x5;
            ...
            if ((BVar3 != 0x0)
                || (
                    BVar3 = pass1_1008_c6ae(ctx.PTR_LOOP_1050_06e0, u_var2, 0x12),
                    BVar3 != 0x0,
                ))
            {
                return 0x4;
...
pub fn pass1_1010_7e40(param_1: U32Ptr, param_2: U32Ptr, param_3: i16, param_4: u16) {
    ...
    *&pu_var2.field_0xa82 = 0x0;
    ctx.PTR_LOOP_1050_14cc = param_1;
...
pub fn pass1_1010_8018(param_1: u32, param_2: u16, param_3: U32Ptr, param_4: u16) {
    ...
    if ((param_2 * 0xa + 0x1fa0) != 0x0) {
        pass1_1010_878c(ctx, param_1, (param_2 * 0xa + 0x1fa0), &mut param_4);
        // u_var2 = (param_1 >> 0x10);
        if ((param_1 + 0x67c) != 0x0) {
            i_var1 = param_2 * 0xa;
            pass1_1008_64c8(
                (param_1 + 0x67c),
                CONCAT22((i_var1 + 0x1fa6), (i_var1 + 0x1fa8)),
                (i_var1 + 0x1fa4),
                param_2,
                param_3,
            );
...
pub fn pass1_1010_8096(param_1: U32Ptr, param_2: i16) {
    ...
    u_var3 = param_1;
    str_1000_4d58(
        ((u_var3 + 0xe82) * 0x4 + 0x2526),
        0x0,
        0x0,
        CONCAT22(unaff_SS, local_206),
        CONCAT22(unaff_SS, local_306),
    );
...
pub fn pass1_1010_84f8(param_1: u32, param_2: i16, param_3: u16) {
    ...
    str_1000_4d58(
        ...
        0x0,
        0x0,
        CONCAT22(param_3, local_208),
        CONCAT22(param_3, local_308),
    );
...
pub fn pass1_1010_85be(param_1: u32, param_2: i16, param_3: i16, param_4: u16) {
    ...
    if (param_2 == 0x2) {
        ...
        str_1000_4d58(
            (u_var1 & 0xffff0000 | (u_var1 + 0x3)),
            0x0,
            0x0,
            CONCAT22(param_4, local_20a),
            CONCAT22(param_4, local_30a),
        );
        string_1000_3d3e(CONCAT22(param_4, local_10a), ctx.s_male_1050_14c6);
...
pub fn pass1_1010_887a(
    ...
    if ((param_1 + 0x67c) != 0x0) {
        ...
        pass1_1008_6562(
            (param_1 + 0x67c),
            CONCAT22((iVar5 + 0x3388), (iVar5 + 0x338a)),
            (iVar5 + 0x3386),
            uStack4,
            in_DX,
        );
        ...
        if ((puVar4 | u_var1) == 0x0) {
            ...
            struct_op_1008_6604(CONCAT22(puVar4, u_var1), uStack24, (uStack24 >> 0x10));
            uVar7 = extraout_dx;
        }
...
pub fn pass1_1010_89f0(
    ...
    if (pu_var5 == 0x0) {
        ...
        file_1008_6414(
            CONCAT13((puVar4 >> 0x8), CONCAT12(puVar4, u_var3)),
            uVar7,
            param_6,
            pu_var5,
        );
...
pub fn pass1_1010_9298(
    ...
    pass1_1000_4906(CONCAT22(param_5, param_1[0x9].field_0x2), 0x0, 0x20c);
    return CONCAT22(param_2, param_1);
}
...
pub fn pass1_1010_9372(param_1: U32Ptr, param_2: u16, param_3: i16, param_4: i16, param_5: i16) {
    ...
    if (0x0 < param_4) {
        if (ctx.PTR_LOOP_1050_3528 == 0x0) {
            ppcVar1 = (*param_1 + 0x18);
            u_var6 = (**ppcVar1)();
            ctx.PTR_LOOP_1050_3528 = mixed_1010_20ba(
                ctx.PTR_LOOP_1050_0ed0,
                u_var6,
                unaff_SS,
                (u_var6 >> 0x10),
...
pub fn pass1_1010_9488(
    ...
    pass1_1010_a5ca(uStack10, u_var2, u_var5, u_var1, u_var3);
    return u_var1 == 0x0;
}
...
pub fn pass1_1010_96d0(param_1: u32) -> i16 {
    ...
    if (i_var3.field_0x1a != 0x0) {
        if (0x0 < i_var3.field_0x1c) {
            pi_var1 = &i_var3.field_0x1c;
            pi_var1 = pi_var1 + -0x1;
        }
        if ((i_var3.field_0x1c == 0x0) && (i_var3.field_0x1e != 0x0)) {
            iStack8 = 0x1;
            u_var4 = pass1_1030_8326();
        ...
        loop {
            ...
            if ((i_var1 == 0x3e) || (i_var1 == 0x41)) {
                ...
                (**ppcVar2)(
                    0x1008,
                    i_var9.field_0xe,
                    CONCAT22(extraout_DX_01, pu_var5),
                    puVar6,
                );
            }
        }
...
pub fn pass1_1010_a50c(param_1: &mut Struct20, param_2: u32, param_3: u32) {
    ...
    i_var1 = param_1;
    pass1_1000_4906((param_1 & 0xffff0000 | (i_var1 + 0xa4)), 0x0, 0x94);
...
pub fn pass1_1010_a69c(
    ...
    match (param_2) {
        ...
        //     TODO: goto LAB_1010_a96c;
        0x1d | 0x24 => {
            pass1_1010_abd2(u_var2, uVar8, 0x1e, pu_var3, param_5, param_6);
            i_var1 = 0x5b;
        }
        //     TODO: goto LAB_1010_a91f;
        0x1e => {
        ...
        //     TODO: goto LAB_1010_aabe;
        0x25 => {
            pass1_1010_abd2(u_var2, uVar8, 0x14, pu_var3, param_5, param_6);
        ...
        0x33 => {
            pass1_1010_abd2(u_var2, uVar8, 0x31, pu_var3, param_5, param_6);
            i_var1 = 0x6c;
        }
        //     TODO: goto LAB_1010_a91f;
        0x36 => {
    ...
    if (param_3 == 0x15) {
        ...
        if (param_3 < 0x16) {
            if (param_3 == '\x06') {
                ...
                // pu_var2 = (u_var3 >> 0x10);
                if (((u_var1 == 0xe) && (pu_var2 != 0x0 || (0x32 < u_var3)))
                    && (param_2 == 0x1
                        || ((param_2 == 0x2 || (param_2 == 0x4)) || (param_2 == 0x3))))
                {
                    ...
                    u_var5 = 0x0;
                    paVar4 =
                        mixed_1010_20ba(ctx.PTR_LOOP_1050_0ed0, 0x37, param_6, pu_var2, param_5);
                    post_win_msg_1008_a0e4(
                        paVar4,
                        CONCAT22(u_var6, u_var5),
                        iVar7,
                        CONCAT11(uVar9, uVar8),
...
pub fn pass1_1010_c58as(
    ...
    if (true) {
        match (param_3) {
            0x5 => {
                ppu_stack14 = &ctx.USHORT_1050_352c;
                u_stack18 = 0xfa4;
                i_stack16 = 0x30;
            }
            _ => {}
            ...
            0xa => {
                ppu_stack14 = &ctx.USHORT_1050_358c;
                u_stack18 = 0xfb3;
                i_stack16 = 0x51;
            }
            0xb => {
            ...
            0xc => {
                ppu_stack14 = &ctx.USHORT_1050_362e;
                u_stack18 = 0xfb6;
                i_stack16 = 0x30;
            }
            0x10 => {
                ppu_stack14 = &ctx.PTR_DAT_1050_1805_1050_368e;
                u_stack18 = 0xfc4;
                i_stack16 = 0x3c;
            }
            0x11 => {
                ppu_stack14 = &ctx.PTR_DAT_1050_1805_1050_3706;
                u_stack18 = 0xfc1;
                i_stack16 = 0x4b;
            }
            0x12 => {
                ppu_stack14 = &ctx.USHORT_1050_379c;
                u_stack18 = 0xfc5;
                i_stack16 = 0x8;
            }
            0x13 => {
            ...
            0x16 => {
                ppu_stack14 = &ctx.USHORT_1050_37ae;
                u_stack18 = 0x157;
                i_stack16 = 0x4;
            }
            0x17 => {
                ppu_stack14 = &USHORT_1050_37b6;
                i_stack16 = 0x2c;
                u_stack18 = 0xfd8;
                if ppu_stack14 != 0x0 {
                    pi_stack6 = i_stack16;
...
pub fn pass1_1010_c7e2(param_1: u32, param_2: u32, param_3: &mut i16) {
    ...
    loop {
        // u_var4 = (param_3 >> 0x10);
        i_var3 = param_3;
        if (*param_3 == i_stack4 || *param_3 < i_stack4) {
            break;
        }
        u_var1 = (i_var3 + 0x2);
...
pub fn pass1_1010_c864(
    ...
    uStack86 = pass1_1010_db2e(
        uVar16,
        uVar17,
        0x1,
        CONCAT22(param_5, &local_f6),
        CONCAT22(param_5, &local_18a),
        param_2,
        param_3,
        param_5,
        param_6,
    ...
    if (uVar9 != 0x0) {
        ...
        loop {
            ...
            if ((extraout_dx < uStack398._2_2_)
                || (extraout_dx <= uStack398._2_2_ && (uVar8 <= uStack398)))
            {
                break;
            }
            ppc_var3 = (u_var4 + 0x4);
...
pub fn pass1_1010_cc56(
    ...
    if (uStack324._2_2_ != 0x0) {
        ...
        uStack12 = pass1_1010_db2e(
            ...
            u_var10,
            0x1,
            CONCAT22(param_5, &local_aa),
            CONCAT22(param_5, &local_13e),
            param_2,
            param_3,
            param_5,
            param_6,
...
pub fn pass1_1010_cf36(param_1: u32, param_2: u32, param_3: U32Ptr, param_4: u8, param_5: U32Ptr) {
    ...
    if (in_DX != 0x0) {
        ...
        //       }
        //     }
        u_var6 = pass1_1010_db2e(
            uVar13,
            uVar14,
            0x8,
            CONCAT22(param_5, &local_a2),
            CONCAT22(param_5, local_136),
            param_2,
            param_3,
            param_5,
            param_4,
...
pub fn pass1_1010_d24a(param_1: u32, param_2: u32, param_3: U32Ptr, param_4: U32Ptr, param_5: u8) {
    ...
    if (puVar6 != 0x0) {
        ...
        puVar4 = pass1_1000_4906(CONCAT22(param_4, local_13a), 0x0, 0x94);
        lStack318 = 0x0;
        // TODO: refactor for loop
        // for (uStack320 = 0x1; uStack320 < 0x25; uStack320 += 0x1) {
        ...
        uVar8 = pass1_1010_db2e(
            ...
            uVar12,
            0x8,
            CONCAT22(param_4, &local_a6),
            CONCAT22(param_4, local_13a),
            param_2,
            param_3,
            param_4,
            param_5,
    ...
    if ((uVar8 | u_var1) != 0x0) {
        ...
        if ((u_var1 | uStack1034) != 0x0) {
            ...
            pass1_1010_d984(
                ...
                &ctx.PTR_DAT_1050_1805_1050_368e,
                param_3,
                param_4,
                param_5,
            );
            ...
            u_var3 = (iVar10 + 0x6);
            pcVar6 = pass1_1010_b038(param_1, u_var3, (u_var3 >> 0x10), (pu_var2 + 0x4), param_6);
            ...
            string_1040_a626(
                (u_var4 & 0xffff0000 | (iVar7 + 0xa)),
                CONCAT22(param_4, local_402),
                uVar9,
            );
            u_var4 = (iVar10 + 0x2);
            u_var11 = (iVar10 + 0x4);
    ...
    if (uStack1032 != 0x0) {
        ...
        if ((uStack1032 | uStack1034) != 0x0) {
            ...
            pass1_1010_d984(
                ...
                &ctx.PTR_DAT_1050_1805_1050_3706,
                param_3,
                param_4,
                param_5,
            );
            ...
            u_var2 = (i_var9 + 0x6);
            pcVar6 = pass1_1010_b038(param_1, u_var2, (u_var2 >> 0x10), (pu_var1 + 0x4), param_6);
...
pub fn pass1_1010_d710(param_1: u32, param_2: u32, param_3: U32Ptr, param_4: U32Ptr, param_5: u8) {
    ...
    if (in_DX != 0x0) {
        ...
        //   }
        // }
        uVar7 = pass1_1010_db2e(
            uVar13,
            uVar14,
            0x4,
            CONCAT22(param_4, &local_a2),
            CONCAT22(param_4, local_136),
            param_2,
            param_3,
            param_4,
            param_5,
...
pub fn pass1_1010_d984(
    ...
    loop {
        ...
        *param_3 = *param_3 + uStack24;
        ...
        puStack1052 = CONCAT22(u_var5, i_var3);
        (i_var3 + 0x4) = (i_stack4 * 0x2 + iVar7);
        string_1000_3d3e(CONCAT22(param_8, local_418), &mut pcStack22);
        string_1040_a626(puStack1052, CONCAT22(param_8, local_418), u_var5);
...
pub fn pass1_1010_db2e(
    ...
    let u_var1: u16;
    let i_var2: &mut Struct493;
    let i_var3: i16;
    let u_var4: u16;
    let i_var4: &mut Struct492;
    let u_var5: u16;
    let u_var6: u16;
    let uVar7: u16;
    let uStack94: u16;
    ...
    loop {
        ...
        u_var1 = i_var4.field_0x4;
        i_var2 = (i_var4.field_0x2 + uStack94 * 0xa);
        // u_var5 = (param_5 >> 0x10);
        ...
        // u_var6 = (param_6 >> 0x10);
        i_var2.field_0x4 = (uStack90 * 0x2 + param_6);
        string_1040_a626(
            CONCAT22(u_var1, i_var2),
        ...
        u_var1 = i_var4.field_0x4;
        i_var3 = i_var4.field_0x2 + (uStack94 + 0x1) * 0xa;
        puStack88 = CONCAT22(u_var1, i_var3);
        (i_var3 + 0x4) = ((uStack90 + 0x1) * 0x2 + param_6);
        string_1040_a626(puStack88, CONCAT22(param_8, local_54), u_var1);
        uStack94 += 0x2;
        uStack90 += 0x2;
        iStack92 += 0x1;
    }
...
pub fn pass1_1010_dc36(
    ...
    *(puVar6 + 0x2) = 0x0;
    ...
    loop {
        ...
        uStack90 += 0x1;
        string_1040_a626(
            (u_var3 & 0xffff0000 | u_var5),
            CONCAT22(param_6, &local_54),
            u_var2,
        );
    }
    return;
        ...
        if (param_2 < 0x14) {
            if (param_2 == '\x06') {
                ...
                if ((bVar1 == 0x0) && ((i_var4 == 0x5 || (i_var4 == 0x6)) || (i_var4 == 0x8))) {
                    u_var5 =
                        pass1_1010_ac62(u_var5, u_var11, 0x7, param_2 & 0xff00 | bVar1, puVar6);
...
pub fn pass1_1010_e1f4(param_1: u32, param_2: u32, param_3: u16, param_4: u16) {
    ...
    *(iVar6 + 0x13c) = 0x0;
    ...
    if ((((((((BVar2 == 0x0)
        ...
        && (
            BVar2 = pass1_1008_c6ae(ctx.PTR_LOOP_1050_06e0, u_var1, 0xa),
            BVar2 == 0x0,
        ))
        && ((
            BVar2 = pass1_1008_c6ae(ctx.PTR_LOOP_1050_06e0, u_var1, 0x15),
            BVar2 == 0x0
                && (
                    BVar2 = pass1_1008_c6ae(ctx.PTR_LOOP_1050_06e0, u_var1, 0xb),
                    BVar2 == 0x0,
                ),
        )))
        && (
            BVar2 = pass1_1008_c6ae(ctx.PTR_LOOP_1050_06e0, u_var1, 0x16),
            BVar2 == 0x0,
        ))
        && ((
            BVar2 = pass1_1008_c6ae(ctx.PTR_LOOP_1050_06e0, u_var1, 0x17),
            BVar2 == 0x0
                && (
                    BVar2 = pass1_1008_c6ae(ctx.PTR_LOOP_1050_06e0, u_var1, 0x21),
                    BVar2 == 0x0,
                ),
        ) && ((
            BVar2 = pass1_1008_c6ae(ctx.PTR_LOOP_1050_06e0, u_var1, 0x1c),
            BVar2 == 0x0
                && ((
                    BVar2 = pass1_1008_c6ae(ctx.PTR_LOOP_1050_06e0, u_var1, 0x1d),
                    BVar2 == 0x0
                        && (
                            BVar2 = pass1_1008_c6ae(ctx.PTR_LOOP_1050_06e0, u_var1, 0x18),
                            BVar2 == 0x0,
                        ),
                ) && (
                    BVar2 = pass1_1008_c6ae(ctx.PTR_LOOP_1050_06e0, u_var1, 0x19),
                    BVar2 == 0x0,
                )),
        ))))
        && ((
            ...
            BVar2 == 0x0
                && (
                    BVar2 = pass1_1008_c6ae(ctx.PTR_LOOP_1050_06e0, u_var1, 0x3),
                    BVar2 == 0x0,
                ),
        )))
        && ((
            ...
            BVar2 == 0x0
                && ((
                    BVar2 = pass1_1008_c6ae(ctx.PTR_LOOP_1050_06e0, u_var1, 0x23),
                    BVar2 == 0x0
                        && (
                            BVar2 = pass1_1008_c6ae(ctx.PTR_LOOP_1050_06e0, u_var1, 0x1b),
                            BVar2 == 0x0,
                        ),
                ) && ((
                    BVar2 = pass1_1008_c6ae(ctx.PTR_LOOP_1050_06e0, u_var1, 0x1f),
                    BVar2 == 0x0
                        && ((
                            BVar2 = pass1_1008_c6ae(ctx.PTR_LOOP_1050_06e0, u_var1, 0x1),
                            BVar2 == 0x0
                                && (
                                    BVar2 = pass1_1008_c6ae(ctx.PTR_LOOP_1050_06e0, u_var1, 0x2),
                                    BVar2 == 0x0,
                                ),
                        ) && (
            ...
            BVar2 = pass1_1008_c6ae(ctx.PTR_LOOP_1050_06e0, u_var1, 0x20),
            BVar2 == 0x0
                && (
                    BVar2 = pass1_1008_c6ae(ctx.PTR_LOOP_1050_06e0, u_var1, 0xe),
                    BVar2 == 0x0,
                ),
        ) && (
            BVar2 = pass1_1008_c6ae(ctx.PTR_LOOP_1050_06e0, u_var1, 0x10),
            BVar2 == 0x0,
        ))))
    {
        ...
        if ((pcVar3 == 0x0)
            && (
                pcVar3 = pass1_1008_c6ae(ctx.PTR_LOOP_1050_06e0, u_var1, 0x11),
                pcVar3 == 0x0,
            ))
        {
...
pub fn pass1_1010_e682(param_1: u32, param_2: u32, param_3: u16, param_4: u8) {
    ...
    *(u_var5 + 0x13c) = 0x0;
    ...
    if (((u_var1 == 0x0)
        && (
            u_var1 = pass1_1008_c6ae(ctx.PTR_LOOP_1050_06e0, uStack8, 0x13),
            u_var1 == 0x0,
        ))
        && (
            u_var1 = pass1_1008_c6ae(ctx.PTR_LOOP_1050_06e0, uStack8, 0x2),
            u_var1 == 0x0,
        ))
    {
        ...
        if ((BVar2 == 0x0)
            && (
                BVar2 = pass1_1008_c6ae(ctx.PTR_LOOP_1050_06e0, uStack8, 0x6),
                BVar2 == 0x0,
            ))
        {
            ...
            if (BVar2 == 0x0) {
                ...
                if ((local_1e == 0x0)
                    && (
                        local_1e = pass1_1008_c6ae(ctx.PTR_LOOP_1050_06e0, uStack8, 0x14),
                        local_1e == 0x0,
                    ))
                {
