...
pub fn pass1_1010_043a(param_1: u32, param_2: i32, param_3: i16, param_4: u16) {
    ...
    loop {
        ...
        if (uVar3 == 0x0) {
            ...
            (**ppcVar2)(0x1000, pu_var1, (pu_var1 >> 0x10), iVar5, uVar5, uVar6);
            return;
        }
...
pub fn pass1_1010_0946(param_1: u16,param_2: u16,param_3: i16,param_4: * mut u8,
param_5: i16,param_6: u16) -> u32

{
let pu_var1: U32Ptr; let lVar2: i32; let lVar3: i32;
...
pub fn pass1_1010_09b4(param_1: u16, param_2: u16, param_3: U32Ptr, param_4: &mut String, param_5: u32,
...
pub fn pass1_1010_0eac(param_1: * mut u8,param_2: * mut u8,param_3: u16,param_4: * mut u8,param_5: u16
) -> u32
...
{
let unaff_DI: i16; let pu_var1: U32Ptr;
...
pub fn pass1_1010_1ea6(param_1: u32, param_2: i32, param_3: u16) {
    ...
    if ((puVar4 + 0x8) == 0x0) {
        ...
        if ((uVar2 | pu_var1) != 0x0) {
            ppcVar3 = *pu_var1;
            (**ppcVar3)(0x1008, pu_var1, uVar2, 0x1, pu_var1, uVar2, pu_var1, uVar2);
        }
        iVar6.field_0x4 = 0x0;
    }
    return;
...
pub fn pass1_1010_6604(param_1: u32, param_2: u16, param_3: u16) {
    ...
    if (local_4 != 0x0) {
        i_var1 = (uVar2 + local_4 + 0x2);
        (uVar2 + local_4) = (uVar2 + local_4);
        (uVar2 + local_4 + 0x2) = i_var1 + 0x1;
...

{
    ...
    i_var1 = (uVar3 + 0x12);
    iVar4 = i_var1;
    if ((i_var1 != 0x4) && (iVar4 = param_2, i_var1 == 0x7)) {
        param_2 = 0x5;
        iVar4 = param_2;
    }
    param_2 = iVar4;
...
{
let uVar1: u16; let uVar2: u16;
let uVar3: u16; let puVar4: U32Ptr; let uVar5: u16; let uStack10: u16;
...
pub fn pass1_1010_a478(param_1: U32Ptr, param_2: u16) {
    ...
    *param_1 = 0xe9cc;
    ...
    if (uVar3.field_0x138 != 0x0) {
        ...
        pass1_1010_1ea6(uVar3.field_0x138, CONCAT22(uVar2, pu_var1), param_2);
    }
    ...
    puStack6 = CONCAT22(uVar4, pu_var1);
    *puStack6 = 0x389a;
    pu_var1[0x1] = 0x1008;
    pass1_1010_1d80(param_1, param_2);
    return;
...
//     TODO: goto LAB_1010_a91f;
        ...
        // puVar3 = (puVar7 >> 0x10);
        pass1_1010_08c0(puVar7, uVar2, i_var1, param_6);
...
//     TODO: goto LAB_1010_a91f;
        ...
        i_var1 = 0x66;
//LAB_1010_a91f:
        pass1_1010_abd2(uVar2, uVar8, i_var1, puVar3, param_5, param_6);
//     TODO: goto switchD_1010_aaef_caseD_b;
        0x3e => i_var1 = 0x5d;
        break;
        0x3f => i_var1 = 0x22;
...

{
    ...
    string_1000_3d3e(CONCAT22(param_7, local_40c), CONCAT22(uVar3, uVar1));
...
{
let uVar1: u16; let iVar2: & mut Struct493; let iVar3: i16; let uVar4: u16; let iVar4: & mut Struct492; let uVar5: u16; let uVar6: u16; let uVar7: u16; let uStack94: u16; let iStack92: i16; let uStack90: u16; let puStack88: U32Ptr; ulocal_54: u8 [0x52];
