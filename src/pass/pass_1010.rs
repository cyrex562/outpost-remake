...
pub fn pass1_1010_11c6(param_1: u32, param_2: u16, param_3: U32Ptr) {
    ...
    pu_var24 = struct_1010_38f8(
        CONCAT22(puVar11, iVar6),
        uStack14._2_2_,
        uStack14._2_2_,
        puVar12,
    );
    ...
    loop {
        ...
        loop {
            ...
            ppc_var3 = ((uStack14._2_2_ * 0x4 + i_var8) + 0x1c);
            (**ppc_var3)(
                0x1000,
                u_var5,
                (u_var5 >> 0x10),
            ...
            puVar14 = puVar12;
            pu_var24 =
                struct_1010_38f8((uStack14._2_2_ * 0x4 + i_var8), iStack40, u_var10, puVar16);
