...
pub unsafe fn unk_draw_op_1020_2020(
    ...
    (**ppc_var1)(style, pu_var3, (pu_var3 >> 0x10), 0x0, 0x0, ptr_1 + -0x22, param_3);
    u_var11 = extraout_dx;
    ...
    if (param_2 != 0x129) {
        ...
        if (param_2 < 0xfc) {
            ...
            if (c_var2 == 'r') {
                ...
                pass1_1038_af40(ctx.PTR_LOOP_1050_5b7c, (u_var5 + 0x8), 0x3, u_var4, u_var5,
...
pub fn load_draw_op_1020_2ede(ctx: &mut AppContext, param_1: U32Ptr, param_2: u32, param_3: u16) {
    ...
    *param_1 = 0x363c;
    (i_var6 + 0x2) = 0x1020;
    pu_var8 = mixed_1010_20ba(ctx, ctx.PTR_LOOP_1050_0ed0, (param_2 + 0xfc), unaff_ss,
                              in_dx, unaff_di);
    (i_var6 + 0x14) = pu_var8;
...
pub fn unk_draw_op_1020_320e(param_1: u32, param_2: HDC16, param_3: u16) {
    ...
    if ((u_var3 + 0x84) == 0x1) {
        ...
        u_var8 = pass1_1008_4772(
            (pu_var1 & 0xffff | (i_var5 + 0x26) << 0x10));
...
pub fn draw_op_1020_33c0(param_1: u32, param_2: u32, param_3: i16, param_4: u32, param_5: i16,
...
// TODO: refactor for loop
            ...
            if (u_var3 != 0x0) {
                ...
                pt_in_rect_1020_5856(param_1, CONCAT22(param_6, u_stack30 as u16),
                                     u_stack30 as u16);
                ...
                if (u_var5 != 0x0) {
                    ...
                    if ((pu_stack26 == 0xb) || (pu_stack26 == 0x37)) {
                        ...
                        if ((u_var5 | u_stack46) != 0x0) {
                            ...
                            pu_stack38 = mixed_1010_20ba(ctx.PTR_LOOP_1050_0ed0, 0x2f, param_6, pu_var6, unaff_di,
                            );
        ...
        rect = 0x1010;
        u_stack18 = mixed_1010_20ba(ctx.PTR_LOOP_1050_0ed0, 0x2, param_6, u_stack30._2_2_, unaff_di);
        if ((u_stack18 + 0x72) != 0x0) {
            ...
            (**ppc_var1)(0x1010, _PTR_LOOP_1050_02a0,
                         (ctx.PTR_LOOP_1050_02a0 >> 0x10), 0x10, i_var7, u_var9, u_var10, pu_var6,
            );
            pu_var12 = pass1_1008_941a(CONCAT22(param_6, local_18), 0x1, 0x86);
            msg = local_18;
            rect = 0x1008;
            win_1008_5c9e(ctx.PTR_LOOP_1050_02a0, CONCAT22(param_6, msg), msg,
...
pub fn unk_draw_op_1020_7f7a(param_1: &mut Struct20, param_2: u16, param_3: i32) {
    ...
    pa_var6 = unk_draw_op_1008_61b2(param_1, param_2, param_3 as u16,
    ...
    string_1000_3d3e((param_1 & 0xffff0000 | ZEXT24(&i_var4.field_0x5b)),
                     s_VrMode_1050_4422);
...
pub fn invalidate_rect_1020_8d90(param_1: u32, param_2: u16, param_3: u32, param_4: u16, param_5: u16,
                                 param_6: u16)

{
    ...
    if u_stack6 != 0x0 {
        ...
        if (param_5 | u_stack6) != 0x0 {
            ...
            file_and_draw_op_1008_4f20(ctx, CONCAT22(param_6, local_38), (u_var1 + 0xe), 0x25,
