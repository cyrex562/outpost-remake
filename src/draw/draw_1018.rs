...
{
  let ppcVar1: u32;
  let paVar2: &mut Struct8;
  let iVar4: &mut Struct9;
  let uVar3: u16;
  let uVar4: u32;
  let iStack16: i16;
...
pub fn unk_draw_op_1018_623e(param_1: u32,param_2: HWND16,param_3: u16)
{
  ...
  *(HGDIOBJ16 *)(puVar13 + -0x40) = HVar8;
  ...
  SelectObject16(ctx.s_tile2_bmp_1050_1538,*(HGDIOBJ16 *)(puVar13 + -0x3c));
  DeleteObject16(ctx.s_tile2_bmp_1050_1538);
...
pub fn draw_line_1018_6444(param_1: u32,HDC16 param_2)
{
  let iVar1: i16;
  INT16 *pIVar2;
  let uVar3: u32;
...
pub fn unk_draw_op_1018_c578(param_1: &mut Struct36,param_2: u16)
{
  ...
  if (((iVar11 + 0xf0) == 0x0) && ((iVar11 + 0xf4) != 0x0)) {
    ...
    uVar1 = iVar11 + 0xf2;
    hwnd = 0x1008;
    win_1008_5c9e(ctx.PTR__LOOP_1050_02a0,
...
pub fn draw_text_1018_c742(param_1: &mut Struct36,HDC16 param_2,param_3: &RECT16,param_4: u16)
{
  ...
  if ((iVar4.field_0x108 != 0x0) && (*iVar4.field_0x108 != '\0')) {
    ...
    CStack10 = SetBkColor16(ctx.s_tile2_bmp_1050_1538,0x0);
    uStack8 = param_4;
    if (iVar4.field_0x106 == 0x0) {
      ...
      iStack20 = 0x0;
      DrawText16(ctx.s_tile2_bmp_1050_1538,0x410,&local_1a,param_3,
                 0xffff);
...
pub fn unk_draw_op_1018_cda8(param_1: &mut Struct36,param_2: u16)
{
  let piVar1: *mut i16;
  let iVar2: i16;
  ...
  if ((iVar10 + 0xf0) == 0x0) {
    ...
    if ((ctx.PTR__LOOP_1050_02a0 + 0x12) == 0x0) {
      hwnd = 0x1008;
      win_1008_5c5c(param_2,uVar5,uVar8,
                    ctx._PTR_LOOP_1050_02a0 & 0xffff | uVar12 << 0x10,0x1d3);
    }
  }
  local_2a = BeginPaint16(hwnd,&local_22);
  pRStack44 = CreateSolidBrush16(s_tile2_bmp_1050_1538);
