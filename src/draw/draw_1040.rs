...
use crate::util::{CONCAT22, SUB42, CONCAT11, CONCAT12, ZEXT24, get_string_at_rsrc};
...
pub fn draw_op_1040_7bb2(in_struct_1: &mut Struct14, in_win_handle_2: HWND16, param_3: u16) {
    ...
    if (BVar2 == 0x0) {
        ...
        uStack8 = (**ppcVar1)(ctx.s_tile2_bmp_1050_1538, in_struct_1, iVar4.field_0x6e, uVar6,
                              uVar7);
        if (uStack8 != 0x0) {
            ...
            if (((uVar4 & 0x800000) != 0x0) && ((uVar4 & 0x400000) != 0x0)) {
                ...
                if (*count != '\0') {
                    ...
                    TextOut16(ctx.s_tile2_bmp_1050_1538, str, count, str_00,
                              (iVar4.field_0x80 - iVar4.field_0x7c) / 0x2 - (DVar5 >> 0x10) / 0x2);
                    if (handle_01 != 0x0) {
...
pub fn load_icon_1040_8b92(param_1: &mut Struct_1040_8b92, instance_handle: HINSTANCE16) {
    ...
    if b_var1 == 0x30 {
        name = get_string_at_rsrc(0x7f03);
    } else {
        if (b_var1 == 0x10) || (b_var1 == 0x10) {
            name = get_string_at_rsrc(0x7f01);
        } else {
            if (b_var1 == 0x40) || (b_var1 == 0x40) {
                name = get_string_at_rsrc(0x7f04);
            } else {
                if b_var1 != 0x20 {
                    return;
                }
                name = get_string_at_rsrc(0x7f02);
            }
        }
    }
...
pub fn draw_text_1040_8d14(
    ...
    obj_handle = 0x0;
    handle = GetProp16(*param_2, &get_string_at_rsrc(0x5e0f));
    if handle != 0x0 {
        obj_handle = SelectObject16(ctx.s_tile2_bmp_1050_1538 as HDC16, handle);
    }
    DrawText16(ctx.s_tile2_bmp_1050_1538 as HDC16, &get_string_at_rsrc(0x410), iVar3.field_0x9e, &rect,
               0xffff);
    if obj_handle != 0x0 {
...
pub fn draw_op_1040_a67e(param_1: u32, param_2: i16, param_3: u16, COLORREF param_4) {
    ...
    if (ctx.PTR__LOOP_1050_5ee8 == 0x0) {
        ...
        // uVar3 = (uVar8 >> 0x10);
        iVar4 = uVar8;
        ctx._PTR_LOOP_1050_5ee8 = CONCAT12(*(iVar4 + 0x94),
                                           CONCAT11(*(iVar4 + 0x95),
                                                    *(iVar4 + 0x96)));
...
pub fn draw_op_1040_c74c(param_1: *mut u32, param_2: u32, param_3: u16) {
    ...
    HStack8 = palette_op_1008_4e08(CONCAT22(uVar1, uStack6), &param_2 + 0x2, uVar1,
                                   0x1008);
    // uVar6 = (param_1 >> 0x10);
    iVar5 = param_1;
    (iVar5 + 0x46) = 0x1;
...
pub fn palette_op_1040_c886(param_1: u32, param_2: u8, param_3: u16, param_4: HDC16) {
    ...
    if (((iVar3 + 0xa) | (iVar3 + 0x8)) != 0x0) {
        ...
        if ((iVar3 + 0x46) == 0x0) {
            ...
            uVar1 = (ctx.PTR__LOOP_1050_4230 + 0x10);
            param_4 = 0x1008;
            HStack4 = palette_op_1008_4e08(CONCAT22(uVar1, uStack12), &param_3, uVar1, 0x1008);
        }
        puStack8 = (iVar3 + 0x8);
        uVar5 = (iVar3 + 0xa);
