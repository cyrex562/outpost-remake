...
pub fn draw_text_1040_94fc(param_1: &mut Struct37,param_2: HDC16)
{
  COLORREF color;
  COLORREF color_00;
...
pub fn draw_text_1040_9650(param_1: i32,param_2: HWND16)
{
  let hdc: HDC16;
