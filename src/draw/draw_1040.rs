...
use crate::defines::{Struct18, Struct13, Struct76, Struct_1040_8b92, Struct17, Struct37, Struct161};
use crate::pass::pass_1008::{pass1_1008_4d72, pass1_1008_4772};
use crate::string::string_1000::str_op_1000_3da4;
use crate::global::AppContext;

pub fn mix_draw_op_1040_21d6(
    param_1: u32,
    param_2: HWND16,
    param_3: u16) {
    let u_var1: u8;
    ...
    pa_var3 = (ctx.PTR__LOOP_1050_4230 + 0xe);
    b_force_background = palette_op_1008_4e08(pa_var3, &local_24, in_dx, 0x1008);
    ppc_var4 = ((i_var6 + 0x8e) + 0x4);
    (**ppc_var4)(0x1008, (i_var6 + 0x8e), 0xffffffff, &local_24, param_3, u_var8);
    ...
    DrawText16(ctx.s_tile2_bmp_1050_1538, &ctx.PTR_LOOP_1050_0010, i_var6 + 0x92, rect,
               0xffff);
    SetTextColor16(ctx.s_tile2_bmp_1050_1538,
                   CONCAT11(*(i_var5 + 0x95), *(i_var5 + 0x96)));
    DrawText16(ctx.s_tile2_bmp_1050_1538, &ctx.PTR_LOOP_1050_0010, i_var6 + 0x9a, rect,
               0xffff);
    if (handle != 0x0) {
...

{
    ...
    if (ctx.PTR__LOOP_1050_5cf8 == 0x0) {
        ...
        // u_var2 = (uVar9 >> 0x10);
        iVar3 = uVar9;
        ctx._PTR_LOOP_1050_5cf8 = CONCAT22(CONCAT11(0x2, *(iVar3 + 0x94)),
...
pub fn draw_op_1040_5a06(param_1: u32, param_2: HWND16, param_3: u16) {
    ...
    uVar8 = 0x1008;
    b_force_background = palette_op_1008_4e08((ctx.PTR__LOOP_1050_4230 + 0xe), &local_2c, in_DX, 0x1008);
    paStack54 = 0x0;
    if ((iVar6 + 0x98) != 0x0) {
        paStack54 = unk_io_op_1010_830a(ctx.PTR__LOOP_1050_14cc, (iVar6 + 0x98), param_3);
        IVar9 = 0x1008;
    ...
    if (paVar11 != 0x0) {
        if (paVar11 != 0x0) {
            ppc_var3 = u_var4;
            (**ppc_var3)(ctx.s_tile2_bmp_1050_1538, paVar11, uVar21, 0x1, uVar13, uVar8, iVar5,
    ...
    if (paVar12 != 0x0) {
        if (paVar12 != 0x0) {
            ppc_var3 = paVar12;
            (**ppc_var3)(ctx.s_tile2_bmp_1050_1538, paVar12, uVar21, 0x1, HVar16, HVar17, HVar18);
        }
    }
...
pub fn draw_op_1040_7bb2(in_struct_1: &mut Struct14, in_win_handle_2: HWND16, param_3: u16) {
    ...
    if (BVar2 == 0x0) {
        uVar6 = i_var4.field_0x6;
        local_hdc_4 = GetWindowDC16(s_tile2_bmp_1050_1538);
        ppcVar1 = (in_struct_1 + 0x68);
        uStack8 = (**ppcVar1)(ctx.s_tile2_bmp_1050_1538, in_struct_1, i_var4.field_0x6e, uVar6,
                              uVar7);
        if (uStack8 != 0x0) {
            HStack10 = palette_op_1008_4e08(uStack8, &local_hdc_4,
            ...
            u_var4 = GetWindowLong16(s_tile2_bmp_1050_1538, -0x10);
            if (((u_var4 & 0x800000) != 0x0) && ((u_var4 & 0x400000) != 0x0)) {
                iVar3 = i_var4.field_0x62 - i_var4.field_0x66;
...

{
    ...
    if (ctx.PTR__LOOP_1050_5df0 == 0x0) {
        ppcVar1 = (*param_1 + 0x68);
        u_var5 = (**ppcVar1)(ctx.s_tile2_bmp_1050_1538, param_1,
                            (param_1 + 0x6e), uVar6);
        if (u_var5 == 0x0) {
            return 0x0;
        }
        ...
        // uVar6 = (u_var5 >> 0x10);
        iVar2 = u_var5;
        ctx._PTR_LOOP_1050_5df0 = CONCAT22(CONCAT11(0x2, *(iVar2 + 0x94)),
...
pub fn draw_text_1040_8d14(
    ctx: &mut AppContext,
    param_1: &mut Struct37,
    param_2: &mut HWND16) {
    let b_var1: u8;
    let ivar2: i16;
    let handle: HANDLE16;
...
pub fn unk_draw_op_1040_9458(
    ...
    if param_1.field_0x8 != 0x0 {
        ...
        ppc_var1 = (uvar2 + 0x4);
        (**ppc_var1)(param_4, pu_stack6, param_1.field_0x28, param_1.field_0x26, &param_3);
...
pub fn draw_text_1040_94fc(
    ...
    DrawText16(ctx.s_tile2_bmp_1050_1538 as HDC16, &ctx.PTR_LOOP_1050_0010, param_1.field_0x2e,
               &rect, 0xffff);
...
pub fn draw_text_1040_9650(
    ctx: &mut AppContext,
    param_1: &mut Struct161,
    param_2: HWND16) {
    let hdc: HDC16;

    hdc = GetDC16(param_2);
    DrawText16(ctx.s_tile2_bmp_1050_1538 as HDC16, 0x410, param_1 + 0x2e,
               (param_1 >> 0x10), 0xffff);
...
pub fn draw_op_1040_9948(param_1: u16, param_2: u32, param_3: HWND16, param_4: &RECT16) {
    ...
    if (i_var4.field_0x6 != '\0') {
        ...
        uVar3 = str_op_1000_3da4((param_2 & 0xffff0000 | ZEXT24(&i_var4.field_0x6)));
    ...
    if (iStack28 != 0x0) {
        if ((i_var4.field_0x4 & 0x4) == 0x0) {
            ...
            GrayString16(0x1000, iStack4 - iStack8, (iStack6 - local_a),
...
pub fn draw_op_1040_a67e(param_1: u32, param_2: i16, param_3: u16, param_4: COLORREF) {
    ...
    if (ctx.PTR__LOOP_1050_5ee8 == 0x0) {
        ...
        // uVar3 = (uVar8 >> 0x10);
        i_var4 = uVar8;
        ctx._PTR_LOOP_1050_5ee8 = CONCAT12(*(i_var4 + 0x94),
                                           CONCAT11(*(i_var4 + 0x95),
                                                    *(i_var4 + 0x96)));
        ctx.PTR_LOOP_1050_5eec =

            CONCAT11(*(i_var4 + 0x3e5), *(i_var4 + 0x3e6));
...
pub fn unk_draw_op_1040_b0f8(param_1: &mut Struct18) {
    ...
    u_var1 = iVar3.field_0x90;
    u_var2 = iVar3.field_0x92;
...
pub fn draw_op_1040_c38e(param_1: u32) {
    ...
    if ((iVar7 != 0x0) && (u_var2 = (iVar8 + 0x6), (u_var2 + 0x16) != 0x0)) {
        ...
        //   iVar5 = u_var1;
        //   u_var1 &= 0xffff0000;
        //   pIVar6 = (INT16 *)(u_var1 | iVar5 + 0x1e);
        //   uVar10 = (u_var1 >> 0x10);
        ...
        u_var2 = (iVar8 + 0x6);
        uVar3 = (iVar8 + 0x6);
        u_var1 = (u_var2 + (uVar3 + 0x16) * 0x4 + 0x26);
        iVar7 = u_var1;
        u_var1 &= 0xffff0000;
        // uVar9 = (u_var1 >> 0x10);
...
pub fn draw_op_1040_c74c(param_1: U32Ptr, param_2: u32, param_3: u16) {
    ...
    HStack8 = palette_op_1008_4e08(CONCAT22(u_var1, uStack6), &param_2 + 0x2, u_var1,
                                   0x1008);
    // uVar6 = (param_1 >> 0x10);
    iVar5 = param_1;
    (iVar5 + 0x46) = 0x1;
...
pub fn palette_op_1040_c886(param_1: u32, param_2: u8, param_3: u16, param_4: HDC16) {
    ...
    if (((iVar3 + 0xa) | (iVar3 + 0x8)) != 0x0) {
        ...
        (**ppcVar2)(param_4, puStack8, u_var5, (iVar3 + 0x28),
                    (iVar3 + 0x26), &param_3);
        if ((iVar3 + 0x46) == 0x0) {
