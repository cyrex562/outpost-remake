pub fn close_file_1008_496c(in_Struct7: *mut Struct7) {
    ...
    *_in_Struct7 = &PTR_LOOP_1050_4c4c;
    in_Struct7.u16_field_2 = &PTR_LOOP_1050_1008;
    ...
    *_in_Struct7 = s_1_1050_389a;
    in_Struct7.u16_field_2 = &PTR_LOOP_1050_1008;
    return;
}

pub fn read_from_file_1008_49e8(in_Struct7: *mut Struct7) {
    ...
    if (in_Struct7.file_path != 0x0) {
        ...
        if ((bytes_read == 0xe) && ((bytes_read >> 0x10) == 0)) {
            ...
            if (local_18 == &PTR_LOOP_1050_4d42) {
                ...
                pvVar3 = lVar8;
                local_1c = __g_Struct94_ptr_1;
                local_1a = (__g_Struct94_ptr_1 >> 0x10);
                alloc_mem_1000_0a48(1, read_count, (read_count >> 0x10), local_1c, local_1a);
                in_Struct7.pv_buffer_0x1a = pvVar3;
                in_Struct7.u16_field_0x1c = extraout_dx;
                if ((extraout_dx | in_Struct7.pv_buffer_0x1a) == 0) {
                    return;
                }
                ...
                if ((struct_a | pa_var5) == 0) {
                    ...
                    in_Struct7.i_field_4 = extraout_dx_00;
                }
...
pub fn close_file_1008_4c26(param_1: *mut Struct7, param_2: u8) -> *mut Struct7 {
...
pub fn file_fn_1008_6414(in_Struct117: *mut Struct117, param_2: u32) {
    let pp_var1: fn();
    ...
    let local_Struct117: *mut Struct117;
    ...
    local_es_4 = (in_Struct117 >> 0x10);
    local_Struct117 = in_Struct117;
    in_Struct117 = 0;
    ...
    if ((paVar3 | paVar2) == 0) {
        ...
        in_Struct117 = paVar2;
        local_Struct117.field_0x2 = extraout_dx;
    }
    pp_var1 = (in_Struct117 + 0x14);
    (**pp_var1)(0x1000, in_Struct117);
    local_Struct117.field_0x4 = paVar2;
    local_Struct117.field_0x6 = extraout_dx_00;
    close_file_1008_496c(&local_26);
    return;
}

pub fn close_file_1008_6dd0(param_1: *mut Struct9) {
...
pub fn write_to_file_1008_6e02(param_1: *mut file_object) -> u16 {
    ...
    if (b_var1 != 0) {
        ...
        i_var2 = pass1_1008_7006(uVar3, u_var4, CONCAT22(unaff_ss, local_4));
        if ((i_var2 != 0)
            && (
                i_var2 = pass1_1008_6eee(uVar3, u_var4, CONCAT22(unaff_ss, local_4)),
                i_var2 != 0,
            ))
        {
...
pub fn close_file_1008_6e78(param_1: &mut Vec<u8>) -> bool {
    let b_var1: bool;
    let mut i_var2: i32;
    let mut u_var3: u16;
    let mut u_var4: u16;
    ...
    if (b_var1 != 0) {
        ...
        uVar3 = param_1;
        set_array_val_1008_72a8(CONCAT22(unaff_ss, local_4), (uVar3 + 4));
        i_var2 = pass1_1008_7056(uVar3, u_var4, CONCAT22(unaff_ss, local_4));
        if ((i_var2 != 0)
            && (
                i_var2 = pass1_1008_6f7a(uVar3, u_var4, CONCAT22(unaff_ss, local_4)),
                i_var2 != 0,
            ))
        {
            b_var1 = close_file_1008_726c(param_1);
...
pub fn close_file_1008_726c(param_1: *mut Struct11) -> bool {
    let mut file_handle: u16;
...
pub fn read_file_1008_7548(param_1: *mut HFILE16, param_2: *mut long) {
    ...
    if (local_6 != 0) {
        ...
        uVar3 = u_var4;
        _local_a = u_var4 & 0xffff | ZEXT24(local_6._2_2_) << 0x10;
...
pub fn read_file_1008_76e4(param_1: *mut HFILE16, param_2: *mut long) {
    ...
    local_6 = 0;
    u_var2 = read_file_1008_7dee(param_1, CONCAT22(local_SS__1, &local_6), 4);
    if (u_var2 == 0) {
        return;
    }
    if (local_6 != 0) {
...
pub fn read_file_1008_77cc(in_hfile: *mut HFILE16, param_2: *mut long) -> u16 {
    ...
    local_4 = 0;
    u_var1 = read_file_1008_7dee(in_hfile, CONCAT22(local_SS__1, &local_4), 2);
    if (u_var1 == 0) {
        return 0;
    }
    if (local_4 != 0) {
        ...
        if (param_2_val == 0) {
            ...
            if ((in_dx | u_var1) == 0) {
                ...
                local_DXAX_90 = pass1_1020_ba3e(CONCAT22(in_dx, u_var1), 5, 5);
...
pub fn write_to_file_1008_7a22(param_1: *mut HFILE16, param_2: *mut *mut u8) {
    ...
    local_12 = local_4;
    b_var1 = write_to_file_1008_7e1c(param_1, CONCAT22(local_SS__1, &local_12), 2);
    if (b_var1 == 0) {
        g_u16_1050_0310 = 0x6d0;
    } else {
        local_6 = 0;
        while (true) {
            ...
            local_a = local_12;
            local_1c = local_12;
            b_var1 = write_to_file_1008_7e1c(param_1, CONCAT22(local_SS__1, &local_1c), 2);
            if (b_var1 == 0) {
                break;
            }
            local_24 = local_10;
            b_var1 = write_to_file_1008_7e1c(param_1, CONCAT22(local_SS__1, &local_24), 4);
            if (b_var1 == 0) {
                return;
            }
            local_6 = local_6 + 1;
...
pub fn read_file_1008_7ad4(in_file: *mut HFILE16, param_2: u32) -> u16 {
    ...
    b_var1 = read_file_1008_7dee(in_file, CONCAT22(local_SS__1, &local_4), 2);
    if (b_var1 != 0) {
        local_6 = 0;
        while (true) {
            if (local_4 <= local_6) {
            ...
            b_var1 = read_file_1008_7dee(in_file, CONCAT22(local_SS__1, &local_14), 2);
            if ((b_var1 == 0)
                || (
                    b_var1 = read_file_1008_7dee(in_file, CONCAT22(local_SS__1, &local_10), 4),
                    b_var1 == 0,
                ))
            {
                break;
...
pub fn write_file_1008_7b4c(param_1: *mut HFILE16, param_2: *mut u8) -> u16 {
    ...
    if (b_var1 != 0) {
        local_c = local_6;
        b_var1 = write_to_file_1008_7e1c(param_1, CONCAT22(local_SS__1, &local_c), 2);
        if (b_var1 != 0) {
            local_c = local_8;
            b_var1 = write_to_file_1008_7e1c(param_1, CONCAT22(local_SS__1, &local_c), 2);
            if (b_var1 != 0) {
...
pub fn read_file_1008_7bc8(in_file: *mut HFILE16, param_2: *mut u16) -> u16 {
    ...
    b_var1 = read_file_1008_7dee(in_file, CONCAT22(local_SS__1, &local_6 + 2), 2);
    if (b_var1 != 0) {
        b_var1 = read_file_1008_7dee(in_file, CONCAT22(local_SS__1, &local_6), 2);
        if (b_var1 != 0) {
            b_var1 = read_file_1008_7dee(in_file, CONCAT22(local_SS__1, &local_8), 2);
            if (b_var1 != 0) {
...
pub fn write_to_file_1008_7cac(param_1: *mut HFILE16, param_2: u16) -> u8 {
    ...
    b_var1 = write_to_file_1008_7e1c(param_1, CONCAT22(local_SS__1, char_buf), buf_size);
    if (b_var1 == 0) {
        g_u16_1050_0310 = 0x6d0;
        return '\0';
    }
    ...
    if (CONCAT31(extraout_var, u_var2) != 0) {
        ...
        if (BVar3 != 0) {
            ...
            while {
                ...
                _local_10 = CONCAT22(extraout_dx, pu_var4);
...
pub fn write_file_1010_0ad2(in_struct_1: *mut Struct235, param_2: u32) {
    let mut u_var1: u32;
    let u_var2: u8;
    let BVar3: bool;
...
pub fn read_file_1010_0c7c(param_1: u32, param_2: *mut HFILE16) {
    ...
    if (CONCAT31(extraout_var, u_var2) == 0) {
        ...
        if (BVar3 != 0) {
            local_8 = 0;
            while (i_var6 = param_1, local_8 < local_6) {
                u_var4 = local_6;
                process_struct_1000_179c(10, in_dx);
                    ...
                    ))
                {
                    ...
                    if (local_16 != 0) {
                        pp_var1 = local_16;
                        (**pp_var1)(&PTR_LOOP_1050_1008, local_16, (local_16 >> 0x10), 1);
                    }
                    // goto LAB_1010_0cb1;
                }
                (local_16 + 4) = local_12;
            ...
            BVar3 = read_file_1008_7dee(param_2, (param_1 & 0xffff0000 | (i_var6 + 0xe)), 2);
            if ((BVar3 != 0)
                && (
                    BVar3 =
                        read_file_1008_7dee(param_2, (param_1 & 0xffff0000 | (i_var6 + 0x10)), 2),
                    BVar3 != 0,
                ))
            {
                local_4 = 0;
...
pub fn read_file_1010_68c6(param_1: u32, param_2: *mut HFILE16) {
    ...
    if (PTR_LOOP_1050_0312 < 2) {
        ...
        _local_a = CONCAT22(in_dx, i_var3);
        ...
        while {
            ...
            BVar6 = (local_4 * 2 + i_var3);
            (i_var4 + b_var5 * 2 + 10) = BVar6;
            local_4 = local_4 + 1;
            b_var5 = BVar6;
            local_4 < 0x81
        } {}
        in_dx = extraout_dx;
        u_var2 = error_check_1000_17ce(_local_a);
    ...
    if (PTR_LOOP_1050_0312 < 2) {
        ...
        BVar6 = read_file_1008_7dee(param_2, CONCAT22(in_dx, b_var5), CONCAT22(u_var11, u_var10));
        if (BVar6 == 0) {
            // LAB_1010_692c:
            g_u16_1050_0310 = 0x6d2;
                        ...
                        while (local_2a < local_36) {
                            ...
                            if (b_result == 0) {
                                ...
                                if (paStack38 != 0x0) {
                                    ...
                                    local_2e = _local_16;
                                    (**pp_var1)(&PTR_LOOP_1050_1008, _local_16, u_var8, 1);
                                }
                                // goto LAB_1010_9ba1;
                            }
                            b_result = read_file_1008_7dee(
    ...
    if (CONCAT31(extraout_var, uVar3) == 0) {
            ...
            )))
        {
            ...
            if ((i_var4 + 0x30) != 0) {
                ...
                (i_var4 + 0x2e) = g_u16_ptr_1050_5f2e;
        ...
        ))
    {
        ...
        if (bool_a != 0) {
            while (true) {
                ...
                i_var2 = pass1_1030_b836(CONCAT22(uVar3, u_var1), ph_var4);
                if (i_var2 == 0) {
                    break;
                }
...
pub fn read_from_file_1038_6118(param_1: *mut Struct933, param_2: *mut HFILE16) {
    let b_var1: bool;
    let u_var2: u8;
    let pu_var3: *mut u32;
    let b_var4: bool;
...
pub fn write_to_file_1030_b768(param_1: *mut Struct961, param_2: *mut HFILE16) {
    let mut u_var1: u32;
    let BVar2: bool;
    let pu_var3: *mut u8;
    let pu_var4: *mut u8;
        ...
        if (pu_var4 != 0) {
            ...
            if (BVar2 != 0) {
                ...
                while {
                    ...
                    local_c = pu_var3;
                    local_a = extraout_dx;
                    write_to_file_1038_75ca(pu_var3, extraout_dx, param_2);
                    pu_var3 != 0x0
                } {}
                return;
            }
...
pub fn pass1_1030_b836(struct_b: *mut Struct962, file_a: *mut HFILE16) {
    let pp_var1: fn();
    ...
    if (BVar2 != 0) {
            ...
            ))
        {
            ...
            while (true) {
                ...
                read_from_file_1038_774e(uVar3, u_var5, pHVar7);
                if (uVar3 == 0) {
                    break;
                }
...
pub fn write_to_file_1030_7418(struct_a: *mut Struct771, file_a: *mut HFILE16) {
    let mut u_var1: u32;
    let mut in_AX: i32;
    ...
    while (true) {
        ...
        _local_14 = CONCAT22(extraout_dx, pc_var2);
        if ((extraout_dx | pc_var2) == 0) {
...
pub fn read_from_file_1030_778c(struct_b: *mut Struct933, file_a: u32) {
    let mut u_var1: u32;
    let u_var2: u8;
                                    ...
                                    ))
                                {
                                        ...
                                        ))
                                    {
                                        ...
                                        while (local_e < local_20) {
                                            ...
                                            u_var8 = pu_var7;
                                            _local_32 = (pu_var7 & 0xffff | extraout_dx_00 << 0x10);
                                            paVar9 = (extraout_dx_00 | u_var8);
                                            if (paVar9 == 0x0) {
                                                local_2c = 0x0;
                                            } else {
                                                *_local_32 = s_1_1050_389a;
                                                (u_var8 + 2) = &PTR_LOOP_1050_1008;
                                                (u_var8 + 4) = 0;
                                                (u_var8 + 6) = 0;
                                                (u_var8 + 8) = 0;
                                                (u_var8 + 10) = 0;
                                        ...
                                        if (BVar3 != 0) {
                                            ...
                                            while (true) {
                                                ...
                                                u_var8 = pu_var7;
                                                _local_32 =
                                                    (pu_var7 & 0xffff | extraout_dx_01 << 0x10);
                                                paVar9 = (extraout_dx_01 | u_var8);
                                                if (paVar9 == 0x0) {
                                                    local_4a = 0;
                                                } else {
                                                    *_local_32 = s_1_1050_389a;
...
pub fn write_to_file_1030_5dbe(param_1: *mut Struct771, param_2: *mut HFILE16) {
    let mut u_var1: u32;
    let mut u_var2: u32;
    let mut i_var3: i32;
    let b_var4: bool;
    ...
    if (i_var3 != 0) {
        u_var7 = (param_1 >> 0x10);
        i_var6 = param_1;
        write_to_file_1008_7c2a(param_2, (i_var6 + 0x10));
        if (i_var3 != 0) {
            u_var1 = (i_var6 + 0x10);
...
pub fn read_from_file_1030_5e70(param_1: u32, param_2: *mut HFILE16) {
    ...
    if (in_AX != 0x0) {
        ...
        alloc_mem_1000_1708();
        _local_40a = CONCAT22(g_u16_ptr_1050_5f2e, _g_Struct94_ptr_1);
        puVar8 = (g_u16_ptr_1050_5f2e | _g_Struct94_ptr_1);
        i_var9 = param_1;
        if (puVar8 == 0x0) {
            (i_var9 + 0x10) = 0;
        } else {
            zero_list_1008_3e38(CONCAT22(g_u16_ptr_1050_5f2e, &_g_Struct94_ptr_1.field_0x4));
        ...
        if (pu_var4 != 0x0) {
            ...
            if (i_var5 != 0) {
                ...
                struct_a = extraout_dx;
                BVar6 = read_file_1008_7dee(param_2, (u_var2 & 0xffff0000 | local_420), 2);
                if (BVar6 != 0) {
                    u_var1 = (i_var9 + 0x10);
                    u_var10 = (u_var1 >> 0x10);
                    i_var5 = u_var1;
                    ...
                    (i_var5 + 0xe) = struct_a;
                    u_var1 = (i_var9 + 0x10);
                    BVar6 = read_file_1008_7dee(param_2, *(u_var1 + 0xc), local_420);
                    if (BVar6 != 0) {}
                    // goto LAB_1030_5fb7;
                }
            }
...
pub fn write_to_file_1030_56f6(param_1: *mut Struct771, param_2: *mut HFILE16) {
    let pu_var1: *mut u16;
    let mut u_var2: u32;
    let mut uVar3: u32;
    let mut i_var4: i32;
                ...
                ))
            {
                ...
                if (b_var5 != 0) {
                    ...
                    while (
                        ...
                        uVar3 = (i_var4 + 0x10);
                        u_var2 = (uVar3 + 0x16);
                        write_file_1008_7b4c(param_2, (u_var2 & 0xffff0000 | (u_var2 + i_var6)));
                        if (i_var6 == 0) {}
                        // goto LAB_1030_5734;
                        local_4 = local_4 + 1;
                    }
...
pub fn read_from_file_1030_581e(param_1: u32, param_2: *mut HFILE16) {
    ...
    if (in_AX != 0x0) {
        ...
        i_var6 = param_1;
        (i_var6 + 0x10) = _g_Struct94_ptr_1;
        (i_var6 + 0x12) = struct_a;
        ...
        if (BVar3 != 0) {
            ...
            (i_var6 + 0x10) = u_var5;
            (i_var6 + 0x12) = struct_a;
            BVar3 = read_file_1008_7dee(param_2, CONCAT22(struct_a, (i_var6 + 0x10) + 2), 2);
            if (BVar3 != 0) {
                pu_var4 = local_408;
                read_file_into_str_1008_7c6e(param_2, CONCAT22(unaff_ss, pu_var4));
                if (pu_var4 != 0x0) {
                    ...
                    if (BVar3 != 0) {
                        ...
                        if ((i_var7 != 0)
                            && (
                                BVar3 = read_file_1008_7dee(
                                    param_2,
                                    (param_1 & 0xffff0000 | (i_var6 + 0x1c)),
                                    2,
                                ),
                                BVar3 != 0,
                            ))
...
pub fn read_from_file_1030_4e70(
    ...
    if (param_4 != 0x0) {
        ...
        i_var1 = path;
        dos3_call_1000_51aa(i_var1, (path >> 0x10), u_var2, pu_var3);
        if (i_var1 == 0) {
...
pub fn write_to_file_1030_2aca(param_1: *mut Struct771, param_2: *mut HFILE16) {
    let mut u_var1: u32;
    let mut u_var2: u32;
    let mut i_var3: i32;
    let b_var4: bool;
...
pub fn read_file_1030_2c8a(param_1: u32, param_2: *mut HFILE16) {
    ...
    alloc_mem_1000_1708();
    _local_40e = CONCAT22(g_u16_ptr_1050_5f2e, _g_Struct94_ptr_1);
    pu_var5 = (g_u16_ptr_1050_5f2e | _g_Struct94_ptr_1);
    local_bx_91 = param_1;
    if (pu_var5 == 0x0) {
        local_bx_91.field_0x10 = 0x0;
    } else {
        zero_list_1008_3e38(CONCAT22(g_u16_ptr_1050_5f2e, &_g_Struct94_ptr_1.field_0x6));
        local_bx_91.field_0x10 = _local_40e;
        pu_var5 = g_u16_ptr_1050_5f2e;
    }
    ...
    if (BVar2 != 0) {
        ...
        if (local_AX_184 != 0x0) {
            ...
            *(i_var6 + 2) = pu_var3;
            ...
            pu_var1 = local_bx_91.field_0x10;
            i_var6 = pu_var1 + 6;
            read_file_1008_7bc8(param_2, (param_2 >> 0x10), i_var6, (pu_var1 >> 0x10));
            if ((((i_var6 != 0)
                && (
                    pu_var1 = local_bx_91.field_0x10,
                    struct_a = extraout_dx,
                ...
                )))
            {
                ...
                if ((pu_var1 + 0x22) != 0) {
                    ...
                    u_var7 = (pu_var1 >> 0x10);
                    i_var6 = pu_var1;
                    u_var4 = (i_var6 + 0x22) * 2;
                    process_struct_1000_179c(u_var4, struct_a);
                    (i_var6 + 0x24) = u_var4;
                    (i_var6 + 0x26) = struct_a;
                    pu_var1 = local_bx_91.field_0x10;
                    u_var7 = (pu_var1 >> 0x10);
                    i_var6 = pu_var1;
                    BVar2 = read_file_1008_7dee(param_2, *(i_var6 + 0x24), ((i_var6 + 0x22) * 2));
                    if (BVar2 == 0) {
                        g_u16_1050_0310 = 0x6d2;
                        return;
                    }
...
pub fn write_to_file_1030_1a9c(param_1: *mut Struct771, param_2: *mut HFILE16) -> bool {
    let pi_var1: *mut i32;
    let mut i_var2: i32;
    let BVar3: bool;
    let mut u_var4: u16;
...
pub fn pass1_1030_1b18(param_1: u32, param_2: *mut HFILE16) -> u16 {
    ...
    if (in_AX != 0) {
        ...
        i_var7 = param_1;
        (i_var7 + 0x10) = u_var4;
        (i_var7 + 0x12) = g_u16_ptr_1050_5f2e;
        ...
        if (b_var5 != 0) {
            ...
            (i_var8 + 4) = struct_a;
            u_var2 = (i_var7 + 0x10);
            b_var5 = read_file_1008_7dee(param_2, *(u_var2 + 2), uVar3);
            if (b_var5 != 0) {
                return 1;
            }
        }
        ...
        ))
    {
        ...
        match paVar26 {
            ...
            0xb => {
                ...
                local_46._1_1_ = 0;
                local_44 = 1;
                local_4a._0_1_ = SUB41(_g_Struct372_1050_0ed0, 0);
                local_4a._1_1_ = (_g_Struct372_1050_0ed0 >> 8);
                local_48 = (_g_Struct372_1050_0ed0 >> 0x10);
                uStack76 = 0x28;
                uStack75 = 0x10;
                uStack78 = 0x7b0a;
                ppVar33 = process_struct_1010_20ba(_g_Struct372_1050_0ed0, 0x1002b);
                ...
                local_40 = 2;
                local_44 = _g_Struct372_1050_0ed0;
                local_42._0_1_ = (_g_Struct372_1050_0ed0 >> 0x10);
                local_42._1_1_ = (_g_Struct372_1050_0ed0 >> 0x18);
                local_46._0_1_ = uVar30;
                local_46._1_1_ = (uVar30 >> 8);
                local_48 = 0x7b44;
                local_a = process_struct_1010_20ba(_g_Struct372_1050_0ed0, CONCAT22(uVar36, 2));
                local_c = u16_1050_13ae;
                if (2 < u16_1050_13ae) {
                    local_40 = 0x2f;
                    local_44 = _g_Struct372_1050_0ed0;
                    ...
                    local_48 = 0x7b63;
                    ppVar33 =
                        process_struct_1010_20ba(_g_Struct372_1050_0ed0, CONCAT22(uVar36, 0x2f));
                    ...
                    while (CONCAT11(local_46._1_1_, local_46) < 9) {
                            ...
                            == local_6)
                        {
                            ...
                            if (local_30 != 0) {
                                ...
                                local_4a._0_1_ = 0xc;
                                local_4a._1_1_ = 0x7c;
                                pass1_1030_835a(_g_bool_1050_5748, CONCAT22(unaff_ss, pu_var19));
...
pub fn write_to_file_1028_e56c(
    ...
    while (true) {
        ...
        _local_1c = CONCAT22(extraout_dx, pu_var2);
    ...
    if (BVar3 == 0) {
        ...
        while {
            pu_var2 = &local_14;
            pass1_1028_e4ec(CONCAT22(unaff_ss, pu_var2));
            _local_1c = CONCAT22(extraout_dx_00, pu_var2);
            if ((extraout_dx_00 | pu_var2) == 0) {
                return;
            }
            pp_var1 = (*_local_1c + 0xc);
            (**pp_var1)(&PTR_LOOP_1050_1008, pu_var2, extraout_dx_00);
                                                                            ...
                                                                            if (i_var4 != 0) {
                                                                                ...
                                                                                if (i_var4 != 0) {
                                                                                    ...
                                                                                    while (true) {
                                                                                        ...
                                                                                        _local_18 = CONCAT22(extraout_dx, pu_var5);
...
pub fn read_file_fn_1028_b81a(param_1: u32, in_file_1: *mut HFILE16) {
    ...
    match (local_a) {
        ...
        4 => {
            u_var8 = pass1_1028_e0bc(_PTR_LOOP_1050_65e2, CONCAT22(local_3a, (i_var9 + 0xc)));
            local_e = (u_var8 >> 0x10);
            (i_var9 + 0x14) = u_var8;
            (i_var9 + 0x16) = local_e;
        ...
        5 => {
            i_var6 = i_var9;
            pass1_1028_e100(_PTR_LOOP_1050_65e2, (i_var9 + 0xc));
            (i_var9 + 0x14) = i_var6;
            (i_var9 + 0x16) = u_var5;
    ...
    if (in_AX != 0) {
        ...
        if (BVar2 != 0) {
            ...
            while (true) {
                ...
                alloc_mem_1000_07fc(_PTR_LOOP_1050_68a2);
                u_var4 = pu_var5;
                local_14 = pu_var5 & 0xffff | extraout_dx << 0x10;
...
pub fn write_to_file_1028_64d6(param_1: *mut Struct771, param_2: *mut HFILE16) -> u16 {
    let mut u_var1: u32;
    let mut i_var2: i32;
    let pu_var3: *mut u16;
    let b_var4: bool;
...
pub fn file_write_fn_1028_0234(param_1: *mut Struct731, param_2: u32) -> bool {
    let mut u_var1: u32;
    let mut i_var2: i32;
    let BVar3: bool;
...
pub fn pass1_1020_8a9c(param_1: *mut Struct393) {
    let mut u_var1: u32;
    let mut u_var2: i32;
    let mut u_var3: u16;
    let mut extraout_dx: u16;
    ...
    ppVar4 = process_struct_1010_20ba(_g_Struct372_1050_0ed0, CONCAT22(unaff_si, 0x29));
    uVar3 = (ppVar4 >> 0x10);
