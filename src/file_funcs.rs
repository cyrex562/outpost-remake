pub fn close_file_1008_496c(in_Struct7: *mut Struct7) {
    ...
    *_in_Struct7 = &PTR_LOOP_1050_4c4c;
    ...
    puVar1 = in_Struct7.func_ptr_0x4;
    uVar2 = in_Struct7.i_field_4;
    if ((uVar2 | puVar1) != 0) {
        unsafe {
            func_ptr = *puVar1;
            (**func_ptr)();
    ...
    if (in_Struct7.file_path != 0x0) {
        ...
        if ((bytes_read == 0xe) && ((bytes_read >> 0x10) == 0)) {
            ...
            if (local_18 == &PTR_LOOP_1050_4d42) {
                ...
                uVar6 = &in_Struct7.pv_buffer_0x1a;
                iVar4 = uVar6;
                uVar6 = uVar6 & 0xffff0000;
                in_Struct7.pv_field_0x12 = (uVar6 | iVar4 + 0xe);
                uVar6 = uVar6 | iVar4 + 0x436;
                in_Struct7.u32_field_0x16 = uVar6;
                ...
                if ((struct_a | paVar5) == 0) {
                    ...
                    uVar7 = uVar2 | Struct131_4;
                    local_18 = (uVar2 >> 0x10);
                    process_struct_1008_4c98((uVar6 & 0xffff | Struct131_4 << 0x10), uVar7, 0x100);
                    paVar5 = uVar7;
                    in_Struct7.func_ptr_0x4 = paVar5;
                    in_Struct7.i_field_4 = extraout_DX_00;
                }
                if (in_Struct7.pv_field_0x22 != 0) {
                    local_16 = local_16 & 0xffff0000 | in_stack_00000006;
                    local_18 = in_Struct7;
                    pass1_1008_4b8e(in_Struct7, paVar5);
                    return;
                }
                return;
            }
...
pub fn file_fn_1008_6414(in_Struct117: *mut Struct117, param_2: u32) {
    ...
    ppcVar1 = (in_Struct117 + 0x14);
    (**ppcVar1)(0x1000, in_Struct117);
    ...
    if (CONCAT31(extraout_var, uVar2) != 0) {
        ...
        if (BVar3 != 0) {
            ...
            while (true) {
                ...
                _local_e = CONCAT22(u_var5, uVar4);
                BVar3 = read_file_1008_7dee(in_file_1, CONCAT22(u_var5, uVar4 + 4), 4);
                if ((((BVar3 == 0)
                    || (
...
pub fn read_file_1018_0000(param_1: u32, param_2: *mut HFILE16) {
    ...
    if (CONCAT31(extraout_var, uVar3) == 0) {
            ...
            )))
        {
            uVar7 = (param_1 >> 0x10);
            if ((iVar4 + 0x30) != 0) {
                _g_Struct94_ptr_1 = ((iVar4 + 0x32) * 6);
...
pub fn read_from_file_1038_7c02(param_1: *mut *mut u8, file_b: *mut HFILE16) -> u16 {
        ...
        ))
    {
        while (local_4 != 0) {
            ...
            iVar2 = read_from_file_1038_774e(_local_e, ph_var4);
            if (iVar2 == 0) {
                return 0;
            }
            fn_ptr_a = (param_1 + 4);
        ...
        if (bool_a != 0) {
            while (true) {
                ...
                iVar2 = pass1_1030_b836(CONCAT22(uVar3, uVar1), ph_var4);
                if (iVar2 == 0) {
                    break;
                }
...
pub fn read_from_file_1038_774e(param_1: u32, param_2: *mut HFILE16) {
        ...
        ))
    {
        ...
        u_var5 = param_2;
        uVar6 = (param_2 >> 0x10);
        read_file_1008_77cc(u_var5, uVar6, iVar3, uVar1);
        if ((iVar3 != 0)
            && (((
                BVar2 = read_file_1008_7dee(param_2, CONCAT22(unaff_SS, &local_4), 2),
                BVar2 != 0
            ...
            )))
        {
            ...
            read_file_1008_7bc8(u_var5, uVar6, iVar3, uVar1);
            if ((((iVar3 != 0)
                && (
                    BVar2 = read_file_1008_7dee(
                        param_2,
                ...
                )))
            {
                ...
                set_param_3_with_switch_1008_72bc(u_var5, uVar6, local_6);
...
pub fn read_file_1030_2c8a(param_1: u32, param_2: *mut HFILE16) {
    ...
    puVar5 = (g_u16_ptr_1050_5f2e | _g_Struct94_ptr_1);
    local_BX_91 = param_1;
    if (puVar5 == 0x0) {
        ...
        if (BVar3 != 0) {
            ...
            if (BVar3 != 0) {
                ...
                if (BVar3 != 0) {
                    ...
                    iVar4 = CONCAT31(extraout_var_00, uVar2);
                    if (iVar4 != 0) {
                        pass1_1028_e628(param_1, uVar6, u_var5, 0, 0x100);
                        if (iVar4 != 0) {
                            uVar2 = read_file_1008_7cfe(file_handle_1);
                            iVar4 = CONCAT31(extraout_var_01, uVar2);
                            if (iVar4 != 0) {
                                pass1_1028_e628(param_1, uVar6, u_var5, 0, 0x200);
                                if (iVar4 != 0) {
                                    uVar2 = read_file_1008_7cfe(file_handle_1);
                                    iVar4 = CONCAT31(extraout_var_02, uVar2);
                                    if (iVar4 != 0) {
                                        pass1_1028_e628(param_1, uVar6, u_var5, 0, 0x300);
                                        if (iVar4 != 0) {
                                            uVar2 = read_file_1008_7cfe(file_handle_1);
                                            iVar4 = CONCAT31(extraout_var_03, uVar2);
                                            if (iVar4 != 0) {
                                                pass1_1028_e628(param_1, uVar6, u_var5, 0, 0x400);
                                                if (iVar4 != 0) {
                                                    uVar2 = read_file_1008_7cfe(file_handle_1);
                                                    iVar4 = CONCAT31(extraout_var_04, uVar2);
                                                    if (iVar4 != 0) {
                                                        pass1_1028_e628(
                                                            param_1, uVar6, u_var5, 0, 0x500,
                                                        );
                                                        if (iVar4 != 0) {
                                                            uVar2 =
...
pub fn read_file_fn_1028_b81a(param_1: u32, in_file_1: *mut HFILE16) {
    ...
    match (local_a) {
        1 | 2 | 3 => {
            u_var5 = iVar9 + 0x14;
            // LAB_1028_b968:
            BVar4 = read_file_1008_7dee(in_file_1, CONCAT22(uVar7, u_var5), 2);
        }
        4 => {
        ...
        5 => {
            ...
            local_e = u_var5;
            BVar4 = read_file_1008_7dee(in_file_1, CONCAT22(u_var5, local_10), 2);
            if (BVar4 == 0) {
                g_u16_1050_0310 = 0x6d2;
                return;
            }
    ...
    if (1 < PTR_LOOP_1050_0312) {
        ...
        while (local_6 < local_4) {
            ...
            if ((struct_a | uVar4) == 0) {
                ...
                u_var5 = pass1_1038_6520(CONCAT22(struct_a, uVar4));
            }
            iVar3 = read_from_file_1038_774e(u_var5, pHVar6);
            if (iVar3 == 0) {
                return 0;
            }
            ppcVar1 = ((param_1 + 0x20) + 8);
