...
use crate::defines::{Struct79, Struct_1000_05e2, Struct19, Struct99, U32Ptr, Struct18, Struct13_1};
...
pub fn mem_op_1000_0308(
    ...
    (struct_2.field_0xa) = (struct_1.field_0x4);
    pi_var4 = (param_1 * 0x2 + struct_2);
    if *pi_var4 == 0x0 {
        (struct_1.field_0x6) = struct_1;
        (struct_1.field_0x4) = struct_1;
    } else {
        i_var2 = *pi_var4;
        (struct_1.field_0x6) = i_var2;
        (struct_1.field_0x4) = (i_var2 + 0x4);
        ((i_var2 + 0x4) + 0x6) = struct_1;
        (i_var2 + 0x4) = struct_1;
    }
    *pi_var4 = struct_1;
    return struct_1;
                ...
                ))
    {
        ...
        if (u_var3 | u_stack20) != 0x0 {
            ...
            if pu_var5 != 0x0 {
                ...
                uvar6 = dvar9 as u16;
                if param_3 == 0x1 {
                    u_var7 = pass1_1000_0782(param_4, uvar6, 0x0);
                } else {
                    if param_3 == 0x3 {
                        pass1_1000_05b4(param_6, 0x0);
                    } else {
                        u_var7 = pass1_1000_09ca(uvar6 as i16, 0x0);
                    }
                }
               // param_2 = (dvar9 >> 0x10);
                *pu_var5 = u_var7;
...
pub  fn mem_op_1000_0510(
   ...
   // u_var9 = (d_var12 >> 0x10);
    ...
    if (param_1 != 0x0) {
        ...
        pu_var1 = (i_var4 + 0x24) as u32;
        b_var11 = u_var10 < *pu_var1;
        if ((b_var11 || u_var10 == *pu_var1) && (b_var11 || (u_var7 - u_var8 < (i_var4 + 0x22) as u16))) {
            b_var11 = false;
            u_var9 = u_var10;
...
pub  fn mem_1000_0670(
    ...
    if (param_2 == 0x0) {
        BVar11 = mem_op_1000_14f2(uVar8 | 0x2000, (param_3 + 0x14) as u32, UVar6, param_4 as u16, ctx.data_seg);
        if (BVar11 == 0x0) {
            return 0x0;
        }
    } else {
        ...
        while ((param_2 < u_stack8) || (param_2 <= u_stack8 && (param_1 <= u_stack10))) {
            loop {
                ...
                *param_3 = ctx.s_tile2_bmp_1050_1538;
                d_var2 = GlobalDOSAlloc16(DVar2) as u32;
                u_var1 = d_var2;
                if (u_var1 == 0x0) {
                    break;
                }
...
pub  fn mem_op_1000_160a(
    ...
    if (ctx.PTR_LOOP_1050_5f2e | ctx.PTR_LOOP_1050_5f2c) == 0x0 {
        ...
        ctx._PTR_LOOP_1050_5f2c = mem_op_1000_18ec(
            ctx,
            ctx.DAT_1050_5f46,
            (param_1).unwrap(),
            param_2
...
pub fn mem_op_1000_179c(
    ...
    let mut var3 = 0u16;
    fn_ptr_op_1000_1708(ctx, param_1, &mut var3, 0x0, pu_var1, pu_var2 as i16, param_3);
    return;
}
...
pub fn mem_op_1000_1902(
    ...
    if true {
        ...
        if (u_var3 | p_uvar1) != 0x0 {
            ...
            mem_op_1000_1b9a(0x0, p_uvar1 as u32, u_var3, param_5);
        }
    }
    return 0x0;
}
...
pub unsafe fn mem_op_1000_1b68(param_1: u16, param_2: u16, param_3: u16, param_4: u16) -> u32 {
    ...
    u_var1 = mem_op_1000_1b9a(0x0, param_3 as u32, param_4, param_2);
    return u_var1;
}
...
pub  fn mem_op_1000_1b9a(param_1: u16, param_2: u32, param_3: u16, param_4: u16) -> u32 {
    ...
    uVar3 = (param_2 + 0x10) as u16;
    while (true) {
        puStack8 = CONCAT22(u_var4, uVar3);
        if ((u_var4 | uVar3) == 0x0) {
            break;
        }
        u_var1 = *puStack8;
...
pub unsafe fn mixed_mem_op_1000_3c51(
    ...
    loop {
        ...
        iVar10 = *piVar1;
        piVar3 = piVar6;
        if (iVar10 == param_6) || (piVar3 = (iVar10 + 0x1) as u32, piVar3 == 0x0) {
            return CONCAT22(param_6 as u16, piVar3 as u16);
        }
        iVar10 = -0x1;
        loop {
            if (iVar10 == 0x0) {
