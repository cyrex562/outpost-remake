use crate::{defines::StructA, fn_ptr::fn_ptr_1000::fn_ptr_op_1000_1708, global::AppContext, misc::{empty_fn_1000_214a, ret_true_1000_2146}, pass::pass_1000::{pass1_1000_0368, pass1_1000_0c32, pass1_1000_15ce, pass1_1000_1a54, pass1_1000_1afe, pass1_1000_1e61, pass1_1000_20a2, pass1_1000_25a8, pass1_1000_2913, pass1_1000_52be, pass1_1000_5390}, string::string_1000::poss_str_op_1000_28dc, sys_api::{_SHI_INVOKEERRORHANDLER1, mixed_dos3_call_1000_3636, mixed_dos3_call_1000_39f2}, util::{CARRY2, CONCAT11, CONCAT22, SUB42, make_u16_ptr}, win_struct::HGLOBAL16, winapi::{FatalAppExit16, FatalExit, GLobalAlloc16, GlobalFree16, GlobalHandle16, GlobalPageLock16, GlobalPageUnlock16, GlobalReAlloc16, GlobalSize16, GlobalUnlock16, WIN16_GlobalLock16}};
...

{
  ...
  // if (((param_1.offset(0x40)).read() | (param_1.offset(0x3e)).read()) == 0x0) {
    ...
    d_var6 = mem_op_1000_1532(param_2);
    d_var7 = d_var6;
  }
  else {
    d_var6 = mem_op_1000_1532(param_2);
    ...
    loop {
      ...
      b_var3 = mem_op_1000_14f2(param_1.field_0x16 | 0x1000,d_var7,param_1,ctx.data_seg, 0, 0, 0);
      i_stack4 = (d_var6 >> 0x10) as i16;
      u_stack6 = d_var6 as u16;
      if b_var3 {break;}
      u_var5 = u_var9 >> 0x1;
      if (u_var5 < 0xc) {
        u_var4 = pass1_1000_1e61(param_2,0x2,param_1,ctx.data_seg);
        if (u_var4 == 0x0) {
    ...
    u_var8 = pass1_1000_5390(u_stack6 - 0x42,i_stack4 - ((u_stack6 < 0x42) as i16),0xc,0x0);
  ...
  *pi_var2 = (*pi_var2 - (d_var6 >> 0x10)) - (u_var9 < d_var6);
  if (u_var5 != 0x0) {
    u_var10 = 0x0;
    u_var9 = 0xc;
    d_var7 = mem_op_1000_1532(param_2);
    u_var8 = pass1_1000_5390(d_var7 - 0x42,
                            (d_var7 >> 0x10) - (d_var7 < 0x42),u_var9,u_var10
                           );
...
pub unsafe fn  mem_op_1000_0308(param_1: i16,param_2: i16, param_3: u16) -> i16

{
  ...
  if (param_2 + 0xa) == 0x0 {
    b_var3 = mem_op_1000_01b0(param_2,param_3);
...
pub unsafe fn mem_op_1000_03c6(param_1: u16,param_2: i16,param_3: u16,param_4: u32,
...

{
  ...
  if ((bVar8) ||
    ...
    if (param_3 == 0x3) {
      uStack20 = ((-((param_6 & 0x1) != 0x0) >> 0x8) & 0x1 | 0x20) <<
                 0x8;
    }
    else {
      uStack20 = 0x1000;
    ...
    if ((uVar3 | uStack20) != 0x0) {
      ...
      if (puVar5 != 0x0) {
        ...
        &DAT_1050_0004 = puVar5;
        (&DAT_1050_0004 + 0x2) = ctx.data_seg;
    ...
    pass1_1000_1e61(param_5,0x7,param_4,ctx.data_seg);
  }
  return 0x0;
}
  ...
  param_3: u16) -> u32
{
  ...
  if (param_1 != 0x0) {
    ...
    if ((b_var11 || u_var10 == *pu_var1) &&
       ((b_var11 || (u_var7 - u_var8 < (i_var4 + 0x22))))) {
      b_var11 = false;
      u_var9 = u_var10;
...

{
  ...
  while (((b_var5 || u_var3 == *pu_var1) &&
    ...
    u_var6._0_2_ = mem_op_1000_03c6(param_1 + 0x14,i_var2,0x3,param_4,param_5,
                                   u_var6,u_var6._1_1_);
    ...
    u_var3 = i_var2 + (0xf000 < param_1 + 0x14) + (param_4 + 0x20) +
            CARRY2(u_var3,*pu_var1);
...
pub unsafe fn mem_op_1000_0838(
  ctx: &mut AppContext,
  param_1: u16,
  param_2: u16) -> u32
{
...
// TODO: LAB_1000_085b:
    if ((param_1 + 0x18) == 0x0) {
      pass1_1000_1e61(param_2,0x4,param_1,ctx.data_seg);
      return 0x0;
    }
    u_var5 = (param_1 + 0x1a);
    loop {
      ...
      if (u_stack6 >> 0x1 < (param_1 + 0x18) + 0x14) {
        u_var7 = pass1_1000_1e61(param_2,0x2,param_1,ctx.data_seg);
...

{
  ...
  if ((param_4 + 0x14) == -0x4153) {
    if ((param_3 != 0x0) ||
       ((true && ((ctx.s_version__d__d_1050_0012 + 0x6) < param_2)))) {
      if ((param_3 != 0x0) ||
         ((true && ((ctx.s_version__d__d_1050_0012 + 0xa) < param_2)))) {
...
pub unsafe fn mem_op_1000_0b20(ctx: &mut AppContext, param_1: u16,param_2: u16,param_3: u16,param_4: u16) -> u16

{
  ...
  loop {
    loop {
      if ((u_var5 <= *pu_var7) &&
         (u_var10 = pass1_1000_0c32(u_var5,u_stack20,0x0), u_var10 != 0x0)) {
...
//LAB_1000_0b9e:
      if (((u_stack20 & 0x10) != 0x0) ||
         (u_var3 = u_var2,
         u_var6 = mem_op_1000_03c6((param_2 + 0x1a),0x0,u_var2,param_2,param_4,0x0,
                                  '\0'), (u_var6 | u_var3) == 0x0)) {
...

{
  ...
  l_var3 = CONCAT22(u_stack8,u_stack10);
  i_stack6 = 0x1;
  ...
  if ((param_1 & 0x4) != 0x0) {
    ...
    pass1_1000_15ce(u_stack10,(l_var3 >> 0x10),
...
pub fn mem_op_1000_14f2(param_1: u16,param_2: u32,param_3: &mut StructA,param_4: u16, param_5: u16, param_6: u16, param_7: u16) -> bool

{
 
  // if (((param_1 & 0x1000) != 0x0) || ((param_3 == 0x0 && (param_2 < 0xfff1)))) {
  if (param_1 & 0x1000) || (param_2 < 0xfff10000) {
    mem_op_1000_1408(param_1 & 0xfdff | 0x800,param_2,param_7, 0);
...
pub fn  mem_op_1000_1558(param_1: u16,param_2: u16,param_3: u16) -> i32
...
pub unsafe fn  mem_op_1000_160a(
  ctx: &mut AppContext, 
  param_1: u16,
  param_2: u16) -> *mut u8
{
  ...
  if ((ctx.PTR_LOOP_1050_5f2e | ctx.PTR_LOOP_1050_5f2c) == 0x0) {
    ...
    ctx._PTR_LOOP_1050_5f2c = mem_op_1000_18ec(ctx.DAT_1050_5f46,param_1,param_2);
    if (ctx._PTR_LOOP_1050_5f2c != 0x0) {
      if (ctx.PTR_LOOP_1050_5f42 != 0x0) {
        pass1_1000_1a54(ctx.PTR_LOOP_1050_5f42,ctx._PTR_LOOP_1050_5f2c,
                        (ctx._PTR_LOOP_1050_5f2c >> 0x10),param_2);
      }
      ctx.PTR_LOOP_1050_5f2e = (ctx._PTR_LOOP_1050_5f2c >> 0x10);
      if (ctx.DAT_1050_5f44 != 0xffff) {
        pass1_1000_1afe(ctx.DAT_1050_5f44,ctx.PTR_LOOP_1050_5f2c,
...

{
  ...
  l_var2 = mem_op_1000_0a48(ctx, 0x0,param_1,0x0,CONCAT22(ctx.PTR_LOOP_1050_5f2e,PTR_LOOP_1050_5f2c) , param_2);
  return l_var2;
}
  ...
  param_3: u16)
{
  ...
  fn_ptr_op_1000_1708(param_1,0x0,0x0,pu_var1,pu_var2,param_3);
  return;
}
...
pub fn mem_op_1000_1dfa(param_1: i16,param_2: u8,param_3: u16,param_4: u16) -> bool
{
  ...
  if ((param_2 & 0x4) == 0x0) {
    uVar2 = (((-((param_2 & 0x2) == 0x0) >> 0x8) & 0xfe) + 0x92)
            << 0x8;
  }
  else {
    uVar2 = 0x1800;
  ...
  if (((param_4 == 0x0) || (false)) ||
     ((param_4 & 0xff00 &
      (((-((param_2 & 0x4) == 0x0) >> 0x8) & 0x82) + 0x18) << 0x8)
      != uVar2)) {
    return 0x1;
  }
  if (param_1 != 0x0) {
...
pub unsafe fn mem_1000_2bb6(param_1: u16,param_2: &mut i16,param_3: i16,param_4: u16,param_5: u16,
       ...
       (((bVar4 & 0x4) != 0x0 ||
        ((((param_2 + 0x78) & 0x1) == 0x0 &&
         (((ctx.PTR_LOOP_1050_61ec != 0x0 &&
          ...
          (mem_1000_2ce8(param_2,param_8,param_5), ((piVar3 + 0x5) & 0x8) == 0x0)
          ))))))) {
      puVar5 = mixed_dos3_call_1000_39f2
                         (puVar7,CONCAT22(param_6,&param_1),
                          (&ctx.PTR_LOOP_1050_0000 + 0x1),param_4,param_5,
                          param_6,param_7);
...
pub unsafe fn mem_1000_2ce8(param_1: &mut i16,param_2: u16,param_3: u16)
{
  let piVar1: *mut i16;
  let uVar2: u16;
