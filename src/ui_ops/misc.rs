...
use crate::{mixed_fn_1010_830a, string_ops1, struct_ops2, sys_ops, sys2, ui_ops, winapi_funcs};
...
use crate::file_ops::close::{close_file_1008_496c, close_file_1008_6dd0, close_file_1008_6e78};
use crate::file_ops::read::read_file_1008_7dee;
...
use crate::other_funcs::{return3_1010_088c, return3_1010_0892, return3_1010_0898, return_10_1010_0886, set_timer_1008_91ba, switch_statement_1008_73ea, switch_stmt_1008_d818, zero_array_val_1008_5394, zero_list_1008_3e38};
...
use crate::prog_structs::prog_structs_10::{Struct62, Struct73};
use crate::prog_structs::prog_structs_12::{Struct431, Struct94};
use crate::prog_structs::prog_structs_16::Struct588;
use crate::prog_structs::prog_structs_17::Struct61;
use crate::prog_structs::prog_structs_18::{Struct180, Struct566};
use crate::prog_structs::prog_structs_1::Struct104;
use crate::prog_structs::prog_structs_2::{Struct199, Struct318, Struct7};
use crate::prog_structs::prog_structs_21::{Struct12, Struct25};
use crate::prog_structs::prog_structs_23::{Struct356, Struct387, Struct43, win_struct_42};
use crate::prog_structs::prog_structs_24::{Struct103, Struct2111, Struct6};
use crate::prog_structs::prog_structs_25::{Struct219, Struct63, Struct65, Struct67, Struct71};
use crate::prog_structs::prog_structs_26::{Struct22, Struct339, Struct340, Struct59};
use crate::prog_structs::prog_structs_27::{pass1_struct_2, Struct298};
use crate::prog_structs::prog_structs_28::{Struct24, Struct300, Struct351, Struct40, Struct434, Struct447};
use crate::prog_structs::prog_structs_29::{Struct123, Struct179, Struct23, Struct362, Struct41, Struct48};
use crate::prog_structs::prog_structs_30::{Struct119, Struct124, Struct347};
use crate::prog_structs::prog_structs_31::{Struct112, Struct16, Struct17, Struct20, Struct27, Struct32, Struct382, Struct4, Struct47};
use crate::prog_structs::prog_structs_3::Struct661;
use crate::prog_structs::prog_structs_4::Struct650;
use crate::prog_structs::prog_structs_6::{Struct622, Struct675};
use crate::prog_structs::prog_structs_7::{Struct376, Struct44, Struct628, Struct629};
use crate::prog_structs::prog_structs_8::{Struct60, Struct68};
use crate::prog_structs::prog_structs_9::{Struct594, Struct604, Struct636, Struct637};
...
use crate::string_ops1::{copy_string_1000_3d3e, fn_1008_6048, get_string_index_1000_3da4, load_string_1008_b1f0, process_string_1000_3cea, process_string_1000_3dbe, process_string_1000_472c, process_string_1000_4d58, string_fn_1000_3f9c, string_fn_1008_5fd8};
use crate::struct_ops1::{process_struct_1000_179c, process_struct_1008_3ab8, process_struct_1008_4772, process_struct_1008_47cc, process_struct_1008_4834, process_struct_1008_48fe, process_struct_1008_4c58, process_struct_1008_574a, process_struct_1008_e3ec, process_struct_1008_e586, process_struct_1010_1d48, process_struct_1010_60fa, process_struct_1020_62e0, process_struct_1040_bf3e, struct_fn_1000_160a};
use crate::struct_ops2::{pass1_1038_7d10, pass1_1038_88f2, pass1_1038_8caa, pass1_1038_9f76, pass1_1038_ab82, pass1_1038_b772, pass1_1038_bddc, pass1_1038_c4a2, pass1_1038_c7b8, pass1_1038_cad8, pass1_1038_cd06, pass1_1038_d242, pass1_1038_d756, pass1_1038_e140, pass1_1038_e2d0, pass1_1038_e69a, pass1_1038_e99a, pass1_1038_eb9e, pass1_1038_eeda, pass1_1040_06e8, pass1_1040_0bfc, pass1_1040_0e1c, pass1_1040_123e, pass1_1040_181c, pass1_1040_1cb4, pass1_1040_1f5a, pass1_1040_2ea2, pass1_1040_34a2, process_struct_1020_04f6, process_struct_1020_0baa, process_struct_1040_7728, process_struct_1040_9824, process_struct_1040_a598, set_struct_1018_36e6};
...
use crate::sys_ops::win::{create_win_1008_9760, win_cleanup_func_1040_b0f8, win_fn_1038_c374, win_fn_1040_3374, win_func_1018_6bb6};
use crate::sys_ops::win_msg::{post_win_msg_1040_7b3c, process_win_msg_1008_9510, send_msg_1010_7c42, send_msg_1040_1696, send_msg_1040_323c, send_win_msg_1008_84ba, send_win_msg_1020_097e, send_win_msg_1038_c228};
...
pub fn gui_fn_1008_2c4e(param_1: *mut Struct16, param_2: u16, param_3: u16) {
    ...
    window::show_window_1038_b634(ctx._g_Struct112_a, (ctx._g_Struct112_a >> 0x10));
...
pub fn win_fn_1040_a784(
    ...
    if (param_3._2_2_ != 0xeb) {
        ...
        if (param_3._2_2_ == 0x1f7) {
            ...
            pass1_1038_af40(ctx._g_Struct112_a, *&param_1.field_0x8, 0x23);
...
pub fn win_fn_1040_cace(param_1: u32) {
    ...
    pass1_1038_af40(ctx._g_Struct112_a, *(i_var5 + 8), u_var8);
    return;
}
...
pub fn win_fn_1008_1414(param_1: u32, param_2: u32) {
    ...
    cursor::set_cursor_1008_2dcc(i_var7, u_var10, 8);
    _local_c = process_struct_1010_20ba(ctx._g_Struct372_1050_0ed0, CONCAT22(unaff_DI, 0x2f));
    u_var8 = (_local_c >> 0x10);
    local_10 = (_local_c + 0x20);
...
pub fn win_fn_1008_2d22(param_1: u32) {
        ...
        ))
    {
        ...
        if ((i_var4 + 0xe8) != 0) {
            ...
            (**ppc_var3)();
            window::show_win_1038_b68a(ctx._g_Struct112_a, (ctx._g_Struct112_a >> 0x10));
            u_var2 = (i_var4 + 0xf4);
...
pub fn win_fn_1040_65ba(param_1: &mut Struct20) {
    ...
    win_gui_func_1040_78e2(param_1);
    _local_6 = struct_ops2::process_struct_1010_20ba(ctx._g_Struct372_1050_0ed0, CONCAT22(unaff_si, 0x2b));
...
pub fn win_fn_1040_5800(param_1: &mut Struct124, param_2: u16, param_3: u16, param_4: u32) {
    ...
    if (param_2._2_2_ == 0xeb) {
        _local_6 = struct_ops2::process_struct_1010_20ba(ctx._g_Struct372_1050_0ed0, CONCAT22(unaff_si, 3));
...
pub fn win_fn_1040_477e(param_1: u32) {
    ...
    ppVar6 = struct_ops2::process_struct_1010_20ba(ctx._g_Struct372_1050_0ed0, CONCAT22(in_stack_0000ffee, 3));
    u_var4 = (ppVar6 >> 0x10);
...
pub fn win_gui_fn_1040_45e8(param_1: &mut Struct124, param_2: u16, param_3: u16, param_4: u32) {
    ...
    pp_var8 = struct_ops2::process_struct_1010_20ba(ctx._g_Struct372_1050_0ed0, CONCAT22(unaff_si, 3));
...
pub fn win_fn_1040_410e(param_1: &mut Struct20) {
    ...
    if ((local_1c == 0) && (local_1e == 0)) {
        ...
        pu_var5 = &local_36;
        pcVar7 = unaff_ss;
        ppVar4 = struct_ops2::process_struct_1010_20ba(ctx._g_Struct372_1050_0ed0, CONCAT22(pu_var5, 0x48));
        pass1_1008_3e94(
            (ppVar4 + 0xe),
...
pub fn win_func_1040_3c64(param_1: i32, param_2: u16, param_3: u16, param_4: u32) {
    ...
    if (param_3._2_2_ == (s_You_may_not_run_a_turn__The_game_1050_0172 + 0x14)) {
        ...
        b_var5 = 1;
        paVar4 = struct_ops2::process_struct_1010_20ba(ctx._g_Struct372_1050_0ed0, 0x1002b);
...
pub fn gui_win_fn_1040_3b1e(param_1: &mut Struct25) {
    ...
    _local_6 = struct_ops2::process_struct_1010_20ba(ctx._g_Struct372_1050_0ed0, CONCAT22(unaff_si, 2));
...
pub fn win_fn_1040_37f0(param_1: i32, param_2: u16, param_3: u16, param_4: u32) {
    ...
    if (param_3._2_2_ == 0x193) {
        _local_6 =
            struct_ops2::process_struct_1010_20ba(ctx._g_Struct372_1050_0ed0, CONCAT22(in_stack_0000fbec, 2));
        local_a = (_local_6 + 0x68);
        load_string_1010_84e0(
            ctx._g_struct_73_1050_14cc,
            (ctx._g_struct_73_1050_14cc >> 0x10),
        ...
        SendMessage16(0, 2, 0x111, (param_1 + 6));
        b_var1 = 1;
        _local_6 = struct_ops2::process_struct_1010_20ba(ctx._g_Struct372_1050_0ed0, 0x1002b);
...
pub fn win_fn_1040_3590(param_1: u32) {
    ...
    _local_408 = struct_ops2::process_struct_1010_20ba(ctx._g_Struct372_1050_0ed0, CONCAT22(local_5b0, 2));
...
pub fn win_fn_1040_311a(param_1: i32, param_2: u16, param_3: u16, param_4: u32) {
    ...
    if (param_2._2_2_ == 0x181) {
        ...
        SendMessage16(0, 2, 0x111, (param_1 + 6));
        BVar7 = 1;
        pa_var5 = struct_ops2::process_struct_1010_20ba(ctx._g_Struct372_1050_0ed0, 0x1002b);
        ...
        window::set_window_pos_1040_331a(param_1, param_2_00, param_3, param_2, param_2._2_2_);
    }
    return;
}
...
pub fn win_fn_1040_2f90(param_1: u32) {
    ...
    _local_6 = struct_ops2::process_struct_1010_20ba(
        ctx._g_Struct372_1050_0ed0,
    ...
    ppVar5 = struct_ops2::process_struct_1010_20ba(ctx._g_Struct372_1050_0ed0, CONCAT22(local_120, 0x2f));
    u_var2 = (ppVar5 + 0x24);
    ...
    if (param_3 != 2) {
        ...
        if (0x19d < param_3 - 2) {
            ...
            if (u_var4 == 0) {
                ...
                _local_16 = struct_ops2::process_struct_1010_20ba(
                    ctx._g_Struct372_1050_0ed0,
...
pub fn pass1_1040_109c(param_1: i32, param_2: Vec<u8>, param_3: Vec<u8>, param_3_00: Vec<u8>) {
    ...
    if (param_3_00._2_2_ == 0x1c1) {
        ...
        if (param_3_00._2_2_ == 0x1c2) {
            ...
            ppVar4 = struct_ops2::process_struct_1010_20ba(
                ctx._g_Struct372_1050_0ed0,
...
pub fn win_fn_1040_07dc(param_1: i32, param_2: u16, param_3: u16, param_4: u16, param_5: i32) {
    ...
    if (param_3 == 0x73) {
        ...
        if (i_var3 == 6) {
            ...
            local_6 = CONCAT22(ctx.dx_reg, b_var4);
            pa_var7 =
                struct_ops2::process_struct_1010_20ba(ctx._g_Struct372_1050_0ed0, CONCAT22(local_810._2_2_, 2));
...
pub fn win_fn_1040_0000(param_1: &mut Struct20) {
    ...
    _local_12 = struct_ops2::process_struct_1010_20ba(ctx._g_Struct372_1050_0ed0, CONCAT22(unaff_si, 0x48));
...
pub fn win_fn_1038_d8ae(param_1: &mut Struct20) {
    ...
    _local_e = struct_ops2::process_struct_1010_20ba(ctx._g_Struct372_1050_0ed0, CONCAT22(in_stack_0000ffd0, 2));
...
pub fn win_fn_1038_d400(param_1: i32, param_2: u16, param_3: u16, param_4: u32) {
    ...
    match (param_2._2_2_) {
        ...
        0x146 => {
            ...
            u_var7 = 0x86;
            ppVar3 = struct_ops2::process_struct_1010_20ba(ctx._g_Struct372_1050_0ed0, 0x860009);
...
pub fn win_fn_1038_d2a2(param_1: &mut Struct20) {
    ...
    u_var8 = 0x86;
    _local_e = struct_ops2::process_struct_1010_20ba(ctx._g_Struct372_1050_0ed0, 0x860009);
    ...
    if (param_2._2_2_ == 0x177) {
        ...
        if (param_2._2_2_ != 0x178) {
            if ((param_2._2_2_ != 0x178) && (param_2._2_2_ - 0x179 < 2)) {
                window::set_window_pos_1038_c31a(param_1, param_2_00, param_3, param_2, param_2._2_2_);
                return;
            }
            post_win_msg_1040_7b3c(param_1, param_2_00, param_3, param_2, param_2._2_2_);
            return;
...
pub fn win_fn_1038_a788(param_1: u32, param_2: i32) {
    ...
    if (param_2 != 0) {
        ...
        if (u_var1 != 0) {
            pu_var5 = local_52;
            ppVar4 = struct_ops2::process_struct_1010_20ba(ctx._g_Struct372_1050_0ed0, CONCAT22(pu_var5, 2));
...
pub fn win_fn_1038_a584(param_1: u32, param_2: i32) {
    ...
    if (param_2 != 0) {
        ...
        if (u_var1 != 0) {
            pu_var5 = local_52;
            paVar4 = struct_ops2::process_struct_1010_20ba(ctx._g_Struct372_1050_0ed0, CONCAT22(pu_var5, 2));
...
pub fn win_fn_1038_9bc8(param_1: &mut Struct20) {
    ...
    HVar7 = unaff_ss;
    HVar14 = unaff_ss;
    _local_a = struct_ops2::process_struct_1010_20ba(ctx._g_Struct372_1050_0ed0, CONCAT22(pu_var11, 0x48));
    pass1_1008_3e94(
        (_local_a + 0xe),
    ...
    u_var9 = 0x1010;
    ppVar10 = struct_ops2::process_struct_1010_20ba(ctx._g_Struct372_1050_0ed0, in_string_1);
...
pub fn win_fn_1038_95fc(param_1: u32) {
    ...
    _local_6 = struct_ops2::process_struct_1010_20ba(ctx._g_Struct372_1050_0ed0, CONCAT22(unaff_si, 8));
    _local_a = struct_ops2::process_struct_1010_20ba(ctx._g_Struct372_1050_0ed0, CONCAT22(unaff_si, 9));
...
pub fn win_gui_fn_1038_8d98(param_1: &mut Struct124, param_2: u16, param_3: u16, param_4: u32) {
    if (param_3._2_2_ == 0xeb) {
        ...
        string_ops1::load_Str_1038_8dda(CONCAT22(param_2, param_1));
    }
    return;
}
...
pub fn win_gui_fn_1020_7824(param_1: &mut Struct622, param_2: u16) {
    ...
    (param_1 + 2) = 0x1020;
    ppVar2 = struct_ops2::process_struct_1010_20ba(ctx._g_Struct372_1050_0ed0, CONCAT22(local_e, 0x25));
...
pub fn win_gui_fn_1020_43f6(in_struct_1: &mut win_struct_42) {
    ...
    ppVar1 = struct_ops2::process_struct_1010_20ba(ctx._g_Struct372_1050_0ed0, CONCAT22(uStack10, 0x32));
...
pub fn win_fun_1020_2ae4(param_1: &mut u32, param_2: i32) {
    ...
    if (param_2 != 0x129) {
        ...
        if (param_2 == 0xfb) {
            pp_var7 = struct_ops2::process_struct_1010_20ba(ctx._g_Struct372_1050_0ed0, CONCAT22(local_c, 0x30));
        ...
        if (param_2 < 0xfc) {
            ...
            if (cVar3 == 'r') {
                ...
                u_var4 = u_var6;
                pp_var7 =
                    struct_ops2::process_struct_1010_20ba(ctx._g_Struct372_1050_0ed0, CONCAT22(i_var8, 0x30));
...
pub fn win_fn_1020_2cf0(param_1: &mut win_struct_42) {
    ...
    u_var7 = (param_1 >> 0x10);
    i32_var6 = param_1;
    pp_var8 = struct_ops2::process_struct_1010_20ba(
        ctx._g_Struct372_1050_0ed0,
...
pub fn gui_win_fn_1020_2ede(param_1: &mut u16, param_2: u32) {
    ...
    (i_var15 + 2) = 0x1020;
    ppVar6 = struct_ops2::process_struct_1010_20ba(
        ctx._g_Struct372_1050_0ed0,
