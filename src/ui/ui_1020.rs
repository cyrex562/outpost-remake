...
use crate::draw::draw_1020::{
    invalidate_rect_1020_735a, load_draw_op_1020_2ede, pt_in_rect_1020_5856, unk_draw_op_1020_3da4,
};
...
use crate::pass::pass_1008::{
    pass1_1008_3e54, pass1_1008_4d84, pass1_1008_5118, pass1_1008_5236, pass1_1008_6978,
    pass1_1008_8ce4, pass1_1008_941a, pass1_1008_9436,
};
use crate::pass::pass_1010::{
    pass1_1010_089e, pass1_1010_1ea6, pass1_1010_375e, pass1_1010_3770, pass1_1010_41d6,
    pass1_1010_451a, pass1_1010_459e, pass1_1010_4674, pass1_1010_4788, pass1_1010_4df0,
    pass1_1010_65d0,
};
use crate::pass::pass_1018::{
    pass1_1018_04b8, pass1_1018_0ac0, pass1_1018_0ad4, pass1_1018_0afa, pass1_1018_0b08,
    pass1_1018_1662, pass1_1018_169e, pass1_1018_1a8e, pass1_1018_1e78, pass1_1018_1f1a,
    pass1_1018_255e, pass1_1018_2afa, pass1_1018_2d22, pass1_1018_2d84, pass1_1018_2e5e,
    pass1_1018_30fc, pass1_1018_57e6,
};
...
use crate::win_struct::{
    HCURSOR16, HDC16, HGDIOBJ16, HMENU16, HPALETTE16, HWND16, PAINTSTRUCT16, POINT16, RECT16,
    SEGPTR, WNDCLASS16,
};
use crate::winapi::{
    BeginPaint16, BringWindowToTop16, ClientToScreen16, CreateWindow16, DeleteObject16,
    DestroyWindow16, DrawIcon16, EnableMenuItem16, EndPaint16, EnumChildWindows1, FillRect16,
    FreeProcInstance16, GetClientRect16, GetDC16, GetDlgItem16, GetStockObject16, GetSubMenu16,
    GetSystemMetrics16, GetWindowRect16, GetWindowText16, InvalidateRect16, IsIconic16, LoadMenu16,
    MakeProcInstance16, MoveWindow16, PostMessage16, PtInRect16, RealizePalette16,
    ReleaseCapture16, SelectPalette16, SendMessage16, SetCursor16, SetDlgItemText16, SetFocus16,
    SetWindowPos16, SetWindowText16, ShowWindow16, TrackPopupMenu16, UnrealizeObject16,
    UpdateWindow16,
};
...
pub fn win_help_op_1020_0ec4(param_1: U32Ptr, param_2: u16, param_3: u16) {
    ...
    u_var3 = param_1;
    if (param_2 == 0xfb) {
        pu_var5 = mixed_1010_20ba(ctx.PTR_LOOP_1050_0ed0, 0x30, param_3, in_DX, unaff_DI);
        pass1_1010_375e(pu_var5);
        ppcVar1 = (*param_1 + 0x14);
        (**ppcVar1)();
        u_var6 = pass1_1010_375e(pu_var5);
        // u_var4 = (u_var6 >> 0x10);
        pass1_1010_4788(
            (u_var3 + 0xf2),
            (u_var6 & 0xffff | u_var4 << 0x10),
            u_var6,
            u_var4,
        );
        return;
    ...
    if (param_2 < 0xfc) {
        if (param_2 == 0xf3) {
            ...
            cVar2 = param_2;
            if (cVar2 == 'o') {
                paVar7 = unk_io_op_1010_830a(ctx.PTR_LOOP_1050_14cc, 0x1f8, param_3);
                WinHelp16(
                    0x1010,
                    (s_New_failed_in_Op__Op_1050_0020 + 0x8),
                    0x0,
                    CONCAT22(paVar7, 0x1),
                );
                return;
            ...
            if (cVar2 == 'r') {
                ...
                pu_var5 = mixed_1010_20ba(ctx.PTR_LOOP_1050_0ed0, 0x30, param_3, in_DX, unaff_DI);
                // u_var4 = (pu_var5 >> 0x10);
                pass1_1010_3770(pu_var5, CONCAT22(uVar9, iVar10), u_var4);
                pass1_1038_af40(
        ...
        pass1_1010_4674((u_var3 + 0xf2), iVar10, 0x1010, param_3);
        return;
    }
    if (true) {
        match (param_2) {
...
pub fn window_op_1020_10a0(param_1: &mut Struct1) {
    let u_var1: u32;
    let ppcVar2: u32;
    ...
    puVar7 = mixed_1010_20ba(ctx.PTR_LOOP_1050_0ed0, 0x2d, unaff_SS, pu_var5, unaff_DI);
    // uVar9 = (puVar7 >> 0x10);
    (iVar11 + 0xf2) = puVar7;
    (iVar11 + 0xf4) = uVar9;
    ...
    u_var3 = LoadIcon16(0x1010, ctx.s_PLNTICON_1050_4267);
    (iVar11 + 0xc2) = u_var3;
    u_var1 = (iVar11 + 0xf2);
    ...
    if (puVar6 == 0x0) {
        ...
        unk_win_ui_op_1020_1418(CONCAT22(pu_var5, u_var3), param_1, unaff_SS);
        (iVar11 + 0xf6) = u_var3;
        (iVar11 + 0xf8) = puVar6;
    }
    (iVar11 + 0xe8) = (iVar11 + 0xf6);
    puVar7 = mixed_1010_20ba(ctx.PTR_LOOP_1050_0ed0, 0x2f, unaff_SS, puVar6, unaff_DI);
    uVar8 = pass1_1018_04b8(puVar7);
    // pu_var5 = (uVar8 >> 0x10);
    pass1_1010_41d6((iVar11 + 0xf2), uVar8, pu_var5, unaff_SS, in_AF);
    uVar8 = pass1_1010_451a((iVar11 + 0xf2), pu_var5, unaff_DI, unaff_SS);
    pBVar4 = uVar8;
    u_var1 = param_1;
    ppcVar2 = (u_var1 + 0x14);
...
pub fn win_ui_cursor_op_1020_1294(
    ...
    if ((param_4 | in_AX) == 0x0) {
        ...
        u_var6 = (i_var4 + 0xf2);
        puStack14 = (u_var6 & 0xffff0000 | (u_var6 + 0x76));
        pass1_1008_3e94(
            puStack14,
        ...
        local_6 -= local_10;
        i_stack4 -= local_12;
        i_var4 = pt_in_rect_1010_40f8((i_var4 + 0xf2), CONCAT22(param_5, &local_6), 0x1010);
        if (i_var4 != -0x1) {
            u_var6 = 0x0;
            HVar2 = LoadCursor16(0x1010, 0x7f02);
            u_var6 = u_var6 & 0xffff0000 | HVar2;
...
pub fn unk_win_ui_op_1020_1418(param_1: &mut Struct40, param_2: i32, param_3: u16) {
    ...
    puVar8 = clear_struct_1008_3e38((param_1 & 0xffff0000 | &iVar5.field_0x1e));
    param_1 = 0x1730;
    ...
    puStack6 = mixed_1010_20ba(ctx.PTR_LOOP_1050_0ed0, 0x29, param_3, puVar6, unaff_DI);
...
pub fn win_ui_op_1020_150e(param_1: U32Ptr, param_2: HDC16) {
    ...
    *param_1 = 0x1730;
    ...
    if ((i_var2 + 0x14) != 0x0) {
        param_2 = 0x1010;
        pass1_1010_1ea6((i_var2 + 0x14), param_1 & 0xffff | u_var3 << 0x10, unaff_SS);
    }
    HVar1 = SelectPalette16(param_2, 0x0, (i_var2 + 0x1c));
    (i_var2 + 0x1c) = HVar1;
...
pub fn mixed_ui_op_1020_179c(param_1: &mut Struct1) {
    ...
    let puVar14: U32Ptr;
    let in_resc_id_3: &WNDCLASS16;
    let in_buffer_4: &WNDCLASS16;
    let local_178: [WNDCLASS16; 0xc];
    let uStack118: u32;
    let uStack114: u32;
    let local_6e: RECT16;
    let uStack106: u32;
    ...
    let mut pIStack12: i16;
    let uStack8: u16;
    let puStack6: U32Ptr;

    dialog_ui_fn_1040_78e2(param_1, &ctx.PTR_LOOP_1050_1040);
    u_var4 = 0x89;
    puStack6 = mixed_1010_20ba(ctx.PTR_LOOP_1050_0ed0, 0x9, unaff_SS, in_DX, unaff_DI);
    ...
    puVar14 = mixed_1010_20ba(ctx.PTR_LOOP_1050_0ed0, 0x39, unaff_SS, puVar7, unaff_DI);
    // uVar12 = (puVar14 >> 0x10);
    uVar8 = puVar14;
    ...
    (i_var9 + 0x8e) = uVar8;
    (i_var9 + 0x90) = uVar12;
    ppcVar2 = ((i_var9 + 0x8e) + 0x10);
    (**ppcVar2)(0x1010, (i_var9 + 0x8e), uVar12, uStack8);
    ...
    *pIStack12 = iVar10 / 0x2;
    ...
    if ((u_var4 == 0x0) || ((i_var9 + 0x96) != 0x0)) {
        ...
        pvStack60 = MakeProcInstance16(ctx.s_tile2_bmp_1050_1538, ctx.PTR_LOOP_1050_038c);
        ...
        MoveWindow16(
            ...
            iStack94,
            iStack98,
            uStack118._2_2_ - IVar5,
            uStack118,
        );
    } else {
        win_1008_5c7c(ctx.PTR_LOOP_1050_02a0, 0x9d0001, unaff_SS, u_var4, uStack58);
        (i_var9 + 0x8c) = u_var4;
        pvStack60 = MakeProcInstance16(0x1008, ctx.PTR_LOOP_1050_038c);
    }
...
pub fn window_op_1020_2642(param_1: &mut Struct1) {
    ...
    // u_var3 = (param_1 >> 0x10);
    i_var2 = param_1;
    get_dc_1018_4db0((i_var2 + 0xf2), (i_var2 + 0x8), 0x1018);
    mem_op_1000_179c(0x18, in_DX, 0x1000);
    u_var1 = in_DX | in_AX;
    if (u_var1 != 0x0) {
        pass1_1020_27b0(in_AX, in_DX, (i_var2 + 0x8), unaff_DI, unaff_SS);
        (i_var2 + 0xee) = in_AX;
        (i_var2 + 0xf0) = u_var1;
        return;
    }
...
pub fn send_msg_1020_29d8(
    ...
    pu_var2 = mixed_1010_20ba(ctx.PTR_LOOP_1050_0ed0, 0x29, unaff_SS, param_6, unaff_DI);
    // pu_var1 = (pu_var2 >> 0x10);
    if (i_var3 == 0x0) {
        pass1_1018_270e(pu_var2, 0x1, (param_1 + 0xfc), pu_var1, unaff_DI, unaff_SS);
    } else {
        pass1_1018_270e(pu_var2, 0x0, (param_1 + 0xfc), pu_var1, unaff_DI, unaff_SS);
...
pub fn enable_menu_item_1020_2c2a(HMENparam_1: u16, param_2: i16) -> bool {
    ...
    b_var1 = EnableMenuItem16(ctx.s_tile2_bmp_1050_1538, w_item_id, 0x5);
    return b_var1;
}

pub fn win_ui_op_1020_2cf0(param_1: &mut Struct1) {
    let u_var1: u32;
    let ppcVar2: u32;
    let u_var3: u16;
    bool * pBVar4;
    ...
    (i_var8 + 0xf2) = puVar10;
    (i_var8 + 0xf4) = u_var5;
    (i_var8 + 0xe0) = (i_var8 + 0xf2);
    (i_var8 + 0xe2) = u_var5;
    puVar12 = ctx.PTR_LOOP_1050_038c;
    u_var3 = LoadIcon16(0x1010, ctx.s_SITEICON_1050_428d);
    (i_var8 + 0xc2) = u_var3;
    u_var1 = (i_var8 + 0xf2);
    ppcVar2 = ((i_var8 + 0xf2) + 0x30);
    (**ppcVar2)(
        ctx.s_tile2_bmp_1050_1538,
        u_var1,
        (u_var1 >> 0x10),
    ...
    if (uVar7 == 0x0) {
        ...
        load_draw_op_1020_2ede(CONCAT22(puVar6, u_var3), param_1, 0x1000);
        (i_var8 + 0xf6) = u_var3;
        (i_var8 + 0xf8) = uVar7;
    }
    (i_var8 + 0xe8) = (i_var8 + 0xf6);
    pass1_1018_0ac0((i_var8 + 0xf2), param_1 & 0xffff | uVar9 << 0x10);
    u_var11 = pass1_1018_0b08((i_var8 + 0xf2));
    pBVar4 = u_var11;
    ppcVar2 = (param_1 + 0x14);
    (**ppcVar2)();
    ppcVar2 = ((i_var8 + 0xf2) + 0x10);
    (**ppcVar2)();
...
pub fn win_ui_op_1020_36f6(param_1: u32, param_2: i16, param_3: i16) {
    ...
    puStack1034 = CONCAT22(u_var6, pcVar4 + 0x2);
    *puStack1034 = 0x0;
    load_string_1010_84e0(
        0x1010,
        ctx.PTR_LOOP_1050_14cc,
    ...
    fn_ptr_2 = ((iVar7 + 0x18) + 0x18);
    (**fn_ptr_2)();
    u_var3 = (iVar7 + 0x8);
    i_var1 = (u_var3 + 0x4a);
    u_var3 = (uStack6 + 0x2);
    let mut string_3 = read_string_from_addr(u_var3 >> 0x10);
    SetDlgItemText16(0x1010, u_var3, string_3);
    u_var3 = (uStack6 + 0xa);
    SetDlgItemText16(ctx.s_tile2_bmp_1050_1538, u_var3, string_3);
    u_var3 = (uStack6 + 0x12);
    SetDlgItemText16(ctx.s_tile2_bmp_1050_1538, u_var3, string_3);
    u_var3 = (uStack6 + 0xe);
    SetDlgItemText16(ctx.s_tile2_bmp_1050_1538, u_var3, string_3);
...
pub fn window_op_1020_38aa(param_1: &mut Struct1) {
    let ppcVar1: u32;
    let u_var2: u16;
    ...
    // uVar12 = (param_1 >> 0x10);
    create_window_ex_1008_9760(param_1, 0x1008);
    puVar10 = mixed_1010_20ba(ctx.PTR_LOOP_1050_0ed0, 0x6, unaff_SS, in_DX, unaff_DI);
    // u_var5 = (puVar10 >> 0x10);
    (u_var11 + 0xfa) = puVar10;
    (u_var11 + 0xfc) = u_var5;
    ...
    ppcVar1 = ((u_var11 + 0xfa) + 0x4);
    (**ppcVar1)(0x1010, (u_var11 + 0xfa), 0x0, u_var2, uVar8);
    puVar7 = extraout_dx;
    pass1_1018_1a8e((u_var11 + 0xfa), extraout_dx, unaff_DI, unaff_SS);
    ...
    if (puVar7 == 0x0) {
        ...
        pass1_1008_3bd6(
            ...
            0x0,
            0x1ac01ad,
            CONCAT22((u_var11 + 0x8), 0xf4),
            puVar7,
            unaff_SS,
        );
        (u_var11 + 0x102) = paVar3;
        (u_var11 + 0x104) = puVar7;
    }
    HVar9 = 0x1000;
    ...
    if (uVar8 == 0x0) {
        ...
        pass1_1008_3bd6(
            ...
            0x0,
            0x1ae01af,
            CONCAT22((u_var11 + 0x8), 0xf5),
            uVar8,
            unaff_SS,
        );
        (u_var11 + 0x106) = paVar3;
        (u_var11 + 0x108) = uVar8;
    }
    u_var4 = (u_var11 + 0xfa);
    ppcVar1 = ((u_var11 + 0xfa) + 0x10);
    ...
    if (u_var2 == 0x0) {
        ...
        get_sys_metrics_1040_7728(CONCAT22(puVar7, uVar8), 0x1, 0x0, 0xfc0, (u_var11 + 0x8));
        (u_var11 + 0x10a) = uVar8;
        (u_var11 + 0x10c) = u_var2;
    }
    u_var4 = (u_var11 + 0x10a);
    (u_var4 + 0x74) = 0x1;
    u_var4 = (u_var11 + 0x10a);
    ppcVar1 = ((u_var11 + 0x10a) + 0x8);
    (**ppcVar1)(HVar9, u_var4, (u_var4 >> 0x10));
    if (((u_var11 + 0x10c) | (u_var11 + 0x10a)) != 0x0) {
        GetWindowRect16(HVar9, &local_a);
        GetWindowRect16(ctx.s_tile2_bmp_1050_1538, &local_12);
        iStack12 -= local_12.y;
        iStack14 = i_stack6 - local_a.x;
        local_12.x = local_a.x;
        local_12.y = i_stack4 + 0x3;
        SetWindowPos16(
            ctx.s_tile2_bmp_1050_1538,
            0x44,
            iStack12,
...
pub fn win_1020_43f6(param_1: &mut Struct1, param_2: U32Ptr, param_3: u16) {
    let ppcVar1: u32;
    let i_var2: i16;
    let u_var3: u16;
    let u_var4: u16;
    ...
    let lVar8: i32;
    let uVar9: u16;
    let i_var9: &mut Struct282;

    i_var9 = param_1;
    // uVar9 = (param_1 >> 0x10);
    create_window_ex_1008_9760(param_1, 0x1008);
    get_dc_1018_4db0(i_var9.field_0xfa, i_var9.field_0x8, 0x1018);
    puVar7 = mixed_1010_20ba(ctx.PTR_LOOP_1050_0ed0, 0x32, param_3, param_2, unaff_DI);
    &i_var9.field_0x10e = puVar7;
    (&i_var9.field_0x10e + 0x2) = (puVar7 >> 0x10);
    if (param_1 == 0x0) {
        i_var2 = 0x0;
        u_var4 = 0x0;
    } else {
        i_var2 = &i_var9.field_0xe2;
        u_var4 = uVar9;
    }
    ppcVar1 = (*i_var9.field_0x10e + 0x4);
    lVar8 = (**ppcVar1)(0x1010, i_var9.field_0x10e, 0xb, i_var2, u_var4);
    mem_op_1000_179c(0x30, (lVar8 >> 0x10), 0x1000);
    // u_var5 = (lVar8 >> 0x10);
    u_var3 = lVar8;
    u_var6 = u_var5 | u_var3;
    if (lVar8 == 0x0) {
        &i_var9.field_0xf6 = 0x0;
    } else {
        pass1_1020_62e0(u_var3, u_var5, i_var9.field_0x8, param_3);
        i_var9.field_0xf6 = u_var3;
        i_var9.field_0xf8 = u_var6;
    }
    ui_op_1020_536e(param_1, 0x0, -0x1, 0x3, u_var6);
    return;
}
...
pub fn mixed_menu_op_1020_44ec(
    ...
    if ((iVar10 + 0x106) != 0x0) {
        if ((iVar10 + 0x106) == param_4) {
            puStack6 = mixed_1010_20ba(ctx.PTR_LOOP_1050_0ed0, 0x3, param_6, in_DX, unaff_DI);
            u_var1 = (iVar10 + 0x108);
            uStack8 = (u_var1 + 0x2e);
            u_var1 = (iVar10 + 0x108);
            // u_var11 = (u_var1 >> 0x10);
            ...
            u_var6 = uStack296._3_1_;
            pcStack286 = uStack296;
            uStack268 = uStack296;
            if (uStack296._3_1_ == 0x0) {
                u_var2 = pass1_1020_bd80(uStack8);
                HVar12 = 0x1000;
                string_1000_3d3e(CONCAT22(param_6, local_108), CONCAT22(puVar9, u_var2));
            } else {
                pass1_1030_8344(
                    ctx.PTR_LOOP_1050_5748,
                    (ctx.PTR_LOOP_1050_5748 >> 0x10),
                ...
                uStack296 = CONCAT22(puVar9, u_var6);
                HVar12 = 0x1010;
                pass1_1010_c3c2(
                    puStack6,
                    (puStack6 >> 0x10),
                    CONCAT22(param_6, local_108),
                    CONCAT22(puVar9, u_var6),
                    puVar9,
                    in_AF,
                    param_6,
                );
            ...
            HVar12 = 0x1008;
            BVar4 = pass1_1008_c6ae(ctx.PTR_LOOP_1050_06e0, uStack8, 0x20);
            if (BVar4 != 0x0) {
            ...
            uStack278 = (u_var6 + 0x2e);
            if (((u_var6 + 0x30) | uStack278) == 0x0) {
                return;
            }
            uStack268 = (uStack278 + 0x200);
            local_108[0] = struct_op_1030_73a8(CONCAT13((in_DX >> 0x8), CONCAT12(in_DX, u_var6)));
            u_var11 = (local_108[0] >> 0x10);
            puStack6 = (local_108[0] + 0x1c);
            u_var6 = (local_108[0] + 0x1e);
            if ((u_var6 | puStack6) != 0x0) {
                uStack268 = (puStack6 & 0xffff | u_var6 << 0x10);
            }
            ...
            HVar12 = 0x1008;
            BVar4 = pass1_1008_c6ae(ctx.PTR_LOOP_1050_06e0, local_134[0], 0x3f);
            if (BVar4 != 0x0) {
                HVar12 = ctx.s_tile2_bmp_1050_1538;
    ...
    if (iVar7 == 0x0) {
        ...
        //       TODO: goto LAB_1020_47e3;
            ...
            if (param_3 == 0x3) {
                ...
                HVar12 = 0x1010;
                puStack304 =
                    mixed_1010_20ba(ctx.PTR_LOOP_1050_0ed0, 0x2f, param_6, in_DX, unaff_DI);
                // u_var11 = (puStack304 >> 0x10);
                uStack300 = (puStack304 + 0x20);
                u_var6 = (puStack304 + 0x22);
                if ((u_var6 | uStack300) != 0x0) {
                    HVar12 = 0x1030;
                    pass1_1030_8308(
                        ctx.PTR_LOOP_1050_5748,
                        (ctx.PTR_LOOP_1050_5748 >> 0x10),
...
pub fn win_sys_op_1020_493c(
    ...
    if (param_2 < 0xea) {
        ...
        match (param_2) {
            ...
            // => { i_var4 = 0x0; } 0x1;=> { i_var4 = 0x0; }=> { i_var4 = 0x0; }=> { i_var4 = 0x0; } = 0x3;
            //
            0x6d => {
                i_var4 = 0x4;
            }
            ...
            0x77 => {
                ...
                paStack18 = unk_io_op_1010_830a(ctx.PTR_LOOP_1050_14cc, 0x1f8, param_6);
                WinHelp16(
                    0x1010,
                    uStack26,
                    CONCAT11((uStack26 >> 0xf), (uStack26 >> 0xf)),
                    CONCAT22(paStack18, 0x1),
                );
                return;
            }
            0x78 => {
                puVar13 = mixed_1010_20ba(ctx.PTR_LOOP_1050_0ed0, 0x45, param_6, param_3, unaff_DI);
    ...
    if (param_2 < 0x133) {
        if (param_2 == 0x102) {
            ...
            //LAB_1020_4b6c:
            fn_ptr_1030_835a(ctx.PTR_LOOP_1050_5748, CONCAT22(param_6, &local_13c));
            return;
        }
        if (param_2 < 0x103) {
            if (false) {
            ...
            match (param_2) {
                ...
                0xf6 => {
                    if ((uVar9 + 0x116) != 0x0) {
                        ...
                        pass1_1010_1ea6(ctx.PTR_LOOP_1050_02a0, CONCAT22(param_3, i_var4), param_6);
                        (uVar9 + 0x116) = 0x0;
                    }
                    i_var4 = 0x12;
                }
                ...
                0xfb => {
                    local_144 =
                        mixed_1010_20ba(ctx.PTR_LOOP_1050_0ed0, 0x3, param_6, param_3, unaff_DI);
                ...
                0x101 => {
                    uStack26 =
                        mixed_1010_20ba(ctx.PTR_LOOP_1050_0ed0, 0x2f, param_6, param_3, unaff_DI);
                    // u_var11 = (uStack26 >> 0x10);
                    ...
                    if (uStack22 == 0x0) {
                        ...
                        uStack30 = CONCAT22(puVar8, pu_var5);
                        //LAB_1020_4c5f:
                        ppcVar1 = (*pu_var5 + 0x74);
                        (**ppcVar1)(uVar16, pu_var5, puVar8);
                        return;
                    }
                    uVar12 = pass1_1038_af40(
                        ctx.PTR_LOOP_1050_5b7c,
                        (uVar9 + 0x8),
                        0xe,
                        puVar7,
                ...
                if (param_2 < 0x107) {
                    if (param_2 == 0x103) {
                        ...
                        if (uStack34 != 0x0) {
                            ...
                            pass1_1030_e63e(
                                CONCAT22(param_6, &local_24e),
                                uStack42,
                                param_6,
                                in_AF,
                            );
                            fn_ptr_1030_835a(ctx.PTR_LOOP_1050_5748, CONCAT22(param_6, &local_24e));
                            return;
                        }
                        uVar16 = 0x0;
                        ...
                        uStack38 = CONCAT22(puVar8, pu_var5);
                    } else {
                        if (param_2 != 0x104) {
                            return;
                        }
                        ...
                        if (uStack34 != 0x0) {
                            ...
                            fn_ptr_1030_835a(
                                ctx.PTR_LOOP_1050_5748,
                                CONCAT13(uVar16, CONCAT12(param_6, pu_var5)),
                            );
                            win_1008_5c5c(param_6, pu_var5, uVar9, ctx.PTR_LOOP_1050_02a0, 0x1e6);
                            return;
                        }
                        uVar16 = 0x0;
                        mem_op_1000_179c(0xb4, puStack32, 0x1000);
                        ...
                        local_356[0] = CONCAT22(puVar8, pu_var5);
                    }
    ...
    if (0x1c8 < param_2) {
        if (param_2 == 0x1ca) {
            local_144 = mixed_1010_20ba(ctx.PTR_LOOP_1050_0ed0, 0x3, param_6, param_3, unaff_DI);
            uStack320 = pass1_1010_c234(local_144, (local_144 >> 0x10), unaff_DI, param_6);
            // u_var10 = (uStack320 >> 0x10);
            uVar19 = uStack320;
            if ((u_var10 | uVar19) == 0x0) {
                return;
            }
            local_13c = mixed_1010_20ba(
                ctx.PTR_LOOP_1050_0ed0,
            ...
            pass1_1010_3770(local_13c, CONCAT22(u_var10, uVar19), param_3);
            i_var4 = 0x3;
        } else {
            uVar17 = (ctx.PTR_LOOP_1050_5748 >> 0x10);
            u_var6 = ctx.PTR_LOOP_1050_5748;
            if (param_2 == 0x200) {
                uVar12 = (uVar9 + 0x108);
                // u_var11 = (uVar12 >> 0x10);
                i_var4 = uVar12;
                ...
                pass1_1030_8344(u_var6, uVar17, uStack26 & 0xffff | ZEXT24(param_3) << 0x10);
                i_var4 = 0x25;
                ...
                if (param_2 == 0x201) {
                    ...
                    pu_var3 = uStack6._3_1_;
                    if (uStack6._3_1_ != 0x5) {
                        return;
                    }
                    pass1_1030_8344(u_var6, uVar17, uStack6 & 0xffff | ZEXT24(param_3) << 0x10);
                    uStack22 = CONCAT22(param_3, pu_var3);
                    i_var4 = 0x27;
                    ctx.PTR_LOOP_1050_5a68 = pu_var3;
    ...
    pass1_1020_2a94((uVar9 + 0xce), CONCAT22(u_var11, uVar18), param_6);
...
pub fn ui_op_1020_536e(param_1: u32, param_2: u32, param_3: i16, param_4: i16, param_5: U32Ptr) {
    ...
    if (uVar7 == 0x0) {
            ...
            if ((param_5 | uVar7) == 0x0) {
                ...
                *pi_var1 = *pi_var1 + 0x1;
                uVar14 = unk_win_ui_op_1020_67ce(
                    CONCAT13((param_5 >> 0x8), CONCAT12(param_5, uVar7)),
                    (iVar10 + 0xcc),
                    param_1,
                );
                (iVar10 + 0xfe) = uVar14;
        ...
        if (param_4 == 0x2) {
            u_var4 = param_3 + 0xc;
            puVar13 = mixed_1010_20ba(ctx.PTR_LOOP_1050_0ed0, u_var4, unaff_SS, param_5, unaff_DI);
            // puVar9 = (puVar13 >> 0x10);
            ...
            if (u_var5 == 0x0) {
                ...
                *pi_var1 = *pi_var1 + 0x1;
                ...
                if (puVar8 == 0x0) {
                    ...
                    pass1_1020_289a(
                        CONCAT13((puVar9 >> 0x8), CONCAT12(puVar9, UVar6)),
                        UVar2,
                        param_1,
                        unaff_SS,
                    );
                ...
                uVar17 = (puVar8 >> 0x8);
                pass1_1020_294a(
                    CONCAT13(uVar17, CONCAT12(uVar16, UVar6)),
                    CONCAT22(param_2, uVar12),
                    (param_2 >> 0x10),
                    puVar8,
                    unaff_DI,
                    unaff_SS,
            ...
            u_var4 = 0x1;
            iVar10 = 0x4;
            puVar13 = mixed_1010_20ba(ctx.PTR_LOOP_1050_0ed0, 0x2b, unaff_SS, puVar9, unaff_DI);
...
pub fn post_msg_1020_55b0(param_1: u32, param_2: u16) -> u16 {
    ...
    puStack12 = mixed_1010_20ba(ctx.PTR_LOOP_1050_0ed0, 0x37, param_2, pu_var3, unaff_DI);
    load_string_1010_84e0(
        0x1010,
        ctx.PTR_LOOP_1050_14cc,
        (ctx.PTR_LOOP_1050_14cc >> 0x10),
    ...
    pu_var5 = pass1_1008_9436(CONCAT22(param_2, local_112));
    uVar8 = (param_2 >> 0x8);
    pcVar6 = pass1_1008_a8f4(
        puStack12,
    ...
    u_var2 = pcVar6;
    pu_var3 = ((pcVar6 >> 0x10) | u_var2);
    // u_var5 = (param_1 >> 0x10);
    hwnd_00 = 0x1008;
    if ((pcVar6 != 0x0) && (*pcVar6 != '\0')) {
        hwnd = 0x1000;
        mem_op_1000_179c(0xb4, pu_var3, 0x1000);
        if ((pu_var3 | u_var2) == 0x0) {
            ...
            puVar6 = pass1_1040_8478(
                ...
                0x0,
                CONCAT13(uVar8, CONCAT12(param_2, local_10c)),
                pcVar6,
                (param_1 + 0x8),
                pu_var3 | u_var2,
            );
    ...
    if (local_10e == 0x6) {
        ...
        hwnd_00 = 0x1010;
        pu_var5 = mixed_1010_20ba(ctx.PTR_LOOP_1050_0ed0, 0x2, param_2, pu_var3, unaff_DI);
...
pub fn menu_ui_op_1020_5bf2(param_1: &mut Struct52, param_2: HWND16, param_3: &RECT16) -> bool {
    ...
    iVar5.field_0x10a = u_var6;
    if ((u_var6 | iVar5.field_0x108) == 0x0) {
        return 0x0;
    }
    if (iVar5.field_0x106 == 0x0) {
        HVar5 = LoadMenu16(instance, ctx.s_TILEMENU_1050_43f0);
...
pub fn win_ui_op_1020_5de8(param_1: u32, param_2: u16, param_3: u16, param_4: u16) {
    ...
    local_6 = param_3;
    uStack4 = param_2;
    puVar6 = mixed_1010_20ba(ctx.PTR_LOOP_1050_0ed0, 0x47, param_4, in_DX, unaff_DI);
    // u_var4 = (puVar6 >> 0x10);
    pu_var3 = &local_6;
    pt_in_rect_1020_5856(
        param_1,
        CONCAT13((param_4 >> 0x8), CONCAT12(param_4, pu_var3)),
        pu_var3,
    );
...
pub fn win_ui_op_1020_5e76(param_1: u32, param_2: u16, param_3: u16) {
    ...
    let uVar15: u8;
    let local_2aa: U32Ptr;
    let local_1aa: U32Ptr;
    let local_aa: [u8; 0x80];
    let uStack42: u32;
    let paStack38: &mut Struct57;
    let local_22: [u8; 0x10];
    ...
    pt_in_rect_1020_5856(
        param_1,
        CONCAT13(uVar15, CONCAT12(unaff_SS, pu_var3)),
        pu_var3,
    );
    uStack10 = CONCAT22(in_DX, pu_var3);
    puVar7 = (in_DX | pu_var3);
    if (puVar7 == 0x0) {
        // goto
        // LAB_1020_6176;
    }
    uStack12 = pu_var3[0x6];
    uStack14 = pu_var3[0x7];
    uStack16 = 0x0;
    uVar13 = 0x1018;
    ...
    if (puVar4 == 0x6b8) {
        ...
        if (puVar4 == 0x6b6) {
            ...
            uVar12 = 0x1000;
            mem_op_1000_179c(0xb4, puVar7, 0x1000);
            uStack42 = CONCAT22(puVar7, u_var6);
            if ((puVar7 | u_var6) == 0x0) {
                paStack38 = 0x0;
            } else {
                uVar12 = SUB42(&ctx.PTR_LOOP_1050_1040, 0x0);
                paStack38 = pass1_1040_8478(
                    CONCAT22(puVar7, u_var6),
                    0x40,
                    CONCAT13(uVar15, CONCAT12(unaff_SS, local_aa)),
        ...
        if (puVar4 < 0x6a7) {
            if (((i_var9 + 0x10c) == 0x78) || ((i_var9 + 0x10c) == 0x74)) {
                uVar13 = 0x1010;
                local_2aa[0] =
                    mixed_1010_20ba(ctx.PTR_LOOP_1050_0ed0, 0x5, unaff_SS, puVar7, unaff_DI);
                puVar7 = (local_2aa[0] >> 0x10);
                if ((local_2aa[0] + 0xa) == 0x0) {
                    return;
                }
            }
            if (((((i_var9 + 0x10c) == 0x6c) || ((i_var9 + 0x10c) == 0x6d))
                || ((i_var9 + 0x10c) == 0x31))
                || ((i_var9 + 0x10c) == 0x32))
            {
                uVar13 = 0x1010;
                local_2aa[0] =
                    mixed_1010_20ba(ctx.PTR_LOOP_1050_0ed0, 0x3a, unaff_SS, puVar7, unaff_DI);
                if ((local_2aa[0] + 0xa) == 0x0) {
                    return;
                }
            }
            pass1_1020_68de((i_var9 + 0xfe), uVar13);
            //       TODO: goto LAB_1020_6176;
        }
        if (0x6b1 < puVar4) {
            uVar12 = 0x1000;
...
pub fn unk_win_op_1020_65cc(param_1: &mut Struct60, param_2: i16, param_3: u16) {
    ...
    if (param_2 == 0x2) {
        // for (i_stack4 = 0x0; i_stack4 < 0x5; i_stack4 += 0x1) {
...
pub fn unk_win_ui_op_1020_67ce(in_struct_1: &mut Struct20, param_2: u16, param_3: i32) {
    ...
    &i_var3[0x1].field_0x14 = 0x0;
    in_struct_1.field_0x0 = 0x70e6;
    i_var3.field_0x2 = 0x1020;
    string_1000_3d3e(
        (in_struct_1 & 0xffff0000 | ZEXT24(&i_var3.field_0x5b)),
        ...
        if (HStack4 != 0x0) {
            if (param_3 == 0x2) {
                ...
                if ((uStack8 != -0x1) || (false)) {
                    ...
                    pu_var2 = local_58;
                    pass1_1018_30ca((i_var3 + 0xf2), CONCAT22(param_6, pu_var2), (LVar5 >> 0x10));
                    hwnd = 0x1018;
                    pass1_1018_2fe8((i_var3 + 0xf2), in_stack_0000ff86, in_stack_0000ff88);
                    if (pu_var2 != 0x0) {
                        invalidate_rect_1020_735a((i_var3 + 0xf6), 0x1018);
                        ppcVar1 = (*param_1 + 0x40);
...
pub fn window_op_1020_6c3a(param_1: &mut Struct1) {
    let u_var1: u32;
    let ppcVar2: u32;
    let HVar3: HICON16;
    ...
    create_window_ex_1008_9760(param_1, 0x1008);
    puVar13 = mixed_1010_20ba(ctx.PTR_LOOP_1050_0ed0, 0x4, unaff_SS, in_DX, unaff_DI);
    // uVar7 = (puVar13 >> 0x10);
    // uVar12 = (param_1 >> 0x10);
    iVar11 = param_1;
    (iVar11 + 0xf2) = puVar13;
    ...
    HVar3 = LoadIcon16(0x1010, ctx.s_TILEICON_1050_440c);
    (iVar11 + 0xc2) = HVar3;
    u_var6 = (iVar11 + 0xf2);
    ppcVar2 = ((iVar11 + 0xf2) + 0x30);
    (**ppcVar2)(
    ...
    pass1_1018_2d22(
        ...
        CONCAT13((unaff_SS >> 0x8), CONCAT12(unaff_SS, paVar4)),
        0xbb8,
    );
    ...
    if (puVar8 != 0x0) {
        pass1_1008_3bd6(
            ...
            0x1b2,
            0x1b001b1,
            CONCAT22((iVar11 + 0x8), 0xbba),
            puVar8,
            unaff_SS,
        );
    }
    mem_op_1000_179c(0x22, puVar8, 0x1000);
    u_var10 = puVar8 | paVar4;
    if (u_var10 == 0x0) {
        (iVar11 + 0xf6) = 0x0;
    } else {
...
pub fn win_ui_fn_1020_6e98(param_1: u32, in_win_handle: HWND16, param_3: u16) {
    ...
    if ((window_name._2_2_ | window_name) != 0x0) {
        window_handle = CreateWindow16(
            0x1018,
            window_name,
            CONCAT22(ctx.PTR_LOOP_1050_038c, window_name._2_2_),
            0x1797,
            (iVar5 + 0x8),
            i_stack4 + -0x19,
            i_stack6,
        ...
        if (window_handle == 0x0) {
            ...
            if ((window_name + 0x4) == 0x0) {
                ...
                SendMessage16(0x1010, pcVar8, (pcVar8 >> 0x10), CONCAT22(u_var10, uVar9));
            } else {
                iStack36 = 0x0;
                loop {
                    ...
                    uVar9 = 0x0;
                    u_var10 = 0x401;
                    u_var3 = pass1_1020_bd80((window_name + iStack36 * 0x2));
                    LVar7 = SendMessage16(
                        ctx.s_tile2_bmp_1050_1538,
                        u_var3,
                        WVar4,
            ...
            uVar9 = 0xffff;
            u_var10 = 0x40d;
            pass1_1018_2d84(u_var3, (iVar5 + 0xf2));
            LVar7 = SendMessage16(0x1018, u_var3, WVar4, CONCAT22(u_var10, uVar9));
            iVar5 = LVar7;
...
pub fn unk_win_ui_op_1020_717e(param_1: U32Ptr, param_2: i32, param_3: u16) {
    ...
    *param_1 = 0x754c;
    (i_var8 + 0x2) = 0x1020;
    puVar13 = mixed_1010_20ba(ctx.PTR_LOOP_1050_0ed0, 0x4, param_3, in_DX, unaff_DI);
    // u_var6 = (puVar13 >> 0x10);
    (i_var8 + 0x1c) = puVar13;
    (i_var8 + 0x1e) = u_var6;
    ppcVar2 = ((i_var8 + 0x1c) + 0x4);
    (**ppcVar2)(0x1010, (i_var8 + 0x1c), u_var6, 0x0, param_1);
    u_var6 = (i_var8 + 0x4);
    local_4 = GetDC16(0x1010);
    u_var3 = (i_var8 + 0x1c);
    *(u_var3 + 0x178) = local_4;
    u_var3 = (i_var8 + 0x1c);
    // uVar12 = (u_var3 >> 0x10);
    iVar10 = u_var3;
    pu_var5 = (iVar10 + 0x24);
    ppcVar2 = (*pu_var5 + 0x14);
    (**ppcVar2)(ctx.s_tile2_bmp_1050_1538, pu_var5, (iVar10 + 0x26), u_var6);
    puVar13 = mixed_1010_20ba(ctx.PTR_LOOP_1050_0ed0, 0x29, param_3, extraout_dx, unaff_DI);
    // puVar7 = (puVar13 >> 0x10);
    paVar1 = (puVar13 + 0xe);
    pass1_1008_4d84(
        (pu_var5 & 0xffff | ZEXT24(extraout_dx) << 0x10),
...
pub fn win_ui_op_1020_737a(param_1: i32, param_2: HWND16, param_3: u16) -> bool {
    ...
    if (BVar4 == 0x0) {
        ...
        pass1_1018_2e5e(param_3, puVar6, in_DX, (i_var8 + 0x1c));
        local_30 = puVar6 & 0xffff | in_DX << 0x10;
        pass1_1008_3e54(
            CONCAT13((param_3 >> 0x8), CONCAT12(param_3, local_42)),
            0x0,
            0x35,
            0xc,
        );
        if ((i_var8 + 0x14) != 0x0) {
            pass1_1008_5236((i_var8 + 0x14));
        }
        if (local_30 != 0x0) {
            u_var1 = (i_var8 + 0x14);
            uVar7 = (i_var8 + 0x16);
        ...
        ppcVar2 = ((i_var8 + 0x18) + 0x94);
        (**ppcVar2)(0x1008, (i_var8 + 0x18), 0x1);
...
pub fn window_op_1020_76aa(param_1: &mut Struct1) {
...
pub fn post_win_msg_1020_79fc(
    ...
    i_var3 = (**ppcVar2)(param_5, i_var4.field_0xe0);
    if (i_var3 != param_4) {
...
pub fn win_ui_menu_op_1020_7ad2(param_1: u32, param_2: HWND16, param_3: &RECT16, param_4: HWND16) {
    ...
    // u_var3 = (param_1 >> 0x10);
    i_var2 = param_1;
    if (((i_var2 + 0xee) != 0x0) && ((i_var2 + 0xec) == 0x0)) {
        HVar1 = LoadMenu16(param_4, (i_var2 + 0xee));
        (i_var2 + 0xec) = HVar1;
        if (HVar1 == 0x0) {
            return;
        }
