...
pub fn mixed_ui_op_1020_179c(param_1: &mut Struct1)
{
  ...
  *pIStack12 = iVar10 / 0x2;
  ...
  EnumChildWindows1(ctx.s_tile2_bmp_1050_1538,(LPVOID)0x0,ZEXT24(pvStack60) << 0x10);
  ...
  if ((iVar9 + 0x96) == 0x0) {
    ...
    SetWindowText16(ctx.s_tile2_bmp_1050_1538,(SEGPTR)local_178);
...
//LAB_1020_1b24:
  ...
  uVar12 = (pIStack12 >> 0x10);
  iVar9 = pIStack12;
  SetWindowPos16(ctx.s_tile2_bmp_1050_1538,0x44,*(INT16 *)(iVar9 + 0x6),
...
set_win_tet_1020_1d2a
          ...
          INT16 in_dlg_id_5,in_hwnd_6: HWND16)
...
//LAB_1020_3846:
  ...
  if ((iVar7 + 0x1c) != 0x0) {
    GetDlgItem16(ctx.s_tile2_bmp_1050_1538,*(INT16 *)(uStack6 + 0x1a));
    SetFocus16(ctx.s_tile2_bmp_1050_1538);
    return;
  }
  InvalidateRect16(ctx.s_tile2_bmp_1050_1538,(RECT16 *)0x0,0x0);
  return;
}
...
pub fn win_1020_43f6(astruct *param_1,uchar *param_2,param_3: u16)
{
  let ppcVar1: u32;
  let iVar2: i16;
  let uVar3: u16;
...
pub fn ui_op_1020_536e(param_1: u32,param_2: u32,param_3: i16,param_4: i16,uchar *param_5)
{
  let piVar1: *mut i16;
  let UVar2: u16;
  let ppcVar3: u32;
...
pub fn menu_ui_op_1020_5bf2(param_1: &mut Struct52,param_2: HWND16,RECT16 *param_3) -> bool
  ...
  if (BVar4 == 0x0) {
    ...
    if (ctx.PTR_LOOP_1050_0010 == 0x0) {
      ...
      if (BVar4 != 0x0) {
        ...
        HStack52 = HStack54;
        iStack50 = iStack56;
        FillRect16(ctx.s_tile2_bmp_1050_1538,local_rect,(HBRUSH16)&local_brush_handle);
...
pub fn win_ui_menu_op_1020_7ad2(param_1: u32,param_2: HWND16,RECT16 *param_3,param_4: HWND16)
{
  let HVar1: HMENU16;
  let iVar2: i16;
  let uVar3: u16;
  ...
  TrackPopupMenu16(ctx.s_tile2_bmp_1050_1538,0x0,0x0,*(INT16 *)(iVar2 + 0x8),0x0,
