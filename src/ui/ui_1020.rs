...
pub fn window_op_1020_10a0(param_1: &mut Struct1) {
    ...
    u_var3 = LoadIcon16(0x1010, s_PLNTICON_1050_4267);
    (iVar11 + 0xc2) = u_var3;
    u_var1 = (iVar11 + 0xf2);
...
pub fn win_ui_op_1020_2cf0(param_1: &mut Struct1) {
    ...
    u_var3 = LoadIcon16(0x1010, s_SITEICON_1050_428d);
    (i_var8 + 0xc2) = u_var3;
    u_var1 = (i_var8 + 0xf2);
...
pub fn win_sys_op_1020_493c(
                ...
                if (param_2 < 0x107) {
                    if (param_2 == 0x103) {
                        ...
                        if (uStack34 != 0x0) {
                            ...
                            win_1008_5c5c(param_6, pu_var5, uVar9, _PTR_LOOP_1050_02a0, 0x1e6);
                            return;
                        }
                        uVar16 = 0x0;
                        mem_op_1000_179c(0xb4, puStack32, 0x1000);
    ...
    if (0x1c8 < param_2) {
        if (param_2 == 0x1ca) {
            ...
            u_var6 = ctx._PTR_LOOP_1050_5748;
            if (param_2 == 0x200) {
                uVar12 = (uVar9 + 0x108);
                // u_var11 = (uVar12 >> 0x10);
                i_var4 = uVar12;
