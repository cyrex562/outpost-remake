...
use crate::defines::{
    Struct11, Struct13, Struct18, Struct76, Struct79, StructB, Struct_1008_09ba, Struct_1008_0a3c,
    U32Ptr,
};
...
use crate::win_struct::{
    ...
    HPALETTE16, HWND16, LOGPALETTE, PAINTSTRUCT16, POINT16, RECT16, WNDCLASS16,
};
use crate::winapi::{
    mciSendCommand16, BeginPaint16, ClientToScreen16, CreatePalette16, CreateSolidBrush16,
    CreateWIndowEx16, CreateWindow16, DefWindowProc16, DeleteObject16, EndPaint16, FillRect16,
    GetClassInfo16, GetClientRect16, GetOpenFileName16, GetSaveFileName16, GetStockObject16,
    GetSubMenu16, GetSysColor16, GetWindowLong16, InvalidateRect16, IsIconic16, KillTimer16,
    LoadCursor16, LoadMenu16, MessageBeep16, MessageBox16, OutputDebugString16, PostMessage16,
    ...
    SetTimer16, SetWindowText16, SetWindowWord16, ShowWindow16, StretchDIBits16, TrackPopupMenu16,
    UpdateWindow16,
};
...
pub unsafe fn win_ui_cursor_op_1008_06c0(
    ...
    if param_4 == 0x400 {
        pass1_1030_8344(ctx, ctx.PTR_LOOP_1050_5748 as u16 as u32, 0x4000001);
        struct_1 = read_struct_from_addr((in_dx | in_ax) as u32);
        if struct_1 != 0x0 {
            if ctx.PTR_LOOP_1050_4fe8 != 0x0 {
                pc_var4 = load_string_1010_847e(
                    ctx.PTR_LOOP_1050_14cc as i16,
                    ((ctx.PTR_LOOP_1050_14cc >> 0x10) as i16),
                    0x1010,
                );
                MessageBox16(0x1010, &ctx.PTR_LOOP_1050_0010, &pc_var4, (pc_var4 >> 0x10));
                return;
            }
...
pub fn message_box_op_1008_12dc(
    ...
    if (bvar1 == 0x0) {
        ...
        // u_var3 = (pc_var4 >> 0x10);
        u_var2 = str_op_1008_60e8(string_1, u_var3);
...
pub fn win_ui_op_1008_1414(
    ...
    if (BVar2 == 0x0) {
        ...
        // uVar7 = (pcVar11 >> 0x10);
        u_var3 = str_op_1008_60e8(string_1, uVar7);
        string_1 = load_string_1010_847e(
            ctx.PTR_LOOP_1050_14cc,
            (ctx.PTR_LOOP_1050_14cc >> 0x10),
            0x1010,
    ...
    uStack16 = u_var5;
    pass1_1030_8344(ctx, ctx.PTR_LOOP_1050_5748, u_var5);
    ...
    uVar14 = (&local_2a >> 0x8);
    u_var3 = param_4;
    puVar12 = mixed_1010_20ba(ctx.PTR_LOOP_1050_0ed0, pu_var5, param_4, puVar6, &iStack36);
    // puVar6 = (puVar12 >> 0x10);
    pass1_1018_179e(
        puVar12,
        CONCAT22(u_var3, CONCAT11(uVar14, uVar13)),
        0x1018,
        param_4,
    );
    uVar13 = 0x0;
    ...
    pass1_1010_043a(
        puVar12,
        CONCAT13(uVar14 as u16, CONCAT12(uVar13, u_var10)),
        iVar15,
        param_4,
    );
...
pub fn win_ui_cursor_op_1008_2e9a(param_1: &mut Struct72, param_2: u16) {
    let u_var1: u16;
    let i_var2: i16;
    let in_DX: U32Ptr;
    let u_var3: u16;
    ...
    if (UStack266 == 0x0) {
        ...
        str_1000_4d58(
            ...
            0x0,
            0x0,
            CONCAT22(param_2, local_224),
            CONCAT22(param_2, local_22e),
        );
        u_var3 = u_var4;
        if (local_22e[0] != '\0') {
            string_1000_3cea(
                CONCAT22(param_2, local_224),
                CONCAT22(param_2, local_22e) as i32,
            );
            u_var3 = u_var4;
        }
        struct_1010_5f1e(uStack262, CONCAT22(param_2, local_224), u_var3);
    } else {
        string_1 = (i_var2 + 0x1a);
        string_1000_3d3e(CONCAT22(param_2, local_102), &mut string_1);
...
pub fn save_file_1008_3178(
    ...
    let mut string_9: String;
    let in_buf_len_2: i16;
    let u_var10: u16;
    let local_782: [u8; 0x104];
    let local_67e: [u16; 0x4];
    let paStack1654: &mut Struct18;
    let mut string_1650: String;
    let UStack1648: u16;
    ...
    let cStack1306: u8;
    let acStack1305: [u8; 0x101];
    let uStack1048: u16;
    let local_416: [u8; 0x8];
    let uStack1038: u16;
    let local_40c: [u8; 102];
    let uStack778: u32;
    let puStack774: U32Ptr;
    let local_302: [u8; 100];
    let local_202: [u8; 0xff];
    let acStack259: [u8; 0x101];
    ...
    string_1000_3d3e(CONCAT22(param_3, local_416), &mut pcVar8);
    ...
    // u_var4 = (pcVar8 >> 0x10);
    string_1000_3d3e(CONCAT22(param_3, acStack1305 + 0x1), &mut pcVar8);
    ...
    if (param_2 == 0x1) {
        uStack1330 = 0x1804;
        string_9 = load_string_1010_847e(ctx.PTR_LOOP_1050_14cc, in_buf_len_2, 0x1010);
        // u_var4 = (pcVar9 >> 0x10);
        string_1000_3d3e(CONCAT22(param_3, local_666), &mut string_9);
    ...
    if (pcStack1382 != 0x0) {
        ...
        if (uStack1326 < 0x0) {
            paStack1654 = load_string_1010_847e(
                ctx.PTR_LOOP_1050_14cc,
                (ctx.PTR_LOOP_1050_14cc >> 0x10),
                0x1010,
            );
            ...
            string_1650 = pcVar8;
            MessageBox16(0x1010, &ctx.PTR_LOOP_1050_0010, &string_1650, UStack1648);
            pcStack1382 = 0x0;
            paStack1646 = paStack1654;
            fn_ptr_1000_17ce(ctx, paStack1654, 0x1000);
        } else {
            str_op_1000_3dbe(
                CONCAT13((param_3 >> 0x8), CONCAT12(param_3 as u8, local_782)),
                pcVar8,
                uStack1326,
            );
...
pub fn set_sys_color_1008_357e(param_1: &mut StructB, param_2: i16, in_index_3: i16, param_4: u16) {
    ...
    if (&i_var3.field_0xf8 == 0x0) {
        ...
        //   u_var5 = (uVar7 >> 0x10);
        //   i_var4 = uVar7;
        //   *(i_var4 + iStack132 * 0x4) = colorref_var2;
...
pub fn fill_rect_1008_39ac(in_win_handle_1: HWND16) {
    let local_brush_handle: [RECT16; 0x2];
...
pub fn win_ui_op_1008_3c34(param_1: u32, param_2: u8, param_3: u16, param_4: HDC16, param_5: u16) {
    let u_var1: u16;
    let ppcVar2: u32;
    let i_var3: i16;
    let u_var4: u16;
...
pub fn post_msg_1008_3d20(param_1: u32, param_2: HWND16) {
    PostMessage16(
        ...
        0x0,
        0x0,
        CONCAT22(0x111, ((param_1 + 0xcc) as u16)),
    );
    return;
}
...
pub fn stretch_di_bits_1008_465a(ctx: &mut AppContext, param_1: &mut Struct76, param_2: HDC16) {
...
pub fn file_and_draw_op_1008_4f20(
    ...
    b_force_background =
        palette_op_1008_46e4(param_1, &local_2c, output, ctx.s_tile2_bmp_1050_1538);
...
pub fn win_1008_5c5c(param_1: &WNDCLASS16, param_2: u16, param_3: u16, param_4: u32, param_5: u16) {
...
pub fn win_1008_5c7c(param_1: u32, param_2: u32, param_3: &WNDCLASS16, param_4: u16, param_5: u16) {
...
pub fn win_ui_op_1008_5cfe(param_1: u32, param_2: &mut String, in_wnd_class: &WNDCLASS16) {
    ...
    if (iStack24 != 0x0) {
        ...
        pcStack14 = string_1;
        DVar5 = mciSendCommand16(
            0x1000,
            local_16,
            CONCAT13(0x22, ZEXT23(in_wnd_class)),
            0x8030000,
        );
        if (((DVar5 >> 0x10) | DVar5) == 0x0) {
            ...
            uStack298 = 0x0;
            mciSendCommand16(0x1000, &message_1, CONCAT12(0x1, in_wnd_class), 0x8060000);
...
pub fn create_window_1008_5e7e(
    ...
    window_handle_1 = CreateWindow16(
        ctx.s_tile2_bmp_1050_1538,
        0x0,
...
pub fn make_def_win_proc_1008_5f44(
    param_1: u16,
    in_wparam_2: WPARAM16,
    param_3: LPARAM,
    in_hwnd_4: HWND16,
) -> LRESULT {
    let WVar1: u16;
...
pub fn win_ui_op_1008_8214(
    ...
    if (param_2 == 0x81) {
        ...
        SetWindowLong16(0x1000, pu_var2, CONCAT22(u_var4, (pu_var2 >> 0x10)));
    }
    if (param_2 == 0x1) {
        pu_var3 = GetWindowLong16(param_7, 0x0);
        *pu_var3 = (param_4 + 0x8);
...
pub fn send_msg_1008_84ba(param_1: u16, param_2: u32, param_3: HWND16) {
    ...
    SendMessage16(
        ...
        ((i_var1 + 0x2) as u16),
        0x0,
        CONCAT22(0x115, uStack4) as i32,
    );
    return;
}

pub fn win_sys_op_1008_84f2(
    param_1: u16,
    param_2: u16,
    param_3: i16,
    param_4: u32,
...
pub fn set_win_text_1008_9664(param_1: &mut Struct_1008_9664, param_2: u16, param_3: &mut String) {
    string_1000_3d3e(param_1.field_0xa, param_3);
    SetWindowText16(0x1000, param_1.field_0xa);
    return;
}
...
pub fn win_ui_reg_class_1008_96d2(
    ...
    if bvar1 == false {
        ...
        avar2 = RegisterClass16(get_struct_ref_from_addr::<WNDCLASS16>(
            ctx.s_tile2_bmp_1050_1538,
        ));
        if avar2 == 0x0 {
...
pub fn create_window_ex_1008_9760(ctx: &mut AppContext, in_struct_1: &mut Struct1, param_2: u16) {
    let u_var1: u32;
    let window_handle: HWND16;
    let astruct: &mut struct_1;
    ...
    if (struct_1.field_0x8 == 0x0) {
        ...
        window_handle = CreateWIndowEx16(
            CONCAT22(struct_1, param_2),
            &class_name,
            ctx.PTR_LOOP_1050_038c,
...
pub fn unk_win_op_1008_97f2(
    ...
    if (param_5 == 0x2b) {
        if (*param_2 == 0x4) {
            win_ui_get_prop_op_1040_9566(CONCAT22(param_3, param_2), &ctx.PTR_LOOP_1050_1040);
        } else {
        ...
        if (param_5 == 0x112) {
                ...
                ))
            {
                make_def_wnd_proc_1008_9ce6(
                    ...
                    param_2,
                    param_3,
                    CONCAT13(0x1, CONCAT12(cVar9, param_4)),
                    param_6,
                );
            }
        } else {
                    ...
                    if (param_5 < 0x205) {
                        ...
                        if (param_5 == 0x210) {
                            ...
                            if (param_5 == 0x30f) {
                                ...
                                i_var4 = (**ppcVar1)(param_6, param_1);
    ...
    if (false) {
        ...
        match (param_5) {
            ...
            0xd => {
                ...
                i_var4 = (**ppcVar1)(0x8, uVar7, uVar8, param_2, CONCAT12(param_4._0_1_, param_3));
            }
            ...
            0x10 => {
                ...
                u_var6 = (**ppcVar1)(0x1008, param_1);
                return u_var6;
            }
            0x19 => {
                ppcVar1 = (*param_1 + 0x78);
                u_var3 = (**ppcVar1)(0x8, uVar7, uVar8, param_2, CONCAT12(param_4._0_1_, param_3));
...
pub fn make_def_wnd_proc_1008_9ce6(
    param_1: u16,
    param_2: u16,
    in_msg_3: u16,
    param_4: WPARAM16,
    ...
    *param_5 = u_var5;
    ...
    match (i_var9 + 0x4) {
        ...
        0x2 => {
            ...
            pcVar12 = pass1_1038_4d28(CONCAT13(
                (u_var6 >> 0x8),
                CONCAT12(u_var6 as u8, i_var9 as u16),
            ));
            param_1 = 0x1000;
            sys_1000_3f9c(
                (uVar8 + 0xe),
        ...
        0x14 => {
            if ((uVar8 + 0x418) == 0x0) {
                ...
                // puVar7 = (pcVar12 >> 0x10);
                string_1000_3cea(
                    (param_4 & 0xffff0000 | ZEXT24((uVar8 + 0xe))) as i32,
                    &mut pcVar12,
                );
                *param_7 = 0x4c;
                uVar14 = 0x1;
                ...
                i_var9 = 0xa;
                puVar11 =
                    mixed_1010_20ba(ctx.PTR_LOOP_1050_0ed0, 0x2b, param_2, puVar7, in_buf_len_5);
                param_1 = 0x1010;
...
pub fn pass1_1008_a8f4(
    ...
    pass1_1008_a1f0(
        ...
        param_1,
        param_2,
        CONCAT22(param_7, &local_6),
        CONCAT22(param_7, i_var1),
        param_4,
    );
    pass1_1008_944e(param_3, local_6, (local_6 >> 0x10));
    return CONCAT22(param_5, i_var1);
}
...
pub fn pass1_1008_b146(param_1: u32, param_2: u16, param_3: u16) {
    ...
    if ((i_var2 + 0x16) != 0x0) {
        ...
        pass1_1030_8344(ctx, ctx.PTR_LOOP_1050_5748, (u_var1 + 0xa));
