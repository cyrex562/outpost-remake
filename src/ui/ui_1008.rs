...
use crate::util::{CONCAT12, CONCAT13, CONCAT22, get_struct_ref_from_addr, SUB42, ZEXT24, get_struct_at_addr, get_string_at_rsrc};
...
pub unsafe fn win_ui_cursor_op_1008_06c0(
    ...
    if param_4 == 0x400 {
        ...
        if struct_1 != 0x0 {
            ...
            send_msg_1030_83ba(ctx, &mut ctx.PTR__LOOP_1050_5748, param_2, unaff_ss, in_AF);
            u_var3 = (ctx.PTR__LOOP_1050_5748 >> 0x10) as u16;
            (ctx.PTR__LOOP_1050_5748 + 0x8) = 0x1;
            u_stack10 = mixed_1010_20ba(ctx, ctx.PTR__LOOP_1050_0ed0, 0x29, unaff_ss, struct_1, unaff_di as i16, 0);
            ...
            pu_var5 = mixed_1010_20ba(ctx, ctx.PTR__LOOP_1050_0ed0, 0x37, unaff_SS, extraout_dx, unaff_di, 0);
...
pub fn message_box_op_1008_12dc(
    ...
    curosr_handle_2 = LoadCursor16(param_3, &get_string_at_rsrc(0x7f02));
    ...
    if (bvar1 == 0x0) {
        ...
        pc_var4 = load_string_1010_847e(ctx.PTR__LOOP_1050_14cc,
...
pub fn win_ui_op_1008_1414(astruct_72 * * param_1, param_2: u32, LPCSTR param_3, param_4: u16,
...

{
    ...
    if (BVar2 == 0x0) {
        ...
        pcVar11 = load_string_1010_847e(ctx.PTR__LOOP_1050_14cc,
                                        (ctx.PTR__LOOP_1050_14cc >> 0x10), 0x1010);
        // uVar7 = (pcVar11 >> 0x10);
        ...
        fn_ptr_1000_17ce(ctx, CONCAT22(uVar7, uVar3), 0x1000);
    ...
    uStack16 = uVar5;
    pass1_1030_8344(
        ctx, ctx.PTR__LOOP_1050_5748, uVar5);
    uStack20 = uVar5 & 0xffff | uVar8 << 0x10;
    uStack24 = (uVar5 + 0x10);
    iVar4 = ((uStack24 + 0x2) + -0x1) as i16;
    ...
    uStack28 = CONCAT22(puVar6, iVar4 as u16);
    uVar5 = (iVar4 + 0x10) as u32;
    uStack32 = uVar5;
    pass1_1030_8344(
        ctx, ctx.PTR__LOOP_1050_5748, uVar5);
    iStack36 = uVar5 as i16;
    ...
    pass1_1010_043a(puVar12, CONCAT13(uVar14 as u16, CONCAT12(uVar13, uVar10)), iVar15, param_4);
...
pub fn post_msg_1008_2d22(param_1: u32) {
    ...
    if (((iVar4 + 0xee) != 0x0) && (piVar1 = (iVar4 + 0xf2), *piVar1 = *piVar1 + -0x1,
                                    (iVar4 + 0xf2) < 0x1)) {
        uVar8 = (iVar4 + 0xee) as u32;
        ppcVar3 = ((iVar4 + 0xee) + 0x90) as u32;
        (**ppcVar3)();
        (iVar4 + 0xee) = 0x0;
        (iVar4 + 0xf2) = 0x0;
        if ((iVar4 + 0xe8) != 0x0) {
            uVar7 = 0x3;
            uVar6 = (iVar4 + 0xe8) as u32;
            ppcVar3 = ((iVar4 + 0xe8) + 0xc) as u32;
            (**ppcVar3)();
            show_win_1038_b68a(ctx.PTR__LOOP_1050_5b7c, &ctx.PTR_LOOP_1050_1038);
            show_window_1010_7ace(((iVar4 + 0xf4) as u32), unaff_SS);
            uVar2 = (iVar4 + 0xe8) as u32;
            ppcVar3 = ((iVar4 + 0xe8) + 0x98) as u32;
...

{
    ...
    if ((param_1 + 0xe8) != 0x0) {
        ...
        iVar3 = (param_1 + 0xe8);
        ppcVar2 = (iVar3 + 0x90) as u32;
        (**ppcVar2)(ctx.s_tile2_bmp_1050_1538, uVar1, (uVar1 >> 0x10), uVar4);
        in_DX = extraout_DX;
    }
    big_switch_1008_15d4(iVar3, s_tile2_bmp_1050_1538, unaff_SS, CONCAT22(param_2, param_1 as u16),
                         param_3);
...
pub fn win_ui_cursor_op_1008_2e9a(astruct_72 * * param_1, param_2: u16) {
    ...
    local_102[0] = '\0';
    uStack262 = mixed_1010_20ba(ctx.PTR__LOOP_1050_0ed0, 0x2, param_2, in_DX, unaff_DI);
    // uVar1 = (uStack262 >> 0x10);
    iVar2 = uStack262 as i16;
    UStack266 = (iVar2 + 0x16);
    uVar3 = (iVar2 + 0x18) as u16;
    ...
    if (UStack266 == 0x0) {
        ...
        uVar3 = uVar4;
        if (local_22e[0] != '\0') {
            pass1_1000_3cea(CONCAT22(param_2, local_224), CONCAT22(param_2, local_22e) as i32);
            uVar3 = uVar4;
        }
        ...
        pass1_1000_3cea(CONCAT22(param_2, local_102) as i32, UStack266);
    }
    if (local_102[0] != '\0') {
...
pub fn save_file_1008_3178(param_1: u32, param_2: i16, param_3: u16) {
    ...
    iVar2 = puStack774;
    uStack778 = (iVar2 + 0x1a) as u32;
    uVar10 = (iVar2 + 0x1c) as u16;
    if ((uVar10 | uStack778) == 0x0) {
        paStack1646 = (iVar2 + 0x64);
        uVar10 = (iVar2 + 0x66) as u16;
...
//LAB_1008_3206:
        unk_str_op_1000_3d3e(CONCAT22(param_3, acStack259 + 0x1),
                             CONCAT22(uVar10, uStack778 as u16));
    }
    ...
    if ((uVar10 | uStack778) != 0x0) {
        unk_str_op_1000_3d3e(CONCAT22(param_3, local_202),
...
//LAB_1008_3461:
    if (pcStack1382 != 0x0) {
        ...
        if (uStack1326 < 0x0) {
            paStack1654 = load_string_1010_847e(ctx.PTR__LOOP_1050_14cc,
                                                (ctx.PTR__LOOP_1050_14cc >> 0x10), 0x1010);
            // uVar6 = (paStack1654 >> 0x10);
            uVar4 = str_op_1008_60e8(paStack1654, uVar6);
            paStack1654 = CONCAT22(uVar6, uVar4);
            pcVar8 = load_string_1010_847e(ctx.PTR__LOOP_1050_14cc,
                                           (ctx.PTR__LOOP_1050_14cc >> 0x10), 0x1010);
...
pub fn set_di_bits_to_device_1008_45d6(param_1: u32, param_2: HDC16) {
    ...
    SetDIBitsToDevice(param_2, 0x0, y_dest, cx, uVar1 as i16, ((uVar1 >> 0x10) as i16), info,
...
pub unsafe fn create_palette_1008_4e38(
    ...
    if (local_struct_1.field_0xe == 0x0) {
        ...
        mem_op_1000_179c(uVar4, param_3 as u16, 0x1000);
...
puVar3 = mixed_1010_20ba(ctx.PTR__LOOP_1050_0ed0, 0x37,unaff_SS, in_DX, unaff_DI); pass1_1008_aa28(puVar3, puVar3, unaff_SS);
}
else {
...
pub fn send_msg_1008_84ba(param_1: u16, param_2: u32, param_3: HWND16) {
    ...
    SendMessage16(param_3, ((iVar1 + 0x2) as u16), 0x0, CONCAT22(0x115, uStack4) as i32);
    return;
}
    ...
    if (param_4 == 0x1f) {
        ...
        if (param_4 < 0x20) {
            if (param_4 != 0x14) {
                ...
                uVar5 = (param_4 & 0xff00 | (cVar8 - 0x1)) as u16;
                if ((cVar8 - 0x1) == 0x0) {
//LAB_1008_8560:
...
//LAB_1008_8771:
                    ...
                    if (param_4 != 0x201) {
                        if (param_4 == 0x202) {
                            ...
                            SendMessage16(ctx.s_tile2_bmp_1050_1538, ((iVar3 + 0x2) as u16), 0x0,
                                          0x11100f9);
                            return;
                        }
                        if (param_4 != 0x203) {
...
pub fn create_window_ex_1008_9760(astruct *in_struct_1, param_2: u16) {
    ...
    if (struct_1.field_0x8 == 0x0) {
        ...
        window_handle = CreateWIndowEx16(CONCAT22(struct_1, param_2), class_name, PTR_LOOP_1050_038c,
                                         ...
                                         struct_1.field_0xb4, uVar1 as u16,
                                         ((uVar1 >> 0x10) as u16), 0x39e, ctx.data_seg);
...
let uVar5: u16; let msg: u16;
let wparam: u16; let unaff_SS: u16;
let uVar6: u32; let uVar7: u8;
...
if ((ctx.PTR_LOOP_1050_039a == 0x0) && (ppcVar1 = ( * param_1 + 0x48), iVar4 = ( * * ppcVar1)(), iVar4 != 0x0))
{
...
if (param_5 < 0x113) {
if (param_5 == 0x86) {
ppcVar1 = ( * param_1 + 0x80); uVar6 = ( * * ppcVar1)(); return uVar6;
}
if (param_5 < 0x87) {
if (param_5 == 0x85) {
ppcVar1 = ( * param_1 + 0x7c); uVar6 = ( * * ppcVar1)(); return uVar6;
}
if (param_5 < 0x86) {
if (cVar9 == '7') {
return (msg + 0xc2);
...
if (param_5 == 0x30f) {
//LAB_1008_9af8:
ppcVar1 = ( * param_1 + 0x8c); iVar4 = ( * * ppcVar1)(param_6, param_1);
//LAB_1008_9ada: return iVar4;
}
if (param_5 == 0x311) {
ppcVar1 = ( * param_1 + 0x88); iVar4 = ( * * ppcVar1)(); if (iVar4 != 0x0) {
// goto LAB_1008_9af8;
}
}
else {
...
ppcVar1 = ( * param_1 + 0x84); iVar4 = ( * * ppcVar1)(0x8, uVar7, uVar8, param_2, CONCAT12(param_4._0_1_, param_3));
//       TODO: goto LAB_1008_9ada;
0xf => ppcVar1 = (* param_1 + 0x34); ( * * ppcVar1)(0x1008, param_1); break; 0x10 => ppcVar1 = ( * param_1 + 0x38);
uVar6 = ( * * ppcVar1)(0x1008,param_1); return uVar6; 0x19 => ppcVar1 = ( * param_1 + 0x78); uVar3 = (* * ppcVar1)(0x8, uVar7, uVar8, param_2, CONCAT12(param_4._0_1_, param_3)); return CONCAT22(0x1050, uVar3); 0x1c => ppcVar1 = ( * param_1 + 0x30); ( * * ppcVar1)(0x8,param_1, param_4);
}
}
switchD_1008_9b30_caseD_1: uVar5 = 0x0;
//LAB_1008_9a95: return uVar5;
}
...
//LAB_1008_a146:
    if (!bVar4) {
        ...
        if ((uVar7 | uVar3) == 0x0) {
            ...
            (uVar3 + 0x2) = 0x1008;
            (uVar3 + 0x4) = param_6 as u16;
            (uVar3 + 0x6) = param_5 as u16;
            (uVar3 + 0xa) = param_4;
            (uVar3 + 0xc) = param_3 as u16;
            (uVar3 + 0xe) = param_2 as u16;
...

{
    ...
    *param_5 = uVar5;
    ...
    switch((iVar9 + 0x4))
    {
        0x1 => load_string_1010_84e0(0x1010, uVar13, uVar5, 0x3ff, (uVar8 + 0xe), (short)in_buf_len_5);
        *param_7 = 0xd1;
//     TODO: goto LAB_1008_a2b1;
        0x2 => uVar1 = (iVar9 + 0x6) as u32;
        ...
        uVar3 = puStack6 >> 0x10;
        pcVar12 = pass1_1038_4d28(CONCAT13((uVar6 >> 0x8), CONCAT12(uVar6 as u8, iVar9 as u16)));
        param_1 = 0x1000;
...
//     TODO: goto LAB_1008_a277;
        0x6 => load_string_1010_84e0(0x1010, uVar13, uVar5, 0x3ff, (uVar8 + 0xe), (short)in_buf_len_5);
        *param_7 = 0xd4;
//LAB_1008_a2b1:
        param_1 = 0x1010;
        *param_6 = 0x1;
...
//LAB_1008_a35a:
        ...
        *param_7 = 0x31;
        break;
        0x37 => load_string_1010_84e0(0x1010, uVar13, uVar5, 0x3ff, (uVar8 + 0xe), (short)in_buf_len_5);
        pcVar12 = load_string_1010_847e(ctx.PTR__LOOP_1050_14cc,
                                        (ctx.PTR__LOOP_1050_14cc >> 0x10), 0x1010);
        param_1 = 0x1000;
        pass1_1000_3cea((param_4 & 0xffff0000 | ZEXT24((uVar8 + 0xe))) as i32, (ULONG)pcVar12);
...
{
let iVar1: i16; let local_6: u32;

iVar1 = & local_6 + 0x2; pass1_1008_a1f0(param_6, param_7, param_8, param_1, param_2,
CONCAT22(param_7, & local_6), CONCAT22(param_7, iVar1),
param_4); pass1_1008_944e(param_3, local_6, (local_6 > > 0x10)); return CONCAT22(param_5, iVar1);
}
...

{
    ...
    if (((iVar2 + 0x414) == 0x0) && (uVar1 = (iVar2 + 0x410) as u32, (uVar1 + 0x8) != 0x0)) {
        (iVar2 + 0x414) = 0x1;
...
pub fn pass1_1008_aa28(param_1: u32, param_2: u16, param_3: &WNDCLASS16) {
    ...
    iVar3 = param_1 as i16;
    if ((iVar3 + 0x414) != 0x0) {
        uVar2 = (iVar3 + 0x410) as u32;
        if ((uVar2 + 0x8) == 0x0) {
            (iVar3 + 0x414) = 0x0;
            return;
        }
        ppcVar1 = ((iVar3 + 0x410) + 0x10) as u32;
        (**ppcVar1)();
...
pub fn pass1_1008_b08c(param_1: *mut u16) {
    ...
    *param_1 = 0xbdc8;
    (iVar1 + 0x2) = 0x1008;
    fn_ptr_1000_17ce(ctx, (iVar1 + 0x4), 0x1000);
    *param_1 = 0x389a;
    (iVar1 + 0x2) = 0x1008;
    return;
}
