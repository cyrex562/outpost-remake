  ...
  if (uStack8 == 0x0) {
    ...
    if (uVar2 == 0x0) {
      ...
      load_string_1008_b65a
                ((uVar4 + 0x94),local_208,CONCAT22(local_108,param_3),param_3);
    }
    lp_string = local_208;
  }
...
pub fn
win_ui_op_1038_977a(param_1: i16,param_2: u16,param_3: i16,param_4: *mut u8,param_5: HWND16,
                   param_6: u16)
