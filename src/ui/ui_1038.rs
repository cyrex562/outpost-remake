...

{
  ...
  if ((LVar3 != -0x1) || (false)) {
    ...
    SendDlgItemMessage16
              ((HWND16)s_tile2_bmp_1050_1538,pcVar2,(pcVar2 >> 0x10)
               ,0x0,0x18540401);
  ...
  *param_3 = '\0';
  ...
  if ((LVar1 != -0x1) || (false)) {
    LVar1 = SendDlgItemMessage16
                      ((HWND16)s_tile2_bmp_1050_1538,param_3,
...
fn send_dlg_item_msg_1038_8d22(param_1: u32,HWND16 param_2,param_3: u16)
{
  ...
  if ((WStack6 != 0xffff) || (false)) {
    SendDlgItemMessage16
              ((HWND16)s_tile2_bmp_1050_1538,local_106,param_3,WStack6,0x185b040a);
...
fn send_dlg_item_msg_1038_8f74(param_1: u32,HWND16 param_2,param_3: *mut u16) -> LRESULT
{
  ...
  if (iVar1 == 0x0) {
    ...
    while( true ) {
      ...
      SendDlgItemMessage16
                ((HWND16)s_tile2_bmp_1050_1538,local_50c,param_3,0x0,
                 0x185b0401);
    }
    GetDlgItem16(0x1008,0x1);
    enable = 0x1;
...
fn win_dlg_op_1038_9294(astruct_1 *param_1,param_2: u16)
{
  ...
  uVar3 = (param_1 >> 0x10);
  UVar1 = GetDlgItemInt16((HWND16)&ctx.PTR_LOOP_1050_1040,0x1,&local_4,unaff_SS);
  (param_1 + 0x94) = UVar1;
  uVar2 = GetDlgItemInt16((HWND16)s_tile2_bmp_1050_1538,0x1,&local_6,unaff_SS);
  (param_1 + 0x96) = uVar2;
...
fn win_ui_op_1038_a972(astruct_1 *param_1)
{
  ...
  dialog_ui_fn_1040_78e2(param_1,&ctx.PTR_LOOP_1050_1040);
  SendDlgItemMessage16((HWND16)&ctx.PTR_LOOP_1050_1040,0x0,0x0,0x1,0x1160401);
...
fn win_ui_op_1038_c89c(astruct_1 *param_1)
{
  ...
  dialog_ui_fn_1040_78e2(param_1,&ctx.PTR_LOOP_1050_1040);
  uVar4 = (param_1 >> 0x10);
  CheckRadioButton16((HWND16)&ctx.PTR_LOOP_1050_1040,0xfac,0xfad,0xfac);
  uVar2 = (param_1 + 0x8e);
  (uVar2 + 0xa) = 0x1;
  uVar2 = (param_1 + 0x8e);
  iVar1 = (uVar2 + 0x12);
...
fn win_ui_op_1038_d2a2(astruct_1 *param_1)
{
  ...
  move_win_1040_826c(param_1,-0x1,0xffff);
  BVar2 = ShowWindow16((HWND16)&ctx.PTR_LOOP_1050_1040,0x5);
...
fn unk_win_ui_op_1038_d400(param_1: u8,param_2: u16,param_3: u16,Uparam_4: i32)
{
  ...
  case 0x145:
    GetDlgItem16((HWND16)&ctx.PTR_LOOP_1050_1038,0x146);
  ...
  case 0x146:
    ...
    break;
  case 0x147:
    GetDlgItem16((HWND16)&ctx.PTR_LOOP_1050_1038,0x148);
    uVar2 = EnableWindow16((HWND16)s_tile2_bmp_1050_1538,0x1);
    uStack6 = 0x1410647;
    uVar11 = 0x1f5;
    goto LAB_1038_d490;
  case 0x148:
    GetDlgItem16((HWND16)&ctx.PTR_LOOP_1050_1038,0x149);
    uVar2 = EnableWindow16((HWND16)s_tile2_bmp_1050_1538,0x1);
    uStack6 = 0x1420647;
    uVar11 = 0x1f2;
//LAB_1038_d490:
  ...
  case 0x149:
    uStack6 = 0x1430648;
    PostMessage16((HWND16)&ctx.PTR_LOOP_1050_1038,0x0,0x0,0x11100b8);
    hwnd = s_tile2_bmp_1050_1538;
    DestroyWindow16((HWND16)s_tile2_bmp_1050_1538);
    break;
  case 0x14a:
    GetDlgItem16((HWND16)&ctx.PTR_LOOP_1050_1038,0x145);
    EnableWindow16((HWND16)s_tile2_bmp_1050_1538,0x1);
    uVar9 = 0xc;
    uVar10 = 0x140;
    WVar8 = 0x0;
    ...
    break;
  case 0x14b:
    GetDlgItem16((HWND16)&ctx.PTR_LOOP_1050_1038,0x147);
    hwnd = s_tile2_bmp_1050_1538;
    EnableWindow16((HWND16)s_tile2_bmp_1050_1538,0x1);
    break;
  default:
...
{
  dialog_ui_fn_1040_78e2(param_1,&ctx.PTR_LOOP_1050_1040);
  CheckRadioButton16((HWND16)&ctx.PTR_LOOP_1050_1040,0x1807,0x1807,0x1807);
...

{
  ...
  case 0x167:
    ...
    GetDlgItem16((HWND16)&ctx.PTR_LOOP_1050_1040,0x16b);
    EnableWindow16((HWND16)s_tile2_bmp_1050_1538,0x1);
    iStack4 = 0x0;
    break;
  case 0x168:
  ...
  case 0x16b:
    ...
    goto LAB_1040_04da;
  case 0x16c:
    GetDlgItem16((HWND16)&ctx.PTR_LOOP_1050_1040,0x16d);
    EnableWindow16((HWND16)s_tile2_bmp_1050_1538,0x1);
    iStack4 = 0x5;
    (param_1 + 0x94) = 0x5;
    goto LAB_1040_04da;
