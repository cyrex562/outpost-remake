...
pub fn win_ui_op_1018_5e9a(param_1: &mut Struct1,param_2: u16)
{
 ...
 // u_var10 = (param_1 >> 0x10);
  ...
  if (puVar6 == 0x0) {
    ...
    pass1_1018_6198(CONCAT22(pu_var5,uVar7),param_1,
                    (i_var9 + 0x6),puVar6,unaff_DI,param_2);
    (i_var9 + 0x92) = uVar7;
    (i_var9 + 0x94) = puVar6;
  }
  u_var1 = (i_var9 + 0x8e);
...
pub fn mix_ui_op_1018_6adc(param_1: &mut Struct28)
{
 ...
 // u_var6 = (param_1 >> 0x10);
  ...
  if ((iVar5 + 0xee) != 0x0) {
    win_1008_5c5c(unaff_SS,u_var3,u_var4,_PTR_LOOP_1050_02a0,(iVar5 + 0xee));
    (iVar5 + 0xf0) = u_var3;
  }
  paVar8 = unk_io_op_1010_830a(ctx.PTR_LOOP_1050_14cc,(iVar5 + 0xec),
                               unaff_SS);
...
pub fn win_1018_df40(astruct *param_1,param_2: u16,param_3: U32Ptr,param_4: u16)
{
 ...
 // u_var1 = (param_1 >> 0x10);
  if ((param_3 | param_2) != 0x0) {
    pu_var2 = struct_1018_e100(CONCAT22(param_3,param_2),i_var1.field_0x8,
...
pub fn win_1020_0316(astruct *param_1,param_2: U32Ptr,param_3: u16)
{
 ...
 // u_var5 = (param_1 >> 0x10);
  ...
  if (puVar4 != 0x0) {
    pass1_1020_04f6(CONCAT22(pu_var3,u_var2),i_var1.field_0x8,puVar4,unaff_DI,
                    param_3);
...
pub fn send_win_msg_1020_08fe(param_1: &mut Struct63,param_2: HWND16)
{
 ...
 // u_var2 = (param_1 >> 0x10);
  ...
  pass1_1008_57c4(
                  (param_1 & 0xffff0000 | &i_var2.field_0xd2));
  param_1 = 0x380a;
