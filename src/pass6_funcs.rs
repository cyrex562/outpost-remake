pub unsafe fn pass1_1038_c410(param_1: *mut Struct44, param_2: u8) -> *mut Struct44 {
...
pub unsafe fn pass1_1038_be4a(param_1: *mut Struct599) {
...
pub unsafe fn pass1_1038_9f56(param_1: *mut Struct44) -> *mut Struct44 {
    ...
    unsafe {
        bVar8 = *pb_var2;
        bVar4 = *pb_var2 - bVar7;
        bVar12 = *pb_var2 < bVar7 || bVar4 < bVar11;
        *pb_var2 = bVar4 - bVar11;
        if ((*pb_var2 != 0)
            && (SBORROW1(bVar8, bVar7) != SBORROW1(bVar4, bVar11)) == (*pb_var2 < '\0'))
        {
            pb_var2 = unaff_si;
            bVar11 = CARRY1(*pb_var2, bVar9) || CARRY1(*pb_var2 + bVar9, bVar12);
            *pb_var2 = *pb_var2 + bVar9 + bVar12;
            ...
            bVar8 = *pb_var2;
            bVar4 = *pb_var2;
            *pb_var2 = bVar4 + bVar9 + bVar12;
            pb_var2 = unaff_si + -0x78;
            *pb_var2 = *pb_var2 + in_CL + (CARRY1(bVar8, bVar9) || CARRY1(bVar4 + bVar9, bVar12));
            puStack34 = &stack0xfffe;
...
pub unsafe fn pass1_1038_9f02(param_1: *mut Struct44) -> *mut Struct44 {
    ...
    bVar16 = (in_dx >> 8);
    unsafe {
        b_var20 = CARRY1(*pbVar1, bVar16) || CARRY1(*pbVar1 + bVar16, bVar19);
        *pbVar1 = *pbVar1 + bVar16 + bVar19;
        pbVar1 = unaff_si;
        b_var5 = *pbVar1;
        bVar8 = *pbVar1 + 0x40;
        bVar19 = 0xbf < *pbVar1 || CARRY1(bVar8, b_var20);
        *pbVar1 = bVar8 + b_var20;
        cVar12 = in_CX;
        if ((*pbVar1 == 0) || (SCARRY1(b_var5, '@') != SCARRY1(bVar8, b_var20)) != (*pbVar1 < '\0'))
        {
            ...
            *pbVar1 = *pbVar1 - 0x22;
            ...
            b_var5 = *pbVar1;
            bVar8 = *pbVar1 - bVar14;
            b_var21 = *pbVar1 < bVar14 || bVar8 < b_var20;
            *pbVar1 = bVar8 - b_var20;
            if ((*pbVar1 == 0)
                || (SBORROW1(b_var5, bVar14) != SBORROW1(bVar8, b_var20)) != (*pbVar1 < '\0'))
            {
                ppb_var2 = (unaff_si + 9);
            ...
            pbVar1 = unaff_si;
            b_var20 = 0xbf < *pbVar1 || CARRY1(*pbVar1 + 0x40, b_var21);
            *pbVar1 = *pbVar1 + 0x40 + b_var21;
            b_var21 = 0xbf < local_4e || CARRY1(local_4e + 0x40, b_var20);
            local_4e = local_4e + 0x40 + b_var20;
            pbVar1 = unaff_si + -0x4f;
            b_var5 = *pbVar1;
            bVar8 = *pbVar1;
            *pbVar1 = bVar8 + 0x40 + b_var21;
            pbVar1 = unaff_si + -0x78;
            *pbVar1 = *pbVar1 + cVar12 + (0xbf < b_var5 || CARRY1(bVar8 + 0x40, b_var21));
            puStack34 = &stack0xfffe;
            process_struct_1040_7728(
                in_struct_1,
                (&PTR_LOOP_1050_0000 + 1),
        ...
        *pb_var2 = bVar4 - bVar11;
            ...
            && (SBORROW1(bVar8, bVar7) != SBORROW1(bVar4, bVar11)) == (*pb_var2 < '\0'))
        {
            ...
            *pb_var2 = *pb_var2 + bVar9 + bVar12;
            ...
            pb_var2 = unaff_si + -0x4f;
            *pb_var2 = *pb_var2 + bVar9 + (bVar12 || CARRY1(bVar8, bVar11));
            puStack34 = &stack0xfffe;
            pass1_1040_b040(
                CONCAT22(&stack0xbf2a, &stack0xfffe),
                CONCAT22(u_var6 | (bVar3 + in_CF) << 8, in_BX),
...
pub unsafe fn pass1_1038_8c8a(param_1: *mut Struct44, param_2: *mut u8) -> *mut Struct44 {
    let pbVar1: *mut u8;
    ...
    unsafe {
        ...
        *pbVar1 = bVar3 - bVar13;
            ...
            && (SBORROW1(bVar8, bVar6) != SBORROW1(bVar3, bVar13)) == (*pbVar1 < '\0'))
        {
            ...
            *pc_var2 = *pc_var2 + bVar6 + (CARRY1(bVar7, bVar10) || CARRY1(bVar8, bVar14));
            ...
            ppVar15 = process_struct_1010_20ba(_g_Struct372_1050_0ed0, CONCAT22(unaff_DI, 0x3f));
            (i_var9 + 0x94) = ppVar15;
...
pub unsafe fn pass1_1038_801a(param_1: *mut u8) {
    ...
    ppVar2 = process_struct_1010_20ba(_g_Struct372_1050_0ed0, CONCAT22(in_stack_0000fff0, 0x30));
    u_var1 = (param_1 >> 0x10);
    u_var3 = pass1_1008_b340((param_1 + 0x94));
    pu_var4 = (u_var3 & 0xffff | ((u_var3 >> 0x10) | u_var3) << 0x10);
    if (u_var3 != 0) {
        pass1_1010_3770(ppVar2, u_var3);
        pu_var4 = pass1_1038_af40(_g_Struct112_a, *(param_1 + 6), 3);
    }
    return pu_var4;
}
...
pub unsafe fn pass1_1038_79f2(param_1: *mut u8, param_2: u32) {
    ...
    (**pp_var1)(&PTR_LOOP_1050_1008, (i_var3 + 4), pu_var2, extraout_dx);
    return;
}
...
pub unsafe fn pass1_1038_6c68(param_1: *mut Struct1153, param_2: u32, param_3: u32, param_4: u16) {
    ...
    ppVar5 = process_struct_1010_20ba(_g_Struct372_1050_0ed0, CONCAT22(in_stack_0000ffd8, 0x2f));
    ...
    if (local_bx_4.field_0x28 == 0) {
        ...
        loop {
            ...
            if (pu_var4 == 0x0) {
                ...
                b_var5 = pass1_1008_c6ae(_PTR_LOOP_1050_06e0, (u_var9 + 0xc), 0x40);
                if (b_var5 != 0) {
    ...
    while (local_6 < param_1_00) {
        ...
        if ((((local_SI_152 + local_6 * 4) != 0)
            && (
                ...
                b_var4 = pass1_1008_c6ae(_PTR_LOOP_1050_06e0, (u_var2 + 0xc), 0x2d),
                b_var4 != 0,
            ))
            && (
    ...
    if (lVar7 != 0) {
        ...
        if ((((temp_7ffe889d3b9.field_0x1a & param_2) == 0)
            && ((
                ...
                b_var4 = pass1_1008_c6ae(_PTR_LOOP_1050_06e0, u_var1, 0x2b),
                b_var4 != 0,
            )))
    ...
    while (local_6 < param_1_00) {
        ...
        if (((local_SI_123 + local_6 * 4) != 0)
            && (
                ...
                b_var4 = pass1_1008_c6ae(_PTR_LOOP_1050_06e0, (u_var3 + 0xc), 0x2e),
                b_var4 != 0,
            ))
        {
            u_var8 = (param_5 >> 0x10);
...
pub unsafe fn pass1_1038_57dc(param_1: *mut u8, param_2: *mut u8, param_3: *mut Struct1129) {
...
pub unsafe fn pass1_1038_5804(param_1: *mut u8, param_2: libc::c_long, param_3: *mut Struct1130) {
    let mut u_var1: u16;
...
pub unsafe fn pass1_1038_5770(param_1: *mut u8, param_2: libc::c_long, param_3: *mut Struct1127) {
    let mut local_es_4: u16;
...
pub unsafe fn pass1_1038_5798(param_1: *mut u8, param_2: u32, param_3: *mut Struct1128) {
    let mut local_es_4: u16;
...
pub unsafe fn pass1_1038_53ba(param_1: *mut u8, param_2: *mut Struct1122) {
    let mut u_var1: u16;
    let mut local_a: u32;
    let mut local_6: u32;
...
pub unsafe fn pass1_1038_5464(param_1: *mut Struct1123) {
    ...
    while (local_e < _local_a) {
        ...
        if (u_var7 != 0) {
            ...
            pa_var5 = pass1_1028_e1ec(_PTR_LOOP_1050_65e2, local_12, extraout_dx_01);
            ...
            while (local_1e < local_1c) {
                ...
                if (u_var7 != 0) {
                    unaff_cs = SUB42(&PTR_LOOP_1050_1028, 0);
                    pa_var5 = pass1_1028_e1ec(_PTR_LOOP_1050_65e2, u_var4, extraout_dx_00);
...
pub unsafe fn pass1_1038_45e4(param_1: *mut Struct1109) {
    ...
    _local_16 = CONCAT22(extraout_dx_03, i_var8);
    u_var4 = *_local_16;
    ppc_var3 = u_var4 + 8;
    i_var9 = i_var8;
    (**ppc_var3)(&PTR_LOOP_1050_1008, i_var8, extraout_dx_03);
    if (_local_16 != 0x0) {
        ppc_var3 = u_var4;
        (**ppc_var3)(&PTR_LOOP_1050_1008, i_var8, extraout_dx_03, 1);
    }
    piVar1 = &local_bx_8.field_0x24;
    unsafe {
...
pub unsafe fn pass1_1038_4760(param_1: *mut Struct1109) {
    ...
    u_var8 = u_var4;
    ppc_var2(&PTR_LOOP_1050_1008, u_var4, extraout_dx_00);
    u_var13 = u_var3;
    u_var14 = extraout_dx;
    if ((extraout_dx_01 | u_var8) == 0) {
        ...
        while (local_1a < _local_16) {
            ...
            pass1_1028_5a94(i_var5, extraout_dx_03, pu_var12);
            if (i_var5 == 2) {
    ...
    if (_local_a != 0x0) {
        ppc_var2 = *_local_a;
        ppc_var2(u_var11, u_var3, extraout_dx, 1, u_var13, u_var14);
    }
    if (_local_e != 0x0) {
        ppc_var2 = *_local_e;
        ppc_var2(u_var11, u_var4, extraout_dx_00, 1);
    }
...
pub unsafe fn pass1_1038_52b8(param_1: *mut Struct1121, param_2: u32, param_3: *mut Struct1125) {
    ...
    if (param_3 != (s_New_failed_in_Op__Op_1050_0020 + 4)) {
        ...
        _local_a = CONCAT22(u_var6, i_var3);
        local_e = 0;
        while (local_e < _local_a) {
            uStack30 = local_e;
    ...
    if (g_u16_ptr_1050_5f2e != 0x0) {
        ...
        while (local_16 < _local_6) {
            ...
            if (u_var4 != 0) {
                ...
                i_var6 = _local_a;
                (i_var5 + i_var6) = paVar3;
                (i_var5 + i_var6 + 2) = u_var4;
                u_var9 = 0x1030;
                u_var10 = pass1_1030_73a8(CONCAT22(u_var4, (i_var5 + i_var6)));
                u_var8 = (_local_e >> 0x10);
                (_local_e + i_var5) = u_var10;
                (_local_e + i_var5 + 2) = (u_var10 >> 0x10);
            }
            local_16 = local_16 + 1;
        }
        local_16 = 0;
        ...
        pp_var11 = process_struct_1010_20ba(_g_Struct372_1050_0ed0, CONCAT22(unaff_si, 2));
...
pub unsafe fn pass1_1038_42cc(param_1: *mut Struct1104) {
    ...
    ppc_var2 = (*_local_a + 0x10);
    u_var5 = u_var4;
    ppc_var2(&PTR_LOOP_1050_1008, u_var4, extraout_dx);
    ...
    while (local_18 < _local_12) {
        ...
        if ((extraout_dx_01 | u_var6) != 0) {
            ppc_var2 = ((u_var8 & 0xffff | extraout_dx_01 << 0x10) + 0x50);
            ppc_var2();
            if (u_var6 != 0) {
                bVar3 = true;
            }
    ...
    if (_local_a != 0x0) {
        ppc_var2 = *_local_a;
        ppc_var2(u_var9, u_var4, extraout_dx, 1);
    }
    return;
}
...
pub unsafe fn pass1_1038_43cc(param_1: *mut Struct1106, param_2: u32, param_3: u16) {
    ...
    if ((in_dx != 0) || (in_AX != 0)) {
        ...
        u_var3 = u_var2;
        (**pp_var1)(&PTR_LOOP_1050_1008, u_var2, extraout_dx);
        ...
        if (_local_e != 0x0) {
            pp_var1 = *_local_e;
            (**pp_var1)(u_var9, u_var2, extraout_dx, 1);
            return;
        }
    }
    return;
...
pub unsafe fn pass1_1038_44d8(
    ...
    if ((in_dx != 0) || (in_AX != 0)) {
        ...
        (**pp_var1)(&PTR_LOOP_1050_1008, local_AX_121, local_DX_128);
        ...
        if (param_2 < param_3) {
                ...
                || (u_var2 = local_bx_14.field_0x210, (u_var2 + 10) == 0))
            {
                ...
                while (local_a < u_var7) {
                    ...
                    pa_var5 = u_var8;
                    if ((((extraout_dx_01 | pa_var5) != 0)
                        && (
                            pass1_1030_cc44(pa_var5, extraout_dx_01, local_c, param_4, 4),
                            pa_var5 != 0x0,
                        ))
...
pub unsafe fn pass1_1038_3ba0(param_1: *mut Struct1097) {
    ...
    ppc_var2(&PTR_LOOP_1050_1008, pu_var9, extraout_dx_00);
    u_var7 = pu_var9;
    ...
    if (pu_var4 != 0x0) {
        ...
        ppc_var2(u_var13, u_var5, extraout_dx_00, 1);
    }
    return;
}
...
pub unsafe fn pass1_1038_3cc0(param_1: u32, param_2: u16, param_3: u16, param_4: u16) {
    ...
    if (param_3_00 == 0x1e) {
        ...
        ppc_var2 = (*_local_a + 0x10);
        pu_var5 = pu_var9;
        ppc_var2(&PTR_LOOP_1050_1008, pu_var9, extraout_dx_01);
        ...
        ppc_var2 = (*_local_1a + 0x10);
        u_var10 = u_var4;
        ppc_var2(&PTR_LOOP_1050_1008, u_var4, extraout_dx_04);
...
pub unsafe fn pass1_1038_349e(param_1: *mut Struct1086, param_2: u32) {
    ...
    while (local_a < _local_6) {
        ...
        u_var4 = u_var5;
        if ((extraout_dx_00 | u_var4) != 0) {
            ppc_var2 = ((u_var5 & 0xffff | extraout_dx_00 << 0x10) + 0x58);
            ppc_var2(
                0x1030,
                u_var4,
                extraout_dx_00,
    ...
    if (i_var9 == 2) {
        ...
        if (i_var9 == 4) {
            ...
            if ((local_6 == (&PTR_LOOP_1050_0000 + 1)) && ((local_6 & 0xff0000) == 0)) {
                ...
                alloc_mem_1000_1708(0x6c, 0, 1, _g_Struct94_ptr_1, g_u16_ptr_1050_5f2e);
            ...
            if (i_var9 == 5) {
                ...
                if (i_var9 == 7) {
                    ...
                    pa_var7 = pass1_1028_e1ec(_PTR_LOOP_1050_65e2, u_var4, (u_var4 >> 0x10));
...
pub unsafe fn pass1_1038_0e78(param_1: u32, param_2: u32) {
    ...
    pp_var1 = u_var2 + 8;
    u_var8 = u_var3;
    (**pp_var1)(&PTR_LOOP_1050_1008, u_var3, extraout_dx);
    u_var8 = extraout_dx_00 | u_var8;
    if (u_var8 == 0) {
        if (_local_a != 0x0) {
            pp_var1 = u_var2;
            (**pp_var1)(8, u_var3, extraout_dx, 1);
            return;
        }
    } else {
        u_var9 = SUB42(&PTR_LOOP_1050_1008, 0);
        ...
        pp_var1 = (*_local_e + 0x10);
        u_var5 = u_var4;
        (**pp_var1)(&PTR_LOOP_1050_1008, u_var4, extraout_dx_01);
        ...
        if (_local_a != 0x0) {
            pp_var1 = *_local_a;
            (**pp_var1)(u_var9, u_var3, extraout_dx, 1);
        }
        if (_local_e != 0x0) {
            pp_var1 = *_local_e;
            (**pp_var1)(u_var9, u_var4, extraout_dx_01, 1);
        }
    }
    return;
}
...
pub unsafe fn pass1_1038_1220(param_1: u32, param_2: u32) {
    ...
    _local_a = CONCAT22(extraout_dx, i_var3);
    pp_var1 = (*_local_a + 0x10);
    i_var4 = i_var3;
    (**pp_var1)(&PTR_LOOP_1050_1008, i_var3, extraout_dx);
    if ((extraout_dx_00 != 0) || (i_var4 != 0)) {
        u_var7 = extraout_dx_00;
        pu_var6 = pass1_1008_c6fa(_PTR_LOOP_1050_06e0, 5);
        i_var5 = pu_var6;
        pass1_1038_4d6e(param_2, pu_var6 & 0xffff | u_var7 << 0x10);
        _local_e = CONCAT22(extraout_dx_01, i_var5);
        u_var8 = i_var5;
        u_var2 = *_local_e;
        pp_var1 = u_var2 + 8;
        i_var4 = i_var5;
        (**pp_var1)(&PTR_LOOP_1050_1008, u_var8, extraout_dx_01);
        if (((extraout_dx_02 != 0) || (u_var7 = extraout_dx_02, i_var4 != 0))
            && (
                pass1_1038_11b0(
                    param_1,
                    CONCAT13((extraout_dx >> 8), CONCAT12(extraout_dx, i_var3)),
                    CONCAT22(extraout_dx_01, i_var5),
                ),
            ...
            ))
        {
            ...
            pp_var1 = u_var2;
            (**pp_var1)(8, u_var8, extraout_dx_01, 1);
            return;
        }
        if (_local_e != 0x0) {
            pp_var1 = *_local_e;
        ...
        i_var5 = pu_var6;
        pass1_1038_4d6e(param_2, pu_var6 & 0xffff | u_var7 << 0x10);
        _local_e = CONCAT22(extraout_dx_05, i_var5);
        pp_var1 = (*_local_e + 0x10);
        i_var4 = i_var5;
    ...
    if (_local_a != 0x0) {
        pp_var1 = *_local_a;
        (**pp_var1)(8, i_var3, extraout_dx, 1);
    }
    return;
}
            ...
            while (local_3a < local_38) {
                ...
                if (((local_46 != 0) && (0xd < local_42)) && (local_42 < 0x1d)) {
                    ...
                    if (local_a == 0) {
                        ...
                        _local_e = CONCAT22(pa_var10, pu_var5);
...
pub unsafe fn pass1_1038_16f2(param_1: u32, param_2: u32, param_3: u32) {
    ...
    if (in_dx != 0) {
        ...
        while (local_16 < _local_12) {
            ...
            pa_var7 = pass1_1028_e1ec(_PTR_LOOP_1050_65e2, u_var15, u_var6);
            unaff_cs = 0x1030;
...
pub unsafe fn pass1_1038_1940(param_1: u32, param_2: u32, param_3: u32) {
    ...
    if (_local_a != 0x0) {
        pp_var1 = *_local_a;
        (**pp_var1)(&PTR_LOOP_1050_1008, u_var2, extraout_dx, 1);
    }
    return;
}
...
pub unsafe fn pass1_1038_19a0(param_1: u32, param_2: u32, param_3: u32) {
    ...
    if ((extraout_dx_00 | u_var4) == 0) {
        ...
        if (_local_a != 0x0) {
            pp_var1 = u_var2;
            (**pp_var1)(0x1030, u_var3, extraout_dx, 1);
            return;
        }
    } else {
        ...
        if (_local_a != 0x0) {
            pp_var1 = *_local_a;
            (**pp_var1)(&PTR_LOOP_1050_1008, u_var3, extraout_dx, 1);
        }
    }
    return;
}
        ...
        if (u_var8 != 0) {
            ...
            if ((i_var5 != 0) && ((&paVar4[1].field_0x16 + 2) != 0)) {
                ...
                if (i_var5 == 0) {
                    ...
                    i_var5 = (u_var10 + 0xc);
                    unaff_cs = SUB42(&PTR_LOOP_1050_1008, 0);
                    BVar6 = pass1_1008_c6ae(_PTR_LOOP_1050_06e0, i_var5, 1);
                    if (BVar6 == 0) {
                        unaff_cs = SUB42(&PTR_LOOP_1050_1008, 0);
                        BVar6 = pass1_1008_c6ae(_PTR_LOOP_1050_06e0, i_var5, 2);
                        if (BVar6 == 0) {
                            BVar6 = pass1_1008_c6ae(_PTR_LOOP_1050_06e0, i_var5, 5);
                            if (BVar6 == 0) {
                                unaff_cs = SUB42(&PTR_LOOP_1050_1008, 0);
                                BVar6 = pass1_1008_c6ae(_PTR_LOOP_1050_06e0, i_var5, 6);
                                if (BVar6 == 0) {}
                                // goto LAB_1038_1c76;
                            }
                            unaff_cs = SUB42(&PTR_LOOP_1050_1008, 0);
...
pub unsafe fn pass1_1038_26ee(param_1: u16, param_2: u16, param_1_00: *mut Struct493) {
    ...
    pa_var5 = (extraout_dx_01 | local_a);
    if (pa_var5 == 0x0) {
...
pub unsafe fn pass1_1038_0c00(param_1: u32) {
    ...
    loop {
        ...
        if (_local_20 != 0x0) {
            pp_var1 = *_local_20;
            (**pp_var1)(8, u_var4, extraout_dx_01, 1);
        }
...
pub unsafe fn pass1_1038_008e(param_1: u16, param_2: u16, param_1_00: *mut Struct1050) {
    ...
    pp_var7 = process_struct_1010_20ba(_g_Struct372_1050_0ed0, CONCAT22(in_stack_0000ffd4, 0x2c));
    ...
    if (local_c != 0) {
        pp_var8 =
            process_struct_1010_20ba(_g_Struct372_1050_0ed0, CONCAT22(in_stack_0000ffd4, 0x2b));
...
pub unsafe fn pass1_1038_01c0(param_1: u16, param_2: u16, param_1_00: u32) {
    ...
    loop {
        ...
        while (local_32 < u_var4) {
            ...
            pa_var5 = (u_var15 & 0xffff | extraout_dx_02 << 0x10);
...
pub unsafe fn pass1_1030_ecf8(param_1: u32) {
    ...
    local_c = 0;
    ppVar15 = process_struct_1010_20ba(_g_Struct372_1050_0ed0, CONCAT22(local_68, 0x2f));
    ...
    ppVar15 = process_struct_1010_20ba(_g_Struct372_1050_0ed0, CONCAT22(local_68, 2));
            ...
            ))
        {
            ...
            while (local_40 < u_var6) {
                ...
                if (u_var11 != 0) {
                    ...
                    pa_var7 = pass1_1028_e1ec(_PTR_LOOP_1050_65e2, u_var10, extraout_dx_03);
...
pub unsafe fn pass1_1030_ea50(param_1: u32, param_2: *mut Struct493) {
    ...
    u_var4 = (param_1 >> 0x10);
    i_var3 = param_1;
    BVar2 = pass1_1008_c6ae(_PTR_LOOP_1050_06e0, (i_var3 + 0x110), 3);
    if (BVar2 != 0) {
...
pub unsafe fn pass1_1030_e0d4() {
    ...
    pp_var9 = process_struct_1010_20ba(_g_Struct372_1050_0ed0, CONCAT22(unaff_si, 0x40));
    local_4 = (pp_var9 >> 0x10);
    local_6 = pp_var9;
    _local_a = pass1_1008_b820(pp_var9);
            ...
            if (local_AX_104.field_0x8 != 0) {
                ...
                if (paVar3 != 0x0) {
                    ...
                    if (local_10 == 0) {
                        ...
                        i_var6 = (local_bx_211 + 0x58c8);
                    } else {
                        i_var6 = (local_14 + 0xe) * 0xc;
                        local_2a = (i_var6 + 0x58be);
                        i_var6 = (i_var6 + 0x58c2);
                    }
                    i_var7 = i_var6;
...
pub unsafe fn pass1_1030_dcf4(param_1: *mut Struct44) {
    ...
    if (_PTR_LOOP_1050_65e2 != 0) {
        ...
        if ((iVar10 + 0x20) == 0) {
            ...
            u_var11 = u_var5;
            ppc_var2(&PTR_LOOP_1050_1038, u_var5, extraout_dx);
            ...
            if (_local_14 != 0x0) {
                ppc_var2 = *_local_14;
                ppc_var2(0x38, u_var5, extraout_dx, 1);
            }
        } else {
            u_var1 = (iVar10 + 0x20);
            u_var9 = in_dx;
...
pub unsafe fn pass1_1030_da22(param_1: *mut Struct44) {
    ...
    loop {
        ...
        if ((((extraout_dx_00 | u_var6) != 0)
            && (
                b_var5 = pass1_1008_c6ae(_PTR_LOOP_1050_06e0, (u_var6 + 0xc), 4),
                b_var5 != 0,
            ))
            && (
...
pub unsafe fn pass1_1030_ca26(param_1: *mut Struct44, param_3: *mut u8) {
    let u_var1: u8;
    let extraout_var: u32;
    let mut in_dx: i32;
