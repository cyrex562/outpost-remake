...
use crate::util::{read_string_from_rsrc, ZEXT24};
    ...
    if (param_1.field_0x8) != 0x0 {
        ...
        if (l_var9 == 0xe) && (param_3 == 0x0) {
            ...
            if local_18 == &ctx.PTR_LOOP_1050_4d42 {
                _llseek16(s_tile2_bmp_1050_1538, 0x0, 0x0);
                ...
                if (i_var7 + 0x22) != 0x0 {
                    pass1_1008_4b8e(param_1, pu_var6, unaff_di, unaff_ss);
                    return pu_var6;
                }
                return pu_var6;
            }
...
pub fn file_fn_1008_6eee(param_1: u16, param_2: u16, param_3: u32) {
    ...
    if (BVar1 != 0x0) {
        ...
        if (BVar1 != 0x0) {
            ...
            if ((uVar3 >> 0x10) != 0x0) {
                u_var2 = pass1_1038_7b20(ctx.PTR__LOOP_1050_5a64, param_3, unaff_SS);
                if (u_var2 != 0x0) {
...

{
    ...
    if (var5 != 0x0) {
        ...
        if (var5 != 0x0) {
            ...
            if (var5 != 0x0) {
                i_var3 = read_file_1038_7c02(ctx.PTR__LOOP_1050_5a64, param_3, var5, u_var1);
                if (i_var3 != 0x0) {
...

{
    ...
    u_var1 = lVar2;
    if ((buffer < lVar2) && ((true || (buffer < u_var1)))) {
        u_var1 = buffer;
    }
    iStack24 = u_var1 - 0x2;
    if (iStack24 < 0x0) {
...
ppcVar1 = ( * param_2 + 0x4); uVar3 = uStack6; ( * * ppcVar1)(); local_20 = uVar3; u_var4 = extraout_DX_00; uStack30 = extraout_DX_00; local_18 = local_20; uStack22 = extraout_DX_00; BVar2 = write_to_file_1008_7e1c
...
let uVar3: u16; let local_12: [u16; 0x3]; let local_c: [u16;0x2]; let local_8: u16; let local_6: u16; let local_4: u16;
...
(u_var2, uVar3, local_12, param_4,0x2, param_3); if (BVar1 != 0x0) {
local_c[0] = local_6; BVar1 = write_to_file_1008_7e1c
(u_var2, uVar3, local_c, param_4, 0x2, param_3); if (BVar1 != 0x0) {
local_c[0] = local_8; BVar1 = write_to_file_1008_7e1c
(u_var2, uVar3, local_c, param_4, 0x2, param_3); if (BVar1 != 0x0) {
return 0x1;
}
}
...

{
    ...
    BVar2 = write_to_file_1008_7e1c(param_1, (param_1 >> 0x10), local_c,
...
pub fn read_file_1008_7cfe(param_1: u16, param_2: u16, param_3: u16,
...
// TODO: refactor for loop
        ...
        //     }
        //     bVar1 = false;
        //     u_var2 = pass1_1008_7e4a((ctx.PTR__s_dcbSC_1050_0336_1050_033c >> 0x10),
        //                             param_5,in_AF,
...
pub fn read_file_1008_7dee(param_1: u16, param_2: u16, param_3: u16, param_4: u16,
                           param_5: u16, param_6: SEGPTR, param_7: HFILE16) -> bool
...

{
    ...
    if (param_3 == 0x0) {
        ...
        if ((BVar3 != 0x0) && (u_var5 = read_file_1008_7dee(uVar11, uVar12, local_10, 0x0, param_6, 0x2, param_5,
        ), u_var5 != 0x0)) {
            if (local_10[0] == 0x0) {
                return;
            }
            ...
            loop {
                ...
                if ((((puVar6 == 0x0) || (BVar3 = read_file_1008_7dee(uVar11, uVar12, local_14, 0x0, param_6, 0x2,
                                                                      0x1000), BVar3 == 0x0)) || (BVar3 = read_file_1008_7dee(uVar11, uVar12, &local_8, 0x0, param_6, 0x4,
                                                                                                                              0x1000), BVar3 == 0x0)) || (BVar3 = read_file_1008_7dee(uVar11, uVar12, local_18, 0x0, param_6, 0x2,
