use crate::defines::{
    Struct18, Struct199, Struct200, Struct76, Struct_1008_496c, Struct_1008_49e8, U32Ptr,
};
...
use crate::pass::pass_1008::{
    pass1_1008_3e76, pass1_1008_3eb4, pass1_1008_4b8e, pass1_1008_7006, pass1_1008_7056,
    pass1_1008_72a8,
};
...
use crate::struct_ops::struct_1008::{
    set_struct_1008_574a, struct_1008_dcdc, struct_op_1008_3f92, struct_op_1008_48fe,
    struct_op_1008_4c98,
};
...
use crate::util::{read_string_from_addr, read_string_from_rsrc, ZEXT24};
use crate::winapi::{WIN16_hread, _hwrite16, _lclose16, _lcreat16, _llseek16, _lopen16};
use crate::{
    util::{CONCAT11, CONCAT22},
    win_struct::{HFILE16, SEGPTR},
};

use super::file_1020::read_file_1020_a65e;
use super::file_1028::read_file_1028_d7ba;
use super::file_1030::read_file_1030_5c52;
    ...
    if (param_1.field_0x8) != 0x0 {
        ...
        if (l_var9 == 0xe) && (param_3 == 0x0) {
            ...
            if local_18 == ctx.PTR_LOOP_1050_4d42 {
                ...
                l_var9 = mem_op_1000_0a48(ctx, 0x1, u_stack6, ctx.PTR_LOOP_1050_5f2c, 0x1000);
                // pu_var6 = (l_var9 >> 0x10);
                ...
                l_var9 = WIN16_hread(
                    0x1000,
                    u_stack6,
                    CONCAT22((param_1.field_0x1a), (u_stack6 >> 0x10)),
                );
                // pu_var5 = (l_var9 >> 0x10);
                u_stack10 = l_var9;
                pu_stack8 = pu_var5;
                ...
                if pu_var6 == 0x0 {
                    ...
                    struct_op_1008_4c98((u_var3 & 0xffff | ZEXT24(pu_var5) << 0x10), u_var4, 0x100);
...
pub fn file_1008_6414(
    ...
    *param_1 = 0x0;
    (var4 + 0x4) = 0x0;
    var2 = var7;
    struct_op_1008_48fe(CONCAT22(param_3, var2), 0x1, param_2, param_4);
    mem_op_1000_179c(0x1e, param_4, 0x1000);
    var6 = CONCAT22(param_4, var2);
    var3 = param_4 | var2;
    if (var3 == 0x0) {
        *param_1 = 0x0;
    } else {
        var2 = var7;
        struct_op_1008_3f92(var6, CONCAT22(param_3, var2));
        param_1 = var2;
        (var4 + 0x2) = var3;
    }
    var1 = (*param_1 + 0x14);
    (**var1)();
    (var4 + 0x4) = var2;
    (var4 + 0x6) = extraout_dx;
    close_file_1008_496c(var7, param_3);
    return;
}

pub fn close_file_1008_6dd0(ctx: &mut AppContext, param_1: U32Ptr, param_2: HFILE16) {
    let u_var1: u16;
...
pub fn file_fn_1008_6eee(
    ...
    var6 = *ctx.PTR_LOOP_1050_5748;
    var10 = *var6;
    pass1_1020_a43e(unaff_ss, in_dx, CONCAT22(unaff_ss, var4));
    var1 = pass1_1028_d7a0(var10, (var10 >> 0x10), param_3, unaff_ss);
    if (var1 != 0x0) {
        var1 = pass1_1030_5c1a(ctx.PTR_LOOP_1050_5736, param_3, unaff_ss);
        if (var1 != 0x0) {
            var3 = write_to_file_1028_dce2(ctx.PTR_LOOP_1050_65e2, param_3, unaff_ss);
            if ((var3 >> 0x10) != 0x0) {
                var2 = pass1_1038_7b20(ctx.PTR_LOOP_1050_5a64, param_3, unaff_ss);
                if (var2 != 0x0) {
                    var1 = pass1_1020_a644(var4, unaff_ss, param_3, unaff_ss);
                    if (var1 != 0x0) {
                        return;
                    }
                }
...
pub fn write_to_file_1008_70a6(
    ctx: &mut AppContext,
    param_1: U32Ptr,
    param_2: &String,
    unaff_ss: u16,
    ...
    string_4 = param_2;
    if ((var1 + 0x4) != -0x1) {
        string_4 = ctx.s_tile2_bmp_1050_1538;
        _lclose16(param_2);
        (var1 + 0x4) = 0xffff;
    }
    h_file_1 = _lcreat16(&string_4, 0x0);
    (var1 + 0x4) = h_file_1;
    if (h_file_1 == 0xffff) {
        ...
        string_4 = str_op_1000_3da4(0x105065a0);
        var3 = _hwrite16(0x1000, &mut string_4, CONCAT22(0x65a0, string_4 >> 0xf));
        if ((var3 == string_4) && (true)) {
            return 0x1;
        }
...
pub fn file_1008_7548(
    ...
    if (local_6 != 0x0) {
        ...
        if (*param_2 == 0x0) {
            param_3 = 0x1000;
            mem_op_1000_179c(ctx, 0x1e, local_6._2_2_, 0x1000);
...
pub fn file_1008_76e4(
    ...
    var6 = 0x0;
    // u_var4 = (param_1 >> 0x10);
    var2 = read_file_1008_7dee(param_1, u_var4, &var6, 0x0, param_4, 0x4, param_3);
    if (var2 == 0x0) {
        return;
    }
    if (var6 != 0x0) {
        if (*param_2 == 0x0) {
            param_3 = 0x1000;
            mem_op_1000_179c(ctx, 0x18, param_5, 0x1000);
            if ((param_5 | var2) == 0x0) {
                *param_2 = 0x0;
            } else {
                param_3 = 0x1030;
...
pub fn file_1008_77cc(
    ...
    if (local_4 != 0x0) {
        if (*param_2 == 0x0) {
            param_4 = 0x1000;
            mem_op_1000_179c(ctx, 0xa, param_3, 0x1000);
...
pub fn write_to_file_1008_7954(
    ...
    local_18 = param_3;
    uStack22 = u_var4;
    BVar2 = write_to_file_1008_7e1c(param_1, u_var5, &local_18, param_5, 0x4, param_4);
    if (BVar2 != 0x0) {
        uStack10 = 0x0;
        loop {
            if (uStack6 <= uStack10) {
            ...
            BVar2 = write_to_file_1008_7e1c(param_1, u_var5, &local_20, param_5, 0x4, param_4);
            if (BVar2 == 0x0) {
                break;
            }
            uStack10 += 0x1;
...
pub fn write_to_file_1008_7a22(
    ctx: &mut AppContext,
    param_1: u32,
    param_2: i32,
    file_handle_1: HFILE16,
    param_4: u16,
) {
    let b_var1: bool;
    let u_var2: u16;
    ...
    u_var2 = param_1;
    // u_var3 = (param_1 >> 0x10);
    b_var1 = write::write_to_file_1008_7e1c(u_var2, u_var3, &local_12, param_4, 0x2, file_handle_1);
    if (b_var1 == 0x0) {
        ctx.PTR_LOOP_1050_0310 = 0x6d0;
    } else {
        uStack6 = 0x0;
...
pub fn write_to_file_1008_7b4c(
    ...
    u_var2 = param_1;
    // u_var3 = (param_1 >> 0x10);
    b_var1 = write_to_file_1008_7e1c(u_var2, u_var3, local_12, param_4, 0x2, param_3);
    if (b_var1 != 0x0) {
        local_c[0] = local_6;
        b_var1 = write_to_file_1008_7e1c(u_var2, u_var3, local_c, param_4, 0x2, param_3);
        if (b_var1 != 0x0) {
            local_c[0] = local_8;
            b_var1 = write_to_file_1008_7e1c(u_var2, u_var3, local_c, param_4, 0x2, param_3);
            if (b_var1 != 0x0) {
...
pub fn read_file_1008_7cfe(
    ...
    loop {
        ...
        //   if (local_406[uStack1040] == *ctx.PTR_s_dcbSC_1050_0336_1050_033c) {
        //     if (!bVar1) {
        //       bVar1 = true;
...
pub fn file_1008_bb5e(
    ...
    u_var11 = param_2;
    // uVar12 = (param_2 >> 0x10);
    read_file_1008_7cfe(ctx, u_var11, 0x16, param_5, param_6);
    if (param_3 == 0x0) {
        ...
        if ((BVar3 != 0x0)
            && (
                u_var5 = read_file_1008_7dee(u_var11, uVar12, local_10, 0x0, param_6, 0x2, param_5),
                u_var5 != 0x0,
            ))
        {
            if (local_10[0] == 0x0) {
            ...
            loop {
                ...
                uVar13 = 0x12;
                u_var4 = &mut local_10[0];
                mem_op_1000_179c(ctx, 0x12, puVar8, 0x1000);
                ...
                puVar6 = local_118;
                u_var10 = uVar9;
                read_file_1008_7c6e(ctx, u_var11, uVar12, CONCAT22(param_6, puVar6), 0x1000);
                if ((((puVar6 == 0x0)
                    || (
                        BVar3 = read_file_1008_7dee(
                            u_var11, uVar12, local_14, 0x0, param_6, 0x2, 0x1000,
                        ),
                        BVar3 == 0x0,
                    ))
                    || (
                        BVar3 = read_file_1008_7dee(
                            u_var11, uVar12, &local_8, 0x0, param_6, 0x4, 0x1000,
                        ),
                        BVar3 == 0x0,
                    ))
                    || (
                        BVar3 = read_file_1008_7dee(
                            u_var11, uVar12, local_18, 0x0, param_6, 0x2, 0x1000,
                        ),
                        BVar3 == 0x0,
                    ))
                {
                ...
                uVar7 = str_op_1008_60e8(ctx, CONCAT22(param_6, local_118), u_var10);
        ...
        if (BVar3 != 0x0) {
            ...
            loop {
                ...
                if ((((BVar3 == 0x0)
                    ...
                    || (
                        BVar3 =
                            read_file_1008_7dee(uVar7, uVar8, local_12, 0x0, param_6, 0x2, 0x1000),
                        BVar3 == 0x0,
                    ))
                    || ((
                        BVar3 = read_file_1008_7dee(
