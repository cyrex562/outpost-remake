...
let uVar4: u16; let extraout_DX_00: u16;
let uVar5: u16; let local_20: u16;
let uStack30: u16; let local_18: u16;
let uStack22: u16; let uStack10: u32;
let uStack6: u32;

if (param_2 == 0x0) {
param_3 = 0x0; uVar4 = 0x0;
}
else {
...
ctx.PTR_LOOP_1050_0310 = 0x6d0; return uVar4;
}
...
CONCAT22(param_4, & local_4)); local_12[0] = local_4; uVar2 = param_1;
// uVar3 = (param_1 >> 0x10);
BVar1 = write_to_file_1008_7e1c
(uVar2, uVar3, local_12, param_4,0x2, param_3); if (BVar1 != 0x0) {
local_c[0] = local_6; BVar1 = write_to_file_1008_7e1c
(uVar2, uVar3, local_c, param_4, 0x2, param_3); if (BVar1 != 0x0) {
...

{
    ...
    if (param_3 == 0x0) {
        ...
        if ((BVar3 != 0x0) && (uVar5 = read_file_1008_7dee(uVar11, uVar12, local_10, 0x0, param_6, 0x2, param_5,
        ), uVar5 != 0x0)) {
            if (local_10[0] == 0x0) {
                return;
            }
...
pub fn file_1008_e70e(param_1: u32, param_2: u32, param_3: i16, param_4: *mut u8, param_5: u16,
                      param_6: u16)
