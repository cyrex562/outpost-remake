use crate::defines::{Struct18, Struct76, Struct_1008_496c, Struct_1008_49e8, U32Ptr};
...
use crate::pass::pass_1008::{
    pass1_1008_3e76, pass1_1008_4b8e, pass1_1008_7006, pass1_1008_7056, pass1_1008_72a8,
};
...
pub fn file_fn_1008_6eee(param_1: u16, param_2: u16, param_3: u32) {
    ...
    puStack6 = *PTR_LOOP_1050_5748;
    uStack10 = *puStack6;
    pass1_1020_a43e(unaff_SS, in_DX, CONCAT22(unaff_SS, local_e));
    b_var1 = pass1_1028_d7a0(uStack10, (uStack10 >> 0x10), param_3, unaff_SS);
    if (b_var1 != 0x0) {
    ...
    if (var5 != 0x0) {
        ...
        if (var5 != 0x0) {
            ...
            if (var5 != 0x0) {
                ...
                if (i_var3 != 0x0) {
                    b_var4 =
                        read_file_1020_a65e(CONCAT22(param_4, local_e), param_3, param_4, local_e);
                    if (b_var4 != 0x0) {
                        return;
                    }
                }
...
pub fn write_to_file_1008_70a6(param_1: U32Ptr, param_2: &String) -> u16 {
    ...
    if (HVar1 == 0xffff) {
        ...
        lVar5 = _hwrite16(0x1000, &mut string_4, CONCAT22(0x65a0, string_4 >> 0xf));
        if ((lVar5 == string_4) && (true)) {
            return 0x1;
        }
...
pub fn write_to_file_1008_7cac(param_1: u32, param_2: u16) -> bool {
    ...
    sys_1000_3f9c(
        ...
        0x340,
        ctx.data_seg,
        ctx.PTR_s_dcbSC_1050_0336_1050_033c,
        &stack0xfffe,
        unaff_ES,
        0x1000,
        param_2,
...
pub fn read_file_1008_7cfe(
    ...
    loop {
        ...
        //   if (local_406[uStack1040] == *PTR_s_dcbSC_1050_0336_1050_033c) {
        //     if (!bVar1) {
        //       bVar1 = true;
