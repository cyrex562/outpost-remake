...
pub fn file_1010_0c7c(param_1: u32, param_2: u32, param_3: i16, param_4: U32Ptr, param_5: u16)
{
  ...
  uVar7 = param_2;
 // uVar8 = (param_2 >> 0x10);
  read_file_1008_7cfe(uVar7, 0x6, 0x1008, param_5);
  if (param_3 == 0x0) {
...
//           TODO: goto LAB_1010_0cb1;
      ...
      if ((BVar3 != 0x0) &&
         (BVar3 = read_file_1008_7dee(uVar7,uVar8,&iVar6.field_0x10,0x0,u_var5,0x2,0x1008)
         , BVar3 != 0x0)) {
  ...
  if (b_var1 != 0x0) {
   ...
   // u_var4 = (param_2 >> 0x10);
    b_var1 = write_to_file_1008_7e1c
                      (u_var3,u_var4,local_10,param_3,0x4,0x1008);
    if (b_var1 != 0x0) {
