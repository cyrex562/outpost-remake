  ...
  if (BVar2 != 0x0) {
   ...
   // uVar6 = (param_2 >> 0x10);
    BVar2 = write_to_file_1008_7e1c
                      (u_var5,uVar6,local_1a,param_3,0x2,0x1008);
    if (BVar2 != 0x0) {
      ...
      uStack16 = local_14[0];
      BVar2 = write_to_file_1008_7e1c
                        (u_var5,uVar6,local_14,param_3,0x2,0x1008);
      while (BVar2 != 0x0) {
  ...
  if (BVar1 != 0x0) {
   ...
   // u_var4 = (param_2 >> 0x10);
    BVar1 = write_to_file_1008_7e1c
                      (uVar3,u_var4,local_c,param_3,0x2,0x1008);
    if (BVar1 != 0x0) {
      local_6[0] = (param_1 + 0x20);
      BVar1 = write_to_file_1008_7e1c
                        (uVar3,u_var4,local_6,param_3,0x2,0x1008);
      if (BVar1 != 0x0) {
...
pub fn write_to_file_1028_3d0e(param_1: u32,param_2: u32,param_3: u16,param_4: u16)
{
  ...
  if (BVar1 != 0x0) {
   ...
   // u_var4 = (param_2 >> 0x10);
    BVar1 = write_to_file_1008_7e1c
                      (param_2,u_var4,local_10,param_3,0x4,0x1008);
    if (BVar1 != 0x0) {
      local_8 = (iVar2 + 0x24);
      BVar1 = write_to_file_1008_7e1c
                        (param_2,u_var4,&local_8,param_3,0x4,0x1008
                        );
      if (BVar1 != 0x0) {
...
pub fn pass1_1028_5fcc(param_1: i16,param_2: U32Ptr,param_3: i16,param_4: u16)
{
  ...
  file_1028_b81a((param_3 + 0x6),(param_3 + 0xa),param_1,param_4,
                 param_2);
  if ((param_1 != 0x0) &&
     (u_var1 = (param_3 + 0x6), u_var2 = (param_3 + 0xa),
...

{
  ...
  if (in_AX != 0x0) {
    ...
    u_var1 = (param_1 + 0xa);
    BVar2 = write_to_file_1008_7e1c
                      (u_var1,(u_var1 >> 0x10),param_1 - 0xa,param_2,
                       0x2,0x1008);
    if (BVar2 == 0x0) {
      ctx.PTR_LOOP_1050_0310 = 0x6d0;
      return BVar2;
...

{
 ...
 // u_var4 = (param_1 >> 0x10);
  ...
  u_var5 = param_2;
 // uVar6 = (param_2 >> 0x10);
  BVar2 = write_to_file_1008_7e1c(u_var5,uVar6,local_e,param_3,0x2,0x1008);
  if (BVar2 == 0x0) {
    ctx.PTR_LOOP_1050_0310 = 0x6d0;
    return 0x0;
  }
  ...
  local_8[0] = (iVar3 + 0xc);
  BVar2 = write_to_file_1008_7e1c(u_var5,uVar6,local_8,param_3,0x2,0x1008);
  if (BVar2 == 0x0) {
    ctx.PTR_LOOP_1050_0310 = 0x6d0;
    return 0x0;
  }
  ...
  if (iStack4 == 0x3 || iStack4 + -0x2 < 0x1) {
    ...
    if (iStack4 == 0x4) {
      if ((iVar3 + 0x14) == 0x0) {
        local_8[0] = 0x0;
        BVar2 = write_to_file_1008_7e1c
                          (u_var5,uVar6,local_8,param_3,0x2,0x1008);
...
pub fn file_1028_b81a(param_1: u32,param_2: u32,param_3: i16,param_4: u16,param_5: U32Ptr)
{
 ...
 // uVar6 = (param_1 >> 0x10);
  ...
  u_var5 = param_2;
 // uVar8 = (param_2 >> 0x10);
  BVar1 = read_file_1008_7dee(u_var5,uVar8,&local_4,0x0,param_4,0x2,0x1008);
  if (BVar1 == 0x0) {
    ctx.PTR_LOOP_1050_0310 = 0x6d2;
    return;
  }
  BVar1 = read_file_1008_7dee(u_var5,uVar8,&local_6,0x0,param_4,0x2,0x1008);
  if (BVar1 == 0x0) {
    ctx.PTR_LOOP_1050_0310 = 0x6d2;
    return;
  }
  BVar1 = read_file_1008_7dee(u_var5,uVar8,&local_8,0x0,param_4,0x2,0x1008);
  if (BVar1 == 0x0) {
    ctx.PTR_LOOP_1050_0310 = 0x6d2;
    return;
  }
  iVar2 = switch_1008_73ea(u_var5,uVar8,local_4);
  (pu_var3 + 0x3) = iVar2;
  iVar2 = switch_1008_73ea(u_var5,uVar8,local_6);
  (pu_var3 + 0xe) = iVar2;
  iVar2 = switch_1008_73ea(u_var5,uVar8,local_8);
  (pu_var3 + 0x4) = iVar2;
  BVar1 = read_file_1008_7dee(u_var5,uVar8,&local_4,0x0,param_4,0x2,0x1008);
  if (BVar1 == 0x0) {
    ctx.PTR_LOOP_1050_0310 = 0x6d2;
  ...
  BVar1 = read_file_1008_7dee(u_var5,uVar8,pu_var3 + 0x1a,0x0,uVar6,0x2,0x1008);
  if (BVar1 == 0x0) {
    ctx.PTR_LOOP_1050_0310 = 0x6d2;
    return;
  }
  ...
  0x3 =>
    puVar4 = pu_var3 + 0x5;
//LAB_1028_b968:
    BVar1 = read_file_1008_7dee(u_var5,uVar8,puVar4,0x0,uVar6,0x2,0x1008);
    break;
  0x4 =>
    uVar7 = pass1_1028_e0bc(ctx.PTR__LOOP_1050_65e2,(pu_var3 + 0x3),pu_var3,param_5,
                            param_4);
...
//       TODO: goto LAB_1028_b968;
    ...
    BVar1 = read_file_1008_7dee(u_var5,uVar8,local_26,0x0,param_4,0x2,0x1008);
    break;
  0x5 =>
    puVar4 = pu_var3;
    pass1_1028_e100(ctx.PTR__LOOP_1050_65e2,(pu_var3 + 0x3),param_5);
    (pu_var3 + 0x5) = puVar4;
    (pu_var3 + 0x16) = param_5;
    puStack16 = ((pu_var3 + 0x5) + 0xa4);
    puStack14 = param_5;
    BVar1 = read_file_1008_7dee(u_var5,uVar8,puStack16,0x0,param_5,0x2,
                                0x1008);
    if (BVar1 == 0x0) {
      ctx.PTR_LOOP_1050_0310 = 0x6d2;
      return;
    }
    BVar1 = read_file_1008_7dee(u_var5,uVar8,local_2a,0x0,param_4,0x2,0x1008);
    if (BVar1 == 0x0) {
      ctx.PTR_LOOP_1050_0310 = 0x6d2;
      return;
    }
    uVar7 = pu_var3[0x5];
    BVar1 = read_file_1008_7dee(u_var5,uVar8,uVar7 + 0xa8,0x0,(uVar7 >> 0x10),
                                0x2,0x1008);
    if (BVar1 == 0x0) {
      ctx.PTR_LOOP_1050_0310 = 0x6d2;
      return;
    ...
    uVar7 = pu_var3[0x5];
    BVar1 = read_file_1008_7dee(u_var5,uVar8,uVar7 + 0xaa,0x0,(uVar7 >> 0x10),
                                0x2,0x1008);
    if (BVar1 == 0x0) {
      ctx.PTR_LOOP_1050_0310 = 0x6d2;
      return;
    ...
    uVar7 = pu_var3[0x5];
    BVar1 = read_file_1008_7dee(u_var5,uVar8,uVar7 + 0xac,0x0,(uVar7 >> 0x10),
                                0x2,0x1008);
    if (BVar1 == 0x0) {
      ctx.PTR_LOOP_1050_0310 = 0x6d2;
      return;
                                      ...
                                      if (BVar2 != 0x0) {
                                        ...
                                        if (BVar2 != 0x0) {
                                          ...
                                          loop {
                                            ...
                                            uStack24 = CONCAT22(u_var4,pu_var3);
...
pub fn read_file_1028_def2(param_1: u32,param_2: u32,param_3: u16,param_4: u16)
{
  ...
  u_var4 = param_2;
 // u_var5 = (param_2 >> 0x10);
  read_file_1008_7cfe(u_var4,u_var5,0xa,0x1008,param_3);
  if (param_4 != 0x0) {
   // uVar3 = (param_1 >> 0x10);
    BVar2 = read_file_1008_7dee(u_var4,u_var5,param_1,0x0,uVar3,0x4,0x1008);
    if (BVar2 != 0x0) {
      BVar2 = read_file_1008_7dee(u_var4,u_var5,param_1 + 0x8,0x0,uVar3,0x2,0x1008);
      if (BVar2 != 0x0) {
        ...
        (**ppcVar1)(0x1008,_PTR_LOOP_1050_5166,
                    (ctx.PTR__LOOP_1050_5166 >> 0x10),param_2);
        if (BVar2 != 0x0) {
          read_file_1008_7cfe(u_var4,u_var5,0xc,0x1008,param_3);
          if (BVar2 != 0x0) {
            pass1_1028_e628(param_1,u_var4,u_var5,0x0,0x100,unaff_SI,unaff_DI,uVar3,param_3,
                            in_AF);
            if (BVar2 != 0x0) {
              read_file_1008_7cfe(u_var4,u_var5,0xd,0x1008,param_3);
              if (BVar2 != 0x0) {
                pass1_1028_e628(param_1,u_var4,u_var5,0x0,0x200,unaff_SI,unaff_DI,uVar3,
                                param_3,in_AF);
                if (BVar2 != 0x0) {
                  read_file_1008_7cfe(u_var4,u_var5,0xe,0x1008,param_3);
                  if (BVar2 != 0x0) {
                    pass1_1028_e628(param_1,u_var4,u_var5,0x0,0x300,unaff_SI,unaff_DI,uVar3,
                                    param_3,in_AF);
                    if (BVar2 != 0x0) {
                      read_file_1008_7cfe(u_var4,u_var5,0xf,0x1008,param_3);
                      if (BVar2 != 0x0) {
                        pass1_1028_e628(param_1,u_var4,u_var5,0x0,0x400,unaff_SI,unaff_DI,
                                        uVar3,param_3,in_AF);
                        if (BVar2 != 0x0) {
                          read_file_1008_7cfe(u_var4,u_var5,0x10,0x1008,param_3);
                          if (BVar2 != 0x0) {
                            pass1_1028_e628(param_1,u_var4,u_var5,0x0,0x500,unaff_SI,
                                            unaff_DI,uVar3,param_3,in_AF);
                            if (BVar2 != 0x0) {
                              read_file_1008_7cfe(u_var4,u_var5,0x11,0x1008,param_3);
                              if (BVar2 != 0x0) {
                                pass1_1028_e628(param_1,u_var4,u_var5,0x0,0x600,unaff_SI,
                                                unaff_DI,uVar3,param_3,in_AF);
                                if (BVar2 != 0x0) {
                                  read_file_1008_7cfe(u_var4,u_var5,0x12,0x1008,param_3);
                                  if (BVar2 != 0x0) {
                                    pass1_1028_e628(param_1,u_var4,u_var5,0x0,0x700,unaff_SI
                                                    ,unaff_DI,uVar3,param_3,in_AF);
                                    if (BVar2 != 0x0) {
                                      read_file_1008_7cfe(u_var4,u_var5,0x13,0x1008,param_3)
                                      ;
                                      if (BVar2 != 0x0) {
