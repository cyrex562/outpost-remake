...
use crate::file::file_1008::{file_1008_76e4, file_1008_77cc, read_file_1008_7bc8, read_file_1008_7c6e, read_file_1008_7dee};
use crate::file::write::write_to_file_1008_7e1c;
use crate::fn_ptr::fn_ptr_1000::{fn_ptr_1000_17ce, fn_ptr_op_1000_1708};
use crate::global::AppContext;
use crate::mem_1000::{mem_op_1000_160a, mem_op_1000_179c, mem_op_1000_0a48};
...
use crate::pass::pass_1030::{pass1_1030_4782, pass1_1030_84ae, pass1_1030_5164};
use crate::string::string_1008::str_op_1008_60e8;
use crate::struct_ops::struct_1008::set_struct_1008_574a;
use crate::util::{CONCAT22, read_struct_from_addr, write_struct_to_addr, ZEXT24};
use crate::winapi::{_lclose16, WIN16_hread, _lopen16};
...
pub fn file_1030_1730(param_1: u32, param_2: u32) {
    ...
    // u_var1 = (param_1 >> 0x10);
    // u_var3 = (param_2 >> 0x10);
    BVar2 = read_file_1008_7dee(param_2, u_var3, param_1 + 0x4, 0x0, u_var1, 0x4,
                                0x1008);
    if (BVar2 != 0x0) {
        BVar2 = read_file_1008_7dee(param_2, u_var3, param_1 + 0x8, 0x0, u_var1, 0x4,
                                    0x1008);
        if (BVar2 != 0x0) {
            return;
        }
...

{
    ...
    if param_3 != 0x0 {
        ...
        u_var4 = param_2;
        bvar5 = read_file_1008_7dee(param_2, u_var4, &i_var10.field_0x10, 0x0,
                                    pu_var7, 0x2, 0x1008);
        if bvar5 != false {
            ...
            pi_var2 = i_var10.field_0x10;
            u_var1 = (pi_var2 + 0x2);
            bvar5 = read_file_1008_7dee(param_2, u_var4, u_var1, 0x0,
                                        (u_var1 >> 0x10), u_var3, 0x1008);
            if (bvar5 != 0x0) {
                return 0x1;
            }
        }
...
pub fn read_file_1030_33f0(param_1: u32, param_2: u32) {
    let u_var1: u16;
    ...
    if (((((BVar2 != 0x0) && (BVar2 = read_file_1008_7dee(u_var3, u_var4, &i_var2.field_0x174, 0x0, u_var1, 0xc, 0x1008), BVar2 != 0x0)) && (BVar2 = read_file_1008_7dee(u_var3, u_var4, &i_var2.field_0x180, 0x0, u_var1, 0xc, 0x1008),
                                                                                                                                             BVar2 != 0x0)) && ((BVar2 = read_file_1008_7dee(u_var3, u_var4, &i_var2.field_0x18c, 0x0, u_var1, 0x18, 0x1008), BVar2 != 0x0 && (BVar2 = read_file_1008_7dee(u_var3, u_var4, &i_var2.field_0x1a8, 0x0, u_var1, 0x2, 0x1008),
                                                                                                                                                                                                                                                                               BVar2 != 0x0)))) && (BVar2 = read_file_1008_7dee(u_var3, u_var4, &i_var2.field_0x1aa, 0x0, u_var1, 0x4, 0x1008),
                                                                                                                                                                                                                                                                                                    BVar2 != 0x0)) {
        if (ctx.PTR_LOOP_1050_0312 < 0x2) {
            return;
        }
        BVar2 = read_file_1008_7dee(u_var3, u_var4, &i_var2.field_0x170, 0x0, u_var1, 0x4, 0x1008);
        if ((BVar2 != 0x0) && (BVar2 = read_file_1008_7dee(u_var3, u_var4, &i_var2.field_0x1ae, 0x0, u_var1, 0x2, 0x1008),
                               BVar2 != 0x0)) {
            return;
        }
    }
...
// param_5 = (lVar5 >> 0x10);
                ...
                if ((param_5 | param_3) != 0x0) {
                    l_stack56 = WIN16_hread(0x1000, *param_2,
...
pub fn file_1030_581e(param_1: u32, param_2: u32, param_3: i16, param_4: U32Ptr, param_5: u16) {
    ...
    if (param_3 != 0x0) {
        ...
        u_var4 = fn_ptr_op_1000_1708(0x20, 0x0, 0x1, PTR_LOOP_1050_5f2c,
        ...
        if (BVar5 != 0x0) {
            ...
            iVar12.field_0x12 = puVar9;
            BVar5 = read_file_1008_7dee(u_var4, u_var11, iVar12.field_0x10 + 0x2, 0x0, puVar9, 0x2, 0x1008);
            if (BVar5 != 0x0) {
                puVar6 = local_408;
                ...
                if (puVar6 != 0x0) {
                    ...
                    uVar8 = &iVar12.field_0x10;
                    BVar5 = read_file_1008_7dee(u_var4, u_var11, uVar8 + 0x1a, 0x0,
                    ...
                    if (BVar5 != 0x0) {
                        ...
                        // }
                        BVar5 = read_file_1008_7bc8(param_2,
                                                    (param_1 & 0xffff0000 | &iVar12.field_0x14), 0x1008,
                                                    param_5);
                        if ((BVar5 != 0x0) && (BVar5 = read_file_1008_7dee(u_var4, u_var11, &iVar12.field_0x1c, 0x0, uVar12,
...
// u_var2 = (param_2 >> 0x10);
read_file_1008_7cfe(param_2, u_var2, 0x9, 0x1008,param_4); if (param_3 != 0x0) {
b_var1 = read_file_1008_7dee(param_2, u_var2, param_1,0x0,
(param_1 > > 0x10), 0x24, 0x1008); if (b_var1 == 0x0) {
ctx.PTR_LOOP_1050_0310 = 0x6d2; return b_var1;
}
param_3 = 0x1;
}
return param_3;
                                    ...
                                    if (BVar3 != 0x0) {
                                        ...
                                        loop {
                                            ...
                                            if ((((BVar3 == 0x0) || (BVar3 = read_file_1008_7dee(uVar13, uVar14, local_42, 0x0, param_5, 0x2, 0x1008), BVar3 == 0x0
                                                                               ...
                                                                               local_3e, 0x0, param_5, 0x2, 0x1008), BVar3 == 0x0)) || ((BVar3 = read_file_1008_7dee(uVar13, uVar14,
                                                                                                                                                                     paStack74 + 0xa, 0x0,
                                                                                                                                                                     (paStack74 >> 0x10), 0x2, 0x1008),
                                                                                                                                         BVar3 == 0x0 || (BVar3 = read_file_1008_7dee(uVar13, uVar14,
                                                                                                                                                                                      paStack74 + 0xc, 0x0,
                                                                                                                                                                                      (paStack74 >> 0x10), 0x2, 0x1008),
                                                                                                                                                          BVar3 == 0x0)))) { break; }
