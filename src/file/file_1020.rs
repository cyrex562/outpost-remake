...
pub fn read_file_1020_a65e(param_1: u32,param_2: u32,param_3: u16,
                   param_4: u16) -> bool

{
  ...
  u_var2 = param_2;
 // u_var3 = (param_2 >> 0x10);
  read_file_1008_7cfe(u_var2,u_var3,0xb,0x1008,param_3);
  if (param_4 != 0x0) {
...
//LAB_1020_a6dc:
    ...
    if (b_var1 != 0x0) {
      ...
      if (b_var1 != 0x0) {
        ...
        if (b_var1 != 0x0) {
          param_4 = read_file_1008_7dee(u_var2,u_var3,local_a,0x0,param_3,0x2,0x1008
                                       );
          if (param_4 != 0x0) {
// goto LAB_1020_a6dc;
}
...

{
  ...
  if (in_AX != 0x0) {
   ...
   // u_var3 = (param_2 >> 0x10);
    b_var1 = write_to_file_1008_7e1c
                      (param_2,u_var3,local_c,param_3,0x2,0x1008);
    if (b_var1 != 0x0) {
      local_6[0] = (param_1 + 0x26);
      b_var1 = write_to_file_1008_7e1c
                        (param_2,u_var3,local_6,param_3,0x2,0x1008)
      ;
      if (b_var1 != 0x0) {
        return 0x1;
      }
