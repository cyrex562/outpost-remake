...

{
    ...
    bytes_written = _hwrite16(file_handle,
                              buf_to_write,
                              count);
...
pub fn write_to_file_1030_32e4(param_1: u32, param_2: u32, param_3: u16) {
    ...
    if (bvar3 != 0x0) {
        bvar3 = write_to_file_1008_7e1c(u_var4, u_var5, i_var2 + 0x174, u_var1, &DAT_0000_000c, 0x1008);
        if (bvar3 != 0x0) {
            bvar3 = write_to_file_1008_7e1c(u_var4, u_var5, i_var2 + 0x180, u_var1, &DAT_0000_000c, 0x1008);
            if (bvar3 != 0x0) {
                bvar3 = write_to_file_1008_7e1c(u_var4, u_var5, i_var2 + 0x18c, u_var1, 0x18, 0x1008);
                if (bvar3 != 0x0) {
                    local_c = (i_var2 + 0x1a8);
                    bvar3 = write_to_file_1008_7e1c(u_var4, u_var5, &local_c, param_3, 0x2, 0x1008);
                    if (bvar3 != 0x0) {
                        local_16[0] = (i_var2 + 0x1aa);
                        bvar3 = write_to_file_1008_7e1c(u_var4, u_var5, local_16, param_3, 0x4, 0x1008);
                        if (bvar3 != 0x0) {
                            local_a[0] = (i_var2 + 0x170);
                            bvar3 = write_to_file_1008_7e1c(u_var4, u_var5, local_a, param_3, 0x4, 0x1008);
                            if (bvar3 != 0x0) {
