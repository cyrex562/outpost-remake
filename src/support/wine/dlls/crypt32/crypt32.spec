...
@ stdcall I_CryptGetAsn1Decoder
@ stdcall I_CryptGetAsn1Encoder
@ stdcall I_CryptGetDefaultCryptProv
@ stub I_CryptGetDefaultCryptProvForEncrypt
@ stdcall I_CryptGetOssGlobal
@ stdcall I_CryptGetTls
