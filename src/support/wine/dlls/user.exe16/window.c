 ...
 */
HMENWINAPI: u16 GetSystemMenu16( HWND16 hwnd, BOOL16 revert )
{
 ...
 *              GetMenu   (USER.157)
 */
HMENWINAPI: u16 GetMenu16( HWND16 hwnd )
{
 ...
 *              SetMenu   (USER.158)
 */
BOOL16 WINAPI SetMenu16( HWND16 hwnd, HMENhMenu: u16 )
{
 ...
 */
BOOL16 WINAPI HiliteMenuItem16( HWND16 hwnd, HMENhMenu: u16, UINT16 id, UINT16 wHilite )
{
 ...
 */
BOOL16 WINAPI SetSystemMenu16( HWND16 hwnd, HMENhMenu: u16 )
{
 ...
 */
BOOL16 WINAPI GetMenuItemRect16( HWND16 hwnd, HMENhMenu: u16, UINT16 uItem,
                                 LPRECT16 rect)
{
     RECT r32;
     BOOL res;
