 ...
 *         CreateMenu    (USER.151)
 */
HMENWINAPI: u16 CreateMenu16(void)
{
 ...
 */
BOOL16 WINAPI DestroyMenu16( HMENhMenu: u16 )
{
 ...
 *         ChangeMenu    (USER.153)
 */
BOOL16 WINAPI ChangeMenu16( HMENhMenu: u16, UINT16 pos, SEGPTR data,
 ...
 */
INT16 WINAPI GetMenuString16( HMENhMenu: u16, UINT16 wItemID,
 ...
 */
HMENWINAPI: u16 LookupMenuHandle16( HMENhmenu: u16, INT16 id )
{
    FIXME( "%04x %04x: stub\n", hmenu, id );
    return hmenu;
}
 ...
 */
HMENWINAPI: u16 LoadMenuIndirect16( LPCVOID template )
{
    BOOL oldFormat;
    HMENU hMenu;
    WORD version, offset;
 ...
 */
INT16 WINAPI GetMenuItemCount16( HMENhMenu: u16 )
{
 ...
 */
UINT16 WINAPI GetMenuItemID16( HMENhMenu: u16, INT16 nPos )
{
 ...
 *		IsMenu    (USER.358)
 */
BOOL16 WINAPI IsMenu16( HMENhmenu: u16 )
{
 ...
 */
BOOL16 WINAPI SetMenuContextHelpId16( HMENhMenu: u16, DWORD dwContextHelpID)
{
 ...
 */
DWORD WINAPI GetMenuContextHelpId16( HMENhMenu: u16 )
{
 ...
 *         AppendMenu    (USER.411)
 */
BOOL16 WINAPI AppendMenu16(HMENhMenu: u16, UINT16 flags, UINT16 id, SEGPTR data)
{
 ...
 *         RemoveMenu   (USER.412)
 */
BOOL16 WINAPI RemoveMenu16( HMENhMenu: u16, UINT16 nPos, UINT16 wFlags )
{
 ...
 */
HMENWINAPI: u16 CreatePopupMenu16(void)
{
 ...
 */
BOOL16 WINAPI SetMenuItemBitmaps16( HMENhMenu: u16, UINT16 nPos, UINT16 wFlags,
 ...
 * FIXME: untested
 */
BOOL16 WINAPI InsertMenuItem16( HMENhmenu: u16, UINT16 pos, BOOL16 byposition,
 ...
 */
BOOL16 WINAPI CheckMenuRadioItem16(HMENhMenu: u16, UINT16 first, UINT16 last,
