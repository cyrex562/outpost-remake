...
#OpenAL AL_1_0
@ cdecl alEnable wine_alEnable
@ cdecl alDisable wine_alDisable
@ cdecl alIsEnabled wine_alIsEnabled
@ cdecl alGetString wine_alGetString
...
@ cdecl alGetBoolean wine_alGetBoolean
@ cdecl alGetInteger wine_alGetInteger
@ cdecl alGetFloat wine_alGetFloat
@ cdecl alGetDouble wine_alGetDouble
...
@ cdecl alIsSource wine_alIsSource
...
@ cdecl alSourcePlay wine_alSourcePlay
@ cdecl alSourceStop wine_alSourceStop
@ cdecl alSourceRewind wine_alSourceRewind
@ cdecl alSourcePause wine_alSourcePause
...
@ cdecl alIsBuffer wine_alIsBuffer
...
@ cdecl alDopplerFactor wine_alDopplerFactor
@ cdecl alDopplerVelocity wine_alDopplerVelocity
@ cdecl alDistanceModel wine_alDistanceModel
#OpenAL ALC_1_1
...
@ cdecl alSpeedOfSound wine_alSpeedOfSound
