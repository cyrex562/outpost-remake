...
@ cdecl _ismbbalnum ucrtbase._ismbbalnum
@ stub _ismbbalnum_l
@ cdecl _ismbbalpha ucrtbase._ismbbalpha
@ stub _ismbbalpha_l
@ stub _ismbbblank
@ stub _ismbbblank_l
@ cdecl _ismbbgraph ucrtbase._ismbbgraph
@ stub _ismbbgraph_l
@ cdecl _ismbbkalnum ucrtbase._ismbbkalnum
@ stub _ismbbkalnum_l
@ cdecl _ismbbkana ucrtbase._ismbbkana
@ stub _ismbbkana_l
@ cdecl _ismbbkprint ucrtbase._ismbbkprint
@ stub _ismbbkprint_l
@ cdecl _ismbbkpunct ucrtbase._ismbbkpunct
@ stub _ismbbkpunct_l
@ cdecl _ismbblead ucrtbase._ismbblead
@ cdecl _ismbblead_l(long ptr) ucrtbase._ismbblead_l
@ cdecl _ismbbprint ucrtbase._ismbbprint
@ stub _ismbbprint_l
@ cdecl _ismbbpunct ucrtbase._ismbbpunct
@ stub _ismbbpunct_l
@ cdecl _ismbbtrail ucrtbase._ismbbtrail
@ stub _ismbbtrail_l
@ cdecl _ismbcalnum ucrtbase._ismbcalnum
@ stub _ismbcalnum_l
@ cdecl _ismbcalpha ucrtbase._ismbcalpha
@ stub _ismbcalpha_l
@ stub _ismbcblank
@ stub _ismbcblank_l
@ cdecl _ismbcdigit ucrtbase._ismbcdigit
@ stub _ismbcdigit_l
@ cdecl _ismbcgraph ucrtbase._ismbcgraph
@ stub _ismbcgraph_l
@ cdecl _ismbchira ucrtbase._ismbchira
@ stub _ismbchira_l
@ cdecl _ismbckata ucrtbase._ismbckata
@ stub _ismbckata_l
@ cdecl _ismbcl0 ucrtbase._ismbcl0
@ stub _ismbcl0_l
@ cdecl _ismbcl1 ucrtbase._ismbcl1
@ stub _ismbcl1_l
@ cdecl _ismbcl2 ucrtbase._ismbcl2
@ stub _ismbcl2_l
@ cdecl _ismbclegal ucrtbase._ismbclegal
@ stub _ismbclegal_l
@ cdecl _ismbclower ucrtbase._ismbclower
@ stub _ismbclower_l
@ cdecl _ismbcprint ucrtbase._ismbcprint
@ stub _ismbcprint_l
@ cdecl _ismbcpunct ucrtbase._ismbcpunct
@ stub _ismbcpunct_l
@ cdecl _ismbcspace ucrtbase._ismbcspace
@ stub _ismbcspace_l
@ cdecl _ismbcsymbol ucrtbase._ismbcsymbol
@ stub _ismbcsymbol_l
@ cdecl _ismbcupper ucrtbase._ismbcupper
@ stub _ismbcupper_l
@ cdecl _ismbslead(ptr ptr) ucrtbase._ismbslead
@ stub _ismbslead_l
@ cdecl _ismbstrail(ptr ptr) ucrtbase._ismbstrail
@ stub _ismbstrail_l
@ cdecl _mbbtombc ucrtbase._mbbtombc
@ stub _mbbtombc_l
...
@ cdecl _mbcjistojms ucrtbase._mbcjistojms
@ stub _mbcjistojms_l
@ cdecl _mbcjmstojis ucrtbase._mbcjmstojis
@ stub _mbcjmstojis_l
@ cdecl _mbclen(ptr) ucrtbase._mbclen
@ stub _mbclen_l
@ cdecl _mbctohira ucrtbase._mbctohira
@ stub _mbctohira_l
@ cdecl _mbctokata ucrtbase._mbctokata
@ stub _mbctokata_l
@ cdecl _mbctolower ucrtbase._mbctolower
@ stub _mbctolower_l
@ cdecl _mbctombb ucrtbase._mbctombb
@ stub _mbctombb_l
@ cdecl _mbctoupper ucrtbase._mbctoupper
@ stub _mbctoupper_l
@ stub _mblen_l
