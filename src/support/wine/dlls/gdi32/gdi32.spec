...
@ stdcall CloseEnhMetaFile
@ stdcall CloseFigure
@ stdcall CloseMetaFile
...
@ stdcall DeleteColorSpace
@ stdcall DeleteDC
@ stdcall DeleteEnhMetaFile
@ stdcall DeleteMetaFile
@ stdcall DeleteObject
...
@ stdcall GdiInitializeLanguagePack
@ stdcall GdiIsMetaFileDC
@ stdcall GdiIsMetaPrintDC
@ stdcall GdiIsPlayMetafileDC
...
@ stdcall GetPixelFormat
@ stdcall GetPolyFillMode
@ stdcall GetROP2
...
@ stdcall GetStockObject
@ stdcall GetStretchBltMode
# @ stub GetStringBitmapA
# @ stub GetStringBitmapW
@ stdcall GetSystemPaletteEntries(long long long ptr)
@ stdcall GetSystemPaletteUse
@ stdcall GetTextAlign
@ stdcall GetTextCharacterExtra
@ stdcall GetTextCharset
@ stdcall GetTextCharsetInfo(long ptr long)
@ stdcall GetTextColor
...
@ stdcall UnrealizeObject
@ stdcall UpdateColors
...
# Graphics drivers
@ cdecl __wine_set_display_driver
