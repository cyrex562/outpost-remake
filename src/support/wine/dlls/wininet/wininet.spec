...
@ stdcall DeleteWpadCacheForNetworks
@ stdcall DetectAutoProxyUrl(str long long)
@ stdcall -private DllInstall(long wstr)
@ stdcall FindCloseUrlCache
...
@ stdcall InternetInitializeAutoProxyDll
