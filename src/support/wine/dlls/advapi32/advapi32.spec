...
@ stdcall CloseEventLog 
@ stdcall CloseServiceHandle
...
@ stdcall CryptDestroyHash
@ stdcall CryptDestroyKey
...
@ stdcall DeleteService
@ stdcall DeregisterEventSource
...
@ stdcall ImpersonateAnonymousToken
@ stdcall ImpersonateLoggedOnUser
@ stdcall ImpersonateNamedPipeClient
@ stdcall ImpersonateSelf
...
@ stdcall NotifyBootConfigStatus
