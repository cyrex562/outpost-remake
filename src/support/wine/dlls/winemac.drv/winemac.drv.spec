...
@ cdecl wine_get_gdi_driver macdrv_get_gdi_driver
...
@ cdecl CreateDesktopWindow macdrv_CreateDesktopWindow
@ cdecl CreateWindow macdrv_CreateWindow
@ cdecl DestroyCursorIcon macdrv_DestroyCursorIcon
@ cdecl DestroyWindow macdrv_DestroyWindow
...
@ cdecl GetKeyboardLayout macdrv_GetKeyboardLayout
...
@ cdecl SetCursor macdrv_SetCursor
@ cdecl SetCursorPos(long long) macdrv_SetCursorPos
@ cdecl SetFocus macdrv_SetFocus
