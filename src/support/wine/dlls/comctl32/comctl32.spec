...
152 stdcall -noname FreeMRUList
...
328 stdcall -ordinal DPA_Create
...
@ stdcall DestroyPropertySheetPage
...
@ stdcall ImageList_DragLeave
@ stdcall ImageList_DragMove(long long)
@ stdcall ImageList_DragShowNolock
...
@ stdcall InitMUILanguage
@ stdcall InitializeFlatSB
