@ cdecl __acrt_iob_func ucrtbase.__acrt_iob_func
...
@ cdecl _close ucrtbase._close
@ cdecl _commit ucrtbase._commit
@ cdecl _creat(str long) ucrtbase._creat
@ cdecl _dup ucrtbase._dup
@ cdecl _dup2(long long) ucrtbase._dup2
@ cdecl _eof ucrtbase._eof
...
@ cdecl _get_osfhandle ucrtbase._get_osfhandle
...
@ stub _getws_s
@ cdecl _isatty ucrtbase._isatty
...
@ cdecl _set_fmode ucrtbase._set_fmode
@ cdecl _set_printf_count_output ucrtbase._set_printf_count_output
@ cdecl _setmaxstdio ucrtbase._setmaxstdio
...
@ cdecl _tell ucrtbase._tell
@ cdecl -ret64 _telli64 ucrtbase._telli64
