...
@ cdecl pcap_datalink_val_to_description wine_pcap_datalink_val_to_description
@ cdecl pcap_datalink_val_to_name wine_pcap_datalink_val_to_name
...
@ stub pcap_stats_ex
@ cdecl pcap_strerror msvcrt.strerror
