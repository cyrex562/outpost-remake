...
@ cdecl wine_get_gdi_driver X11DRV_get_gdi_driver
...
@ cdecl GetKeyboardLayout X11DRV_GetKeyboardLayout
...
@ cdecl UnloadKeyboardLayout X11DRV_UnloadKeyboardLayout
@ cdecl VkKeyScanEx(long long) X11DRV_VkKeyScanEx
@ cdecl DestroyCursorIcon X11DRV_DestroyCursorIcon
@ cdecl SetCursor X11DRV_SetCursor
...
@ cdecl CreateDesktopWindow X11DRV_CreateDesktopWindow
@ cdecl CreateWindow X11DRV_CreateWindow
@ cdecl DestroyWindow X11DRV_DestroyWindow
...
@ cdecl SetFocus X11DRV_SetFocus
...
# WinTab32
@ cdecl AttachEventQueueToTablet X11DRV_AttachEventQueueToTablet
@ cdecl GetCurrentPacket(ptr) X11DRV_GetCurrentPacket
@ cdecl LoadTabletInfo X11DRV_LoadTabletInfo
