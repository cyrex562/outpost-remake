...
@ stdcall DispatchMessageA(ptr) user32.DispatchMessageA
@ stdcall DispatchMessageW(ptr) user32.DispatchMessageW
@ stdcall GetMessageA(ptr long long long) user32.GetMessageA
...
@ stdcall PeekMessageA(ptr long long long long) user32.PeekMessageA
@ stdcall PeekMessageW(ptr long long long long) user32.PeekMessageW
@ stdcall PostMessageA(long long long long) user32.PostMessageA
@ stdcall PostMessageW(long long long long) user32.PostMessageW
@ stdcall PostQuitMessage user32.PostQuitMessage
@ stdcall PostThreadMessageA(long long long long) user32.PostThreadMessageA
@ stdcall PostThreadMessageW(long long long long) user32.PostThreadMessageW
@ stdcall RegisterWindowMessageA(str) user32.RegisterWindowMessageA
@ stdcall RegisterWindowMessageW(wstr) user32.RegisterWindowMessageW
@ stdcall SendMessageA(long long long long) user32.SendMessageA
...
@ stdcall SetMessageQueue user32.SetMessageQueue
