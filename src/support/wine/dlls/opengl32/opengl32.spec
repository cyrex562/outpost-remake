...
@ stdcall glDisable
@ stdcall glDisableClientState
@ stdcall glDrawArrays(long long long)
@ stdcall glDrawBuffer
...
@ stdcall glPushAttrib
@ stdcall glPushClientAttrib
...
@ stdcall glShadeModel
@ stdcall glStencilFunc(long long long)
@ stdcall glStencilMask
...
@ stdcall glTexCoord1i
@ stdcall glTexCoord1iv(ptr)
@ stdcall glTexCoord1s
