...
@ stdcall ImmCreateIMCC
@ stdcall ImmCreateSoftKeyboard(long long long long)
@ stdcall ImmDestroyContext
@ stdcall ImmDestroyIMCC
@ stdcall ImmDestroySoftKeyboard
@ stdcall ImmDisableIME
@ stdcall ImmDisableIme ImmDisableIME
@ stdcall ImmDisableLegacyIME()
@ stdcall ImmDisableTextFrameService
...
@ stdcall ImmGetIMCCSize
@ stdcall ImmGetIMCLockCount
...
@ stdcall ImmUnlockIMC
@ stdcall ImmUnlockIMCC
...
@ stdcall __wine_register_window
@ stdcall __wine_unregister_window
