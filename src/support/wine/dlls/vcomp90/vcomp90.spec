...
@ cdecl _vcomp_sections_init vcomp._vcomp_sections_init
@ cdecl _vcomp_sections_next() vcomp._vcomp_sections_next
@ cdecl _vcomp_set_num_threads vcomp._vcomp_set_num_threads
@ cdecl _vcomp_single_begin vcomp._vcomp_single_begin
...
@ cdecl omp_set_dynamic vcomp.omp_set_dynamic
@ cdecl omp_set_lock(ptr) vcomp.omp_set_lock
@ cdecl omp_set_nest_lock(ptr) vcomp.omp_set_nest_lock
@ cdecl omp_set_nested vcomp.omp_set_nested
@ cdecl omp_set_num_threads vcomp.omp_set_num_threads
