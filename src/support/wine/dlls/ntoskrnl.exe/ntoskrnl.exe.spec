...
@ stdcall IoSetThreadHardErrorMode
...
@ stdcall KeSetSystemAffinityThread
...
@ stdcall MmAllocateNonCachedMemory
...
@ cdecl -private isdigit msvcrt.isdigit
@ cdecl -private islower msvcrt.islower
@ cdecl -private isprint msvcrt.isprint
@ cdecl -private isspace msvcrt.isspace
@ cdecl -private isupper msvcrt.isupper
@ cdecl -private isxdigit msvcrt.isxdigit
...
@ cdecl -private srand msvcrt.srand
...
@ cdecl -private tolower msvcrt.tolower
@ cdecl -private toupper msvcrt.toupper
@ cdecl -private towlower msvcrt.towlower
@ cdecl -private towupper msvcrt.towupper
