...
@ cdecl -arch=win32 ??2@YAPAXI@Z MSVCRT_operator_new
@ cdecl -arch=win64 ??2@YAPEAX_K@Z MSVCRT_operator_new
...
@ cdecl -arch=win32 ??_U@YAPAXI@Z MSVCRT_operator_new
@ cdecl -arch=win64 ??_U@YAPEAX_K@Z MSVCRT_operator_new
...
@ cdecl -arch=win32 ?Alloc@Concurrency@@YAPAXI@Z Concurrency_Alloc
@ cdecl -arch=win64 ?Alloc@Concurrency@@YAPEAX_K@Z Concurrency_Alloc
...
@ cdecl ?Oversubscribe@Context@Concurrency@@SAX_N@Z Context_Oversubscribe
@ cdecl -arch=win32 ?RegisterShutdownEvent@CurrentScheduler@Concurrency@@SAXPAX@Z CurrentScheduler_RegisterShutdownEvent
@ cdecl -arch=win64 ?RegisterShutdownEvent@CurrentScheduler@Concurrency@@SAXPEAX@Z CurrentScheduler_RegisterShutdownEvent
...
@ cdecl ?_set_new_mode@@YAHH@Z MSVCRT__set_new_mode
...
@ cdecl -arch=i386,win64 __crtTerminateProcess MSVCR110__crtTerminateProcess
@ cdecl __crtSleep MSVCRT__crtSleep
...
@ cdecl __isascii MSVCRT___isascii
@ cdecl __iscsym MSVCRT___iscsym
@ cdecl __iscsymf MSVCRT___iscsymf
@ stub __iswcsym
@ stub __iswcsymf
...
@ cdecl __set_app_type MSVCRT___set_app_type
...
@ cdecl __toascii MSVCRT___toascii
...
@ cdecl _byteswap_ulong MSVCRT__byteswap_ulong
@ cdecl _byteswap_ushort
@ cdecl _c_exit() MSVCRT__c_exit
@ cdecl _cabs MSVCRT__cabs
@ cdecl _callnewh
...
@ cdecl _chdrive MSVCRT__chdrive
...
@ cdecl _clearfp()
@ cdecl _close MSVCRT__close
@ cdecl _commit MSVCRT__commit
...
@ cdecl -arch=i386 _crt_debugger_hook MSVCRT__crt_debugger_hook
@ cdecl -arch=arm,win64 __crt_debugger_hook MSVCRT__crt_debugger_hook
@ varargs _cscanf(str)
...
@ cdecl _filelength MSVCRT__filelength
@ cdecl -ret64 _filelengthi64 MSVCRT__filelengthi64
@ cdecl _fileno(ptr) MSVCRT__fileno
@ cdecl _findclose MSVCRT__findclose
...
@ cdecl _fputchar MSVCRT__fputchar
@ cdecl _fputwc_nolock(long ptr) MSVCRT__fputwc_nolock
@ cdecl _fputwchar MSVCRT__fputwchar
...
@ cdecl _get_osfhandle MSVCRT__get_osfhandle
...
@ cdecl _malloc_crt MSVCRT_malloc
@ cdecl _mbbtombc
@ stub _mbbtombc_l
...
@ cdecl -arch=i386 _set_SSE2_enable MSVCRT__set_SSE2_enable
@ cdecl -arch=win64 _set_FMA3_enable MSVCRT__set_FMA3_enable
@ cdecl _set_abort_behavior(long long) MSVCRT__set_abort_behavior
@ cdecl _set_controlfp(long long)
@ cdecl _set_doserrno
@ cdecl _set_errno
@ cdecl _set_error_mode
@ cdecl _set_fmode MSVCRT__set_fmode
@ cdecl _set_invalid_parameter_handler(ptr)
@ stub _set_malloc_crt_max_wait
@ cdecl _set_output_format MSVCRT__set_output_format
@ cdecl _set_printf_count_output MSVCRT__set_printf_count_output
...
@ cdecl _setmaxstdio MSVCRT__setmaxstdio
@ cdecl _setmbcp
@ cdecl _setmode(long long) MSVCRT__setmode
@ stub _setsystime(ptr long)
@ cdecl _sleep MSVCRT__sleep
...
@ cdecl _strerror MSVCRT__strerror
@ stub _strerror_s
...
@ cdecl _tell MSVCRT__tell
@ cdecl -ret64 _telli64
...
@ cdecl _tolower MSVCRT__tolower
@ cdecl _tolower_l(long ptr) MSVCRT__tolower_l
@ cdecl _toupper MSVCRT__toupper
...
@ cdecl _wcserror MSVCRT__wcserror
...
@ cdecl fesetround MSVCRT_fesetround
@ stub fetestexcept
@ stub feupdateenv
...
@ cdecl isalnum MSVCRT_isalnum
@ cdecl isalpha MSVCRT_isalpha
@ cdecl isblank MSVCRT_isblank
@ cdecl iscntrl MSVCRT_iscntrl
@ cdecl isdigit MSVCRT_isdigit
@ cdecl isgraph MSVCRT_isgraph
@ cdecl isleadbyte MSVCRT_isleadbyte
@ cdecl islower MSVCRT_islower
@ cdecl isprint MSVCRT_isprint
@ cdecl ispunct MSVCRT_ispunct
@ cdecl isspace MSVCRT_isspace
@ cdecl isupper MSVCRT_isupper
@ cdecl iswalnum MSVCRT_iswalnum
@ cdecl iswalpha ntdll.iswalpha
@ cdecl iswascii MSVCRT_iswascii
@ cdecl iswblank MSVCRT_iswblank
@ cdecl iswcntrl MSVCRT_iswcntrl
@ cdecl iswctype(long long) ntdll.iswctype
@ cdecl iswdigit MSVCRT_iswdigit
@ cdecl iswgraph MSVCRT_iswgraph
@ cdecl iswlower MSVCRT_iswlower
@ cdecl iswprint MSVCRT_iswprint
@ cdecl iswpunct MSVCRT_iswpunct
@ cdecl iswspace MSVCRT_iswspace
@ cdecl iswupper MSVCRT_iswupper
@ cdecl iswxdigit MSVCRT_iswxdigit
@ cdecl isxdigit MSVCRT_isxdigit
@ cdecl labs MSVCRT_labs
...
@ cdecl strerror MSVCRT_strerror
...
@ cdecl tolower MSVCRT_tolower
@ cdecl toupper MSVCRT_toupper
@ stub towctrans
@ cdecl towlower MSVCRT_towlower
@ cdecl towupper MSVCRT_towupper
