...
@ stdcall CreateBitmapIndirect(ptr) gdi32.CreateBitmapIndirect
...
@ stdcall CreatePatternBrush gdi32.CreatePatternBrush
@ stdcall CreatePen(long long long) gdi32.CreatePen
@ stdcall CreateSolidBrush gdi32.CreateSolidBrush
@ stdcall DPtoLP(long ptr long) gdi32.DPtoLP
@ stdcall GdiAlphaBlend(long long long long long long long long long long long) gdi32.GdiAlphaBlend
@ stdcall GdiFlush() gdi32.GdiFlush
@ stdcall GetBitmapBits(long long ptr) gdi32.GetBitmapBits
@ stdcall GetBkColor gdi32.GetBkColor
@ stdcall GetBkMode gdi32.GetBkMode
@ stdcall GetDIBits(long long long long ptr ptr long) gdi32.GetDIBits
@ stdcall GetPixel(long long long) gdi32.GetPixel
...
@ stdcall OffsetViewportOrgEx(long long long ptr) gdi32.OffsetViewportOrgEx
@ stdcall PatBlt(long long long long long long) gdi32.PatBlt
@ stdcall PolyBezierTo(long ptr long) gdi32.PolyBezierTo
@ stdcall Polyline(long ptr long) gdi32.Polyline
@ stdcall Rectangle(long long long long long) gdi32.Rectangle
@ stdcall SetBkColor(long long) gdi32.SetBkColor
@ stdcall SetBkMode(long long) gdi32.SetBkMode
...
@ stdcall SetStretchBltMode(long long) gdi32.SetStretchBltMode
@ stdcall SetWindowExtEx(long long long ptr) gdi32.SetWindowExtEx
@ stdcall SetWindowOrgEx(long long long ptr) gdi32.SetWindowOrgEx
