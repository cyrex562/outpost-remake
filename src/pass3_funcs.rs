...
pub fn pass1_1028_121e(param_1: *mut Struct44) -> *mut Struct44 {
    ...
    u_var3 = (u_var4 >> 0x10);
    paVar2 = pass1_1028_e1ec(_PTR_LOOP_1050_65e2, u_var4, u_var3);
    if ((u_var3 | paVar2) == 0) {
        return 0x0;
    }
...
pub fn win_fn_1020_de32(param_1: u32, param_2: u16) {
    ...
    process_win_msg_1008_9510(&PTR_LOOP_1050_5b80, &g_alloc_addr_1050_1050, u_var3);
    u_var3 = (param_1 >> 0x10);
...
pub fn win_fn_1020_df10(param_1: u32, param_2: u32, param_3: u32) {
    ...
    if (in_AX == 0) {
        ...
        if (local_22._3_1_ != '\0') {
            paVar2 = pass1_1028_e1ec(_PTR_LOOP_1050_65e2, local_a, u_var3);
...
pub fn pass1_1020_e044(param_1: u32) {
    ...
    u_var3 = (u_var5 >> 0x10);
    paVar2 = pass1_1028_e1ec(_PTR_LOOP_1050_65e2, u_var5, u_var3);
...
pub fn pass1_1020_915a(param_1: *mut Struct697) {
    ...
    if (local_struct_1.field_0xb8 != i_var1) {
        ...
        u_var3 = mixed_fn_1010_830a(_g_struct_73_1050_14cc, local_c);
