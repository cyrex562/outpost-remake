...
pub fn pass1_1028_5f30(param_1: *mut Struct44) {
    ...
    if ((i_var6 + 0x12) == 5) {
        ...
        uVar3 = pass1_1030_25b2(pu_var4 & 0xffff | extraout_dx_00 << 0x10, i_var8);
        if (uVar3 != 0) {
            pi_var1 = (i_var6 + 0x20);
...
pub fn switch_fn_1028_297c(param_1: u32, param_2: u32, param_3: u32) {
    ...
    if (i_var2 == 0) {
        ...
        u_var5 = u_var4 | lVar6;
        if (lVar6 != 0) {
            paVar3 = pass1_1028_e1ec(_PTR_LOOP_1050_65e2, lVar6, u_var4);
...
pub fn pass1_1028_2e84(param_1: u16, param_2: u32) {
    ...
    if ((param_2 >> 0x10) == 0) {
        ...
        pass1_1010_043a(ppVar1, CONCAT22(uVar3, u_var2), u_var10);
...
pub fn pass1_1028_3246(param_1: *mut Struct44) {
    ...
    local_10 = in_dx;
    pass1_1030_7c50(CONCAT22(in_dx, local_12), CONCAT22(uVar3, u_var2), u_var4);
...
pub fn pass1_1028_36bc(param_1: u32, param_2: u32) {
    ...
    if ((param_1 + 0x28) != 0) {
        ...
        while (local_4 < 0x1d) {
            uVar3 = (param_1 + 0x28);
            u_var4 = pass1_1020_bae6(uVar3, CONCAT22(local_4, (uVar3 >> 0x10)));
            u_var2 = param_2;
...
pub fn pass1_1028_1556(param_1: u32) -> bool {
    ...
    while (true) {
        ...
        u_var6 = (u_var7 >> 0x10);
        paVar4 = pass1_1028_e1ec(_PTR_LOOP_1050_65e2, u_var7, u_var6);
        if ((u_var6 | paVar4) == 0) {
            return 0;
        }
        ...
        i_var1 = (u_var8 + 0xc);
        b_var5 = pass1_1008_c6ae(_PTR_LOOP_1050_06e0, i_var1, 0x13);
...
pub fn pass1_1028_21ba(param_1: u16, param_2: u16, param_1_00: u32, param_2_00: u32) -> bool {
    ...
    uVar3 = u_var2 | lVar4;
    if (lVar4 != 0) {
        paVar1 = pass1_1028_e1ec(_PTR_LOOP_1050_65e2, lVar4, u_var2);
        if ((uVar3 | paVar1) != 0) {
...
pub fn pass1_1028_04ee(param_1: u32, param_2: u32) {
    ...
    while {
        ...
        pi_var1 = (param_2 + 2);
        unsafe { *pi_var1 = *pi_var1 + CARRY2(uVar3, u_var2) };
...
pub fn pass1_1028_081e(param_1: *mut Struct44) {
    ...
    if (i_var2 < 0xfa) {
        ...
        if (0x1c1 < i_var2) {
            ...
            if ((i_var2 < 0x2ee) && (CONCAT22(uVar3, u_var6) % 3 != 0)) {
                return;
            }
            pi_var1 = &local_bx_41.field_0x20;
            unsafe { *pi_var1 = *pi_var1 + 1 };
        ...
        u_var6 = (CONCAT22(uVar3, u_var6) % 3);
    }
    if (u_var6 != 0) {
        return;
    }
...
pub fn pass1_1028_09d4(param_1: u32, param_2: u32, param_3: u32, param_4: u32) {
    ...
    if ((local_4 != 0) && (local_4 != 4)) {
        if (((local_4 - 5) < 1) || (SBORROW2(local_4 - 5, 1) || (3 < (local_4 - 6)))) {
            ...
            u_var4 = (u_var5 >> 0x10);
            paVar2 = pass1_1028_e1ec(_PTR_LOOP_1050_65e2, param_3, u_var8);
            u_var1 = &paVar2.field_0x10;
            paVar2 = pass1_1028_e1ec(_PTR_LOOP_1050_65e2, u_var1, (u_var1 >> 0x10));
            pu_var3 = local_6;
            pass1_1030_bcde(
...
pub fn pass1_1028_0c84(param_1: *mut Struct44, param_2: *mut u8) {
    ...
    if (local_e <= local_14) {
        ...
        local_24 = local_28;
        if (local_3a._3_1_ != '\0') {
            pa_var5 = pass1_1028_e1ec(_PTR_LOOP_1050_65e2, local_28, u_var6);
...
pub fn pass1_1028_0d9c(param_1: *mut Struct44) {
    ...
    if (local_16 <= local_14) {
        ...
        if (local_3a._3_1_ != '\0') {
            local_24 = local_28;
            paVar4 = pass1_1028_e1ec(_PTR_LOOP_1050_65e2, local_28, u_var6);
            local_3a = CONCAT22(u_var6, paVar4);
            u_var2 = pass1_1030_6fa0(CONCAT22(u_var6, paVar4));
            b_var5 = pass1_1008_c6ae(_PTR_LOOP_1050_06e0, CONCAT31(extraout_var_00, u_var2), 0x13);
            if (b_var5 != 0) {
...
pub fn pass1_1028_1024(param_1: *mut Struct44) -> i32 {
    ...
    while (true) {
        ...
        BVar2 = pass1_1008_c6ae(_PTR_LOOP_1050_06e0, (u_var7 + 0xc), 0x13);
...
pub fn pass1_1028_1106(param_1: *mut Struct44) -> i32 {
    ...
    while (true) {
        ...
        u_var4 = (u_var5 >> 0x10);
        paVar3 = pass1_1028_e1ec(_PTR_LOOP_1050_65e2, u_var5, u_var4);
        if ((u_var4 | paVar3) == 0) {
            break;
        }
        ...
        BVar2 = pass1_1008_c6ae(_PTR_LOOP_1050_06e0, (u_var6 + 0xc), 0x13);
        if (BVar2 != 0) {
            local_1a = local_1a & 0xffff | (local_1a._2_2_ + 1) << 0x10;
        }
        local_1a = local_1a & 0xffff0000 | (local_1a + 1);
...
pub fn pass1_1028_121e(param_1: *mut Struct44) -> *mut Struct44 {
    ...
    uVar3 = (u_var4 >> 0x10);
    paVar2 = pass1_1028_e1ec(_PTR_LOOP_1050_65e2, u_var4, uVar3);
    if ((uVar3 | paVar2) == 0) {
        return 0x0;
    }
...
pub fn pass1_1028_134a(param_1: *mut u32) {
    ...
    u_var8 = (param_1 >> 0x10);
    i_var7 = param_1;
    b_var4 = pass1_1008_c6ae(_PTR_LOOP_1050_06e0, (i_var7 + 0xc), 0x13);
    if (b_var4 != 0) {
        pu_var5 = &local_6;
        unsafe { ppc_var2 = (*param_1 + 0x40) };
        ppc_var2(&PTR_LOOP_1050_1008, i_var7, u_var8, pu_var5);
        if (pu_var5 != 0x0) {
            pi_var1 = (i_var7 + 0x22);
            unsafe { *pi_var1 = *pi_var1 + 1 };
            return;
        ...
        uVar3 = pass1_1028_b58e((u_var6 & 0xffff | in_dx << 0x10));
        local_16 = 0;
        while (local_16 < 10) {
...
pub fn pass1_1020_ea20(param_1: u32, param_2: u32, param_3: u32, param_4: u32) {
    ...
    pa_var5 = pass1_1028_e1ec(_PTR_LOOP_1050_65e2, local_8, local_38);
    ...
    if (local_e != 7) {
        ...
        if (local_22._3_1_ != '\0') {
            pa_var5 = pass1_1028_e1ec(_PTR_LOOP_1050_65e2, local_8, local_8._2_2_);
            _local_32 = CONCAT22(local_8._2_2_, pa_var5);
            pass1_1030_7296(CONCAT22(local_8._2_2_, pa_var5));
            pass1_1030_730a(_local_32);
            local_2e = process_struct_1010_20ba(_g_Struct372_1050_0ed0, CONCAT22(u_var10, 0x2f));
...
pub fn pass1_1020_ed3c(param_1: *mut Struct44) {
    ...
    if (pi_var1_val == 0) {
        ...
        uVar3 = extraout_dx;
        u_var2 = pass1_1028_b58e(param_1);
        _local_18 = CONCAT31(extraout_var_00, u_var2) & 0xffff | uVar3 << 0x10;
...
pub fn pass1_1028_0176(param_1: *mut Struct44, param_2: *mut u8) {
    ...
    u_var9 = 0x14;
    uVar3 = pass1_1028_b58e(param_1);
    pass1_1030_7f1a(uVar3, u_var6, u_var9);
    return;
}
...
pub fn pass1_1020_dca8(param_1: *mut Struct44) {
    ...
    pass1_1020_dc1c(param_1, CONCAT22(local_SS__1, local_2e));
    pass1_1008_3e54(CONCAT22(local_SS__1, local_2e), u_var1, uVar3, u_var4);
    pass1_1020_dc1c(param_1, CONCAT22(local_SS__1, local_2e));
    pass1_1008_3e54(CONCAT22(local_SS__1, local_2e), u_var1, uVar3, u_var5);
    pass1_1020_dc1c(param_1, CONCAT22(local_SS__1, local_2e));
...
pub fn pass1_1020_e08e(param_1: *mut Struct44) {
    ...
    pa_var5 = pass1_1028_e1ec(_PTR_LOOP_1050_65e2, local_14, (local_14 >> 0x10));
    pass1_1030_5b1c(
...
pub fn pass1_1020_e558(param_1: *mut Struct44) {
    ...
    if ((u_var5 + 0x24) != 6) {
        ...
        local_14 = local_18;
        if (local_30._3_1_ != '\0') {
            paVar3 = pass1_1028_e1ec(_PTR_LOOP_1050_65e2, local_14, u_var4);
...
pub fn pass1_1020_cac2(param_1: *mut Struct44) {
    ...
    pp_var8 = process_struct_1010_20ba(_g_Struct372_1050_0ed0, CONCAT22(in_stack_0000ffca, 2));
...
pub fn pass1_1020_d118(param_1: *mut u8, param_2: u32, param_3: u32, param_4: u32) {
    ...
    if (i_var1 == 5) {
        u_var2 = param_1;
        uVar3 = (param_1 >> 0x10);
        pass1_1028_c23e(u_var2, uVar3, param_2, param_3, param_4);
        if (i_var1 != 0) {
            pass1_1028_c3aa(u_var2, uVar3, param_2, param_3, param_4);
            if (i_var1 != 0) {
                u_var2 =
                    pass1_1028_c314(u_var2, uVar3, param_2, param_3, (param_3 >> 0x10), param_4);
                if (u_var2 != 0) {
                    return 1;
                }
            }
...
pub fn pass1_1020_d194(param_1: *mut Struct44) {
    ...
    u_var12 = (uVar15 >> 0x10);
    u_var1 = (uVar15 + 0x10);
    pa_var5 = pass1_1028_e1ec(_PTR_LOOP_1050_65e2, u_var1, (u_var1 >> 0x10));
    u_var13 = u_var12;
    u_var4 = pass1_1028_b58e(param_1);
    uVar3 = CONCAT31(extraout_var, u_var4) & 0xffff;
    puVar6 = local_4;
    pass1_1030_bd74(
        puVar6,
        unaff_ss,
    ...
    if (0x1e < puVar6) {
        ...
        if (i_var7 == 0) {
            u_var12 = extraout_dx;
            pu_var10 = pass1_1008_c6fa(_PTR_LOOP_1050_06e0, 0x15);
...
pub fn pass1_1020_b240(param_1: *mut u8, param_2: *mut u8, param_3: *mut u8) {
    ...
    local_22._3_1_ = (local_6 >> 0x18);
    if (local_22._3_1_ != '\0') {
        paVar2 = pass1_1028_e1ec(_PTR_LOOP_1050_65e2, local_6, u_var4);
...
pub fn call_alloc_mem_fn_1020_bcc4(in_struct_1: *mut Struct705) {
    ...
    if (local_struct_1.field_0x4 == 0) {
        ...
        unsafe {
            i_var2 = uVar3 + *pu_var1;
            g_u16_ptr_1050_5f2e = CARRY2(uVar3, *pu_var1)
        };
    }
...
pub fn pass1_1020_8eaa(param_1: *mut Struct393) {
    ...
    pass1_1018_2646(local_bx_17.field_0x16, uVar3, param_1 & 0xffff0000 | u_var1);
...
pub fn pass1_1020_5d56(param_1: *mut u32, param_2: u32) -> bool {
    ...
    pass1_1038_af40(_g_Struct112_a, *(u_var2 + 8), 9);
    return 1;
}
...
pub fn call_draw_fn_1020_3bd6(in_struct_1: *mut Struct657) {
    ...
    if (local_struct_1.field_0x100 == 0) {
        ...
        pu_var3 = pass1_1038_af40(_g_Struct112_a, local_struct_1.field_0x8, u_var2);
...
pub fn pass1_1020_3c32(param_1: *mut Struct658, param_2: u16, uparam_2_00: i32) {
    ...
    if (param_2_00 == 0xf5) {
        ...
        pass1_1018_1b02(u_var1, (u_var1 >> 0x10), uVar3);
        return;
    }
