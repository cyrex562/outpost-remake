use crate::{defines::{Struct11, Struct18, Struct27, Struct29, Struct65, StructB}, fn_ptr::{fn_ptr_1000::fn_ptr_1000_17ce, util::{get_fn_ptr_1, get_fn_ptr_2}}, global::AppContext, pass::{pass_1008::pass1_1008_57c4, pass_1040::pass1_1040_c60e}, ui::ui_1008::set_sys_color_1008_357e, util::CONCAT22, win_struct::{HDC16, HICON16, HWND16}, winapi::{DeleteDC16, DeleteObject16, DestroyIcon16, DestroyMenu16, DestroyWindow16, GetWindowWord16, IsDlgButtonChecked, IsWindow16, PostMessage16, SelectPalette16, SendMessage16, ShowWindow16}};
...
//LAB_1010_30ad:
      i_var6 = i_stack6;
      if (bVar4) {
        while (i_stack8 = i_var6 + 0x1, pi_var1 = &i_var4.field_0x16,
        ...
        *pi_var1 = *pi_var1 + 0x1;
        ...
        mov_update_win_1040_93aa
                  (param_3,i_stack10,i_var4.field_0x1a,&ctx.PTR_LOOP_1050_1040);
      }
      if (!b_var4) {
...
pub fn destroy_window_1018_c518(
  ctx: &mut AppContext,
  param_1: &mut Struct29)
{
  let b_var1: bool;
