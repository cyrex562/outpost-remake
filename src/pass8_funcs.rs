...
pub unsafe fn pass1_1008_e9a4(param_1: u16, param_2: u16, param_1_00: u32) {
    ...
    unsafe {
        _local_6 = CONCAT22(
            ((u_var5 >> 0x10) - local_BX_14.field_0x10) - (u_var5 < *puVar1),
            u_var5 - *puVar1,
        );
    }
...
pub unsafe fn pass1_1008_ed8a(
    ...
    if (0 < param_4) {
        ...
        uVar2 = (**ppcVar1)();
        ppRam10500df6 = process_struct_1010_20ba(_g_Struct372_1050_0ed0, CONCAT22(unaff_SI, uVar2));
...
pub unsafe fn pass1_1010_0000(param_1: i32, param_2: u16) {
    ...
    uVar3 = param_2;
    u_var5 = param_2;
    ppVar1 = process_struct_1010_20ba(_g_Struct372_1050_0ed0, CONCAT22(iVar2, 0x48));
    pass1_1008_3e94(
        (ppVar1 + 0xe),
        CONCAT22(uVar3, iVar2),
        CONCAT22(u_var5, iVar4),
    );
    return CONCAT22(param_2, param_1);
}
...
pub unsafe fn pass1_1010_0538(
    ...
    match (uVar7) {
        ...
        _ => {
            // LAB_1010_0619:
            u_var5 = string_fn_1008_5fd8(CONCAT11(7, uVar12), u_var5);
            uVar8 = CONCAT31(extraout_var, u_var5);
        }
        // goto LAB_1010_0621;
        0x16 => {
            uVar12 = 0x8d;
        ...
        0x1e => {
            ...
            paVar11 = 0x795;
            // LAB_1010_0785:
            u_var5 = string_fn_1008_5fd8(paVar11, u_var5);
            uVar8 = CONCAT31(extraout_var_01, u_var5);
            // goto LAB_1010_0621;
        }
    }
    u_var5 = string_fn_1008_5fd8(CONCAT11(7, uVar12), u_var5);
    uVar8 = CONCAT31(extraout_var_00, u_var5);
    // LAB_1010_0621:
    in_str_list_1 = uVar8;
    (in_str_list_1 + 2) = uVar6;
    // LAB_1010_0850:
...
pub unsafe fn pass1_1010_0946(param_1: u16, param_2: u16, param_1_00: i32) {
    ...
    uVar4 = pass1_1008_dfa6(ppVar3, CONCAT22(u_var5, uVar2), uVar6);
    uVar2 = (uVar4 >> 0x10);
    if (uVar4 != 0) {
...
pub unsafe fn pass1_1010_09b4(
    ...
    local_a = 0;
    if (bVar2) {
        ppVar9 = process_struct_1010_20ba(_g_Struct372_1050_0ed0, CONCAT22(in_stack_0000ffde, 2));
        uVar4 = (ppVar9 >> 0x10);
...
pub unsafe fn pass1_1010_0f9c(param_1: *mut u32) {
    ...
    process_struct_1000_179c(u_var5, paVar10);
    (iVar12 + 0x60) = u_var5;
    (iVar12 + 0x62) = paVar10;
...
pub unsafe fn process_struct_1010_20ba(
    ...
    match (in_string_1) {
        ...
        5 => {
            ...
            if ((paVar4 | local_Struct64_ptr) == 0) {}
            // goto LAB_1010_2126;
            puVar1 = pass1_1008_eabc(local_Struct64_ptr, paVar4, in_string_1);
            uVar3 = (puVar1 >> 0x10);
            local_Struct64_ptr = puVar1
        }
        6 => {
            paVar4 = struct_a;
        ...
        10 => {
            ...
            if ((paVar4 | local_Struct64_ptr) == 0) {}
            // goto LAB_1010_2126;
            uVar7 = pass1_1010_0eac(local_Struct64_ptr, paVar4, in_string_1);
            uVar3 = (uVar7 >> 0x10);
            local_Struct64_ptr = uVar7
        }
        0xb => {
            paVar4 = struct_a;
            process_struct_1000_179c(0x1c, struct_a);
            if ((paVar4 | local_Struct64_ptr) == 0) {}
            // goto LAB_1010_2126;
            uVar7 = pass1_1008_aefe(local_Struct64_ptr, paVar4, in_string_1);
            uVar3 = (uVar7 >> 0x10);
            local_Struct64_ptr = uVar7
        }
        ...
        0x2e => {
            ...
            if (uVar3 == 0) {}
            // goto LAB_1010_2126;
            uVar7 = pass1_1018_1ff4(local_Struct64_ptr, CONCAT22(in_string_1, paVar4));
            local_Struct64_ptr = uVar7
        }
        0x2f => {
            paVar4 = struct_a;
        ...
        0x31 => {
            ...
            if ((paVar4 | local_Struct64_ptr) == 0) {
                ...
                uVar7 = process_struct_1010_9298(local_Struct64_ptr, paVar4, in_string_1);
                uVar3 = (uVar7 >> 0x10);
                local_Struct64_ptr = uVar7;
            }
        }
        ...
        0x35 => {
            ...
            if (uVar3 == 0) {}
            // goto LAB_1010_2126;
            uVar7 = modify_struct_1010_6700(local_Struct64_ptr, CONCAT22(in_string_1, paVar4));
            local_Struct64_ptr = uVar7
        }
        0x36 => {
            paVar4 = struct_a;
        ...
        0x3a => {
            ...
            if ((paVar4 | local_Struct64_ptr) == 0) {}
            // goto LAB_1010_2126;
            puVar1 = pass1_1008_d72e(local_Struct64_ptr, paVar4, in_string_1);
            uVar3 = (puVar1 >> 0x10);
            local_Struct64_ptr = puVar1
        }
        0x3b => {
        ...
        0x3d => {
            ...
            if (uVar3 == 0) {}
            // goto LAB_1010_2126;
            uVar7 = pass1_1010_8c32(local_Struct64_ptr, CONCAT22(in_string_1, paVar4));
            local_Struct64_ptr = uVar7
        }
        0x3e => {
            paVar4 = struct_a;
        ...
        0x41 => {
            ...
            uVar7 = pass1_1008_ecb2(local_Struct64_ptr, paVar4);
            uVar3 = (uVar7 >> 0x10);
            local_Struct64_ptr = uVar7;
            // LAB_1010_2683:
        ...
        0x42 => {
            ...
            if ((paVar4 | local_Struct64_ptr) == 0) {}
            // goto LAB_1010_2126;
            puVar1 = pass1_1008_ec10(local_Struct64_ptr, paVar4, in_string_1);
            uVar3 = (puVar1 >> 0x10);
            local_Struct64_ptr = puVar1
        }
        0x43 => {
        ...
        0x45 => {
            ...
            if ((paVar4 | local_Struct64_ptr) == 0) {}
            // goto LAB_1010_2126;
            uVar7 = pass1_1010_0000(local_Struct64_ptr, paVar4);
            uVar3 = (uVar7 >> 0x10);
            local_Struct64_ptr = uVar7
        }
        0x46 => {
        ...
        0x47 => {
            ...
            if (uVar3 == 0) {}
            // goto LAB_1010_2126;
            puVar1 = pass1_1018_56e6(local_Struct64_ptr, CONCAT22(in_string_1, paVar4));
            local_Struct64_ptr = puVar1
        }
        0x48 => {
            paVar4 = struct_a;
...
pub unsafe fn pass1_1010_45d6(param_1: *mut Struct419) {
    ...
    if (local_bx_5.field_0x7e != 0) {
        if (_PTR_LOOP_1050_0388 != 0) {
            ...
            pass1_1008_92b2(_PTR_LOOP_1050_0388, 500, iVar4, u_var5);
        }
        local_4 = 0;
        while (local_4 < 0x10) {
            if (local_bx_5.field_0x24 != local_4) {
                ...
                if ((uVar2 | puVar1) != 0) {
                    ...
                    (**ppc_var3)(unaff_cs, puVar1, uVar2, 1);
                }
...
pub unsafe fn pass1_1010_533c(param_1: u32, param_2: u32) {
    ...
    loop {
        ...
        str_fn_1010_5286(u_var5, uVar6, uVar4);
        iVar3 = uVar4;
...
pub unsafe fn pass1_1010_a0a0(param_1: u32) {
    ...
    loop {
        ...
        process_struct_1010_9fee(param_1, u_var5, (iVar4 + 4));
    }
}
    ...
    if (uVar7 != 0) {
        ...
        while (uVar2 = uVar6, local_146 < 0x25) {
            ...
            if ((local_146 * 4 + _local_c) == 0) {
                uVar2 = uVar7;
                if (u_var5 != 0) {
                    uVar6 = pass1_1020_bae6(u_var5, CONCAT22(local_146, uVar17));
                    uVar9 = uVar6;
                    uVar2 = uVar7 | uVar9;
                    if (uVar2 != 0) {
                        if (local_e == 0) {
...
pub unsafe fn pass1_1010_d24a(param_1: u32, param_2: u32, param_3: u32) {
    ...
    if ((extraout_DX_00 | uVar6) != 0) {
        ...
        u_var5 = CONCAT31(extraout_var, uVar2);
        local_13e = 0;
        local_140 = 1;
        while (local_140 < 0x25) {
...
pub unsafe fn pass1_1010_d710(param_1: u32, param_2: *mut u8, param_3: *mut Struct485) {
    ...
    if (uVar6 != 0) {
        ...
        local_142 = 1;
        u_var5 = uVar4;
        while (uVar2 = u_var5, local_142 < 0x25) {
            if ((local_142 * 4 + _local_c) != 0) {
                ...
                if (uVar4 == 0) {
                    ...
                    u_var5 = pass1_1020_bae6(uVar4, CONCAT22(local_142, (uVar4 >> 0x10)));
                    uVar2 = u_var5;
                }
                u_var5 = uVar2;
                if (uVar2 == 0) {
...
pub unsafe fn pass1_1010_debe(
    ...
    ppVar9 = process_struct_1010_20ba(_g_Struct372_1050_0ed0, CONCAT22(unaff_SI, 0x35));
    paVar5 = (ppVar9 >> 0x10);
    iVar6 = param_4;
    uVar7 = (param_4 >> 0x10);
    if (param_2 == 0x13) {
...
pub unsafe fn pass1_1018_0902(param_1: *mut u32, param_2: u32) {
    ...
    pass1_1030_5a52(CONCAT22(u_var5, ppVar3), puVar7, puVar8);
