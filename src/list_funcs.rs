...
pub fn modify_u16_list_1008_5bdc(in_struct_a: *mut astruct_375)

{
    let mut local_AX_17: u16;
    let mut local_DX_63: u16;
    let struct_a: *mut astruct_375;
    let mut local_BP__1: u16;
    let struct_a_hi: *mut astruct_375;
    ...
    ppVar1 = process_struct_1010_20ba(_g_astruct_372_1050_0ed0, CONCAT22(local_BP__1, 2));
...
pub fn zero_list_1008_6c90(param_1: *mut astruct_1)
...
pub fn
modify_list_1008_6cb4(param_1: *mut u32, param_2: u16, param_3: u16, param_4: u16, param_5: u16) -> *mut u32
...
pub fn modify_list_1008_87a2(param_1: *mut astruct_44, param_2: u8) -> *mut astruct_44
...
pub fn 
pass1_1008_87cc(param_1: *mut astruct_204, param_2: u16, param_3: u16, param_4: u16,param_5: u32,param_6: u32)

{
    ...
    let struct_204_1: *mut astruct_204;
    let local_BX_223: *mut astruct_205;
    ...
    {
        _PTR_LOOP_1050_0382 =
            process_struct_1010_20ba(_g_astruct_372_1050_0ed0, CONCAT22(unaff_SI, 0x2e));
    }
    ...
    pass1_1008_3e76((param_1 & 0xff000000 |
                            CONCAT12((param_1 >> 0x10), &struct_204_1.field_0x1c)),
                    0, (iVar3 + struct_204_1.field_0xe) * local_e + struct_204_1.field_0x12 + local_a, (iVar3 - struct_204_1.field_0xe) * local_c + struct_204_1.field_0x10 + local_8);
