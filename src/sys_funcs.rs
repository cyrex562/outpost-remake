...
pub fn dos3_call_1000_3636(uparam_1: i32, uparam_2: i32, uparam_3: i32, uparam_4: i32) {
    ...
    if (((param_1 < u16_1050_5f8a) || (PTR_LOOP_1050_61ec == 0x0)) || (2 < param_1)) {
        ...
        // goto LAB_1000_299d;
        if ((param_4 & 2) == 0) {
            if (-1 < ((u_var5 >> 0x10) + param_3 + CARRY2(uVar3, param_2))) {
                // LAB_1000_36e3:
                bVar4 = false;
                pcVar2 = swi(0x21);
                unsafe {
...
pub fn dos3_call_1000_435c(param_1: *mut u16) {
    ...
    if ((u_var5 != extraout_DX_00) && (uVar4 = extraout_DX_00, cVar6 == '\x17')) {
        uVar3 = in_CX;
        uVar4 = u_var5;
    }
...
pub fn get_sys_metrics_1018_09a8(param_1: u32) {
    ...
    puVar7 = &local_a;
    ppVar6 = process_struct_1010_20ba(_g_Struct372_1050_0ed0, CONCAT22(puVar7, 0x48));
...
pub fn call_win_proc_1040_a410(param_1: u16, param_2: u32, param_3: u32) {
    ...
    if (param_3 == 0x19) {
        ...
        if (param_3 == 0x110) {
            ...
            u_var5 = send_win_msg_1040_a308(uVar3, (uVar3 >> 0x10), param_1, param_2);
            return u_var5;
        }
    }
    if (local_6 != 0) {
...
pub fn send_win_msg_1040_a308(param_1: u32, param_2: u16, param_3: u16, param_4: HWND16) {
    ...
    if ((uVar2 + 0x10) == 0) {
        ...
        local_c = 0;
        while (uVar2 = (iVar4 + 0x90), pu_var1 = (uVar2 + 0x10), unsafe {
            *pu_var1 != local_c && local_c <= *pu_var1
        }) {
            WVar7 = 0;
            uVar8 = 0x401;
            uVar2 = (iVar4 + 0x90);
...
pub fn win_fn_1020_0ec4(param_1: *mut u32, uparam_2: i32) {
    ...
    iVar4 = param_1;
    if (param_2 == 0xfb) {
        ppVar8 = process_struct_1010_20ba(_g_Struct372_1050_0ed0, CONCAT22(local_c, 0x30));
    ...
    if (param_2 == 0xf3) {
        ...
        if (cVar3 == 'r') {
            iVar5 = iVar4 + 10;
            uVar9 = uVar7;
            ppVar8 = process_struct_1010_20ba(_g_Struct372_1050_0ed0, CONCAT22(iVar5, 0x30));
            pass1_1010_3770(ppVar8, CONCAT22(uVar9, iVar5));
            pass1_1038_af40(_g_Struct112_a, *(iVar4 + 8), 3);
            return;
        }
        if (cVar3 == -0xf) {
            uVar9 = 1;
...
pub fn write_private_profile_str_1010_5b10(param_1: *mut Struct376) {
    ...
    ppVar7 = process_struct_1010_20ba(_g_Struct372_1050_0ed0, CONCAT22(unaff_SI, 0x48));
    ...
    if ((uVar2 | pu_var1) != 0) {
        ...
        (**ppcVar4)(0x1000, pu_var1, uVar2, 1);
    }
...
pub fn get_private_profile_str_1010_5404(param_1: *mut Struct64, param_2: u32) {
    ...
    if (**&param_1.field_0xe != '\0') {
        ...
        local_16 = uVar8;
        ppVar17 = process_struct_1010_20ba(_g_Struct372_1050_0ed0, CONCAT22(uVar23, 0x48));
    ...
    if (**&param_1.field_0xe != '\0') {
        ...
        pass1_fn_1008_60e8(u_var5, (u_var5 >> 0x10), uVar20, uVar21);
    ...
    if (**&param_1.field_0xe != '\0') {
        ...
        pass1_fn_1008_60e8(u_var5, (u_var5 >> 0x10), uVar21);
...
pub fn process_win_msg_1008_54aa(
    ...
    func_ptr_c = CONCAT22(uVar2, in_Struct97_1);
    if (_PTR_LOOP_1050_0392 != 0) {
        // WARNING: Load size is inaccurate
        unsafe {
            ppcVar1 = (*func_ptr_c + 4);
        }
        (**ppcVar1)(0x1000, in_Struct97_1, uVar2, _PTR_LOOP_1050_0392);
    }
    local_1e = CONCAT22(uVar2, in_Struct97_1);
    // WARNING: Load size is inaccurate
    unsafe {
    ...
    if (func_ptr_c != 0) {
        ...
        (**ppcVar1)(0x1000, in_Struct97_1, uVar2, 1);
    }
...
pub fn get_prop_1040_9566(param_1: *mut i32) {
    ...
    if (unsafe { *param_1 == 4 }) {
        uVar1 = (iVar6 + 0xc);
        h_var4 = GetProp16(s_thisHi_1050_5e6f, (iVar6 + 10));
        HVar5 = GetProp16(s_thisLo_1050_5e68, (iVar6 + 10));
        if ((h_var4 | HVar5) != 0) {
            iVar2 = (iVar6 + 6);
            if (iVar2 == 1) {
                _local_c = CONCAT22(h_var4, uVar1);
                ppc_var3 = (*_local_c + 0xc);
                (**ppc_var3)(offset, uVar1, h_var4, (iVar6 + 8));
                return;
            }
            if (iVar2 == 2) {
                _local_c = CONCAT22(h_var4, uVar1);
            ...
            if (iVar2 == 4) {
                ...
                (**ppc_var3)(offset, uVar1, h_var4, *(iVar6 + 8) & 0x10);
                return;
            }
        }
    }
...
pub fn make_proc_inst_1040_8fb8(
    ...
    *_in_Struct1 = 0x9800;
    ...
    uVar2 = in_Struct1.field_0x36;
    in_Struct1.field_0x28 = uVar2;
    in_Struct1.field_0x26 = uVar2;
...
pub fn post_win_msg_1040_672e(param_1: i32, param_2: u16, param_3: u16, param_4: u32) {
    ...
    if (param_3._2_2_ == (s_vrpal_bmp_1050_183a + 7)) {
        ...
        pass1_1038_af40(_g_Struct112_a, *(param_1 + 8), uVar1);
...
pub fn win_fn_1040_3374(param_1: u32, param_2: *mut u32, param_3: HWND16) {
    ...
    loop {
        ...
        uVar3 = _local_6;
        (**ppcVar1)(u_var5, param_2, uVar4, local_a, (local_a >> 0x10));
        uVar2 = uVar3;
        pass1_1018_3a7a(
            *(param_1 + 0x96),
...
pub fn send_win_msg_1038_ed8a(param_1: u16, param_2: u32, param_3: u32) {
    ...
    if (param_3._2_2_ != 0x1c8) {
        if (param_3._2_2_ == 0x1c9) {
            ...
            paVar3 = pass1_1028_e1ec(_PTR_LOOP_1050_65e2, uVar1, u_var5);
            if ((u_var5 | paVar3) == 0) {
                return;
            }
            iVar4 = pass1_1030_5b00(CONCAT22(u_var5, paVar3));
...
pub fn pass1_1038_e4bc(param_1: *mut u8, param_2: *mut u8, param_3: *mut u8) {
    ...
    if (param_3._2_2_ == 0x1c4) {
        ppVar9 = process_struct_1010_20ba(_g_Struct372_1050_0ed0, CONCAT22(unaff_SI, 0x2f));
        uVar12 = (ppVar9 >> 0x10);
        uVar7 = (ppVar9 + 0x24);
        uVar6 = (ppVar9 + 0x26);
        if ((uVar6 | uVar7) != 0) {
            ...
            if (uVar7 != 0) {
                ...
                if ((extraout_DX_00 | uVar7) == 0) {
                    ...
                    ppVar9 =
                        process_struct_1010_20ba(_g_Struct372_1050_0ed0, CONCAT22(uVar6, 0x32));
                    win_fn_1010_71d6(
                        ppVar9,
                        1,
        ...
        uVar10 = 0;
        uVar11 = 0;
        ppVar9 = process_struct_1010_20ba(_g_Struct372_1050_0ed0, 0x32);
...
pub fn win_fn_1038_da68(param_1: i32, param_2: u16, param_3_00: i32, param_3: u32) {
    ...
    if (param_3._2_2_ == (s_New_failed_in_Op__Op__Simulator_1050_0110 + 0x11)) {
        ...
        if ((s_New_failed_in_Op__Op__Simulator_1050_0110 + 0x11) < param_3._2_2_) {
            ...
            // LAB_1038_db1c:
            puVar6 = pass1_1038_af40(_g_Struct112_a, *(param_1 + 8), uVar7);
            in_DX = (puVar6 >> 0x10);
    ...
    if (local_8 == 0) {
        ...
        (**ppcVar1)(u_var5, param_3._2_2_, uVar4);
    } else {
...
pub fn win_fn_1038_c374(param_1: u32, param_2: *mut u32, param_3: HWND16) {
    ...
    loop {
        ...
        uVar4 = _local_6;
        ppcVar2(uVar6, param_2, u_var5, local_a, (local_a >> 0x10));
        uVar1 = (param_1 + 0x8e);
...
pub fn check_gui_dlg_1038_b922(param_1: u32, param_2: u32, uparam_3: i32) {
    ...
    if (param_3 < 0x1b5) {
        if (0x19f < param_3) {
            ...
            u_var5 = IsDlgButtonChecked16(param_3, (iVar12 + 6));
            if (u_var5 != 0) {
                piVar1 = (iVar12 + 0x96);
                unsafe {
                    *piVar1 = *piVar1 + -1;
        ...
        if (param_3 == 0xfb1) {
            ...
            while (CONCAT11(local_46c._1_1_, local_46c) < 0x1b5) {
                u_var5 = IsDlgButtonChecked16(CONCAT11(local_46c._1_1_, local_46c), (iVar12 + 6));
                if (u_var5 == 1) {
            ...
            ppc_var3 = (CONCAT22(uVar11, local_8) + 0x74);
            (**ppc_var3)(uVar14, local_8);
            if (local_8 != 1) {
                return;
            }
    ...
    if (BVar4 == 0) {
        ...
        if ((bVar11 || unsafe { *pu_var1 == u_var5 })
            && (bVar11
                || (
                    pu_var1 = &local_BX_40.field_0x16,
                    unsafe { *pu_var1 < uVar13 } || unsafe { *pu_var1 == uVar13 },
                )))
        {
...
pub fn win_fn_1038_362e(param_1: *mut Struct1090) {
    ...
    if (local_BX_4.field_0x214 == 0) {
        ...
        ppVar3 = process_struct_1010_20ba(_g_Struct372_1050_0ed0, CONCAT22(uVar4, 0x37));
...
pub fn pass1_1028_a188(param_1: u16, param_2: u16, param_1_00: i32, param_2_00: i32, param_5: u32) {
    ...
    uVar10 = uVar3 >> 0xf;
    iVar11 = param_2_00 * 4;
    lVar2 = (uVar7 & 0xffff | uVar6 << 0x10) + (iVar11 + u_var5);
    lVar8 = lVar2 / (uVar3 & 0xffff | uVar10 << 0x10);
    lVar9 = lVar8 * (uVar3 & 0xffff | uVar10 << 0x10);
    local_e = lVar2;
    local_c = (lVar2 >> 0x10);
    uVar6 = lVar9;
    (u_var5 + iVar11) = local_e - uVar6;
    (u_var5 + iVar11 + 2) = (local_c - (lVar9 >> 0x10)) - (local_e < uVar6);
...
pub fn pass1_1028_9a02(param_1: *mut Struct806) -> u8 {
    ...
    local_a = u_var5;
    pass1_1030_3694(u_var5, (u_var5 >> 0x10), 0, uVar1, (uVar1 >> 0x10));
    uVar3 = u_var5;
    ...
    if ((extraout_DX_00 | uVar3) == 0) {
        ...
        ppVar7 = process_struct_1010_20ba(_g_Struct372_1050_0ed0, CONCAT22(local_38, 0x2b));
        ...
        if (local_1e == 0) {
            ...
            uVar8 = 0;
            uVar9 = 0;
            ppVar7 = process_struct_1010_20ba(_g_Struct372_1050_0ed0, 0x37);
            post_win_msg_1008_a0e4(
                ppVar7,
...
pub fn pass1_1028_6ff6(param_1: u32) {
        ...
        )))
    {
        ...
        while {
            ...
            if ((local_34 == 0)
                && (
                    pass1_1028_740c(param_1, uVar3, 0x22, CONCAT22(extraout_DX_03, pu_var1)),
                    pu_var1 != 0x0,
                ))
            {
