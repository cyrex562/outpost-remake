...
pub fn get_dos_env_1000_27d6(ctx: &mut AppContext) {
    let pi_var1: *mut i32;
...
pub fn dos3_call_1000_35fe(param_1: i32) -> u16 {
...
pub fn dos3_call_1000_3636(param_1: i32, param_2: i32, uparam_3: i32, param_4: i32) {
    let pu8_var1: *mut u8;
...
pub fn dos3_call_1000_42de(param_1: u32, param_2: *mut u16, param_3: *mut u16) {
    ...
    (i_var7 + 10) = u_var8;
    if (bVar11) {
        pass1_fn_1000_29af(unaff_si, u_var13, i32_var6);
    }
    (i_var7 + 0xc) = bVar11;
    return;
}
...
pub unsafe fn dos3_call_1000_23ea(ctx: &mut AppContext, a: i16, b: u16) {
    ...
    let pu8_var11: *mut u8;
    let pu8_var12: *mut u8;
    let unaff_es: u16;
...
pub fn win_fn_1020_0ec4(param_1: *mut u32, param_2: i32) {
    let mut u_var1: u32;
    let ppc_var2: fn();
    let mut cVar3: u8;
    let mut i_var4: i32;
    ...
    if (param_2 == 0xf3) {
        ...
        if ((cVar3 + 0x91) == 0) {
            ...
            WinHelp16(0x28, 1, CONCAT22(ctx.dx_reg, u_var6), (i_var4 + 8));
            return;
        }
        if (cVar3 == 'r') {
            i_var5 = i_var4 + 10;
...
pub fn post_msg_1020_03b2(param_1: u32) {
    ...
    u_var1 = (param_1 + 0xe2);
    PostMessage16(0, (u_var1 + 0x16), 0x111, ctx.g_h_window);
    return;
}
...
pub fn win_func_1018_6bb6(param_1: u32) {
    ...
    i_var2 = param_1;
    if ((i_var2 + 0xea) != 0) {
        PostMessage16(0, (i_var2 + 0xea), 0x111, ctx.g_h_window);
    }
    PostMessage16(0, 0x79, 0x111, ctx.g_h_window);
    if ((i_var2 + 0xf0) != 0) {
...
pub fn get_private_profile_str_1010_5404(param_1: *mut Struct64, param_2: u32) {
    ...
    local_8 = u_var7;
    local_6 = ctx.dx_reg;
    process_string_1000_3cea(*&param_1.field_0xe, CONCAT22(ctx.dx_reg, u_var7));
    u_var5 = &param_1.field_0xe;
...
pub fn post_win_msg_1008_a0e4(
    ...
    if (param_6 == 0x14) {
        b_var6 = PostMessage16(0, 0xfc, 0x111, ctx.g_h_window);
        u_var4 = b_var6;
    }
    return u_var4;
}
...
pub fn process_win_msg_1008_54aa(
    ...
    ctx.PTR_LOOP_1050_0390 = in_Struct97_1;
    struct_a = ctx.dx_reg;
    ctx.PTR_LOOP_1050_5768 = ctx.ax_reg;
    ctx.PTR_LOOP_1050_576a = ctx.dx_reg;
    pass1_fn_1008_60e8();
    ctx._PTR_LOOP_1050_0392 = CONCAT22(struct_a, in_Struct97_1);
    ...
    if (ctx._PTR_LOOP_1050_0392 != 0) {
        ...
        pp_var1(0x1000, in_Struct97_1, u_var2, ctx._PTR_LOOP_1050_0392);
    }
...
pub fn get_prop_1040_9566(param_1: *mut i32) {
    ...
    if (unsafe { *param_1 == 4 }) {
        u_var1 = (i32_var6 + 0xc);
        h_var4 = GetProp16(s_thisHi_1050_5e6f, (i32_var6 + 10));
        HVar5 = GetProp16(s_thisLo_1050_5e68, (i32_var6 + 10));
        if ((h_var4 | HVar5) != 0) {
            i_var2 = (i32_var6 + 6);
            if (i_var2 == 1) {
    ...
    *_in_Struct1 = 0x9800;
    ...
    if (_g_proc_inst_1050_5e18 == 0) {
        _g_proc_inst_1050_5e18 =
            MakeProcInstance16(hinstance, CONCAT22(0x9684, ctx.g_h_instance_1050_038c));
    }
        ...
        *pu8_var1 = bVar8 - bVar13;
            ...
            && (SBORROW1(b_var2, bVar6) != SBORROW1(bVar8, bVar13)) == (pb_var1_val < '\0'))
        {
            ...
            *pu_var15 = 0x9800;
            ...
            if (_g_proc_inst_1050_5e18 == 0) {
                _g_proc_inst_1050_5e18 =
                    MakeProcInstance16(unaff_cs, CONCAT22(0x9684, ctx.g_h_instance_1050_038c));
            }
            PTR_LOOP_1050_5e16 = PTR_LOOP_1050_5e16 + 1;
            return;
        }
...
pub fn win_fn_1040_3374(param_1: u32, param_2: *mut u32, param_3: HWND16) {
    ...
    loop {
        ...
        LVar6 = SendMessage16(CONCAT22(ctx.dx_reg, u_var2), 0, 0x403, param_3);
        u_var5 = 0x1000;
        error_check_1000_17ce(CONCAT22(ctx.dx_reg, u_var2));
        if (LVar6 == -1) {
            break;
        }
        if (LVar6 == -2) {
...
pub fn send_msg_1040_1696(param_1: u32, param_2: HWND16) {
    ...
    SendMessage16(CONCAT22(ctx.dx_reg, u_var3), w_var6, u_var7, param_2);
    SendMessage16(0, 1, 0xb, param_2);
    return;
}
...
pub fn destroy_win_1040_13b2(param_1: u32, param_2: i32) {
    ...
    u_var8 = (param_1 >> 0x10);
    if (param_2 != 0) {
        local_56 = GetDlgItem16(0xfd2, (i32_var6 + 6));
        ...
        local_ac = GetDlgItem16((s_vrpal_bmp_1050_183a + 4), (i32_var6 + 6));
        LVar10 = SendMessage16(0, 0, 0x407, local_ac);
        local_ae = LVar10;
        if (local_ae != 0xffff) {
            SendMessage16(CONCAT22(unaff_ss, local_aa), local_ae, 0x408, local_ac);
        }
        local_ac = GetDlgItem16((s_vrpal_bmp_1050_183a + 5), (i32_var6 + 6));
        LVar10 = SendMessage16(0, 0, 0x407, local_ac);
        paVar4 = LVar10;
        local_ae = paVar4;
        if (paVar4 != 0xffff) {
                ...
                if (param_3._2_2_ != (s_New_failed_in_Op__Op__Simulator_1050_0110 + 0x13)) {
                    if (param_3._2_2_ + -0x125 == 0x0) {
                        ...
                        if (pu_var3 == 0x0) {
                            ...
                            in_dx = ctx.dx_reg;
                            param_3._2_2_ =
                                WinHelp16(0, 3, CONCAT22(ctx.dx_reg, pu_var3), (param_1 + 6));
                        } else {
...
pub fn post_win_msg_1038_d840(param_1: *mut u8, param_2: i32) {
    let mut i_var1: i32;
    let mut u_var2: u16;
    ...
    if ((HVar2 | HVar3) != 0) {
        ...
        if (param_3 == 0x19) {
            ...
            if ((param_3 == 0x112) && ((param_2._2_2_ & 0xfff0) == 0xf140)) {
                LVar5 = SendMessage16(0, 0xf140, 0x112, &ctx.g_h_window);
                u_var4 = (LVar5 == 0);
                // goto LAB_1038_d10e;
            }
        }
...
pub fn make_proc_inst_1038_cf6c(param_1: *mut u16) {
    ...
    pvVar3 = MakeProcInstance16(unaff_cs, CONCAT22(0xd116, ctx.g_h_instance_1050_038c));
    (pu_var1 + 4) = pvVar3;
    (pu_var1 + 6) = (pvVar3 >> 0x10);
    pvVar3 = MakeProcInstance16(offset, CONCAT22(0xd01e, ctx.g_h_instance_1050_038c));
...
pub fn check_gui_dlg_1038_b922(param_1: u32, param_2: u32, uparam_3: i32) {
    ...
    if (param_3 < 0x1b5) {
        ...
        PostMessage16(0, 0xce, 0x111, ctx.g_h_window);
        uVar16 = 1;
    }
    post_win_msg_1040_7b3c(
        param_1,
...
pub fn win_fn_1038_362e(param_1: *mut Struct1090) {
    ...
    if (local_bx_4.field_0x214 == 0) {
        ...
        ppVar3 = process_struct_1010_20ba(ctx._g_Struct372_1050_0ed0, CONCAT22(u_var4, 0x37));
...
pub fn win_fn_1030_e67c(ctx: &mut AppContext, param_1: u32) -> u16 {
    let mut u_var1: u16;
...
pub fn win_msg_fn_1020_d460(param_1: *mut u8, param_2: u32, param_3: u32, param_4: u32) -> u16 {
    ...
    if (u_var1 != 0) {
        ...
        process_win_msg_1008_9510(&PTR_LOOP_1050_5b80, &ctx.g_alloc_addr_1050_1050);
        ppVar2 = process_struct_1010_20ba(
            ctx._g_Struct372_1050_0ed0,
...
pub fn post_msg_1020_4394(ctx: &mut AppContext, param_1: u32, param_2: i32) {
    ...
    if (param_2 == 0x10) {
        if ((i_var2 + 0x34) != 0) {
            PostMessage16(0, 0xf6, 0x111, ctx.g_h_window);
            return;
        }
    } else {
        if (param_2 < 0x11) {
...
pub fn post_win_msg_1020_1ca4(param_1: u32) -> u16 {
    ...
    if ((param_1 + 0x96) == 0) {
        ...
        PostMessage16(0, 0xde, 0x111, ctx.g_h_window);
    }
    return 1;
}
...
*/
pub fn _hread(h_file: &mut HFILE16, buffer: &mut Vec<u8>, count: usize) -> usize {
    unimplemented!()
}
