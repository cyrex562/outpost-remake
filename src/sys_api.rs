...
use crate::win_struct::{HDC16, HGLOBAL16, HINSTANCE16, HWND16, MSG16, RECT16, SEGPTR, WNDCLASS16, WPARAM16};
...
//         TODO: goto LAB_1000_299d;
            ...
            uVar4 = SUB42(&ctx.PTR_DAT_1050_0041_1050_4202, 0x0);
            if (true) {
                pcVar2 = swi(0x21);
                uVar9 = (*pcVar2)(iVar7);
            } else {
...

{
    ...
    uVar3 = CONCAT11(0x3d, (param_3 & 0x3 | param_4) as u8);
    uVar7 = 0x0;
    uVar6 = param_3;
    if true {
        pcVar1 = swi(0x21);
...
//LAB_1000_38e3:
            ...
            if ((param_4 != 0x0) || ((param_3 & 0x2) == 0x0)) {
                ...
                uVar5 = CONCAT11(0x3d, param_3 & 0x3 | param_4);
                uVar7 = 0x0;
                if (true) {
                    pcVar1 = swi(0x21);
                    uVar5 = (*pcVar1)();
...
//LAB_1000_3973:
            ...
            if (uVar5 < &DAT_1050_5f8a) {
                (uVar5 + 0x5f90) = bVar11 | bVar10 | 0x1;
                return uVar5;
            }
            if (true) {
                pcVar1 = swi(0x21);
...
//LAB_1000_3acf:
        ...
        if (param_3 != 0x0) {
            ...
            if (uVar8 < 0xa9) {
                ...
                cVar26 = puVar3 < 0x0;
                cVar25 = puVar3 == 0x0;
                cVar23 = (POPCOUNT(puVar3 & 0xff) & 0x1) == 0x0;
                if (bVar22) {
...
uVar8 = (param_3 + 0x6); puVar1 = (param_3 + - 0xc); bVar9 = uVar8 < * puVar1; uVar5 = uVar8 - * puVar1; cVar13 = uVar5 < 0x0; cVar12 = uVar5 == 0x0; cVar11 = (POPCOUNT(uVar5 & 0xff) & 0x1) == 0x0; if (bVar9) {
piVar6 = CONCAT11(0x40, param_1); bVar9 = 0x0; cVar13 = '\0'; cVar12 = '\x01'; cVar11 = '\x01'; if (true) {
pcVar3 = swi(0x21); piVar6 = (* pcVar3)(ctx.data_seg);
}
else {
DOS3Call( & ctx.PTR_LOOP_1050_1000);
}
...
if ( ! bVar9) {
piVar2 = (param_3 + - 0x4); *piVar2 = * piVar2 + piVar6; bVar9 = piVar7 < piVar6; piVar7 = (piVar7 - piVar6); cVar13 = piVar7 < 0x0; cVar12 = piVar7 == 0x0; cVar11 = (POPCOUNT(piVar7 & 0xff) & 0x1) == 0x0; if (bVar9 | | cVar12) {
return param_1;
}
}
uVar4 = (cVar13 < < 0x7 | cVar12 << 0x6 | param_8 < < 0x4 | cVar11 << 0x2 | 0x2 | bVar9) < < 0x8; uVar5 = piVar6 & 0xff | uVar4; if ((param_3 + - 0x4) == 0x0) {
...
uVar5 = (param_3 + - 0x4); puVar1 = (param_3 + - 0x6); bVar10 = uVar5 < * puVar1; uVar5 -= * puVar1;
}
if (bVar10) {
((param_3 + - 0xa) + 0x2) = 0x29a2; pass1_1000_29b5(uVar5); uVar5 = 0xffff;
}
return uVar5;
}
...
{
let puVar1: * mut u8; let uVar2: u16; let local_4: u16; let iStack2: i16;

iStack2 = param_6 + 0x1; ctx.PTR_LOOP_1050_68b2._0_1_ = 0x42; ctx.PTR_LOOP_1050_68ae = param_1; ctx.PTR_LOOP_1050_68b0 = param_2; _USHORT_1050_68a8 = CONCAT22(param_2, param_1); ctx.PTR_LOOP_1050_68ac = 0x7fff; uVar2 = sys_1000_30b4( & USHORT_1050_68a8,ctx.data_seg,
CONCAT22(param_4, param_3), & iStack2,
& USHORT_1050_68a8, param_7, param_8, param_9); puVar1 = _USHORT_1050_68a8; ctx.PTR_LOOP_1050_68ac = ctx.PTR_LOOP_1050_68ac + - 0x1; if (ctx.PTR_LOOP_1050_68ac < 0x0) {
mem_1000_2bb6(0x0, & USHORT_1050_68a8, & iStack2,param_7, param_8, param_9,
param_10, param_2);
}
else {
_USHORT_1050_68a8 =

(_USHORT_1050_68a8 & 0xffff0000 | (USHORT_1050_68a8 + 0x1)); * puVar1 = 0x0;
}
return uVar2;
}
...
pub fn mixed_win_sys_op_1008_016e(param_1: u32, param_2: u16) {
    ...
    if ((uVar4 < 0x3) || ((uVar4 == 0x3 && (uStack10 < 0xa)))) {
        ...
        if (puVar6 == 0x0) {
            ...
            uVar10 = SUB42(&ctx.PTR_LOOP_1050_1040, 0x0);
            iVar3 = string_1040_8520(CONCAT22(puVar7, uVar4), 0x0, 0x10, 0x2, 0x5de,
    ...
    uVar5 = (iVar3 + 0x8);
    puVar2 = (iVar3 + 0x8);
    ctx._PTR_LOOP_1050_0298 = uVar5;
    *puVar2 = 0x70;
    (puVar2 + 0x2) = ctx.s_tile2_bmp_1050_1538;
    uVar10 = 0x1000;
    ...
    if (puVar7 != 0x0) {
        ...
        paVar14 = pass1_1038_aeca(CONCAT22(puVar6, uVar4), param_2);
        // puVar7 = (paVar14 >> 0x10);
        uVar4 = paVar14;
    }
    if (ctx.PTR__LOOP_1050_5b7c == 0x0) {
        debug_print_1008_6048(s_New_failed_in_Op__Op__DialogCtr_1050_0053, uVar10, param_2);
        fn_ptr_op_1000_24cd(0x1, &stack0xfffe);
    }
    uVar10 = 0x1000;
    ...
    if (puVar6 != 0x0) {
        uVar10 = SUB42(&ctx.PTR_LOOP_1050_1038, 0x0);
        make_proc_inst_1038_cf6c(CONCAT22(puVar7, uVar4), puVar6, &ctx.PTR_LOOP_1050_1038);
    }
    if (ctx.PTR__LOOP_1050_5bc8 == 0x0) {
        debug_print_1008_6048(s_New_failed_in_Op__Op__DialogHand_1050_0073, uVar10, param_2);
        fn_ptr_op_1000_24cd(0x1, &stack0xfffe);
    }
    ...
    puStack16 = puVar6;
    if (puVar7 != 0x0) {
        pass1_1008_5bdc(CONCAT22(puVar6, uVar4), unaff_DI, param_2);
    }
    ...
    uVar5 = (iVar3 + 0x4);
    ctx.PTR_LOOP_1050_0396 = (uVar5 + 0x8);
...
//       TODO: goto LAB_1008_9547;
    ...
    return;
    code_r0x10089538: param_2 = s_tile2_bmp_1050_1538;
...
pub fn get_sys_metrics_1010_46f6(param_1: u32) {
    ...
    puVar6 = mixed_1010_20ba(ctx.PTR__LOOP_1050_0ed0, 0x48, unaff_SS, in_DX, unaff_DI);
...
pub fn free_rsrc_1010_4b3e(param_1: U32Ptr, param_2: HGLOBAL16) {
    ...
    *param_1 = (s_SCForceMorale__s_for_colony__08l_1050_5024 + 0x6);
    ...
    if ((iVar8 + 0x2a) != 0x0) {
        ...
        if (BVar7 == 0x0) {
            HVar12 = ctx.s_tile2_bmp_1050_1538;
            FreeResource16(ctx.s_tile2_bmp_1050_1538);
        }
    }
    (iVar8 + 0x2a) = 0x0;
    if (*(iVar8 + 0x12) != 0x0) {
...
pub fn find_n_load_rsrc_1010_4e9e(param_1: u32, param_2: HGLOBAL16) {
    let BVar1: bool;
    HRSRC16
    h_rsrc;
    let iVar2: i16;
    ...
    if ((iVar2 + 0x20) != 0x0) {
        ...
        h_rsrc = FindResource16(HVar3, &ctx.PTR_LOOP_1050_000a, 0x0);
        HVar3 = LoadResource16((HMODULE16)s_tile2_bmp_1050_1538, h_rsrc);
        (iVar2 + 0x2a) = HVar3;
        if (HVar3 != 0x0) {
            WIN16_LockResource16(ctx.s_tile2_bmp_1050_1538);
            return;
        }
    }
    return;
...
pub fn win_sys_op_1010_5404(param_1: &mut Struct54, param_2: &mut Struct19, param_3: u16, param_4: &mut WNDCLASS16) {
    ...
    pcVar18 = load_string_1010_847e(ctx.PTR__LOOP_1050_14cc,
    ...
    if (*param_1.field_0xe != '\0') {
        ...
        puVar19 = mixed_1010_20ba(ctx.PTR__LOOP_1050_0ed0, 0x48, param_4, puVar12, unaff_DI);
    ...
    GetPrivateProfileString16(pCVar6, uVar3, (uVar3 >> 0x10),
                              (s_You_may_not_run_a_turn__The_game_1050_00df + 0x21), pcVar18,
                              (pcVar18 >> 0x10));
    if (*param_1.field_0xe != '\0') {
    ...
    uVar3 = &param_1.field_0xa;
    pCVar6 = ctx.s_tile2_bmp_1050_1538;
    GetPrivateProfileString16(pCVar16, uVar3, (uVar3 >> 0x10),
                              (s_You_may_not_run_a_turn__The_game_1050_00df + 0x21), pcVar18,
                              (pcVar18 >> 0x10));
    if (*param_1.field_0xe != '\0') {
        pCVar6 = &ctx.PTR_LOOP_1050_1000;
    ...
    puVar9 = GetPrivateProfileString16(pCVar16, uVar3, (uVar3 >> 0x10),
    ...
    if (param_1.field_0x62 == 0x0) {
        ...
        loop {
            ...
            if ((((puVar14[0x11] < 0x0) || (puVar14[0x12] < 0x0)) || (piVar1 = puVar14 + 0x11,
                                                                      *piVar1 != iStack10 - uStack46 && (iStack10 - uStack46) <= *piVar1)) || (puVar9 = (iStack12 - uStack46), ppuVar2 = (puVar14 + 0x12),
    ...
    GetPrivateProfileString16(&ctx.PTR_LOOP_1050_1000, uVar3, (uVar3 >> 0x10),
                              (s_You_may_not_run_a_turn__The_game_1050_00df + 0x21), pcVar18,
                              (pcVar18 >> 0x10));
    if (*param_1.field_0xe != '\0') {
        pcVar18 = param_1.field_0xe;
...
pub fn write_private_profile_str_1010_5b10(param_1: U32Ptr) {
    ...
    *param_1 = 0x6312;
    (iVar6 + 0x2) = 0x1010;
    puVar8 = mixed_1010_20ba(ctx.PTR__LOOP_1050_0ed0, 0x48, unaff_SS, in_DX, unaff_DI);
    uVar3 = (iVar6 + 0xe);
    sys_1000_3f9c(uVar3, (uVar3 >> 0x10), 0x149c,
    ...
    uVar3 = (iVar6 + 0xa);
    WritePrivateProfileString16(&ctx.PTR_LOOP_1050_1000, uVar3, (uVar3 >> 0x10),
                                pCVar5);
    uVar3 = (iVar6 + 0xa);
    WritePrivateProfileString16(ctx.s_tile2_bmp_1050_1538, uVar3, (uVar3 >> 0x10),
                                (iVar6 + 0xe));
    if ((iVar6 + 0x1e) == 0x0) {
        pCVar5 = 0x13c8;
    } else {
    ...
    WritePrivateProfileString16(ctx.s_tile2_bmp_1050_1538, uVar3, (uVar3 >> 0x10),
                                pCVar5);
    uVar3 = (iVar6 + 0xe);
    sys_1000_3f9c(uVar3, (uVar3 >> 0x10), 0x14a2,
...
pub fn get_private_profile_string_1010_6132(param_1: u32, param_2: i16, param_3: &String) {
    ...
    uVar1 = (iVar7 + 0xe);
    uVar2 = (iVar7 + 0xa);
    GetPrivateProfileString16(param_3, uVar2, (uVar2 >> 0x10),
...
pub fn mixed_sys_op_1018_2978(param_1: u32, param_2: u16, param_3: u16) {
    ...
    pass1_1010_8096(ctx.PTR__LOOP_1050_14cc, 0x1);
    puVar2 = local_2a;
    uStack6 = param_2;
    struct_op_1008_48fe(CONCAT22(param_3, puVar2), 0x1,
    ...
    if (uVar5 == 0x0) {
        ...
        puVar3 = local_2a;
        uVar9 = 0x1008;
        struct_op_1008_3f92(CONCAT22(in_DX, puVar2),
    ...
    if (puVar7 == 0x0) {
        ...
        struct_1008_4c58(
            CONCAT13((puVar6 >> 0x8), CONCAT12(puVar6, puVar3)));
    }
    // uVar9 = (param_1 >> 0x10);
    iVar8 = param_1;
    (iVar8 + 0xe) = puVar3;
...
pub fn make_proc_inst_1038_cf6c(param_1: U32Ptr, param_2: U32Ptr, param_3: U32Ptr) {
    ...
    *param_1 = 0x389a;
    ...
    (iVar2 + 0x8) = 0x0;
    *param_1 = 0xd23e;
    (iVar2 + 0x2) = &ctx.PTR_LOOP_1050_1038;
...
{
let ppcVar1: u32; wparam: WPARAM16; let HVar2: HANDLE16; let HVar3: HANDLE16; let uVar4: u16; let LVar5: LRESULT; let uVar6: u16; let uVar7: u16; let uVar8: u16; let uVar9: u16; let lStack14: i32; let puStack10: u32; let lStack6: i32;

uVar9 = SUB42(ctx.data_seg, 0x0); uVar8 = param_3._2_2_; HVar2 = GetProp16(param_5, s_procHi_1050_5bd7);
uVar7 = param_3._2_2_; HVar3 = GetProp16(ctx.s_tile2_bmp_1050_1538, s_procLo_1050_5bd0); lStack6 = CONCAT22(HVar2, HVar3); uVar6 = param_3._2_2_; HVar2 = GetProp16(ctx.s_tile2_bmp_1050_1538,s_thisHi_1050_5be5); HVar3 = GetProp16(ctx.s_tile2_bmp_1050_1538, s_thisLo_1050_5bde); puStack10 = CONCAT22(HVar2,HVar3);
...
if (param_3 == 0x86) {
ppcVar1 = ( * puStack10 + 0x20); uVar4 = ( * * ppcVar1)(ctx.s_tile2_bmp_1050_1538, HVar3, HVar2, wparam);
//         TODO: goto LAB_1038_d10e;
}
if ((param_3 == 0x112) & & ((wparam & 0xfff0) == 0xf140)) {
LVar5 = SendMessage16(ctx.s_tile2_bmp_1050_1538, 0x0,0x0, 0x112f140); uVar4 = (LVar5 == 0x0);
//         TODO: goto LAB_1038_d10e;
}
}
if (lStack14 != 0x0) {
    ...
    if (param_2 < 0x310000) {
        ...
        if (cVar3 == '\x02') {
            if ((HVar4 | HVar5) != 0x0) {
                uVar2 = *puStack6;
                ppcVar1 = uVar2 + 0x6;
                (**ppcVar1)(ctx.s_tile2_bmp_1050_1538, HVar5, HVar4, param_1, param_2, uVar6, uVar7,
                            uVar8);
                if (puStack6 != 0x0) {
                    ppcVar1 = uVar2;
...
pub fn reg_class_1040_98c0(param_1: i32, param_2: HINSTANCE16, in_wnd_class_3: &WNDCLASS16) {
    ...
    if (BVar1 == 0x0) {
        l_name = (param_1 + 0x54);
        uStack26 = 0x9cde;
        uStack24 = SUB42(&ctx.PTR_LOOP_1050_1040, 0x0);
        uStack22 = 0x40000;
...

{
    ...
    if (ctx.PTR__LOOP_1050_5edc == 0x0) {
...
{
let uVar1: u16; let ppcVar2: u32;
let puVar4: u32; wparam: WPARAM16; let iVar5: i16; let unaff_DI: i16; let uVar6: u16; let uVar7: u32; let uStack6: u32; let puVar3: u32; let uVar5: u32;
...
// uVar6 = (uVar5 >> 0x10);
iVar5 = uVar5; uVar1 = (iVar5 + 0x6); if ((uVar1 | (iVar5 + 0x4)) == 0x0) {
return uVar1 < < 0x10;
}
