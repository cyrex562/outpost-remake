...
pub fn mixed_win_op_1008_0c60(param_1: &mut Struct72,param_2: u16,param_3: bool,param_4: HWND16, param_5: u16,param_6: u16)
...

{
  ...
  if ((ctx.PTR_LOOP_1050_0312 < 0x2) && (i_var1 = i_stack4, true)) {
    ...
    0x3a |
    0x3b |
    0x3c => { i_var1 = param_3 + 0x3; }
    0x3d |
    0x3e => { i_var1 = param_3 + 0x4; }
    0x3f |
    0x40 |
    0x41 |
    0x42 |
