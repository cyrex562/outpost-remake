...
pub unsafe fn struct_1010_0f9c(
    ...
    (**fn_ptr_1)();
    i_var8.field_0x68 = param_2;
    if (&i_var8.field_0x60 != 0x0) && (i_var8.field_0x68 == 0x1) {
        return;
    }
    if i_var8.field_0x68 == 0x0 {
        return;
    }
    let mut pu_var7 = struct_from_addr::<Struct79>(extraout_dx);
    pass1_1028_dc52(CONCAT22(param_3, local_14), 0x1, 0x0, 0x700);
    u_var2 = i_var8.field_0x68 * 0x18;
    mem_op_1000_179c(ctx, u_var2, &mut pu_var7, 0x1000);
    i_var8.field_0x60 = u_var2;
    i_var8.field_0x62 = pu_var7;
    pu_stack28 = CONCAT22(pu_var7, i_var8.field_0x60);
    u_stack30 = i_var8.field_0x68;
    loop {
        loop {
            pu_var6 = pu_var7;
            pu_var3 = local_14;
...
//LAB_1010_10ca:
    u_var2 = i_var8.field_0x68 << 0x2;
    mem_op_1000_179c(u_var2, pu_var7, 0x1000);
    i_var8.field_0x64 = u_var2;
    i_var8.field_0x66 = pu_var7;
    i_stack32 = 0x0;
    u_stack30 = 0x0;
    loop {
        if ((i_var8.field_0x68 * 0x3) <= u_stack30) { break; }
        pu_var7 = i_var8.field_0x62;
        u_var5 = &i_var8.field_0x64;
        // u_var9 = (u_var5 >> 0x10);
        i_var11 = u_var5;
        (i_var11 + i_stack32 * 0x4) = i_var8.field_0x60 + u_stack30 * 0x8;
...
pub fn struct_1010_2cd2(param_1: &mut Struct19, param_3: u16, param_4: u16, unaff_di: i16, extraout_dx: u16) {
    ...
    let pu_var2 = mixed_1010_20ba(
        ctx, ctx.PTR_LOOP_1050_0ed0, 0x48, param_4,
...
{
    let u_var1: u16;
    let i_var2: &mut Struct240;
    let u_var2: u16;
    let pu_var3: U32Ptr;

    if (param_2 != 0x0) {
        u_var1 = param_2 << 0x2;
        mem_op_1000_179c(u_var1, param_4, 0x1000);
        // u_var2 = (param_1 >> 0x10);
        i_var2 = param_1;
        i_var2.field_0x8 = u_var1;
        i_var2.field_0xa = param_4;
        return CONCAT22(param_4, i_var2.field_0x8);
    }
...
pub fn struct_1010_3c52(ctx: &mut AppContext, param_1: u32, param_2: u16, param_3: u16) {
    ...
    let u_var2: u16;
    let ppc_var3: u32;
    let i_var4: &mut Struct274;
    let u_var4: u16;
    let paVar5: &mut Struct43;

    // u_var4 = (param_1 >> 0x10);
    i_var4 = param_1;
    i_var4.field_0x14 = param_2;
    ...
    paVar5 = unk_io_op_1010_830a(ctx.PTR_LOOP_1050_14cc, i_var4.field_0x14, param_3);
    i_var4.field_0xe = paVar5;
    i_var4.field_0x10 = (paVar5 >> 0x10);
    return;
}
...

{
    ...
    if &i_var3.field_0x1a == 0x0 {
        u_var2 = i_var3.field_0x30 << 0x3;
        mem_op_1000_179c(ctx, u_var2, param_7, 0x1000);
        &i_var3.field_0x1a = u_var2;
        i_var3.field_0x1c = param_7;
    }
    u_var1 = &i_var3.field_0x1a;
    i_var4 = param_6 * 0x8;
    (u_var1 + i_var4) = param_5;
    u_var1 = &i_var3.field_0x1a;
    (u_var1 + i_var4 + 0x2) = param_4;
    u_var1 = &i_var3.field_0x1a;
    (u_var1 + i_var4 + 0x4) = param_3;
    u_var1 = &i_var3.field_0x1a;
    (u_var1 + i_var4 + 0x6) = param_2;
    return;
}
...
pub fn struct_1010_5f1e(param_1: &mut Struct73, param_2: &mut String, param_3: u16) {
    let u_var1: u16;
    let i_var3: &mut Struct73;
    let u_var3: &mut Struct73;

    // u_var3 = (param_1 >> 0x10);
    i_var3 = param_1;
    fn_ptr_1000_17ce(ctx, &i_var3.field_0x16, 0x1000);
...
pub fn struct_1010_9172(param_1: u32) {
    ...
    paVar5 = CONCAT22(u_var2, pu_var1);
    if ((u_var2 | pu_var1) != 0x0) {
        ppc_var3 = *pu_var1;
        paVar5 = (**ppc_var3)();
    }
    ...
    if (paVar5 == 0x0) {
        ...
        u_var6 = struct_op_1030_1cd8(paVar5, 0x5, 0x5);
    }
    i_var4.field_0x4 = u_var6;
    i_var4.field_0x6 = (u_var6 >> 0x10);
    return;
}
...
pub fn struct_1010_a1d8(param_1: &mut Struct627, param_2: &mut Struct19, param_3: u16, param_4: &mut WNDCLASS16) {
    ...
    param_1.field_0xc = 0x1010;
    puVar4 = mixed_1010_20ba(ctx.PTR_LOOP_1050_0ed0, 0x2f, param_4,
...
pub fn struct_1010_e9e4(param_1: &mut Struct261, param_2: &mut Struct19, param_3: u16) {
    ...
    if ((puVar7 | u_var5) == 0x0) {
        &param_1.field_0xe = 0x0;
    } else {
        puVar10 = pass1_1018_dcf6(CONCAT22(puVar7, u_var5));
    ...
    // for (i_stack4 = 0x1; i_stack4 < 0x9; i_stack4 += 0x1) {
    //   pass1_1008_612e(0x0,0x1d,u_var6);
    //   u_var5 = u_var6;
    //   pass1_1008_612e(0x1,0x2,u_var5);
    //   if ((u_var6 & 0x1) != 0x0) {
    //     u_var5 = -u_var5;
    //   }
    //   i_var8 = i_stack4 * 0x4;
    //   pu_var1 = (&param_1.field_0x34 + i_var8);
    //   u_var2 = *pu_var1;
    //   u_var4 = u_var5 + *pu_var1;
    //   u_var6 = u_var4;
    //   i_var3 = (&param_1.field_0x34 + i_var8 + 0x2);
    //   (&param_1.field_0x34 + i_var8) = u_var4;
    //   (&param_1.field_0x36 + i_var8) =
    //        (u_var5 >> 0xf) + i_var3 + CARRY2(u_var5,u_var2);
    // }
    return;
}
