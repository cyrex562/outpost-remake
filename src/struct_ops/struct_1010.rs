...
pub fn set_struct_fields_1010_1d48(param_1: &mut Struct79, param_2: u16)
...
pub fn struct_1010_2cd2(param_1: &mut Struct79, param_3: u16, param_4: u16, unaff_di: i16, extraout_dx: u16)
{
  // let unaff_DI: i16;
