...
use crate::err_ops::{_SHI_INVOKEERRORHANDLER1, error_check_1000_0dc6, error_check_1000_16ee, error_check_1000_17ce, invoke_error_handler_1000_1e61};
...
use crate::mem_funcs::alloc_mem::alloc_mem_1000_010c;
use crate::mem_funcs::free_mem::free_mem_1000_1b9a;
use crate::mem_funcs::mem_size::get_mem_sz_1000_1532;
...
use crate::pass::pass4_funcs::{pass1_1028_dc52, pass1_1028_e4ec, pass1_1030_1312};
...
use crate::pass::pass8_funcs::{pass1_1008_ec72, pass1_1010_038e, pass1_1010_041a, pass1_1010_0538, pass1_1010_1d80, pass1_1010_37d4, pass1_1010_383a, pass1_1010_65d0};
...
use crate::structs::prog_structs_1::{Struct104, Struct393, Struct552};
use crate::structs::prog_structs_11::{Struct355, Struct475, Struct95};
use crate::structs::prog_structs_12::{Struct102, Struct1049, Struct460, Struct94};
use crate::structs::prog_structs_13::{Struct342, Struct880};
use crate::structs::prog_structs_14::Struct893;
use crate::structs::prog_structs_15::Struct1169;
use crate::structs::prog_structs_16::{Struct1023, Struct151, Struct493};
use crate::structs::prog_structs_17::{Struct1026, Struct1055, Struct1175};
use crate::structs::prog_structs_18::{Struct1042, Struct180, Struct195, Struct391, Struct568};
use crate::structs::prog_structs_2::{Struct1054, Struct199, Struct296, Struct413, Struct660, Struct668, Struct7};
use crate::structs::prog_structs_20::{Struct1073, Struct388, Struct508, Struct514};
use crate::structs::prog_structs_21::Struct297;
use crate::structs::prog_structs_23::{Struct1022, Struct1037, Struct210, Struct341};
use crate::structs::prog_structs_24::{Struct103, Struct1144, Struct1172, Struct182, Struct2111, Struct354, Struct384};
use crate::structs::prog_structs_25::{Struct152, Struct402, Struct64, Struct65, Struct81, Struct84, Struct85, Struct882};
use crate::structs::prog_structs_26::{Struct392, Struct96, Struct97};
use crate::structs::prog_structs_27::{Struct1029, Struct186, Struct298, Struct344};
use crate::structs::prog_structs_28::{Struct1034, Struct1040, Struct1043, Struct1044, Struct1046, Struct1047, Struct1048, Struct1056, Struct1057, Struct1071, Struct1074, Struct346, Struct357, Struct377, Struct434, Struct464};
use crate::structs::prog_structs_29::{Struct1025, Struct1027, Struct1030, Struct1031, Struct1032, Struct1033, Struct1038, Struct1039, Struct105, Struct114, Struct214, Struct216, Struct310, Struct314, Struct336, Struct375, Struct412};
use crate::structs::prog_structs_30::{Struct106, Struct154, Struct190, Struct304, Struct435};
use crate::structs::prog_structs_31::{Struct107, Struct127, Struct155, Struct191, Struct303, Struct316, Struct352, Struct405, Struct436, Struct437, Struct438, Struct474};
...
use crate::structs::prog_structs_8::{Struct108, Struct302, Struct644, Struct649, Struct68};
use crate::structs::prog_structs_9::{Struct1019, Struct1072, Struct209};
...
use crate::util::{CARRY1, CONCAT11, CONCAT12, CONCAT13, CONCAT22, CONCAT31, LOCK, SBORROW1, SBORROW2, SUB42, ZEXT24};
use crate::winapi::{GetSystemMetrics16, swi};

pub fn set_struct_1000_0782(ctx: &mut AppContext, param_1: &String) -> u16 {
    ...
    if (ctx.ax_reg < paVar4) {
        ...
        unsafe {
            ...
            if (pu_var5 == PTR_LOOP_1050_000e) {
              ctx.PTR_LOOP_1050_000e = pu_var5[1];
            }
        ...
        if (ctx.PTR_DAT_0005_0000_1050_0004 < local_4) {
          ctx.PTR_DAT_0005_0000_1050_0004 = local_4;
        }
    }
    unsafe {
...
pub fn struct_fn_1000_160a(ctx: &mut AppContext) -> Address<Struct94> {
    ...
    if (ctx.g_u16_ptr_1050_5f2e | ctx.g_struct_ptr_1) == 0 {
        ...
        ctx.u16_1050_5f32 = 1;
        ctx.g_struct_ptr_1 = init_struct_1000_18ec(None);
        if ctx.g_struct_ptr_1 != 0x0 {
            ...
            if ctx.u16_1050_5f44 != 0xffff {
                check_structs_1000_1afe(ctx.u16_1050_5f44, ctx.g_struct_ptr_1);
            }
        }
    }
    return ctx.g_struct_ptr_1;
}

pub fn process_struct_1000_179c(ctx: &mut AppContext, param_1: u16, struct_a: &mut Struct7) {
    let u16_ptr_1: &mut  u16;
    let mut u16_ptr_2: &mut Struct199;
    let mut local_4: u16;

    u16_ptr_1 = ctx.g_struct_ptr_1;
    u16_ptr_2 = ctx.g_u16_ptr_1050_5f2e;
    if (ctx.g_u16_ptr_1050_5f2e | ctx.g_struct_ptr_1) == 0 {
        u16_ptr_1 = struct_fn_1000_160a(ctx);
        u16_ptr_2 = struct_a;
    }
...
pub fn process_struct_1000_2e74(param_1: &mut  Struct154) -> bool {
    ...
    if (ctx.PTR_LOOP_1050_61ec != 0x0) {
        ...
        ppvVar4 = 0x5ff2;
        if ((param_1 == 0x621c) || (ppvVar4 = &ctx.PTR_LOOP_1050_5ff6, param_1 == 0x6228)) {
...
pub fn process_struct_1008_9d36(param_1: Vec<u8>, param_2: Vec<u8>, param_3: u16) {
  ...
  ctx.PTR_LOOP_1050_4232 = param_2;
    ...
    while {
        ...
        mixed_fn_1010_830a(ctx.g_struct_73_1050_14cc, u_var1);
  ...
  // u_var3 = (u_var4  >> 0x10);
    ...
    process_struct_1008_9262(
      ctx._PTR_LOOP_1050_0388,
        (ctx._PTR_LOOP_1050_0388 >> 0x10),
        0x50,
...
pub unsafe fn process_struct_1008_c882(param_1: u32) {
  ...
  // u_var14 = (param_1  >> 0x10);
    ...
    (iVar13 + 10) = pa_var5;
    (iVar13 + 0xc) = u_var9;
    ppVar16 = process_struct_1010_20ba(ctx.g_struct_var_1050_0ed0, CONCAT22(unaff_si, 0x35));
  ...
  // local_es_6 = (param_1  >> 0x10);
    ...
    if ((temp_5f342bbd88 + 0x12) != 0x71) {
        ...
        if (ctx.PTR_LOOP_1050_5f02 == 0x0) {
            mixed_fn_1010_830a(ctx.g_struct_73_1050_14cc, 0xff);
          ctx._PTR_LOOP_1050_5f04 = CONCAT22(local_DX_67, i_var3);
            local_CS__1 = 0x1010;
            mixed_fn_1010_830a(ctx.g_struct_73_1050_14cc, 0x100);
          ctx._PTR_LOOP_1050_5f08 = CONCAT22(local_DX_87, i_var3);
        }
      ctx.PTR_LOOP_1050_5f02 = PTR_LOOP_1050_5f02 + 1;
...
pub fn process_struct_1010_2cd2(
    ...
    pu_var2 = &local_6;
    u_var4 = unaff_ss;
    ppVar1 = process_struct_1010_20ba(ctx.g_struct_var_1050_0ed0, CONCAT22(pu_var2, 0x48));
    pass1_1008_3e94(
        (ppVar1 + 0xe),
...
pub fn process_struct_1010_3e3c(in_struct_1: &mut  Struct393, param_2: u16) {
  ...
  // uStack16 = (in_struct_1  >> 0x10);
    ...
    in_struct_1.field_0x0 = &ctx.PTR_LOOP_1050_4a46;
    local_struct_2.u16_0x2 = 0x1010;
    local_struct_2.field_0x20 = &ctx.PTR_LOOP_1050_4a82;
    ...
    mixed_fn_1010_830a(ctx.g_struct_73_1050_14cc, 0x1a1);
...
pub unsafe fn pass1_1010_3f00(param_1: &mut  Struct376) {
  ...
  // u_var4 = (param_1  >> 0x10);
    local_bx_5 = param_1;
    param_1.ptr_a_lo = &ctx.PTR_LOOP_1050_4a46;
    local_bx_5.field_0x2 = 0x1010;
    local_bx_5.field_0x20 = &ctx.PTR_LOOP_1050_4a82;
...
pub fn process_struct_1010_4a8a(param_1: &mut  Struct375, param_2: &mut  Struct375, param_3: u16) {
    ...
    *(&param_1.u16_x16 + 2) = local_DX_102;
    ppVar1 = process_struct_1010_20ba(ctx.g_struct_var_1050_0ed0, CONCAT22(local_6, 3));
...
pub fn process_struct_1010_6abc(param_1: &mut  Struct438, param_2: u32) {
    ...
    param_1.field_0xc = 0x1010;
    ppVar2 = process_struct_1010_20ba(ctx.g_struct_var_1050_0ed0, CONCAT22(in_stack_0000fff6, 3));
    param_1.field_0x14 = ppVar2;
    &param_1.field_0x16 = (ppVar2 >> 0x10);
    u_var3 = *&param_1.field_0x14;
    pp_var1 = (&param_1.field_0x14 + 4);
    (**pp_var1)();
    ppVar2 = process_struct_1010_20ba(ctx.g_struct_var_1050_0ed0, CONCAT22(u_var3, 0x2f));
...
pub fn process_struct_1008_e3ec(in_struct_a: &mut  Struct310, param_2: u32, param_3: u32) {
  ...
  // struct_b_hi = (in_struct_a  >> 0x10);
    ...
    if (paVar3 != 0x0) {
        ...
        (**fn_ptr_a)(&ctx.PTR_LOOP_1050_1028, struct_c_lo);
        paVar3 = ctx.dx_reg;
    }
    process_struct_1000_179c(0x18, paVar3);
...
pub fn process_struct_1008_e586(ctx: &mut AppContext, param_1: Vec<u8>, param_1_00: u32) {
  ...
  // paVar1 = pass1_1028_e1ec(ctx._PTR_LOOP_1050_65e2, param_1_00, (param_1_00  >> 0x10));
    ...
    process_struct_1000_179c(ctx, 0x80, struct_a);
...
pub unsafe fn process_struct_1008_ed1e(ctx: &mut AppContext, param_1: u16, param_2: u16, param_1_00: i32) {
    let mut in_ax: i32;
    let in_dx: &mut  Struct199;
    let mut local_4: u16;

    if param_1_00 != 0 {
        process_struct_1000_179c(ctx, param_1_00 << 2, in_dx);
        return;
    }
...
pub unsafe fn process_struct_1020_1eea(
  ...
  // local_es_4 = (in_struct_1  >> 0x10);
    ...
    string_1 = CONCAT22(string_1, 0x39);
...
pub fn process_struct_1010_a1d8(
    ...
    struct_a =
        process_struct_1010_20ba(ctx.g_struct_var_1050_0ed0, CONCAT22(string_ptr_base, 0x2f));
...
pub fn process_struct_1018_0570(param_1: &mut  u16, param_2: u16) {
  ...
  // u_var9 = (param_1  >> 0x10);
    ...
    if ((ctx.PTR_LOOP_1050_3960 == 0x0) && (ctx._PTR_LOOP_1050_3962 == 0)) {
        pa_var5 = struct_a;
        process_struct_1000_179c(8, struct_a);
      ctx._PTR_LOOP_1050_3962 = CONCAT22(pa_var5, u_var6);
        pass1_1000_4906(CONCAT22(pa_var5, u_var6), 0, 8);
    }
  ctx.PTR_LOOP_1050_3960 = PTR_LOOP_1050_3960 + 1;
    ...
    pp_var7 = process_struct_1010_20ba(ctx.g_struct_var_1050_0ed0, CONCAT22(u_var8, 2));
    if ((pp_var7 + 0x80) != 0) {
        local_bx_18.field_0x84 = 2;
    }
    pp_var7 = process_struct_1010_20ba(ctx.g_struct_var_1050_0ed0, CONCAT22(u_var8, 9));
    i_var4 = pp_var7;
    ...
    pp_var7 = process_struct_1010_20ba(ctx.g_struct_var_1050_0ed0, CONCAT22(u_var8, 0x3b));
...
pub fn process_struct_1018_e5dc(in_struct_1: &mut  Struct65, param_2: u16, param_3: u32) {
  ...
  // local_struct_1 = (in_struct_1  >> 0x10);
    ...
    (i_var2 + 0xe2) = 0xe82c;
    (i_var2 + 0xe4) = 0x1018;
    ppVar3 = process_struct_1010_20ba(ctx.g_struct_var_1050_0ed0, CONCAT22(unaff_bp, 10));
  // u_var1 = (ppVar3  >> 0x10);
    (i_var2 + 0xf2) = ppVar3;
    (i_var2 + 0xf4) = u_var1;
...
pub fn process_struct_1018_e91e(in_struct_a: &mut  Struct65, param_2: u16, param_3: u32) {
  ...
  // struct_a_2 = (in_struct_a  >> 0x10);
    ...
    ppVar6 = process_struct_1010_20ba(ctx.g_struct_var_1050_0ed0, CONCAT22(char_ptr_1, 0x28));
  // u_var4 = (ppVar6  >> 0x10);
    struct_a_1.u16_xf2 = ppVar6;
    struct_a_1.u16_xf4 = u_var4;
    struct_a_1.u16_xe6 = struct_a_1.u16_xf2;
    struct_a_1.u16_xe8 = u_var4;
    ppVar6 = process_struct_1010_20ba(ctx.g_struct_var_1050_0ed0, CONCAT22(char_ptr_1, 0x32));
...
pub fn process_struct_1020_04f6(in_struct_1: &mut  Struct629, param_2: u16) {
  ...
  // local_struct_1_hi = (in_struct_1  >> 0x10);
    ...
    ppVar5 = process_struct_1010_20ba(ctx.g_struct_var_1050_0ed0, pcStack32);
  // u_var3 = (ppVar5  >> 0x10);
    ...
    ppVar5 = process_struct_1010_20ba(ctx.g_struct_var_1050_0ed0, CONCAT22(u_var6, 0x48));
  // u_var4 = (ppVar5  >> 0x10);
    i_var2 = ppVar5;
...
pub unsafe fn process_struct_1020_0baa(struct_param_1: &mut Struct636, param_2: u16) {
    let mut local_DX_123: u16;
    // let local_struct_1: Struct636;
    // let local_struct_1_hi: Struct636;
    let ppVar1: Struct2111;
    let p_uvar2: u16;
    let pu_var3: u16;
    let paVar4: Struct636;
    let local_string_1: String;

    //// ocal_struct_1_hi = (in_struct_1  >> 0x10);
    // local_struct_1 = in_struct_1;
    struct_param_1.u16_0x0 = ctx.s_1_1050_389a;
    local_struct_1.u16_0x02 = ctx.PTR_LOOP_1050_1008;
    struct_param_1.u16_0x0 = (ctx.s_18_2_1050_3aa5 + 3);
    local_struct_1.u16_0x02 = ctx.PTR_LOOP_1050_1008;
    local_struct_1.u16_0x04 = param_2;
    struct_param_1.u16_0x0 = ctx.s_0_020_1050_3ab0;
    local_struct_1.u16_0x02 = ctx.PTR_LOOP_1050_1008;
    local_struct_1.u16_0x06 = 0;
    local_struct_1.u16_0x0a = 0;
    local_struct_1.u16_0x0c = 0;
    struct_param_1.u16_0x0 = 0xdbc;
    local_struct_1.u16_0x02 = 0x1020;
    ppVar1 = process_struct_1010_20ba(ctx.g_struct_var_1050_0ed0, CONCAT22(local_string_1, 7));
...
pub fn pass1_1040_34a2(
  ...
  // u_var2 = (param_1  >> 0x10);
    ...
    (iVar1 + 2) = &ctx.PTR_LOOP_1050_1040;
    ppVar3 = process_struct_1010_20ba(ctx.g_struct_var_1050_0ed0, CONCAT22(unaff_bp, 0x3c));
    (iVar1 + 0x8e) = ppVar3;
...
pub fn pass1_1040_1f5a(param_1: &mut  Struct68, param_2: Vec<u8>) {
  ...
  // u_var2 = (u_var5  >> 0x10);
    process_struct_1010_20ba(ctx.g_struct_var_1050_0ed0, CONCAT22(unaff_si, 0x48));
    ...
    process_struct_1010_20ba(ctx.g_struct_var_1050_0ed0, CONCAT22(i_var3 + 0xa6, 0x2b));
    pass1_1010_0538();
    return;
}
...
pub fn pass1_1040_1cb4(
  ...
  // u_var2 = (param_1  >> 0x10);
    ...
    ppVar3 = process_struct_1010_20ba(ctx.g_struct_var_1050_0ed0, in_string_1);
    (iVar1 + 0x8e) = ppVar3;
    (iVar1 + 0x90) = (ppVar3 >> 0x10);
...
pub fn pass1_1040_181c(
  ...
  // u_var2 = (param_1  >> 0x10);
    ...
    (iVar1 + 2) = &ctx.PTR_LOOP_1050_1040;
    ppVar3 = process_struct_1010_20ba(ctx.g_struct_var_1050_0ed0, CONCAT22(unaff_bp, 2));
    (iVar1 + 0x8e) = ppVar3;
    (iVar1 + 0x90) = (ppVar3 >> 0x10);
    return;
}
...
pub fn pass1_1040_123e(
  ...
  // u_var2 = (param_1  >> 0x10);
    ...
    (iVar1 + 2) = &ctx.PTR_LOOP_1050_1040;
    ppVar3 = process_struct_1010_20ba(ctx.g_struct_var_1050_0ed0, CONCAT22(unaff_bp, 0x46));
    (iVar1 + 0x8e) = ppVar3;
    (iVar1 + 0x90) = (ppVar3 >> 0x10);
    return param_1;
}
...
pub fn pass1_1040_0e1c(
  ...
  // u_var2 = (param_1  >> 0x10);
    ...
    *(iVar1 + 0x98) = param_2;
    ...
    (iVar1 + 2) = &ctx.PTR_LOOP_1050_1040;
    ppVar3 = process_struct_1010_20ba(ctx.g_struct_var_1050_0ed0, CONCAT22(unaff_bp, 0x3a));
    (iVar1 + 0x8e) = ppVar3;
    (iVar1 + 0x90) = (ppVar3 >> 0x10);
    return;
}
...
pub fn pass1_1040_0bfc(
  ...
  // u_var2 = (param_1  >> 0x10);
    ...
    (iVar1 + 2) = &ctx.PTR_LOOP_1050_1040;
    ppVar3 = process_struct_1010_20ba(ctx.g_struct_var_1050_0ed0, CONCAT22(unaff_bp, 0x39));
    (iVar1 + 0x8e) = ppVar3;
    (iVar1 + 0x90) = (ppVar3 >> 0x10);
    (iVar1 + 0x74) = 1;
    return param_1;
...
pub fn pass1_1040_06e8(
  ...
  // u_var2 = (param_1  >> 0x10);
    ...
    (iVar1 + 2) = &ctx.PTR_LOOP_1050_1040;
    ppVar3 = process_struct_1010_20ba(ctx.g_struct_var_1050_0ed0, CONCAT22(unaff_bp, 7));
    (iVar1 + 0x8e) = ppVar3;
    (iVar1 + 0x90) = (ppVar3 >> 0x10);
    return param_1;
}
...
pub fn pass1_1038_eeda(param_1: &mut  Struct68, param_2: Vec<u8>) {
  ...
  // u_var2 = (param_1  >> 0x10);
    ...
    (iVar1 + 2) = &ctx.PTR_LOOP_1050_1040;
    ppVar3 = process_struct_1010_20ba(ctx.g_struct_var_1050_0ed0, CONCAT22(unaff_bp, 9));
    (iVar1 + 0x8e) = ppVar3;
    (iVar1 + 0x90) = (ppVar3 >> 0x10);
    (iVar1 + 0x74) = 1;
    return;
...
pub fn pass1_1038_e99a(
  ...
  // u_var2 = (param_1  >> 0x10);
    ...
    (iVar1 + 2) = &ctx.PTR_LOOP_1050_1038;
    ppVar3 = process_struct_1010_20ba(ctx.g_struct_var_1050_0ed0, CONCAT22(unaff_bp, 0x30));
    (iVar1 + 0x8e) = ppVar3;
    (iVar1 + 0x90) = (ppVar3 >> 0x10);
    return param_1;
}
...
pub fn pass1_1038_e69a(
  ...
  // u_var2 = (param_1  >> 0x10);
    ...
    (iVar1 + 2) = &ctx.PTR_LOOP_1050_1038;
    ppVar3 = process_struct_1010_20ba(ctx.g_struct_var_1050_0ed0, CONCAT22(unaff_bp, 0x43));
    (iVar1 + 0x8e) = ppVar3;
    (iVar1 + 0x90) = (ppVar3 >> 0x10);
    return;
}
...
pub fn pass1_1038_df86(param_1: Vec<u8>) {
    ...
    pp_var11 = process_struct_1010_20ba(ctx.g_struct_var_1050_0ed0, CONCAT22(in_stack_0000ffe6, 2));
...
pub fn pass1_1038_d756(param_1: &mut  Struct68, param_2: Vec<u8>) -> &mut  Struct68 {
  ...
  // u_var3 = (param_1  >> 0x10);
    ...
    (i_var2 + 2) = &ctx.PTR_LOOP_1050_1038;
    ppVar4 = process_struct_1010_20ba(ctx.g_struct_var_1050_0ed0, CONCAT22(unaff_bp, 0x2b));
    (i_var2 + 0x92) = ppVar4;
...
pub fn pass1_1038_cd06(
  ...
  // u_var2 = (param_1  >> 0x10);
    ...
    (iVar1 + 2) = &ctx.PTR_LOOP_1050_1038;
    ppVar3 = process_struct_1010_20ba(ctx.g_struct_var_1050_0ed0, CONCAT22(unaff_bp, 0x42));
    (iVar1 + 0x8e) = ppVar3;
    (iVar1 + 0x90) = (ppVar3 >> 0x10);
    return;
}
...
pub fn pass1_1038_cad8(param_1: u32, param_2: Vec<u8>) -> u8 {
  ...
  // u_var2 = (param_1  >> 0x10);
    ...
    param_1 = 0xcc9a;
    (iVar1 + 2) = &ctx.PTR_LOOP_1050_1038;
    ppVar3 = process_struct_1010_20ba(ctx.g_struct_var_1050_0ed0, CONCAT22(unaff_bp, 0x2c));
    (iVar1 + 0x8e) = ppVar3;
    (iVar1 + 0x90) = (ppVar3 >> 0x10);
    (iVar1 + 0x74) = 0;
    return param_1;
...
pub fn pass1_1038_c7b8(
  ...
  // u_var2 = (param_1  >> 0x10);
    ...
    (iVar1 + 2) = &ctx.PTR_LOOP_1050_1038;
    ppVar3 = process_struct_1010_20ba(ctx.g_struct_var_1050_0ed0, CONCAT22(unaff_bp, 5));
    (iVar1 + 0x8e) = ppVar3;
    (iVar1 + 0x90) = (ppVar3 >> 0x10);
    return param_1;
}
...
pub fn pass1_1038_c4a2(
  ...
  // u_var2 = (param_1  >> 0x10);
    ...
    (iVar1 + 2) = &ctx.PTR_LOOP_1050_1038;
    ppVar3 = process_struct_1010_20ba(ctx.g_struct_var_1050_0ed0, CONCAT22(unaff_bp, 0x3b));
    (iVar1 + 0x8e) = ppVar3;
    (iVar1 + 0x90) = (ppVar3 >> 0x10);
    return;
}
...
pub fn pass1_1038_9144(ctx: &mut AppContext, param_1: Vec<u8>, param_2: Vec<u8>) {
  ...
  // u_var5 = (param_1  >> 0x10);
    ...
    (i_var3 + 0x98) = 0;
    param_1 = 0x99a2;
    (i_var3 + 2) = &ctx.PTR_LOOP_1050_1038;
    (i_var3 + 0x8a) = 0x27;
    pp_var7 = process_struct_1010_20ba(ctx.g_struct_var_1050_0ed0, CONCAT22(unaff_si, 0x28));
        ...
        *pu8_var1 = b_var2 - b_var14;
            ...
            && (SBORROW1(bVar7, bVar6) != SBORROW1(b_var2, b_var14)) == (*pu8_var1 < '\0'))
        {
          ...
          // u_var12 = (param_1  >> 0x10);
            ...
            (i_var8 + 2) = &ctx.PTR_LOOP_1050_1038;
            (i_var8 + 0x8a) = 0x27;
            ppVar16 =
                process_struct_1010_20ba(ctx.g_struct_var_1050_0ed0, CONCAT22(unaff_si, 0x28));
...
pub fn pass1_1038_8caa(param_1: &mut  Vec<u8>, param_2: Vec<u8>) -> &mut  Vec<u8> {
  ...
  // u_var2 = (param_1  >> 0x10);
    ...
    (iVar1 + 2) = &ctx.PTR_LOOP_1050_1038;
    ppVar3 = process_struct_1010_20ba(ctx.g_struct_var_1050_0ed0, CONCAT22(unaff_bp, 0x3f));
    (iVar1 + 0x94) = ppVar3;
        ...
        *pu8_var1 = b_var2 - bVar10;
            ...
            && (SBORROW1(b_var5, u8_var4) != SBORROW1(b_var2, bVar10)) == (*pu8_var1 < '\0'))
        {
          ...
          // u_var9 = (pu_var12  >> 0x10);
            ...
            (i32_var6 + 0x9e) = 0;
            *pu_var12 = 0x8c2e;
            (i32_var6 + 2) = &ctx.PTR_LOOP_1050_1038;
            return;
        }
        if (*pu8_var1 != 0) {
            error_check_1000_17ce(param_1);
...
pub fn pass1_1038_7d10(param_1: u32, param_2: Vec<u8>) {
  ...
  // u_var1 = (param_1  >> 0x10);
    ...
    param_1 = 0x8876;
    local_bx_18.field_0x2 = &ctx.PTR_LOOP_1050_1038;
    struct_a = process_struct_1010_20ba(ctx.g_struct_var_1050_0ed0, CONCAT22(unaff_bp, 0x40));
...
pub fn pass1_1038_6520(param_1: &mut  Struct1144) {
  ...
  // local_es_4 = (param_1  >> 0x10);
    ...
    local_bx_4.field_0x2 = &ctx.PTR_LOOP_1050_1038;
    return;
}
...
pub fn pass1_1038_2b9a(param_1: Vec<u8>) {
  ...
  // u_var7 = (param_1  >> 0x10);
    if ((in_dx | in_ax) != 0) {
        ...
        *_local_a = 0x309a;
        (in_ax + 2) = &ctx.PTR_LOOP_1050_1038;
    }
    (i_var5 + 0x114) = 0;
    (i_var5 + 0x110) = 0;
    return;
    ...
    if ((in_dx | ctx.ax_reg) != 0) {
      ...
      // u_var3 = (param_1  >> 0x10);
        ...
        *_local_a = (s_fem110_wav_1050_29fa + 4);
        ctx.ax_reg.field_0x2 = &ctx.PTR_LOOP_1050_1038;
    }
    return;
}
...
pub fn pass1_1030_e34e(struct_a: &mut  Struct1022) {
    ...
    if ((struct_c | struct_b) != 0) {
      ...
      // struct_e = (struct_a  >> 0x10);
        ...
        *_local_a = 0x6ad2;
        struct_b.field_0x2 = &ctx.PTR_LOOP_1050_1028;
...
// Struct2551 *32 process_struct_1010_20ba (Struct372 *32 in_struct_372_ptr, char *32 in_string_1)
pub fn process_struct_1010_20ba(a: &mut Struct372, b: u32) -> Struct2111 {
    let mut out: Struct2111 = Struct2111::new();
    out
}
