...
use crate::structs::prog_structs_2::{Struct390, Struct306};
...
pub fn write_to_file_1008_7954(ctx: &mut AppContext, param_1: &mut HFILE16, param_2: &mut  Struct731) {
    let pp_var1: fn();
    //
    let b_result: bool;
    let mut u_var3: u32;
    ...
    if param_2 == 0x0 {
        ...
        // pp_var1 = param_2.field_0x10;
        // (**pp_var1)();
        get_fn_ptr_at_address(param_2.field_0x10)();
        local_16 = ctx.dx_reg;
    }
    local_6 = CONCAT22(local_16, ctx.ax_reg);
    local_18 = ctx.ax_reg;
    b_result = write_to_file_1008_7e1c(param_1, local_18, 4);
    if b_result != false {
        local_a = 0;
        loop {
            if local_6 <= local_a {
            ...
            pp_var1 = get_fn_ptr_at_address(param_2.field_0x4.full_address);
            u_var3 = local_6;
            pp_var1();
            local_20 = u_var3;
            local_1e = ctx.dx_reg;
            local_18 = local_20;
            local_16 = ctx.dx_reg;
            b_result = write_to_file_1008_7e1c(param_1, CONCAT22(ctx.stack_seg_reg, &local_20), 4);
            if b_result == 0 {
                break;
            }
            local_a = local_a + 1;
...
pub unsafe fn write_to_file_1008_7cac(ctx: &mut AppContext, param_1: &HFILE16, param_2: u16) -> bool {
    let mut b_var1: bool;
    ...
    b_var1 = write_to_file_1008_7e1c(&param_1, char_buf.as_mut_vec(), buf_size as usize);
    if b_var1 == false {
        ctx.g_u16_1050_0310 = 0x6d0;
        return false;
    }
...
pub unsafe fn write_to_file_1008_c98e(param_1: u32, param_2: u32) {
    let u_var1: u8;
    let BVar2: bool;
    ...
    u_var1 = write_to_file_1008_7cac(ctx,param_2, 0x15);
...
pub unsafe fn write_to_file_1008_e5da(param_1: u32, param_2: u32) {
    ...
    u_var2 = write_to_file_1008_7cac(ctx,param_2, 0x14);
...
pub unsafe fn write_file_1010_0ad2(ctx: &mut AppContext, in_struct_1: &mut  Struct235, param_2: u32) {
    ...
    u_var2 = write_to_file_1008_7cac(ctx, param_2, 6);
    if (CONCAT31(extraout_var, u_var2) == 0) {
        return;
    }
...
pub unsafe fn write_to_file_1010_3fc2(ctx: &mut AppContext, struct_param_1: &mut Struct390, hfile_param_2: &HFILE16) -> bool {
    let b_result: bool;
    let struct_var_1: Struct390;
    let string_var_4: String;
    let u_var1 = write_to_file_1008_7cac(ctx,hfile_param_2, 5);
    if u_var1 != false {
...
pub unsafe fn write_to_file_1010_5dc6(
    ...
    let u_var2 = write_to_file_1008_7cac(ctx,in_file_1, 4);
    if u_var2 != false {
        ctx.bx_reg = in_struct_1;
...
pub unsafe fn write_file_1010_6372(param_1: u32, hfile_param2: &HFILE16) {
    let u_var1: u8;
    let BVar2: bool;
    let extraout_var: u32;
    let mut i_var3: i32;
    ...
    u_var1 = write_to_file_1008_7cac(ctx,hfile_param2, 7);
    if (CONCAT31(extraout_var, u_var1) != 0) {
      // u_var4 = (param_1  >> 0x10);
        i_var3 = param_1;
        local_10 = (i_var3 + 10);
...
pub unsafe fn write_to_file_1010_6846(param_1: u32, param_2: &HFILE16) {
    let u_var1: u8;
    let mut i_var2: i32;
    let b_var3: bool;
    let extraout_var: u32;
    ...
    u_var1 = write_to_file_1008_7cac(ctx,param_2, 3);
    if (CONCAT31(extraout_var, u_var1) != 0) {
        i_var2 = param_1;
...
pub unsafe fn write_to_file_1010_9900(ctx: &mut AppContext, param_1: u16, param_2: &HFILE16) -> bool {
    ...
    let b_var2 = write_to_file_1008_7cac(ctx,param_2, 1);
...
pub unsafe fn write_to_file_1010_ed58(param_1: u32, in_file: &HFILE16) {
    ...
    u_var2 = write_to_file_1008_7cac(ctx,in_file, 2);
    if (CONCAT31(extraout_var, u_var2) != 0) {
...
pub unsafe fn write_to_file_1038_7b20(param_1: &mut  u32, param_2: &HFILE16) -> u16 {
    ...
    u_var2 = write_to_file_1008_7cac(ctx,param_2, 0x17);
...
pub fn write_to_file_1038_5e16(ctx: &mut AppContext, param_1: &mut Struct731, param_2: &HFILE16) {
    ...
    write_to_file_1030_16d6(ctx, param_1, param_2);
    if ctx.ax_reg != 0 {
      // u_var3 = (param_1  >> 0x10);
      //   local_bx_28 = param_1;
        pu_var2 = &mut param_1.field_0xc;
        local_6 = pu_var2;
...
pub fn write_to_file_1030_de7c(ctx: &mut AppContext, param_1: &mut Struct731, param_2: &HFILE16, param_3: u16) {

    let b_var1: bool;
    let mut unaff_ss: u16;
    let mut local_10: &mut StructuredData;

    write_to_file_1028_b5ec(param_1, param_2);
    if param_3 != 0 {
        local_10 = &mut param_1.field_0x20;
        b_var1 = write_to_file_1008_7e1c(param_2, local_10.buffer.as_mut(), 4);
        if b_var1 == true {
            ctx.g_u16_1050_0310 = 0x6d0;
            return;
        }
...
pub fn write_to_file_1030_d61c(param_1: &mut Struct731, param_2: &HFILE16) {
...
pub fn write_to_file_1030_c230(param_1: &mut Struct731, param_2: &HFILE16) {
...
pub unsafe fn write_to_file_1030_7418(struct_param_1: &mut FileObject, hfile_param_2: &HFILE16) {
    ...
    write_to_file_1030_16d6(ctx, struct_param_1, hfile_param_2);
    if ctx.ax_reg == 0 {
        return;
    }
...
pub unsafe fn write_to_file_1030_5dbe(struct_param_1: &mut Struct771, hfile_param2: &HFILE16) {
    ...
    i_var3 = write_to_file_1030_1978(ctx, struct_param_1, hfile_param2);
    if i_var3 != 0 {
...
pub unsafe fn write_to_file_1030_5c1a(param_1: &mut string, param_2: &HFILE16) -> bool {
    let u_var1: u8;
    let extraout_AH: u8;
    let BVar2: bool;

    u_var1 = write_to_file_1008_7cac(ctx,param_2, 9);
...
pub unsafe fn write_to_file_1030_56f6(struct_param_1: &mut Struct731,
                                      hfile_param_2: &HFILE16) {
    let pu_var1: &mut  u16;
    let mut u_var2: u32;
    let mut u_var3: u32;
    let mut i_var4: i32;
    ...
    i_var4 = write_to_file_1030_1978(ctx, struct_param_1, hfile_param_2);
    if i_var4 != 0 {
      // u_var8 = (struct_param_1  >> 0x10);
        i_var4 = struct_param_1.field_0x0;
        local_e = (i_var4 + 0x10);
        ...
        if b_var5 != false {
                ...
                )
            {
                u_var3 = i_var4 + 0x10;
                local_8 = u_var3 + 0x1a;
                b_var5 = write_to_file_1008_7e1c(hfile_param_2, &local_8, 2);
                if b_var5 != false {
                    local_4 = 0;
                    let pu_var1_val = unsafe { *pu_var1 };
                    while (
...
pub unsafe fn write_to_file_1030_2aca(param_1: &mut FileObject, param_2: &HFILE16) {
    ...
    i_var3 = write_to_file_1030_1978(ctx, param_1, param_2);
    if (i_var3 == 0) {
        return;
    }
  // u_var7 = (param_1  >> 0x10);
...
pub fn write_to_file_1030_1978(ctx: &mut AppContext, param_1: &mut Struct731, param_2: &HFILE16) -> i32 {
    let mut i_var1: i32;

    i_var1 = write_to_file_1030_16d6(ctx, param_1, param_2);
    if i_var1 != 0 {
...
pub fn write_to_file_1030_16d6(ctx: &mut AppContext, param_1: &mut Struct731, param_2: &HFILE16) {
    let b_var1: bool;
    let mut local_10: &mut Vec<u8>;
    let mut local_8: &mut Vec<u8>;

    local_10 = &mut param_1.field_0x4;
    b_var1 = write_to_file_1008_7e1c(param_2, local_10, 4);
    if b_var1 != false {
        local_8 = &mut param_1.field_0x8;
...
pub unsafe fn write_to_file_1028_dce2(param_1: &mut  u32, param_2: &HFILE16) {
    ...
    u_var2 = write_to_file_1008_7cac(ctx,param_2, 10);
    if (CONCAT31(extraout_var, u_var2) != 0) {
                                    ...
                                    if (i_var4 != 0) {
                                        ...
                                        if (i_var4 != 0) {
                                            ...
                                            if (i_var4 != 0) {
                                                ...
                                                if (i_var4 != 0) {
                                                    u_var2 = write_to_file_1008_7cac(ctx,param_2, 0x10);
                                                            ...
                                                            if (i_var4 != 0) {
                                                                ...
                                                                if (i_var4 != 0) {
                                                                    ...
                                                                    if (i_var4 != 0) {
                                                                        ...
                                                                        if (i_var4 != 0) {
                                                                            u_var2 = write_to_file_1008_7cac(ctx,param_2, 0x13);
                                                                            i_var4 = CONCAT31(
                                                                                extraout_var_07,
                                                                                u_var2,
                                                                            );
...
pub unsafe fn write_to_file_1028_d7a0(param_1: u16, param_2: u16, param_1_00: u32) -> i32 {
    let u_var1: u8;
    let extraout_AH: u8;
    let mut i_var2: i32;

    u_var1 = write_to_file_1008_7cac(ctx, param_1_00, 8);
...
pub fn write_to_file_1028_b5ec(in_struct_1: &mut Struct731, in_file_handle: &HFILE16) -> bool {
    let mut u_var1: u32;
    let b_var2: bool;
    let mut i_var3: i32;
    let mut unaff_ss: u16;
  ...
  //   i_var4 = in_struct_1;
    local_e = (in_struct_1 + 0xc);
    b_var2 = write_to_file_1008_7e1c(in_file_handle, &local_e, 2);
    if b_var2 == false {
        ctx.g_u16_1050_0310 = 0x6d0;
        return false;
    }
    i_var3 = write_to_file_1030_16d6(ctx, in_struct_1, in_file_handle);
    if i_var3 == 0 {
        return false;
    }
    local_8 = (in_struct_1 + 0xc);
    b_var2 = write_to_file_1008_7e1c(in_file_handle, CONCAT22(unaff_ss, &local_8), 2);
    if (b_var2 == 0) {
        ctx.g_u16_1050_0310 = 0x6d0;
        return 0;
    }
    local_8 = (in_struct_1 + 0xe);
    b_var2 = write_to_file_1008_7e1c(in_file_handle, CONCAT22(unaff_ss, &local_8), 2);
    if (b_var2 == 0) {
        ctx.g_u16_1050_0310 = 0x6d0;
        return 0;
    }
    local_8 = (in_struct_1 + 0x10);
    b_var2 = write_to_file_1008_7e1c(in_file_handle, CONCAT22(unaff_ss, &local_8), 2);
    if (b_var2 == 0) {
        ctx.g_u16_1050_0310 = 0x6d0;
        return 0;
    }
    local_8 = (in_struct_1 + 0x12);
    b_var2 = write_to_file_1008_7e1c(in_file_handle, CONCAT22(unaff_ss, &local_8), 2);
    if (b_var2 == 0) {
        ctx.g_u16_1050_0310 = 0x6d0;
        return 0;
    }
    local_8 = (in_struct_1 + 0x18);
    b_var2 = write_to_file_1008_7e1c(in_file_handle, CONCAT22(unaff_ss, &local_8), 2);
    if (b_var2 == 0) {
        ctx.g_u16_1050_0310 = 0x6d0;
        return 0;
    }
    local_8 = (in_struct_1 + 0x1a);
    b_var2 = write_to_file_1008_7e1c(in_file_handle, CONCAT22(unaff_ss, &local_8), 2);
    if (b_var2 == 0) {
        ctx.g_u16_1050_0310 = 0x6d0;
        return 0;
    }
    local_4 = (in_struct_1 + 0x12);
    if (local_4 == 6) {
        local_4 = (in_struct_1 + 0x18);
    }
    if (local_4 < 1) {
        return 1;
    }
    ...
    if (local_4 == 3 || (local_4 - 2) < 1) {
        local_8 = (in_struct_1 + 0x14);
    } else {
        if (local_4 == 4) {
            if ((in_struct_1 + 0x14) == 0) {
                local_8 = 0;
                b_var2 = write_to_file_1008_7e1c(in_file_handle, CONCAT22(unaff_ss, &local_8), 2);
                // goto joined_r0x1028b766;
            }
            u_var1 = (in_struct_1 + 0x14);
            local_8 = (u_var1 + 0x94);
        } else {
            if (local_4 != 5) {
                return 1;
...
pub unsafe fn write_file_fn_1028_2418(param_1: &mut FileObject, param_2: &HFILE16) -> bool {
    ...
    let mut local_e: u16;
    let mut local_c: u16;
    let mut local_a: Struct306 = Struct306::new();
...
pub unsafe fn file_write_fn_1028_0234(ctx: &mut AppContext, param_1: &mut Struct731, param_2: u32) -> bool {
    let mut u_var1: u32;
    let mut i_var2: i32;
    let b_var3: bool;
    let mut local_1a: u16;
    ...
    if i_var2 != 0 {
      ...
      //   local_bx_28 = param_1;
        ...
        b_var3 = write_to_file_1008_7e1c(param_2, &local_1a, 2);
        if b_var3 != false {
            pass1_1008_5784(CONCAT22(unaff_ss, local_a), param_1.field_0x22);
            u_var1 = param_1.field_0x22;
            local_14 = (u_var1 + 8);
            local_10 = local_14;
            b_var3 = write_to_file_1008_7e1c(param_2, &local_14, 2);
            while b_var3 != false {
                _local_e = pass1_1008_5b12(local_a);
                if _local_e == 0 {
                    return true;
                }
                local_14 = (_local_e + 4);
...
pub fn file_write_fn_1020_e94e(param_1: &mut Struct731, param_2: &HFILE16) -> bool {
    let b_var1: bool;
    let mut local_c: &mut StructuredData;

    b_var1 = write_to_file_1030_de7c(ctx, param_1, param_2);
    if b_var1 != false {
        local_c = &mut param_1.field_0x24;
        b_var1 = write_to_file_1008_7e1c(param_2, local_c.buffer.as_ref(), 2);
        if b_var1 == false {
            ctx.g_u16_1050_0310 = 0x6d0;
            return b_var1;
        }
...
pub unsafe fn call_write_to_file_1020_a644(param_1: u16, param_2: u16, param_1_00: u32) -> i32 {
    let u_var1: u8;
    let mut write_file_result: i32;
    let extraout_AH: u8;

    u_var1 = write_to_file_1008_7cac(ctx,param_1_00, 0xb);
...
pub fn write_to_file_1030_1a9c(
    ...
    i_var2 = write_to_file_1030_1978(ctx, param_1, param_2);
    if i_var2 != 0 {
      // u_var4 = (param_1  >> 0x10);
        i_var2 = param_1.field_0x0 as i32;
        local_c = param_1.field_0x10;
        b_var3 = write_to_file_1008_7e1c(param_2, CONCAT22(unaff_ss, &local_c), 2);
        if b_var3 != 0 {
            if (param_1 + 0x10) == 0 {
                return 1;
            }
            pi_var1 = (param_1 + 0x10);
