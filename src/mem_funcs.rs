...
pub fn free_mem_1000_0052(param_1: *mut u32) -> u32
{
    ...
    // let BVar5: bool;
    let mut BVar5: bool;
    // local_BX__1: *mut astruct_86;
    let mut local_BX__1: astruct_86;
...
// LAB_1000_00f9:
    ...
    return CONCAT22((iVar3 - local_BX__1.field_0x20) - (uVar2 < *puVar1), uVar2 - *puVar1);
}
...
// LAB_1000_016d:
                ...
                {
                    alloc_addr = alloc_mem_1000_03c6( * (s_version__d__d_1050_0012 + 8),
                                                            local_4, 0x0);
...

{
    ...
    else
    {
        ...
        while (true)
        {
            ...
            iVar3 = alloc_mem_1000_14f2((in_BX + 0x16) | 0x1000, lVar8, in_BX,
    ...
    *piVar2 = (*piVar2 - (lVar7 >> 0x10)) - (uVar4 < lVar7);
    ...
    if (uVar5 != 0)
    {
        ...
        uVar9 = 0xc;
        lVar8 = get_mem_sz_1000_1532(&g_alloc_addr_1050_1050);
        iVar3 = pass1_fn_1000_5390(lVar8 - 0x42,
                                   (lVar8 >> 0x10) - (lVar8 < 0x42), uVar9, uVar10);
...
{
    let local_AX__1: *mut astruct_125;
    let mut in_DX: i32;
    let mut in_BX: i32;
    astruct_125 **ppaVar1;
    let mut local_c: u16;
...
pub fn alloc_mem_1000_03c6(in_alloc_size: u32, param_2: u16, param_3: *mut astruct_93) -> *mut libc::c_void
{
    let puVar1: *mut u32;
    let piVar2: *mut i32;
    let mut uVar3: i32;
    ...
    let mut uVar5: u16;
    let mut in_DX: i32;
    let local_BX__1: *mut astruct_78;
    let mut unaff_CS: u16;
    let mut bVar6: bool;
    let mut alloc_addr: u32;
    ...
    uVar3 = in_alloc_size._2_2_ + (0xf000 < in_alloc_size) + param_3.field_0x20 +
            CARRY2(uVar3, pu_var1_val);
    puVar1 = &param_3.field_0x28;
    bVar6 = uVar3 < pu_var1_val;
    if ((bVar6) ||
        ((bVar6 || uVar3 == pu_var1_val &&
                       (puVar1 = &param_3.field_0x26, uVar4 < pu_var1_val || uVar4 == pu_var1_val))))
    {
        if (param_2 == 3)
        {
...
// ppuVar9: *mut *mut u8;
    ...
    let mut local_6: u16;
    let mut local_4: u16;
    let temp_5f5b47e88b: *mut astruct_88;
    ...
    if (in_AX != 0)
    {
        ...
        if ((bVar7 || uVar6 == pu_var1_val) && ((bVar7 || (uVar4 - uVar5 < temp_5f5b47e88b.field_0x22))))
        {
            bVar7 = false;
          // goto LAB_1000_0595;
        }
...
{
    let mut in_AL: u8;
    let local_BX__1: *mut astruct_82;
    let local_4: u8;
...
pub fn alloc_mem_1000_05e2(param_1: *mut astruct_89, param_2: u16, param_3: *mut astruct_144)

{
    ...
    let mut uVar4: i32;
    let mut iVar5: i32;
    let local_BX__1: *mut astruct_90;
    let mut unaff_CS: u16;
    let mut bVar6: bool;
    let pvVar7: *mut void;
    let lVar8: u32;
    ...
    while
    {
        ...
        let pu_var1_val = unsafe{*puVar1};
        uVar4 = uVar3 + pu_var1_val;
        uVar3 = iVar2 + (0xf000 < param_1 + 1) + local_BX__1.field_0x20 +
                CARRY2(uVar3, pu_var1_val);
        puVar1 = &local_BX__1.field_0x28;
        bVar6 = uVar3 < pu_var1_val;
        ((bVar6 || uVar3 == pu_var1_val) &&
              ((bVar6 || (puVar1 = &local_BX__1.field_0x26, uVar4 < pu_var1_val || uVar4 == pu_var1_val)))) &&
             ((lVar8 != 0 ||
               (iVar5 = invoke_error_handler_1000_1e61(unaff_CS, 2, local_BX__1), iVar5 != 0)))
    } {}
    return 0;
}
...
pub fn alloc_mem_1000_0670(uparam_1: i32, param_2: *mut i32) -> u16
{
    ...
    uVar7 = unsafe{*in_BX};
    uVar8 = -((param_1 & 1) != 0) & 0x100 | -((param_1 & 4) != 0) & 0x400 |
            (uVar7 + 0x16);
    if ((param_2._2_2_ | param_2) == 0)
    {
        iVar10 = alloc_mem_1000_14f2(uVar8 | 0x2000, in_AX + 0x14, iVar10, in_BX,
                                     &g_alloc_addr_1050_1050);
        if (iVar10 == 0)
        {
            return 0;
    ...
    else
    {
        ...
        while
        {
            lVar13 = alloc_mem_1000_1408(uVar8 | 0x2000, in_AX + 0x14, iVar10, in_BX,
                                         &g_alloc_addr_1050_1050);
...
pub fn alloc_mem_1000_0838(param_1: *mut astruct_142)

{
    ...
    let mut iVar5: i32;
    let mut uVar6: i32;
    let local_BX__1: *mut astruct_91;
    let piVar7: *mut i32;
    let mut unaff_CS: u16;
    let mut bVar8: bool;
    let pvVar9: *mut void;
    ...
    let temp_5f1305d326: *mut astruct_143;
...
// LAB_1000_085b:
        ...
        while (local_6 = uVar6, pvVar9 = alloc_mem_1000_03c6(local_6, 1, param_1),
               pvVar9 == 0)
        {
...
pub fn
alloc_mem_1000_0a48(uparam_1: i32, param_2: *mut astruct_89, param_3: u16,param_4: u32)

{
    let paVar1: *mut astruct_140;
    let mut uVar2: i32;
    let in_CX: *mut astruct_92;
    let mut uVar3: i32;
    let mut uVar4: u16;
    let local_DI_113: *mut astruct_140;
    let mut uVar5: u16;
    let mut unaff_CS: u16;
    let mut uVar6: u32;
    let mut local_6: u16;
...
pub fn
alloc_mem_1000_0b20(param_1: u16, param_2: *mut astruct_93, param_3: *mut astruct_92, param_4: u16)

{
    let puVar1: *mut u32;
    let mut uVar2: i32;
    let paVar3: *mut astruct_89;
    let mut uVar4: i32;
    let mut alloc_data: u16;
    let local_CX_30: *mut astruct_92;
    let paVar5: *mut astruct_89;
    let local_BX__1: *mut astruct_93;
    let mut uVar6: u16;
    let mut bVar7: bool;
    let mut uVar8: u32;
    let pvVar9: *mut void;
    ...
    loop
    {
        while
        {
            if ((paVar5 <= paVar3) && (pvVar9 = pass1_fn_1000_0c32(paVar5, 0x0, local_14), pvVar9 != 0))
            {
                ...
                if ((local_14 & 0x20) == 0)
                {
                    ...
                    unsafe {
                        ...
                        if ((bVar7 || uVar2 == *puVar1) &&
                            ((bVar7 || (puVar1 = &local_BX__1.field_0x26, uVar4 < *puVar1 || uVar4 == *puVar1))))
                        {
...
pub fn 
alloc_mem_1000_0ed4(uparam_1: i32, uparam_2: i32, uparam_3: i32, param_4: *mut u16, param_5: u16) -> libc::c_long
...

{
    ...
    if ((bVar1 & 7) != 0)
    {
        ...
        if (bVar4 != 2)
        {
            ...
            return CONCAT22((alloc_size >> 0x10) - (alloc_size < 0x14),
                            alloc_size - 0x14);
        }
    }
    uVar2 = (param_1 + -2);
...
pub fn alloc_mem_1000_1408(uparam_1: i32, uparam_2: i32, param_3: i32, param_4: u16_00, param_5: u16) -> SEGPTR
...
pub fn 
alloc_mem_1000_14f2(uparam_1: i32, uparam_2: i32, param_3: i32, param_4: u16, param_5: u16) -> u16
...
pub fn alloc_mem_1000_167a(param_1: u16, param_2: u16) -> *mut u8
{
    ...
    mem_buf = alloc_mem_1000_0a48(0, param_1, 0, _g_astruct_94_ptr_1, g_u16_ptr_1050_5f2e);
    return mem_buf;
}
...
pub fn 
alloc_mem_1000_1708(uparam_1: i32, uparam_2: i32, uparam_3: i32, uparam_4: i32, uparam_5: i32) -> u16
...

{
    ...
    uVar2 = alloc_mem_1000_0a48(0, param_1, 0, _g_astruct_94_ptr_1, g_u16_ptr_1050_5f2e);
    return uVar2;
}
...

{
    ...
    if (((g_u16_ptr_1050_5f2e | _g_astruct_94_ptr_1) == 0) &&
        (_g_astruct_94_ptr_1 = struct_fn_1000_160a(uVar1, 0), g_u16_ptr_1050_5f2e = puVar2, (puVar2 | _g_astruct_94_ptr_1) == 0))
    {
        return 0;
    }
    uVar1 = alloc_mem_1000_0a48(1, uVar1, 0, _g_astruct_94_ptr_1, g_u16_ptr_1050_5f2e);
    return uVar1;
}
...
pub fn  free_mem_1000_1b68(param_1: *mut astruct_98, param_2: u16) -> bool
...
pub fn  free_mem_1000_1b9a(param_1: u16, param_1_00: *mut astruct_99) -> bool

{
    ...
    let mut uVar4: i32;
    let mut uVar5: i32;
    let local_BX_5: *mut astruct_99;
    let local_SI_34: *mut astruct_100;
    let mut uVar6: u16;
    let mut local_c: u16;
    let mut local_a: u16;
    let mut local_8: u16;
...

{
    ...
    if ((*(in_BX + 2) & 4) == 0)
    {
        ...
        if (HVar5 != 0)
        {
            if ((HVar5 != handle) || (HVar5 = in_stack_00000000, dVar8 = GlobalSize16(handle), dVar8 == 0)) {}
              // goto LAB_1000_289a;
            in_AX = HVar5;
            if ((*(in_CX + 2) & 4) != 0)
            {
...
pub fn copy_mem_1008_4274(in_astruct_101: *mut astruct_101)

{
    let mut u_var1: u32;
    let in_AX: *mut astruct_102;
    let mut extraout_DX: u16;
    let mut extraout_DX_00: i32;
    let struct_a: *mut astruct_199;
    let mut extraout_DX_01: u16;
    let local_astruct_101: *mut astruct_101;
    ...
    uVar2 = (in_astruct_101 >> 0x10);
    local_astruct_101 = in_astruct_101;
    if (local_astruct_101.field_0x6 != 0)
    {
        get_mem_sz_1000_1284(local_astruct_101.field_0x6);
        a_struct_102 = in_AX;
        alloc_mem_1000_0a48(1, in_AX, extraout_DX, __g_astruct_94_ptr_1);
        _local_a = CONCAT22(extraout_DX_00, a_struct_102);
        struct_a = (extraout_DX_00 | a_struct_102);
        if (struct_a != 0x0)
        {
            uVar1 = local_astruct_101.field_0x6;
            hmemcpy16(CONCAT22(in_AX, 0x1000),
...
{
    let mut u_var1: u32;
    let local_AX__1: *mut astruct_111;
    let mut count: u32;
    let in_DX: *mut astruct_199;
    let mut uVar2: i32;
    let local_BX_4: *mut astruct_109;
    let local_BX_42: *mut astruct_110;
    let mut uvar3: u16;
    let mut uVar4: u16;
    let mut local_c: u16;
    let mut local_6: u16;
    ...
    else
    {
        ...
        uVar4 = (uVar1 >> 0x10);
        local_BX_42 = uVar1;
        pass1_1008_6604(CONCAT22(in_DX, local_AX__1), local_BX_42.field_0x8, local_BX_42.field_0x4);
    }
    ...
    hmemcpy16(CONCAT22(count, 0x1000),
...
pub fn alloc_mem_1008_909c(in_struct_1: *mut astruct_210)

{
    ...
    else
    {
        ...
        g_u16_ptr_1050_5f2e =
            ((iVar3 + 0x14) + (iVar3 + 0x18) + CARRY2(uVar2, pu_var1_val));
    }
    ...
    if ((iVar3 + 6) == 0)
    {
        ...
        {
            _g_astruct_94_ptr_1 = local_AX_23;
            struct_fn_1000_160a();
        }
        else
        {
        ...
        uVar2 = local_AX_23 << 2;
        alloc_mem_1000_1708(uVar2, 0, 1, _g_astruct_94_ptr_1, g_u16_ptr_1050_5f2e);
    }
    else
    {
        uVar2 = local_AX_23 * 4;
        alloc_mem_1000_0ed4(1, uVar2, (g_u16_ptr_1050_5f2e * 2 + CARRY2(local_AX_23, local_AX_23)) * 2 + CARRY2(local_AX_23 * 2, local_AX_23 * 2),
                            (iVar3 + 6));
