...

{
  ...
  let mut pa_var4 = (param_2 * 0x4);
  let u_var6 = (param_1 >> 0x10);
  let i_var5 = param_1;
  let pu_stack6 = (&pa_var4.field_0x0 + i_var5);
  if pu_stack6 != 0x0 {
    return pu_stack6;
  }
  if false {
  ...
  0x1 => {
      ...
      pu_var3 = (param_4 | pa_var4);
      if pu_var3.is_null() {
//LAB_1010_2126:
          pa_var4 = 0x0;
          //TODO: pu_var3 = 0x0;
      } else {
          struct_1010_3b7a(pa_var4, param_2);
      }
  ...
  0x2 => {
      ...
      // goto
      // LAB_1010_2126
      win_sys_op_1010_5404(pa_var4, param_4, param_2, param_3);
  ...
  0x3 => {
      ...
      // goto
      // LAB_1010_2126
      struct_1010_a1d8(pa_var4, param_4, param_2, param_3);
  ...
  0x4 => {
      ...
      // goto
      // LAB_1010_2126
      struct_1018_2b10(CONCAT22(param_4, pa_var4), param_2, param_3);

  }
  0x5 => {
      mem_op_1000_179c(ctx, 0x14, param_4, 0x1000);
      if ((param_4 | pa_var4) == 0x0) {}
      // goto
      // LAB_1010_2126
      pu_var9 = pass1_1008_eabc(pa_var4, param_4, param_2);
  ...
  0x6 => {
      ...
      // goto
      // LAB_1010_2126
      pass1_1018_18b8(param_3, CONCAT22(param_4, pa_var4), param_2);
  ...
  0x7 => {
      ...
      // goto
      // LAB_1010_2126
      u_var11 = pass1_1010_3d82(ctx, pa_var4, param_4, param_2, param_3);
  ...
  0x8 => {
      ...
      // goto
      // LAB_1010_2126
      struct_1010_95aa(pa_var4, param_4, param_2);
  ...
  0x9 => {
      ...
      // goto
      // LAB_1010_2126
      struct_1010_6326(pa_var4, param_4, param_2);
  ...
  0xa => {
      ...
      // goto
      // LAB_1010_2126
      u_var11 = pass1_1010_0eac(pa_var4, param_4, param_2,
                                (param_4 | pa_var4), param_3);
      pu_var3 = (u_var11 >> 0x10);
      pa_var4 = u_var11;
  ...
  0xb => {
      ...
      // goto
      // LAB_1010_2126
      u_var11 = pass1_1008_aefe(pa_var4, param_4, param_2,
                                (param_4 | pa_var4), param_3);
      pu_var3 = (u_var11 >> 0x10);
      pa_var4 = u_var11;
  ...
  0xc | 0xd | 0xe | 0xf | 0x10 | 0x11 | 0x12 | 0x13 | 0x14 | 0x15 | 0x16 | 0x17 | 0x18 | 0x19 | 0x1a | 0x1b | 0x1c | 0x1d | 0x1e | 0x1f | 0x20 | 0x21 | 0x22 | 0x23 | 0x24 => {
      ...
      // goto
      // LAB_1010_2126
      struct_1018_0570(CONCAT22(param_4, pa_var4), param_2, param_3);
  ...
  0x25 => {
      ...
      // goto
      // LAB_1010_2126
      pass1_1018_4aaa(pa_var4, param_4, param_2, pu_var3, param_3);
  ...
  0x26 => {
      ...
      // goto
      // LAB_1010_2126
      pass1_1008_d99e(pa_var4, param_4, param_2, pu_var3, param_3);
  ...
  0x27 => {
      ...
      // goto
      // LAB_1010_2126
      pass1_1008_9d36(pa_var4, param_4, param_2, param_3);
  ...
  0x28 => {
      ...
      // goto
      // LAB_1010_2126
      pass1_1010_28e6(pa_var4, param_4, param_2, pu_var3, param_3);
  ...
  0x29 => {
      ...
      // goto
      // LAB_1010_2126
      struct_1018_229c(pa_var4, param_4, param_2, pu_var3, param_3);
  ...
  0x2a => {
      ...
      // goto
      // LAB_1010_2126
      pass1_1010_503e(pa_var4, param_4, param_2, pu_var3, param_3);
  ...
  0x2b => {
      ...
      // goto
      // LAB_1010_2126
      struct_1010_02e0(ctx, pa_var4, param_2, 0);
  ...
  0x2c => {
      ...
      // goto
      // LAB_1010_2126
      pass1_1008_eb2a(pa_var4, param_4, param_2);
  ...
  0x2d => {
      ...
      // goto
      // LAB_1010_2126
      pass1_1010_3e3c(CONCAT22(param_4, pa_var4), param_2, param_3);
  ...
  0x2e => {
      ...
      // goto
      // LAB_1010_2126
      u_var11 = pass1_1018_1ff4(pa_var4, param_4, param_2);
      pu_var3 = (u_var11 >> 0x10);
      pa_var4 = u_var11;
  ...
  0x2f => {
      ...
      // goto
      // LAB_1010_2126
      struct_1010_e9e4(pa_var4, param_4, param_2);
  ...
  0x30 => {
      ...
      // goto
      // LAB_1010_2126
      pu_var8 = pass1_1010_3702(pa_var4, param_4, param_2);
...
//LAB_1010_2680:
          ...
          u_var11 = pass1_1010_9298(pa_var4, param_4, param_2,
                                    pa_var4, (param_4 | pa_var4),
                                    param_3);
          pu_var3 = (u_var11 >> 0x10);
          pa_var4 = u_var11;
      }
//     TODO: // goto // LAB_1010_2683
  ...
  0x32 => {
      ...
      // goto
      // LAB_1010_2126
      pass1_1010_6abc(pa_var4, param_4, param_2);
  }
  0x33 => {
      mem_op_1000_179c(ctx, 0x72, param_4, 0x1000);
      if ((param_4 | pa_var4) == 0x0) {
//LAB_1010_25b8:
          ...
          u_var10 = pass1_1010_195e(pa_var4, param_4, param_2);
          u_var7 = (u_var10 >> 0x10);
          u_var2 = u_var10;
      }
//     TODO: // goto // LAB_1010_25bb
  ...
  0x34 => {
      ...
      // goto
      // LAB_1010_25b8
      u_var11 = pass1_1010_1b6e(pa_var4, param_4, param_2, param_3,
                                (param_4 | pa_var4));
      u_var7 = (u_var11 >> 0x10);
      u_var2 = u_var11;
//LAB_1010_25bb:
...
//     TODO: // goto switchD_1010_2765_caseD_38;
  ...
  0x35 => {
      ...
      // goto
      // LAB_1010_2126
      u_var11 = pass1_1010_6700(pa_var4, param_4, param_2);
      pu_var3 = (u_var11 >> 0x10);
      pa_var4 = u_var11;
  }
  0x36 => {
      ...
      // goto
      // LAB_1010_2126
      pass1_1008_d790(pa_var4, param_4, param_2, param_3);
  }
  0x37 => {
      ...
      // goto
      // LAB_1010_2126
      struct_1008_9fd2(pa_var4, param_4, param_2);
      // break;
      // default:
//     TODO: // goto switchD_1010_2765_caseD_38;
}
  0x39 => {
      ...
      // goto
      // LAB_1010_2126
      pass1_1010_4a8a(pa_var4, param_4, param_2, param_3);
  }
  0x3a => {
      ...
      // goto
      // LAB_1010_2126
      pu_var8 = pass1_1008_d72e(pa_var4, param_4, param_2);
      pu_var3 = (pu_var8 >> 0x10);
      pa_var4 = pu_var8;
  }
  0x3b => {
      ...
      // goto
      // LAB_1010_2126
      struct_1008_dd4e(pa_var4, param_4, param_2);
  }
  0x3c => {
      ...
      // goto
      // LAB_1010_2126
      pass1_1018_331c(pa_var4, param_4, param_2, param_3, pu_var3);
  }
  0x3d => {
      mem_op_1000_179c(ctx, 0xe, param_4, 0x1000);
      if ((param_4 | pa_var4) == 0x0)
      // goto
      // LAB_1010_2126
      u_var11 = pass1_1010_8c32(pa_var4, param_4, param_2, param_3);
      pu_var3 = (u_var11 >> 0x10);
      pa_var4 = u_var11;
  }
  0x3e => {
      ...
      // goto
      // LAB_1010_2126
      pass1_1018_5070(pa_var4, param_4, param_2);
  }
  0x3f => {
      ...
      // goto
      // LAB_1010_2126
      pass1_1008_c72a(pa_var4, param_4, param_2);
  }
  0x40 => {
      ...
      // goto
      // LAB_1010_2126
      pass1_1008_af94(pa_var4, param_4, param_2);
  }
  0x41 => {
      uVar2 = 0x60;
      mem_op_1000_179c(ctx, 0x60, param_4, 0x1000);
      ...
      // LAB_1010_2680
      u_var7 = 0x1008;
      struct_1008_ecb2(pa_var4, param_4, param_2);
      pu_var3 = extraout_dx;
//LAB_1010_2683:
      *(astruct_636 * *)(param_2 * 0x4 + i_var5) = pa_var4;
      (param_2 * 0x4 + i_var5 + 0x2) = pu_var3;
      ppc_var1 = (pa_var4 + 0x10);
      (**ppc_var1)(u_var7, pa_var4, pu_var3, u_var2);
  }
  0x42 => {
      mem_op_1000_179c(ctx, 0xc, param_4, 0x1000);
      if ((param_4 | pa_var4) == 0x0) {}
      // goto
      // LAB_1010_2126
      pu_var8 = pass1_1008_ec10(pa_var4, param_4, param_2);
      pu_var3 = (pu_var8 >> 0x10);
      pa_var4 = pu_var8;
  ...
  0x43 => {
      ...
      // goto
      // LAB_1010_2126
      pu_var8 = pass1_1010_2bfc(pa_var4, param_4, param_2);
      pu_var3 = (pu_var8 >> 0x10);
      pa_var4 = pu_var8;
  ...
  0x45 => {
      ...
      // goto
      // LAB_1010_2126
      u_var11 = pass1_1010_0000(pa_var4, param_2, param_3);
      pu_var3 = (u_var11 >> 0x10);
      pa_var4 = u_var11;
  ...
  0x46 => {
      ...
      // goto
      // LAB_1010_2126
      struct_1010_50b2(pa_var4, param_4, param_2);
  ...
  0x47 => {
      ...
      // goto
      // LAB_1010_2126
      pu_var8 = pass1_1018_56e6(pa_var4, param_4, param_2);
      pu_var3 = (pu_var8 >> 0x10);
      pa_var4 = pu_var8;
  ...
  0x48 => {
      ...
      // // goto
      // // LAB_1010_2126
      unk_draw_op_1008_da12(ctx, pa_var4, param_4, param_2);
  }
      _ => {}
  }
  pu_stack6 = CONCAT22(pu_var3, pa_var4);
