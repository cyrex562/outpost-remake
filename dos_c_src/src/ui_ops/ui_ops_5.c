    ...
    else
    {
        if(((0x0 < param_2 + -0x3) && (!SBORROW2(param_2 + -0x3, 0x1))) && (param_2 + -0x4 < 0x4))
        {
            ...
            if(BVar3 == 0x0)
            {
                ...
                {
                    InvalidateRect16((HWND16)LAST_SEGMENT, (RECT16 *)0x0, 0x0);
                    ...
                    if((u_var2 + 0x7a) != 0x0)
                    {
                        u_var2          = iVar5->field_0x2c;
                        (u_var2 + 0x7a) = 0x0;
                        SendMessage16((HWND16)LAST_SEGMENT, 0x0, 0x0, 0x1110131);
                        return;
                    }
                }
            }
...

{
    ...
    if(param_2 != 0x12b)
    {
        ...
        if(param_2 < 0x12c)
        {
            if(param_2 == 0x6f)
            {
                paVar5 = unk_io_op_1010_830a(globals->_PTR_LOOP_1050_14cc, 0x1f8, param_4);
                hwnd_var2 = WinHelp16(SEG_1010,0x0029, 0x0, CONCAT22(paVar5, 0x1)); //  (s_New_failed_in_Op__Op_1050_0020 + 0x9)
                return hwnd_var2;
            }
            if(param_2 == 0xeb)
            {
                ...
                {
                LAB_1020_6a6f:
                    win_ui_fn_1020_6e98(param_1, (HWND16)LAST_SEGMENT, param_4);
                    return hwnd_var2;
                }
            }
            else
            {
                ...
                else
                {
                    ...
                    LAB_1020_69c3:
                        hwnd_var2
                          = PostMessage16(param_3, 0x0, 0x0, CONCAT22(0x112, uVar6));
                        return hwnd_var2;
                    }
                }
            }
                ...
                else
                {
                    ...
                    else
                    {
                        ...
                        if(hwnd_var2 == 0x0)
                        {
                            ...
                            if(hwnd_var2 != 0x0)
                            {
                                hwnd_var2 = DestroyWindow16((HWND16)LAST_SEGMENT);
                                return hwnd_var2;
                            }
                            goto LAB_1020_6a6f;
                        }
...

{
    ...
    if(param_4 == 0x1797)
    {
        ...
        if(HStack4 != 0x0)
        {
            ...
            {
                hwnd    = (HWND16)LAST_SEGMENT;
                uStack8 = SendMessage16((HWND16)LAST_SEGMENT, 0x0, 0x0, 0x4090000);
                if(uStack8 != -0x1)
                {
                    HVar6  = HStack4;
                    LVar5  = SendMessage16((HWND16)LAST_SEGMENT, local_58, param_6, CONCAT22(0x40a, uStack8));
                    pu_var2 = local_58;
...

{
    ...
    window_handle = GetDlgItem16((HWND16)LAST_SEGMENT, 0x1797);
    ...
    {
        window_handle = CreateWindow16(SEG_1018, window_name, CONCAT22(globals->PTR_LOOP_1050_038c, window_name), 0x1797, (iVar5 + 0x8), iStack4 + -0x19, IStack6, 0x0, 0x0, 0x103, 0x40a0);
        p_var2        = window_name;
        if(window_handle == 0x0)
        {
            if((window_name | window_name) != 0x0)
        ...
        else
        {
            ...
            if((window_name + 0x4) == 0x0)
            {
                ...
                SendMessage16(SEG_1010, pcVar8, (WPARAM16)(pcVar8 >> 0x10), CONCAT22(uVar10, uVar9));
            }
            else
            {
                iStack36 = 0x0;
                while(true)
                {
                    ...
                    LVar7    = SendMessage16((HWND16)LAST_SEGMENT, uVar3, WVar4, CONCAT22(uVar10, uVar9));
                    WVar4    = (WPARAM16)(LVar7 >> 0x10);
            ...
            LVar7 = SendMessage16(SEG_1018, uVar3, WVar4, CONCAT22(uVar10, uVar9));
            iVar5 = LVar7;
            if((iVar5 != -0x1) || ((LVar7 >> 0x10) != -0x1))
            {
                SendMessage16((HWND16)LAST_SEGMENT, 0x0, 0x0, CONCAT22(0x407, iVar5));
                SendMessage16((HWND16)LAST_SEGMENT, 0x0, 0x0, CONCAT22(0x418, iVar5));
            }
            p_var2        = window_name;
            window_handle = (HWND16)LAST_SEGMENT;
...

{
    ...
    *param_1        = addr_table_1020_754c;//0x754c;
    (iVar8 + 0x2)   = SEG_1020;
    puVar13         = mixed_1010_20ba(NULL, globals->_PTR_LOOP_1050_0ed0, 0x4, param_3, in_DX, unaff_DI);
    uVar6           = (puVar13 >> 0x10);
    (iVar8 + 0x1c)  = puVar13;
    (iVar8 + 0x1e)  = uVar6;
    ...
    *(HDC16 *)(uVar3 + 0x178) = local_4;
    ...
    puVar13 = mixed_1010_20ba(NULL, globals->_PTR_LOOP_1050_0ed0, 0x29, param_3, extraout_DX, unaff_DI);
    puVar7  = (puVar13 >> 0x10);
...

{
    ...
    if(iVar1 == 0x3)
    {
        ...
        uVar8  = 0x0;
        uVar5  = 0x0;
        puVar6 = mixed_1010_20ba(NULL, globals->_PTR_LOOP_1050_0ed0, 0x47, unaff_SS, in_DX, unaff_DI);
...

{
    ...
    if(uVar7 == 0x0)
    {
        if((iVar10 + 0xfe) == 0x0)
        {
            mem_op_1000_179c(0xfc, param_5, SEG_1000);
    ...
    else
    {
        if(param_4 == 0x2)
        {
            ...
            puVar13 = mixed_1010_20ba(
              NULL, globals->_PTR_LOOP_1050_0ed0, uVar4, unaff_SS, param_5, unaff_DI);
            puVar9  = (puVar13 >> 0x10);
            ...
            if(uVar5 == 0x0)
            {
                ...
                *pi_var1 = *pi_var1 + 0x1;
                ...
                uVar12  = 0xfe;
                UVar6   = u_var2;
                mem_op_1000_179c(0xfe, puVar9, SEG_1000);
                puVar8 = (puVar9 | UVar6);
                if(puVar8 == 0x0)
                {
                    UVar6  = 0x0;
            ...
            iVar10  = 0x4;
            puVar13 = mixed_1010_20ba(
              NULL, globals->_PTR_LOOP_1050_0ed0, 0x2b, unaff_SS, puVar9, unaff_DI);
...

{
    ...
    pu_stack6 = mixed_1010_20ba(
      NULL, globals->_PTR_LOOP_1050_0ed0, 0x2f, param_3, in_DX, unaff_DI);
...

{
    ...
    if((in_DX | param_3) != 0x0)
    {
        ...
        while(true)
        {
            ...
            {
                BVar2 = PtInRect16((RECT16 *)SEG_1008, *param_2);
                if(BVar2 != 0x0)
                {
                    return;
                }
...

{
    ...
    LAB_1020_5942:
                    ...
                    if((puStack26 == 0xb) || (puStack26 == 0x37))
                    {
                        ...
                        if((uVar5 | uStack46) != 0x0)
                        {
                            ...
                            puStack38 = mixed_1010_20ba(
                              NULL, globals->_PTR_LOOP_1050_0ed0, 0x2f, param_6, puVar6, unaff_DI);
        ...
        if(BVar4 == 0x0)
            goto LAB_1020_5a16;
        rect     = (RECT16 *)SEG_1010;
        uStack18 = mixed_1010_20ba(NULL, globals->_PTR_LOOP_1050_0ed0, 0x2, param_6, uStack30, unaff_DI);
        if((uStack18 + 0x72) != 0x0)
        {
            ...
            (**ppcVar1)(SEG_1010, globals->_PTR_LOOP_1050_02a0, (_PTR_LOOP_1050_02a0 >> 0x10), 0x10, iVar7, uVar9, uVar10, puVar6);
            puVar12 = pass1_1008_941a(CONCAT22(param_6, local_18), 0x1, 0x86);
            msg     = local_18;
            rect    = (RECT16 *)SEG_1008;
...

{
    ...
    if(u_var2 != 0x0)
    {
        ...
        instance = (RECT16 *)LAST_SEGMENT;
        uVar8    = uStack10;
        BVar3    = PtInRect16(unaff_CS, (POINT16)CONCAT22(HStack4, local_6));
        if(BVar3 != 0x0)
        {
            PostMessage16((HWND16)LAST_SEGMENT, 0x0, 0x0, 0x1110131);
            return 0x1;
        }
    }
    ...
    TrackPopupMenu16((HMENU16)LAST_SEGMENT, 0x0, 0x0, iVar5->field_0x8, 0x0, local_10.y, (RECT16 *)local_10.x);
    return 0x1;
}
...

{
    ...
    local_6          = param_3;
    uStack4          = param_2;
    puVar6           = mixed_1010_20ba(NULL, globals->_PTR_LOOP_1050_0ed0, 0x47, param_4, in_DX, unaff_DI);
    uVar4            = (puVar6 >> 0x10);
    puVar3           = &local_6;
    ...
    else
    {
        ...
        if(puVar4 == 0x6b6)
        {
            load_string_1010_84e0(
              SEG_1010, globals->PCHAR_1050_14cc, 0x3ff, local_aa, (short)unaff_SS);
            load_string_1010_84e0(
              SEG_1010, globals->PCHAR_1050_14cc, 0x3ff, local_1aa, (short)unaff_SS);
            uVar6  = sys_1000_3f9c(local_2aa, unaff_SS, local_1aa, unaff_SS, globals->PTR_LOOP_1050_50cc, &stack0xfffe, uVar11, SEG_1000, unaff_SS, in_AF);
            uVar12 = SEG_1000;
            mem_op_1000_179c(0xb4, puVar7, SEG_1000);
        ...
        if(puVar4 < 0x6a7)
        {
            if(((iVar9 + 0x10c) == 0x78) || ((iVar9 + 0x10c) == 0x74))
            {
                ...
                local_2aa[0] = mixed_1010_20ba(
                  NULL, globals->_PTR_LOOP_1050_0ed0, 0x5, unaff_SS, puVar7, unaff_DI);
            ...
            if(((((iVar9 + 0x10c) == 0x6c) || ((iVar9 + 0x10c) == 0x6d)) || ((iVar9 + 0x10c) == 0x31)) || ((iVar9 + 0x10c) == 0x32))
            {
                uVar13       = SEG_1010;
                local_2aa[0] = mixed_1010_20ba(
                  NULL, globals->_PTR_LOOP_1050_0ed0, 0x3a, unaff_SS, puVar7, unaff_DI);
                if((local_2aa[0] + 0xa) == 0x0)
                {
                    return;
                }
...

{
    ...
    if((iVar10 + 0x106) != 0x0)
    {
        ...
        {
            pu_stack6        = mixed_1010_20ba(NULL, globals->_PTR_LOOP_1050_0ed0, 0x3, param_6, in_DX, unaff_DI);
            uVar1           = (iVar10 + 0x108);
            uStack8         = (uVar1 + 0x2e);
            uVar1           = (iVar10 + 0x108);
            uVar11          = (uVar1 >> 0x10);
            ...
            if(BVar4 != 0x0)
            {
                uStack296 = load_string_1010_847e(_PTR_LOOP_1050_14cc, (u16)(_PTR_LOOP_1050_14cc >> 0x10), SEG_1010);
        ...
        else
        {
            if(param_3 == 0x3)
            {
                ...
                puStack304   = mixed_1010_20ba(
                  NULL, globals->_PTR_LOOP_1050_0ed0, 0x2f, param_6, in_DX, unaff_DI);
...

{
    ...
    if(param_2 < 0xea)
    {
        ...
        case 0x77:
            ...
            WinHelp16(SEG_1010, uStack26, CONCAT11((undefined)(uStack26 >> 0xf), (uStack26 >> 0xf)), CONCAT22(paStack18, 0x1));
            return;
        case 0x78:
            puVar13    = mixed_1010_20ba(
              NULL, globals->_PTR_LOOP_1050_0ed0, 0x45, param_6, param_3, unaff_DI);
        ...
        if(param_2 < 0x103)
        {
            ...
            case 0xfb:
                local_144 = mixed_1010_20ba(
                  NULL, globals->_PTR_LOOP_1050_0ed0, 0x3, param_6, param_3, unaff_DI);
            ...
            case 0x101:
                uStack26       = mixed_1010_20ba(
                  NULL, globals->_PTR_LOOP_1050_0ed0, 0x2f, param_6, param_3, unaff_DI);
                ...
                uVar12    = pass1_1038_af40(_PTR_LOOP_1050_5b7c, (uVar9 + 0x8), 0xe, puVar7, uVar9, SEG_1038, param_6);
                paStack18 = (Struct43 *)mixed_1010_20ba(
                  NULL, globals->_PTR_LOOP_1050_0ed0, 0x43, param_6, (uVar12 >> 0x10), unaff_DI);
            ...
            if(param_2 != 0x106)
            {
                if(param_2 < 0x107)
                {
                    if(param_2 == 0x103)
                    {
                        ...
                        if(uStack34 != 0x0)
                        {
                            uVar12    = pass1_1038_af40(_PTR_LOOP_1050_5b7c, (uVar9 + 0x8), 0xf, puStack32, uVar9, SEG_1038, param_6);
                        ...
                        uVar16 = 0x0;
                        mem_op_1000_179c(0xb4, puStack32, SEG_1000);
    ...
    LAB_1020_49b7:
        pass1_1038_af40(_PTR_LOOP_1050_5b7c, (uVar9 + 0x8), iVar4, param_3, uVar9, SEG_1038, param_6);
        return;
    }
    if(param_2 == 0x1c8)
    {
    ...
    if(0x1c8 < param_2)
    {
        if(param_2 == 0x1ca)
        {
            ...
            local_13c = mixed_1010_20ba(
              NULL, globals->_PTR_LOOP_1050_0ed0, 0x30, param_6, (uVar10 | uVar19), unaff_DI);
...
//    iVar8                      = param_1;
    ...
    *(HICON16 *)(param_1 + 0xc2) = icon_handle_1;
    ...
    puVar6 = extraout_DX;
    mem_op_1000_179c(0x22, extraout_DX, SEG_1000);
    ...
    {
        load_draw_op_1020_2ede(CONCAT22(puVar6, icon_handle_1), param_1, SEG_1000);
...
//    iVar1                         = (Struct12 *)in_struct_1;
    ...
    SelectObject16((HDC16)LAST_SEGMENT, in_struct_1->field_0x1e);
    DeleteObject16((HGDIOBJ16)LAST_SEGMENT);
    SelectPalette16((HDC16)LAST_SEGMENT, 0x0, in_struct_1->field_0x20);
    DeleteObject16((HGDIOBJ16)LAST_SEGMENT);
...

{
    ...
    uVar6   = (u_stack6 >> 0x10);
    GetWindowText16(SEG_1018, 0x3ff, (u16)local_406);
    pcVar4       = pass1_1000_472c(CONCAT22(param_3, local_406), ':');
    puStack1034  = CONCAT22(uVar6, pcVar4 + 0x2);
    *puStack1034 = 0x0;
    load_string_1010_84e0(SEG_1010, globals->PCHAR_1050_14cc, 0x3ff, local_406, param_3);
    ppcVar2 = ((iVar7 + 0x18) + 0x18);
    (**ppcVar2)();
    uVar3 = (iVar7 + 0x8);
    iVar1 = (uVar3 + 0x4a);
    uVar3 = (u_stack6 + 0x2);
    SetDlgItemText16(SEG_1010, (u16)uVar3, (SEGPTR)(uVar3 >> 0x10));
    uVar3 = (u_stack6 + 0xa);
    SetDlgItemText16((HWND16)LAST_SEGMENT, (u16)uVar3, (SEGPTR)(uVar3 >> 0x10));
    uVar3 = (u_stack6 + 0x12);
    SetDlgItemText16((HWND16)LAST_SEGMENT, (u16)uVar3, (SEGPTR)(uVar3 >> 0x10));
    uVar3 = (u_stack6 + 0xe);
    SetDlgItemText16((HWND16)LAST_SEGMENT, (u16)uVar3, (SEGPTR)(uVar3 >> 0x10));
...
LAB_1020_3846:
    ...
    if((iVar7 + 0x1c) != 0x0)
    {
        GetDlgItem16((HWND16)LAST_SEGMENT, (u_stack6 + 0x1a));
        SetFocus16((HWND16)LAST_SEGMENT);
        return;
    }
    InvalidateRect16((HWND16)LAST_SEGMENT, (RECT16 *)0x0, 0x0);
...

{
    ...
    uVar12 = (param_1 >> 0x10);
    create_window_ex_1008_9760(param_1, SEG_1008);
    puVar10         = mixed_1010_20ba(NULL, globals->_PTR_LOOP_1050_0ed0, 0x6, unaff_SS, in_DX, unaff_DI);
    uVar5           = (puVar10 >> 0x10);
    (uVar11 + 0xfa) = puVar10;
    (uVar11 + 0xfc) = uVar5;
    ...
    mem_op_1000_179c(0x20, puVar7, SEG_1000);
    ...
    HVar9 = SEG_1000;
    mem_op_1000_179c(0x42, puVar7, SEG_1000);
    uVar8 = puVar7 | paVar3;
    if(uVar8 == 0x0)
    {
        (uVar11 + 0x106) = 0x0;
    ...
    HVar9  = SEG_1000;
    mem_op_1000_179c(0x8e, puVar7, SEG_1000);
    u_var2 = puVar7 | uVar8;
    if(u_var2 == 0x0)
    {
        (uVar11 + 0x10a) = 0x0;
    ...
    if(((uVar11 + 0x10c) | (uVar11 + 0x10a)) != 0x0)
    {
        ...
        SetWindowPos16((HWND16)LAST_SEGMENT, 0x44, iStack12, iStack14, local_12.y, local_a.x, 0x0);
    }
    return;
}
