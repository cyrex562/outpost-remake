void __stdcall16far unk_win_op_1020_65cc(astruct_60 *param_1, i16 param_2, u16 param_3)

{
    ...
    if(param_2 == 0x2)
    {
        for(iStack4 = 0x0; iStack4 < 0x5; iStack4 = iStack4 + 0x1)
        {
            ...
            {
                ppcVar1 = (**(undefined4 **)(iVar4 + iVar6) + 0x4);
    ...
    else
    {
        if(((0x0 < param_2 + -0x3) && (!SBORROW2(param_2 + -0x3, 0x1))) && (param_2 + -0x4 < 0x4))
        {
            ...
            if(BVar3 == 0x0)
            {
                ...
                if((BVar3 == 0x0) && (uVar2 = iVar5->field_0x14, (uVar2 + 0x24) != 0x0))
                {
...
void __stdcall16far unk_win_ui_op_1020_67ce(astruct_20 *in_struct_1, u16 param_2, u32 param_3)

{
    ...
    struct_1020_790e(&in_struct_1->field_0x0, s_TPPOPMENU_1050_43fa, param_2, param_3, unaff_SS);
    ...
    unk_str_op_1000_3d3e((in_struct_1 & 0xffff0000 | ZEXT24(&iVar3->field_0x5b)), s_VrMode2_1050_4404);
...
void __stdcall16far pass1_1020_687c(u32 param_1, u16 param_2, u16 param_3)
...
u16 __stdcall16far unk_destroy_win_op_1020_694c(u32 param_1, u16 param_2, HWND16 param_3, u16 param_4)
    ...
    if(param_2 != 0x12b)
    {
        ...
        if(param_2 < 0x12c)
        {
            if(param_2 == 0x6f)
            {
                ...
                uVar2  = WinHelp16(0x1010, (LPCSTR)(s_New_failed_in_Op__Op_1050_0020 + 0x9), 0x0, CONCAT22(paVar5, 0x1));
                return uVar2;
            }
            if(param_2 == 0xeb)
            {
...
void __stdcall16far win_ui_op_1020_6ae6(u32 *param_1, u16 param_2, i16 param_3, i16 param_4, HWND16 param_5, WPARAM16 param_6)
    ...
    if(param_4 == 0x1797)
    {
        ...
        if(HStack4 != 0x0)
        {
            if(param_3 == 0x2)
            {
                ...
                {
                    HVar6  = HStack4;
                    LVar5  = SendMessage16((HWND16)s_tile2_bmp_1050_1538, local_58, param_6, CONCAT22(0x40a, uStack8));
                    puVar2 = local_58;
                    pass1_1018_30ca(*(iVar3 + 0xf2), CONCAT22(param_6, puVar2), (LVar5 >> 0x10));
                    hwnd = 0x1018;
...
void __stdcall16far enable_menu_item_1020_6b9a(HMENU16 param_1, i16 param_2)
...
void __stdcall16far pass1_1020_6bbc(u32 param_1, u16 param_2, u16 param_3)
...
void __stdcall16far win_ui_fn_1020_6e98(undefined4 param_1, HWND16 in_win_handle, u16 param_3)

{
    ...
    {
        window_handle = CreateWindow16((LPCSTR)0x1018, (LPCSTR)window_name, CONCAT22(PTR_LOOP_1050_038c, window_name._2_2_), 0x1797, (iVar5 + 0x8), iStack4 + -0x19, IStack6, 0x0, 0x0, 0x103, 0x40a0);
        paVar2        = window_name;
        if(window_handle == 0x0)
        {
        ...
        else
        {
            ...
            if((window_name + 0x4) == 0x0)
            {
                uVar9  = 0x0;
                uVar10 = 0x401;
                pcVar8 = load_string_1010_847e(_PTR_LOOP_1050_14cc, (i1616)(_PTR_LOOP_1050_14cc >> 0x10), 0x1010);
...
astruct_3 *__stdcall16far pass1_1020_70c0(astruct_3 *param_1, byte param_2, u16 param_3)
...
void __stdcall16far unk_win_ui_op_1020_717e(u16 *param_1, u32 param_2, u16 param_3)

{
    ...
    *(HDC16 *)(uVar3 + 0x178) = local_4;
    ...
    pass1_1008_4d84((astruct_90 *)(puVar5 & 0xffff | ZEXT24(extraout_DX) << 0x10), paVar1, puVar7);
    HVar4                         = palette_op_1008_4e08(paVar1, &local_4, puVar7, 0x1008);
    *(HPALETTE16 *)(iVar8 + 0x20) = HVar4;
    return;
}

void __stdcall16far pass1_1020_51c6(u32 param_1, u16 param_2, u32 param_3, u16 param_4, u16 param_5)

{
    ...
    if(iVar2 != 0x0)
    {
        pt_in_rect_op_1020_58ce(param_1 & 0xffff | uVar4 << 0x10, param_2, uVar5, (byte)(param_3 >> 0x10), param_4, param_5);
        if(iVar2 == 0x0)
        {
...
void __stdcall16far win_ui_cursor_op_1020_522e(astruct_52 *param_1, u16 param_2, u16 param_3)
...
void __stdcall16far pass1_1020_52de(u32 param_1, u16 param_2)
...
void __stdcall16far ui_op_1020_536e(u32 param_1, undefined4 param_2, i16 param_3, i16 param_4, u8 *param_5)
    ...
    if(uVar7 == 0x0)
    {
        if((iVar10 + 0xfe) == 0x0)
        {
            ...
            else
            {
                piVar1           = (iVar10 + 0xcc);
                *piVar1          = *piVar1 + 0x1;
                uVar14           = unk_win_ui_op_1020_67ce(CONCAT13((param_5 >> 0x8), CONCAT12(param_5, uVar7)), (iVar10 + 0xcc), param_1);
                (iVar10 + 0xfe)  = uVar14;
        ...
        if(param_4 == 0x2)
        {
            ...
            if(uVar5 == 0x0)
            {
                ...
                *piVar1 = *piVar1 + 0x1;
                ...
                {
                    pass1_1020_289a(CONCAT13((puVar9 >> 0x8), CONCAT12(puVar9, UVar6)), UVar2, param_1, unaff_SS);
                }
                puStack16 = CONCAT22(puVar8, UVar6);
                uVar16    = SUB21(puVar8, 0x0);
                uVar17    = (undefined)(puVar8 >> 0x8);
                ...
                pass1_1008_6978(param_1, UVar2, CONCAT22(puVar8, UVar6), uVar14, (uVar14 >> 0x10));
                ppcVar3 = (iVar10 + 0xc);
...
void __stdcall16far set_cursor_1020_5764(u32 param_1, i16 param_2, u16 param_3)

{
    ...
    {
        h_instance = 0x1030;
        pass1_1030_8308(_PTR_LOOP_1050_5748, (_PTR_LOOP_1050_5748 >> 0x10), CONCAT22(param_3, &local_e), CONCAT13((param_3 >> 0x8), CONCAT12(param_3, local_c)), uStack10 & 0xffff | uVar1 << 0x10, &local_e, uVar1);
        if(param_2 <= local_e)
        {
            uVar4 = (param_1 >> 0x10);
            iVar3 = param_1;
...
void __stdcall16far pt_in_rect_1020_5856(u32 param_1, POi1616 *param_2, u16 param_3)
...
void __stdcall16far pt_in_rect_op_1020_58ce(u32 param_1, u16 param_2, u16 param_3, byte param_4, RECT16 *param_5, u16 param_6)

{
    ...
    LAB_1020_5942:
        ...
        LAB_1020_5a16:
            ...
            if(uVar3 != 0x0)
            {
                ...
                {
                    BVar4 = PtInRect16(rect_00, (POi1616)CONCAT22(uStack4, local_6));
                    if(BVar4 != 0x0)
                    {
                        local_18[0] = 0x0;
                        uStack20    = 0x0;
            ...
            if(uVar3 != 0x0)
            {
                ...
                pt_in_rect_1020_5856(param_1, (POi1616 *)CONCAT22(param_6, uStack30), uStack30);
                ...
                if(uVar5 != 0x0)
                {
                    ...
                    uVar3 = pass1_1020_5d56(param_1, CONCAT22(uStack30._2_2_, uStack30), uVar5, unaff_DI, param_6);
                    if(uVar3 != 0x0)
                    {
                        return;
                    }
        ...
        BVar4          = PtInRect16(rect, (POi1616)CONCAT22(uStack4, local_6));
        if(BVar4 == 0x0)
            goto LAB_1020_5a16;
        rect     = (RECT16 *)0x1010;
        ...
        if((uStack18 + 0x72) != 0x0)
        {
            ...
            (**ppcVar1)(0x1010, _PTR_LOOP_1050_02a0, (_PTR_LOOP_1050_02a0 >> 0x10), 0x10, iVar7, uVar9, uVar10, puVar6);
    ...
    else
    {
        ...
        puStack12      = uStack30._2_2_;
        BVar4          = PtInRect16(param_5, (POi1616)CONCAT22(uStack4, local_6));
        if(BVar4 == 0x0)
            goto LAB_1020_5942;
        uVar9 = 0x68;
    }
...

{
    ...
    if(uVar2 != 0x0)
    {
        ...
        uVar8    = uStack10;
        BVar3    = PtInRect16(unaff_CS, (POi1616)CONCAT22(HStack4, local_6));
        if(BVar3 != 0x0)
        {
    ...
    ppRVar4 = &local_6;
    pt_in_rect_1020_5856(param_1, (POi1616 *)CONCAT22(unaff_SS, ppRVar4), ppRVar4);
    uVar6              = (uVar8 >> 0x10);
...
void __stdcall16far win_ui_op_1020_5de8(u32 param_1, u16 param_2, u16 param_3, u16 param_4)

{
    ...
    uVar4            = (puVar6 >> 0x10);
    puVar3           = &local_6;
    pt_in_rect_1020_5856(param_1, (POi1616 *)CONCAT13((param_4 >> 0x8), CONCAT12(param_4, puVar3)), puVar3);
    if((uVar4 | puVar3) != 0x0)
    {
        uVar2    = (puVar3 + 0x21);
        uVar1    = puVar3[0x22];
...
void __stdcall16far win_ui_op_1020_5e76(u32 param_1, u16 param_2, u16 param_3)

{
    ...
    uStack4        = param_2;
    puVar3         = &local_6;
    uVar15         = (undefined)(unaff_SS >> 0x8);
    pt_in_rect_1020_5856(param_1, (POi1616 *)CONCAT13(uVar15, CONCAT12(unaff_SS, puVar3)), puVar3);
    ...
    if(puVar4 == 0x6b8)
    {
        ...
        {
            iVar5 = string_1040_8520(CONCAT13((puVar7 >> 0x8), CONCAT12(puVar7, puVar4)), PTR_LOOP_1050_0396, 0x40, 0x2, 0x6b8, 0x6ad, puVar8, unaff_SS);
        }
    ...
    else
    {
        if(puVar4 == 0x6b4)
        {
            ...
            {
                iVar5 = string_1040_8520(CONCAT13((puVar7 >> 0x8), CONCAT12(puVar7, puVar4)), PTR_LOOP_1050_0396, 0x40, 0x2, 0x57b, puStack18, puVar8, unaff_SS);
            }
            paStack38 = CONCAT22(puVar8, iVar5);
            uVar13    = 0xab;
            goto LAB_1020_5f84;
        ...
        if(puVar4 == 0x6b6)
        {
            load_string_1010_84e0(0x1010, _PTR_LOOP_1050_14cc, (_PTR_LOOP_1050_14cc >> 0x10), 0x3ff, local_aa, (short)unaff_SS);
            load_string_1010_84e0(0x1010, _PTR_LOOP_1050_14cc, (_PTR_LOOP_1050_14cc >> 0x10), 0x3ff, local_1aa, (short)unaff_SS);
            uVar6  = sys_1000_3f9c(local_2aa, unaff_SS, local_1aa, unaff_SS, PTR_LOOP_1050_50cc, &stack0xfffe, uVar11, 0x1000, unaff_SS, in_AF);
            uVar12 = 0x1000;
            mem_op_1000_179c(0xb4, puVar7, 0x1000);
            ...
            else
            {
                ...
                paStack38 = pass1_1040_8478(CONCAT22(puVar7, uVar6), 0x40, CONCAT13(uVar15, CONCAT12(unaff_SS, local_aa)), CONCAT22(unaff_SS, local_2aa), PTR_LOOP_1050_0396, puVar7 | uVar6);
            }
        ...
        if(0x6b1 < puVar4)
        {
            ...
            {
                uVar12  = SUB42(&PTR_LOOP_1050_1040, 0x0);
                puVar10 = string_1040_8520(CONCAT13((puVar7 >> 0x8), CONCAT12(puVar7, puVar4)), PTR_LOOP_1050_0396, 0x40, 0x2, 0x57b, puStack18, puVar8, unaff_SS);
            }
...
void __stdcall16far pass1_1020_6184(u32 param_1, u16 param_2, u16 param_3)
...
void __stdcall16far pass1_1020_434c(i16 param_1, u16 param_2, u32 *param_3, u16 param_4, u16 param_5, i16 param_6, u16 param_7, u16 param_8)
...
void __stdcall16far mixed_menu_op_1020_44ec(u32 param_1, u16 param_2, i16 param_3, HMENU16 param_4, HMENU16 param_5, u16 param_6)
    ...
    if((iVar10 + 0x106) != 0x0)
    {
        if(*(HMENU16 *)(iVar10 + 0x106) == param_4)
        {
            ...
            if(uStack296._3_1_ == 0x0)
            {
                ...
                HVar12 = 0x1000;
                unk_str_op_1000_3d3e(CONCAT22(param_6, local_108), CONCAT22(puVar9, uVar2));
            }
            else
            {
                ...
                HVar12    = 0x1010;
                pass1_1010_c3c2(puStack6, (puStack6 >> 0x10), CONCAT22(param_6, local_108), CONCAT22(puVar9, uVar6), puVar9, in_AF, param_6);
            }
            ...
            if(BVar4 != 0x0)
            {
                uStack296 = load_string_1010_847e(_PTR_LOOP_1050_14cc, (i1616)(_PTR_LOOP_1050_14cc >> 0x10), 0x1010);
...
void __stdcall16far win_sys_op_1020_493c(u32 *param_1, u16 param_2, u8 *param_3, u16 param_4, HCURSOR16 param_5, WNDCLASS16 *param_6)

{
    ...
    if(param_2 < 0xea)
    {
        ...
        case 0x77:
            ...
            WinHelp16(0x1010, (LPCSTR)uStack26, CONCAT11((undefined)((LPCSTR)uStack26 >> 0xf), (undefined)((LPCSTR)uStack26 >> 0xf)), CONCAT22(paStack18, 0x1));
            return;
        case 0x78:
    ...
    if(param_2 < 0x133)
    {
        if(param_2 == 0x102)
        {
            ...
            {
                uVar16 = 0x40;
                iVar4  = string_1040_8520(CONCAT22(param_3, param_2), PTR_LOOP_1050_0396, 0x31, 0x2, 0x57b, 0x62b, puVar8, param_6);
            }
        ...
        if(param_2 < 0x103)
        {
            ...
            case 0x101:
                ...
                if(uStack22 == 0x0)
                {
                    ...
                    {
                        uVar16 = 0x40;
                        puVar5 = string_1040_8520(CONCAT22(puVar7, uStack22), PTR_LOOP_1050_0396, 0x30, 0x2, 0x57b, 0x730, puVar8, param_6);
                    }
                ...
                paStack18 = (astruct_43 *)mixed_1010_20ba(_PTR_LOOP_1050_0ed0, 0x43, param_6, (uVar12 >> 0x10), unaff_DI);
                ...
                pass1_1028_84ca((astruct_100 *)CONCAT22(param_6, &local_13c), uStack22, uVar9, uStack10, puStack14, param_6, in_AF);
                goto LAB_1020_4b6c;
            }
        }
        else
            ...
            if(param_2 != 0x106)
            {
                if(param_2 < 0x107)
                {
                    if(param_2 == 0x103)
                    {
                        ...
                        {
                            uVar16 = 0x40;
                            puVar5 = string_1040_8520(CONCAT22(puStack32, uStack34), PTR_LOOP_1050_0396, 0x30, 0x2, 0x57b, 0x730, puVar8, param_6);
                        }
                    ...
                    else
                    {
                        ...
                        if(uStack34 != 0x0)
                        {
                            ...
                            {
                                uVar16 = 0x40;
                                iVar4  = string_1040_8520(CONCAT22(puStack32, uStack34), PTR_LOOP_1050_0396, 0x31, 0x2, 0x57b, 0x62c, puVar8, param_6);
                            }
                            ...
                            uVar16  = (undefined)(param_6 >> 0x8);
                            paVar14 = pass1_1030_e79a((astruct_100 *)CONCAT13(uVar16, CONCAT12(param_6, local_356)), param_6, in_AF);
                            uVar9   = (paVar14 >> 0x10);
                            puVar5  = local_356;
                        ...
                        {
                            uVar16 = 0x40;
                            puVar5 = string_1040_8520(CONCAT22(puStack32, uStack34), PTR_LOOP_1050_0396, 0x30, 0x2, 0x57b, 0x731, puVar8, param_6);
                        }
...
BOOL16 __stdcall16far enable_menu_item_1020_2c2a(HMENU16 param_1, i16 param_2)
...
astruct_18 *__stdcall16far pass1_1020_3616(astruct_18 *param_1, byte param_2, u16 param_3)
...
void __stdcall16far win_ui_op_1020_36f6(u32 param_1, i16 param_2, short param_3)

{
    ...
    uVar6   = (uStack6 >> 0x10);
    GetWindowText16(0x1018, 0x3ff, (i1616)local_406);
    pcVar4       = pass1_1000_472c(CONCAT22(param_3, local_406), ':');
    puStack1034  = CONCAT22(uVar6, pcVar4 + 0x2);
    *puStack1034 = 0x0;
    load_string_1010_84e0(0x1010, _PTR_LOOP_1050_14cc, (_PTR_LOOP_1050_14cc >> 0x10), 0x3ff, local_406, param_3);
    ppcVar2 = ((iVar7 + 0x18) + 0x18);
    (**ppcVar2)();
    uVar3 = (iVar7 + 0x8);
    iVar1 = (uVar3 + 0x4a);
    uVar3 = (uStack6 + 0x2);
    SetDlgItemText16(0x1010, (i1616)uVar3, (SEGPTR)(uVar3 >> 0x10));
    uVar3 = (uStack6 + 0xa);
    SetDlgItemText16((HWND16)s_tile2_bmp_1050_1538, (i1616)uVar3, (SEGPTR)(uVar3 >> 0x10));
    uVar3 = (uStack6 + 0x12);
    SetDlgItemText16((HWND16)s_tile2_bmp_1050_1538, (i1616)uVar3, (SEGPTR)(uVar3 >> 0x10));
    uVar3 = (uStack6 + 0xe);
    SetDlgItemText16((HWND16)s_tile2_bmp_1050_1538, (i1616)uVar3, (SEGPTR)(uVar3 >> 0x10));
...
LAB_1020_3846:
    ...
    if((iVar7 + 0x1c) != 0x0)
    {
        GetDlgItem16((HWND16)s_tile2_bmp_1050_1538, (uStack6 + 0x1a));
        SetFocus16((HWND16)s_tile2_bmp_1050_1538);
        return;
    }
    InvalidateRect16((HWND16)s_tile2_bmp_1050_1538, (RECT16 *)0x0, 0x0);
...
void __stdcall16far pass1_1020_3898(astruct_30 *param_1, u16 param_2)
...

{
    ...
    {
        unk_draw_op_1020_3da4((astruct_24 *)CONCAT22(puVar7, uVar2), param_1);
        (uVar11 + 0xf6) = uVar2;
    ...
    uVar8  = MoveWindow16(HVar9, 0x1, &paVar3->field_0x6, &paVar3->field_0x4, (i1616)puVar7, *(BOOL16 *)paVar3);
    HVar9  = 0x1000;
