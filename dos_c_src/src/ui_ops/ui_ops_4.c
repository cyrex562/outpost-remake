...

{
    ...
    pu_stack6 = mixed_1010_20ba(_PTR_LOOP_1050_0ed0, 0x2, param_2, in_DX, unaff_DI);
    ...
    *(HWND16 *)(iVar5 + 0x92) = HVar2;
    ...
    HVar2                     = GetDlgItem16((HWND16)0x1538, 0x17a);
    *(HWND16 *)(iVar5 + 0x94) = HVar2;
    send_msg_1038_c374(param_1, local_116, HVar2, 0x1538);
    ...
    (iVar5 + 0x9c) = LVar10;
    SendMessage16((HWND16)0x1538, pcVar9, wparam, 0x40dffff);
    HVar2                     = GetDlgItem16((HWND16)0x1538, 0x178);
    *(HWND16 *)(iVar5 + 0x96) = HVar2;
    HVar2                     = GetDlgItem16((HWND16)0x1538, 0x177);
    *(HWND16 *)(iVar5 + 0x98) = HVar2;
    HVar2                     = GetDlgItem16((HWND16)0x1538, 0x184);
...

{
    ...
    u_stack6 = load_string_1010_847e(_PTR_LOOP_1050_14cc, (u16)(_PTR_LOOP_1050_14cc >> 0x10), 0x1010);
    if(param_4 == 0x177)
    {
        pass1_1008_e05e(*(param_1 + 0x8e), 0x2, CONCAT22(param_2, param_1 + 0x19eU), CONCAT22(param_2, param_1 + 0x9e), param_5, in_AF);
        load_string_1010_84e0(0x1010, globals->PCHAR_1050_14cc, (_PTR_LOOP_1050_14cc >> 0x10), 0x200, local_40c, param_5);
        sys_1000_3f9c(local_70c, param_5, local_40c, param_5, param_1 + 0x19eU, &stack0xfffe, param_2, 0x1000, param_5, in_AF);
        load_string_1010_84e0(0x1010, globals->PCHAR_1050_14cc, (_PTR_LOOP_1050_14cc >> 0x10), 0x100, local_50c, param_5);
        hwnd = (HWND16)0x1538;
    ...
    else
    {
        if(param_4 != 0x178)
        {
            ...
            post_win_msg_1040_7b3c(CONCAT22(param_2, param_1), param_3, param_4, param_4, &PTR_LOOP_1050_1040);
            return;
        }
        ...
        if(iVar1 == 0x0)
        {
            load_string_1010_84e0(0x1010, globals->PCHAR_1050_14cc, (_PTR_LOOP_1050_14cc >> 0x10), 0x3ff, local_40c, param_5);
            load_string_1010_84e0(0x1010, globals->PCHAR_1050_14cc, (_PTR_LOOP_1050_14cc >> 0x10), 0x3ff, local_50c, param_5);
            MessageBox16(0x1010, (s_New_failed_in_Op__Op_1050_0020 + 0x10), local_50c, param_5);
            return;
        }
        hwnd = 0x1008;
        pass1_1008_e01c(*(param_1 + 0x8e), CONCAT22(param_2, param_1 + 0x19e), uStack10);
        pass1_1038_af40(_PTR_LOOP_1050_5b7c, (param_1 + 0x8), 0x1f, u_var2, param_1, 0x1008, param_5);
    }
...

{
    ...
    pass1_1008_e320(*(Struct102 **)(param_1 + 0x8e), param_1 & 0xffff0000 | (param_1 + 0x19eU), param_1 & 0xffff0000 | lp_string, unaff_SS);
    ...
    EnableWindow16((HWND16)0x1538, uVar1 & 0x2);
    return;
}
...

{
    ...
    load_string_1010_84e0(0x1010, globals->PCHAR_1050_14cc, (_PTR_LOOP_1050_14cc >> 0x10), 0x400, local_80e, (short)param_2);
...

{
    ...
    u_var2 = (_PTR_LOOP_1050_14cc >> 0x10);
    if(param_4 == 0x17d)
    {
        load_string_1010_84e0(0x1010, globals->PCHAR_1050_14cc, u_var2, 0x3ff, local_404, param_5);
        uVar1 = (param_1 + 0x92);
        hwnd  = (HWND16)0x1538;
...

{
    ...
    if(param_3 == 0xfce)
    {
        ...
        win_1008_5c9e(_PTR_LOOP_1050_02a0, CONCAT22(param_4, local_6), local_6, (pu_var2 >> 0x10), param_4);
        uVar1         = (param_1 + 0x8e);
        (uVar1 + 0xa) = 0x6;
    ...
    post_win_msg_1040_7b3c(CONCAT22(param_2, param_1), (param_2 >> 0x10), param_3, param_3, &PTR_LOOP_1050_1040);
    return;
}
...

{
    ...
    {
    LAB_1038_c8da:
        HVar3 = GetDlgItem16((HWND16)0x1538, 0xfce);
        if(HVar3 != 0x0)
        {
            EnableWindow16((HWND16)0x1538, 0x1);
        }
        HVar3 = GetDlgItem16((HWND16)0x1538, 0x1);
        if(HVar3 == 0x0)
            goto LAB_1038_c93c;
        enable = 0x0;
    }
    ...
    EnableWindow16((HWND16)0x1538, enable);
LAB_1038_c93c:
...

{
    ...
    else
    {
        ...
        else
        {
            ...
            HVar5 = GetDlgItem16((HWND16)0x1538, 0x17d8);
        }
        EnableWindow16((HWND16)0x1538, HVar5);
    }
    return;
}
...

{
    ...
    pu_stack6 = mixed_1010_20ba(_PTR_LOOP_1050_0ed0, 0x27, param_2, in_DX, unaff_DI);
    pass1_1008_3e38(CONCAT22(param_2, local_c));
    pass1_1008_3f62(CONCAT22(param_2, local_c), (pu_stack6 & 0xffff0000 | (pu_stack6 + 0x52)));
    pass1_1008_3e94(CONCAT22(param_2, local_c), CONCAT22(param_2, &local_10), CONCAT22(param_2, &local_e));
    paStack20 = (Struct76 *)unk_io_op_1010_830a(_PTR_LOOP_1050_14cc, 0x1c0, param_2);
...

{
    ...
    pu_var2           = mixed_1010_20ba(_PTR_LOOP_1050_0ed0, 0x2, unaff_SS, in_DX, unaff_DI);
    uVar1            = (pu_var2 + 0x6c);
    GetDlgItem16(0x1010, 0x114);
    SetWindowText16((HWND16)0x1538, (SEGPTR)uVar1);
    SetFocus16((HWND16)0x1538);
...

{
    ...
    if(param_2 != 0x0)
    {
        ...
        GetWindowText16((HWND16)0x1538, 0x50, (u16)local_52);
        uVar1 = str_op_1000_3da4(CONCAT22(param_4, local_52));
        if(uVar1 != 0x0)
        {
            puVar3 = local_52;
            pu_var2 = mixed_1010_20ba(_PTR_LOOP_1050_0ed0, 0x2, param_4, in_DX, unaff_DI);
            pass1_1010_6006(pu_var2, CONCAT22(param_4, puVar3), (pu_var2 >> 0x10));
            GetWindowWord16(0x1010, -0x8);
            PostMessage16((HWND16)0x1538, 0x0, 0x0, 0x1110105);
...

{
    ...
    SetWindowText16((HWND16)0x1538, (SEGPTR)uVar1);
    SetFocus16((HWND16)0x1538);
    LVar5 = SendMessage16((HWND16)0x1538, 0x0, 0xffff, 0x4010000);
    uVar3 = (LVar5 >> 0x10);
    u_var2 = LVar5;
    unk_win_ui_op_1038_a18c(param_1, unaff_SS);
    win_1008_5c7c(_PTR_LOOP_1050_02a0, 0x30001, unaff_SS, u_var2, uVar3);
    (param_1 + 0x8c) = u_var2;
    ShowWindow16(0x1008, 0x5);
    return;
}
...

{
    ...
    if(param_4.b_0x2 == 0x116)
    {
        ...
        GetDlgItem16((HWND16)0x1538, 0x11a);
        enable = 0x0;
    }
    else
    {
...

{
    ...
    LVar3 = SendDlgItemMessage16((HWND16)0x1538, 0x0, 0x0, 0x1, 0x11a0401);
    u_var2 = (LVar3 >> 0x10);
    GetDlgItem16((HWND16)0x1538, 0x11a);
    BVar1 = EnableWindow16((HWND16)0x1538, 0x0);
    win_1008_5c7c(_PTR_LOOP_1050_02a0, 0x40001, unaff_SS, BVar1, u_var2);
...

{
    ...
    if(param_2 != 0x0)
    {
        ...
        if(LVar2 == 0x0)
        {
            LVar2 = SendDlgItemMessage16((HWND16)0x1538, 0x0, 0x0, 0x0, 0x1170400);
            if(LVar2 == 0x0)
            {
                LVar2 = SendDlgItemMessage16((HWND16)0x1538, 0x0, 0x0, 0x0, 0x1180400);
                if(LVar2 == 0x0)
                {
                    LVar2 = SendDlgItemMessage16((HWND16)0x1538, 0x0, 0x0, 0x0, 0x1190400);
                    if(LVar2 != 0x0)
                    {
        ...
        LVar2           = SendDlgItemMessage16((HWND16)0x1538, 0x0, 0x0, 0x0, 0x11a0400);
        (puVar1 + 0x82) = LVar2;
        GetWindowWord16((HWND16)0x1538, -0x8);
        PostMessage16((HWND16)0x1538, 0x0, 0x0, 0x1110105);
        destroy_win_1040_7b98(param_1, &PTR_LOOP_1050_1040);
    }
    return;
...

{
    ...
    (param_1 + 0xac) = 0x0;
    (param_1 + 0xae) = 0x0;
    if(_PTR_LOOP_1050_5b7c == (Struct20 *)0x0)
    {
...
LAB_1038_89af:
    if(bVar2)
    {
        ...
        SetDlgItemInt16((HWND16)0x1538, 0x0, (iVar3 + 0x98), s_dibtext_bmp_1050_1844 + 0xb);
    }
    return 0x0;
}
...

{
    ...
    pcStack264 = param_2;
    puStack262 = param_3;
    load_string_1010_84e0(0x1010, globals->PCHAR_1050_14cc, (_PTR_LOOP_1050_14cc >> 0x10), 0x3ff, param_2, (short)param_3);
    load_string_1010_84e0(0x1010, globals->PCHAR_1050_14cc, (_PTR_LOOP_1050_14cc >> 0x10), 0x3ff, local_104, param_4);
    pass1_1000_3cea(CONCAT22(puStack262, pcStack264), CONCAT22(param_4, local_104));
    load_string_1010_84e0(0x1010, globals->PCHAR_1050_14cc, (_PTR_LOOP_1050_14cc >> 0x10), 0x3ff, local_104, param_4);
    pass1_1000_3cea(CONCAT22(puStack262, pcStack264), CONCAT22(param_4, local_104));
    load_string_1010_84e0(0x1010, globals->PCHAR_1050_14cc, (_PTR_LOOP_1050_14cc >> 0x10), 0x101, local_20a, param_4);
...

{
    ...
    uVar6    = (param_1 >> 0x10);
    iVar5    = param_1;
    pass1_1010_c3c2(pu_stack6, uVar3, CONCAT22(param_2, local_106), *(iVar5 + 0x94), uVar3, in_AF, param_2);
    LVar7          = SendDlgItemMessage16(0x1010, (u16)local_106, param_2, 0x0, 0x1846000c);
    uVar4          = (LVar7 >> 0x10);
    uVar1          = (iVar5 + 0x94);
    (iVar5 + 0x9c) = (uVar1 + 0x32);
    (iVar5 + 0x9a) = (iVar5 + 0x9c);
    SetDlgItemInt16((HWND16)0x1538, 0x0, (iVar5 + 0x9c), s_dibtext_bmp_1050_1844 + 0x9);
    uVar1 = (iVar5 + 0x94);
    u_var2 = *(uVar1 + 0x2e);
    pass1_1038_3aa6(u_var2, u_var2, uVar4);
    (iVar5 + 0x98) = u_var2;
    SetDlgItemInt16((HWND16)0x1538, 0x0, u_var2, s_dibtext_bmp_1050_1844 + 0xb);
    return;
}
...

{
    ...
    mem_op_1000_179c(0x1000, param_3, 0x1000);
    load_string_1010_84e0(0x1010, globals->PCHAR_1050_14cc, (_PTR_LOOP_1050_14cc >> 0x10), 0x100, local_206, param_4);
    load_string_1010_84e0(0x1010, globals->PCHAR_1050_14cc, (_PTR_LOOP_1050_14cc >> 0x10), 0x3ff, param_2, (short)param_3);
    load_string_1010_84e0(0x1010, globals->PCHAR_1050_14cc, (_PTR_LOOP_1050_14cc >> 0x10), 0x3ff, local_104, param_4);
...

{
    ...
    SendDlgItemMessage16((HWND16)0x1538, 0x0, 0x0, 0x0, 0x185b0405);
    ...
    {
        load_string_1010_84e0(0x1010, globals->PCHAR_1050_14cc, (_PTR_LOOP_1050_14cc >> 0x10), 0x3ff, &local_404, (short)param_3);
        SendDlgItemMessage16(0x1010, (u16)&local_404, param_3, 0x0, 0x185b0401);
        GetDlgItem16((HWND16)0x1538, 0x1);
        enable = 0x0;
    }
    EnableWindow16((HWND16)0x1538, enable);
    LVar4 = SendDlgItemMessage16((HWND16)0x1538, 0x0, 0x0, 0x1, 0x185b000b);
    return LVar4;
}
...

{
    ...
    (param_1 + 0x94) = UVar1;
    u_var2            = GetDlgItemInt16((HWND16)0x1538, 0x1, &local_6, (BOOL16)unaff_SS);
    (param_1 + 0x96) = u_var2;
    win_ui_dlg_op_1038_98b4((Struct51 *)(param_1 & 0xffff | uVar3 << 0x10), 0x1538, unaff_SS);
    win_1008_5c7c(_PTR_LOOP_1050_02a0, 0x950001, unaff_SS, u_var2, in_DX);
    return;
}
...

{
    ...
    if((-0x1 < iStack8) && (u_stack6 = GetDlgItemInt16(param_6, 0x1, &local_c, param_7), local_c != 0x0))
    {
        ...
        iVar2 = iStack8 * 0xe;
        GetDlgItem16((HWND16)0x1538, (iVar2 + 0x5a72));
        SetFocus16((HWND16)0x1538);
        if((uStack10 != 0x0) && (lVar3 = unk_win_ui_op_1038_9820((Struct51 *)CONCAT22(param_2, param_1), 0x1, iStack4, 0x1538, param_7), lVar3 != 0x0))
        {
            SetDlgItemInt16((HWND16)0x1538, 0x1, u_stack6, *(BOOL16 *)(iVar2 + 0x5a72));
            SetDlgItemInt16((HWND16)0x1538, 0x1, (param_1 + 0x94), 0xfa9);
            SetDlgItemInt16((HWND16)0x1538, 0x1, (param_1 + 0x96), 0xfa8);
        }
    }
    return 0x1;
}
...

{
    ...
    EnableWindow16((HWND16)0x1538, in_b_enable_3);
    return;
}
...

{
    ...
    uVar12 = 0x0;
    hdc    = GetDC16((HWND16)0x1538);
    IVar4  = GetDeviceCaps16((HDC16)0x1538, 0xa);
    ...
    SetWindowPos16((HWND16)0x1538, 0x1, 0x0, 0x0, iStack14, iStack12, 0x0);
...

{
    ...
    LVar3 = SendDlgItemMessage16((HWND16)0x1538, 0x0, 0x0, 0x0, 0x18540409);
    if(LVar3 != -0x1)
    {
        SendDlgItemMessage16((HWND16)0x1538, 0x0, 0x0, (WPARAM16)LVar3, 0x18540403);
        SendDlgItemMessage16((HWND16)0x1538, (u16)pcVar2, (pcVar2 >> 0x10), 0x0, 0x18540401);
        SendDlgItemMessage16((HWND16)0x1538, 0x0, 0x0, 0xffff, 0x18540407);
        SendDlgItemMessage16((HWND16)0x1538, 0x0, 0x0, 0x0, 0x18550405);
        SendDlgItemMessage16((HWND16)0x1538, 0x0, 0x0, 0x0, 0x18560405);
        enable_win_1038_806a(param_1, 0x1538);
    }
    LVar3 = SendDlgItemMessage16((HWND16)0x1538, 0x0, 0x0, 0x1, 0x1854000b);
    return LVar3;
}
...

{
    ...
    LVar3 = SendDlgItemMessage16((HWND16)0x1538, 0x0, 0x0, 0xffff, 0x18560407);
...

{
    ...
    GetDlgItem16((HWND16)0x1538, 0x1858);
    EnableWindow16((HWND16)0x1538, 0x0);
    GetDlgItem16((HWND16)0x1538, 0x1859);
    BVar1 = EnableWindow16((HWND16)0x1538, 0x0);
...

{
    ...
    *param_3 = '\0';
    ...
    if((LVar1 != -0x1) && (LVar1 = SendDlgItemMessage16((HWND16)0x1538, (u16)param_3, (param_3 >> 0x10), (WPARAM16)LVar1, CONCAT22(param_4, 0x40a)), LVar1 != -0x1))
    {
        return 0x1;
    }
    return 0x0;
...

{
    ...
    mem_op_1000_179c(0x1000, param_3, 0x1000);
    load_string_1010_84e0(0x1010, globals->PCHAR_1050_14cc, (_PTR_LOOP_1050_14cc >> 0x10), 0x3ff, local_206, param_4);
    load_string_1010_84e0(0x1010, globals->PCHAR_1050_14cc, (_PTR_LOOP_1050_14cc >> 0x10), 0x3ff, param_2, (short)param_3);
    load_string_1010_84e0(0x1010, globals->PCHAR_1050_14cc, (_PTR_LOOP_1050_14cc >> 0x10), 0x3ff, local_104, param_4);
    pass1_1000_3cea(CONCAT22(param_3, param_2), CONCAT22(param_4, local_104));
    load_string_1010_84e0(0x1010, globals->PCHAR_1050_14cc, (_PTR_LOOP_1050_14cc >> 0x10), 0x3ff, local_104, param_4);
...

{
    ...
    {
        hwnd = 0x1010;
        load_string_1010_84e0(0x1010, globals->PCHAR_1050_14cc, (_PTR_LOOP_1050_14cc >> 0x10), 0x100, local_30a, param_3);
        lp_string = local_30a;
    }
    else
    {
        u_var2 = send_dlg_item_msg_1038_8164(uVar4, uVar3, CONCAT22(param_3, local_108), 0x1854, 0x1008);
        if(u_var2 == 0x0)
        {
            hwnd = 0x1010;
            load_string_1010_84e0(0x1010, globals->PCHAR_1050_14cc, (_PTR_LOOP_1050_14cc >> 0x10), 0x100, local_208, param_3);
        }
        else
        {
            hwnd = 0x1008;
...

{
    ...
    SendDlgItemMessage16((HWND16)0x1538, 0x0, 0x0, 0x0, 0x1855000b);
    SendDlgItemMessage16((HWND16)0x1538, 0x0, 0x0, 0x0, 0x1856000b);
    SendDlgItemMessage16((HWND16)0x1538, 0x0, 0x0, 0x0, 0x18540405);
    SendDlgItemMessage16((HWND16)0x1538, 0x0, 0x0, 0x0, 0x18550405);
    LVar4   = SendDlgItemMessage16((HWND16)0x1538, 0x0, 0x0, 0x0, 0x18560405);
    u_stack6 = pass1_1008_b820(*(param_1 + 0x94), LVar4, (LVar4 >> 0x10));
    if(u_stack6 == 0x0)
    {
        load_string_1010_84e0(0x1010, globals->PCHAR_1050_14cc, (_PTR_LOOP_1050_14cc >> 0x10), 0x100, local_108, param_3);
        SendDlgItemMessage16(0x1010, (u16)local_108, param_3, 0x0, 0x18540401);
        SendDlgItemMessage16((HWND16)0x1538, 0x0, 0x0, 0x1, 0x1854000b);
        SendDlgItemMessage16((HWND16)0x1538, 0x0, 0x0, 0x1, 0x1855000b);
        LVar4 = SendDlgItemMessage16((HWND16)0x1538, 0x0, 0x0, 0x1, 0x1856000b);
        u_var2 = (LVar4 >> 0x10);
        GetDlgItem16((HWND16)0x1538, 0x1857);
        load_string_1010_84e0(0x1010, globals->PCHAR_1050_14cc, (_PTR_LOOP_1050_14cc >> 0x10), 0x100, local_108, param_3);
...

{
    ...
    if(u_stack6 != 0x0)
    {
        ...
        if(uVar1 != 0x0)
        {
            ...
            SendDlgItemMessage16((HWND16)0x1538, 0x0, 0x0, 0x0, 0x1856000b);
            SendDlgItemMessage16((HWND16)0x1538, 0x0, 0x0, 0x0, 0x18550405);
            LVar6  = SendDlgItemMessage16((HWND16)0x1538, 0x0, 0x0, 0x0, 0x18560405);
            puVar3 = (LVar6 >> 0x10);
            pu_var2 = local_106;
            pass1_1008_b4a0(*(uVar4 + 0x94), CONCAT22(param_2, pu_var2), pu_var2, puVar3, param_2);
            pass1_1008_b200(*(uVar4 + 0x94), param_2);
            uVar8 = CONCAT22(puVar3 | pu_var2, pu_var2);
            if((puVar3 | pu_var2) != 0x0)
            {
                send_dlg_item_msg_1038_8400(uVar4, uVar5, CONCAT22(puVar3, pu_var2), 0x1855, param_2);
            ...
            LVar6 = SendDlgItemMessage16((HWND16)0x1538, 0x0, 0x0, 0x1, 0x1856000b);
            uVar1 = LVar6;
        }
    }
    return uVar1;
...

{
    ...
    uVar5 = param_1;
    uVar1 = (param_1 >> 0x10);
    u_var2 = send_dlg_item_msg_1038_8164(uVar5, uVar1, CONCAT22(param_3, local_102), 0x1855, param_2);
    if(u_var2 != 0x0)
    {
...

{
    ...
    u_var2 = (param_1 >> 0x10);
    uVar1 = send_dlg_item_msg_1038_8164(param_1, u_var2, CONCAT22(param_3, local_102), 0x1856, param_2);
    if(uVar1 != 0x0)
    {
    ...
    if(iVar9->field_0x4 != 0x0)
    {
        ...
        if(*iVar9->field_0xc == 0x0)
        {
            ...
            else
            {
                ...
                uVar9  = (uStack20 >> 0x10);
                pass1_1008_50c2((Struct110 *)CONCAT22(puVar6, uVar3), *(uStack20 + 0x8), *(uStack20 + 0x4), puVar5, u_stack6);
            ...
            struct_op_1008_48fe((Struct81 *)CONCAT22(param_2, local_3a), 0x1, paVar10, (paVar10 >> 0x10));
            ...
            else
            {
                ...
                uVar9 = (uStack20 >> 0x10);
                pass1_1008_50c2((Struct110 *)CONCAT22(puVar6, uVar3), *(uStack20 + 0x8), *(uStack20 + 0x4), (param_1 & 0xffff0000 | uVar4), u_stack6);
                pu_var2            = iVar9->field_0xc;
                uVar9             = (pu_var2 >> 0x10);
...

{
    ...
    if(u_stack6 != 0x0)
    {
        ...
        {
            uStack4 = param_5;
            sys_1000_3f9c(local_10, param_6, s__03ld_1050_442a, &USHORT_1050_1050, u_stack6, &stack0xfffe, uVar3, 0x1000, param_6, in_AF);
            uVar1 = (iVar2 + 0x22);
            ...
            u_stack60 = pass1_1008_4772((Struct76 *)CONCAT22(param_6, local_38));
...

{
    ...
    if(b_var2 == 0x0)
    {
        GetWindowRect16((HWND16)0x1538, &local_a);
        iStack6   = iStack6 - local_a.x;
    ...
    (**ppcVar1)(0x1538, (param_1 + 0xe0), &local_a);
    return;
}
...

{
    ...
    if(((iVar2 + 0xee) != 0x0) && ((iVar2 + 0xec) == 0x0))
    {
        ...
        *(HMENU16 *)(iVar2 + 0xec) = HVar1;
        ...
        HVar1                      = GetSubMenu16((HMENU16)0x1538, 0x0);
        *(HMENU16 *)(iVar2 + 0xec) = HVar1;
        if(HVar1 == 0x0)
        {
            return;
    ...
    TrackPopupMenu16((HMENU16)0x1538, 0x0, 0x0, (iVar2 + 0x8), 0x0, local_6.y, (RECT16 *)local_6.x);
    return;
}
