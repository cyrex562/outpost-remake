...

{
    ...
    *(HWND16 *)(iVar5 + 0x92) = HVar2;
    ...
    puVar7 = mixed_1010_20ba(globals->_PTR_LOOP_1050_0ed0, 0x2f, param_2, puVar3, unaff_DI);
    uVar4  = (puVar7 >> 0x10);
    uVar8  = *(puVar7 + 0x24);
    uVar1  = (iVar5 + 0x8e);
    ...
    *(HWND16 *)(iVar5 + 0x94) = HVar2;
    ...
    pcVar9         = load_string_1010_847e(globals->_PTR_LOOP_1050_14cc, (u16)(globals->_PTR_LOOP_1050_14cc >> 0x10), SEG_1010);
...

{
    ...
    u_stack6 = load_string_1010_847e(_PTR_LOOP_1050_14cc, (u16)(_PTR_LOOP_1050_14cc >> 0x10), SEG_1010);
    if(param_4 == 0x177)
    {
        pass1_1008_e05e(*(param_1 + 0x8e), 0x2, CONCAT22(param_2, param_1 + 0x19eU), CONCAT22(param_2, param_1 + 0x9e), param_5, in_AF);
        load_string_1010_84e0(SEG_1010, globals->PCHAR_1050_14cc, (_PTR_LOOP_1050_14cc >> 0x10), 0x200, local_40c, param_5);
        sys_1000_3f9c(local_70c, param_5, local_40c, param_5, param_1 + 0x19eU, &stack0xfffe, param_2, SEG_1000, param_5, in_AF);
        load_string_1010_84e0(SEG_1010, globals->PCHAR_1050_14cc, (_PTR_LOOP_1050_14cc >> 0x10), 0x100, local_50c, param_5);
    ...
    else
    {
        if(param_4 != 0x178)
        {
            ...
            {
                set_win_pos_1038_c31a(CONCAT22(param_2, param_1), param_3, param_4, SEG_1010);
                return;
            }
        ...
        if(iVar1 == 0x0)
        {
            load_string_1010_84e0(SEG_1010, globals->PCHAR_1050_14cc, (_PTR_LOOP_1050_14cc >> 0x10), 0x3ff, local_40c, param_5);
            load_string_1010_84e0(SEG_1010, globals->PCHAR_1050_14cc, (_PTR_LOOP_1050_14cc >> 0x10), 0x3ff, local_50c, param_5);
            MessageBox16(SEG_1010, (s_New_failed_in_Op__Op_1050_0020 + 0x10), local_50c, param_5);
            return;
        }
        hwnd = SEG_1008;
        pass1_1008_e01c(*(param_1 + 0x8e), CONCAT22(param_2, param_1 + 0x19e), uStack10);
        pass1_1038_af40(_PTR_LOOP_1050_5b7c, (param_1 + 0x8), 0x1f, u_var2, param_1, SEG_1008, param_5);
    }
...

{
    ...
    load_string_1010_84e0(SEG_1010, globals->PCHAR_1050_14cc, (_PTR_LOOP_1050_14cc >> 0x10), 0x400, local_80e, (short)param_2);
...

{
    ...
    if(param_4 == 0x17d)
    {
        load_string_1010_84e0(SEG_1010, globals->PCHAR_1050_14cc, u_var2, 0x3ff, local_404, param_5);
        uVar1 = (param_1 + 0x92);
        hwnd  = (HWND16)LAST_SEGMENT;
...

{
    ...
    if(param_5 == 0xeb)
    {
        pass1_1040_b54a(param_1, param_2, param_3, CONCAT22(0xeb, param_4), in_DX, SEG_1040, unaff_SS);
        puVar6   = mixed_1010_20ba(globals->_PTR_LOOP_1050_0ed0, 0x3, unaff_SS, in_DX, unaff_DI);
        iVar4    = puVar6 + 0xa4;
        uVar3    = (puVar6 >> 0x10);
        iStack12 = 0x0;
        HVar5    = SEG_1010;
    ...
    else
    {
        ...
        else
        {
            if(param_5 != 0x17d8)
            {
                pass1_1040_b54a(param_1, param_2, param_3, CONCAT22(param_5, param_4), in_DX, SEG_1040, unaff_SS);
                return;
            }
...

{
    ...
    pu_stack6 = mixed_1010_20ba(globals->_PTR_LOOP_1050_0ed0, 0x27, param_2, in_DX, unaff_DI);
    ...
    piVar4    = &local_1c;
    uVar7     = param_2;
    puStack36 = mixed_1010_20ba(globals->_PTR_LOOP_1050_0ed0, 0x48, param_2, (uStack24 >> 0x10), unaff_DI);
...

{
    ...
    pu_var2           = mixed_1010_20ba(globals->_PTR_LOOP_1050_0ed0, 0x2, unaff_SS, in_DX, unaff_DI);
    uVar1            = (pu_var2 + 0x6c);
...

{
    ...
    if(param_2 != 0x0)
    {
        ...
        {
            puVar3 = local_52;
            pu_var2 = mixed_1010_20ba(globals->_PTR_LOOP_1050_0ed0, 0x2, param_4, in_DX, unaff_DI);
            ...
            destroy_win_1040_7b98(CONCAT22(in_stack_00000006, param_1), SEG_1040);
        }
    }
    return;
}
...

{
    ...
    dialog_ui_fn_1040_78e2(param_1, SEG_1040);
    puVar4 = mixed_1010_20ba(globals->_PTR_LOOP_1050_0ed0, 0x2, unaff_SS, in_DX, unaff_DI);
    uVar1  = (puVar4 + 0x68);
...

{
    ...
    else
    {
        ...
        {
            post_win_msg_1040_7b3c(CONCAT22(param_2, param_1), param_3, param_4, param_4.b_0x2, SEG_1040);
            return;
        }
...

{
    ...
    if(param_2 != 0x0)
    {
        puVar1 = mixed_1010_20ba(globals->_PTR_LOOP_1050_0ed0, 0x2, unaff_SS, in_DX, unaff_DI);
...

{
    ...
    pcStack264 = param_2;
    puStack262 = param_3;
    load_string_1010_84e0(SEG_1010, globals->PCHAR_1050_14cc, (_PTR_LOOP_1050_14cc >> 0x10), 0x3ff, param_2, (short)param_3);
    load_string_1010_84e0(SEG_1010, globals->PCHAR_1050_14cc, (_PTR_LOOP_1050_14cc >> 0x10), 0x3ff, local_104, param_4);
    pass1_1000_3cea(CONCAT22(puStack262, pcStack264), CONCAT22(param_4, local_104));
    load_string_1010_84e0(SEG_1010, globals->PCHAR_1050_14cc, (_PTR_LOOP_1050_14cc >> 0x10), 0x3ff, local_104, param_4);
    pass1_1000_3cea(CONCAT22(puStack262, pcStack264), CONCAT22(param_4, local_104));
    load_string_1010_84e0(SEG_1010, globals->PCHAR_1050_14cc, (_PTR_LOOP_1050_14cc >> 0x10), 0x101, local_20a, param_4);
    MessageBox16(SEG_1010, 0x0, local_20a, param_4);
    fn_ptr_1000_17ce((Struct18 *)CONCAT22(puStack262, pcStack264), SEG_1000);
    return;
}
...

{
    ...
    pu_stack6 = mixed_1010_20ba(globals->_PTR_LOOP_1050_0ed0, 0x3, param_2, in_DX, unaff_DI);
...

{
    ...
    mem_op_1000_179c(SEG_1000, param_3, SEG_1000);
    load_string_1010_84e0(SEG_1010, globals->PCHAR_1050_14cc, (_PTR_LOOP_1050_14cc >> 0x10), 0x100, local_206, param_4);
    load_string_1010_84e0(SEG_1010, globals->PCHAR_1050_14cc, (_PTR_LOOP_1050_14cc >> 0x10), 0x3ff, param_2, (short)param_3);
    load_string_1010_84e0(SEG_1010, globals->PCHAR_1050_14cc, (_PTR_LOOP_1050_14cc >> 0x10), 0x3ff, local_104, param_4);
    ...
    pass1_1000_3cea(CONCAT22(param_3, param_2), CONCAT22(param_4, local_104));
    MessageBox16(SEG_1000, 0x0, local_206, param_4);
    fn_ptr_1000_17ce((Struct18 *)CONCAT22(param_3, param_2), SEG_1000);
    return;
}
...

{
    ...
    {
        load_string_1010_84e0(SEG_1010, globals->PCHAR_1050_14cc, (_PTR_LOOP_1050_14cc >> 0x10), 0x3ff, &local_404, (short)param_3);
...

{
    ...
    if((-0x1 < iStack8) && (u_stack6 = GetDlgItemInt16(param_6, 0x1, &local_c, param_7), local_c != 0x0))
    {
        ...
        SetFocus16((HWND16)LAST_SEGMENT);
        if((uStack10 != 0x0) && (lVar3 = unk_win_ui_op_1038_9820((Struct51 *)CONCAT22(param_2, param_1), 0x1, iStack4, LAST_SEGMENT, param_7), lVar3 != 0x0))
        {
...

{
    ...
    uStack10 = mixed_1010_20ba(globals->_PTR_LOOP_1050_0ed0, 0x48, unaff_SS, in_DX, unaff_DI);
    ...
    puVar10  = mixed_1010_20ba(globals->_PTR_LOOP_1050_0ed0, 0x3, unaff_SS, puVar7, unaff_DI);
    iVar5    = puVar10 + 0xa4;
    uVar12   = (puVar10 >> 0x10);
    iStack36 = 0x0;
    HVar6    = SEG_1010;
...

{
    ...
    puVar1 = mixed_1010_20ba(globals->_PTR_LOOP_1050_0ed0, 0x30, unaff_SS, in_DX, unaff_DI);
...

{
    ...
    *param_3 = '\0';
    ...
    if((LVar1 != -0x1) && (LVar1 = SendDlgItemMessage16((HWND16)LAST_SEGMENT, (u16)param_3, (param_3 >> 0x10), (WPARAM16)LVar1, CONCAT22(param_4, 0x40a)), LVar1 != -0x1))
    {
        return 0x1;
    }
    return 0x0;
...

{
    ...
    mem_op_1000_179c(SEG_1000, param_3, SEG_1000);
    load_string_1010_84e0(SEG_1010, globals->PCHAR_1050_14cc, (_PTR_LOOP_1050_14cc >> 0x10), 0x3ff, local_206, param_4);
    load_string_1010_84e0(SEG_1010, globals->PCHAR_1050_14cc, (_PTR_LOOP_1050_14cc >> 0x10), 0x3ff, param_2, (short)param_3);
    load_string_1010_84e0(SEG_1010, globals->PCHAR_1050_14cc, (_PTR_LOOP_1050_14cc >> 0x10), 0x3ff, local_104, param_4);
    pass1_1000_3cea(CONCAT22(param_3, param_2), CONCAT22(param_4, local_104));
    load_string_1010_84e0(SEG_1010, globals->PCHAR_1050_14cc, (_PTR_LOOP_1050_14cc >> 0x10), 0x3ff, local_104, param_4);
...

{
    ...
    {
        hwnd = SEG_1010;
        load_string_1010_84e0(SEG_1010, globals->PCHAR_1050_14cc, (_PTR_LOOP_1050_14cc >> 0x10), 0x100, local_30a, param_3);
        lp_string = local_30a;
    }
    else
    {
        u_var2 = send_dlg_item_msg_1038_8164(uVar4, uVar3, CONCAT22(param_3, local_108), 0x1854, SEG_1008);
        if(u_var2 == 0x0)
        {
            hwnd = SEG_1010;
            load_string_1010_84e0(SEG_1010, globals->PCHAR_1050_14cc, (_PTR_LOOP_1050_14cc >> 0x10), 0x100, local_208, param_3);
        }
        else
        {
            hwnd = SEG_1008;
...

{
    ...
    while(true)
    {
        ...
        if(lVar2 == 0x0)
            break;
        uVar1 = (lVar2 + 0x4);
        SendDlgItemMessage16(SEG_1008, (u16)uVar1, (uVar1 >> 0x10), 0x0, CONCAT22(param_4, 0x401));
    }
    return;
}
...

{
    ...
    if(u_stack6 == 0x0)
    {
        load_string_1010_84e0(SEG_1010, globals->PCHAR_1050_14cc, (_PTR_LOOP_1050_14cc >> 0x10), 0x100, local_108, param_3);
...

{
    ...
    if(u_stack6 != 0x0)
    {
        uVar1 = send_dlg_item_msg_1038_8164(uVar4, uVar5, CONCAT22(param_2, local_106), 0x1854, SEG_1008);
        if(uVar1 != 0x0)
        {
...

{
    ...
    puVar5          = mixed_1010_20ba(globals->_PTR_LOOP_1050_0ed0, 0x5, param_5, param_3, param_4);
    u_var2           = (puVar5 >> 0x10);
    (puVar5 + 0x12) = param_2;
    uVar3           = u_var2;
    BVar1           = bring_win_to_top_1038_b72e(_PTR_LOOP_1050_5b7c, 0x4, (HWND16)SEG_1038);
    if(BVar1 == 0x0)
    {
        pass1_1038_af40(_PTR_LOOP_1050_5b7c, (_PTR_LOOP_1050_4230 + 0x16), 0x4, uVar3, globals->_PTR_LOOP_1050_4230, SEG_1038, param_5);
    }
