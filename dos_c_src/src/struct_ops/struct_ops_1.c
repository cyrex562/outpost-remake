...
void pass1_1040_b7ee(Globals* globals, struct Struct57 *param_1, long param_2, u16 param_3)
...
void pass1_1040_a640(Globals* globals, struct Struct57 *param_1, u32 param_2, u16 param_3)
...
void  pass1_1040_4e94(struct Struct57 *param_1, long param_2, u16 param_3)
...
void  pass1_1040_3966(
  struct Struct57 *param_1, u32 param_2, u16 param_3, u16 param_4, u16 param_5, u8 *param_6, i16 param_7, u16 param_8)
...
struct Struct57 * pas1_1040_29c2(Struct57 *param_1, u32 param_2, u16 param_3, u16 param_4, u16 param_5)
...

{
    ...
    pu_var2             = mixed_1010_20ba(_PTR_LOOP_1050_0ed0, 0x3f, param_5, param_3, param_4);
    ...
    if(((&iVar8->field_0xe + 0x2) | &iVar8->field_0xe) == 0x0)
    {
        if(iVar8->field_0xc == 0x0)
        {
            if(iVar8->field_0x12 == 0x0)
            {
                ...
                {
                    paStack40->field_0x0 = addr_table_1008_380a[36]; // 0x389a
                    ...
                    uVar3->field_0xa     = 0x0;
                    uVar3->field_0xc     = 0x0;
                    paStack40->field_0x0 = addr_table_1018_56ce;//0x56ce;
    ...
    else
    {
        ...
        if((bVar15 || *ppuVar1 == puVar11) && ((bVar15 || (pu_var2 = &iVar9->field_0x16, *pu_var2 < uVar9 || *pu_var2 == uVar9))))
        {
            ...
            else
            {
                ...
                {
                    paStack26->field_0x0 = addr_table_1008_380a[36]; // 0x389a
                    ...
                    uVar8->field_0xa     = 0x0;
                    uVar8->field_0xc     = 0x0;
                    paStack26->field_0x0 = addr_table_1018_56ce; // 0x56ce
...

{
    ...
    for(u_stack6 = 0x0; u_stack6 < param_3; u_stack6 = u_stack6 + 0x1)
    {
        uVar9 = (param_4 >> 0x10);
        iVar7 = param_4;
        if(((u_stack6 * 0x4 + iVar7) != 0x0) && (uVar3 = (u_stack6 * 0x4 + iVar7), BVar4 = pass1_1008_c6ae(_PTR_LOOP_1050_06e0, (uVar3 + 0xc), 0x2e), BVar4 != 0x0))
        {
            uVar8    = (param_5 >> 0x10);
...

{
    ...
    pu_stack6 = CONCAT22(uVar8, param_3);
    uVar8    = (param_1 >> 0x10);
    iVar7    = param_1;
    if((iVar7 + 0xc) == 0x0)
    {
...

{
    ...
    pu_stack6 = CONCAT22(uVar8, param_1);
    uVar8    = (param_3 >> 0x10);
    iVar7    = param_3;
    if((iVar7 + 0xc) == 0x0)
    {
...
Struct100 * pass1_1038_28d8(Struct100 *param_1, u16 param_2, u8 param_3)
...
void  pass1_1038_2a0e(Struct100 *param_1, u32 param_2, u32 param_3, u32 param_4, u32 param_5, u16 param_6, u8 param_7)
            ...
            if(puVar10 == 0x0)
            {
                ...
                while(true)
                {
                    ...
                    if(bVar9)
                    {
                        ...
                        {
                            paStack82->field_0x0 = addr_table_1008_380a[36]; // 0x389a
                            (uVar13 + 0x2)       = SEG_1008;
                            (uVar13 + 0x4)       = 0x0;
                            (uVar13 + 0x6)       = 0x0;
                            (uVar13 + 0x8)       = 0x0;
                            (uVar13 + 0xa)       = 0x0;
                            (uVar13 + 0xc)       = 0x0;
                            paStack82->field_0x0 = addr_table_1018_56ce; // 0x56ce
                            (uVar13 + 0x2)       = SEG_1018;
                        }
        ...
        if(uVar11 != 0x0)
        {
            ...
            if(puVar8 == 0x0)
            {
                ...
                while(true)
                {
                    ...
                    {
                        paStack80->field_0x0 = addr_table_1008_380a[36]; // 0x389a
                        (uVar11 + 0x2)       = SEG_1008;
                        (uVar11 + 0x4)       = 0x0;
                        (uVar11 + 0x6)       = 0x0;
                        (uVar11 + 0x8)       = 0x0;
                        (uVar11 + 0xa)       = 0x0;
                        (uVar11 + 0xc)       = 0x0;
                        paStack80->field_0x0 = addr_table_1018_56ce; // 0x56ce
                        (uVar11 + 0x2)       = SEG_1018;
                    }
...
Struct100 * pass1_1030_e09e(Struct100 *param_1, u16 param_2, u8 param_3)
...
void  struct_1030_e2be(Struct100 *param_1, u16 param_2, u32 param_3, u32 param_4, u16 param_5, u8 param_6)
...
Struct100 * pass1_1030_e63e(Struct100 *param_1, u16 param_2, u16 param_3, u8 param_4)
...
Struct100 * pass1_1030_e79a(Struct100 *param_1, u16 param_2, u8 param_3)
...
Struct100 * pass1_1030_eb50(Struct100 *param_1, u16 param_2, u8 param_3)
...
Struct100 * pass1_1030_ecc2(Struct100 *param_1, u16 param_2, u8 param_3)
