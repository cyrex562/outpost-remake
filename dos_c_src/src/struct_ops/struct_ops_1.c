...

{
    ...
    pu_var2             = mixed_1010_20ba(globals->_PTR_LOOP_1050_0ed0, 0x3f, param_5, param_3, param_4);
...

{
    ...
    puVar9 = mixed_1010_20ba(globals->_PTR_LOOP_1050_0ed0, 0x2f, param_7, param_5, param_6);
    uVar5  = (puVar9 >> 0x10);
