...

{
    ...
    if(BVar1 != 0x0)
    {
        ...
        {
            puVar3  = mixed_1010_20ba(globals->_PTR_LOOP_1050_0ed0, 0x8, param_6, param_4, param_5);
            param_4 = (puVar3 >> 0x10);
            pass1_1010_988c(puVar3, (param_1 + 0xc));
        }
        pu_stack6 = mixed_1010_20ba(globals->_PTR_LOOP_1050_0ed0, 0x2f, param_6, param_4, param_5);
...
{
    struct_1028_0954(param_1);
    *param_1        = addr_table_1020_cc7c;//0xcc7c;
    param_1->field_0x2 = SEG_1020;
    return param_1;
}
...

{
    ...
    uVar1            = (param_1 >> 0x10);
    (param_1 + 0x20) = 0x0;
    *param_1         = addr_table_1020_d53e;//0xd53e;
    param_1->field_0x2 = SEG_1020;
    return param_1;
}
...

{
    ...
    (iVar1 + 0xfa) = 0x0;
    (iVar1 + 0xfc) = 0x0;
    *param_1       = addr_table_1020_2e4a;//0x2e4a;
    (iVar1 + 0x2)  = SEG_1020;
...

{
    ...
    *param_1          = addr_table_1008_3aa0[4]; // 0x3ab0;
    ...
    iVar2->field_0xa  = 0x0;
    iVar2->field_0xc  = 0x0;
    *param_1          = addr_table_1020_0dbc;//0xdbc;
    iVar2->field_0x2  = SEG_1020;
    puVar3            = mixed_1010_20ba(globals->_PTR_LOOP_1050_0ed0, 0x7, param_4, param_3, unaff_DI);
    puVar1            = (puVar3 >> 0x10);
    ...
    uVar6             = u_var2;
    puVar3            = mixed_1010_20ba(globals->_PTR_LOOP_1050_0ed0, 0x48, param_4, puVar1, unaff_DI);
...

{
    ...
    u_var2          = (param_1 >> 0x10);
    iVar1          = param_1;
    *param_1       = addr_table_1018_5a62;//0x5a62; //s_Alloc__s_1050_5a5b + 0x7;
    (iVar1 + 0x2)  = SEG_1018;
...

{
    ...
    *param_1         = addr_table_1008_380a[36]; // 0x389a
    ...
    iVar1->field_0xc = 0x0;
    *param_1         = addr_table_1018_4a8a[7];//0x4aa6; //&PTR_LOOP_1050_4aa6;
    iVar1->field_0x2 = SEG_1018;
}
...

{
    ...
    *param_1         = addr_table_1018_4a8a[2];//0x4a92;
    iVar1->field_0x2 = SEG_1018;
    iVar1->field_0xc = 0x1;
    return param_1;
}
...

{
    ...
    *param_1          = addr_table_1018_4a8a[4];//0x4a9a; //&PTR_LOOP_1050_4a9a;
    iVar1->field_0x2  = SEG_1018;
    iVar1->field_0xc  = 0x2;
}
...

{
    ...
    iVar1          = param_1;
    *(iVar1 + 0xe) = param_4;
    *param_1       = addr_table_1018_4a8a[6];//0x4aa2; &PTR_LOOP_1050_4aa2;
    (iVar1 + 0x2)  = SEG_1018;
    (iVar1 + 0xc)  = 0x3;
}
...

{
    ...
    *param_1          = addr_table_1018_4a8a[1];//0x4a8e; &PTR_LOOP_1050_4a8e;
    iVar1->field_0x2  = SEG_1018;
    iVar1->field_0xc  = 0x4;
    return param_1;
}
...

{
    ...
    iVar1->field_0xe = param_4;
    *param_1         = addr_table_1018_4a8a[3];//0x4a96; // &PTR_LOOP_1050_4a96;
    iVar1->field_0x2 = SEG_1018;
    iVar1->field_0xc = 0x5;
    return param_1;
}
...

{
    ...
    iVar1         = param_1;
    (iVar1 + 0xe) = param_4;
    *param_1      = addr_table_1018_4a8a[5];//0x4a9e;
    (iVar1 + 0x2) = SEG_1018;
    (iVar1 + 0xc) = 0x6;
    return param_1;
}
...

{
    ...
    iVar1->field_0xe = param_4;
    *param_1         = addr_table_1018_4a8a;//0x4a8a; // &PTR_LOOP_1050_4a8a;
    iVar1->field_0x2 = SEG_1018;
    iVar1->field_0xc = 0x7;
    return;
}
...

{
    ...
    puVar5                      = mixed_1010_20ba(globals->_PTR_LOOP_1050_0ed0, 0x2f, param_3, (puVar5 >> 0x10), unaff_DI);
...

{
    ...
    param_1->field_0x2         = SEG_1018;
    param_1->field_0x1c_addr_base        = addr_table_1018_2ada[6];//0x2af2; // s_fem132_wav_1050_2aec + 0x6;
