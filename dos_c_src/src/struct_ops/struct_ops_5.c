...
void struct_1010_3b7a(Struct79 *param_1, u16 param_3)
...

{
    ...
    *param_1          = addr_table_1008_dd4a;//0xdd4a;
    iVar1->field_0x2  = SEG_1008;
    return;
}
...

{
    ...
    u_var2         = (param_1 >> 0x10);
    iVar1         = param_1;
    *param_1      = addr_table_1008_051e[3]//0x052a;
    (iVar1 + 0x2) = SEG_1008;
    (iVar1 + 0x4) = 0x0;
    (iVar1 + 0x8) = 0x0;
    *param_1      = addr_table_1008_051e;//0x51e;
    (iVar1 + 0x2) = SEG_1008;
    return;
}
