...
//    param_1  = (Struct307 *)param_1;
    param_1  = (Struct307 *)&param_1->field_0x4;
...

{
    ...
    if((param_3 != 0x0) && (BVar2 = read_file_1008_7dee(uVar6, uVar8, &local_4, 0x0, unaff_SS, 0x2, SEG_1008), BVar2 != 0x0))
    {
        while(local_4 != 0x0)
        {
            ...
            file_1038_774e(
              NULL, CONCAT22(puVar5, uVar3), CONCAT22(uVar9, uVar7), puVar5, unaff_SS);
            if(uVar3 == 0x0)
            {
                return 0x0;
            }
...
//    iVar4  = (Struct401 *)param_1;
    param_1  = (Struct401 *)param_1->field_0x4;
//    uVar3  = (param_1 >> 0x10);
    uVar9  = param_2;
    uVar10 = (param_2 >> 0x10);
...
//    iVar2 = (Struct731 *)param_1;
    param_1 = (Struct731 *)&param_1->field_0xc;
    ...
    pass1_1008_5784(CONCAT22(param_4, local_26), param_1->field_0x3a);
    while(true)
    {
        puVar5 = local_26;
        ...
        if((extraout_DX | puVar5) == 0x0)
        {
            ...
            pass1_1008_5784(CONCAT22(param_4, local_26), param_1->field_0x3e);
            while(true)
            {
                puVar5 = local_26;
                pass1_1008_5b12(puVar5, param_4);
...
//        iVar3 = (Struct387 *)param_1;
        param_1 = (Struct387 *)&param_1->field_0xc;
...

{
    ...
    if(param_3 != 0x0)
    {
        ...
        uStack1034 = CONCAT22(globals->PTR_LOOP_1050_5f2e, uVar3);
        ...
        {
            puVar11         = pass1_1008_3e38(CONCAT22(globals->PTR_LOOP_1050_5f2e, uVar3 + 0x4));
            puVar8          = (puVar11 >> 0x10);
            ...
            *puVar11        = uVar5;
            ...
            if(BVar6 != 0x0)
            {
                ...
                if(BVar6 != 0x0)
                {
                    ...
                    {
                    LAB_1030_5fb7:
                        puVar11 = mixed_1010_20ba(globals->u16_1050_0ed0, 0x2f, param_5, puVar8, unaff_DI);
...

{
    ...
    plVar3                      = &local_a;
    globals->dat_1050_5f2e      = read_file_1030_4e70(param_1, CONCAT22(param_2, plVar3), (u8 **)CONCAT22(param_2, &local_6), (long)s_bldgops_dat_1050_5708, param_3);
    pcVar2                      = local_6;
    if(plVar3 != (long *)0x0)
    {
        uVar10 = param_1;
        ...
        uVar9    = uVar5;
        uStack28 = CONCAT22(globals->PTR_LOOP_1050_5f2e, uVar5);
...
//    uVar12 = (param_1 >> 0x10);
    ...
    if(param_3 != 0x0)
    {
        ...
        {
            pass1_1030_84ae(CONCAT22(globals->PTR_LOOP_1050_5f2e, uVar4));
        }
...
//    iVar2 = (Struct430 *)param_1;
    param_1 = (Struct430 *)&param_1->field_0x4;
//    uVar1 = (param_1 >> 0x10);
    uVar3 = param_2;
    uVar4 = (param_2 >> 0x10);
