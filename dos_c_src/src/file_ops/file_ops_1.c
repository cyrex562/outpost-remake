...

{
    ...
    pass1_1008_766e(param_2, puVar5, param_4, SEG_1008, param_3);
    if(puVar5 != 0x0)
    {
        uVar1 = (param_1 >> 0x10);
        uVar4 = param_2;
        uVar6 = (param_2 >> 0x10);
        BVar2 = read_file_1008_7dee(uVar4, uVar6, &iVar2->field_0x8, 0x0, uVar1, 0x4, SEG_1008);
        if((((((BVar2 != 0x0) && (iVar3 = file_1008_77cc(param_2, (long *)(param_1 & 0xffff0000 | &iVar2->field_0xe), param_3, SEG_1008, param_4), iVar3 != 0x0))
              && (BVar2 = read_file_1008_7dee(uVar4, uVar6, &local_4, 0x0, param_4, 0x2, SEG_1008), BVar2 != 0x0))
             && ((BVar2 = read_file_1008_7dee(uVar4, uVar6, &local_6, 0x0, param_4, 0x2, SEG_1008), BVar2 != 0x0 && (BVar2 = read_file_1008_7dee(uVar4, uVar6, &local_8, 0x0, param_4, 0x2, SEG_1008), BVar2 != 0x0))))
            && ((BVar2 = read_file_1008_7dee(uVar4, uVar6, &iVar2->field_0x16, 0x0, uVar1, 0x4, SEG_1008),
                 BVar2 != 0x0
                   && ((BVar2 = read_file_1008_7bc8(param_2, (param_1 & 0xffff0000 | &iVar2->field_0x1a_addr_offset), SEG_1008, param_4),
                        BVar2 != 0x0 && (BVar2 = read_file_1008_7dee(uVar4, uVar6, &iVar2->field_0x20, 0x0, uVar1, 0x4, SEG_1008), BVar2 != 0x0))))))
           && ((BVar2 = read_file_1008_7dee(uVar4, uVar6, &iVar2->field_0x24, 0x0, uVar1, 0x2, SEG_1008),
                BVar2 != 0x0
                  && ((BVar2 = read_file_1008_7dee(uVar4, uVar6, &iVar2->field_0x26, 0x0, uVar1, 0x2, SEG_1008), BVar2 != 0x0 && (BVar2 = read_file_1008_7dee(uVar4, uVar6, &iVar2->field_0x28, 0x0, uVar1, 0x2, SEG_1008), BVar2 != 0x0))))))
        {
...

{
    ...
    local_6 = 0x0;
    pu_var2  = &local_6;
    file_1008_7548(param_2, (long *)CONCAT22(param_5, pu_var2), SEG_1008, param_5);
    if(pu_var2 != 0x0)
    {
        uVar8            = (param_1 >> 0x10);
        ...
        uVar9            = param_2;
        uVar10           = (param_2 >> 0x10);
        BVar3            = read_file_1008_7dee(uVar9, uVar10, &iVar9->field_0x10, 0x0, uVar8, 0x4, SEG_1008);
        if(((((BVar3 != 0x0) && (BVar3 = read_file_1008_7dee(uVar9, uVar10, &iVar9->field_0x18, 0x0, uVar8, 0x2, SEG_1008), BVar3 != 0x0))
             && (BVar3 = read_file_1008_7dee(uVar9, uVar10, &iVar9->field_0x1a_addr_offset, 0x0, uVar8, 0x2, SEG_1008), BVar3 != 0x0))
            && ((BVar3 = read_file_1008_7dee(uVar9, uVar10, &local_8, 0x0, param_5, 0x2, SEG_1008), BVar3 != 0x0 && (BVar3 = read_file_1008_7dee(uVar9, uVar10, &iVar9->field_0x1e, 0x0, uVar8, 0x4, SEG_1008), BVar3 != 0x0))))
           && (BVar3 = read_file_1008_7dee(uVar9, uVar10, &iVar9->field_0x22, 0x0, uVar8, 0x2, SEG_1008), BVar3 != 0x0))
        {
            iVar9->field_0x1c_addr_base = local_8;
            BVar3             = read_file_1008_7dee(uVar9, uVar10, &iVar9->field_0x24, 0x0, uVar8, 0x2, SEG_1008);
            if((BVar3 != 0x0) && (uVar4 = read_file_1008_7dee(uVar9, uVar10, &iVar9->field_0x26, 0x0, uVar8, 0x94, SEG_1008), uVar4 != 0x0))
            {
                if(PTR_LOOP_1050_0312 < 0x2)
                {
                    uVar5  = 0x54;
                    SVar11 = 0x54;
                    mem_op_1000_179c(0x54, param_4, SEG_1000);
                ...
                puVar6 = local_408;
                read_file_1008_7c6e(uVar9, uVar10, CONCAT22(param_5, puVar6), SEG_1008);
                if(puVar6 != 0x0)
                {
                    ...
                    if(((((BVar3 != 0x0) && (BVar3 = read_file_1008_7dee(uVar9, uVar10, CONCAT11((param_1 >> 0x8) + '\x02', param_1), 0x0, uVar8, 0x4, SEG_1008), BVar3 != 0x0))
                         && (BVar3 = read_file_1008_7dee(uVar9, uVar10, &iVar9->field_0x204, 0x0, uVar8, 0x2, SEG_1008), BVar3 != 0x0))
                        && ((
                          (BVar3 = read_file_1008_7dee(uVar9, uVar10, &iVar9->field_0x206, 0x0, uVar8, 0x2, SEG_1008), BVar3 != 0x0 && (BVar3 = read_file_1008_7dee(uVar9, uVar10, &iVar9->field_0x208, 0x0, uVar8, 0x2, SEG_1008), BVar3 != 0x0))
                          && ((BVar3 = read_file_1008_7dee(uVar9, uVar10, &iVar9->field_0x20a, 0x0, uVar8, 0x2, SEG_1008),
                               BVar3 != 0x0
                                 && ((BVar3 = read_file_1008_7dee(uVar9, uVar10, &iVar9->field_0x20c, 0x0, uVar8, 0x2, SEG_1008),
                                      BVar3 != 0x0 && (BVar3 = read_file_1008_7dee(uVar9, uVar10, &iVar9->field_0x20e, 0x0, uVar8, 0x2, SEG_1008), BVar3 != 0x0))))))))
...

{
    ...
    if(((param_3 != 0x0) && (0x1 < globals->PTR_LOOP_1050_0312)) && (BVar1 = read_file_1008_7dee(param_2, (param_2 >> 0x10), param_1 + 0x20, 0x0, (param_1 >> 0x10), 0x4, SEG_1008), BVar1 == 0x0))
    {
        globals->PTR_LOOP_1050_0310 = 0x6d2;
        return;
    }
...

{
    ...
    uVar9  = param_2;
    uVar10 = (param_2 >> 0x10);
    BVar4  = read_file_1008_7dee(uVar9, uVar10, iVar4, 0x0, uVar3, 0x4, SEG_1008);
    if(((BVar4 == 0x0) || (BVar4 = read_file_1008_7bc8(param_2, (param_1 & 0xffff0000 | &iVar4->field_0x8), SEG_1008, param_4), BVar4 == 0x0)) || (BVar4 = read_file_1008_7dee(uVar9, uVar10, &local_4, 0x0, param_4, 0x2, SEG_1008), BVar4 == 0x0))
    {
        globals->PTR_LOOP_1050_0310 = 0x6d2;
    }
    else
    {
        ...
        if(BVar4 != 0x0)
        {
            while(true)
            {
                ...
                local_12[0] = local_12[0] - 0x1;
                uVar12      = param_2;
                mem_op_1000_179c(0x2a, param_3, SEG_1000);
...

{
    ...
    iVar3 = write_to_file_1008_7b4c(param_2, param_1 & 0xffff0000 | ZEXT24(iVar2), SEG_1008, param_4);
    if(iVar3 == 0x0)
    {
        globals->PTR_LOOP_1050_0310 = 0x6d0;
        return;
    ...
    write_to_file_1008_7954(param_2, iVar2->field_0x1e, BVar4, SEG_1008, param_4);
    if(BVar4 == 0x0)
    {
        globals->PTR_LOOP_1050_0310 = 0x6d0;
        return;
    }
    write_to_file_1008_7a22(param_2, iVar2->field_0x22, SEG_1008, param_4);
    if(BVar4 == 0x0)
    {
        globals->PTR_LOOP_1050_0310 = 0x6d0;
        return;
    }
    write_to_file_1008_7a22(param_2, iVar2->field_0x26, SEG_1008, param_4);
    if(BVar4 == 0x0)
    {
        globals->PTR_LOOP_1050_0310 = 0x6d0;
        return;
    ...
    pass1_1008_79f0(param_2, iVar2->field_0x36, SEG_1008, param_4);
    if(BVar4 == 0x0)
    {
        globals->PTR_LOOP_1050_0310 = 0x6d0;
        return;
...

{
    ...
    if(param_3 != 0x0)
    {
        ...
        BVar3 = read_file_1008_7bc8(param_2, (param_1 & 0xffff0000 | ZEXT24(iVar3)), SEG_1008, param_5);
        if(BVar3 != 0x0)
        {
            uVar13 = param_2;
            uVar14 = (param_2 >> 0x10);
            ...
            if(BVar3 != 0x0)
            {
                ...
                if(BVar3 != 0x0)
                {
                    ...
                    BVar3             = read_file_1008_7dee(uVar13, uVar14, &iVar3->field_0x16, 0x0, uVar11, 0x4, SEG_1008);
                    if(BVar3 != 0x0)
                    {
                        plVar7 = (long *)(param_1 & 0xffff0000 | &iVar3->field_0x1e);
                        file_1008_76e4(param_2, plVar7, SEG_1008, param_5, param_4);
                        if((((plVar7 != 0x0) && (iVar6 = file_1008_77cc(param_2, (long *)(param_1 & 0xffff0000 | &iVar3->field_0x22), param_4, SEG_1008, param_5), iVar6 != 0x0))
                            && (iVar6 = file_1008_77cc(param_2, (long *)(param_1 & 0xffff0000 | &iVar3->field_0x26), param_4, SEG_1008, param_5), iVar6 != 0x0))
                           && (BVar3 = read_file_1008_7dee(uVar13, uVar14, &iVar3->field_0x2a, 0x0, uVar11, 0x4, SEG_1008), BVar3 != 0x0))
                        {
                            ...
                            BVar3 = read_file_1008_7dee(uVar13, uVar14, &iVar3->field_0x32, 0x0, uVar11, 0x2, SEG_1008);
                            if((BVar3 != 0x0) && (BVar3 = read_file_1008_7dee(uVar13, uVar14, &iVar3->field_0x34, 0x0, uVar11, 0x2, SEG_1008), BVar3 != 0x0))
                            {
...

{
    ...
    if(param_3 != 0x0)
    {
        ...
        uVar3      = fn_ptr_op_1000_1708(0x10, 0x0, 0x1, globals->PTR_LOOP_1050_5f2c, globals->PTR_LOOP_1050_5f2e, SEG_1000);
        ...
        uVar3  = param_2;
        uVar14 = (param_2 >> 0x10);
        read_file_1008_7c6e(uVar3, uVar14, CONCAT22(param_5, puVar4), SEG_1008);
        if(puVar4 != 0x0)
        {
            ...
            *puVar11        = uVar5;
            ...
            if(BVar6 != 0x0)
            {
                ...
                if(BVar6 != 0x0)
                {
                    ...
                    uVar5 = (iVar9 + 0xa) * 0x2;
                    uVar7 = uVar5;
                    mem_op_1000_179c(uVar5, puVar8, SEG_1000);
                    u_var2         = (iVar12 + 0x10);
                    uVar10        = (u_var2 >> 0x10);
                    iVar9         = u_var2;
                    (iVar9 + 0xc) = uVar7;
    ...
    if(param_4 != 0x0)
    {
        ...
        if(uVar1 == 0x0)
        {
            *param_2 = uStack20;
            ...
            if(HVar2 != 0xffff)
            {
                lVar5           = mem_op_1000_0a48(0x1, *param_2, (*param_2 >> 0x10), globals->_PTR_LOOP_1050_5f2c, SEG_1000);
                param_5         = (lVar5 >> 0x10);
                param_3         = lVar5;
                (param_3 + 0x2) = param_5;
                if((param_5 | param_3) != 0x0)
                {
                    lStack56 = WIN16_hread(SEG_1000, (SEGPTR)*param_2, CONCAT22(*param_3, (*param_2 >> 0x10)));
                    uVar3    = (lStack56 >> 0x10);
...

{
    ...
    if(plVar3 != (long *)0x0)
    {
        ...
        uVar5    = fn_ptr_op_1000_1708(uVar4 * 0xae, 0x0, 0x1, globals->PTR_LOOP_1050_5f2c, globals->PTR_LOOP_1050_5f2e, SEG_1000);
        uVar9    = uVar5;
...

{
    ...
    if(param_3 != 0x0)
    {
        ...
        uVar4  = fn_ptr_op_1000_1708(0x20, 0x0, 0x1, globals->PTR_LOOP_1050_5f2c, globals->PTR_LOOP_1050_5f2e, SEG_1000);
        ...
        if(BVar5 != 0x0)
        {
            ...
            {
                puVar6 = local_408;
                read_file_1008_7c6e(uVar4, uVar11, CONCAT22(param_5, puVar6), SEG_1008);
                if(puVar6 != 0x0)
                {
                    ...
                    if(BVar5 != 0x0)
                    {
                        ...
                        iVar2 = (uVar8 + 0x1a);
                        uVar7 = iVar2 * 0x6;
                        mem_op_1000_179c(uVar7, puVar9, SEG_1000);
                        ...
                        BVar5 = read_file_1008_7bc8(param_2, (param_1 & 0xffff0000 | &iVar12->field_0x14), SEG_1008, param_5);
                        if((BVar5 != 0x0) && (BVar5 = read_file_1008_7dee(uVar4, uVar11, &iVar12->field_0x1c_addr_base, 0x0, uVar12, 0x2, SEG_1008), BVar5 != 0x0))
                        {
                            return;
                        }
                    }
...

{
    ...
    uVar3 = param_2;
    uVar4 = (param_2 >> 0x10);
    BVar2 = read_file_1008_7dee(uVar3, uVar4, iVar2, 0x0, uVar1, 0x16c, SEG_1008);
    if(((((BVar2 != 0x0) && (BVar2 = read_file_1008_7dee(uVar3, uVar4, &iVar2->field_0x174, 0x0, uVar1, 0xc, SEG_1008), BVar2 != 0x0)) && (BVar2 = read_file_1008_7dee(uVar3, uVar4, &iVar2->field_0x180, 0x0, uVar1, 0xc, SEG_1008), BVar2 != 0x0))
        && ((BVar2 = read_file_1008_7dee(uVar3, uVar4, &iVar2->field_0x18c, 0x0, uVar1, 0x18, SEG_1008), BVar2 != 0x0 && (BVar2 = read_file_1008_7dee(uVar3, uVar4, &iVar2->field_0x1a8, 0x0, uVar1, 0x2, SEG_1008), BVar2 != 0x0))))
       && (BVar2 = read_file_1008_7dee(uVar3, uVar4, &iVar2->field_0x1aa, 0x0, uVar1, 0x4, SEG_1008), BVar2 != 0x0))
    {
        if(PTR_LOOP_1050_0312 < 0x2)
        {
            return;
        }
        BVar2 = read_file_1008_7dee(uVar3, uVar4, &iVar2->field_0x170, 0x0, uVar1, 0x4, SEG_1008);
        if((BVar2 != 0x0) && (BVar2 = read_file_1008_7dee(uVar3, uVar4, &iVar2->field_0x1ae, 0x0, uVar1, 0x2, SEG_1008), BVar2 != 0x0))
        {
            return;
        }
    }
