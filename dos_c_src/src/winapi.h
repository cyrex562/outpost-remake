...
// i1616                       GetModuleFileName16(HINSTANCE16 h_module, LPSTR lp_file_name, i1616 n_size);
...
// HFILE16                     _lcreat16(LPCSTR path, i1616 attr);
// long                        _llseek16(HFILE16 h_file, long l_offset, i1616 n_origin);
// HFILE16                     _lopen16(LPCSTR path, i1616 mode);
// i1616                       lstrlen16(LPCSTR str);
...
// i1616                       GetPrivateProfileString16(LPCSTR section, LPCSTR entry, LPCSTR def_val, LPSTR buffer, u16 len, LPCSTR filename);
...
// BOOL16                      LineTo16(HDC16 hdc, i1616 x, i1616 y);
// DWORD                       MoveTo16(HDC16 hdc, i1616 x, i1616 y);
// BOOL16                      Ellipse16(HDC16 hdc, i1616 left, i1616 top, i1616 right, i1616 bottom);
// BOOL16                      Rectangle16(HDC16 hdc, i1616 left, i1616 top, i1616 right, i1616 bottom);
// BOOL16                      TextOut16(HDC16 hdc, i1616 x, i1616 y, char *str, i1616 count);
// BOOL16                      Polygon16(HDC16 hdc, POi1616 *pt, i1616 count);
...
// DWORD                       GetTextExtent16(HDC16 hdc, LPCSTR str, i1616 count);
...
// i1616                       StretchDIBits16(HDC16 hdc, i1616 x_dst, i1616 y_dst, i1616 width_dst, i1616 height_dst, i1616 x_src, i1616 y_src, i1616 width_src, i1616 height_src, PVOID bits, BITMAPINFO *info, u16 w_usage, DWORD dw_rop);
// i1616                       SetDIBitsToDevice(HDC16 hdc, i1616 x_dest, i1616 y_dest, i1616 cx, i1616 cy, i1616 x_src, i1616 y_src, u16 startscan, u16 lines, LPCVOID bits, BITMAPINFO *info, u16 coloruse);
// BOOL16                      MoveToEx16(HDC16 hdc, i1616 x, i1616 y, POi1616 *pt);
// i1616                       MessageBox16(HWND16 hwnd, LPCSTR text, LPCSTR title, u16 type);
i16 InitApp16(HINSTANCE16 h_instance);
// void                        PostQuitMessage16(i1616 exit_code);
...
// i1616                       GetWindowText16(HWND16 hwnd, SEGPTR lp_string, i1616 n_max_count);
...
// HWND16                      CreateWindow16(LPCSTR class_name, LPCSTR window_name, DWORD style, i1616 x, i1616 y, i1616 width, i1616 height, HWND16 parent, HMENU16 hmenu, HINSTANCE16 instance, LPVOID data);
// BOOL16                      ShowWindow16(HWND16 hwnd, i1616 cmd);
...
// BOOL16                      MoveWindow16(HWND16 hwnd, i1616 x, i1616 y, i1616 cx, i1616 cy, BOOL16 repai16);
// ATOM                        RegisterClass16(WNDCLASS16 *wc);
// HDC16                       GetDC16(HWND16 hwnd);
// HDC16                       GetWindowDC16(HWND16 hwnd);
// i1616                       ReleaseDC16(HWND16 hwnd, HDC16 hdc);
// HCURSOR16                   SetCursor16(HCURSOR16 hcursor);
// i1616                       ShowCursor16(BOOL16 b_show);
// BOOL16                      PtInRect16(RECT16 *rect, POi1616 pt);
// i1616                       FillRect16(HDC16 hdc, RECT16 *rect, HBRUSH16 hbrush);
// i1616                       FrameRect16(HDC16 hdc, RECT16 *rect, HBRUSH16 hbrush);
// BOOL16                      DrawIcon16(HDC16 hdc, i1616 x, i1616 y, HICON16 h_icon);
// i1616                       DrawText16(HDC16 hdc, LPCSTR str, i1616 count, RECT16 *rect, u16 flags);
...
// HWND16                      GetDlgItem16(HWND16 hwnd_dlg, i1616 id);
// void                        SetDlgItemText16(HWND16 hwnd, i1616 id, SEGPTR lp_string);
// void                        SetDlgItemi1616(HWND16 hwnd, i1616 id, u16 value, BOOL16 f_signed);
// u16                         GetDlgItemi1616(HWND16 hwnd, i1616 id, BOOL16 *translated, BOOL16 f_signed);
// BOOL16                      CheckRadioButton16(HWND16 hwnd_dlg, u16 first_id, u16 last_id, u16 check_id);
// BOOL16                      CheckDlgButton16(HWND16 hwnd, i1616 id, u16 check);
// u16                         IsDlgButtonChecked(HWND16 hwnd, u16 id);
// LRESULT                     SendDlgItemMessage16(HWND16 hwnd, i1616 id, u16 msg, WPARAM16 w_param, LPARAM l_param);
...
// WORD                        GetWindowWord16(HWND16 hwnd, i1616 offset);
// WORD                        SetWindowWord16(HWND16 hwnd, i1616 offset, WORD newval);
// long                        GetWindowLong16(HWND16 hwnd, i1616 offset);
// long                        SetWindowLong16(HWND16 hwnd, i1616 offset, long newval);
...
// HMENU16                     GetSubMenu16(HMENU16 h_menu, i1616 n_pos);
...
// i1616                       LoadString16(HINSTANCE16 instance, u16 resource_id, LPSTR buffer, i1616 buf_len);
// HACCEL16                    LoadAccelerators16(HINSTANCE16 instance, LPCSTR lp_table_name);
// i1616                       TranslateAccelerator16(HWND16 hwnd, HACCEL16 haccel, MSG16 *msg);
// i1616                       GetSystemMetrics16(i1616 index);
// COLORREF                    GetSysColor16(i1616 index);
// void                        SetSysColors16(i1616 count, i1616 *list, COLORREF *values);
// BOOL16                      GrayString16(HDC16 hdc, HBRUSH16 param_2, LPVOID gsprc, LPARAM lparam, i1616 cch, i1616 x, i1616 y, i1616 cx, i1616 cy);
// HWND16                      SetSysModalWindow(HWND16 hwnd);
// HWND16                      GetNextDlgTabItem16(HWND16 hwnd_dlg, HWND16 hwnd_ctrl, BOOL16 f_previous);
// BOOL16                      SetWindowPos16(HWND16 hwnd, HWND16 hwnd_insert_after, i1616 x, i1616 y, i1616 cx, i1616 cy, WORD flags);
// u16                         GetMenuState16(HMENU16 hmenu, u16 w_item_id, u16 w_flags);
// i1616                       GetDlgCtrlID16(HWND16 hwnd);
...
// BOOL16                      TrackPopupMenu16(HMENU16 hmenu, u16 wflags, i1616 x, i1616 y, i1616 n_reserved, HWND16 hwnd, RECT16 *lp_rect);
// i1616                       wspri16f16(LPSTR buffer, LPCSTR spec, WORD *valist);
// i1616                       wvspri16f16(LPSTR buffer, LPCSTR spec, WORD *args);
// HWND16                      CreateWIndowEx16(DWORD ex_style, LPCSTR class_name, LPCSTR window_name, DWORD style, i1616 x, i1616 y, i1616 width, i1616 height, HWND16 parent, HMENU16 hmenu, HINSTANCE16 instance, LPVOID data);
