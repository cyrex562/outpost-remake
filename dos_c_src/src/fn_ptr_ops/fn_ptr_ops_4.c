...

{
    ...
    {
        fn_ptr_1000_17ce(*(Struct18 **)(param_1 + 0x6), 0x1000);
    }
...

{
    ...
    while(true)
    {
        ...
        uVar6  = (uVar4 >> 0x10);
        iVar5  = uVar4;
        paVar3 = *(Struct18 **)(iVar5 + iStack4 * 0x4);
