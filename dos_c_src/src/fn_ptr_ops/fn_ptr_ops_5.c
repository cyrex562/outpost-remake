...

{
    ...
    *param_1        = &PTR_LOOP_1050_4a8e;
    (param_1 + 0x2) = 0x1018;
    fn_ptr_1000_17ce(*(Struct18 **)(param_1 + 0x10), 0x1000);
    pass1_1018_4760(param_1);
    return;
}
...

{
    ...
    fn_ptr_1000_17ce(*(Struct18 **)&iVar3->field_0x186, 0x1000);
