...

{
    ...
    if(PTR_LOOP_1050_5f2e == (undefined *)0x0)
    {
        if(*param_1 == 0x0)
        {
            ...
            uVar3
              = fn_ptr_op_1000_1708(uVar2 * 0x6, 0x0, 0x1, (uint)PTR_LOOP_1050_5f2c, (uint)PTR_LOOP_1050_5f2e, 0x1000);
        }
        else
        {
            lVar5 = pass1_1000_0ed4(
              0x1000, param_3, 0x1, uVar2 * 0x6, 0x0, (ushort *)*param_1, (ushort)((ulong)*param_1 >> 0x10));
...

{
    ...
    plVar3             = &local_a;
    PTR_LOOP_1050_5f2e = (undefined *)read_file_1030_4e70(param_3,
                                                          (undefined4 *)CONCAT22(param_1, plVar3),
                                                          (byte **)CONCAT22(param_1, &local_6),
                                                          (long)s_bldgbld_dat_1050_56fc,
                                                          param_2);
    pcVar2             = local_6;
    if(plVar3 != (long *)0x0)
    {
        ...
        uVar4 = fn_ptr_op_1000_1708(
          (uint)pcVar6 * 0x98, 0x0, 0x1, (uint)PTR_LOOP_1050_5f2c, (uint)PTR_LOOP_1050_5f2e, 0x1000);
    ...
    *(undefined4 *)(param_2 + -0x8) = 0x0;
    if(*(long *)(param_1 + 0x4) == 0x0)
    {
        ...
        uVar5 = fn_ptr_op_1000_1708(
          *(int *)(param_2 + -0x4) << 0x2, 0x0, 0x1, (uint)PTR_LOOP_1050_5f2c, (uint)PTR_LOOP_1050_5f2e, 0x1000);
    }
    else
    {
        uVar3              = *(undefined4 *)(param_1 + 0x4);
        uVar2              = *(uint *)(param_2 + -0x4);
        lVar7              = pass1_1000_0ed4(0x1000,
                                param_4,
                                0x1,
                                uVar2 * 0x4,
                                ((int)PTR_LOOP_1050_5f2e * 0x2 + (uint)CARRY2(uVar2, uVar2)) * 0x2
                                  + (uint)CARRY2(uVar2 * 0x2, uVar2 * 0x2),
                                (ushort *)uVar3,
...

{
    ...
    else
    {
        ...
        lVar5              = pass1_1000_0ed4(0x1000,
                                param_2,
                                0x1,
                                uVar3 * 0x4,
                                ((int)PTR_LOOP_1050_5f2e * 0x2 + (uint)CARRY2(uVar3, uVar3)) * 0x2
                                  + (uint)CARRY2(uVar3 * 0x2, uVar3 * 0x2),
                                (ushort *)lVar5,
                                (ushort)((ulong)lVar5 >> 0x10));
        PTR_LOOP_1050_5f2e = (undefined *)((ulong)lVar5 >> 0x10);
        uVar3              = (uint)lVar5;
    }
...

{
    ...
    while(true)
    {
        ...
        if(((uVar5 | (uint)uVar7) == 0x0)
           || (puVar1 = (ulong *)((uint)uVar7 + 0xc), uVar2 <= *puVar1 && *puVar1 != uVar2))
            break;
...

{
    ...
    paVar2
      = (astruct_18 *)pass1_1028_e0bc(_PTR_LOOP_1050_65e2, *(int *)((int)param_1 + 0xc), param_2, param_3, param_4);
...
void __stdcall16far pass1_1028_a3ae(
  ushort param_1, ushort param_2, ulong param_3, long param_4, int param_5, ushort param_6, uchar param_7, int param_8)

{
    ...
    if((((puVar6 == (uchar *)0x0) && (*(long *)(iVar9 + 0x200) != 0x8000002))
        && (pass1_1030_38b8(), -0x1 < (int)puVar6))
    ...
    uVar7    = (uStack16 * 0x5 + (uint)CARRY2(uStack18, uStack18) * 0x2 + (uint)CARRY2(uStack18 * 0x2, uStack18 * 0x2)
             + (uint)CARRY2(uStack18 * 0x4, uStack18))
            * 0x2
          + (uint)CARRY2(uStack18 * 0x5, uStack18 * 0x5);
    uStack22 = CONCAT22(uVar7, uVar4);
    if((uVar7 <= uStack14._2_2_) && ((uVar7 < uStack14._2_2_ || (uVar4 < (uint)uStack14))))
    {
        pass1_1028_ae66((astruct_100 *)CONCAT22(param_6, &local_146),
                        uStack14,
                        CONCAT22(uVar7, uVar4),
                        *(ulong *)(iVar9 + 0x4),
                        param_6,
                        param_7);
...

{
    ...
    ppuVar4 = ppuVar1;
    pass1_1030_64ce(param_3,
                    ppuVar1,
                    param_2,
                    _PTR_LOOP_1050_5740,
                    (ushort *)(param_1 & 0xffff0000 | ZEXT24(ppuVar1)),
                    *(long *)(iVar11 + 0x108),
                    (ulong *)CONCAT22(param_3, local_26));
    uStack6 = *ppuVar4;
    uVar15  = (undefined)(param_3 >> 0x8);
    pass1_1008_3eb4((ushort *)(param_1 & 0xffff0000 | ZEXT24(ppuVar1)),
                    (ushort *)CONCAT22(param_3, local_c),
                    (ushort *)CONCAT13(uVar15, CONCAT12((char)param_3, local_a)),
                    (ushort *)CONCAT22(param_3, local_8));
    puStack46      = uStack6;
    uStack56       = uStack6;
    ...
    if(uStack14 == 0x0)
    {
        ...
        if((*(int *)(iVar11 + 0x11a) == 0xa) || (*(int *)(iVar11 + 0x11a) == 0x37))
        {
            ...
            *(uchar **)(iVar11 + 0x10e) = uStack6._2_2_;
            ...
            uVar14                      = 0x1018;
            pass1_1018_0196(uVar7 | ZEXT24(uStack6._2_2_) << 0x10,
                            *(ulong *)(iVar11 + 0x10c),
                            *(ulong *)(iVar11 + 0x108),
                            (ushort)uVar7,
                            uStack6._2_2_,
        ...
        if(puVar8 != (uchar *)0x0)
        {
            ...
            (**ppcVar3)(
              uVar14, (uint)uStack6, uStack6._2_2_, 0x0, (char)puStack18, (int)((ulong)puStack18 >> 0x10), 0x0);
            puVar8 = extraout_DX;
        }
    }
    else
    ...
    pass1_1030_73ee(CONCAT13((char)((uint)puVar8 >> 0x8), CONCAT12((char)puVar8, (uint)uStack6)),
                    *(ulong *)(iVar11 + 0x10c),
                    (ushort)puVar8);
    ...
    if((uVar9 | (uint)uStack26) != 0x0)
    {
        struct_1030_e4fa((astruct_100 *)CONCAT13(uVar15, CONCAT12((char)param_3, local_156)),
                         uStack26 & 0xffff | (ulong)uVar9 << 0x10,
                         param_3,
                         param_4);
