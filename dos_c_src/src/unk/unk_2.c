...

{
    ...
    puVar8 = mixed_1010_20ba(globals->_PTR_LOOP_1050_0ed0, 0x3, param_4, param_2, param_3);
    puVar6 = (puVar8 >> 0x10);
    uVar3  = puVar8;
    uVar7  = (param_1 >> 0x10);
    ...
    if(-0x1 < uVar3)
    {
        ...
        puVar9  = mixed_1010_20ba(globals->_PTR_LOOP_1050_0ed0, uVar10, param_4, puVar6, param_3);
