...

{
    ...
    if(PTR_LOOP_1050_574c != 0x0)
    {
        ...
        pass1_1000_2b5c(_PTR_LOOP_1050_5752, (_PTR_LOOP_1050_5752 >> 0x10), 0x5763, &USHORT_1050_1050, unaff_ES, &stack0xfffe, SEG_1000, param_3);
        pass1_1000_2f48(_PTR_LOOP_1050_5752, &stack0xfffe, unaff_ES, SEG_1000, param_3, in_AF);
    }
    return;
}
    ...
    *param_1           = 0x8e38;
    ...
    for(iStack34 = 0x0; iStack34 < 0x5; iStack34 = iStack34 + 0x1)
    {
        ...
        else
        {
            ...
            (&iVar4[0x1].field_0x2)[iStack34 * 0x2]  = pu_var2;
        }
        puVar1 = pu_var2;
    }
    return;
    ...
    if(u_var2 != 0x0)
    {
        ...
        for(uStack10 = 0x0; uStack10 < u_stack6; uStack10 = uStack10 + 0x1)
        {
            ...
            if(uVar5 != 0x0)
            {
                ...
                {
                    param_2 = param_2 + -0x1;
                    pass1_1028_e332(_PTR_LOOP_1050_65e2, u_var2, extraout_DX_00, unaff_SS);
...

{
    ...
    if(uStack12._3_1_ != '\x03')
    {
        ...
        if(bStack291 == 0x2)
        {
            uVar1 = (iVar3 + 0x108);
            pass1_1028_e1ec(_PTR_LOOP_1050_65e2, uVar1, (uVar1 >> 0x10));
            pass1_1010_82f8(_PTR_LOOP_1050_14cc, **(u16 **)(u_var2 + 0x10));
        }
    }
    return;
}
...

{
    ...
    uVar5   = fn_ptr_op_1000_1708(0x16c, 0x0, 0x1, globals->PTR_LOOP_1050_5f2c, globals->PTR_LOOP_1050_5f2e, SEG_1000);
    ...
    do
    {
        ...
        *ppu_var2 = globals->PTR_LOOP_1050_5f2e + (*ppu_var2 + CARRY2(uVar3, uVar7));
...

{
    ...
    uVar4  = fn_ptr_op_1000_1708(0x16c, 0x0, 0x1, globals->PTR_LOOP_1050_5f2c, globals->PTR_LOOP_1050_5f2e, SEG_1000);
    uVar6  = (param_2 - 0x1U);
