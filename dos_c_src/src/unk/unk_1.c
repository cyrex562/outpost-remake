...

{
        ...
        iStack4               = iStack4 + 0x1)
    {
        ...
        pcVar3 = pass1_1010_b038(
          (uchar *)puVar8, (ushort)uVar2, (ushort)((ulong)uVar2 >> 0x10), *(uchar **)((int)puStack12 + 0x4), param_4);
...
ulong __stdcall16far pass1_1040_a2cc(
  int param_1, ulong param_2, ulong param_3, ushort param_4, uchar *param_5, ushort param_6, ushort param_7)
...

{
    ...
    iStack8  = 0x0;
    while((piVar2 = *(int **)((int)param_1 + 0x90),
           *piVar2 != iStack8 && iStack8 <= *piVar2 && (*(int *)((int)puStack6 + 0x4) != 0x1770)))
    {
        iStack8  = iStack8 + 0x1;
