...
{
    *param_1        = addr_table_1008_efc4;//0xefc4;
...

{
    ...
    uVar7  = *(param_3 + 0x12);
    puVar6 = mixed_1010_20ba(globals->_PTR_LOOP_1050_0ed0, 0x3, param_6, param_4, param_5);
    uVar4  = (puVar6 >> 0x10);
    uVar1  = puVar6;
    uVar5  = uVar4;
    if(uVar7 == 0x7d)
...
{
    *param_1        = addr_table_1010_02c8;//0x2c8;
    param_1->field_0x2 = SEG_1010;
...

{
    ...
    load_string_1010_84e0(SEG_1010, globals->PCHAR_1050_14cc, (_PTR_LOOP_1050_14cc >> 0x10), 0x3ff, in_string_2, (short)param_3);
    return;
}
...

{
    ...
    *param_1         = addr_table_1008_bdcc;//0xbdcc;
    iVar4->field_0x2 = SEG_1008;
    puVar1           = iVar4->field_0xa;
    u_var2            = iVar4->field_0xc;
    if((u_var2 | puVar1) != 0x0)
...

{
    ...
    *param_1         = addr_table_1008_380a[36]; // 0x389a
    ...
    iVar1->field_0x4 = 0x0;
    *param_1         = addr_table_1008_bdc8;//0xbdc8;
    iVar1->field_0x2 = SEG_1008;
    return param_1;
}
...

{
    ...
    uVar1           = (param_1 >> 0x10);
    (param_1 + 0x8) = 0x0;
    *param_1        = addr_table_1008_bdc0;//0xbdc0;
    param_1->field_0x2 = SEG_1008;
    return param_1;
}
...

{
    ...
    uVar1           = (param_1 >> 0x10);
    (param_1 + 0x8) = 0x0;
    *param_1        = addr_table_1008_bdc0[7];//0xbddc;
    param_1->field_0x2 = SEG_1008;
    return param_1;
}
...

{
    ...
    {
        globals->_PTR_LOOP_1050_0382 = mixed_1010_20ba(globals->_PTR_LOOP_1050_0ed0, 0x2e, param_7, (puVar9 >> 0x10), unaff_DI);
    }
    ...
    {
        puVar9           = pass1_1008_ada2(CONCAT22(puVar5, u_var2), iVar5->field_0x2e);
...

{
    ...
    pass1_1018_20ee(_PTR_LOOP_1050_0382, pi_var1);
...

{
    ...
    {
        uVar6 = (u_stack6 >> 0x10);
        pass1_1008_50c2((Struct110 *)CONCAT22(pu_var2, puVar1), *(u_stack6 + 0x8), *(u_stack6 + 0x4), param_2, param_3);
    }
