...
void __stdcall16far
pass1_1028_9efc(ulong param_1, ushort *param_2, uint param_3, int param_4, ushort param_5, uchar param_6)

{
    ...
    if((param_3 | (uint)param_2) != 0x0)
    {
        ...
        pass1_1028_dc52(
          (astruct_92 *)CONCAT13((char)(param_5 >> 0x8), CONCAT12((char)param_5, &local_18)), 0x1, 0x0, 0x400);
        while(true)
        {
            puVar2 = &local_18;
            ...
            puStack6 = puVar2;
            if(((uint)puStack4 | (uint)puVar2) == 0x0)
                break;
            ...
            if(puVar2[0xff] != 0x0)
            {
                ...
                {
                    pass1_1028_a3ae((ushort)param_1,
                                    uVar10,
                                    CONCAT22(puStack4, puVar2),
                                    uVar7,
                                    param_4,
                                    param_5,
                                    param_6,
                ...
                if(lVar1 != 0x8000002)
                {
                    ...
                    if(puVar6 != (uchar *)0x0)
                    {
                        ...
                        post_win_msg_1008_a0e4(
                          paVar8, 0x0, uVar3, puStack6[0x104], *(ulong *)(puStack6 + 0x2), 0x2, 0x1008, param_5);
                    }
                }
            }
        }
        ...
        if(iVar4 != 0x0)
        {
            ...
            if(iVar4 < 0x1)
            {
                if(iVar4 < 0x0)
                {
                    ...
                    if(((int)puVar6 < 0x1) && (((int)puVar6 < 0x0 || (iVar4 == 0x0))))
                    {
                        paVar8 = (astruct_67 *)mixed_1010_20ba(_PTR_LOOP_1050_0ed0, 0x37, param_5, puVar6, param_4);
                        post_win_msg_1008_a0e4(
                          paVar8, 0x0, 0x0, 0x1, *(ulong *)((int)puStack6 + 0x4), 0x6, 0x1008, param_5);
                    }
                }
            }
            else
            {
                ...
                puVar6 = (uchar *)((ulong)puVar9 >> 0x10);
                post_win_msg_1008_a0e4((astruct_67 *)((ulong)puVar9 & 0xffff | ZEXT24(puVar6) << 0x10),
                                       0x0,
                                       iVar4,
                                       *(ushort *)((int)puStack6 + 0x208),
                                       0x4000001,
                                       0x2,
                                       0x1008,
                                       param_5);
...
void __stdcall16far pass1_1028_84ca(
  astruct_100 *param_1, ulong param_2, ushort param_3, ushort param_4, ushort param_5, ushort param_6, uchar param_7)

{
    ...
    *(undefined2 *)(iVar2 + 0x2) = (int)&USHORT_1050_1028;
    ...
    sys_1000_3f9c((uchar *)(iVar2 + 0x8),
                  puVar3,
                  (ushort)s_SCForceMorale__s_for_colony__08l_1050_5024,
...
void __stdcall16far struct_op_1028_933c(astruct_100 *param_1,
                                        ushort       param_2,
                                        ushort       param_3,
                                        ushort       param_4,
                                        ulong       *param_5,
...

{
    ...
    *(undefined2 *)(iVar1 + 0x2)   = (int)&USHORT_1050_1028;
    sys_1000_3f9c((uchar *)(iVar1 + 0x8),
                  puVar2,
                  (ushort)s_SCPutBldg_site_0x_08lx__bldg__u__1050_50ce,
                  (ushort)&USHORT_1050_1050,
                  (ushort)param_8,
                  &stack0xfffe,
                  puVar2,
...

{
    ...
    if(puVar5 == (ulong *)0x98)
    {
        ...
        if(*(long *)((int)puVar5 + 0x200) == 0x8000002)
        {
            ...
            puVar1  = &local_18;
            pass1_1020_a49a(
              param_4, param_5, puVar6, CONCAT22(param_4, puVar1), (int *)CONCAT22(param_4, local_1e), 0x7a);
                ...
                while(true)
                {
                    ...
                    if(*(long *)(puVar2 + 0x200) != 0x8000002)
                    {
                        ...
                        for(uStack56 = 0x0; uStack56 < uStack50; uStack56 = uStack56 + 0x1)
                        {
                            ...
                            if((int)uVar4 <= (int)uStack68)
                            {
                                paVar9 = pass1_1028_8fc0(
                                  (astruct_100 *)CONCAT13(uVar10, CONCAT12((char)param_4, &local_156)),
                                  *(ulong *)((int)uStack64 + 0x4),
                                  *(ulong *)((int)uStack38 + 0x4),
                                  param_4,
                                  in_AF);
                        ...
                        if(puStack46 != (undefined4 *)0x0)
                        {
                            ...
                            (**ppcVar1)(
                              uVar6, (int)puStack46, (int)((ulong)puStack46 >> 0x10), 0x1, puStack46, puStack46);
                        }
                    }
                }
            }
                    ...
                    if(*(long *)(puVar2 + 0x200) != 0x8000002)
                    {
                        ...
                        for(uStack60 = 0x0; uStack60 < uStack50; uStack60 = uStack60 + 0x1)
                        {
                            ...
                            if(((int)uVar3 <= iStack52)
                               && (pass1_1028_7742((ushort)param_1, (ushort)(param_1 >> 0x10), 0x4, uStack68, param_4),
                                   uStack72 = uVar3,
                                   uVar3 == 0x0))
                            {
                                paVar9 = pass1_1028_b0de(
                                  (astruct_100 *)CONCAT13(uVar10, CONCAT12((char)param_4, &local_158)),
                                  *(ulong *)((int)uStack68 + 0x4),
                                  *(ulong *)((int)uStack38 + 0x4),
                                  param_4,
                                  param_5);
                                uVar5 = (ulong)paVar9 >> 0x10;
                ...
                if(*(long *)(puVar2 + 0x200) != 0x8000002)
                {
                    ...
                    for(uStack56 = 0x0; uStack56 < uStack44; uStack56 = uStack56 + 0x1)
                    {
                        ...
                        if(((uVar3 != 0x0) && (uVar3 != 0x70)) && (uVar3 != 0x71))
                        {
                            ...
                            uStack68 = uVar3;
                            if(((int)uVar3 <= iStack52)
                               && (pass1_1028_7742((ushort)param_1, (ushort)(param_1 >> 0x10), 0x4, uStack64, param_3),
                                   uStack72 = uVar3,
                                   uVar3 == 0x0))
                            {
                                paVar9 = pass1_1028_8698(
                                  (astruct_100 *)CONCAT13(uVar10, CONCAT12((char)param_3, &local_158)),
                                  *(ulong *)((int)uStack64 + 0x4),
                                  *(ulong *)((int)uStack32 + 0x4),
                                  param_4,
                                  param_3);
                                uVar5 = (ulong)paVar9 >> 0x10;
                                uVar6 = 0x30;
