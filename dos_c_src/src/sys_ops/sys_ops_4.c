...
void pass1_1028_a8f4(u32 param_1, Struct335 *param_2, u8 *param_3)
...
void pass1_1028_aa68(u32 param_1, Struct336 *param_2, u8 *param_3)
...
void pass1_1028_abec(u32 param_1, Struct337 *param_2, u8 *param_3)
...
void pass1_1028_ad9c(u32 param_1, Struct338 *param_2, u8 *param_3)
...

{
    ...
    puVar7 = mixed_1010_20ba(globals->_PTR_LOOP_1050_0ed0, 0x2, param_4, param_2, param_3);
    puVar4 = (puVar7 >> 0x10);
...
LAB_1028_af42:
    ...
    paVar8             = (Struct67 *)mixed_1010_20ba(globals->_PTR_LOOP_1050_0ed0, 0x37, param_4, puVar4, param_3);
    ...
    puVar7 = mixed_1010_20ba(globals->_PTR_LOOP_1050_0ed0, 0x2b, param_4, puVar4, param_3);
...

{
    ...
    mem_op_1000_179c(0x116, param_3, SEG_1000);
    puStack10 = CONCAT22(param_3, param_2);
    if((param_3 | param_2) != 0x0)
    {
        *puStack10         = addr_table_1008_380a[36]; // 0x389a
...

{
    ...
    mem_op_1000_179c(0x110, param_3, SEG_1000);
    puStack10 = CONCAT22(param_3, param_2);
    if((param_3 | param_2) != 0x0)
    {
        *puStack10         = addr_table_1008_380a[36]; // 0x389a
...

{
    ...
    mem_op_1000_179c(0x124, param_3, SEG_1000);
    puStack10 = CONCAT22(param_3, param_2);
    if((param_3 | param_2) != 0x0)
    {
        *puStack10         = addr_table_1008_380a[36]; // 0x389a
...

{
    ...
    mem_op_1000_179c(0x118, param_3, SEG_1000);
    puStack10 = CONCAT22(param_3, param_2);
    iVar5     = (Struct331 *)param_1;
    uVar6     = (param_1 >> 0x10);
    if((param_3 | param_2) != 0x0)
    {
        *puStack10         = addr_table_1008_380a[36]; // 0x389a
...
void pass1_1028_9efc(u32 param_1, u16 *param_2, u16 param_3, i16 param_4, u16 param_5, u8 param_6)

{
    ...
    if((param_3 | param_2) != 0x0)
    {
        pu_stack6 = param_2;
        puStack4 = param_3;
        pass1_1028_dc52((Struct92 *)CONCAT13((param_5 >> 0x8), CONCAT12(param_5, &local_18)), 0x1, 0x0, 0x400);
        while(true)
        {
            pu_var2 = &local_18;
            ...
            if(pu_var2[0xff] != 0x0)
            {
                ...
                {
                    pass1_1028_a3ae(param_1, uVar10, CONCAT22(puStack4, pu_var2), uVar7, param_4, param_5, param_6, lVar1);
                }
                uVar3 = lVar5;
                pass1_1028_a28a(param_1, uVar10, CONCAT22(puStack4, pu_stack6));
                if((uVar7 < 0x1) && ((uVar7 < 0x0 || (uVar3 < 0x64))))
                {
                    pass1_1028_a4ee(param_1, CONCAT22(puStack4, pu_stack6), param_4, param_5);
                }
                if(lVar1 != 0x8000002)
                {
                    pass1_1038_42cc(CONCAT22(puStack4, pu_stack6), param_5);
                    puVar6 = (uVar7 | uVar3);
                    uVar7  = uVar7 & 0xffff0000 | ZEXT24(puVar6);
                    if(puVar6 != 0x0)
                    {
                        paVar8 = (Struct67 *)mixed_1010_20ba(globals->_PTR_LOOP_1050_0ed0, 0x37, param_5, puVar6, param_4);
        ...
        uStack22 = SEG_1008;
        puVar9   = mixed_1010_20ba(globals->_PTR_LOOP_1050_0ed0, 0x8, param_5, 0x0, param_4);
        puVar6   = (puVar9 >> 0x10);
        iVar4    = puVar9;
        pass1_1028_e1ec(globals->_PTR_LOOP_1050_65e2, 0x1, 0x400);
        pu_stack6 = iVar4;
        ...
        if(iVar4 != 0x0)
        {
            ...
            {
                puVar9 = mixed_1010_20ba(globals->_PTR_LOOP_1050_0ed0, 0x37, param_5, puVar6, param_4);
                puVar6 = (puVar9 >> 0x10);
                post_win_msg_1008_a0e4((Struct67 *)(puVar9 & 0xffff | ZEXT24(puVar6) << 0x10), 0x0, iVar4, (pu_stack6 + 0x208), 0x4000001, 0x2, SEG_1008, param_5);
                puVar9 = mixed_1010_20ba(globals->_PTR_LOOP_1050_0ed0, 0x2b, param_5, puVar6, param_4);
...
void pass1_1028_a0fa(u32 param_1, Struct334 *param_2, u8 *param_3)
...
void pass1_1028_8400(u32 param_1, u16 param_2, u8 *param_3)
...
void pass1_1028_84ca(Struct100 *param_1, u32 param_2, u16 param_3, u16 param_4, u16 param_5, u16 param_6, u8 param_7)

{
    ...
    *(iVar2 + 0x10e)   = param_2;
    ...
    sys_1000_3f9c((iVar2 + 0x8), puVar3, s_SCForceMorale__s_for_colony__08l_1050_5024, &USHORT_1050_1050, uVar1, &stack0xfffe, puVar3, SEG_1000, param_6, param_7);
    return;
}
...
void pass1_1028_9264(u32 param_1, u16 param_2, u8 *param_3)
...
void struct_op_1028_933c(Struct100 *param_1, u16 param_2, u16 param_3, u16 param_4, u32 *param_5, u16 param_6, u32 param_7, u32 param_8, u16 param_9, u8 param_10)

{
    ...
    *(iVar1 + 0x114)   = *param_5;
    ...
    (iVar1 + 0x2)      = SEG_1028;
    sys_1000_3f9c((iVar1 + 0x8), pu_var2, s_SCPutBldg_site_0x_08lx__bldg__u__1050_50ce, &USHORT_1050_1050, param_8, &stack0xfffe, pu_var2, SEG_1000, param_9, param_10);
    return;
}

void pass1_1028_752e(u32 param_1, u16 param_2, u8 *param_3)
...
void pass1_1028_767e(i16 param_1, u16 param_2, i16 param_3, u16 param_4)

{
    ...
    {
        puVar1 = mixed_1010_20ba(globals->_PTR_LOOP_1050_0ed0, 0x40, param_4, 0x0, param_3);
        load_str_and_spri16f_1008_b78a(puVar1, param_4, (puVar1 >> 0x10), puVar1);
    }
    return;
}


void pass1_1028_78b8(u32 param_1, long param_2, i16 param_3, u16 param_4, u8 param_5)

{
    ...
    if(puVar5 == 0x98)
    {
        ...
        if((puVar5 + 0x200) == 0x8000002)
        {
            ...
            puVar6  = (puVar13 >> 0x10);
            puVar1  = &local_18;
            pass1_1020_a49a(param_4, param_5, puVar6, CONCAT22(param_4, puVar1), CONCAT22(param_4, local_1e), 0x7a);
    ...
    uVar10 = (ZEXT48(pu_stack6) % 0x7d);
    puVar8 = (ZEXT48(pu_stack6) % 0x7d);
    puVar6 = puVar8;
    if(uVar10 == 0x0)
    {
        local_1e[0] = puVar8;
        ...
        if(local_1e[0] < 0x1a)
        {
            pass1_1028_dc52((Struct92 *)CONCAT22(param_4, &local_30), 0x1, 0x0, 0x400);
            do
            {
                uVar7  = uVar10;
    ...
    if(pu_stack6 == 0x12c)
    {
        ...
        iVar9     = 0xf;
        uVar15    = 0x1;
        puVar13   = mixed_1010_20ba(globals->_PTR_LOOP_1050_0ed0, 0x2b, param_4, puVar8, param_3);
        puVar8    = (puVar13 >> 0x10);
        puVar6    = puVar13;
        local_30  = puVar6;
        puStack46 = puVar8;
    ...
    if(pu_stack6 == 0x3d)
    {
        puVar13     = mixed_1010_20ba(globals->_PTR_LOOP_1050_0ed0, 0x2, param_4, puVar8, param_3);
        uVar10      = puVar13 >> 0x10;
        local_30    = puVar13;
        puVar8      = (puVar13 >> 0x10);
        ...
        {
            pass1_1028_dc52((Struct92 *)CONCAT22(param_4, local_42), 0x1, 0x0, 0x400);
            while(true)
            {
                uVar7   = uVar10;
                ppu_var2 = local_42;
            ...
            iVar9     = 0x10;
            uVar15    = 0x1;
            puVar13   = mixed_1010_20ba(globals->_PTR_LOOP_1050_0ed0, 0x2b, param_4, 0x0, param_3);
            puVar8    = (puVar13 >> 0x10);
            puVar6    = puVar13;
            puStack20 = puVar6;
            puStack18 = puVar8;
    ...
    {
        puStack74 = mixed_1010_20ba(globals->_PTR_LOOP_1050_0ed0, 0x2f, param_4, puStack8, param_3);
        for(puStack70 = 0x1; puStack70 < 0x9; puStack70 = (puStack70 + 0x1))
        {
            ...
            if(local_42[0] == pu_stack6)
            {
                ...
                if(local_30 != 0x0)
                {
                    pass1_1028_90e6((Struct100 *)CONCAT22(param_4, &uStack340), puStack70, param_4, param_5);
                    puVar4 = &uStack340;
...
void pass1_1028_7c4e(u32 param_1, u8 *param_2, i16 param_3, u16 param_4)
        ...
        if(0x2 < uStack12)
        {
            ...
            if(uVar5 == 0x0)
            {
                ...
                while(true)
                {
                    ...
                    uStack38 = CONCAT22(uVar4, pu_var2);
                    uVar5    = (uVar4 | pu_var2);
                    ...
                    if((pu_var2 + 0x200) != 0x8000002)
                    {
                        ...
                        for(uStack56 = 0x0; uStack56 < uStack50; uStack56 = uStack56 + 0x1)
                        {
                            ...
                            if(uVar4 <= u_stack68)
                            {
                                paVar9 = pass1_1028_8fc0((Struct100 *)CONCAT13(uVar10, CONCAT12(param_4, &local_156)), *(u_stack64 + 0x4), *(uStack38 + 0x4), param_4, in_AF);
                                uVar5  = paVar9 >> 0x10;
                                uVar6  = 0x30;
...
void pass1_1028_7dfc(u32 param_1, u8 *param_2, i16 param_3, u16 param_4, u8 param_5)
            ...
            if(uVar5 == 0x0)
            {
                ...
                while(true)
                {
                    ...
                    if((pu_var2 + 0x200) != 0x8000002)
                    {
                        ...
                        uVar6    = 0x10;
                        puVar7   = mixed_1010_20ba(globals->_PTR_LOOP_1050_0ed0, 0x2, param_4, puVar4, param_3);
                        uVar5    = puVar7 >> 0x10;
                        ...
                        for(u_stack60 = 0x0; u_stack60 < uStack50; u_stack60 = u_stack60 + 0x1)
                        {
                            ...
                            {
                                paVar9 = pass1_1028_b0de((Struct100 *)CONCAT13(uVar10, CONCAT12(param_4, &local_158)), *(u_stack68 + 0x4), *(uStack38 + 0x4), param_4, param_5);
                                uVar5  = paVar9 >> 0x10;
                                uVar6  = 0x30;
...
void pass1_1028_7fb6(u32 param_1, i16 param_2, u16 param_3, u8 param_4)
        ...
        if(uVar5 == 0x0)
        {
            ...
            while(true)
            {
                ...
                if((pu_var2 + 0x200) != 0x8000002)
                {
                    ...
                    uVar6     = 0x10;
                    puVar8    = mixed_1010_20ba(globals->_PTR_LOOP_1050_0ed0, 0x2, param_3, puVar4, param_2);
                    uVar5     = puVar8 >> 0x10;
                    ...
                    for(uStack56 = 0x0; uStack56 < uStack44; uStack56 = uStack56 + 0x1)
                    {
                        ...
                        if(((uVar3 != 0x0) && (uVar3 != 0x70)) && (uVar3 != 0x71))
                        {
                            ...
                            {
                                paVar9 = pass1_1028_8698((Struct100 *)CONCAT13(uVar10, CONCAT12(param_3, &local_158)), *(u_stack64 + 0x4), *(uStack32 + 0x4), param_4, param_3);
                                uVar5  = paVar9 >> 0x10;
                                uVar6  = 0x30;
...
void pass1_1028_82b4(u32 param_1, u16 param_2, u8 *param_3)
...

{
    ...
    mem_op_1000_179c(0x10e, param_3, SEG_1000);
    puStack10 = CONCAT22(param_3, param_2);
    if((param_3 | param_2) != 0x0)
    {
        *puStack10         = addr_table_1008_380a[36]; // 0x389a
...
void pass1_1028_6ef6(u32 param_1, u16 param_2, u8 *param_3)
...
void pass1_1028_737e(u32 param_1, u16 param_2, u16 param_3)
...
u32 pass1_1028_611e(i16 param_1, u16 param_2, i16 param_3, u32 param_4, u16 param_5, u8 *param_6)

{
    ...
    mem_op_1000_179c(0xc, param_6, SEG_1000);
...
void pass1_1028_4194(u32 *param_1, u16 param_2, u16 param_3, u16 param_4, u16 param_5)

{
    ...
    {
        puVar3 = mixed_1010_20ba(globals->_PTR_LOOP_1050_0ed0, 0x2b, param_5, puVar1, param_3);
...
void pass1_1028_43c2(i16 param_1, u16 param_2, i16 param_3, u8 *param_4, i16 param_5, u16 param_6)

{
    ...
    if(param_3 == 0x0)
    {
        puVar1 = mixed_1010_20ba(globals->_PTR_LOOP_1050_0ed0, 0x8, param_6, param_4, param_5);
...
void pass1_1028_43f6(u32 param_1, i16 param_2, u8 *param_3, u16 param_4, i16 param_5, u16 param_6)

{
    ...
    uVar1  = 0x83;
    pu_var2 = mixed_1010_20ba(globals->_PTR_LOOP_1050_0ed0, 0x9, param_6, param_3, param_5);
...

{
    ...
    uVar6     = (param_1 >> 0x10);
    iVar6     = (Struct312 *)param_1;
    // WARNING: Load size is inaccurate
    puVar3    = iVar6->field_0x20;
    puVar4    = (&iVar6->field_0x20 + 0x2);
    paStack30 = (Struct99 *)CONCAT22(puVar4, puVar3);
    puStack34 = puVar3;
    puStack32 = puVar4;
    ...
    mem_op_1000_179c(0xc, puVar4, SEG_1000);
    puStack34 = puVar3;
    puStack32 = puVar4;
    if((puVar4 | puVar3) == 0x0)
    {
    ...
    if(puStack10 != 0x0)
    {
        ...
        {
            pass1_1020_bb16(puStack10, CONCAT13((param_3 >> 0x8), CONCAT12(param_3, &local_28)), CONCAT22(param_3, local_1a), uStack18);
            if((local_28 != 0x0) && (local_1a[0] != 0x0))
            {
                paStack30 = pass1_1000_07fc(SEG_1000, globals->PTR_LOOP_1050_68a2);
                uVar5     = (paStack30 >> 0x10);
                u_var2     = (Struct313 *)paStack30;
                if((uVar5 | u_var2) == 0x0)
                {
                ...
                {
                    paStack30->field_0x0 = addr_table_1008_380a[36]; // 0x389a
