            ...
            if(pu_var2[0xff] != 0x0)
            {
                ...
                if(lVar1 != 0x8000002)
                {
                    ...
                    if(puVar6 != 0x0)
                    {
                        ...
                        post_win_msg_1008_a0e4(paVar8, 0x0, uVar3, pu_stack6[0x104], *(pu_stack6 + 0x2), 0x2, 0x1008, param_5);
                    }
                }
            }
        }
        ...
        if(iVar4 != 0x0)
        {
            ...
            if(iVar4 < 0x1)
            {
                if(iVar4 < 0x0)
                {
                    ...
                    {
                        paVar8 = (Struct67 *)mixed_1010_20ba(_PTR_LOOP_1050_0ed0, 0x37, param_5, puVar6, param_4);
                        post_win_msg_1008_a0e4(paVar8, 0x0, 0x0, 0x1, *(pu_stack6 + 0x4), 0x6, 0x1008, param_5);
                    }
                }
            }
            else
            {
                ...
                puVar6 = (puVar9 >> 0x10);
                post_win_msg_1008_a0e4((Struct67 *)(puVar9 & 0xffff | ZEXT24(puVar6) << 0x10), 0x0, iVar4, (pu_stack6 + 0x208), 0x4000001, 0x2, 0x1008, param_5);
...

{
    ...
    *(iVar1 + 0x114)   = *param_5;
    ...
    sys_1000_3f9c((iVar1 + 0x8), pu_var2, s_SCPutBldg_site_0x_08lx__bldg__u__1050_50ce, &USHORT_1050_1050, param_8, &stack0xfffe, pu_var2, 0x1000, param_9, param_10);
    return;
}
