...

{
    ...
    case 0x1e:
        ...
        paVar5 = (Struct25 *)mixed_1010_20ba(_PTR_LOOP_1050_0ed0, 0x40, param_6, puVar3, param_5);
        puVar3 = (paVar5 >> 0x10);
...
switchD_1010_aaef_caseD_b:
    paVar6 = (Struct67 *)mixed_1010_20ba(_PTR_LOOP_1050_0ed0, 0x37, param_6, puVar3, param_5);
    puVar3 = (paVar6 >> 0x10);
