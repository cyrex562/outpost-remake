...

{
    ...
    if(uStack1032 != 0x0)
    {
        ...
        if((uStack1032 | uStack1034) != 0x0)
        {
            ...
            sys_1000_3f9c(local_402, param_4, 0x3926, &USHORT_1050_1050, local_40c, &stack0xfffe, uVar8, SEG_1000, param_4, param_5);
            ...
            uVar8          = (uVar11 >> 0x10);
            sys_1000_3f9c(local_402, param_4, 0x3929, &USHORT_1050_1050, uVar11, &stack0xfffe, iVar9, SEG_1000, param_4, param_5);
...

{
    ...
    do
    {
        ...
        *param_3      = *param_3 + uStack24;
        ...
        sys_1000_3f9c(local_418, param_8, 0x3935, &USHORT_1050_1050, uStack18, &stack0xfffe, uVar5, SEG_1000, param_8, param_9);
        ...
        iStack4       = iStack4 + 0x2;
        sys_1000_3f9c(local_418, param_8, 0x3938, &USHORT_1050_1050, uStack24, &stack0xfffe, uVar5, SEG_1000, param_8, param_9);
        string_1040_a626(puStack1052, CONCAT22(param_8, local_418), uVar5);
    } while(true);
}
...

{
    ...
    while(true)
    {
        ...
        iVar2 = (Struct493 *)(iVar4->field_0x2 + uStack94 * 0xa);
        uVar5 = (param_5 >> 0x10);
        uVar6 = (param_4 >> 0x10);
        ...
        sys_1000_3f9c(local_54, param_8, 0x393b, &USHORT_1050_1050, *(param_5 + iStack92 * 0x4), &stack0xfffe, uVar5, SEG_1000, param_8, param_9);
        uVar1         = iVar4->field_0x4;
...

{
    ...
    iVar2            = (Struct105 *)(&iVar5->field_0x2 + param_4 * 0xa);
    uVar7            = (param_5 >> 0x10);
    iVar2->field_0x4 = (param_4 * 0x2 + param_5);
    string_1040_a626(CONCAT22(u_var2, iVar2), pcVar4, u_var2);
...

{
    ...
    *param_3 = 0x0;
    ...
    puVar10  = mixed_1010_20ba(globals->_PTR_LOOP_1050_0ed0, 0x35, param_6, puVar6, unaff_DI);
    puVar6   = (puVar10 >> 0x10);
    iVar7    = param_4;
    uVar8    = (param_4 >> 0x10);
    if(param_2 == 0x13)
    {
        ...
        u_var2 = *param_3 * 0x2;
        mem_op_1000_179c(u_var2, puVar6, SEG_1000);
        param_4       = u_var2;
        (iVar7 + 0x2) = puVar6;
...

{
    ...
    *(iVar6 + 0x13c) = 0x0;
    ...
    if(BVar3 == 0x0)
    {
        ...
        puVar8  = mixed_1010_20ba(globals->_PTR_LOOP_1050_0ed0, 0x31, param_5, param_3, param_4);
        ppcVar1 = (*puVar8 + 0x14);
    ...
    {
        puVar8  = mixed_1010_20ba(globals->_PTR_LOOP_1050_0ed0, 0x41, param_5, param_3, param_4);
        ppcVar1 = (*puVar8 + 0x14);
        (**ppcVar1)(SEG_1008, puVar8, (puVar8 >> 0x10), puVar4, puVar4 >> 0xf);
    ...
    if(uVar5 == 0x0)
    {
        load_string_1010_84e0(SEG_1008, globals->PCHAR_1050_14cc, (_PTR_LOOP_1050_14cc >> 0x10), 0x3ff, (iVar6 + 0x13c), in_buf_len_5);
    }
    else
    {
        ppcVar1 = (*puVar4 + 0x14);
    ...
    *(uVar5 + 0x13c) = 0x0;
    ...
    if(((uVar1 == 0x0) && (uVar1 = pass1_1008_c6ae(_PTR_LOOP_1050_06e0, uStack8, 0x13), uVar1 == 0x0)) && (uVar1 = pass1_1008_c6ae(_PTR_LOOP_1050_06e0, uStack8, 0x2), uVar1 == 0x0))
    {
        ...
        if(BVar2 != 0x0)
        {
            ...
            uStack22 = uVar8;
        LAB_1010_e76d:
            sys_1000_3f9c((uVar5 + 0x13c), in_buf_len_5, uVar9, &USHORT_1050_1050, uVar8, &stack0xfffe, uVar6, SEG_1000, param_3, param_4);
            return;
        }
            ...
            if(BVar2 == 0x0)
            {
                ...
                if((local_1e == 0x0) && (local_1e = pass1_1008_c6ae(_PTR_LOOP_1050_06e0, uStack8, 0x14), local_1e == 0x0))
                {
                    ...
                    if(BVar2 == 0x0)
                    {
                        ...
                        if(uVar8 == 0x0)
                        {
                            load_string_1010_84e0(SEG_1008, globals->PCHAR_1050_14cc, (_PTR_LOOP_1050_14cc >> 0x10), 0x3ff, (uVar5 + 0x13c), (short)in_buf_len_5);
                            return;
                        }
    ...
    sys_1000_3f9c((uVar5 + 0x13c), in_buf_len_5, uVar8, &USHORT_1050_1050, uVar1, &stack0xfffe, uVar6, SEG_1000, param_3, param_4);
    return;
}
...

{
    ...
    mem_op_1000_179c(uVar3, param_3, SEG_1000);
    uVar6            = (local_18._18_4_ >> 0x10);
    ...
    else
    {
        ...
        if((param_3 | iVar8->field_0x4) != 0x0)
        {
            ...
            *puVar1                 = paVar8;
            ...
            pass1_1028_dc52((Struct92 *)CONCAT22(param_4, local_18), 0x1, 0x0, 0x200);
            iStack30 = 0x1;
            while(true)
            {
...

{
    ...
    puVar5 = mixed_1010_20ba(globals->_PTR_LOOP_1050_0ed0, 0x2f, param_3, param_1, param_2);
    u_var2  = (puVar5 >> 0x10);
    uVar1  = (puVar5 + 0x24);
    uVar4  = (puVar5 + 0x26);
    uVar3  = uVar4 | uVar1;
...

{
    ...
    if(param_3 == 0x0)
    {
        mem_op_1000_179c(0x100, param_5, SEG_1000);
    ...
    load_string_1010_84e0(SEG_1010, globals->PCHAR_1050_14cc, (_PTR_LOOP_1050_14cc >> 0x10), 0x3ff, pu_stack6, (short)(pu_stack6 >> 0x10));
    return;
}
...

{
    ...
    sys_1000_3f9c(u_stack6, (u_stack6 >> 0x10), 0x38c5, &USHORT_1050_1050, local_40c, &stack0xfffe, u_var2, SEG_1000, param_7, param_6);
    return;
}
...

{
    ...
    if(param_5 == 0x0)
    {
        mem_op_1000_179c(0x100, param_3, SEG_1000);
    ...
    default:
        break;
    case 0x6:
        load_string_1010_84e0(SEG_1010, uVar7, uVar6, 0x3ff, in_buffer_4, (short)in_buf_len_5);
        uStack22 = str_op_1000_3da4(pcStack6);
        pcVar5   = load_string_1010_847e(_PTR_LOOP_1050_14cc, (u16)(_PTR_LOOP_1050_14cc >> 0x10), SEG_1000);
        uVar7    = pcVar5;
    ...
    LAB_1010_c4f9:
        sys_1000_3f9c((in_buffer_4 + uStack22), in_buf_len_5, uVar6, &USHORT_1050_1050, uVar7, &stack0xfffe, uVar3, SEG_1000, param_1, param_2);
        return;
    }
    load_string_1010_84e0(SEG_1010, uVar7, uVar6, 0x3ff, in_buffer_4, (short)in_buf_len_5);
    return;
...

{
    ...
    uVar3 = param_5;
    mem_op_1000_179c(0x18, param_6, SEG_1000);
    uVar1  = uVar3;
    ...
    if(ppuStack14 != (u8 **)0x0)
    {
        *piStack6 = iStack16;
        ...
        mem_op_1000_179c(u_var2, puVar5, SEG_1000);
...

{
    ...
    for(uStack400 = 0x1; uStack400 < 0x25; uStack400 = uStack400 + 0x1)
    {
        ...
        if(uStack404 != (Struct18 *)0x0)
        {
            ...
            uStack408 = CONCAT22(uStack404, pcVar5);
            ...
            {
                uVar6                               = str_op_1008_60e8(CONCAT22(uStack404, pcVar5), uVar9);
    ...
    if(uStack324 != 0x0)
    {
        ...
        for(uStack320 = 0x1; uStack320 < 0x25; uStack320 = uStack320 + 0x1)
        {
            ...
            if(uStack324 != 0x0)
            {
                ...
                {
                    uVar4                              = str_op_1008_60e8(CONCAT22(uStack324, pcVar3), uVar8);
        ...
        for(uStack332 = 0x10000; uStack332 < 0x15; uStack332 = uStack332 & 0xffff | (uStack332 + 0x1) << 0x10)
        {
            if((&local_13e)[uStack332] != 0x0)
            {
                ...
                {
                    uVar4                               = SEG_1008;
                    uVar5                               = str_op_1008_60e8(CONCAT22(uStack324, pcVar3), uVar8);
...

{
    ...
    iStack12 = 0x4;
    mixed_1010_20ba(globals->_PTR_LOOP_1050_0ed0, 0x2, param_4, param_2, param_3);
...

{
    ...
    puVar7 = mixed_1010_20ba(globals->_PTR_LOOP_1050_0ed0, 0x35, param_6, puVar3, param_5);
    puVar3 = (puVar7 >> 0x10);
    u_var2  = param_1;
    uVar8  = (param_1 >> 0x10);
    puVar4 = puVar3;
    ...
    case 0x1e:
        u_var2  = 0x1;
        iVar1  = 0x2;
        puVar7 = mixed_1010_20ba(globals->_PTR_LOOP_1050_0ed0, 0x2b, param_6, puVar3, param_5);
        puVar3 = (puVar7 >> 0x10);
        pass1_1010_08c0(puVar7, u_var2, iVar1, param_6);
        paVar5 = (Struct25 *)mixed_1010_20ba(globals->_PTR_LOOP_1050_0ed0, 0x40, param_6, puVar3, param_5);
        puVar3 = (paVar5 >> 0x10);
...
switchD_1010_aaef_caseD_b:
    paVar6 = (Struct67 *)mixed_1010_20ba(globals->_PTR_LOOP_1050_0ed0, 0x37, param_6, puVar3, param_5);
    puVar3 = (paVar6 >> 0x10);
