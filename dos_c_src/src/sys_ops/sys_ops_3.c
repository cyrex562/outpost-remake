...

{
    ...
    *param_1                     = 0x0;
    ...
    if(puVar2 != 0x0)
    {
        pass1_1030_615a((Struct137 *)(param_2 & 0xffff | ZEXT24(param_3) << 0x10), puVar2);
    }
...

{
    ...
    {
        struct_op_1008_8e9e((Struct78 *)CONCAT22(puVar2, puStack6), 0x6, 0x24);
    }
    (iVar3 + 0x4) = puStack6;
    (iVar3 + 0x6) = uStack4;
