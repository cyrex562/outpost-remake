...
void __stdcall16far pass1_1030_1be2(u32 param_1, u16 param_2, u8 *param_3)

{
    ...
    for(uStack4 = 0x0; puVar2 = *(u16 **)(iVar4 + 0x10), uStack4 <= *puVar2 && *puVar2 != uStack4; uStack4 = uStack4 + 0x1)
    {
...
void __stdcall16far pass1_1028_ef00(u16 param_1, u8 *param_2, u32 param_3, u16 param_4, u16 param_5, u16 param_6, u16 param_7)

{
    ...
    else
    {
        if(param_5 == 0xc)
        {
            ...
            {
                puVar2  = pass1_1030_bc24(param_2 | param_5, param_5, param_2, 0xc, _param_6);
                uVar1   = (puVar2 >> 0x10);
        ...
        else
        {
            ...
            {
                puVar2  = pass1_1028_b22c(CONCAT22(param_2, uVar1), param_5, _param_6, param_2 | uVar1);
                uVar1   = (puVar2 >> 0x10);
                param_5 = (astruct_365 *)puVar2;
                goto LAB_1028_ef8b;
            }
...
u16 *__stdcall16far switch_1030_07ac(u16 param_1, u16 param_2, u16 param_3, u16 param_4, u16 param_5, u32 param_6, u8 *param_7, astruct_179 *param_8, u16 param_9, u16 param_10, u16 param_11)

{
    ...
    case 0x1f:
        mem_op_1000_179c(0x26, param_7, 0x1000);
        puVar2 = (param_7 | param_8);
        if(puVar2 != 0x0)
        {
            pass1_1028_00cc(param_8, param_7, param_4, param_6, puVar2);
            return CONCAT22(puVar2, param_8);
        }
        break;
    case 0x20:
        mem_op_1000_179c(0x20, param_7, 0x1000);
    ...
    case 0x35:
        ...
        if(puVar2 != 0x0)
        {
            pass1_1028_3816(param_8, param_7, param_4, param_6, puVar2, param_9, param_10);
            return CONCAT22(puVar2, param_8);
        }
        break;
    case 0x36:
    ...
    case 0x3e:
        ...
        if(puVar2 != 0x0)
        {
            pass1_1028_1fc8(param_8, param_7, param_4, param_6, puVar2);
            return CONCAT22(puVar2, param_8);
        }
        break;
    case 0x3f:
...
void __stdcall16far pass1_1028_e628(u32 param_1, u16 param_2, u16 param_3, i16 param_4, i16 param_5, u16 param_6, u16 param_7, u16 param_8, u16 param_9, u8 param_10)

{
    ...
    puStack10 = 0x0;
    if(((param_4 == 0x0) && ((param_5 - 0x100U) == '\0')) && (puVar17 = (u16 *)(param_5 - 0x100U >> 0x7), puVar17 < (u16 *)(&PTR_LOOP_1050_000e + 0x1)))
    {
        uVar37 = (param_1 >> 0x10);
        ...
        case(u16 *)0x0:
            ...
            while(CONCAT22(uStack26, uStack28) < local_6)
            {
                ...
                {
                    puVar25  = pass1_1030_5d0a((puVar27 & 0xffff | ZEXT24(puVar17) << 0x10));
                ...
                pass1_1030_14b4(uVar20->field_0xe, ppuStack24, local_16, uVar5 & 0xffff | (uVar16 & 0xff) << 0x10, param_9);
        ...
        case(u16 *)0x2:
            ...
            while(CONCAT22(uStack38, uStack40) < local_6)
            {
                ...
                pcStack12 = (fn_ptr_1)(uVar5 >> 0x10);
                puVar17   = (u16 *)(uVar16 & 0xff);
                pass1_1030_14b4(uVar20->field_0x12, uVar18, uVar19, uVar5 & 0xffff | (uVar16 & 0xff) << 0x10, param_9);
        ...
        case(u16 *)0x3:
            ...
            local_16  = uVar19;
            local_14  = puVar17;
            pass1_1030_61fe(_PTR_LOOP_1050_5740, CONCAT22(puVar17, uVar19), param_1 & 0xffff0000 | &uVar20->field_0x114, &uVar20->field_0x108, uVar19, puVar17, param_9);
            if((uVar20->field_0x11a == 0xa) || (uVar20->field_0x11a == 0x37))
            {
                ...
                *(u16 **)(&uVar20->field_0x10c + 0x2) = puVar17;
                pass1_1018_0196(local_6, CONCAT22(puVar17, &uVar20->field_0x10c), *&uVar20->field_0x108, uVar19, puVar17, param_9);
            ...
            *(u16 **)(&uVar20->field_0x110 + 0x2) = puVar17;
            ...
            if(CONCAT22(uStack28, puStack30) != 0x0)
            {
                ...
                fn_ptr_1030_835a((u32 **)*(u32 **)&PTR_LOOP_1050_5748, CONCAT22(param_9, &local_14c));
                local_14c  = 0x389a;
                uStackY330 = 0x1008;
            }
            ...
            uStackY78 = 0x9902;
            pass1_1030_7e5a(CONCAT13((ppuStack24 >> 0x8), CONCAT12(ppuStack24, uStack26)), *(puVar27 + 0x4), extraout_DX_00);
            return;
        case(u16 *)0x4:
            ...
            while(CONCAT22(uStack38, uStack40) < local_6)
            {
                ...
                {
                    puVar25 = pass1_1030_560e((puVar27 & 0xffff | ZEXT24(puVar17) << 0x10));
                    uVar21  = (puVar25 >> 0x10);
                    iVar14  = puVar25;
                }
                ...
                pass1_1030_14b4(uVar20->field_0x16, puStack36, (puStack36 >> 0x10), CONCAT22(pcStack12, puStack14) & 0xffffff, param_9);
                lVar6    = CONCAT22(uStack38, uStack40) + 0x1;
                uStack40 = lVar6;
                uStack38 = (lVar6 >> 0x10);
            }
        ...
        case(u16 *)0x6:
            ...
            for(local_30 = 0x0; local_30 < local_6; local_30 = ((long)local_30 + 0x1))
            {
                ...
                {
                    uVar12 = puStack32;
                    pass1_1038_30aa((puVar27 & 0xffff | ZEXT24(puVar17) << 0x10), param_9);
                }
        ...
        case(u16 *)0x9:
            ...
            pcStack12 = (fn_ptr_1)uVar20->field_0x2e;
        ...
        case(u16 *)0xa:
            ...
            while(CONCAT22(uVar10, uVar21) < local_6)
            {
                ...
                {
                    puVar25 = pass1_1028_b204((puVar27 & 0xffff | ZEXT24(puVar17) << 0x10));
                    uVar15  = (puVar25 >> 0x10);
                    iVar14  = puVar25;
                }
                ...
                pcStack12 = (fn_ptr_1)(uVar5 >> 0x10);
                puVar17   = (u16 *)(uVar16 & 0xff);
                pass1_1030_14b4(uVar20->field_0x22, uVar19, uVar22, uVar5 & 0xffff | (uVar16 & 0xff) << 0x10, param_9);
        ...
        case(u16 *)0xb:
            ...
            iVar14    = 0x1d;
            uStackY78 = 0x7b0a;
            puVar25   = mixed_1010_20ba(_PTR_LOOP_1050_0ed0, 0x2b, param_9, puVar17, param_7);
            puVar17   = (u16 *)(puVar25 >> 0x10);
            param_4   = puVar25;
            pass1_1010_043a(puVar25, CONCAT13(uVar31, CONCAT12(uVar29, puVar17)), iVar14, param_9);
        code_r0x10287b17:
            ...
            {
                puVar25 = mixed_1010_20ba(_PTR_LOOP_1050_0ed0, 0x2f, param_9, (puStack10 >> 0x10), param_7);
                uVar32  = (undefined)(puVar25 >> 0x10);
                uVar33  = (undefined)(puVar25 >> 0x18);
                uVar35  = 0x1;
                uVar36  = 0x0;
                uVar29  = puVar25;
                uVar31  = (puVar25 >> 0x8);
                while(CONCAT11(uVar36, uVar35) < 0x9)
                {
                    uVar28 = uVar29;
                    uVar30 = uVar31;
                    if((CONCAT11(uVar31, uVar29) + 0x34 + CONCAT11(uVar36, uVar35) * 0x4) == local_6)
                    {
                        puVar9   = (u16 *)(&PTR_LOOP_1050_0000 + 0x1);
                        local_30 = CONCAT22(local_30._2_2_, 0x1);
                        uVar35   = 0xd7;
                        uVar36   = 0x7b;
                        pass1_1008_612e(0x1, 0x64, 0x1);
                        puVar17 = (u16 *)(CONCAT11(uVar36, uVar35) - 0x7);
                        if(puVar17 == (u16 *)0x0)
                        {
                            bVar24 = SBORROW2(puVar9, 0x32);
                            puVar8 = puVar9 + -0x19;
                            bVar23 = puVar9 == (u16 *)(s_New_failed_in_Op__Op_1050_0020 + 0x12);
                        LAB_1028_7b74:
                        ...
                        {
                            puVar17 = (u16 *)(CONCAT11(uVar36, uVar35) - 0x8);
                            if(puVar17 == (u16 *)0x0)
                            {
                                bVar24 = SBORROW2(puVar9, 0x19);
                                puVar8 = (u16 *)(puVar9 + -0x19);
                        ...
                        if(local_30 != 0x0)
                        {
                            pass1_1028_90e6((astruct_100 *)CONCAT13(uVar34, CONCAT12(param_9, &local_154)), CONCAT11(uVar36, uVar35), param_9, param_10);
                            puVar17 = &local_154;
                            uVar32  = 0x8;
                            uVar33  = 0x10;
                            uVar29  = 0xc;
                        ...
                        uVar35 = uVar32;
                        uVar36 = uVar33;
                        pass1_1010_ebf8(CONCAT13(uVar33, CONCAT12(uVar32, CONCAT11(uVar31, uVar29))), CONCAT11(uVar39, uVar38) + puVar17, uVar19, uVar19);
                        uVar32 = uVar29;
                        uVar33 = uVar31;
                    }
                LAB_1028_7ba0:
        ...
        case(u16 *)0xc:
            ...
            while(CONCAT22(uVar10, uVar21) < local_6)
            {
                ...
                puVar27  = switch_1030_0000(uVar20, uVar37, uStack44, puVar17, paVar18, param_6, param_7);
                ...
                puVar17   = (u16 *)(uVar16 & 0xff);
                paVar18   = uVar20;
                pass1_1030_14b4(uVar20->field_0x26, uStack40, uStack38, uVar5 & 0xffff | (uVar16 & 0xff) << 0x10, param_9);
                lVar6  = CONCAT22(uVar10, uVar21) + 0x1;
                uVar21 = lVar6;
                uVar10 = (lVar6 >> 0x10);
            }
        ...
        case(u16 *)0xd:
            ...
            uVar16     = pass1_1028_21ba(uVar20, uVar37, CONCAT22(param_9, &local_10), (long)local_6, &local_10, puVar17, param_9);
            if(uVar16 == 0x0)
            {
                ppuStack24 = (u16 **)(local_14 + 0x1);
                puStack14  = ppuStack24;
        ...
        case(u16 *)0xe:
            ...
            while(CONCAT22(uVar10, uVar21) < local_6)
            {
                ...
                pcStack12 = (fn_ptr_1)(uVar5 >> 0x10);
                puVar17   = (u16 *)(uVar16 & 0xff);
                pass1_1030_14b4(uVar20->field_0x2a, uVar19, uVar22, uVar5 & 0xffff | (uVar16 & 0xff) << 0x10, param_9);
                lVar6  = CONCAT22(uVar10, uVar21) + 0x1;
                uVar21 = lVar6;
                uVar10 = (lVar6 >> 0x10);
            }
...
u32 __stdcall16far pass1_1028_ebee(u32 param_1, u16 param_2, u16 param_3)
...
void __stdcall16far pass1_1028_ec36(u32 param_1, u16 param_2, i16 param_3, u16 param_4, u32 param_5, u16 param_6, u8 *param_7, u16 param_8)

{
    ...
    pass1_1030_1358(*(param_1 + 0xe), uVar2, puVar4, *(uVar2 + 0x4) & 0xffff | ((uVar2 + 0x6) & 0xff) << 0x10, param_8);
    return;
}


void __stdcall16far pass1_1028_ecac(u32 param_1, u16 param_2, i16 *param_3, u16 param_4, u32 param_5, u16 param_6, u8 *param_7, u16 param_8)
...
void __stdcall16far pass1_1028_ed2c(u32 param_1, u16 param_2, i16 param_3, u16 param_4, u32 param_5, u16 param_6, u8 *param_7, u16 param_8, u8 param_9)

{
    ...
    uVar2 = *(uVar3 + 0x4);
    pass1_1030_6222(_PTR_LOOP_1050_5740, 0x1, CONCAT22(puVar6, uVar4), uVar2, uVar2, puVar7, param_8);
    pass1_1030_1358(*(param_1 + 0x16), uVar3, puVar5, uVar2 & 0xffffff, param_8);
    return;
}
...
void __stdcall16far pass1_1028_edc4(u32 param_1, u16 param_2, u16 *param_3, long param_4, u8 *param_5, u16 param_6)

{
    ...
    puStack6 = param_3;
    pass1_1030_64ce(param_6, param_3, param_5, _PTR_LOOP_1050_5740, param_3, param_4, CONCAT22(param_6, local_1a));
    uVar2    = *param_3;
    uStack14 = uVar2;
    uStack10 = uVar2;
    ...
    {
        pass1_1038_3222((uVar2 & 0xffff | ZEXT24(param_5) << 0x10), uStack14, param_4, uVar1, puVar3, in_AF, param_6);
    }
...
void __stdcall16far struct_1028_d22e(u32 *param_1, u32 param_2, u16 param_3)
...
void __stdcall16far struct_1028_d59c(u32 *param_1, u8 *param_2)
...
void __stdcall16far pass1_1028_d81c(u32 *param_1, u32 param_2, u8 *param_3, u16 param_4)

{
    ...
    *param_1            = 0x0;
    ...
    if(puVar2 != 0x0)
    {
        pass1_1030_615a((astruct_137 *)(param_2 & 0xffff | ZEXT24(param_3) << 0x10), puVar2);
    }
    ...
    puVar1 = pass1_1000_4906((astruct_20 *)(param_1 & 0xffff0000 | &iVar6->field_0xa), 0x0, 0x24);
...
u32 __stdcall16far pass1_1028_e0bc(u32 param_1, i16 param_2, u32 *param_3, u8 *param_4, u16 param_5)
...
void __stdcall16far pass1_1028_e100(u32 param_1, u16 param_2, u8 *param_3)

{
    ...
    uVar4    = (astruct_311 *)fn_ptr_op_1000_1708(0xae, 0x0, 0x1, PTR_LOOP_1050_5f2c, PTR_LOOP_1050_5f2e, 0x1000);
    uVar3    = ZEXT24(uVar4);
...
void __stdcall16far pass1_1028_e28a(u8 *param_1, i16 param_2, u16 param_3)
...
void __stdcall16far pass1_1028_c3aa(u16 param_1, u16 param_2, u16 *param_3, u32 param_4, u32 param_5, u16 param_6)

{
    ...
    if(0x1e < puStack24)
    {
        ...
        if(uVar3 == 0x0)
        {
            ...
            ppcVar1 = *puStack32;
            (**ppcVar1)(0x1030, uVar4, puVar9, 0x1, uVar18, puVar8, puStack32, puStack32, uVar5, uVar20);
            return;
        }
    }
    return;
...
void __stdcall16far pass1_1028_ccd0(u8 param_1, u16 param_2, u32 param_3, u16 *param_4)

{
    ...
    puVar2 = &local_8;
    pass1_1008_3eb4(param_4, CONCAT22(param_2, puVar2), CONCAT22(param_2, &local_6), CONCAT22(param_2, &local_4));
    ...
    if((uVar6 | puVar3) != 0x0)
    {
        uStack60 = 0x0;
        iStack62 = 0x0;
        for(uStack64 = uStack12; uStack64 <= iStack16; uStack64 = uStack64 + 0x1)
        {
            for(uStack72 = uStack10; iVar4 = iStack62, uStack72 <= iStack14; uStack72 = uStack72 + 0x1)
            {
                ...
                if(uStack60._3_1_ == '\0')
                {
                    ...
                    struct_op_1028_87f0(param_2, param_1, (astruct_97 *)CONCAT22(param_2, &local_178), 0x0, 0x0, uVar8, param_4, (param_4 >> 0x10), CONCAT22(uVar10, uVar9), CONCAT22(uVar12, uVar11));
...
void __stdcall16far pass1_1028_d078(u16 param_1, u32 param_2, u32 param_3)

{
    ...
    uVar6    = pass1_1038_565e(param_1, (uStack4 | puStack6), CONCAT22(uStack4, puStack6));
    uStack8  = (uVar6 >> 0x10);
    uStack10 = uVar6;
...
astruct_100 *__stdcall16far struct_op_1028_d1dc(u16 param_1, u8 param_2, astruct_100 *param_3, u16 param_4)
