...
void  pass1_1028_ef00(u16 param_1, u8 *param_2, u32 param_3, u16 param_4, u16 param_5, u16 param_6, u16 param_7) {
    ...
    if(param_5 == 0x4) {
        mem_op_1000_179c(0x16, param_2, SEG_1000);
        ...
        if(param_5 == 0xc) {
            mem_op_1000_179c(0xe, param_2, SEG_1000);
...
u16 * switch_1030_07ac(u16 param_1, u16 param_2, u16 param_3, u16 param_4, u16 param_5, u32 param_6, u8 *param_7, Struct179 *param_8, u16 param_9, u16 param_10, u16 param_11) {
    ...
    switch(param_4 - 0x1) {
        ...
        case 0x7:
        case 0x8:
            mem_op_1000_179c(0x20, param_7, SEG_1000);
            ...
            break;
        case 0x9:
            mem_op_1000_179c(0x22, param_7, SEG_1000);
            if((param_7 | param_8) != 0x0) {
            ...
            break;
        case 0xa:
            mem_op_1000_179c(0x26, param_7, SEG_1000);
            uVar1 = param_7 | param_8;
            goto joined_r0x10300adb;
        case 0xb:
            mem_op_1000_179c(0x2c, param_7, SEG_1000);
            if((param_7 | param_8) != 0x0) {
        ...
        case 0x5f:
        case 0x60:
            mem_op_1000_179c(0x24, param_7, SEG_1000);
            if((param_7 | param_8) != 0x0) {
        ...
        case 0x2c:
        case 0x2d:
            mem_op_1000_179c(0x2a, param_7, SEG_1000);
            if((param_7 | param_8) != 0x0) {
        ...
        case 0x37:
        case 0x38:
            mem_op_1000_179c(0x9a, param_7, SEG_1000);
            if((param_7 | param_8) != 0x0) {
        ...
        case 0x72:
        case 0x76:
            mem_op_1000_179c(0x26, (puVar4 >> 0x10), SEG_1000);
            uVar3 = (puVar4 >> 0x10);
            if(puVar4 != 0x0) {
        ...
        switch(puVar17) {
            case0x0:
                ...
                while(CONCAT22(uStack26, uStack28) < local_6) {
                    pu_var27 = local_6;
                    mem_op_1000_179c(0x14, puVar17, SEG_1000);
                    puStack32 = pu_var27;
                    puStack30 = puVar17;
...
//                halt_baddata();
            case0x2:
                ...
                while(CONCAT22(uStack38, uStack40) < local_6) {
                    pu_var27 = local_6;
                    mem_op_1000_179c(0x1c, puVar17, SEG_1000);
                    puStack32 = pu_var27;
            ...
            case0x3:
                ...
                local_16  = uVar19;
                local_14  = puVar17;
                pass1_1030_61fe(globals->_PTR_LOOP_1050_5740, CONCAT22(puVar17, uVar19), param_1 & 0xffff0000 | &u_var20->field_0x114, &u_var20->field_0x108, uVar19, puVar17, param_9);
            ...
            case0x4:
                ...
                while(CONCAT22(uStack38, uStack40) < local_6) {
                    pu_var27 = local_6;
                    mem_op_1000_179c(0x1e, puVar17, SEG_1000);
                    puStack32 = pu_var27;
                    puStack30 = puVar17;
                    if((puVar17 | puStack32) == 0x0) {
                        iVar14 = 0x0;
            ...
            case0x6:
                ...
                for (local_30 = 0x0; local_30 < local_6; local_30 = ((long) local_30 + 0x1)) {
                    pu_var27 = local_6;
                    mem_op_1000_179c(0x21e, puVar17, SEG_1000);
                    puStack32 = pu_var27;
                    uVar16 = puVar17 | puStack32;
                    puStack30 = puVar17;
                    if(uVar16 == 0x0) {
            ...
            default:
                ...
                while(true) {
                    ...
                    p_var26   = pass1_1000_07fc(SEG_1000, globals->PTR_LOOP_1050_5744);
                    ...
                    uStackY78 = 0xe977;
                    pass1_1030_671c(globals->_PTR_LOOP_1050_5740, uVar5, CONCAT22(param_9, &stack0xffca), lVar6, &stack0xffca, uStack42, param_7, param_9);
            ...
            case0xa:
                ...
                while(CONCAT22(uVar10, u_var21) < local_6) {
                    pu_var27 = local_6;
                    mem_op_1000_179c(0xe, puVar17, SEG_1000);
                    puStack32 = pu_var27;
                    puStack30 = puVar17;
                    if((puVar17 | puStack32) == 0x0) {
                        iVar14 = 0x0;
            ...
            case0xb:
                ...
                iVar14    = 0x1d;
                uStackY78 = 0x7b0a;
                pu_var25   = mixed_1010_20ba(globals->u16_1050_0ed0, 0x2b, param_9, puVar17, param_7);
            ...
            code_r0x10287b17:
                ...
                puStack10 = mixed_1010_20ba(globals->u16_1050_0ed0, 0x2, param_9, puVar17, param_7);
                pcStack12 = (fn_ptr_1)PTR_LOOP_1050_13ae;
                if(0x2 < globals->PTR_LOOP_1050_13ae) {
                    pu_var25 = mixed_1010_20ba(globals->u16_1050_0ed0, 0x2f, param_9, (puStack10 >> 0x10), param_7);
                    ...
                    while(CONCAT11(uVar36, uVar35) < 0x9) {
                        ...
                        if((CONCAT11(uVar31, u_var29) + 0x34 + CONCAT11(uVar36, uVar35) * 0x4) == local_6) {
                            ...
                            if(local_30 != 0x0) {
                                ...
                                u_var29  = 0xc;
                                uVar31  = 0x7c;
                                fn_ptr_1030_835a(globals->_PTR_LOOP_1050_5748, CONCAT22(param_9, puVar17));
            ...
            case0xe:
                ...
                while(CONCAT22(uVar10, u_var21) < local_6) {
                    pu_var27 = local_6;
                    mem_op_1000_179c(0x3b2, puVar17, SEG_1000);
                    puStack32 = pu_var27;
                    uVar16    = puVar17 | puStack32;
                    puStack30 = puVar17;
                    if(uVar16 == 0x0) {
...
u32  pass1_1028_ebee(u32 param_1, u16 param_2, u16 param_3) {
    ...
    mem_op_1000_179c(0x14, param_3, SEG_1000);
    ...
    u_var2          = (globals->_PTR_LOOP_1050_5166 >> 0x10);
    return CONCAT22((globals->_PTR_LOOP_1050_5166 + 0x6), (globals->_PTR_LOOP_1050_5166 + 0x4));
}
...
void  pass1_1028_ec36(u32 param_1, u16 param_2, i16 param_3, u16 param_4, u32 param_5, u16 param_6, u8 *param_7, u16 param_8) {
    ...
    mem_op_1000_179c(0x14, param_7, SEG_1000);
...
void  pass1_1028_ecac(u32 param_1, u16 param_2, i16 *param_3, u16 param_4, u32 param_5, u16 param_6, u8 *param_7, u16 param_8) {
    ...
    mem_op_1000_179c(0x1c, param_7, SEG_1000);
...
void  pass1_1028_ed2c(u32 param_1, u16 param_2, i16 param_3, u16 param_4, u32 param_5, u16 param_6, u8 *param_7, u16 param_8, u8 param_9) {
    ...
    mem_op_1000_179c(0x1e, param_7, SEG_1000);
    if((param_7 | param_6) == 0x0) {
        uVar3  = 0x0;
        puVar5 = 0x0;
    } else {
    ...
    u_var2 = *(uVar3 + 0x4);
    pass1_1030_6222(globals->_PTR_LOOP_1050_5740, 0x1, CONCAT22(puVar6, uVar4), u_var2, u_var2, puVar7, param_8);
...
void  pass1_1028_edc4(u32 param_1, u16 param_2, u16 *param_3, long param_4, u8 *param_5, u16 param_6) {
    ...
    uStack14 = u_var2;
    uStack10 = u_var2;
    mem_op_1000_179c(0x21e, param_5, SEG_1000);
    uVar1  = u_var2;
...
void  pass1_1028_d81c(u32 *param_1, u32 param_2, u8 *param_3, u16 param_4) {
    ...
    mem_op_1000_179c(0x4, puVar3, SEG_1000);
    ...
    mem_op_1000_179c(0x1c, pu_var2, SEG_1000);
    ...
    mem_op_1000_179c(0x1c, puVar3, SEG_1000);
...
void  pass1_1028_e100(u32 param_1, u16 param_2, u8 *param_3) {
    ...
    uVar4    = (Struct311 *)fn_ptr_op_1000_1708(0xae, 0x0, 0x1, globals->dat_1050_5f2c, globals->dat_1050_5f2e, SEG_1000);
    uVar3    = uVar4;
...
void  pass1_1028_e28a(u8 *param_1, i16 param_2, u16 param_3) {
    ...
    puVar4  = mixed_1010_20ba(globals->u16_1050_0ed0, 0x2f, param_3, param_1, param_2);
    uVar3   = (puVar4 >> 0x10);
    pu_var2  = (puVar4 + 0xa);
    ppcVar1 = (*pu_var2 + 0x4);
...
void  pass1_1028_c3aa(u16 param_1, u16 param_2, u16 *param_3, u32 param_4, u32 param_5, u16 param_6) {
    ...
    if(0x1e < puStack24) {
        uVar3   = 0x87;
        puVar13 = mixed_1010_20ba(globals->u16_1050_0ed0, 0x9, param_6, puVar8, unaff_DI);
...
void  pass1_1028_ccd0(u8 param_1, u16 param_2, u32 param_3, u16 *param_4) {
    ...
    puStack48 = mixed_1010_20ba(globals->u16_1050_0ed0, 0x2f, param_2, puVar5, unaff_DI);
    uVar6     = (puStack48 >> 0x10);
    uStack52  = *(puStack48 + 0x20);
    puVar3    = local_2c;
    pass1_1030_6522(globals->_PTR_LOOP_1050_5740, CONCAT22(param_2, puVar3), uStack52, param_2);
        ...
        for(u_stack64 = uStack12; u_stack64 <= iStack16; u_stack64 = u_stack64 + 0x1) {
            for(uStack72 = uStack10; iVar4 = iStack62, uStack72 <= iStack14; uStack72 = uStack72 + 0x1) {
                ...
                if(u_stack60._3_1_ == '\0') {
                    ...
                    fn_ptr_1030_835a(globals->_PTR_LOOP_1050_5748, CONCAT22(param_2, &local_178));
