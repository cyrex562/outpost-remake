...

{
    ...
    param_1           = 0x840c;
    iVar2->fld2_segment     = 0x1040//SEG_1040;
...

{
    ...
    sys_1000_3f9c(local_16, param_7, 0x5a1a, SEG_1050, *&iVar5->field_0x4, &stack0xfffe, uVar5, SEG_1000, param_7, param_6);
...

{
    ...
    param_1->fld0_addr_table = 0x1c2e;
    iVar2->fld2_segment  = SEG_1038;
