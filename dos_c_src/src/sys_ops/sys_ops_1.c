...

{
    ...
    if(pcVar5 != 0x0)
    {
        ...
        uVar6 = pass1_1038_af40(_PTR_LOOP_1050_5b7c, (u_var2 + 0x6), 0x3, uVar1, u_var2, 0x1010, param_4);
    }
    return uVar6;
}
...

{
    ...
    {
        pass1_1038_16f2(param_1, puStack10, param_2, extraout_DX | uVar4, ppcVar6, (u_var2 >> 0x10), 0x1008, param_4, param_5);
        if(puStack10 != 0x0)
        {
            ppcVar1 = *puStack10;
