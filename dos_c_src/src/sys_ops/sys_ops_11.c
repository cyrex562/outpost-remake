...

{
    ...
    *pu_var2                      = 0x70;
    ...
    uVar10                       = SEG_1000;
    mem_op_1000_179c(0x126, puVar6, SEG_1000);
    uVar4     = uVar5;
    puVar7    = (puVar6 | uVar4);
    uStack18  = uVar4;
    puStack16 = puVar6;
    ...
    uVar10 = SEG_1000;
    mem_op_1000_179c(0xe8c, puVar7, SEG_1000);
    puVar6    = (puVar7 | uVar4);
    uStack18  = uVar4;
    puStack16 = puVar7;
    if(puVar6 != 0x0)
    ...
    uVar10 = SEG_1000;
    mem_op_1000_179c(0xb0, puVar6, SEG_1000);
    puVar7    = (puVar6 | uVar4);
    uStack18  = uVar4;
    puStack16 = puVar6;
    if(puVar7 != 0x0)
    ...
    {
        uVar10 = SUB42(SEG_1038, 0x0);
        make_proc_inst_1038_cf6c(CONCAT22(puVar7, uVar4), puVar6, SEG_1038);
    }
    ...
    mem_op_1000_179c(0xfc, puVar7, SEG_1000);
    uVar8     = puVar7 | uVar4;
    uStack18  = uVar4;
    puStack16 = puVar7;
    if(uVar8 == 0x0)
    ...
    {
        set_struct_op_1008_0536(CONCAT22(puVar7, uVar4), SEG_1000, param_2);
    }
    (iVar3 + 0x4) = uVar4;
    (iVar3 + 0x6) = uVar8;
    if((iVar3 + 0x4) == 0x0)
...

{
    ...
    do
    {
        ...
        if((uVar7 | uVar6) != 0x0)
        {
            ...
            uVar17 = 0x0;
            uVar11 = uVar7;
            HVar8  = GLobalAlloc16(SEG_1000, CONCAT22(uVar7, uVar6));
...

{
    ...
    if((*(u8 *)(param_3 + 0x2) & 0x4) == 0x0)
    {
        ...
        HVar4   = GlobalReAlloc16(SEG_1000, CONCAT22(param_1, 0x20), (param_1 == 0x0));
        if(HVar4 == 0x0)
        {
        LAB_1000_3cb6:
...
LAB_1000_272e:
    ...
    LAB_1000_27c1:
        ...
        *ppcVar10           = 0x0;
        ...
        globals->_PTR_LOOP_1050_5fc2 = CONCAT22(globals->PTR_LOOP_1050_5fc4, globals->PTR_LOOP_1050_5fc2);
        return;
    }
    *ppcVar10     = pcVar13;
