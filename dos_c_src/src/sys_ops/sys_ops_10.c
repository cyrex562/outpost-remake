...

{
    ...
    if(iStack4 == 0x0)
    {
        ...
        puVar13 = uStack26;
        uVar9   = uVar8;
        mem_op_1000_179c(0x10, uStack26, 0x1000);
        puStack18 = uVar9;
        puStack16 = puVar13;
...

{
    ...
    win_ui_reg_class_1008_96d2(param_1, 0x1538, param_4);
    return param_1;
}
...

{
    ...
    (**ppcVar1)(0x1000, (param_1 + 0xd2), param_1, pu_stack6);
    return;
}
...

{
    ...
    while(true)
    {
        ...
        ppcVar1 = (*pu_var2 + 0x8);
        uVar3   = (**ppcVar1)(0x1010, pu_var2, param_3);
        param_4 = (uVar3 >> 0x10);
        if(uVar3 == 0x0)
            break;
        iStack4 = iStack4 + 0x1;
