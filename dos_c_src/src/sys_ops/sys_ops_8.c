        ...
        if(param_3 < 0x16)
        {
            if(param_3 == '\x06')
            {
                ...
                if(((uVar1 == 0xe) && ((pu_var2 != 0x0 || (0x32 < uVar3)))) && ((param_2 == 0x1 || (((param_2 == 0x2 || (param_2 == 0x4)) || (param_2 == 0x3))))))
                {
                    ...
                    iVar7  = 0x0;
                    uVar5  = 0x0;
                    paVar4 = (Struct67 *)mixed_1010_20ba(globals->_PTR_LOOP_1050_0ed0, 0x37, param_6, pu_var2, param_5);
...
u32  pass1_1010_8c32(Struct640 *param_1, u16 param_2, u16 param_3, u16 param_4)

{
    ...
    pu_var2                     = mixed_1010_20ba(globals->_PTR_LOOP_1050_0ed0, 0x3, param_4, (paVar1 >> 0x10), unaff_DI);
    ...
    if(uVar5 != 0x0)
    {
        ...
        if(uVar5 == 0x1)
        {
            ...
            case 0x1:
                ...
                if(0x0 < iStack12)
                {
                    pcVar10 = load_string_1010_847e(_PTR_LOOP_1050_14cc, (u16)(_PTR_LOOP_1050_14cc >> 0x10), (HINSTANCE16)SEG_1028);
...

{
    ...
    puVar4           = mixed_1010_20ba(globals->_PTR_LOOP_1050_0ed0, 0x3, param_3, pu_var2, unaff_DI);
    iVar3->field_0x8 = puVar4;
    iVar3->field_0xa = (puVar4 >> 0x10);
    return;
}

u32  pass1_1010_9298(Struct79 *param_1, Struct79 *param_2, u16 param_3, u16 param_4, u8 *param_5, u16 param_6)

{
    struct_1010_2cd2(param_1, param_2, param_3, param_6);
    param_1 =  addr_table_1010_9566;//0x9566;
    param_1->field_0x2         = SEG_1010;
    mem_op_1000_179c(0x20c, param_5, SEG_1000);
...

{
    ...
    if(0x0 < param_4)
    {
        if(_PTR_LOOP_1050_3528 == 0x0)
        {
            ...
            uVar6               = (**ppcVar1)();
            globals->_PTR_LOOP_1050_3528 = mixed_1010_20ba(globals->_PTR_LOOP_1050_0ed0, uVar6, unaff_SS, (uVar6 >> 0x10), unaff_DI);
        }
        uVar6 = (param_1 + 0xc);
...

{
    ...
    if(iVar9->field_0x18 == 0x0)
    {
        ...
        mem_op_1000_179c(0xc, puVar7, SEG_1000);
        uVar4 = puVar6;
        if((puVar7 | uVar4) == 0x0)
        {
            uVar4 = 0x0;
...
void  pass1_1010_878c(Struct87 **param_1, i16 param_2, HINSTANCE16 param_3)

{
    ...
    if(puVar3 != 0x0)
    {
        ...
        param_3 = SEG_1000;
        fn_ptr_1000_17ce((Struct18 *)CONCAT22(puVar4, uVar1), SEG_1000);
    }
    if((param_2 == 0x1) || (param_2 == 0x2))
    {
        ...
        paVar8 = *param_1;
        paVar9 = (Struct87 *)CONCAT22(puVar3, u_var2);
    LAB_1010_8853:
        uVar4 = paVar9;
    ...
    else
    {
        ...
        mem_op_1000_179c(0x8, (paVar9 >> 0x10), SEG_1000);
...

{
    ...
    (**ppcVar1)();
    puVar3                       = mixed_1010_20ba(globals->_PTR_LOOP_1050_0ed0, 0x2f, unaff_SS, extraout_DX, unaff_DI);
...

{
    ...
    in_buffer_4 = param_4;
    mem_op_1000_179c(0x80, in_buf_len_5, SEG_1000);
    load_string_1010_84e0(SEG_1000, globals->PCHAR_1050_14cc, (_PTR_LOOP_1050_14cc >> 0x10), 0x80, in_buffer_4, (short)in_buf_len_5);
...
void  win_sys_op_1010_5404(Struct54 *param_1, u16 param_2, u16 param_3, u16 param_4)

{
    ...
    paVar17                    = struct_op_1010_1d48((Struct79 *)CONCAT22(param_2, param_1), param_3);
    ...
    mem_op_1000_179c(0x101, puVar12, SEG_1000);
    ...
    pcVar18  = load_string_1010_847e(_PTR_LOOP_1050_14cc, (u16)(_PTR_LOOP_1050_14cc >> 0x10), SEG_1000);
    ...
    if(*param_1->field_0xe != '\0')
    {
        ...
        puVar19             = mixed_1010_20ba(globals->_PTR_LOOP_1050_0ed0, 0x48, param_4, puVar12, unaff_DI);
    ...
    *(u16 **)&param_1->field_0x64 = puVar9;
    ...
    mem_op_1000_179c(0x8, puVar12, SEG_1000);
    ...
    if(*param_1->field_0xe != '\0')
    {
        ...
        while(uStack46 = pass1_1000_47a4(CONCAT22(u_var20, uVar15), 0x105013f8, param_4), (puVar12 | uStack46) != 0x0)
        {
            puStack44 = puVar12;
...

{
    ...
    if(param_2 == 0x0)
    {
        puVar1 = mixed_1010_20ba(globals->_PTR_LOOP_1050_0ed0, 0x2e, param_5, param_3, param_4);
...
void  pass1_1010_4a8a(Struct637 *param_1, u16 param_2, u16 param_3, u16 param_4)

{
    ...
    puVar3                       = mixed_1010_20ba(globals->_PTR_LOOP_1050_0ed0, 0x3, param_4, puVar1, unaff_DI);
...

{
    ...
    if(&iVar3->field_0x1a_addr_offset == 0x0)
    {
        ...
        mem_op_1000_179c(u_var2, param_7, SEG_1000);
...

{
    ...
    while(true)
    {
        ...
        u_stack6 = CONCAT22(puVar4, puVar3);
...

{
    ...
    {
        uVar7 = SEG_1000;
        mem_op_1000_179c(0x4a, param_3, SEG_1000);
        uVar3 = param_2;
        uVar5 = param_3 | uVar3;
        if(uVar5 == 0x0)
        {
        ...
        for(; (uStack12 & 0xf) != 0x0; uStack12 = uStack12 >> 0x4)
        {
            ...
            uVar7    = SEG_1000;
            puVar4   = puStack8;
            mem_op_1000_179c(0x4a, puVar6, SEG_1000);
            uVar3 = puVar4;
            uVar5 = puVar6 | uVar3;
            if(uVar5 == 0x0)
            {
...

{
    ...
    {
        pass1_1040_c54a(CONCAT22(param_6, param_5), 0x1, CONCAT22(param_4, param_3), SEG_1040, param_7);
        return;
    }
    return;
}
...

{
    ...
    {
        uVar1 = param_2 << 0x2;
        mem_op_1000_179c(uVar1, param_4, SEG_1000);
        u_var2            = (param_1 >> 0x10);
...

{
    ...
    mem_op_1000_179c(0x16, param_5, SEG_1000);
    if((param_5 | param_4) != 0x0)
    {
...
u32  pass1_1010_3d82(Struct628 *param_1, u16 param_2, u16 param_3, u16 param_4)
...
void  pass1_1010_3e3c(Struct55 *param_1, u16 param_2, u16 param_3)
...

{
    ...
    puVar12           = mixed_1010_20ba(globals->_PTR_LOOP_1050_0ed0, 0x2f, param_4, param_3, unaff_DI);
    ...
    mem_op_1000_179c(uVar4, puVar8, SEG_1000);
