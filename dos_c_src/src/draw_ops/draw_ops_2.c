...

{
    ...
    hwnd = SEG_1010;
    puStack38
      = mixed_1010_20ba(globals->_PTR_LOOP_1050_0ed0, 0x2, param_2, in_DX, unaff_DI);
...

{
    ...
    do
    {
        ...
        MoveToEx16(
          (HDC16)LAST_SEGMENT, (u16)local_38, param_3, *(POINT16 **)(iVar3 + puStack26));
...
//    Struct129 *iVar2;
    ...
    unk_draw_op_1020_7f7a(globals, param_2, 0x5, CONCAT22(param_4, param_3));
//    u_var2             = (param_2 >> 0x10);
//    iVar2              = (Struct129 *)param_2;
    ...
    puVar3 = mixed_1010_20ba(globals->_PTR_LOOP_1050_0ed0, 0x25, param_1, extraout_DX, unaff_DI);
    uVar1  = (puVar3 >> 0x10);
...

{
    ...
    param_1->field_0x2         = SEG_1020;
    puVar5 = mixed_1010_20ba(globals->_PTR_LOOP_1050_0ed0, 0x25, param_5, extraout_DX, param_4);
    uVar4  = (puVar5 >> 0x10);
...
void draw_op_1020_7cc8(Globals *globals,
                       Struct6 *struct_arg1, HWND16   hwnd_arg2, u16 param_3)
...

{
    ...
    paVar6 = unk_draw_op_1008_61b2(
      NULL, param_1, param_2, param_3, CONCAT22(in_stack_0000000e, param_3), unaff_SS);
    puVar4 = (paVar6 >> 0x10);
    //    uVar5                      = (param_1 >> 0x10);
    //    iVar4                      = param_1;
    ...
    puVar7
      = mixed_1010_20ba(globals->_PTR_LOOP_1050_0ed0, 0x48, unaff_SS, puVar4, unaff_DI);
    uVar1               = (puVar7 >> 0x10);
...

{
    ...
    {
        InvalidateRect16(
          (HWND16)LAST_SEGMENT, (RECT16 *)(&PTR_LOOP_1050_0000 + 0x1), 0x0);
    }
    return;
}
...

{
    ...
    if(BVar4 == 0x0)
    {
        ...
        if(local_30 != 0x0)
        {
            ...
            puVar5 = local_42;
            pass1_1008_8ce4(
              local_30, CONCAT22(param_3, puVar5), local_brush_handle, param_3);
            (iVar8 + 0x14) = puVar5;
            (iVar8 + 0x16) = uVar7;
        }
    ...
    else
    {
        if(PTR_LOOP_1050_0010 == 0x0)
        {
            ...
            if(BVar4 != 0x0)
            {
                ...
                iStack50           = iStack56;
                FillRect16(
                  (HDC16)LAST_SEGMENT, local_rect, (HBRUSH16)&local_brush_handle);
                DrawIcon16((HDC16)LAST_SEGMENT, BStack38, 0x2, 0x2);
            }
        }
    }
    BVar4 = EndPaint16((HWND16)LAST_SEGMENT, &local_paint_struct);
    return BVar4;
}
...

{
    ...
    (iVar8 + 0x2)      = SEG_1020;
    puVar10        = mixed_1010_20ba(globals->_PTR_LOOP_1050_0ed0, 0x6, unaff_SS, in_DX, unaff_DI);
    uVar7          = (puVar10 >> 0x10);
    (iVar8 + 0x14) = puVar10;
    (iVar8 + 0x16) = uVar7;
...

{
    ...
    if((*(u8 *)(param_1 + 0xe) & 0x1) != 0x0)
    {
        ...
        Rectangle16((HDC16)LAST_SEGMENT,
                    local_6 + param_2 + 0x5,
                    local_4 + param_3 + 0x5,
                    local_6 + param_2 + -0x5,
                    local_4 + param_3 + -0x5);
...

{
    ...
    uVar5->field_0xe2  = addr_table_1020_623c[39];//0x62d8;
    ...
    puVar8
      = mixed_1010_20ba(globals->_PTR_LOOP_1050_0ed0, 0x29, unaff_SS, puVar4, unaff_DI);
...

{
    ...
    pass1_1018_0d9a(
      *(iVar4 + 0x14), CONCAT22(param_3, &local_c), CONCAT22(param_3, &local_a));
    uVar3 = (iVar4 + 0x14);
    draw_op_1020_33c0(param_1, *(uVar3 + 0x6c), local_c, local_a, 0x1, local_4, SEG_1018);
    pass1_1018_1054(
      *(iVar4 + 0x14), CONCAT22(param_3, &local_c), CONCAT22(param_3, &local_a), param_3);
    uVar3 = (iVar4 + 0x14);
...
void draw_op_1020_33c0(u32 param_1,
                       u32 param_2,
                       i16 param_3,
                       u32 param_4,
                       i16 param_5,
...

{
    ...
    if(param_3 != 0x0)
    {
        ...
        for(iStack20 = 0x0; iStack20 < param_3; iStack20 = iStack20 + 0x1)
        {
            ...
            hdc = SEG_1000;
            fn_ptr_1000_17ce((Struct18 *)CONCAT22(in_DX, iVar1), SEG_1000);
...

{
    ...
    pass1_1008_3e94(
      pu_stack6, CONCAT22(unaff_SS, &local_a), CONCAT22(unaff_SS, &local_a + 0x2));
...

{
    ...
    if((u_var2 + 0x100) == 0x0)
    {
        ...
        uVar4            = pass1_1038_af40(_PTR_LOOP_1050_5b7c,
                                (u_var2 + 0x8),
                                iVar1,
                                param_2,
                                u_var2,
            ...
            *pbVar2  = *pbVar2 | bVar12;
            ...
            code_rSEG_10203db1:
                ...
                *puVar6         = addr_table_1020_408a;//0x408a;
                (puVar6 + 0x2)  = SEG_1020;
                puVar32
                  = mixed_1010_20ba(globals->_PTR_LOOP_1050_0ed0, 0x6, param_9, pu_var24, pcVar27);
...

{
    ...
    *(HDC16 **)(iVar12 + 0x10) = pHVar5;
    ...
    while((puVar14 + -0x38) < (puVar14 + -0x28))
    {
        ...
        u_var2 = (puVar14 + -0x30);
        pass1_1008_3e76(
          CONCAT22(param_3, puVar14 + -0x36), 0x0, u_var2, (u_var2 >> 0x10));
        u_var2 = (puVar14 + -0x2c);
...

{
    ...
    if(param_2 != 0x0)
    {
        ...
        u_var2  = pass1_1020_23f2(
          param_1, uVar3, CONCAT22(param_3, local_a), (puVar1 >> 0x10), param_3);
...

{
    ...
    puVar3 = mixed_1010_20ba(globals->_PTR_LOOP_1050_0ed0, 0x2a, param_4, extraout_DX, unaff_DI);
    uVar1  = (puVar3 >> 0x10);
...

{
    ...
    param_1->field_0x2         = SEG_1020;
    puVar5 = mixed_1010_20ba(globals->_PTR_LOOP_1050_0ed0, 0x2a, param_5, extraout_DX, param_4);
    uVar4  = (puVar5 >> 0x10);
    param_1->field_0x14 = puVar5;
    param_1->field_0x16 = uVar4;
    param_1->field_0x6  = param_1->field_0x14;
