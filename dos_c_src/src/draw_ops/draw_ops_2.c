...
void __stdcall16far unk_draw_op_1018_cda8(astruct_36 *param_1, u16 param_2)

{
    ...
    if(uVar5 == 0x0)
    {
        ...
        PostMessage16((HWND16)s_tile2_bmp_1050_1538, 0x0, 0x0, CONCAT22(0x111, (iVar10 + 0xea)));
        return;
    }
    if((iVar10 + 0xf0) == 0x0)
    {
        (iVar10 + 0xf0) = 0x1;
        hwnd            = 0x1008;
        win_1008_5c5c(param_2, uVar5, uVar8, _PTR_LOOP_1050_02a0, 0x1f3);
        uVar12 = (_PTR_LOOP_1050_02a0 >> 0x10);
        if((_PTR_LOOP_1050_02a0 + 0x12) == 0x0)
        {
            hwnd = 0x1008;
            win_1008_5c5c(param_2, uVar5, uVar8, _PTR_LOOP_1050_02a0 & 0xffff | uVar12 << 0x10, 0x1d3);
        }
    }
...
void __stdcall16far unk_draw_op_1018_cfc0(astruct_36 *param_1, u16 param_2)
...
void __stdcall16far palette_op_1020_92c4(u16 *param_1, HDC16 param_2)
...
void __stdcall16far mix_draw_op_1020_9312(u32 param_1, HWND16 param_2)

{
    ...
    puVar1  = (uVar3 + 0xa);
    ppcVar2 = (*puVar1 + 0x4);
    (**ppcVar2)(s_tile2_bmp_1050_1538, puVar1, (puVar1 >> 0x10), 0x0, param_1 & 0xffff0000 | (iVar4 + 0xa), uVar6);
    EndPai1616((HWND16)s_tile2_bmp_1050_1538, &local_22);
    return;
}

void __stdcall16far draw_op_1020_9364(astruct_7 *param_1, HWND16 in_win_handle_2, i1616 param_3)

{
    ...
    do
    {
        ...
        HStack50 = CreatePen16((i1616)s_tile2_bmp_1050_1538, (i1616)uVar4, (COLORREF)(uVar4 >> 0x10));
        HStack52 = SelectObject16((HDC16)s_tile2_bmp_1050_1538, HStack50);
        MoveToEx16((HDC16)s_tile2_bmp_1050_1538, (i1616)local_38, param_3, *(POi1616 **)(uStack58 * 0x2 + puStack26));
        LineTo16((HDC16)s_tile2_bmp_1050_1538, (puStack26 + uStack58 * 0x2), (i1616)uStack6);
        iVar3 = (iStack20 - uStack58) * 0x2;
        MoveToEx16((HDC16)s_tile2_bmp_1050_1538, (i1616)local_38, param_3, *(POi1616 **)(iVar3 + puStack26));
        LineTo16((HDC16)s_tile2_bmp_1050_1538, (puStack26 + iVar3), (i1616)uStack6);
    ...
    uStack6  = CONCAT22(uVar2, (i1616)uStack6);
    ...
    do
    {
        ...
        MoveToEx16((HDC16)s_tile2_bmp_1050_1538, (i1616)local_38, param_3, *(POi1616 **)((iVar5 + uStack46) * 0x2 + puStack26));
        LineTo16((HDC16)s_tile2_bmp_1050_1538, ((iStack20 - *piVar1) * 0x2 + puStack26), iVar3 + local_a.x);
        iVar3 = ((iStack22 - uStack58) * 0x2 + uStack42);
        MoveToEx16((HDC16)s_tile2_bmp_1050_1538, (i1616)local_38, param_3, *(POi1616 **)(*piVar1 * 0x2 + puStack26));
        LineTo16((HDC16)s_tile2_bmp_1050_1538, ((iStack20 - *piVar1) * 0x2 + puStack26), iVar3 + local_a.x);
        SelectObject16((HDC16)s_tile2_bmp_1050_1538, HStack52);
        DeleteObject16((HGDIOBJ16)s_tile2_bmp_1050_1538);
        uStack58 = uStack58 - 0x1;
...
astruct_18 *__stdcall16far pass1_1020_96a2(astruct_18 *param_1, byte param_2, u16 param_3)
...
astruct_18 *__stdcall16far pass1_1020_7526(astruct_18 *param_1, byte param_2, u16 param_3)
...
void __stdcall16far struct_1020_7554(u16 param_1, astruct_20 *param_2, u16 param_3, u16 param_4)
...
void __stdcall16far pass1_1020_7824(astruct_666 *param_1, u16 param_2, u16 param_3, i16 param_4, u16 param_5)
...
void __stdcall16far pass1_1020_78ac(u16 *param_1, u16 param_2)
...
void __stdcall16far struct_1020_790e(u16 *param_1, u32 param_2, u16 param_3, u32 param_4, u16 param_5)
...
void __stdcall16far string_1020_79b4(u16 param_1, u32 param_2, i16 param_3, char *param_4)
...
void __stdcall16far pass1_1020_79e4(u32 param_1, u16 param_2, u16 param_3)
...
void __stdcall16far draw_op_1020_7cc8(u32 param_1, HWND16 in_win_handle_2, u16 param_3)

{
    ...
    if((is_iconic == 0x0) || (PTR_LOOP_1050_0010 != 0x0))
    {
        ...
        puVar2  = (iVar3 + 0xe0);
        ppcVar1 = (*puVar2 + 0x24);
        (**ppcVar1)(s_tile2_bmp_1050_1538, puVar2, (iVar3 + 0xe2), 0x0, uVar9, HVar10, uVar11);
        ...
        if(*count != '\0')
        {
            ...
            DVar6 = GetTextExtent16((HDC16)s_tile2_bmp_1050_1538, str, (i1616)count);
            iVar3 = (DVar6 >> 0x10);
            if(is_iconic == 0x0)
            {
            ...
            TextOut16((HDC16)s_tile2_bmp_1050_1538, (i1616)str, (i1616)count, str_00, iStack66);
        }
...
void __stdcall16far unk_draw_op_1020_7f7a(astruct_20 *param_1, u16 param_2, u32 param_3)

{
    ...
    paVar6                     = unk_draw_op_1008_61b2(param_1, param_2, param_3, CONCAT22(in_stack_0000000e, param_3._2_2_), unaff_SS);
    puVar4                     = (paVar6 >> 0x10);
    uVar5                      = (param_1 >> 0x10);
    iVar4                      = param_1;
    ...
    unk_str_op_1000_3d3e((param_1 & 0xffff0000 | ZEXT24(&iVar4->field_0x5b)), s_VrMode_1050_4422);
...
void __stdcall16far realize_palette_1020_8128(u32 param_1, i16 param_2, HGDIOBJ16 param_3, u16 param_4)
...

{
    ...
    if(0x0 < UVar1)
    {
        InvalidateRect16((HWND16)s_tile2_bmp_1050_1538, (RECT16 *)(&PTR_LOOP_1050_0000 + 0x1), 0x0);
    }
    return;
}

void __stdcall16far pass1_1020_6466(u16 *param_1, u16 param_2, u16 param_3)
...
void __stdcall16far mix_draw_op_1020_650c(astruct_7 *param_1, HWND16 param_2, u16 param_3)

{
    ...
    uVar2    = (iVar3 + 0x14);
    puStack6 = (uVar2 + 0xa);
    if(((iVar3 + 0x10) != 0x0) || (uVar2 = (iVar3 + 0x14), (uVar2 + 0x24) != 0x0))
    {
    ...
    do
    {
        ...
        if((iVar4 + iVar5) != 0x0)
        {
            ...
            (**ppcVar1)(param_2, uVar2, (uVar2 >> 0x10), puStack6, (puStack6 >> 0x10));
        }
        iStack8 = iStack8 + 0x1;
    } while(iStack8 < 0x5);
    uVar7 = (iVar3 + 0x4);
    BeginPai1616(param_2, &local_28);
    ppcVar1 = (*puStack6 + 0x4);
    (**ppcVar1)(s_tile2_bmp_1050_1538, puStack6, (puStack6 >> 0x10), 0x0, 0x0, iVar3 + 0xa, uVar6, uVar7);
    EndPai1616((HWND16)s_tile2_bmp_1050_1538, &local_28);
    return;
}
void __stdcall16far realize_palette_1020_6896(u32 param_1, i16 param_2, HGDIOBJ16 param_3)
...
void __stdcall16far pass1_1020_68de(u32 param_1, u16 param_2)
...
void __stdcall16far pt_in_rect_1020_68fc(u32 *param_1, u16 param_2, u16 param_3)
...
void __stdcall16far destroy_icon_1020_6bd2(u32 param_1, u8 param_2, HICON16 param_3)
...
HGDIOBJ16 __stdcall16far draw_op_1020_7070(i1616 param_1, u16 param_2)
...
void __stdcall16far palette_op_1020_7270(u16 *param_1, HDC16 param_2)
...
void __stdcall16far invalidate_rect_1020_735a(u32 param_1, HWND16 param_2)
...
BOOL16 __stdcall16far win_ui_op_1020_737a(u32 param_1, HWND16 param_2, u16 param_3)

{
    ...
    iVar8    = param_1;
    uVar11   = (iVar8 + 0x4);
    local_24 = BeginPai1616(param_2, &local_pai16_struct);
    uVar10   = (iVar8 + 0x4);
    ...
    else
    {
        if(PTR_LOOP_1050_0010 == 0x0)
        {
            ...
            if(BVar4 != 0x0)
            {
                local_rect = (RECT16 *)GetStockObject16((i1616)s_tile2_bmp_1050_1538);
    ...
    BVar4 = EndPai1616((HWND16)s_tile2_bmp_1050_1538, &local_pai16_struct);
    return BVar4;
}

void __stdcall16far unk_draw_op_1020_3da4(astruct_24 *param_1, u32 param_2)

{
    ...
    *(i1616_t *)(iVar8 + 0x1e)   = iVar4;
    HVar5                        = GetStockObject16((i1616)s_tile2_bmp_1050_1538);
...
void __stdcall16far validate_rect_1020_3f12(u32 param_1, i16 param_2, HWND16 param_3)
...
void __stdcall16far mixed_draw_op_1020_3fa0(u32 param_1, HWND16 param_2, u16 param_3)

{
    ...
    (**ppcVar2)(s_tile2_bmp_1050_1538, puStack40, (puStack40 >> 0x10), 0x0, &local_24, param_3, uVar6);
    uVar3    = (iVar4 + 0x14);
    iStack46 = (uVar3 + 0x44);
    uVar3    = (iVar4 + 0x14);
    uStack44 = *(uVar3 + 0x40);
...
void __stdcall16far draw_rect_1020_40ce(u32 param_1, i16 param_2, i16 param_3, u16 param_4)

{
    ...
    if((*(byte *)(param_1 + 0xe) & 0x1) != 0x0)
    {
        ...
        handle = CreatePen16((i1616)s_tile2_bmp_1050_1538, 0xf9, 0x100);
...
void __stdcall16far unk_draw_op_1020_41c8(astruct_20 *param_1, u16 param_2, u16 param_3, u16 param_4)

{
    ...
    HVar2                      = LoadCursor16((HINSTANCE16)s_tile2_bmp_1050_1538, (LPCSTR)(s__s__ld_1050_019c + 0x3));
    uVar5->field_0xf2          = HVar2;
    puVar9                     = PTR_LOOP_1050_038c;
    PTR_LOOP_1050_0398         = LoadAccelerators16((HINSTANCE16)s_tile2_bmp_1050_1538, (LPCSTR)s_OpAccel_1050_43e8);
...
void __stdcall16far destroy_cursor_1020_42f4(u16 *param_1, HMENU16 param_2)
...
void __stdcall16far pass1_1020_2c72(u32 param_1, u16 param_2, u16 param_3)
...
void __stdcall16far destroy_icon_1020_2c88(u32 param_1, HICON16 param_2)
...
void __stdcall16far load_draw_op_1020_2ede(u16 *param_1, u32 param_2, u16 param_3)

{
    ...
    *(HDC16 *)(iVar6 + 0x18) = HVar3;
    ...
    uVar1                        = (iVar6 + 0x14);
    uVar1                        = (uVar1 + 0x64);
    handle                       = CreatePen16((i1616)s_tile2_bmp_1050_1538, (i1616)uVar1, (COLORREF)(uVar1 >> 0x10));
...
void __stdcall16far invalidate_rect_1020_3080(u32 param_1, i16 param_2, HWND16 param_3)
...
void __stdcall16far draw_op_1020_30be(u32 param_1, HWND16 param_2, u16 param_3)

{
    ...
    else
    {
        if(PTR_LOOP_1050_0010 == 0x0)
        {
            ...
            if(iStack38 != 0x0)
            {
                pRStack40 = (RECT16 *)GetStockObject16((i1616)s_tile2_bmp_1050_1538);
                GetClientRect16((HWND16)s_tile2_bmp_1050_1538, &local_30);
                local_3c = 0x0;
                iStack56 = (iStack44 - local_30.x) + -0x1;
    ...
    EndPai1616(hwnd, &local_22);
    return;
}


void __stdcall16far unk_draw_op_1020_320e(u32 param_1, HDC16 param_2, u16 param_3)

{
    ...
    if((uVar3 + 0x84) == 0x1)
    {
        ...
        uVar8     = pass1_1008_4772((astruct_76 *)(puVar1 & 0xffff | (iVar5 + 0x26) << 0x10));
        local_4   = CreateDC16((LPCSTR)0x1008, (LPCSTR)uVar8, (LPCSTR)(uVar8 >> 0x10), init_data);
        pHStack6  = &local_4;
        ppcVar2   = (*puVar1 + 0x8);
        (**ppcVar2)(s_tile2_bmp_1050_1538, puVar1, (puVar1 >> 0x10), pHStack6, param_3);
    }
...
void __stdcall16far draw_op_1020_33c0(u32 param_1, u32 param_2, i16 param_3, u32 param_4, i16 param_5, u16 param_6, u16 param_7)

{
    ...
    if(param_3 != 0x0)
    {
        pen_handle    = CreatePen16(param_7, (i1616)param_2, (COLORREF)(param_2 >> 0x10));
...
void __stdcall16far draw_op_1020_3488(u32 param_1)

{
    ...
    pass1_1008_3e94(puStack6, CONCAT22(unaff_SS, &local_a), CONCAT22(unaff_SS, &local_a + 0x2));
    ...
    uVar3     = (param_1 + 0x14);
    uVar3     = (uVar3 + 0x64);
    handle    = CreatePen16(0x1008, (i1616)uVar3, (COLORREF)(uVar3 >> 0x10));
    handle_00 = SelectObject16((HDC16)s_tile2_bmp_1050_1538, handle);
    HVar4     = GetStockObject16((i1616)s_tile2_bmp_1050_1538);
    HVar4     = SelectObject16((HDC16)s_tile2_bmp_1050_1538, HVar4);
    bottom    = (local_a >> 0x10);
    Rectangle16((HDC16)s_tile2_bmp_1050_1538, local_a + 0x6, bottom + 0x6, local_a, bottom);
    SelectObject16((HDC16)s_tile2_bmp_1050_1538, handle_00);
...
void __stdcall16far draw_polygon_1020_3602(u16 param_1, u16 param_2, u32 param_3, HDC16 param_4)

{
    Polygon16(param_4, (POi1616 *)param_3, (i1616)(param_3 >> 0x10));
    return;
}


void __stdcall16far pass1_1020_3bd6(u32 param_1, u16 param_2, u16 param_3, u16 param_4)

{
    ...
    if((uVar2 + 0x100) == 0x0)
    {
        ...
        uVar4           = pass1_1038_af40(_PTR_LOOP_1050_5b7c, (uVar2 + 0x8), iVar1, param_2, uVar2, &PTR_LOOP_1050_1038, param_4);
        (uVar2 + 0x10e) = uVar4;
...
void __stdcall16far pass1_1020_3d08(u16 param_1,
                                    u16 param_2,
                                    u16 param_3,
                                    u16 param_4,
                                    u16 param_5,
...

{
    ...
    *param_6 = 0x3c;
    puVar24  = CONCAT11((param_2 >> 0x8) + '<' + (*(byte *)(param_3 + param_5) < 0x20), bVar22);
    ...
    *pbVar2  = *pbVar2 | bVar22;
    ...
    uVar20   = CONCAT11((param_6 + 0x2 >> 0x8) + bVar12 + bVar10, bVar11 + bVar10 * '\x06') & 0xff0f;
    ...
    do
    {
        ...
        *pcVar1 = *pcVar1 + (puVar24 >> 0x8) + (CARRY1(bVar12, bVar25) || CARRY1(bVar11 + bVar25, bVar31));
            ...
            *pbVar2 = *pbVar2 | bVar12;
            ...
            code_r0x10203d96:
                ...
                *pbVar2  = *pbVar2 & (byte)puVar24;
                pcVar27  = pcVar26 + 0x2;
                uVar21   = puVar24 & 0xff;
                puVar24  = (uVar21 | (byte)((puVar24 >> 0x8) * '\x02' + ((byte)uVar20 < 0x20)) << 0x8);
            ...
            code_r0x10203db1:
                ...
                *puVar6         = 0x408a;
                (puVar6 + 0x2)  = 0x1020;
                puVar32         = mixed_1010_20ba(_PTR_LOOP_1050_0ed0, 0x6, param_9, puVar24, pcVar27);
                uVar28          = (puVar32 >> 0x10);
                uVar7           = (param_4 + 0x6);
                uVar29          = (uVar7 >> 0x10);
                iVar13          = uVar7;
                ...
                (**ppcVar5)(0x1010, (iVar13 + 0x14), uVar28, 0x0, iVar13, uVar29);
                ...
                *(i1616_t *)(uVar7 + 0x1e)   = iVar15;
                uVar28                       = (param_4 + -0x2);
                HVar16                       = GetStockObject16((i1616)s_tile2_bmp_1050_1538);
                ...
                *(HGDIOBJ16 *)(uVar7 + 0x1a) = HVar16;
                ...
                puVar8                       = (param_4 + -0x6);
                ppcVar5                      = (*puVar8 + 0x8);
                (**ppcVar5)(s_tile2_bmp_1050_1538, puVar8, (puVar8 >> 0x10), puVar17, param_9, uVar29, uVar28);
                uVar7             = (param_4 + 0x6);
                uVar29            = (uVar7 >> 0x10);
                iVar13            = uVar7;
                (iVar13 + 0x1c)   = puVar17;
        ...
        *pbVar2 = *pbVar2 | bVar11;
        param_16
          = (param_14 & 0x1) * 0x4000 | (param_13 & 0x1) * 0x200 | (param_12 & 0x1) * 0x100 | (*pbVar2 < '\0') * 0x80 | (*pbVar2 == 0x0) * 0x40 | (byte)(bVar4 | bVar3 | bVar10 & 0x1) * 0x10 | ((POPCOUNT(*pbVar2) & 0x1U) == 0x0) * 0x4;
        pbVar2  = (byte *)(param_3 + iVar13);
        *pbVar2 = *pbVar2 | bVar11;
        bVar12  = in(0x79);
        pbVar2  = (byte *)(param_3 + iVar13);
        ...
        *pbVar2        = *pbVar2 + bVar12;
        ...
        pcStack4._0_3_ = CONCAT21((param_14 & 0x1) * 0x4000 | (SCARRY1(bVar18, bVar12) != SCARRY1(bVar23, bVar30)) * 0x800 | (param_13 & 0x1) * 0x200 | (param_12 & 0x1) * 0x100 | (cVar19 < '\0') * 0x80 | (cVar19 == '\0') * 0x40
                                    | (byte)(bVar4 | bVar3 | bVar10 & 0x1) * 0x10 | ((POPCOUNT(cVar19) & 0x1U) == 0x0) * 0x4 | (CARRY1(bVar18, bVar12) || CARRY1(bVar23, bVar30)),
                                  pcStack4._0_1_);
...
void __stdcall16far invalidate_rect_1020_1fb2(u32 param_1, i16 param_2, HWND16 param_3)
...
void __stdcall16far unk_draw_op_1020_2020(u32 param_1, HWND16 param_2, u16 param_3)

{
    ...
    *(HDC16 **)(iVar12 + 0x10) = pHVar5;
    ...
    while((puVar14 + -0x38) < (puVar14 + -0x28))
    {
        ...
        uVar2             = (puVar14 + 0x6);
        pass1_1020_2286(uVar2, (uVar2 >> 0x10), CONCAT13((param_3 >> 0x8), CONCAT12(param_3, puVar14 + -0x30)), (uVar17 + 0x8));
        uVar2 = (puVar14 + -0x30);
        pass1_1008_3e76(CONCAT22(param_3, puVar14 + -0x36), 0x0, uVar2, (uVar2 >> 0x10));
        uVar2 = (puVar14 + -0x2c);
        pass1_1008_4480(*(puVar14 + -0x26), CONCAT22(param_3, puVar14 + -0x36), *(astruct_76 **)(uVar2 + iVar12), param_3);
        iVar12 = (puVar14 + -0x38);
        uVar2  = (puVar14 + -0x30);
        uVar15 = uVar2;
        ...
        uVar2                  = (iVar19 + 0x1a);
        iVar12                 = iVar12 * 0x8;
        (uVar2 + iVar12)       = CONCAT11(uVar21, uVar20);
        uVar2                  = (iVar19 + 0x1a);
        ...
        *piVar18               = *piVar18 + (-((puVar14 + -0x38) == 0x0) & 0x5) + 0x14 + (uVar2 + 0x4);
    ...
    *(HGDIOBJ16 *)(puVar14 + -0x40) = HVar8;
    ...
    if(HVar8 == 0x0)
    {
        ...
        HVar9                          = CreateSolidBrush16((COLORREF)s_tile2_bmp_1050_1538);
        *(HBRUSH16 *)(puVar14 + -0x3e) = HVar9;
        HVar7                          = CreatePen16((i1616)s_tile2_bmp_1050_1538, 0xff, 0x0);
        *(HPEN16 *)(puVar14 + -0x3a)   = HVar7;
    ...
    uVar2 = (puVar14 + 0x6);
    SelectPalette16(0x1010, 0x0, *(BOOL16 *)(uVar2 + 0x10));
    DeleteObject16((HGDIOBJ16)s_tile2_bmp_1050_1538);
    SelectObject16((HDC16)s_tile2_bmp_1050_1538, *(HGDIOBJ16 *)(puVar14 + -0x3c));
    DeleteObject16((HGDIOBJ16)s_tile2_bmp_1050_1538);
    SelectObject16((HDC16)s_tile2_bmp_1050_1538, *(HGDIOBJ16 *)(puVar14 + -0x40));
    DeleteObject16((HGDIOBJ16)s_tile2_bmp_1050_1538);
    EndPai1616((HWND16)s_tile2_bmp_1050_1538, (PAi16STRUCT16 *)(puVar14 + -0x20));
    return;
}

void __stdcall16far draw_line_1020_229c(u32 param_1, HDC16 param_2)

{
    ...
    uVar7 = (pIVar2 >> 0x10);
    iVar5 = pIVar2;
    LineTo16((HDC16)s_tile2_bmp_1050_1538, 0x5, (iVar5 + iVar1 * 0x8 + -0x4));
    ...
    LineTo16((HDC16)s_tile2_bmp_1050_1538, 0x5f, (iVar5 + iVar1 * 0x8 + -0x4));
    for(iStack10 = 0x0; iStack10 < iVar1; iStack10 = iStack10 + 0x1)
    {
        piVar6 = (iStack10 * 0x8 + iVar5);
        iVar4  = (piVar6[0x2] - *piVar6 >> 0x1) + *piVar6;
...
void __stdcall16far pass1_1020_239c(u32 param_1, i16 *param_2, u16 param_3)

{
    ...
    if(param_2 != 0x0)
    {
        ...
        uVar3   = (param_1 >> 0x10);
        uVar2   = pass1_1020_23f2(param_1, uVar3, CONCAT22(param_3, local_a), (puVar1 >> 0x10), param_3);
        draw_polygon_1020_2474(param_1, uVar3, CONCAT22(uVar2, 0x3), 0x1008);
    }
    return;
}

void __stdcall16far draw_polygon_1020_2474(u16 param_1, u16 param_2, u32 param_3, HDC16 param_4)
...
void __stdcall16far struct_1020_2524(astruct_20 *param_1, u16 param_2, u16 param_3, u16 param_4)
...
void __stdcall16far pass1_1020_27b0(astruct_664 *param_1, u16 param_2, u16 param_3, i16 param_4, u16 param_5)
...
void __stdcall16far pass1_1020_2838(u16 *param_1, u16 param_2)
