    ...
    if(param_2 != 0x129)
    {
        ...
        if(param_2 < 0xfc)
        {
            ...
            if(cVar2 == 'r')
            {
                ...
                pass1_1038_af40(globals->_PTR_LOOP_1050_5b7c, (uVar5 + 0x8), 0x3, uVar4, uVar5, SEG_1038, param_4);
                return;
            }
            if(cVar2 == 'u')
            {
...

{
    ...
    if((uVar1 + 0xe6) == 0x0)
    {
        ...
        pass1_1038_af40(globals->_PTR_LOOP_1050_5b7c, (uVar1 + 0x8), 0x8, (puVar3 >> 0x10), uVar1, SEG_1038, param_5);
    }
    return;
}
