    ...
    if(param_2 != 0x129)
    {
        ...
        if(param_2 < 0xfc)
        {
            ...
            if(cVar2 == 'o')
            {
                ...
                WinHelp16(0x1010, (LPCSTR)(s_New_failed_in_Op__Op_1050_0020 + 0xa), 0x0, CONCAT22(paVar8, 0x1));
                return;
            }
            if(cVar2 == 'r')
            {
...
void unk_draw_op_1020_0c3e(undefined4 param_1, HWND16 param_2)
...
void cleanup_ui_op_1020_1038(undefined4 param_1)
...
void draw_op_1020_1674(u32 param_1, i1616 param_2)
...
void pass1_1018_e5dc(u16 param_1, astruct_20 *param_2, u16 param_3, u16 param_4)
...
void pass1_1018_e91e(astruct_20 *param_1, u16 param_2, u16 param_3, u16 param_4)
...
void pass1_1020_01d8(astruct_20 *param_1, u16 param_2, u16 param_3, u16 param_4, u16 param_5, u16 param_6, u16 param_7, u32 param_8, u16 param_9)
...
void fill_rect_1020_065e(undefined4 param_1, HWND16 in_win_handle_2)
...
void pass1_1018_dfd4(undefined4 param_1, u8 *param_2, i16 param_3, u16 param_4, u16 param_5)
...
void pass1_1018_e230(u16 param_1, astruct_20 *param_2, u16 param_3, u16 param_4)
...
void pass1_1018_e4f2(astruct_659 *param_1, u16 param_2, u16 param_3, i16 param_4, u16 param_5)
...
void unk_draw_op_1018_c578(astruct_36 *param_1, u16 param_2)
...
void draw_text_1018_c742(astruct_36 *param_1, HDC16 param_2, RECT16 *param_3, u16 param_4)

{
    ...
    if((iVar4->field_0x108 != 0x0) && (*iVar4->field_0x108 != '\0'))
    {
        ...
        if(iVar4->field_0x106 == 0x0)
        {
            ...
            iStack20 = 0x0;
            DrawText16((HDC16)s_tile2_bmp_1050_1538, (LPCSTR)0x410, (i1616)&local_1a, param_3, 0xffff);
        ...
        DrawText16((HDC16)s_tile2_bmp_1050_1538, (LPCSTR)&PTR_LOOP_1050_0010, (i1616)&local_12, param_3, 0xffff);
...
void pass1_1018_5b06(astruct_132 *param_1, u16 param_2, u16 param_3, u16 param_4)

{
    ...
    draw_op_1020_9364(CONCAT22(param_2, param_1), 0x1020, param_4);
    puVar3 = param_1->field_0x14;
    pass1_1008_3f62(CONCAT22(param_2, &param_1->field_0x1c), (puVar3 & 0xffff0000 | (puVar3 + 0x52)));
    pass1_1008_3f32(CONCAT22(param_2, &param_1->field_0x1c), CONCAT22(param_4, local_c));
    ...
    {
        pass1_1008_50c2((astruct_110 *)CONCAT22(puVar7, uVar5), *(uVar4 + 0x8), *(uVar4 + 0x4), CONCAT22(param_2, &param_1->field_0x1c), puVar1);
...
void set_window_text_1018_6066(u1616 param_1, u1616 param_2, SEGPTR in_win_text_3, u1616 param_4, i1616 dialog_id_5, HWND16 in_hwnd_6)
...

{
    ...
    wspri16f16((LPSTR)s_tile2_bmp_1050_1538, &stack0xfff4, param_3);
...

{
    ...
    *(HGDIOBJ16 *)(puVar13 + -0x40) = HVar8;
    ...
    uVar3 = (puVar13 + 0x6);
    SelectPalette16(0x1010, 0x0, *(BOOL16 *)(uVar3 + 0x10));
    DeleteObject16((HGDIOBJ16)s_tile2_bmp_1050_1538);
    ...
    DeleteObject16((HGDIOBJ16)s_tile2_bmp_1050_1538);
    EndPai1616((HWND16)s_tile2_bmp_1050_1538, (PAi16STRUCT16 *)(puVar13 + -0x20));
    return;
}
...
void struct_1018_66cc(astruct_20 *param_1, u16 param_2, u16 param_3, u16 param_4)
...
void pass1_1018_6924(astruct_658 *param_1, u16 param_2, u16 param_3, i16 param_4, u16 param_5)
...
void mixed_draw_op_1018_6a7a(astruct_28 *param_1, u16 param_2)
...
void clenaup_win_ui_1018_4d22(astruct_11 *in_struct_1, HDC16 in_hdc_2)
...
void create_dc_1018_4e04(astruct_8 **param_1, u1616 param_2, i16 param_3, i16 param_4, LPCSTR in_string_5, u16 in_string_6)
...
void struct_1018_5840(astruct_20 *param_1, u16 param_2, u16 param_3, u16 param_4)
...
void invalidate_rect_1018_58e2(astruct_58 *param_1, i16 param_2, HWND16 param_3)
...
void pass1_1010_4674(u32 param_1, i16 param_2, u16 param_3, u1616 param_4)
...
void draw_1010_47ae(u32 param_1, u16 param_2, u1616 param_3)
...
void draw_op_1010_47d0(u1632 param_1, u1616 param_2, u1616 param_3, i1616 in_style_3, u1616 param_5)

{
    ...
    uVar8            = 0x5;
    stock_obj_handle = GetStockObject16((i1616)s_tile2_bmp_1050_1538);
    local_e          = 0x0;
    uStack12         = 0x0;
    uStack10         = 0x1;
    uStack8          = 0x1;
...

{
    ...
    PStack8        = (POi1616)CONCAT22(param_2, param_3);
    uVar5          = (param_1 >> 0x10);
    iVar4          = param_1;
            ...
            if((uStack4 != 0x0) && (0x3 < PTR_LOOP_1050_3960))
            {
                ...
                if(uVar4 == 0x0)
                {
                    ...
                    else
                    {
                        ...
                        iVar6 = string_1040_8520(CONCAT22(puVar7, uVar5), PTR_LOOP_1050_0396, 0x30, 0x2, 0x643, 0x645, puVar8, unaff_SS);
                    }
...
u1616_t draw_fn_1010_2a32(u1616_t param_1, u1616_t param_2, u1616 *__return_storage_ptr__, i16 param_4, u16 param_5, u32 param_6, u1616_t param_7, u1616_t param_8, u1616_t param_9, u1616_t param_10)

{
    ...
    case 0x3:
    case 0xb:
        *(u1616_t *)(uVar11 + 0xa) = param_8;
    case 0x9:
    case 0xf:
    case 0x15:
    case 0x1b:
        *(u1616_t *)(uVar11 + 0xa)  = param_8;
        *(u1616_t *)(uVar11 + 0x10) = param_8;
        *(u1616_t *)(uVar11 + 0xc)  = param_8;
        return (u1616_t)param_10;
    case 0x5:
    ...
    case 0xd:
        ...
        *pbVar3 = bVar5 + (uVar11 < 0x1c);
        uVar6   = (CARRY1(bVar22, (byte)param_7) || CARRY1(bVar5, uVar11 < 0x1c));
        ...
        {
            (*pcVar9)();
            param_7 = (u1616_t)extraout_DX_00;
        }
        ...
        *piVar1        = s_SCi16ernalPutBldg2_site_0x_08lx__1050_5099 + 0x1;
        ...
        return (u1616_t)CONCAT11((undefined)param_1, uVar28);
    case 0xe:
    ...
    case 0x13:
        ...
        if((((iVar15 + 0x22) != 0x0) || ((iVar15 + 0x24) != 0x0)) || (((iVar15 + 0x26) != 0x0 || ((iVar15 + 0x28) != 0x0))))
        {
            ...
            uVar4    = (param_1 + 0xa);
            HStack30 = 0x62a0;
            WritePrivateProfileString16((LPCSTR)&PTR_LOOP_1050_1000, (LPCSTR)uVar4, (LPCSTR)(uVar4 >> 0x10), (LPCSTR) * (param_1 + 0xe));
        }
        return param_7;
    case 0x14:
    ...
    case 0x17:
        ...
        *(u1616_t *)(__return_storage_ptr__ + 0x12) = param_8;
        ...
        {
            PTR_LOOP_1050_0310 = 0x6d2;
            return (u1616_t)puVar18;
        }
        ppcVar8 = *puStack38;
        (**ppcVar8)();
        PTR_LOOP_1050_0310 = 0x6d2;
        return (u1616_t)extraout_DX_01;
    case 0x18:
        bVar22 = 0x2;
        goto LAB_1010_2ad8;
    case 0x19:
...
void unk_draw_op_1008_da12(astruct_19 *param_1, u16 param_2, u16 param_3)

{
    ...
    if((uVar8 & 0x100) != 0x0)
    {
        ...
        param_1->field_0x16 = (i1616)IVar5;
        ...
        start   = fn_ptr_op_1000_1708((IVar5 + 0x1) * 0x4, 0x0, 0x1, PTR_LOOP_1050_5f2c, count, 0x1000);
        ...
        uVar9                        = fn_ptr_op_1000_1708((iVar7 + 0x1) * 0x4, 0x0, 0x1, PTR_LOOP_1050_5f2c, PTR_LOOP_1050_5f2e, 0x1000);
        ...
        if(lStack8 != 0x0)
        {
            if(param_1->field_0x18 != (u16 *)0x0)
            {
                ...
                GetSystemPaletteEntries((HDC16)s_tile2_bmp_1050_1538, entries * 0x4 + start, (u1616)count, entries);
                ...
                for(iStack16 = 0x0; puVar4 = puStack32, piVar1 = &param_1->field_0x16, *piVar1 != iStack16 && iStack16 <= *piVar1; iStack16 = iStack16 + 0x1)
                {
                    ...
                    iVar10          = puStack32;
                    puStack32       = (u16 *)(puStack32 & 0xffff0000 | (iVar10 + 0x4));
