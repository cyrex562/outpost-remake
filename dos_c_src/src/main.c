...

{
    ...
    do
    {
        ...
        if((param_8 != 0) && (bVar9 = param_1 < 0xff00, param_1 = param_1 + 0x100, globals->U16_1050_5f7e = param_5, bVar9))
        {
    ...
    interrupt_vector_op_1000_23ea(NULL, param_2, param_5, 0, u16_var15);
    globals->dat_1050_5f84 = result;
    ...
    fn_ptr_op_1000_24cd(globals, uVar5, 0);
    iVar14 = 0x15;
    iVar13 = 0x15;
...

{
    ...
    globals->hinst_1050_038c    = param_4;
...

{
    init_op_1008_54aa(globals,
                      globals->u16_1050_5f52,
                      CONCAT22(globals->u16_1050_5f50, globals->u16_1050_5f4e),
                      globals->u16_1050_5f4a,
