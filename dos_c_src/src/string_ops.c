...
void string_1040_a626(u16 *param_1, char *param_2, u16 param_3)
...
void pass1_1030_4dbc(u32 param_1, u32 param_2, long param_3)

{
    ...
    if(((iVar5 + 0x160) == 0x0) || (lVar3 = (iVar5 + 0x164), plVar1 = (long *)(iVar5 + 0x164), *plVar1 = *plVar1 + -0x1, lVar3 == 0x0))
    {
        (iVar5 + 0x160) = 0x0;
    }
    else
...

{
    ...
    pcVar1 = load_string_1010_847e(_PTR_LOOP_1050_14cc, (i1616)(_PTR_LOOP_1050_14cc >> 0x10), 0x1010);
    return pcVar1;
}
...
void pass1_1020_6e52(u16 param_1, u16 param_2, u16 param_3, i16 param_4, u16 param_5, i16 param_6)

{
    ...
    if(uVar1 == 0x0)
    {
        pcVar2 = load_string_1010_847e(_PTR_LOOP_1050_14cc, (i1616)(_PTR_LOOP_1050_14cc >> 0x10), 0x1010);
    }
    else
    {
...

{
    ...
    else
    {
        ...
        else
        {
            if(iVar1 != 0x18c)
            {
                load_string_1010_84e0(0x1010, _PTR_LOOP_1050_14cc, (_PTR_LOOP_1050_14cc >> 0x10), 0x100, (iVar2 + 0x22), (short)valist);
                return;
            }
            buffer = (LPSTR)0x1008;
            pass1_1008_57f0(uVar3, (iVar2 + 0x130), unaff_SS);
    ...
    wspri16f16(buffer, (LPCSTR)(iVar2 + 0x22), valist);
    return;
}
    ...
    if((bVar11) || ((bVar11 || *puVar1 == uStack4 && (*(uVar10 + 0x13e) < uStack6))))
    {
        ...
        if((uVar10 + 0x13a) < uVar3)
        {
            ...
            *(uVar10 + 0x138) = uVar9;
            piVar2            = (uVar10 + 0x13a);
            *piVar2           = *piVar2 + 0x1;
            wspri16f16((LPSTR)0x1030, (LPCSTR)(uVar10 + 0x22), valist);
            return;
        }
...

{
    ...
    while(true)
    {
        ...
        string_1040_a626((uVar3 & 0xffff0000 | uVar5), CONCAT22(param_6, &local_54), uVar2);
    }
    return;
}
...

{
    ...
    *(param_1 + 0x13c) = 0x0;
    ...
    load_string_1010_84e0(0x1010, _PTR_LOOP_1050_14cc, (_PTR_LOOP_1050_14cc >> 0x10), 0x3ff, (param_1 + 0x13c), in_buf_len_5);
...

{
    ...
    *(param_1 + 0x13c) = 0x0;
    ...
    load_string_1010_84e0(0x1030, _PTR_LOOP_1050_14cc, (_PTR_LOOP_1050_14cc >> 0x10), 0x3ff, (param_1 + 0x13c), in_buf_len_5);
    return;
}
...

{
    ...
    {
        pcVar1 = load_string_1010_847e(_PTR_LOOP_1050_14cc, (i1616)(_PTR_LOOP_1050_14cc >> 0x10), param_1);
        return pcVar1;
    }
    return 0x0;
}
...
LAB_1010_adee:
    if(pcStack6 == 0x0)
    {
        pcStack6 = load_string_1010_847e(_PTR_LOOP_1050_14cc, (i1616)(_PTR_LOOP_1050_14cc >> 0x10), param_1);
    }
    return pcStack6;
}
...
char *load_string_1010_847e(i16 param_1, i1616 in_buf_len_2, HINSTANCE16 in_hinstsance_3)
...
void load_string_1010_84ac(i16 param_1, i1616 param_2, HINSTANCE16 param_3)
...

{
    ...
    load_string_1010_84ac(_PTR_LOOP_1050_14cc, (i1616)(_PTR_LOOP_1050_14cc >> 0x10), 0x1000);
...

{
    ...
    load_string_1010_84e0(0x1010, _PTR_LOOP_1050_14cc, (_PTR_LOOP_1050_14cc >> 0x10), 0x100, in_buffer_4, (short)param_2);
    uVar5 = (param_1 >> 0x10);
    ...
    if(iVar5->field_0xa == 0x0)
    {
        ...
        for(iStack516 = 0x1; iStack516 < 0x6; iStack516 = iStack516 + 0x1)
        {
            ...
            uVar3 = (uVar7 >> 0x10);
            uVar4 = uVar3;
            wspri16f16((LPSTR)&PTR_LOOP_1050_1000, local_102, param_2);
...

{
    ...
    uStack4 = (uVar6 >> 0x10);
    load_string_1010_84e0(0x1010, _PTR_LOOP_1050_14cc, (_PTR_LOOP_1050_14cc >> 0x10), 0x100, local_206, (short)param_2);
    iStack6 = uVar6;
    uVar5   = (param_1 >> 0x10);
    iVar4   = param_1;
    piVar1  = (iVar4 + 0x22);
    *piVar1 = *piVar1 + 0x1;
    wspri16f16((LPSTR)0x1010, local_106, param_2);
    iStack6         = uVar6;
...

{
    ...
    *param_1           = 0x0;
    ...
    sys_1000_3f9c(0x65a0, &USHORT_1050_1050, _PTR_s_SC_03d_1050_0314_1050_031c, (_PTR_s_SC_03d_1050_0314_1050_031c >> 0x10), 0x4, &stack0xfffe, uVar2, 0x1000, param_4, param_5);
    uVar1           = str_op_1008_60e8(param_2, param_3);
    param_1         = uVar1;
    (param_1 + 0x2) = param_3;
    return param_1;
...
void __stdcall16far pass1_1008_48de(u16 param_1, u32 param_2, i16 param_3, u16 param_4, u16 *param_5, i16 param_6, i16 param_7, byte *param_8, u16 param_9, u16 param_10, char param_11, u16 param_12, u8 param_13)

{
    ...
    uVar6   = param_4 & 0xff | (byte)((param_4 >> 0x8) + param_4 + param_11) << 0x8;
    puVar7  = (param_6 + 0x1);
...

{
    ...
    if(((PTR_LOOP_1050_5fc0 | PTR_LOOP_1050_5fbe) != 0x0) && ((param_2 | param_1) != 0x0))
    {
        ...
        while(true)
        {
            uVar4 = (u1616_t)(puVar4 >> 0x10);
            uVar3 = (u1616_t)puVar4;
...
PCHAR poss_str_op_1000_28dc(i16 param_1)
...
void pass1_1000_2913(i16 param_1, u1616_t param_2, u1616_t param_3)
