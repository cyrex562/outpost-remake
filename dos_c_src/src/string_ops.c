...

{
    ...
    u_var2  = (param_1 + 0x90);
    uVar1  = (param_1 + 0x94);
    pcVar4 = string_op_1010_ada6(SEG_1010, param_3, uVar1, (uVar1 >> 0x10), param_2, (u_var2 + 0xa));
    return pcVar4;
}
...
//    u16  uVar4;
    ...
    struct384_var_6 = (Struct384 *) ptr_from_addr_pair(addr_var5.segment, addr_var5.offset);
...
void pass1_1038_4d3c(Struct385 *param_1, char *param_2, u16 param_3) {
    ...
    Struct18 *in_struct = (Struct18 *) ptr_from_addr_pair(param_1->segment_field_0x1fc, param_1->offset_field_0x1fa);
...
void pass1_1020_6e52(Globals *globals, u16 param_1, u16 param_2, u16 param_3, u16 offset_param_4, u16 segment_param_5,
                     i16 param_6) {
    u16 seg_var1;
    char *pcVar2;
...
void sprintf_op_1018_34b6(Globals *globals, struct_1018_34b6_1 *param_1, u8 param_2) {
    i16 iVar1;
...
//            buffer = SEG_1008;
            ...
            if (iVar1 != 0x18c) {
                load_string_1010_84e0(
                        SEG_1010, globals->dat_1050_14cc, 0x100, (param_1->field_0x22), param_1->field_0x0);
                return;
            }
//            buffer = SEG_1008;
            pass1_1008_57f0(uVar3, (param_1->field_0x130), unaff_SS);
...
void load_str_1010_ddf6(Globals *globals, struct_1010_ddf6_1 *param_1, Struct383 *param_2) {
    ...
    *(param_1->field_0x13c) = 0x0;
    uVar1 = struct_op_1030_73a8(globals, param_2);
    switch ((uVar1 + 0x12)) {
        case 0x1:
        case 0x2:
        case 0x4:
    ...
    load_string_1010_84e0(
            SEG_1010, globals->dat_1050_14cc, 0x3ff, (param_1->field_0x13c), in_buf_len_5);
...
void pass1_1010_de78(Globals *globals, struct_1010_ddf6_1 *param_1, u32 param_2) {
    *(param_1->field_0x13c) = 0x0;
    ...
    load_string_1010_84e0(
            SEG_1030, globals->dat_1050_14cc, 0x3ff, (param_1->field_0x13c), param_1->field_0x0);
}
...

{
    ...
    {
        pcVar1 = load_string_1010_847e(u16_LOOP_1050_14cc, param_1);
        return pcVar1;
    }
    return 0x0;
}
...
LAB_1010_adee:
    if(pcStack6 == 0x0)
    {
        pcStack6 = load_string_1010_847e(u16_LOOP_1050_14cc, param_1);
    }
    return pcStack6;
}
...

{
    ...
    str_op_1008_60e8(CONCAT22(param_2, (param_1 + 0x682)));
    return;
}
...

{
    ...
    load_string_1010_84ac(u16_LOOP_1050_14cc, SEG_1000);
...

{
    ...
    pcVar1 = load_string_1010_847e(u16_LOOP_1050_14cc, SEG_1010);
    return pcVar1;
}
...

{
    ...
    uVar5  = param_2;
    pcVar3 = load_string_1010_847e(u16_LOOP_1050_14cc, SEG_1010);
...
//    iVar5 = (Struct102 *)param_1;
    ...
    uVar4              = (pcVar5 >> 0x10);
    u_var2              = (Struct103 *)pass1_1000_3d7a(pcVar5, uVar7);
    if((u_var2 != (Struct103 *)0x0) && (u_var2 = (Struct103 *)pass1_1000_3d7a(param_3, param_2), u_var2 != (Struct103 *)0x0))
    {
        lVar6 = pass1_1008_e8cc(param_4, param_1, param_2, param_3);
        uVar3 = (lVar6 >> 0x10);
        u_var2 = (Struct103 *)lVar6;
        uVar4 = uVar3 | u_var2;
        if((uVar4 != 0x0)
           && (((paVar1 = (Struct103 *)u_var2->field_0xc, u_var2 = paVar1, paVar1 != (Struct103 *)0x0 && (u_var2 = (Struct103 *)(&paVar1[-0x1].field_0xc + 0x1), u_var2 != (Struct103 *)0x0))
                && (u_var2 = (Struct103 *)&paVar1[-0x1].field_0xc, u_var2 != (Struct103 *)0x0))))
        {
            u_var2 = (Struct103 *)&paVar1[-0x1].field_0xb;
        }
    }
...
//    u16         uVar5;
    ...
    load_string_1010_84e0(
      SEG_1010, globals->dat_1050_14cc, 0x100, in_buffer_4, (short)param_2);
//    uVar5 = (param_1 >> 0x10);
//    iVar5 = (Struct25 *)param_1;
    if(param_1->field_0xa == 0x0)
    {
        ...
        param_1->field_0xa         = paVar6;
//        (param_1->field_0xc) = (paVar6 >> 0x10);
        for(iStack516 = 0x1; iStack516 < 0x6; iStack516 = iStack516 + 0x1)
        {
            mem_op_1000_179c(0x12, (paVar6 >> 0x10), 0);
            ...
            u_var2         = str_op_1008_60e8(CONCAT22(param_2, local_102));
            (uVar7 + 0x4) = u_var2;
            (uVar7 + 0x6) = uVar4;
...

{
    ...
    uStack4 = (uVar6 >> 0x10);
    load_string_1010_84e0(
      SEG_1010, globals->dat_1050_14cc, 0x100, local_206, (short)param_2);
    iStack6 = uVar6;
    uVar5   = (param_1 >> 0x10);
    iVar4   = param_1;
    pi_var1  = (iVar4 + 0x22);
...

{
    ...
    puVar4 = CONCAT22(globals->PTR_LOOP_1050_5fc0, globals->PTR_LOOP_1050_5fbe);
    if(((globals->PTR_LOOP_1050_5fc0 | globals->PTR_LOOP_1050_5fbe) != 0x0) && ((param_2 | param_1) != 0x0))
    {
        ...
        while(true)
        {
            ...
            if((*(uVar3 + 0x2) | *puVar4) == 0x0)
                break;
            u_var2 = str_op_1000_3da4(CONCAT22((uVar3 + 0x2), *puVar4));
            if(((uVar1 < u_var2) && (*(*puVar4 + uVar1) == '=')) && (u_var2 = pass1_1000_3de8(CONCAT22((uVar3 + 0x2), *puVar4), CONCAT22(param_2, param_1), uVar1, unaff_SI, uVar3), u_var2 == 0x0))
            {
