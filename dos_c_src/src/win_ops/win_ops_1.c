        ...
        if(param_4 < 0x31)
        {
            ...
            else
            {
                if(bVar16 < 0x9)
                {
                    if(bVar16 == 0x1)
                    {
                        pi_var13        = (u16 *)GetWindowLong16((HWND16)s_tile2_bmp_1050_1538, 0x0);
                        iVar5          = pi_var13;
...

{
    ...
    LVar2 = SendMessage16((HWND16)s_tile2_bmp_1050_1538, u_var2, (WPARAM16)(u_var2 >> 0x10), CONCAT22(uVar4, uVar3));
    return LVar2;
}
