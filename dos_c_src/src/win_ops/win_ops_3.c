...

{
    ...
    if((iVar3 + 0xea) == 0x0)
    {
        ...
        pu_var2         = local_6;
        win_1008_5c9e(globals->_PTR_LOOP_1050_02a0, CONCAT22(param_2, pu_var2), pu_var2, (puVar5 >> 0x10), param_2);
        (iVar3 + 0xec) = pu_var2;
...

{
    ...
    iVar2 = param_1;
    get_dc_1018_4db0(*(iVar2 + 0xf2), (iVar2 + 0x8), SEG_1008);
    mem_op_1000_179c(0x28, in_DX, SEG_1000);
    uVar1 = in_DX | in_AX;
    if(uVar1 != 0x0)
    {
...

{
    ...
    *(uVar1 + 0x12)   = u_var2;
    ...
    mem_op_1000_179c(0x12, puVar3, SEG_1000);
...

{
    ...
    default:
        ...
        break;
    case 0x3:
        mem_op_1000_179c(0x9e, in_DX, SEG_1000);
        puVar5 = (in_DX | puVar6);
        if(puVar5 == 0x0)
            goto LAB_1010_73fe;
        HVar10 = (HWND16)SEG_1040;
    ...
    case 0x5:
    case 0x6:
        mem_op_1000_179c(0x98, in_DX, SEG_1000);
        puVar5 = (in_DX | puVar6);
        if(puVar5 == 0x0)
            goto LAB_1010_73fe;
        HVar10 = (HWND16)SEG_1040;
    ...
    case 0x13:
        ...
        break;
    case 0x14:
        mem_op_1000_179c(0x9a, in_DX, SEG_1000);
        puVar5 = (in_DX | puVar6);
        if(puVar5 == 0x0)
            goto LAB_1010_73fe;
        HVar10 = (HWND16)SEG_1040;
    ...
    case 0x16:
        ...
        break;
    case 0x17:
        mem_op_1000_179c(0xec, in_DX, SEG_1000);
        puVar5 = (in_DX | puVar6);
        if(puVar5 == 0x0)
            goto LAB_1010_73fe;
        HVar10 = (HWND16)SEG_1040;
...
LAB_1010_7710:
    ...
    if(puStack10 != 0x0)
    {
        ...
        if(uVar4 != 0x0)
        {
            ...
            uVar16 = 0xc;
            mem_op_1000_179c(0xc, puVar6, SEG_1000);
...

{
    ...
    if(globals->_PTR_LOOP_1050_0388 != 0x0)
    {
        ...
        pass1_1008_92b2(globals->_PTR_LOOP_1050_0388, 0x50, CONCAT22(uVar6, puVar4));
    }
    iStack4 = 0x0;
    do
    {
...
LAB_1008_a146:
    ...
    {
        param_7   = SEG_1000;
        paStack14 = pass1_1000_07fc(SEG_1000, globals->PTR_LOOP_1050_03a0);
