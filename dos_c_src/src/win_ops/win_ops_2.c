...

{
    ...
    iStack8 = 0x0;
    uVar6   = (param_1 + 0x6);
    u_var2   = GetDlgItemi1616(param_5, 0x1, &local_4, param_6);
    u_stack6 = u_var2;
    if(u_var2 != 0x0)
    {
        uVar5 = 0xb4;
...

{
    ...
    UVar3 = GetDlgItemi1616((HWND16)0x1538, 0x1, &local_6, param_5);
...

{
    ...
    SetDlgItemi1616((HWND16)0x1538, 0x1, (iVar3 + 0x96), 0xfa8);
    return;
}
