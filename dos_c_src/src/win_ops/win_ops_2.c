                ...
                if(param_4 != 0x123)
                {
                    ...
                    else
                    {
                        if(param_4 == 0x126)
                        {
                            ...
                            param_4 = WinHelp16(0x1010, 0x0, 0x0, CONCAT22(paStack14, 0x3));
                        }
                        else
                        {
...

{
    ...
    uStack16 = (**ppcVar1)(0x1008, pu_stack6, (pu_stack6 >> 0x10), local_a, param_4);
    ...
    if(iStack12 == 0x6)
    {
        ...
        ppcVar1 = (*pu_stack6 + 0x6c);
        (**ppcVar1)(0x1008, pu_stack6, (pu_stack6 >> 0x10), local_14);
        uVar9    = 0x0;
        uVar10   = 0x0;
        iVar2    = 0x15;
        uVar7    = 0x1;
    ...
    ppcVar1 = (*pu_stack6 + 0x6c);
    (**ppcVar1)(0x1008, pu_stack6, (pu_stack6 >> 0x10), &local_18);
    return;
}
...

{
    ...
    if(param_3 != 0x0)
    {
        ...
        if(UVar1 == 0x0)
        {
            ...
            UVar1   = IsDlgButtonChecked((HWND16)0x1538, 0x1806);
            if(UVar1 == 0x0)
                goto LAB_1038_e229;
            lparam = 0x1110130;
        }
        ...
        param_4 = (HWND16)0x1538;
        SendMessage16((HWND16)0x1538, 0x0, 0x0, lparam);
    }
LAB_1038_e229:
...

{
    ...
    var2     = l_param;
    handle_2 = GetProp16((HWND16)0x1538, s_procLo_1050_5bd0);
    var7     = CONCAT22(handle_1, handle_2);
    var8     = l_param;
    handle_1 = GetProp16((HWND16)0x1538, s_thisHi_1050_5be5);
    handle_2 = GetProp16((HWND16)0x1538, s_thisLo_1050_5bde);
    ...
    if((handle_1 | handle_2) != 0x0)
    {
        ...
        {
            fn_ptr_1 = (*var6 + 0x34);
            var5     = (**fn_ptr_1)(0x1538, handle_2, handle_1, win_handle_1, param_2, l_param, var8, var2, var3, var4);
        }
        else
        {
            if(l_param == 0x86)
            {
                fn_ptr_1 = (*var6 + 0x20);
                var1     = (**fn_ptr_1)(0x1538, handle_2, handle_1, w_param);
                goto LAB_1038_d10e;
            }
            if((l_param == 0x112) && ((w_param & 0xfff0) == 0xf140))
            {
                lresult = SendMessage16((HWND16)0x1538, 0x0, 0x0, 0x112f140);
                var1    = (lresult == 0x0);
                goto LAB_1038_d10e;
            }
        }
    ...
    if(var7 != 0x0)
    {
        lresult = CallWindowProc16(0x1538, win_handle_1, param_2, w_param, l_param);
        return lresult;
    }
    var1 = 0x0;
LAB_1038_d10e:
...

{
    ...
    uVar6    = param_3;
    HVar5    = GetProp16((HWND16)0x1538, s_thisLo_1050_5bec);
    ...
    if(param_2 == 0x30)
    {
        ...
        SetProp16((HWND16)0x1538, param_2, 0x5c06);
        return;
    }
    if(param_2 < 0x310000)
    {
        ...
        if(cVar3 == '\x02')
        {
            if((HVar4 | HVar5) != 0x0)
            {
                u_var2   = *pu_stack6;
                ppcVar1 = u_var2 + 0x6;
                (**ppcVar1)(0x1538, HVar5, HVar4, param_1, param_2, uVar6, uVar7, uVar8);
                if(pu_stack6 != 0x0)
                {
                    ppcVar1 = u_var2;
                    (**ppcVar1)(0x1538, HVar5, HVar4, 0x1);
                }
            }
            HVar4 = GetProp16((HWND16)0x1538, 0x5bfa);
            if(HVar4 == 0x0)
            {
                return;
            }
            DeleteObject16((HGDIOBJ16)0x1538);
            RemoveProp16((HWND16)0x1538, 0x5c00);
            return;
        }
        if(cVar3 == '\x06')
        {
    ...
    if((HVar4 | HVar5) != 0x0)
    {
        ...
        (**ppcVar1)(0x1538, HVar5, HVar4, param_1, param_2);
    }
    return;
}
...

{
    ...
    SendMessage16((HWND16)0x1538, param_1 + 0x9e, wparam, CONCAT22(0x408, LVar1));
    LVar1 = SendMessage16((HWND16)0x1538, param_1 + 0x19e, wparam, CONCAT22(0x408, LVar2));
    return LVar1;
}
...

{
    ...
    if(WStack6 != 0xffff)
    {
        SendDlgItemMessage16((HWND16)0x1538, (u16)local_106, param_3, WStack6, 0x185b040a);
...

{
    ...
    if(u_var2 != 0x0)
    {
        ...
        iStack8 = (**ppcVar1)(0x1008, puStack12, (puStack12 >> 0x10), local_10, param_6, uVar5, uVar6, u_var2);
    }
...

{
    ...
    UVar3 = GetDlgItemInt16((HWND16)0x1538, 0x1, &local_6, param_5);
...

{
    ...
    for(iStack8 = 0x0; iVar3 = param_1, u_var2 = (param_1 >> 0x10), iStack8 < 0xf; iStack8 = iStack8 + 0x1)
    {
        ...
        unk_win_ui_op_1038_9820(param_1, UVar1, iVar3, 0x1538, param_3);
        param_2 = (HWND16)0x1538;
    }
    SetDlgItemInt16(param_2, 0x1, (iVar3 + 0x94), 0xfa9);
    SetDlgItemInt16((HWND16)0x1538, 0x1, (iVar3 + 0x96), 0xfa8);
    return;
}
...

{
    ...
    if(uVar1 != 0x0)
    {
        post_win_msg_1008_a0e4(p_var2, 0x0, 0x0, 0x1, 0x0, uVar1, 0x1008, param_4);
    }
    return 0x1;
}
...

{
    ...
    if((uStack16 | uStack18) != 0x0)
    {
        ...
        if((iVar11 + 0x200) != 0x8000002)
        {
            ...
            post_win_msg_1008_a0e4((Struct67 *)(puVar15 & 0xffff | ZEXT24(puVar13) << 0x10), 0x0, uStack18, (iVar11 + 0x208), *(iVar11 + 0x4), 0x2, 0x1008, param_6);
...

{
    ...
    post_win_msg_1008_a0e4(paVar1, CONCAT22(uVar3, u_var2), iVar4, uVar5, CONCAT22(uVar7, uVar6), iVar8, 0x1008, param_4);
...

{
    ...
    if(iVar3 != param_4)
    {
        ...
        (**ppcVar2)(0x1538, puVar1, (puVar1 >> 0x10), param_4, uVar5);
    }
    return;
}
...
//    iVar11                      = param_1;
    ...
    icon_handle_1                = LoadIcon16(0x1010, globals->s_TILEICON_1050_440c);
    *(HICON16 *)(param_1 + 0xc2) = icon_handle_1;
    uVar6                       = (param_1 + 0xf2);
    fn_ptr_1                     = ((param_1 + 0xf2) + 0x30);
    (**fn_ptr_1)(0x1538, uVar6, (uVar6 >> 0x10), icon_handle_1, puVar14);
    ...
    (**fn_ptr_1)(0x1000, uVar1, (uVar1 >> 0x10));
    pBVar5 = (BOOL16 *)uVar6;
    MoveWindow16(0x1000, 0x1, pBVar5[0x3], pBVar5[0x2], pBVar5[0x1], *pBVar5);
    uVar6   = param_1;
    fn_ptr_1 = (uVar6 + 0x94);
    (**fn_ptr_1)(0x1538, param_1, (param_1 >> 0x10), 0x0);
    fn_ptr_1 = (uVar6 + 0x10);
    (**fn_ptr_1)(0x1538, param_1, 0x1);
    UpdateWindow16(0x1538);
}
...
LAB_1020_7310:
    ...
    invalidate_rect_1020_735a(param_1, 0x1538);
    return;
}
...

{
    ...
    load_string_1010_84e0(0x1010, globals->PCHAR_1050_14cc, (_PTR_LOOP_1050_14cc >> 0x10), 0x100, local_10c, param_2);
...

{
    ...
    *param_1           = 0x3d08;
    ...
    load_string_1010_84e0(0x1010, globals->PCHAR_1050_14cc, (_PTR_LOOP_1050_14cc >> 0x10), 0x3ff, &iVar2->field_0xa, in_buf_len_5);
...

{
    ...
    if(iVar2->field_0xe8 != 0x0)
    {
        ...
        if(BVar1 != 0x0)
        {
            SendMessage16((HWND16)0x1538, 0x0, 0x0, 0x1110001);
        }
