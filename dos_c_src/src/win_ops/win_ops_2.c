...

{
    ...
    if(param_3 != 0x1c8)
    {
        if(param_3 == 0x1c9)
        {
            puVar7 = mixed_1010_20ba(globals->_PTR_LOOP_1050_0ed0, 0x2f, unaff_SS, in_DX, unaff_DI);
            u_var2  = (puVar7 >> 0x10);
            uVar1  = (puVar7 + 0x20);
            uVar5  = (puVar7 + 0x22);
            uVar3  = uVar5 | uVar1;
            ...
            puVar7 = mixed_1010_20ba(globals->_PTR_LOOP_1050_0ed0, uVar4, unaff_SS, puVar6, unaff_DI);
            if(puVar7 == 0x0)
            {
                return;
            }
    ...
    SendMessage16(param_4, 0x0, 0x0, CONCAT22(0x111, param_3));
    return;
}
...

{
    ...
    if(param_3 == 0x204)
    {
        pass1_1038_de20(CONCAT22(param_2, param_1), 0x204, param_4, param_4, param_6, in_BX, param_5);
        return;
    }
    iStack6 = 0x0;
    iStack4 = 0x0;
                ...
                if(param_4 != 0x123)
                {
                    ...
                    else
                    {
                        if(param_4 == 0x126)
                        {
                            ...
                            param_4 = WinHelp16(SEG_1010, 0x0, 0x0, CONCAT22(paStack14, 0x3));
                        }
                        else
                        {
...
LAB_1038_dac3:
    ...
    else
    {
        ...
        {
            uVar4 = SUB42(&PTR_LOOP_1050_1040, 0x0);
            iVar7 = string_1040_8520(CONCAT22(param_6, param_4), (param_1 + 0x6), 0x0, 0x3, 0x634, iStack4, puVar3, param_5);
            goto LAB_1038_dc37;
        }
    }
    uVar4  = SEG_1000;
    ...
    puVar3 = 0x0;
LAB_1038_dc37:
    paStack14 = (Struct43 *)CONCAT22(puVar3, iVar7);
    if(uStack8 == 0x0)
    {
...

{
    ...
    mem_op_1000_179c(0xb4, param_3, SEG_1000);
    ...
    pu_stack6 = CONCAT22(puVar4, iVar2);
    ...
    if(iStack12 == 0x6)
    {
        mem_op_1000_179c(0xb4, puVar4, SEG_1000);
        ...
        pu_stack6 = CONCAT22(puVar4, iVar3);
        ...
        iVar3    = 0x0;
        uVar5    = 0x0;
        local_18 = (Struct67 *)mixed_1010_20ba(globals->_PTR_LOOP_1050_0ed0, 0x37, param_4, extraout_DX, unaff_DI);
        post_win_msg_1008_a0e4(local_18, CONCAT22(uVar6, uVar5), iVar3, uVar7, CONCAT13(uVar10, CONCAT12(uVar9, uVar8)), iVar2, SEG_1008, param_4);
...

{
    ...
    if(param_3 != 0x0)
    {
        ...
        if(UVar1 == 0x0)
        {
            ...
            UVar1   = IsDlgButtonChecked((HWND16)LAST_SEGMENT, 0x1806);
            if(UVar1 == 0x0)
                goto LAB_1038_e229;
            lparam = 0x1110130;
        }
        ...
        param_4 = (HWND16)LAST_SEGMENT;
        SendMessage16((HWND16)LAST_SEGMENT, 0x0, 0x0, lparam);
    }
LAB_1038_e229:
...

{
    ...
    if(param_3 == 0x1c4)
    {
        puVar10 = mixed_1010_20ba(globals->_PTR_LOOP_1050_0ed0, 0x2f, param_6, param_4, param_5);
        uVar14  = (puVar10 >> 0x10);
        uVar4   = (puVar10 + 0x24);
        uVar5   = (puVar10 + 0x26);
        uVar3   = uVar5 | uVar4;
        if(uVar3 != 0x0)
        {
            ...
            if((uVar5 | uVar3) != 0x0)
            {
                ...
                else
                {
                    ...
                    puVar10 = mixed_1010_20ba(globals->_PTR_LOOP_1050_0ed0, 0x32, param_6, puVar7, (u_var2 >> 0x10));
    ...
    else
    {
        ...
        else
        {
            if(param_3 != 0x1c6)
            {
                post_win_msg_1040_7b3c(CONCAT13((param_2 >> 0x8), CONCAT12(param_2, param_1)), (param_2 >> 0x10), param_3, param_3, &PTR_LOOP_1050_1040);
                return;
            }
            uVar14 = 0xd;
        }
        ...
        uVar12  = 0x0;
        uVar13  = 0x0;
        puVar10 = mixed_1010_20ba(globals->_PTR_LOOP_1050_0ed0, 0x32, param_6, param_4, param_5);
...

{
    ...
    var2     = l_param;
    handle_2 = GetProp16((HWND16)LAST_SEGMENT, s_procLo_1050_5bd0);
    var7     = CONCAT22(handle_1, handle_2);
    var8     = l_param;
    handle_1 = GetProp16((HWND16)LAST_SEGMENT, s_thisHi_1050_5be5);
    handle_2 = GetProp16((HWND16)LAST_SEGMENT, s_thisLo_1050_5bde);
    ...
    if((handle_1 | handle_2) != 0x0)
    {
        ...
        else
        {
            ...
            {
                lresult = SendMessage16((HWND16)LAST_SEGMENT, 0x0, 0x0, 0x112f140);
                var1    = (lresult == 0x0);
                goto LAB_1038_d10e;
            }
        }
...

{
    ...
    uVar6    = param_3;
    HVar5    = GetProp16((HWND16)LAST_SEGMENT, s_thisLo_1050_5bec);
    pu_stack6 = CONCAT22(HVar4, HVar5);
    if(param_2 == 0x30)
    {
        if(param_2 == 0x0)
        {
        ...
        SetProp16((HWND16)LAST_SEGMENT, param_2, 0x5c06);
        return;
    }
    if(param_2 < 0x310000)
    {
        ...
        if(cVar3 == '\x02')
        {
            ...
            HVar4 = GetProp16((HWND16)LAST_SEGMENT, 0x5bfa);
            if(HVar4 == 0x0)
            {
                return;
            }
            DeleteObject16((HGDIOBJ16)LAST_SEGMENT);
            RemoveProp16((HWND16)LAST_SEGMENT, 0x5c00);
            return;
        }
        if(cVar3 == '\x06')
        {
...
void  post_win_msg_1038_d840(Struct70 *param_1, u16 param_2, HWND16 param_3)
...

{
    ...
    LVar2  = SendMessage16((HWND16)LAST_SEGMENT, 0x0, 0x0, 0x4070000);
    SendMessage16((HWND16)LAST_SEGMENT, param_1 + 0x9e, wparam, CONCAT22(0x408, LVar1));
    LVar1 = SendMessage16((HWND16)LAST_SEGMENT, param_1 + 0x19e, wparam, CONCAT22(0x408, LVar2));
    return LVar1;
}
...

{
    ...
    if(WStack6 != 0xffff)
    {
        SendDlgItemMessage16((HWND16)LAST_SEGMENT, (u16)local_106, param_3, WStack6, 0x185b040a);
...

{
    ...
    pu_stack6  = mixed_1010_20ba(globals->_PTR_LOOP_1050_0ed0, 0x8, param_2, in_DX, unaff_DI);
    puStack10 = mixed_1010_20ba(globals->_PTR_LOOP_1050_0ed0, 0x9, param_2, (pu_stack6 >> 0x10), unaff_DI);
    puVar5    = (puStack10 >> 0x10);
    u_var2     = puStack10;
    hwnd      = SEG_1000;
    mem_op_1000_179c(0xc, puVar5, SEG_1000);
    ...
    for(iStack20 = 0x0; iStack20 < 0xf; iStack20 = iStack20 + 0x1)
    {
        ...
        if(UVar3 != 0x0)
        {
            if((iStack20 * 0xe + 0x5a7c) < 0x83)
            {
                ...
                HVar8  = SEG_1000;
                UVar4  = UVar3;
                mem_op_1000_179c(0x8, puVar5, SEG_1000);
...

{
    ...
    {
        uVar5 = 0xb4;
        mem_op_1000_179c(0xb4, param_4, SEG_1000);
        ...
        {
            iVar3 = string_1040_8520(CONCAT22(param_4, u_var2), (param_1 + 0x6), 0x41, 0x2, 0x5db, 0x5da, puVar4, param_6);
        }
...
long  unk_win_ui_op_1038_9820(Struct51 *param_1, i16 param_2, i16 param_3, HWND16 param_4, BOOL16 param_5)

{
    ...
    UVar3 = GetDlgItemInt16((HWND16)LAST_SEGMENT, 0x1, &local_6, param_5);
...
void  win_ui_dlg_op_1038_98b4(Struct51 *param_1, HWND16 param_2, BOOL16 param_3)

{
    ...
    SetDlgItemInt16((HWND16)LAST_SEGMENT, 0x1, (iVar3 + 0x96), 0xfa8);
    return;
}
...

{
    ...
    if((iVar1 + 0x214) == 0x0)
    {
        ...
        paVar3 = (Struct67 *)mixed_1010_20ba(globals->_PTR_LOOP_1050_0ed0, 0x37, unaff_SS, in_DX, unaff_DI);
...

{
    ...
    paStack6 = (Struct67 *)mixed_1010_20ba(globals->_PTR_LOOP_1050_0ed0, 0x37, param_7, param_5, param_6);
...

{
    ...
    p_var2 = (Struct67 *)mixed_1010_20ba(globals->_PTR_LOOP_1050_0ed0, 0x37, param_4, param_2, param_3);
...

{
    ...
    if((param_3 | uVar4) == 0x0)
    {
        ...
        puVar8   = mixed_1010_20ba(globals->_PTR_LOOP_1050_0ed0, 0x2b, param_4, 0x0, param_5);
        ...
        pass1_1038_349e(u_stack6, CONCAT22(0x800, uVar7));
        iStack30 = 0x0;
        uStack26 = 0x0;
        ...
        while(true)
        {
            ...
            u_stack6 = CONCAT22(uVar4, pu_var2);
            uVar5   = uVar4 | pu_var2;
            if(uVar5 == 0x0)
                break;
        ...
        if(iStack30 == 0x0)
        {
            ...
            iVar6  = 0x0;
            uVar7  = 0x0;
            paVar9 = (Struct67 *)mixed_1010_20ba(globals->_PTR_LOOP_1050_0ed0, 0x37, param_4, 0x0, param_5);
            post_win_msg_1008_a0e4(paVar9, CONCAT22(uVar10, uVar7), iVar6, CONCAT11(uVar12, uVar11), CONCAT22(uVar14, uVar13), iVar15, SEG_1008, param_4);
        }
    }
    return;
}
...

{
    ...
    if((uStack16 | uStack18) != 0x0)
    {
        ...
        {
            puVar15 = mixed_1010_20ba(globals->_PTR_LOOP_1050_0ed0, 0x37, param_6, puVar13, iVar12);
            ...
            puVar15 = mixed_1010_20ba(globals->_PTR_LOOP_1050_0ed0, 0x2b, param_6, puVar13, iVar12);
...

{
    ...
    iVar4  = 0x0;
    u_var2  = 0x0;
    paVar1 = (Struct67 *)mixed_1010_20ba(globals->_PTR_LOOP_1050_0ed0, 0x37, param_4, param_2, param_3);
    post_win_msg_1008_a0e4(paVar1, CONCAT22(uVar3, u_var2), iVar4, uVar5, CONCAT22(uVar7, uVar6), iVar8, SEG_1008, param_4);
...

{
    ...
    paVar4 = (Struct67 *)mixed_1010_20ba(globals->_PTR_LOOP_1050_0ed0, 0x37, param_4, param_2, param_3);
    uVar3  = param_1;
    iVar10 = (uVar3 + 0x108);
    if(iVar10 - 0x1U < 0x8)
    {
        ...
        case 0x7:
            ...
            iVar10 = 0x7;
            puVar5 = mixed_1010_20ba(globals->_PTR_LOOP_1050_0ed0, 0x2f, param_4, pu_var2, param_3);
            uVar1  = (puVar5 >> 0x10);
            uVar3  = puVar5;
...

{
    ...
    puVar3   = mixed_1010_20ba(globals->_PTR_LOOP_1050_0ed0, 0x2c, unaff_SS, in_DX, unaff_DI);
    u_var2    = (puVar3 >> 0x10);
    lVar1    = (puVar3 + 0xc);
    uStack8  = (lVar1 >> 0x10);
    uStack10 = lVar1;
...
LAB_1028_7066:
    ...
    if(iStack30 == 0x0)
    {
        ...
        if(puStack32 != 0x0)
        {
            ...
            uVar16             = 0x0;
            iVar11             = 0x1;
            uStack52           = (Struct67 *)mixed_1010_20ba(globals->_PTR_LOOP_1050_0ed0, 0x2b, param_4, puStack32, param_3);
    ...
    if((iStack28 != 0x0) && (iStack26 != 0x0))
    {
        ...
        iVar11    = 0x0;
        uVar9     = 0x0;
        uStack52  = (Struct67 *)mixed_1010_20ba(globals->_PTR_LOOP_1050_0ed0, 0x37, param_4, puStack32, param_3);
        puStack32 = (uStack52 >> 0x10);
        pu_var2    = uStack52;
        post_win_msg_1008_a0e4(uStack52, CONCAT22(uVar10, uVar9), iVar11, CONCAT11(uVar14, uVar12), CONCAT22(uVar17, uVar15), iVar18, SEG_1008, param_4);
    }
    pass1_1028_e1ec(globals->_PTR_LOOP_1050_65e2, 0x1, 0x800);
    puVar4    = (puStack32 | pu_var2);
    puStack34 = pu_var2;
    if(((((puVar4 != 0x0) && (pu_var2 = pass1_1030_2242(CONCAT22(puStack32, pu_var2), 0x4), pu_var2 == 0x0)) && (pu_var2 = pass1_1030_2242(CONCAT22(puStack32, puStack34), 0x2a), pu_var2 == 0x0))
        && ((pu_var2 = pass1_1030_2242(CONCAT22(puStack32, puStack34), 0x4b), pu_var2 == 0x0 && (pu_var2 = pass1_1030_2242(CONCAT22(puStack32, puStack34), 0x54), pu_var2 == 0x0))))
       && ((pu_var2 = pass1_1030_2242(CONCAT22(puStack32, puStack34), 0x2c),
            pu_var2 == 0x0 && ((pu_var2 = pass1_1030_2242(CONCAT22(puStack32, puStack34), 0x3c), pu_var2 == 0x0 && (pu_var2 = pass1_1030_2242(CONCAT22(puStack32, puStack34), 0x3d), pu_var2 == 0x0))))))
    {
        if(iStack4 != 0x0)
        {
            uStack8  = 0x1;
        ...
        do
        {
            ...
            uVar16 = (param_1 >> 0x10);
            if((uStack52 == 0x0) && (pass1_1028_740c(param_1, uVar16, 0x22, CONCAT22(puVar5, pu_var2)), pu_var2 != 0x0))
            {
                uStack52 = (Struct67 *)CONCAT22(uStack52, 0x1);
            }
        ...
        iVar11    = 0x0;
        uVar9     = 0x0;
        paStack38 = (Struct67 *)mixed_1010_20ba(globals->_PTR_LOOP_1050_0ed0, 0x37, param_4, puVar4, param_3);
        puVar4    = (paStack38 >> 0x10);
        pu_var2    = paStack38;
        post_win_msg_1008_a0e4(paStack38, CONCAT22(uVar10, uVar9), iVar11, CONCAT11(uVar14, uVar12), CONCAT22(uVar17, uVar15), iVar18, SEG_1008, param_4);
    }
LAB_1028_72d3:
    pass1_1028_e1ec(globals->_PTR_LOOP_1050_65e2, 0x1, 0x400);
    uStack24 = CONCAT22(puVar4, pu_var2);
    ...
    {
        puVar8    = mixed_1010_20ba(globals->_PTR_LOOP_1050_0ed0, 0x3b, param_4, (puVar4 | pu_var2), param_3);
        puVar4    = (puVar8 >> 0x10);
        iStack48  = puVar8;
        puStack46 = puVar4;
        pass1_1008_df4a(puVar8, param_3, param_4);
        puVar8    = mixed_1010_20ba(globals->_PTR_LOOP_1050_0ed0, 0x3c, param_4, puVar4, param_3);
        uVar7     = (puVar8 >> 0x10);
        iStack48  = puVar8;
        puStack46 = uVar7;
        ...
        while(true)
        {
            ...
            pu_var2 = local_46;
            pass1_1028_e4ec(CONCAT22(param_4, pu_var2));
            uStack52 = (Struct67 *)CONCAT22(uVar6, pu_var2);
            uVar7    = uVar6 | pu_var2;
            if(uVar7 == 0x0)
                break;
            if((pu_var2 + 0x200) != 0x8000002)
...

{
    ...
    if(iVar7->field_0xea == 0x0)
    {
        ...
        mem_op_1000_179c(0x112, puVar5, SEG_1000);
        puVar6 = (puVar5 | uVar4);
        if(puVar6 == 0x0)
        {
            uVar3     = 0x0;
...

{
    ...
    mem_op_1000_179c(0x18, in_DX, SEG_1000);
    uVar3 = in_DX | in_AX;
    if(uVar3 != 0x0)
    {
...
//    i16          iVar11;
    ...
    create_window_ex_1008_9760(param_1, SEG_1008);
    puVar13                     = mixed_1010_20ba(globals->_PTR_LOOP_1050_0ed0, 0x4, unaff_SS, in_DX, unaff_DI);
    uVar7                       = (puVar13 >> 0x10);
//    uVar12                      = (param_1 >> 0x10);
//    iVar11                      = param_1;
    ...
    *(HICON16 *)(param_1 + 0xc2) = icon_handle_1;
    ...
    puVar9 = extraout_DX;
    pass1_1018_2d22(*(param_1 + 0xf2), CONCAT22(unaff_SS, &local_6), CONCAT13((unaff_SS >> 0x8), CONCAT12(unaff_SS, paVar4)), 0xbb8);
    ...
    mem_op_1000_179c(0x42, puVar8, SEG_1000);
    ...
    mem_op_1000_179c(0x22, puVar8, SEG_1000);
...

{
    ...
    puStack12 = mixed_1010_20ba(globals->_PTR_LOOP_1050_0ed0, 0x37, param_2, puVar3, unaff_DI);
    load_string_1010_84e0(SEG_1010, globals->PCHAR_1050_14cc, (_PTR_LOOP_1050_14cc >> 0x10), 0x100, local_10c, param_2);
    puVar5  = pass1_1008_9436(CONCAT22(param_2, local_112));
    uVar8   = (param_2 >> 0x8);
    pcVar6  = pass1_1008_a8f4(puStack12, CONCAT13(uVar8, CONCAT12(param_2, &local_114)), CONCAT22(param_2, local_112), CONCAT22(param_2, &local_10e), (puVar5 >> 0x10), SEG_1008, param_2, in_AF);
    u_var2   = pcVar6;
    ...
    {
        hwnd = SEG_1000;
        mem_op_1000_179c(0xb4, puVar3, SEG_1000);
        ...
        else
        {
            ...
            puVar6 = pass1_1040_8478(CONCAT22(puVar3, u_var2), 0x0, CONCAT13(uVar8, CONCAT12(param_2, local_10c)), pcVar6, (param_1 + 0x8), puVar3 | u_var2);
        }
        uVar4 = (puVar6 >> 0x10);
        if(iStack272 == 0x0)
        {
    ...
    if(local_10e == 0x6)
    {
        ...
        hwnd_00         = SEG_1010;
        puVar5          = mixed_1010_20ba(globals->_PTR_LOOP_1050_0ed0, 0x2, param_2, puVar3, unaff_DI);
        puVar3          = (puVar5 >> 0x10);
        (puVar5 + 0x20) = 0x1;
    }
    if(local_10e == 0x15)
...
void  win_1020_43f6(Struct0 *param_1, u8 *param_2, u16 param_3)

{
    ...
    puVar7                      = mixed_1010_20ba(globals->_PTR_LOOP_1050_0ed0, 0x32, param_3, param_2, unaff_DI);
    ...
    mem_op_1000_179c(0x30, (lVar8 >> 0x10), SEG_1000);
    uVar5 = (lVar8 >> 0x10);
    uVar3 = lVar8;
    uVar6 = uVar5 | uVar3;
    if(lVar8 == 0x0)
...

{
    ...
    iVar3 = (param_4 >> 0x10);
    post_win_msg_1020_79fc((Struct69 *)CONCAT22(param_2, param_1), param_3, param_4, iVar3, param_7);
    pu_var2 = mixed_1010_20ba(globals->_PTR_LOOP_1050_0ed0, 0x29, unaff_SS, param_6, unaff_DI);
    puVar1 = (pu_var2 >> 0x10);
    if(iVar3 == 0x0)
    {
...

{
    ...
    if(iVar2->field_0xe8 != 0x0)
    {
        ...
        if(BVar1 != 0x0)
        {
            SendMessage16((HWND16)LAST_SEGMENT, 0x0, 0x0, 0x1110001);
        }
...
void  win_1020_09ba(Struct0 *param_1, u16 param_2, u8 *param_3, u16 param_4)

{
    ...
    create_window_ex_1008_9760(param_1, SEG_1008);
    mem_op_1000_179c(0xe, param_3, SEG_1000);
...
Struct63 * pass1_1020_0ae8(Struct63 *param_1, u8 param_2, u16 param_3)
...

{
    ...
    if(param_2 == 0xfb)
    {
        puVar5 = mixed_1010_20ba(globals->_PTR_LOOP_1050_0ed0, 0x30, param_3, in_DX, unaff_DI);
    ...
    else
    {
        ...
        if(cVar2 == 'o')
        {
            ...
            WinHelp16(SEG_1010, (s_New_failed_in_Op__Op_1050_0020 + 0x8), 0x0, CONCAT22(paVar7, 0x1));
            return;
        }
        if(cVar2 == 'r')
        {
            ...
            pass1_1038_af40(_PTR_LOOP_1050_5b7c, (uVar3 + 0x8), 0x3, uVar4, uVar3, SEG_1038, param_3);
            return;
        }
        if(cVar2 == -0xf)
        {
