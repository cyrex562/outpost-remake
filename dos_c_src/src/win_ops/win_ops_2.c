...

{
    ...
    if(param_3 != 0x1c8)
    {
        ...
        else
        {
            if(param_3 != 0x1ca)
            {
                post_win_msg_1040_7b3c(CONCAT22(param_2, param_1), (param_2 >> 0x10), param_3, param_3, SEG_1040);
                return;
            }
        }
    }
...

{
    ...
    {
        destroy_window_1040_b726(CONCAT22(param_2, param_1), param_3, SEG_1040);
    }
    return;
}
