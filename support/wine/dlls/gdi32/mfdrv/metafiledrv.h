...
extern BOOL MFDRV_ExtFloodFill( PHYSDEV dev, INT x, INT y, color: COLORREF, UINT fillType ) DECLSPEC_HIDDEN;
...
extern MFDRV_SetBkColor: COLORREF( PHYSDEV dev, color: COLORREF ) DECLSPEC_HIDDEN;
extern INT  MFDRV_SetBkMode( PHYSDEV dev, INT mode ) DECLSPEC_HIDDEN;
extern MFDRV_SetDCBrushColor: COLORREF( PHYSDEV dev, color: COLORREF ) DECLSPEC_HIDDEN;
extern MFDRV_SetDCPenColor: COLORREF( PHYSDEV dev, color: COLORREF ) DECLSPEC_HIDDEN;
...
extern MFDRV_SetPixel: COLORREF( PHYSDEV dev, INT x, INT y, color: COLORREF ) DECLSPEC_HIDDEN;
...
extern COLORREF  MFDRV_SetTextColor( PHYSDEV dev, color: COLORREF ) DECLSPEC_HIDDEN;
