...
25  stdcall -noname IsCharAlphaWrapW user32.IsCharAlphaW
26  stdcall -noname IsCharUpperWrapW user32.IsCharUpperW
27  stdcall -noname IsCharLowerWrapW user32.IsCharLowerW
28  stdcall -noname IsCharAlphaNumericWrapW user32.IsCharAlphaNumericW
29  stdcall -ordinal IsCharSpaceW
30  stdcall -noname IsCharBlankW
31  stdcall -noname IsCharPunctW
32  stdcall -noname IsCharCntrlW(ptr)
33  stdcall -noname IsCharDigitW
34  stdcall -noname IsCharXDigitW
...
96  stdcall -noname GetWindowTextLengthWrapW user32.GetWindowTextLengthW
...
148 stdcall -noname VkKeyScanWrapW user32.VkKeyScanW
...
169 stdcall -ordinal IUnknown_AtomicRelease
...
180 stdcall -noname SHRemoveAllSubMenus
...
222 stdcall -noname SHGlobalCounterCreate
223 stdcall -noname SHGlobalCounterGetValue
224 stdcall -noname SHGlobalCounterIncrement
...
413 stdcall -noname SHGetMachineInfo
...
418 stdcall -ordinal MLFreeLibrary
...
424 stdcall -noname SHGlobalCounterDecrement
425 stdcall -noname DeleteMenuWrap(ptr long long) user32.DeleteMenu
426 stdcall -noname DestroyMenuWrap user32.DestroyMenu
...
429 stdcall -noname MLIsMLHInstance
430 stdcall -noname MLSetMLHInstance(long long)
431 stdcall -noname MLClearMLHInstance
...
@ stdcall PathGetCharTypeA
@ stdcall PathGetCharTypeW
