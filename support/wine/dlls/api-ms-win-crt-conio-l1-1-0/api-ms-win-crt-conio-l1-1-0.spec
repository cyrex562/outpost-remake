...
@ cdecl _putch ucrtbase._putch
@ cdecl _putch_nolock ucrtbase._putch_nolock
@ cdecl _putwch ucrtbase._putwch
@ cdecl _putwch_nolock ucrtbase._putwch_nolock
@ cdecl _ungetch ucrtbase._ungetch
@ cdecl _ungetch_nolock ucrtbase._ungetch_nolock
@ cdecl _ungetwch ucrtbase._ungetwch
@ cdecl _ungetwch_nolock ucrtbase._ungetwch_nolock
