...
@ cdecl _configure_narrow_argv ucrtbase._configure_narrow_argv
@ cdecl _configure_wide_argv ucrtbase._configure_wide_argv
...
@ cdecl _crt_debugger_hook ucrtbase._crt_debugger_hook
@ cdecl _endthread() ucrtbase._endthread
@ cdecl _endthreadex ucrtbase._endthreadex
...
@ cdecl _set_app_type ucrtbase._set_app_type
@ cdecl _set_controlfp(long long) ucrtbase._set_controlfp
@ cdecl _set_doserrno ucrtbase._set_doserrno
@ cdecl _set_errno ucrtbase._set_errno
@ cdecl _set_error_mode ucrtbase._set_error_mode
...
@ cdecl _seterrormode ucrtbase._seterrormode
@ cdecl _sleep ucrtbase._sleep
@ cdecl _statusfp() ucrtbase._statusfp
@ cdecl -arch=i386 _statusfp2(ptr ptr) ucrtbase._statusfp2
@ cdecl _strerror ucrtbase._strerror
@ stub _strerror_s
@ cdecl _wassert(wstr wstr long) ucrtbase._wassert
@ cdecl _wcserror ucrtbase._wcserror
