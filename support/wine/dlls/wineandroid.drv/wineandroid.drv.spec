...
@ cdecl wine_get_gdi_driver ANDROID_get_gdi_driver

# USER driver

@ cdecl GetKeyNameText(long ptr long) ANDROID_GetKeyNameText
@ cdecl GetKeyboardLayout ANDROID_GetKeyboardLayout
...
@ cdecl CreateWindow ANDROID_CreateWindow
@ cdecl DestroyWindow ANDROID_DestroyWindow
