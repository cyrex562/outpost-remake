...
@ stdcall AddClipboardFormatListener
...
@ stdcall AllowSetForegroundWindow 
...
@ stdcall ArrangeIconicWindows
@ stdcall AttachThreadInput(long long long)
@ stdcall BeginDeferWindowPos
...
@ stdcall CloseDesktop
@ stdcall CloseTouchInputHandle
@ stdcall CloseWindow
@ stdcall CloseWindowStation
...
@ stdcall DeregisterShellHookWindow 
@ stdcall DestroyAcceleratorTable
@ stdcall DestroyCaret()
@ stdcall DestroyCursor
@ stdcall DestroyIcon
@ stdcall DestroyMenu
# @ stub DestroyReasons
@ stdcall DestroyWindow
...
@ stdcall GetAppCompatFlags
@ stdcall GetAppCompatFlags2
@ stdcall GetAsyncKeyState
@ stdcall GetAutoRotationState(ptr)
@ stdcall GetAwarenessFromDpiAwarenessContext
@ stdcall GetCapture()
...
@ stdcall GetWindowContextHelpId
@ stdcall GetWindowDC
@ stdcall GetWindowDisplayAffinity(long ptr)
@ stdcall GetWindowDpiAwarenessContext
...
@ stdcall IsCharAlphaA
@ stdcall IsCharAlphaNumericA
@ stdcall IsCharAlphaNumericW
@ stdcall IsCharAlphaW
@ stdcall IsCharLowerA
@ stdcall IsCharLowerW
@ stdcall IsCharUpperA
@ stdcall IsCharUpperW
@ stdcall IsChild(long long)
@ stdcall IsClipboardFormatAvailable
...
@ stdcall IsValidDpiAwarenessContext
@ stdcall IsWinEventHookInstalled
@ stdcall IsWindow
@ stdcall IsWindowEnabled
# @ stub IsWindowInDestroy
@ stdcall IsWindowRedirectedForPrint
@ stdcall IsWindowUnicode
@ stdcall IsWindowVisible
@ stdcall IsZoomed
...
@ stdcall LockSetForegroundWindow 
@ stub LockWindowStation
@ stdcall LockWindowUpdate
...
@ stdcall RegisterServicesProcess
@ stdcall RegisterShellHookWindow 
@ stdcall RegisterSystemThread(long long)
@ stdcall RegisterTasklist 
...
@ stdcall SetActiveWindow
@ stdcall SetCapture
@ stdcall SetCaretBlinkTime
...
@ stdcall SetDoubleClickTime
@ stdcall SetFocus
@ stdcall SetForegroundWindow
...
@ stdcall SetMessageExtraInfo
@ stdcall SetMessageQueue
@ stdcall SetParent(long long)
@ stdcall SetPhysicalCursorPos(long long)
@ stdcall SetProcessDPIAware()
@ stdcall SetProcessDefaultLayout
@ stdcall SetProcessDpiAwarenessContext
@ stdcall SetProcessDpiAwarenessInternal
@ stdcall SetProcessWindowStation
@ stdcall SetProgmanWindow 
...
@ stdcall SetTaskmanWindow 
@ stdcall SetThreadDesktop
...
@ stdcall ShutdownBlockReasonDestroy
# @ stub SoftModalMessageBox
@ stdcall SubtractRect(ptr ptr ptr)
@ stdcall SwapMouseButton
@ stdcall SwitchDesktop
...
@ stdcall UnhookWinEvent
@ stdcall UnhookWindowsHook(long ptr)
@ stdcall UnhookWindowsHookEx
@ stdcall UnionRect(ptr ptr ptr)
@ stdcall UnloadKeyboardLayout
...
@ stdcall WINNLSGetEnableStatus
@ stdcall WINNLSGetIMEHotkey
