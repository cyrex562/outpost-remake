...
@ stdcall BringWindowToTop user32.BringWindowToTop
...
@ stdcall GetWindowTextLengthW user32.GetWindowTextLengthW
...
@ stdcall IsIconic user32.IsIconic
@ stdcall IsWindow user32.IsWindow
@ stdcall IsWindowUnicode user32.IsWindowUnicode
...
@ stub SoundSentry
@ stdcall UnhookWindowsHookEx user32.UnhookWindowsHookEx
