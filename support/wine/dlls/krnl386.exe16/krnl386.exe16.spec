...
14  pascal LocalNotify LocalNotify16
...
25  pascal GlobalCompact GlobalCompact16
...
147 pascal -ret16 SetLastError SetLastError16
...
156 pascal   LimitEMSPages LimitEMSPages16
157 pascal   GetCurPID GetCurPID16
...
184 pascal GlobalDOSAlloc GlobalDOSAlloc16
...
220 pascal RegCloseKey RegCloseKey16                                # Both 95/NT
...
227 pascal RegFlushKey RegFlushKey16
228 pascal -ret16 K228(word) GetExePtr
229 pascal -ret16 K229 Local32GetSegment16
...
443 pascal VWin32_EventDestroy VWin32_EventDestroy
...
450 pascal VWin32_EventWait VWin32_EventWait
451 pascal VWin32_EventSet VWin32_EventSet
...
458 pascal SetW32Event SetW32Event
459 pascal ResetW32Event ResetW32Event
...
464 pascal GetThreadQueue GetThreadQueue16
...
474 pascal CloseW32Handle CloseW32Handle
475 pascal -ret16 GetTEBSelectorFS() GetTEBSelectorFS16
476 pascal ConvertToGlobalHandle ConvertToGlobalHandle16
477 stub WOAFullScreen
478 stub WOATerminateProcess
479 pascal KERNEL_479 VWin32_EventSet  # ???
...
514 pascal FreeLibrary32W FreeLibrary32W16                # Both NT/95
...
623 pascal -ret16 InitCBClient InitCBClient16
...
@ stdcall -arch=win32 DosFileHandleToWin32Handle
@ stdcall -arch=win32 Win32HandleToDosFileHandle
@ stdcall -arch=win32 DisposeLZ32Handle
@ stdcall -arch=win32 GlobalAlloc16(long long)
@ stdcall -arch=win32 GlobalLock16
@ stdcall -arch=win32 GlobalUnlock16
@ stdcall -arch=win32 GlobalFix16
@ stdcall -arch=win32 GlobalUnfix16
@ stdcall -arch=win32 GlobalWire16
@ stdcall -arch=win32 GlobalUnWire16
@ stdcall -arch=win32 GlobalFree16
@ stdcall -arch=win32 GlobalSize16
@ stdcall -arch=win32 HouseCleanLogicallyDeadHandles()
@ stdcall -arch=win32 GetWin16DOSEnv()
@ stdcall -arch=win32 LoadLibrary16(str)
@ stdcall -arch=win32 FreeLibrary16
...
@ stdcall -arch=win32 RestoreThunkLock
...
@ stdcall -arch=win32 K32WOWGlobalLock16
@ stdcall -arch=win32 K32WOWGlobalUnlock16
@ stdcall -arch=win32 K32WOWGlobalFree16
@ stdcall -arch=win32 K32WOWGlobalAllocLock16(long long ptr)
@ stdcall -arch=win32 K32WOWGlobalUnlockFree16
@ stdcall -arch=win32 K32WOWGlobalLockSize16(long ptr)
@ stdcall -arch=win32 K32WOWYield16()
@ stdcall -arch=win32 K32WOWDirectedYield16
@ stdcall -arch=win32 K32WOWGetVDMPointerFix(long long long)
@ stdcall -arch=win32 K32WOWGetVDMPointerUnfix
...
@ stdcall -arch=win32 _KERNEL32_99
...
@ stdcall -arch=win32 FreeSLCallback
...
@ stdcall -arch=win32 MapHModuleLS
@ stdcall -arch=win32 MapHModuleSL
@ stdcall -arch=win32 MapLS(ptr)
@ stdcall -arch=win32 MapSL
@ stdcall -arch=win32 MapSLFix
@ stdcall -arch=win32 PrivateFreeLibrary
...
@ stdcall -arch=win32 LocalLock16
@ stdcall -arch=win32 LocalUnlock16
@ stdcall -arch=win32 LocalReAlloc16(long long long)
@ stdcall -arch=win32 LocalFree16
@ stdcall -arch=win32 LocalSize16
@ stdcall -arch=win32 LocalCompact16
@ stdcall -arch=win32 LocalCountFree16()
@ stdcall -arch=win32 LocalHeapSize16()
@ stdcall -arch=win32 LockResource16
...
@ cdecl -arch=win32 -private __wine_vxd_get_proc
