...
@ stdcall CMP_WaitNoPendingInstallEvents
...
@ stdcall SetupDestroyDiskSpaceList
...
@ stdcall SetupSetNonInteractiveMode
...
@ stdcall pSetupMalloc MyMalloc
@ stdcall pSetupRealloc(ptr long) MyRealloc
@ stdcall pSetupSetGlobalFlags
