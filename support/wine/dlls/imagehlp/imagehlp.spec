...
@ stdcall GetTimestampForLoadedLibrary dbghelp.GetTimestampForLoadedLibrary
...
@ stdcall SymCleanup dbghelp.SymCleanup
...
@ stdcall SymSetOptions dbghelp.SymSetOptions
