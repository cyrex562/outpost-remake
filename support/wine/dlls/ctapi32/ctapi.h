...
IS8 CT_init( Ictn: u16, Ipn: u16 );
IS8 CT_data( Ictn: u16, IU8 *dad, IU8 *sad, Ilenc: u16, IU8 *command, IU16 *lenr,
	IU8 *response );
IS8 CT_close( Ictn: u16 );

/* Proprietary extension */
IS8 CT_keycb( Ictn: u16, void (* cb)(Ictn: u16, IU8 status) );
