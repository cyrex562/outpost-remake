...
@ stdcall LdrDisableThreadCalloutsForDll
...
@ stdcall NtImpersonateAnonymousToken
...
@ stdcall NtSetDefaultUILanguage
...
@ stdcall -arch=win32 -ret64 RtlConvertLongToLargeInteger
...
@ stdcall -arch=win32 -ret64 RtlConvertUlongToLargeInteger
...
@ stdcall RtlDowncaseUnicodeChar
...
@ stdcall RtlExitUserProcess
@ stdcall RtlExitUserThread
...
@ stdcall RtlNtStatusToDosErrorNoTeb
...
@ stdcall RtlRestoreLastWin32Error RtlSetLastWin32Error
...
@ stdcall RtlSetLastWin32ErrorAndNtStatusFromNtStatus
...
@ stdcall RtlWow64EnableFsRedirection
...
@ stdcall -private ZwAlertThread NtAlertThread
...
@ stdcall -private ZwClearEvent NtClearEvent
@ stdcall -private ZwClose NtClose
...
@ stdcall -private ZwDeleteAtom NtDeleteAtom
# @ stub ZwDeleteBootEntry
@ stdcall -private ZwDeleteFile(ptr) NtDeleteFile
@ stdcall -private ZwDeleteKey NtDeleteKey
...
@ stdcall -private ZwFlushKey NtFlushKey
...
@ stdcall -private ZwImpersonateAnonymousToken NtImpersonateAnonymousToken
...
@ stdcall -private ZwMakeTemporaryObject NtMakeTemporaryObject
...
@ stdcall -private ZwResumeProcess NtResumeProcess
...
@ stdcall -private ZwSetDefaultUILanguage NtSetDefaultUILanguage
...
@ stdcall -private ZwShutdownSystem NtShutdownSystem
@ stdcall -private ZwSignalAndWaitForSingleObject(long long long ptr) NtSignalAndWaitForSingleObject
@ stub ZwStartProfile
@ stub ZwStopProfile
@ stdcall -private ZwSuspendProcess NtSuspendProcess
...
@ cdecl -private __isascii NTDLL___isascii
@ cdecl -private __iscsym NTDLL___iscsym
@ cdecl -private __iscsymf NTDLL___iscsymf
@ cdecl -private __toascii NTDLL___toascii
...
@ cdecl -private _tolower NTDLL__tolower
@ cdecl -private _toupper NTDLL__toupper
...
@ cdecl -private isalnum NTDLL_isalnum
@ cdecl -private isalpha NTDLL_isalpha
@ cdecl -private iscntrl NTDLL_iscntrl
@ cdecl -private isdigit NTDLL_isdigit
@ cdecl -private isgraph NTDLL_isgraph
@ cdecl -private islower NTDLL_islower
@ cdecl -private isprint NTDLL_isprint
@ cdecl -private ispunct NTDLL_ispunct
@ cdecl -private isspace NTDLL_isspace
@ cdecl -private isupper NTDLL_isupper
@ cdecl -private iswalpha NTDLL_iswalpha
@ cdecl -private iswctype(long long) NTDLL_iswctype
@ cdecl -private iswdigit NTDLL_iswdigit
@ cdecl -private iswlower NTDLL_iswlower
@ cdecl -private iswspace NTDLL_iswspace
@ cdecl -private iswxdigit NTDLL_iswxdigit
@ cdecl -private isxdigit NTDLL_isxdigit
@ cdecl -private labs NTDLL_labs
...
@ cdecl -private tolower NTDLL_tolower
@ cdecl -private toupper NTDLL_toupper
@ cdecl -private towlower NTDLL_towlower
@ cdecl -private towupper NTDLL_towupper
