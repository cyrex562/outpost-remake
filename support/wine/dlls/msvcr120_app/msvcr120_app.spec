...
@ cdecl -arch=win32 ??2@YAPAXI@Z msvcr120.??2@YAPAXI@Z
@ cdecl -arch=win64 ??2@YAPEAX_K@Z msvcr120.??2@YAPEAX_K@Z
...
@ cdecl -arch=win32 ??_U@YAPAXI@Z msvcr120.??_U@YAPAXI@Z
@ cdecl -arch=win64 ??_U@YAPEAX_K@Z msvcr120.??_U@YAPEAX_K@Z
...
@ cdecl -arch=win32 ?Alloc@Concurrency@@YAPAXI@Z msvcr120.?Alloc@Concurrency@@YAPAXI@Z
@ cdecl -arch=win64 ?Alloc@Concurrency@@YAPEAX_K@Z msvcr120.?Alloc@Concurrency@@YAPEAX_K@Z
...
@ cdecl ?Oversubscribe@Context@Concurrency@@SAX_N@Z msvcr120.?Oversubscribe@Context@Concurrency@@SAX_N@Z
@ cdecl -arch=win32 ?RegisterShutdownEvent@CurrentScheduler@Concurrency@@SAXPAX@Z msvcr120.?RegisterShutdownEvent@CurrentScheduler@Concurrency@@SAXPAX@Z
@ cdecl -arch=win64 ?RegisterShutdownEvent@CurrentScheduler@Concurrency@@SAXPEAX@Z msvcr120.?RegisterShutdownEvent@CurrentScheduler@Concurrency@@SAXPEAX@Z
...
@ cdecl ?_set_new_mode@@YAHH@Z msvcr120.?_set_new_mode@@YAHH@Z
...
@ cdecl __crtSleep msvcr120.__crtSleep
...
@ cdecl __isascii msvcr120.__isascii
@ cdecl __iscsym msvcr120.__iscsym
@ cdecl __iscsymf msvcr120.__iscsymf
@ stub __iswcsym
@ stub __iswcsymf
...
@ cdecl __toascii msvcr120.__toascii
...
@ cdecl _amsg_exit msvcr120._amsg_exit
...
@ cdecl _byteswap_ulong msvcr120._byteswap_ulong
@ cdecl _byteswap_ushort msvcr120._byteswap_ushort
@ cdecl _c_exit() msvcr120._c_exit
@ cdecl _cabs msvcr120._cabs
@ cdecl _callnewh msvcr120._callnewh
...
@ cdecl _close msvcr120._close
@ cdecl _commit msvcr120._commit
@ extern _commode msvcr120._commode
@ cdecl _configthreadlocale msvcr120._configthreadlocale
...
@ cdecl -arch=i386 _crt_debugger_hook msvcr120._crt_debugger_hook
@ cdecl -arch=arm,win64 __crt_debugger_hook msvcr120.__crt_debugger_hook
...
@ cdecl _filelength msvcr120._filelength
@ cdecl -ret64 _filelengthi64 msvcr120._filelengthi64
@ cdecl _fileno(ptr) msvcr120._fileno
@ cdecl _findclose msvcr120._findclose
...
@ cdecl _fputchar msvcr120._fputchar
@ cdecl _fputwc_nolock(long ptr) msvcr120._fputwc_nolock
@ cdecl _fputwchar msvcr120._fputwchar
...
@ cdecl _get_osfhandle msvcr120._get_osfhandle
...
@ cdecl _isatty msvcr120._isatty
...
@ cdecl _ismbbalnum msvcr120._ismbbalnum
@ stub _ismbbalnum_l
@ cdecl _ismbbalpha msvcr120._ismbbalpha
@ stub _ismbbalpha_l
@ stub _ismbbblank
@ stub _ismbbblank_l
@ cdecl _ismbbgraph msvcr120._ismbbgraph
@ stub _ismbbgraph_l
@ cdecl _ismbbkalnum msvcr120._ismbbkalnum
@ stub _ismbbkalnum_l
@ cdecl _ismbbkana msvcr120._ismbbkana
@ stub _ismbbkana_l
@ cdecl _ismbbkprint msvcr120._ismbbkprint
@ stub _ismbbkprint_l
@ cdecl _ismbbkpunct msvcr120._ismbbkpunct
@ stub _ismbbkpunct_l
@ cdecl _ismbblead msvcr120._ismbblead
@ cdecl _ismbblead_l(long ptr) msvcr120._ismbblead_l
@ cdecl _ismbbprint msvcr120._ismbbprint
@ stub _ismbbprint_l
@ cdecl _ismbbpunct msvcr120._ismbbpunct
@ stub _ismbbpunct_l
@ cdecl _ismbbtrail msvcr120._ismbbtrail
@ stub _ismbbtrail_l
...
@ cdecl _malloc_crt msvcr120._malloc_crt
# extern _mbcasemap
...
@ cdecl -arch=i386 _set_SSE2_enable msvcr120._set_SSE2_enable
@ cdecl _set_abort_behavior(long long) msvcr120._set_abort_behavior
@ cdecl _set_controlfp(long long) msvcr120._set_controlfp
@ cdecl _set_doserrno msvcr120._set_doserrno
@ cdecl _set_errno msvcr120._set_errno
@ cdecl _set_error_mode msvcr120._set_error_mode
@ cdecl _set_fmode msvcr120._set_fmode
@ cdecl _set_invalid_parameter_handler(ptr) msvcr120._set_invalid_parameter_handler
@ stub _set_malloc_crt_max_wait
@ cdecl _set_output_format msvcr120._set_output_format
@ cdecl _set_printf_count_output msvcr120._set_printf_count_output
...
@ cdecl _setmaxstdio msvcr120._setmaxstdio
@ cdecl _setmbcp msvcr120._setmbcp
...
@ cdecl _strerror msvcr120._strerror
@ stub _strerror_s
...
@ cdecl _tell msvcr120._tell
@ cdecl -ret64 _telli64 msvcr120._telli64
...
@ cdecl _tolower msvcr120._tolower
@ cdecl _tolower_l(long ptr) msvcr120._tolower_l
@ cdecl _toupper msvcr120._toupper
...
@ cdecl _unlock msvcr120._unlock
...
@ cdecl _wcserror msvcr120._wcserror
...
@ cdecl fesetround msvcr120.fesetround
@ stub fetestexcept
@ stub feupdateenv
...
@ stub imaxabs
@ stub imaxdiv
@ cdecl isalnum msvcr120.isalnum
@ cdecl isalpha msvcr120.isalpha
@ cdecl isblank msvcr120.isblank
@ cdecl iscntrl msvcr120.iscntrl
@ cdecl isdigit msvcr120.isdigit
@ cdecl isgraph msvcr120.isgraph
@ cdecl isleadbyte msvcr120.isleadbyte
@ cdecl islower msvcr120.islower
@ cdecl isprint msvcr120.isprint
@ cdecl ispunct msvcr120.ispunct
@ cdecl isspace msvcr120.isspace
@ cdecl isupper msvcr120.isupper
@ cdecl iswalnum msvcr120.iswalnum
@ cdecl iswalpha msvcr120.iswalpha
@ cdecl iswascii msvcr120.iswascii
@ cdecl iswblank msvcr120.iswblank
@ cdecl iswcntrl msvcr120.iswcntrl
@ cdecl iswctype(long long) msvcr120.iswctype
@ cdecl iswdigit msvcr120.iswdigit
@ cdecl iswgraph msvcr120.iswgraph
@ cdecl iswlower msvcr120.iswlower
@ cdecl iswprint msvcr120.iswprint
@ cdecl iswpunct msvcr120.iswpunct
@ cdecl iswspace msvcr120.iswspace
@ cdecl iswupper msvcr120.iswupper
@ cdecl iswxdigit msvcr120.iswxdigit
@ cdecl isxdigit msvcr120.isxdigit
@ cdecl labs msvcr120.labs
...
@ cdecl strerror msvcr120.strerror
...
@ cdecl tolower msvcr120.tolower
@ cdecl toupper msvcr120.toupper
@ stub towctrans
@ cdecl towlower msvcr120.towlower
@ cdecl towupper msvcr120.towupper
