...
u16 pass1_1000_0e08(param_1: i16)
{
    u16 *puVar1;
    u8 *pbVar2;
    u16 uVar3;
...
i16 pass1_1000_3038(param_1: i16)
{
    u16 uVar1;
    u8 *puVar2;
    i16 iVar3;
...
u8 *pass1_1000_400a(param_1: i16)
{
    u8 *puVar1;
...
char *pass1_1000_472c(param_1: u32,
                      char param_2)
{
    char *pcVar1;
    u16 uVar2;
...
u16 pass1_1000_47a4(param_1: u32,
                    u32 param_2)
{
    u8 *pbVar1;
    u8 bVar2;
...
u16 pass1_1000_484c(param_1: u32,
                    param_2: u32,
                    u16 param_3)
{
    u8 *pbVar1;
...
u16 pass1_1000_48a8(param_1: u32,
                    param_2: u32,
                    param_3: i16)
{
    u16 *puVar1;
...
i16 pass1_1000_545a(param_1: u32,
                    u32 param_2)
{
    u8 *pbVar1;
    u8 bVar2;
...
u16 *pass1_1000_54a0(param_1: u32,
                     u16 param_2,
                     u16 param_3)
{
    u16 *puVar1;
