...
u16*  mixed_1010_20ba(param_1: u32,u16 param_2,u16 param_3,u8 *param_4,int param_5)
...
LAB_1010_2126:
      ...
      struct_1010_3b7a((astruct_648 *)paVar4,(u16)param_4,param_2);
    }
    break;
  case 2:
    ...
    win_sys_op_1010_5404((astruct_54 *)paVar4,(u16)param_4,param_2,param_3);
    break;
  case 3:
    mem_op_1000_179c(0x53c,param_4,0x1000);
    puVar3 = (u8 *)((uint)param_4 | (uint)paVar4);
    if (puVar3 == (u8 *)0x0) goto LAB_1010_2126;
    struct_1010_a1d8((astruct_627 *)paVar4,(u16)param_4,param_2,param_3);
    break;
  case 4:
  ...
  case 7:
    ...
    if (((uint)param_4 | (uint)paVar4) == 0) goto LAB_1010_2126;
    uVar11 = pass1_1010_3d82((astruct_628 *)paVar4,(u16)param_4,param_2,param_3);
  ...
  case 8:
    ...
    puVar3 = (u8 *)((uint)param_4 | (uint)paVar4);
    if (puVar3 == (u8 *)0x0) goto LAB_1010_2126;
    struct_1010_95aa((astruct_629 *)paVar4,(u16)param_4,param_2);
    break;
  case 9:
    mem_op_1000_179c(0x26,param_4,0x1000);
    puVar3 = (u8 *)((uint)param_4 | (uint)paVar4);
    if (puVar3 == (u8 *)0x0) goto LAB_1010_2126;
    struct_1010_6326((astruct_630 *)paVar4,(u16)param_4,param_2);
    break;
  case 10:
  ...
  case 0x2e:
    ...
    if (((uint)param_4 | (uint)paVar4) == 0) goto LAB_1010_2126;
    uVar11 = pass1_1018_1ff4((astruct_634 *)paVar4,(u16)param_4,param_2);
    puVar3 = (u8 *)(uVar11 >> 0x10);
    paVar4 = (astruct_636 *)uVar11;
    break;
  case 0x2f:
    ...
    puVar3 = (u8 *)((uint)param_4 | (uint)paVar4);
    if (puVar3 == (u8 *)0x0) goto LAB_1010_2126;
    struct_1010_e9e4((astruct_261 *)paVar4,(u16)param_4,param_2);
    break;
  case 0x30:
    mem_op_1000_179c(0xe,param_4,0x1000);
    if (((uint)param_4 | (uint)paVar4) == 0) goto LAB_1010_2126;
...
LAB_1010_2680:
      ...
      uVar11 = pass1_1010_9298((astruct_79 *)paVar4,(astruct_79 *)param_4,param_2,(u16)paVar4,
  ...
  case 0x32:
    ...
    puVar3 = (u8 *)((uint)param_4 | (uint)paVar4);
    if (puVar3 == (u8 *)0x0) goto LAB_1010_2126;
    pass1_1010_6abc((astruct_635 *)paVar4,(u16)param_4,param_2);
    break;
  case 0x33:
    mem_op_1000_179c(0x72,param_4,0x1000);
...
LAB_1010_25bb:
  ...
  case 0x36:
    ...
    puVar3 = (u8 *)((uint)param_4 | (uint)paVar4);
    if (puVar3 == (u8 *)0x0) goto LAB_1010_2126;
    pass1_1008_d790((astruct_647 *)paVar4,(u16)param_4,param_2,param_3);
    break;
  case 0x37:
  ...
  case 0x39:
    ...
    puVar3 = (u8 *)((uint)param_4 | (uint)paVar4);
    if (puVar3 == (u8 *)0x0) goto LAB_1010_2126;
    pass1_1010_4a8a((astruct_637 *)paVar4,(u16)param_4,param_2,param_3);
    break;
  case 0x3a:
  ...
  case 0x3b:
    ...
    puVar3 = (u8 *)((uint)param_4 | (uint)paVar4);
    if (puVar3 == (u8 *)0x0) goto LAB_1010_2126;
    struct_1008_dd4e((astruct_209 *)paVar4,(u16)param_4,param_2);
    break;
  case 0x3c:
    mem_op_1000_179c(0x146,param_4,0x1000);
    puVar3 = (u8 *)((uint)param_4 | (uint)paVar4);
    if (puVar3 == (u8 *)0x0) goto LAB_1010_2126;
    pass1_1018_331c((astruct_638 *)paVar4,(u16)param_4,param_2,param_3,puVar3);
    break;
  case 0x3d:
    mem_op_1000_179c(0xe,param_4,0x1000);
    if (((uint)param_4 | (uint)paVar4) == 0) goto LAB_1010_2126;
    uVar11 = pass1_1010_8c32((astruct_640 *)paVar4,(u16)param_4,param_2,param_3);
    puVar3 = (u8 *)(uVar11 >> 0x10);
    paVar4 = (astruct_636 *)uVar11;
    break;
  case 0x3e:
    ...
    puVar3 = (u8 *)((uint)param_4 | (uint)paVar4);
    if (puVar3 == (u8 *)0x0) goto LAB_1010_2126;
    pass1_1018_5070((astruct_641 *)paVar4,(u16)param_4,param_2);
    break;
  case 0x3f:
    mem_op_1000_179c(0x12,param_4,0x1000);
    puVar3 = (u8 *)((uint)param_4 | (uint)paVar4);
    if (puVar3 == (u8 *)0x0) goto LAB_1010_2126;
    pass1_1008_c72a((astruct_642 *)paVar4,(u16)param_4,param_2);
    break;
  case 0x40:
    mem_op_1000_179c(0x24,param_4,0x1000);
    puVar3 = (u8 *)((uint)param_4 | (uint)paVar4);
    if (puVar3 == (u8 *)0x0) goto LAB_1010_2126;
    pass1_1008_af94((astruct_643 *)paVar4,(u16)param_4,param_2);
    break;
  case 0x41:
    uVar2 = 0x60;
    mem_op_1000_179c(0x60,param_4,0x1000);
    ...
    uVar7 = 0x1008;
    struct_1008_ecb2((astruct_221 *)paVar4,(u16)param_4,param_2);
    puVar3 = extraout_DX;
LAB_1010_2683:
  ...
  case 0x43:
    mem_op_1000_179c(0x12,param_4,0x1000);
    if (((uint)param_4 | (uint)paVar4) == 0) goto LAB_1010_2126;
    puVar8 = pass1_1010_2bfc((astruct_644 *)paVar4,(u16)param_4,param_2);
    puVar3 = (u8 *)((u32)puVar8 >> 0x10);
    paVar4 = (astruct_636 *)puVar8;
    break;
  case 0x45:
    mem_op_1000_179c(0xe,param_4,0x1000);
    if (((uint)param_4 | (uint)paVar4) == 0) goto LAB_1010_2126;
    uVar11 = pass1_1010_0000((astruct_645 *)paVar4,(u16)param_4,param_2,param_3);
    puVar3 = (u8 *)(uVar11 >> 0x10);
    paVar4 = (astruct_636 *)uVar11;
    break;
  case 0x46:
    ...
    puVar3 = (u8 *)((uint)param_4 | (uint)paVar4);
    if (puVar3 == (u8 *)0x0) goto LAB_1010_2126;
    struct_1010_50b2((astruct_646 *)paVar4,(u16)param_4,param_2);
    break;
  case 0x47:
    mem_op_1000_179c(0xe,param_4,0x1000);
    if (((uint)param_4 | (uint)paVar4) == 0) goto LAB_1010_2126;
  ...
  case 0x48:
    ...
    puVar3 = (u8 *)((uint)param_4 | (uint)paVar4);
    if (puVar3 == (u8 *)0x0) goto LAB_1010_2126;
    unk_draw_op_1008_da12((astruct_19 *)paVar4,(u16)param_4,param_2);
  }
