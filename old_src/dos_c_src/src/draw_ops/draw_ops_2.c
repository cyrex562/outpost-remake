...
void  unk_draw_op_1018_cda8(astruct_36 *param_1, u16 param_2)
...
void  unk_draw_op_1018_cfc0(astruct_36 *param_1, u16 param_2)
...
void  draw_op_1020_9364(astruct_7 *param_1, HWND16 in_win_handle_2, u16 param_3)

{
    ...
    do
    {
        ...
        HStack50 = CreatePen16((u16)s_tile2_bmp_1050_1538, (u16)uVar4, (COLORREF)(uVar4 >> 0x10));
        HStack52 = SelectObject16((HDC16)s_tile2_bmp_1050_1538, HStack50);
        MoveToEx16((HDC16)s_tile2_bmp_1050_1538, (u16)local_38, param_3, *(POi1616 **)(uStack58 * 0x2 + puStack26));
        LineTo16((HDC16)s_tile2_bmp_1050_1538, (puStack26 + uStack58 * 0x2), (u16)uStack6);
        iVar3 = (iStack20 - uStack58) * 0x2;
        MoveToEx16((HDC16)s_tile2_bmp_1050_1538, (u16)local_38, param_3, *(POi1616 **)(iVar3 + puStack26));
        LineTo16((HDC16)s_tile2_bmp_1050_1538, (puStack26 + iVar3), (u16)uStack6);
    ...
    uStack6  = CONCAT22(uVar2, (u16)uStack6);
    ...
    do
    {
        ...
        MoveToEx16((HDC16)s_tile2_bmp_1050_1538, (u16)local_38, param_3, *(POi1616 **)((iVar5 + uStack46) * 0x2 + puStack26));
        LineTo16((HDC16)s_tile2_bmp_1050_1538, ((iStack20 - *piVar1) * 0x2 + puStack26), iVar3 + local_a.x);
        iVar3 = ((iStack22 - uStack58) * 0x2 + uStack42);
        MoveToEx16((HDC16)s_tile2_bmp_1050_1538, (u16)local_38, param_3, *(POi1616 **)(*piVar1 * 0x2 + puStack26));
        LineTo16((HDC16)s_tile2_bmp_1050_1538, ((iStack20 - *piVar1) * 0x2 + puStack26), iVar3 + local_a.x);
        SelectObject16((HDC16)s_tile2_bmp_1050_1538, HStack52);
        DeleteObject16((HGDIOBJ16)s_tile2_bmp_1050_1538);
        uStack58 = uStack58 - 0x1;
...
void  struct_1020_7554(u16 param_1, astruct_20 *param_2, u16 param_3, u16 param_4)
...
void  struct_1020_790e(u16 *param_1, param_2: u32, u16 param_3, param_4: u32, u16 param_5)
...
void  string_1020_79b4(u16 param_1, param_2: u32, i16 param_3, char *param_4)
...
void  pass1_1020_79e4(param_1: u32, u16 param_2, u16 param_3)
...
void  draw_op_1020_7cc8(param_1: u32, HWND16 in_win_handle_2, u16 param_3)

{
    ...
    if((is_iconic == 0x0) || (PTR_LOOP_1050_0010 != 0x0))
    {
        ...
        if(*count != '\0')
        {
            ...
            DVar6 = GetTextExtent16((HDC16)s_tile2_bmp_1050_1538, str, (u16)count);
            iVar3 = (DVar6 >> 0x10);
            if(is_iconic == 0x0)
            {
            ...
            TextOut16((HDC16)s_tile2_bmp_1050_1538, (u16)str, (u16)count, str_00, iStack66);
        }
...
void  unk_draw_op_1020_7f7a(astruct_20 *param_1, u16 param_2, u32 param_3)
...
void  realize_palette_1020_8128(param_1: u32, i16 param_2, HGDIOBJ16 param_3, u16 param_4)
...
void  mix_draw_op_1020_650c(astruct_7 *param_1, HWND16 param_2, u16 param_3)
...
void  realize_palette_1020_6896(param_1: u32, i16 param_2, HGDIOBJ16 param_3)
...
void  pass1_1020_68de(param_1: u32, u16 param_2)
...
void  destroy_icon_1020_6bd2(param_1: u32, u8 param_2, HICON16 param_3)
...
BOOL16  win_ui_op_1020_737a(param_1: u32, HWND16 param_2, u16 param_3)

{
    ...
    else
    {
        if(PTR_LOOP_1050_0010 == 0x0)
        {
            ...
            if(BVar4 != 0x0)
            {
                local_rect = (RECT16 *)GetStockObject16((u16)s_tile2_bmp_1050_1538);
...
void  unk_draw_op_1020_3da4(astruct_24 *param_1, u32 param_2)

{
    ...
    *(i1616_t *)(iVar8 + 0x1e)   = iVar4;
    HVar5                        = GetStockObject16((u16)s_tile2_bmp_1050_1538);
...
void  win_ui_palette_op_1020_3e84(astruct_16 *param_1)
...
void  validate_rect_1020_3f12(param_1: u32, i16 param_2, HWND16 param_3)
...
void  mixed_draw_op_1020_3fa0(param_1: u32, HWND16 param_2, u16 param_3)
...
void  draw_rect_1020_40ce(param_1: u32, i16 param_2, i16 param_3, u16 param_4)

{
    ...
    if((*(u8 *)(param_1 + 0xe) & 0x1) != 0x0)
    {
        ...
        handle = CreatePen16((u16)s_tile2_bmp_1050_1538, 0xf9, 0x100);
...
void  unk_draw_op_1020_41c8(astruct_20 *param_1, u16 param_2, u16 param_3, u16 param_4)
...
void  pass1_1020_2c72(param_1: u32, u16 param_2, u16 param_3)
...
void  load_draw_op_1020_2ede(u16 *param_1, param_2: u32, u16 param_3)

{
    ...
    *(HDC16 *)(iVar6 + 0x18) = HVar3;
    ...
    uVar1                        = (iVar6 + 0x14);
    uVar1                        = (uVar1 + 0x64);
    handle                       = CreatePen16((u16)s_tile2_bmp_1050_1538, (u16)uVar1, (COLORREF)(uVar1 >> 0x10));
...
void  invalidate_rect_1020_3080(param_1: u32, i16 param_2, HWND16 param_3)
...
void  draw_op_1020_30be(param_1: u32, HWND16 param_2, u16 param_3)

{
    ...
    else
    {
        if(PTR_LOOP_1050_0010 == 0x0)
        {
            ...
            if(iStack38 != 0x0)
            {
                pRStack40 = (RECT16 *)GetStockObject16((u16)s_tile2_bmp_1050_1538);
                GetClientRect16((HWND16)s_tile2_bmp_1050_1538, &local_30);
                local_3c = 0x0;
                iStack56 = (iStack44 - local_30.x) + -0x1;
...
void  unk_draw_op_1020_320e(param_1: u32, HDC16 param_2, u16 param_3)
...
void  draw_op_1020_33c0(param_1: u32, param_2: u32, i16 param_3, param_4: u32, i16 param_5, u16 param_6, u16 param_7)
...

{
    ...
    handle_00 = SelectObject16((HDC16)s_tile2_bmp_1050_1538, handle);
    HVar4     = GetStockObject16((u16)s_tile2_bmp_1050_1538);
...
void  draw_polygon_1020_3602(u16 param_1, u16 param_2, param_3: u32, HDC16 param_4)
...
void  pass1_1020_3bd6(param_1: u32, u16 param_2, u16 param_3, u16 param_4)
            ...
            *pbVar2 = *pbVar2 | bVar12;
            ...
            code_r0x10203db1:
                ...
                *(i1616_t *)(uVar7 + 0x1e)   = iVar15;
                uVar28                       = (param_4 + -0x2);
                HVar16                       = GetStockObject16((u16)s_tile2_bmp_1050_1538);
...
void  invalidate_rect_1020_1fb2(param_1: u32, i16 param_2, HWND16 param_3)
...
void  unk_draw_op_1020_2020(param_1: u32, HWND16 param_2, u16 param_3)

{
    ...
    *(HGDIOBJ16 *)(puVar14 + -0x40) = HVar8;
    ...
    if(HVar8 == 0x0)
    {
        ...
        HVar9                          = CreateSolidBrush16((COLORREF)s_tile2_bmp_1050_1538);
        *(HBRUSH16 *)(puVar14 + -0x3e) = HVar9;
        HVar7                          = CreatePen16((u16)s_tile2_bmp_1050_1538, 0xff, 0x0);
        *(HPEN16 *)(puVar14 + -0x3a)   = HVar7;
...
void  draw_line_1020_229c(param_1: u32, HDC16 param_2)
...
void  pass1_1020_239c(param_1: u32, i16 *param_2, u16 param_3)
...
void  draw_polygon_1020_2474(u16 param_1, u16 param_2, param_3: u32, HDC16 param_4)
...
void  struct_1020_2524(astruct_20 *param_1, u16 param_2, u16 param_3, u16 param_4)
