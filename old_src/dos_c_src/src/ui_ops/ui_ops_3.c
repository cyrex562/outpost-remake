...
void  win_ui_op_1040_0170(i16 param_1, u16 param_2, u16 param_3, param_4: u32, u16 param_5, WNDCLASS16 *param_6)
...
LRESULT  win_ui_op_1040_0558(param_1: u32, i16 param_2, HWND16 param_3)
...
void enable_win_1040_060e(param_1: u32, i16 param_2, HWND16 param_3, u16 param_4)
...
void  win_ui_op_1038_eaa2(param_1: u32, i16 param_2, HWND16 param_3, WPARAM16 param_4)
...
void  check_dlg_btn_checked_1038_cdd6(param_1: u32, i16 param_2, HWND16 param_3)
...

{
    ...
    if((uStack6._2_2_ != 0x0) && (uStack6 != 0x0))
    {
        ...
        if(BVar3 != 0x0)
        {
            ...
            pcVar7  = load_string_1010_847e(_PTR_LOOP_1050_14cc, (u16)(_PTR_LOOP_1050_14cc >> 0x10), 0x1010);
            hwnd_00 = (HWND16)s_tile2_bmp_1050_1538;
            SendDlgItemMessage16(0x1010, (u16)pcVar7, (pcVar7 >> 0x10), WVar8, CONCAT22(uStack6._2_2_, uVar9));
        }
    }
    if(iStack8 != 0x0)
    {
...
BOOL16  bring_win_to_top_1038_b72e(param_1: u32, i16 param_2, HWND16 in_win_handle_3)
...
u32  win_ui_op_1038_b922(u32 *param_1, param_2: u32, u16 param_3, u16 param_4, HWND16 param_5, WNDCLASS16 *param_6)
...
void  win_ui_cursor_op_1038_bc30(param_1: u32, HINSTANCE16 param_2, u16 param_3)
...
void  pass1_1038_be76(u16 param_1, param_2: u32, u8 *param_3, i16 param_4, u16 param_5)
