void  unk_win_op_1020_65cc(astruct_60 *param_1, i16 param_2, u16 param_3)
...
void  unk_win_ui_op_1020_67ce(astruct_20 *in_struct_1, u16 param_2, u32 param_3)
...
void  pass1_1020_687c(param_1: u32, u16 param_2, u16 param_3)
...
u16  unk_destroy_win_op_1020_694c(param_1: u32, u16 param_2, HWND16 param_3, u16 param_4)
    ...
    if(param_2 != 0x12b)
    {
        ...
        if(param_2 < 0x12c)
        {
            if(param_2 == 0x6f)
            {
                ...
                uVar2  = WinHelp16(0x1010, (s_New_failed_in_Op__Op_1050_0020 + 0x9), 0x0, CONCAT22(paVar5, 0x1));
                return uVar2;
            }
            if(param_2 == 0xeb)
            {
...
void  enable_menu_item_1020_6b9a(HMENU16 param_1, param_2: i16)
...
void  pass1_1020_6bbc(param_1: u32, u16 param_2, u16 param_3)
...
void  win_ui_fn_1020_6e98(param_1: u32, HWND16 in_win_handle, u16 param_3)

{
    ...
    {
        window_handle = CreateWindow16(0x1018, window_name, CONCAT22(globals->PTR_LOOP_1050_038c, window_name._2_2_), 0x1797, (iVar5 + 0x8), iStack4 + -0x19, IStack6, 0x0, 0x0, 0x103, 0x40a0);
        paVar2        = window_name;
        if(window_handle == 0x0)
        {
            if((window_name._2_2_ | window_name) != 0x0)
...
astruct_3 * pass1_1020_70c0(astruct_3 *param_1, u8 param_2, u16 param_3)
...
void  unk_win_ui_op_1020_717e(u16 *param_1, param_2: u32, u16 param_3)
...
void  pass1_1020_51c6(param_1: u32, u16 param_2, param_3: u32, u16 param_4, u16 param_5)
...
void  win_ui_cursor_op_1020_522e(astruct_52 *param_1, u16 param_2, u16 param_3)
...
void  pass1_1020_52de(param_1: u32, u16 param_2)
...
void  ui_op_1020_536e(param_1: u32, param_2: u32, i16 param_3, i16 param_4, u8 *param_5)
...
void  set_cursor_1020_5764(param_1: u32, i16 param_2, u16 param_3)
...
void  pt_in_rect_1020_5856(param_1: u32, POi1616 *param_2, u16 param_3)
...
void  pt_in_rect_op_1020_58ce(param_1: u32, u16 param_2, u16 param_3, u8 param_4, RECT16 *param_5, u16 param_6)
...
BOOL16  menu_ui_op_1020_5bf2(astruct_52 *param_1, HWND16 param_2, RECT16 *param_3)
...
void  win_ui_op_1020_5de8(param_1: u32, u16 param_2, u16 param_3, u16 param_4)
...

{
    ...
    if(puVar4 == 0x6b8)
    {
        ...
        {
            iVar5 = string_1040_8520(CONCAT13((puVar7 >> 0x8), CONCAT12(puVar7, puVar4)), globals->PTR_LOOP_1050_0396, 0x40, 0x2, 0x6b8, 0x6ad, puVar8, unaff_SS);
        }
    ...
    else
    {
        if(puVar4 == 0x6b4)
        {
            ...
            {
                iVar5 = string_1040_8520(CONCAT13((puVar7 >> 0x8), CONCAT12(puVar7, puVar4)), globals->PTR_LOOP_1050_0396, 0x40, 0x2, 0x57b, puStack18, puVar8, unaff_SS);
            }
            paStack38 = CONCAT22(puVar8, iVar5);
            uVar13    = 0xab;
            goto LAB_1020_5f84;
        ...
        if(puVar4 == 0x6b6)
        {
            load_string_1010_84e0(0x1010, globals->_PTR_LOOP_1050_14cc, (_PTR_LOOP_1050_14cc >> 0x10), 0x3ff, local_aa, (short)unaff_SS);
            load_string_1010_84e0(0x1010, globals->_PTR_LOOP_1050_14cc, (_PTR_LOOP_1050_14cc >> 0x10), 0x3ff, local_1aa, (short)unaff_SS);
        ...
        if(0x6b1 < puVar4)
        {
            ...
            {
                uVar12  = SUB42(&PTR_LOOP_1050_1040, 0x0);
                puVar10 = string_1040_8520(CONCAT13((puVar7 >> 0x8), CONCAT12(puVar7, puVar4)), globals->PTR_LOOP_1050_0396, 0x40, 0x2, 0x57b, puStack18, puVar8, unaff_SS);
            }
...
void  pass1_1020_6184(param_1: u32, u16 param_2, u16 param_3)
...
void  mixed_menu_op_1020_44ec(param_1: u32, u16 param_2, i16 param_3, HMENU16 param_4, HMENU16 param_5, u16 param_6)
...

{
    ...
    if(param_2 < 0xea)
    {
        ...
        case 0x77:
            ...
            WinHelp16(0x1010, uStack26, CONCAT11((undefined)(uStack26 >> 0xf), (undefined)(uStack26 >> 0xf)), CONCAT22(paStack18, 0x1));
            return;
        case 0x78:
    ...
    if(param_2 < 0x133)
    {
        if(param_2 == 0x102)
        {
            ...
            {
                uVar16 = 0x40;
                iVar4  = string_1040_8520(CONCAT22(param_3, param_2), globals->PTR_LOOP_1050_0396, 0x31, 0x2, 0x57b, 0x62b, puVar8, param_6);
            }
        ...
        if(param_2 < 0x103)
        {
            ...
            case 0x101:
                ...
                if(uStack22 == 0x0)
                {
                    ...
                    {
                        uVar16 = 0x40;
                        puVar5 = string_1040_8520(CONCAT22(puVar7, uStack22), globals->PTR_LOOP_1050_0396, 0x30, 0x2, 0x57b, 0x730, puVar8, param_6);
                    }
            ...
            if(param_2 != 0x106)
            {
                if(param_2 < 0x107)
                {
                    if(param_2 == 0x103)
                    {
                        ...
                        {
                            uVar16 = 0x40;
                            puVar5 = string_1040_8520(CONCAT22(puStack32, uStack34), globals->PTR_LOOP_1050_0396, 0x30, 0x2, 0x57b, 0x730, puVar8, param_6);
                        }
                    ...
                    else
                    {
                        ...
                        if(uStack34 != 0x0)
                        {
                            ...
                            {
                                uVar16 = 0x40;
                                iVar4  = string_1040_8520(CONCAT22(puStack32, uStack34), globals->PTR_LOOP_1050_0396, 0x31, 0x2, 0x57b, 0x62c, puVar8, param_6);
                            }
                        ...
                        {
                            uVar16 = 0x40;
                            puVar5 = string_1040_8520(CONCAT22(puStack32, uStack34), globals->PTR_LOOP_1050_0396, 0x30, 0x2, 0x57b, 0x731, puVar8, param_6);
                        }
...
BOOL16  enable_menu_item_1020_2c2a(HMENU16 param_1, param_2: i16)
...
void  win_ui_op_1020_2cf0(astruct *param_1)
...
void  win_ui_op_1020_36f6(param_1: u32, i16 param_2, short param_3)

{
    ...
    *puStack1034 = 0x0;
    load_string_1010_84e0(0x1010, globals->_PTR_LOOP_1050_14cc, (_PTR_LOOP_1050_14cc >> 0x10), 0x3ff, local_406, param_3);
    ...
    uVar3 = (uStack6 + 0xa);
    SetDlgItemText16((HWND16)s_tile2_bmp_1050_1538, (u16)uVar3, (SEGPTR)(uVar3 >> 0x10));
    uVar3 = (uStack6 + 0x12);
    SetDlgItemText16((HWND16)s_tile2_bmp_1050_1538, (u16)uVar3, (SEGPTR)(uVar3 >> 0x10));
    uVar3 = (uStack6 + 0xe);
    SetDlgItemText16((HWND16)s_tile2_bmp_1050_1538, (u16)uVar3, (SEGPTR)(uVar3 >> 0x10));
...
void  pass1_1020_3898(astruct_30 *param_1, u16 param_2)
...
void  window_op_1020_38aa(astruct *param_1)
