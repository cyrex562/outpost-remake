...
// }
//
// BOOL ScreenToClient(HWND hWnd, LPPOlpPoi16: i16)
//
//{
//     BOOL BVar1;
//
...
// }
//
// BOOL GetCursorPos(LPPOlpPoi16: i16)
//
//{
//     BOOL BVar1;
//
...
// }
//
// BOOL PeekMessageA(LPMSG lpMsg, HWND hWnd, wMsgFilterMin: u32, wMsgFilterMax: u32, u32 wRemoveMsg)
//
//{
//     BOOL BVar1;
//
...
//}
//
// void PostQuitMessage(nExitCode: i16)
//
//{
...
//}
//
// HWND CreateWindowExA(dwExStyle: u32, LPCSTR lpClassName, LPCSTR lpWindowName, dwStyle: u32, i16 X, i16 Y, i16 nWidth,
...
//}
//
// i16 GetDeviceCaps(HDC hdc, index: i16)
//
//{
//    i16 iVar1;
//
...
//}
//
// i16 WideCharToMultiByte(CodePage: u32, dwFlags: u32, LPCWSTR lpWideCharStr, i16 cchWideChar, LPSTR lpMultiByteStr,
...
//}
//
// i16 MultiByteToWideChar(CodePage: u32, dwFlags: u32, LPCSTR lpMultiByteStr, i16 cbMultiByte, LPWSTR lpWideCharStr,
//                        cchWideChar: i16)
//
//{
//    i16 iVar1;
