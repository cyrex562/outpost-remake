...
void  def_win_proc_1008_5632(u32 *param_1, WPARAM16 param_2, param_3: u16, param_4: i16, param_5: u16)

{
    ...
    if(((puStack6 >> 0x10) | puStack6) == 0x0)
    {
        ...
        puStack6 = *param_1;
        SetWindowLong16((HWND16)s_tile2_bmp_1050_1538, puStack6, puStack6 >> 0x10);
        pass1_1008_9628(puStack6, param_5);
    }
    ppcVar1 = (*puStack6 + 0x1c);
    (**ppcVar1)(s_tile2_bmp_1050_1538, puStack6, (puStack6 >> 0x10), param_1, param_2, param_3, param_4, uVar2);
    return;
}


void  pass1_1008_3bd6(astruct_160 *param_1, param_2: u16, param_3: u16, param_4: u32, param_5: u16, param_6: u32, param_7: u32, param_8: u16, param_9: u16)

{
    ...
    mov_update_win_1040_93aa((astruct_65 *)CONCAT22(param_2, param_1), param_4, (param_4 >> 0x10), &PTR_LOOP_1050_1040);
    return;
}
...
void  pass1_1008_0a92(param_1: u32, short param_2)
...
void  window_op_1008_0af8(astruct *param_1, mut param_2: *mut u8, param_3: u16)
...
BOOL16  mixed_win_op_1008_0c60(astruct_72 **param_1, param_2: u16, BOOL16 param_3, HWND16 param_4, param_5: u16, param_6: u16)
