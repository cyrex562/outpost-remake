...
use crate::win_platform::types::{CONTEXT, HGDIOBJ16, HGLOBAL16, HINSTANCE16, HTASK16, swi_0x21_fn_ptr};
...
pub fn swi(opcode: u8) -> u16
{
    unimplemented!()
}

pub fn swi_0x21() -> swi_0x21_fn_ptr
{
    unimplemented!()
}

pub fn WaitEvent16(h_task: HTASK16) -> bool
{
    unimplemented!()
}

pub fn InitApp16(h_instance: HINSTANCE16) -> i16
{
    unimplemented!()
}
...
pub fn LoadString16(instance: HINSTANCE16, resource_id: u16, buffer: &String, buf_len: u16) -> u16
{
    unimplemented!()
}
...
// HDC16                       BeginPai1616(HWND16 hwnd, PAINTSTRUCT16 *lps);
