...
use crate::defines::{
    Struct18, Struct19, Struct20, Struct37, Struct57, Struct76, Struct79, Struct87,
    Struct_1000_2cb0, Struct_1040_98c0,
};
...
use crate::pass::pass_1000::{
    pass1_1000_1f68, pass1_1000_25a8, pass1_1000_2913, pass1_1000_29af, pass1_1000_29b5,
    pass1_1000_29dc, pass1_1000_39e1, pass1_1000_3bac, pass1_1000_3e2c, pass1_1000_422a,
    pass1_1000_462e, pass1_1000_47a4, pass1_1000_4906, pass1_1000_5008, pass1_1000_55b1,
};
use crate::pass::pass_1008::{
    pass1_1008_3e94, pass1_1008_405c, pass1_1008_4772, pass1_1008_4d84, pass1_1008_5394,
    pass1_1008_5784, pass1_1008_57c4, pass1_1008_57f0, pass1_1008_5b12, pass1_1008_5bdc,
    pass1_1008_9628,
};
use crate::pass::pass_1010::{
    pass1_1010_1d80, pass1_1010_2024, pass1_1010_6034, pass1_1010_7e40, pass1_1010_8096,
};
use crate::pass::pass_1020::string_1020_c0d8;
use crate::pass::pass_1040::pass1_1040_b040;
use crate::string::string_1000::{
    str_op_1000_28dc, str_op_1000_3da4, string_1000_3cea, string_1000_3d3e, string_1000_475e,
};
...
use crate::struct_ops::struct_1008::{
    set_struct_1008_574a, set_struct_op_1008_0536, struct_1008_4c58, struct_op_1008_3f92,
    struct_op_1008_48fe,
};
...
use crate::win_platform::winapi::{swi, swi_0x21};
use crate::win_struct::{
    ATOM, HANDLE16, HDC16, HGLOBAL16, HINSTANCE16, HRSRC16, HWND16, LPARAM, MSG16, RECT16, SEGPTR,
    WNDCLASS16, WPARAM16,
};
use crate::winapi::{
    swi, wsprintf16, DOS3Call, DefWindowProc16, DeleteObject16, DispatchMessage16, FatalAppExit16,
    FatalExit, FindResource16, FreeProcInstance16, FreeResource16, GLobalAlloc16, GetClassInfo16,
    GetClientRect16, GetDC16, GetMessage16, GetPrivateProfileString16, GetProp16,
    GetSystemMetrics16, GetVersion16, GetWindowLong16, GlobalFree16, GlobalUnlock16,
    IsDialogMessage16, KillTimer16, LoadResource16, LoadString16, MakeProcInstance16, MessageBox16,
    RegisterClass16, ReleaseDC16, RemoveProp16, SetErrorMode16, SetProp16, SetWindowLong16,
    TranslateAccelerator16, TranslateMessage16, UpdateWindow16, WIN16_GlobalLock16,
    WIN16_LockResource16, WritePrivateProfileString16,
};

pub unsafe fn _SHI_INVOKEERRORHANDLER1(globals: &mut Globals) -> u16 {
    let mut i_var1: bool;
    let BVar2: bool;
    let u_var2: u16;
    let mut unaff_CS = 0u16;
    let pu32_var_5: *mut u32;
    let pu16_var_6: *mut u16;
    let u_var3: u16;

    u_var3 = globals.data_seg;
    pu16_var_6 = globals.data_seg;
    if (globals.PTR_LOOP_1050_5f1c | globals.PTR_1050_5f1a) == 0x0 {
        pu32_var_5 = ptr::null_mut();
        pu16_var_6 = ptr::null_mut();
    } else {
        i_var1 = mem_op_1000_21b6(globals.PTR_1050_5f1a, globals.PTR_LOOP_1050_5f1c);
        pu32_var_5 = globals.PTR_1050_5f1a;
        pu16_var_6 = globals.PTR_LOOP_1050_5f1c;
        if i_var1 == false {
            globals.PTR_1050_5f1a = &mut globals.PTR_1050_1f7e;
            globals.PTR_LOOP_1050_5f1c = &globals.PTR_LOOP_1050_1000;
            pu32_var_5 = &mut globals.PTR_1050_1f7e;
            pu16_var_6 = &mut globals.PTR_LOOP_1050_1000;
        }
    }
    if (pu16_var_6 | pu32_var_5) != 0x0 {
        BVar2 = msg_box_op_1000_1f24(&globals.PTR_1050_5f1a, globals.data_seg, 0x0, unaff_CS);
        if BVar2 == false {
            u_var2 = (*pu32_var_5)();
        } else {
            pu16_var_6 = ptr::null_mut();
...
pub fn dos3_call_1000_23ea(
    ...
    let uVar7: u16;
    let ppcVar8: u32;
    let mut pcVar9: swi_0x21_fn_ptr;
    let u_var10: u16;
    let bVar11: u8;
    let bVar12: u8;
    let uVar13: u16;
    ...
    if (true) {
        ...
        action = globals.s_tile2_bmp_1050_1538;
        DOS3Call(&globals.PTR_LOOP_1050_1000);
    }
...
pub fn sys_1000_30b4(
    ...
    i_var3 = param_4 + 0x1;
    u_var4 = SUB42(globals.data_seg, 0x0);
    exit_1000_25f2(
        ctx,
        0x30c5,
        param_7,
    ...
    if (bVar1 != 0x0) & &(true) {
        ...
        u_var3 = ((((bVar2 * 0x8) + 0x5ffe) >> 0x4) * 0x2 + 0x30a4)(
            param_5 & 0xff00 | bVar1,
            u_var4,
            i_var3,
        );
        return u_var3;
...
pub fn dos3_call_op_1000_35fe(param_1: u16, param_2: i16) -> u16 {
    ...
    if (param_1 < globals.DAT_1050_5f8a) {
        u_var2 = 0x3e50;
        u_var3 = 0x0;
        if (true) {
            pcVar1 = swi(0x21);
...
pub fn mixed_dos3_call_1000_3636(
    param_1: u16,
    param_2: u16,
    param_3: u16,
    param_4: u16,
    ...
    if (((param_1 < globals.DAT_1050_5f8a) || (globals.PTR_LOOP_1050_61ec == 0x0)) || (0x2 < param_1)) {
        ...
        if ((param_4 & 0x2) == 0x0) {
            ...
            u_var4 = SUB42(&globals.PTR_DAT_1050_0041_1050_4202, 0x0);
            if (true) {
                pcVar2 = swi(0x21);
                uVar9 = (*pcVar2)(iVar7);
            } else {
        ...
        //LAB_1000_369b:
        u_var3 = globals.s_471_bmp_1050_1600;
    } else {
        u_var3 = 0x900;
    }
    uVar8 = true;
    //LAB_1000_299d:
    if (uVar8) {
        pass1_1000_29b5(ctx, &mut u_var3);
    }
    return;
}
...
pub fn mixed_dos3_call_1000_370a(
    ...
    if ((param_3 & 0x8000) == 0x0)
        && ((param_3 & 0x4000) != 0x0 || ((globals.DAT_1050_6061 & 0x80) == 0x0))
    {
        bVar10 = 0x80;
    }
    uVar9 = SUB42(globals.data_seg, 0x0) as u16;
    u_var3 = CONCAT11(0x3d, (param_3 & 0x3 | param_4) as u8);
    uVar7 = 0x0;
    u_var6 = param_3;
    if true {
        pcVar1 = swi(0x21);
        uVar8 = (*pcVar1)(bVar10, param_4, globals.data_seg, param_6 + 0x1);
    } else {
        DOS3Call(&globals.PTR_LOOP_1050_1000);
    ...
    if (uVar7) {
        if ((u_var2 == 0x2) && ((u_var6 & 0x100) != 0x0)) {
            ...
            if (u_var5 < &globals.DAT_1050_5f8a) {
...
pub fn mixed_dos3_call_1000_39f2(
    ...
    uStack4 = SUB42(globals.data_seg, 0x0);
    piStack14 = globals.DAT_1050_5f8a;
    piVar7 = globals.DAT_1050_5f8a;
    if ((globals.PTR_LOOP_1050_61ec != 0x0)
        && (
            piVar7 = globals.PTR_s_ed_in_Op_Op_1050_0028_1050_5f8e,
            param_1 < (&globals.PTR_LOOP_1050_0002 + 0x1),
        ))
    {
        param_1 = globals.DAT_1050_5f8a;
    }
    if (piVar7 <= param_1) {
        uVar21 = true;
        piVar7 = 0x900;
    ...
    if ((param_1[0x5f90] & 0x20) != 0x0) {
        piVar7 = &globals.PTR_DAT_1050_0041_1050_4202;
        param_5 = 0x1000;
        uVar21 = 0x0;
        if (true) {
            pcVar4 = swi(0x21);
            ...
            param_5 = globals.s_tile2_bmp_1050_1538;
            DOS3Call(&globals.PTR_LOOP_1050_1000);
        }
        if (uVar21) {
            // goto LAB_1000_299d;
    ...
    if (((piVar16 + 0x2fc8) & 0x80) == 0x0) {
        ...
        uStack10 = SUB42(globals.data_seg, 0x0);
        bVar24 = true;
        uStack6 = 0x0;
        uStack8 = 0x0;
        ...
        if (param_3 != 0x0) {
            ...
            if (uVar8 < 0xa9) {
                ...
                if (bVar22) {
                    ...
                    if (true) {
                        pcVar4 = swi(0x21);
                        piVar10 = (*pcVar4)(globals.data_seg, puVar12, piVar16);
                    } else {
                        DOS3Call(&globals.PTR_LOOP_1050_1000);
                    }
                } else {
                ...
                uVar8 =
                    (cVar26 << 0x7 | cVar25 << 0x6 | param_7 << 0x4 | cVar23 << 0x2 | 0x2 | bVar22)
                        << 0x8;
...
pub fn mixed_dos3_call_1000_3ad9(
    ...
    if (bVar9) {
        ...
        if (true) {
            pcVar3 = swi(0x21);
            piVar6 = (*pcVar3)(globals.data_seg);
        } else {
            DOS3Call(&globals.PTR_LOOP_1050_1000);
        }
    } else {
...
pub fn sys_1000_3f9c(
    ...
    globals._USHORT_1050_68a8 = CONCAT22(param_2, param_1);
    globals.PTR_LOOP_1050_68ac = 0x7fff;
    u_var2 = sys_1000_30b4(
        ctx,
        &globals.USHORT_1050_68a8,
        globals.data_seg,
    ...
    if (globals.PTR_LOOP_1050_68ac < 0x0) {
        ...
        globals._USHORT_1050_68a8 = (globals._USHORT_1050_68a8 & 0xffff0000 | (globals.USHORT_1050_68a8 + 0x1));
        *pu_var1 = 0x0;
    }
    return u_var2;
}
...
pub fn mixed_sys_op_1000_40af(
    ...
    loop {
        ...
        if ((uVar7 | u_var6) != 0x0) {
            ...
            if ((HVar8 != 0x0) && ((uVar17 & 0x1) != 0x0)) {
                SVar9 = WIN16_GlobalLock16(globals.s_tile2_bmp_1050_1538);
                if ((SVar9 != 0x0) || (uVar7 == 0x0)) {
                    iVar16 = 0x12;
                    iVar10 = 0x12;
                    pass1_1000_25a8(ctx, param_5, globals.s_tile2_bmp_1050_1538);
                    pass1_1000_2913(ctx, iVar10, param_5, globals.s_tile2_bmp_1050_1538);
                ...
                HVar8 = pass1_1000_422a(ctx, uVar7, HVar8, globals.s_tile2_bmp_1050_1538, unaff_SS);
                if (HVar8 == 0x0) {
                    GlobalUnlock16(globals.s_tile2_bmp_1050_1538);
                    GlobalFree16(globals.s_tile2_bmp_1050_1538);
                    HVar8 = 0x0;
                }
            }
            param_4 = globals.s_tile2_bmp_1050_1538;
            if (HVar8 != 0x0) {
                puVar14 = 0x0;
                // TODO: refactor
        ...
        iVar10 = (*globals.PTR_LOOP_1050_618c)(param_4, param_3, param_1, param_2);
        if (iVar10 == 0x0) {
            return 0x0;
        }
    }
    ...
    pcVar13[-0x1] = '\0';
    //LAB_1000_28cb:
    FatalAppExit16(globals.s_tile2_bmp_1050_1538, str);
    FatalExit();
...
pub fn dos3_call_1000_4f20(param_1: u16) -> u16 {
    ...
    if (true) {
        pcVar1 = swi(0x21);
        u_var2 = (*pcVar1)(globals.data_seg, param_1 + 0x1);
    } else {
        DOS3Call(&globals.PTR_LOOP_1050_1000);
    }
    if (!u_var3) {
...
pub fn mixed_win_sys_op_1008_016e(ctx: &mut AppContext, param_1: u32, param_2: u16) {
    let ppcVar1: u32;
    let pu_var2: *mut u16;
    let i_var3: i16;
    ...
    let local_1be: [u8; 0x80];
    let local_13e: [u8; 0xac];
    let local_92: [u8; 0x80];
    let uStack18: u16;
    ...
    let puStack4: *mut u16;

    instance = globals.s_tile2_bmp_1050_1538;
    ...
    if (version_part_2 < 0x3) || (version_part_2 == 0x3 && (version_part_3 < 0xa)) {
        ...
        if (puVar6 == 0x0) {
            ...
            u_var10 = SUB42(&globals.PTR_LOOP_1050_1040, 0x0);
            i_var3 = string_1040_8520(
                CONCAT22(puVar7, version_part_2),
                0x0,
                0x10,
                0x2,
                0x5de,
    ...
    if ((uStack8 == 0x3) && (0xb < version_part_3)) {
        globals.PTR_LOOP_1050_0010 = (&globals.PTR_LOOP_1050_0000 + 0x1);
    }
    ...
    if (version_part_2 != 0x0) {
        ...
        LoadString16(globals.s_tile2_bmp_1050_1538, 0x80, local_1be, param_2);
        version_part_2 = MessageBox16(
            globals.s_tile2_bmp_1050_1538,
            &globals.PTR_LOOP_1050_0010,
            local_13e,
            param_2,
        );
        fn_ptr_op_1000_24cd(0x1, &stack0xfffe);
    ...
    if ((puVar7 | version_part_2) == 0x0) {
        ...
        uStack18 = version_part_2;
        puStack16 = puVar7;
        let mut var19: *mut u16; = CONCAT22(puVar7, version_part_2);
        puVar12 = pass1_1008_5394(&mut var19);
        // puVar6 = (puVar12 >> 0x10);
    ...
    u_var5 = (i_var3 + 0x8);
    pu_var2 = (i_var3 + 0x8);
    globals.PTR_LOOP_1050_0298 = u_var5;
    *pu_var2 = 0x70;
    (pu_var2 + 0x2) = globals.s_tile2_bmp_1050_1538;
    u_var10 = 0x1000;
    ...
    if (puVar7 != 0x0) {
        u_var10 = 0x1010;
        uVar13 = pass1_1010_2024(CONCAT13((puVar6 >> 0x8), CONCAT12(puVar6, version_part_2)));
        // puVar7 = (uVar13 >> 0x10);
        version_part_2 = uVar13;
    }
    if (globals.PTR_LOOP_1050_0ed0 == 0x0) {
    ...
    if (globals.PTR_LOOP_1050_14cc == 0x0) {
    ...
    puStack16 = puVar6;
    if (puVar7 != 0x0) {
        u_var10 = SUB42(&globals.PTR_LOOP_1050_1038, 0x0);
        paVar14 = pass1_1038_aeca(CONCAT22(puVar6, version_part_2), param_2);
        // puVar7 = (paVar14 >> 0x10);
        version_part_2 = paVar14;
    }
    if (globals.PTR_LOOP_1050_5b7c == 0x0) {
        debug_print_1008_6048(
            globals.s_New_failed_in_Op__Op__DialogCtr_1050_0053,
            u_var10,
            param_2,
        );
        fn_ptr_op_1000_24cd(0x1, &stack0xfffe);
    ...
    if (globals.PTR_LOOP_1050_5bc8 == 0x0) {
        debug_print_1008_6048(
            globals.s_New_failed_in_Op__Op__DialogHand_1050_0073,
            u_var10,
            param_2,
        );
        fn_ptr_op_1000_24cd(0x1, &stack0xfffe);
    ...
    if (globals.PTR_LOOP_1050_02a0 == 0x0) {
    ...
    u_var5 = (i_var3 + 0x4);
    globals.PTR_LOOP_1050_0396 = (u_var5 + 0x8);
...
pub fn kill_timer_1008_921c(param_1: *mut u16;, param_2: HWND16) {
    ...
    *param_1 = 0x9416;
    ...
    globals.PTR_LOOP_1050_0388 = 0x0;
...
pub fn win_msg_op_1008_9498(
    ...
    if (globals.PTR_LOOP_1050_5bc8 + 0x8) != 0x0 {
        // goto code_r0x100894cd;
    }
    //   TODO: goto LAB_1008_94dc;
    // code_r0x100894cd:
    in_msg_1 = globals.s_tile2_bmp_1050_1538;
    b_var1 = IsDialogMessage16(globals.s_tile2_bmp_1050_1538, &local_msg_1);
    if b_var1 == false {
        //LAB_1008_94dc:
        ...
        TranslateMessage16(globals.s_tile2_bmp_1050_1538);
        in_msg_1 = globals.s_tile2_bmp_1050_1538;
        DispatchMessage16(globals.s_tile2_bmp_1050_1538);
    }
...
pub fn unk_win_msg_op_1008_9510(
    ...
    return;
    // code_r0x10089538:
    param_2 = globals.s_tile2_bmp_1050_1538;
    has_message = IsDialogMessage16(globals.s_tile2_bmp_1050_1538, &local_14);
    if has_message == 0x0 {
        //LAB_1008_9547:
        if globals.PTR_LOOP_1050_0398 != 0x0 {
            param_2 = globals.s_tile2_bmp_1050_1538;
            IVar1 =
                TranslateAccelerator16(globals.s_tile2_bmp_1050_1538, (HACCEL16) & local_14, param_3);
            if IVar1 != 0x0 {
                // goto LAB_1008_9578;
            }
        }
...
pub fn get_sys_metrics_1010_46f6(param_1: u32) {
    ...
    puVar6 = mixed_1010_20ba(globals.PTR_LOOP_1050_0ed0, 0x48, unaff_SS, in_DX, unaff_DI);
    ...
    IVar2 = GetSystemMetrics16(globals.s_tile2_bmp_1050_1538);
    i_var3 = GetSystemMetrics16(globals.s_tile2_bmp_1050_1538);
    (i_var4 + 0x1e) = i_var3 + IVar2 + (uVar7 + 0x8);
    return;
}

pub fn win_sys_op_1010_5404(
    param_1: &mut Struct54,
    ...
    let extraout_dx: *mut u16;
    let puVar12: *mut u16;
    let extraout_DX_00: *mut u16;
    let extraout_DX_01: *mut u16;
    let puVar13: *mut u16;
    let puVar14: *mut u16;
    let unaff_DI: i16;
    let uVar15: u16;
    ...
    let mut string_12: String;
    let puVar19: *mut u16;
    let uVar20: u16;
    let local_134: [u8; 102];
    let puStack50: *mut u16;
    let uStack46: u16;
    let puStack44: *mut u16;
    let iStack42: i16;
    let iStack26: i16;
    ...
    string_12 = param_1.field_0xe;
    // uVar15 = (pcVar18 >> 0x10);
    puVar13 = (string_12 + uStack4);
    if (puVar13[-0x1] != '\\') {
        *puVar13 = 0x5c;
        string_12 = param_1.field_0xe;
        *(string_12 + uStack4 + 0x1) = 0x0;
    }
    string_12 = load_string_1010_847e(
        globals.PTR_LOOP_1050_14cc,
        (globals.PTR_LOOP_1050_14cc >> 0x10),
        0x1000,
    );
    // puVar12 = (pcVar18 >> 0x10);
    uStack8 = SUB42(string_12, 0x0);
    puStack6 = puVar12;
    string_1000_3cea(param_1.field_0xe, &mut string_12);
    string_2 = str_op_1008_60e8(param_1.field_0xe, puVar12);
    param_1.field_0xa = string_2;
    param_1.field_0xc = puVar12;
    string_12 = param_1.field_0xe;
    string_2 = globals.s_tile2_bmp_1050_1538;
    ...
    if (*param_1.field_0xe != '\0') {
        string_2 = &globals.PTR_LOOP_1050_1000;
        iStack22 = pass1_1000_3e2c(param_1.field_0xe);
        puVar19 = mixed_1010_20ba(globals.PTR_LOOP_1050_0ed0, 0x48, param_4, puVar12, unaff_DI);
    ...
    string_3 = globals.s_tile2_bmp_1050_1538;
    GetPrivateProfileString16(
        &string_2,
        u_var3,
        (u_var3 >> 0x10),
    ...
    if (*param_1.field_0xe != '\0') {
        string_3 = &globals.PTR_LOOP_1050_1000;
    ...
    string_12 = param_1.field_0xe;
    u_var3 = &param_1.field_0xa;
    index = globals.s_tile2_bmp_1050_1538;
    ...
    if (param_1.field_0x62 == 0x0) {
        uVar15 = SUB42(globals.s_tile2_bmp_1050_1538, 0x0);
        ...
        loop {
            ...
            if ((((puVar14[0x11] < 0x0) || (puVar14[0x12] < 0x0))
                || (
                    pi_var1 = puVar14 + 0x11,
                    *pi_var1 != iStack10 - uStack46 && (iStack10 - uStack46) <= *pi_var1,
                ))
                || (
                    puVar9 = (iStack12 - uStack46),
                    ppu_var2 = (puVar14 + 0x12),
    ...
    string_12 = param_1.field_0xe;
    pass1_1000_5008(string_12, (string_12 >> 0x10), 0x100, &stack0xfffe);
    uStack4 = str_op_1000_3da4(param_1.field_0xe);
    string_12 = param_1.field_0xe;
    // uVar15 = (pcVar18 >> 0x10);
    puVar13 = (string_12 + uStack4);
    ...
    if (*param_1.field_0xe != '\0') {
        string_12 = param_1.field_0xe;
        uVar15 = SUB42(string_12, 0x0);
        // uVar20 = (pcVar18 >> 0x10);
        while (
            uStack46 = pass1_1000_47a4(CONCAT22(uVar20, uVar15), 0x105013f8, param_4),
...
pub fn write_private_profile_str_1010_5b10(param_1: *mut u16;) {
    ...
    *param_1 = 0x6312;
    (iVar6 + 0x2) = 0x1010;
    puVar8 = mixed_1010_20ba(globals.PTR_LOOP_1050_0ed0, 0x48, unaff_SS, in_DX, unaff_DI);
    u_var3 = (iVar6 + 0xe);
    sys_1000_3f9c(
        ctx,
        u_var3,
    ...
    u_var3 = (iVar6 + 0xa);
    WritePrivateProfileString16(&globals.PTR_LOOP_1050_1000, u_var3, (u_var3 >> 0x10), &pCVar5);
    u_var3 = (iVar6 + 0xa);
    ...
    u_var3 = (iVar6 + 0xa);
    WritePrivateProfileString16(globals.s_tile2_bmp_1050_1538, u_var3, (u_var3 >> 0x10), &pCVar5);
    if ((iVar6 + 0x74) == 0x0) {
        pCVar5 = 0x13c8;
    } else {
        pCVar5 = 0x13c4;
...
pub fn get_sys_metrics_1018_1ea0(param_1: &mut Struct55, param_2: u16) {
    ...
    IVar1 = GetSystemMetrics16(globals.s_tile2_bmp_1050_1538);
    IVar2 = GetSystemMetrics16(globals.s_tile2_bmp_1050_1538);
...
pub fn mixed_sys_op_1018_2978(param_1: u32, param_2: u16, param_3: u16) {
    ...
    pass1_1010_8096(globals.PTR_LOOP_1050_14cc, 0x1);
    pu_var2 = local_2a;
    uStack6 = param_2;
    struct_op_1008_48fe(
        CONCAT22(param_3, pu_var2),
        0x1,
        CONCAT22(in_DX, param_2),
        in_DX,
    );
    uVar9 = 0x1000;
    ...
    if (u_var5 == 0x0) {
        ...
        pu_var3 = local_2a;
        uVar9 = 0x1008;
        struct_op_1008_3f92(CONCAT22(in_DX, pu_var2), CONCAT22(param_3, pu_var3));
    }
    ...
    if (puVar7 == 0x0) {
        ...
        struct_1008_4c58(CONCAT13((puVar6 >> 0x8), CONCAT12(puVar6, pu_var3)));
    }
    // uVar9 = (param_1 >> 0x10);
    i_var8 = param_1;
    (i_var8 + 0xe) = pu_var3;
...
pub fn sprintf_op_1018_34b6(param_1: u32, param_2: u8) {
    ...
    u_var3 = switch_1018_3b9e(
        param_1,
        (i_var2 + 0x12e),
        CONCAT31(in_register_00000001, param_2),
        in_DX,
        unaff_SS,
    );
    i_var1 = (i_var2 + 0x12e);
...
pub fn get_sys_metrics_1018_4b1e(param_1: &mut Struct55, param_2: u16, param_3: u16) -> u16 {
    ...
    (i_var1 + 0x12) = param_2;
    (i_var1 + 0x14) = 0x0;
    param_1.field_0x0 = &globals.PTR_LOOP_1050_4c9e;
    (i_var1 + 0x2) = 0x1018;
    if (globals.PTR_LOOP_1050_416c == 0x0) {
        globals.PTR_LOOP_1050_416c = GetSystemMetrics16(0x1010);
        globals.PTR_LOOP_1050_416e = GetSystemMetrics16(globals.s_tile2_bmp_1050_1538);
        globals.PTR_LOOP_1050_4170 = GetSystemMetrics16(globals.s_tile2_bmp_1050_1538);
    }
    return param_1;
}
...
pub fn make_proc_inst_1038_cf6c(param_1: *mut u16;, param_2: *mut u16;, param_3: *mut u16;) {
    let pvVar1: *mut u16;
    let i_var2: i16;
    let u_var3: u16;
    ...
    *param_1 = 0x389a;
    ...
    (i_var2 + 0x8) = 0x0;
    *param_1 = 0xd23e;
    (i_var2 + 0x2) = &globals.PTR_LOOP_1050_1038;
    globals.PTR_LOOP_1050_5bc8 = param_1;
    pvVar1 = MakeProcInstance16(param_3, globals.PTR_LOOP_1050_038c);
    (i_var2 + 0x4) = pvVar1;
    (i_var2 + 0x6) = param_2;
    globals.PTR_LOOP_1050_5bcc = MakeProcInstance16(globals.s_tile2_bmp_1050_1538, globals.PTR_LOOP_1050_038c);
...
pub fn free_proc_inst_1038_cfda(param_1: *mut u16;, param_2: *mut u16;) {
    let i_var1: i16;
    let u_var2: u16;
    ...
    i_var1 = param_1;
    *param_1 = 0xd23e;
    (i_var1 + 0x2) = &globals.PTR_LOOP_1050_1038;
    FreeProcInstance16(param_2);
    FreeProcInstance16(globals.s_tile2_bmp_1050_1538);
    (i_var1 + 0x4) = 0x0;
    *param_1 = 0x389a;
    (i_var1 + 0x2) = 0x1008;
    return;
...
pub fn call_win_proc_1038_d020(
    param_1: HWND16,
    param_2: u32,
    param_3: LPARAM,
    param_4: u16,
    ...
    uVar9 = SUB42(globals.data_seg, 0x0);
    uVar8 = param_3._2_2_;
    HVar2 = GetProp16(param_5, globals.s_procHi_1050_5bd7);
    uVar7 = param_3._2_2_;
    HVar3 = GetProp16(globals.s_tile2_bmp_1050_1538, globals.s_procLo_1050_5bd0);
    lStack6 = CONCAT22(HVar2, HVar3);
    u_var6 = param_3._2_2_;
    HVar2 = GetProp16(globals.s_tile2_bmp_1050_1538, globals.s_thisHi_1050_5be5);
    HVar3 = GetProp16(globals.s_tile2_bmp_1050_1538, globals.s_thisLo_1050_5bde);
    puStack10 = CONCAT22(HVar2, HVar3);
    wparam = (param_2 >> 0x10);
    if ((HVar2 | HVar3) != 0x0) {
        lStack14 = 0x0;
        if (param_3 == 0x19) {
            ppcVar1 = (*puStack10 + 0x34);
            lStack14 = (**ppcVar1)(
                globals.s_tile2_bmp_1050_1538,
                HVar3,
                HVar2,
            ...
            if (param_3 == 0x86) {
                ...
                u_var4 = (**ppcVar1)(globals.s_tile2_bmp_1050_1538, HVar3, HVar2, wparam);
                //         TODO: goto LAB_1038_d10e;
            }
            if ((param_3 == 0x112) & &((wparam & 0xfff0) == 0xf140)) {
                LVar5 = SendMessage16(globals.s_tile2_bmp_1050_1538, 0x0, 0x0, 0x112f140);
                u_var4 = (LVar5 == 0x0);
                //         TODO: goto LAB_1038_d10e;
            }
        }
    ...
    if lStack6 != 0x0 {
        LVar5 = CallWindowProc16(globals.s_tile2_bmp_1050_1538, param_1, param_2, wparam, param_3);
        return LVar5;
    }
    u_var4 = 0x0;
    //LAB_1038_d10e:
...
pub fn win_prop_op_1038_d118(
    ...
    uVar8 = SUB42(globals.data_seg, 0x0);
    uVar7 = param_3;
    HVar4 = GetProp16(param_5, globals.s_thisHi_1050_5bf3);
    u_var6 = param_3;
    HVar5 = GetProp16(globals.s_tile2_bmp_1050_1538, globals.s_thisLo_1050_5bec);
    puStack6 = CONCAT22(HVar4, HVar5);
    if (param_2._2_2_ == 0x30) {
        if (param_2 == 0x0) {
            return;
        }
        SetProp16(globals.s_tile2_bmp_1050_1538, param_2, 0x5c06);
        return;
    }
    if (param_2 < 0x310000) {
        // cVar3 = (param_2 >> 0x10);
        if (cVar3 == '\x02') {
            if ((HVar4 | HVar5) != 0x0) {
                ...
                if (puStack6 != 0x0) {
                    ppcVar1 = u_var2;
                    (**ppcVar1)(globals.s_tile2_bmp_1050_1538, HVar5, HVar4, 0x1);
                }
            }
            HVar4 = GetProp16(globals.s_tile2_bmp_1050_1538, 0x5bfa);
            if (HVar4 == 0x0) {
                return;
            }
            DeleteObject16(globals.s_tile2_bmp_1050_1538);
            RemoveProp16(globals.s_tile2_bmp_1050_1538, 0x5c00);
            return;
        }
        if (cVar3 == '\x06') {
            if ((param_2 != (&globals.PTR_LOOP_1050_0000 + 0x1))
                && (param_2 != &globals.PTR_LOOP_1050_0002))
            {
                u_var2 = &globals.PTR_LOOP_1050_5bc8;
                (u_var2 + 0x8) = 0x0;
                return;
            }
            u_var2 = &globals.PTR_LOOP_1050_5bc8;
    ...
    if ((HVar4 | HVar5) != 0x0) {
        ...
        (**ppcVar1)(globals.s_tile2_bmp_1050_1538, HVar5, HVar4, param_1, param_2);
    }
    return;
}

pub fn get_sys_metrics_1040_7728(
    ...
    param_1 = 0x840c;
    i_var2.field_0x2 = &globals.PTR_LOOP_1050_1040;
    string_1000_3d3e((param_1 & 0xffff0000 | &i_var2.field_0x10), 0x10505db0);
    pass1_1000_4906((param_1 & 0xffff0000 | &i_var2.field_0x7a), 0x0, 0x8);
    pass1_1000_4906((param_1 & 0xffff0000 | &i_var2.field_0x82), 0x0, 0x8);
...
pub fn get_sys_metrics_1040_8c66(param_1: &mut Struct37, param_2: HWND16) {
    ...
    i_var4 = param_1;
    hdc = GetDC16(param_2);
    draw_text_1040_8d14(ctx, param_1, globals.s_tile2_bmp_1050_1538);
    ...
    *pi_var1 = *pi_var1 + 0x30;
    ReleaseDC16(globals.s_tile2_bmp_1050_1538, hdc);
    return;
}
...
pub fn reg_class_1040_98c0(
    ...
    if b_result == false {
        ...
        AVar2 = RegisterClass16(&globals.s_tile2_bmp_1050_1538 as &WNDCLASS16);
        if AVar2 == 0x0 {
...
pub fn make_proc_inst_1040_a234(
    param_1: *mut u16;,
    param_2: *mut u16;,
    param_3: u16,
    param_4: u32,
    ...
    if (globals.PTR_LOOP_1050_5edc == 0x0) {
        pvVar1 = MakeProcInstance16(param_5, globals.PTR_LOOP_1050_038c);
        globals.PTR_LOOP_1050_5edc = CONCAT22(in_DX, pvVar1);
    }
    (param_1 + 0xc) = globals.PTR_LOOP_1050_5edc;
...
pub fn free_proc_inst_1040_a294(param_1: &mut Struct18, param_2: u16) {
    ...
    if (globals.PTR_LOOP_1050_5eda == 0x0) {
        FreeProcInstance16(param_2);
        globals.PTR_LOOP_1050_5edc = 0x0;
    }
    unk_draw_op_1040_b0f8(param_1);
    return;
}

pub fn call_win_proc_1040_a40e(
    param_1: HWND16,
    param_2: u32,
    param_3: LPARAM,
    param_4: u16,
    ...
    wparam = (param_2 >> 0x10);
    if (param_3 == 0x19) {
        puVar4 = &globals.PTR_LOOP_1050_5ee0;
        ppcVar2 = (*puVar4 + 0x34);
        uStack6 = (**ppcVar2)(
            param_5,
            puVar4,
        ...
        if (param_3 == 0x110) {
            uVar7 = win_msg_1040_a308(&globals.PTR_LOOP_1050_5ee0, unaff_DI, param_5, param_6);
            return uVar7;
        }
    }
    if (uStack6 != 0x0) {
    ...
    u_var5 = &globals.PTR_LOOP_1050_5bc8;
    // u_var6 = (u_var5 >> 0x10);
    iVar5 = u_var5;
    u_var1 = (iVar5 + 0x6);
    if ((u_var1 | (iVar5 + 0x4)) == 0x0) {
        return u_var1 << 0x10;
    }
...
unsafe fn def_win_proc_1008_5632(
    ...
    u_var2 = SUB42(globals.data_seg, 0x0) as u16;
    ...
    if ((pu_stack6 >> 0x10) | pu_stack6) == 0x0 {
        ...
        pu_stack6 = *param_1;
        SetWindowLong16(globals.s_tile2_bmp_1050_1538, pu_stack6, pu_stack6 >> 0x10);
