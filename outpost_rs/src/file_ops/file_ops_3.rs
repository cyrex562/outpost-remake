...
void pass1_1018_0000(param_1: u32, param_2: u32, param_3: i16, mut param_4: *mut u8, param_5: u16)
...
void write_to_file_1010_6372(param_1: u32, param_2: u32, param_3: u16)
...
void pass1_1010_68c6(param_1: u32, param_2: u32, param_3: u16, mut param_4: *mut u8, param_5: u16)
...
void file_1010_0c7c(param_1: u32, param_2: u32, param_3: i16, mut param_4: *mut u8, param_5: u16)
...
void file_1008_e70e(param_1: u32, param_2: u32, param_3: i16, mut param_4: *mut u8, param_5: u16, param_6: u16)
...
void pass1_1008_c9d4(param_1: u32, param_2: u32, param_3: i16, param_4: u16, longlong param_5)
...
void  file_1008_bb5e(param_1: u32, param_2: u32, param_3: i16, mut param_4: *mut u8, param_5: u16, param_6: u16)
...
u16 file_1008_77cc(param_1: u32, long *param_2, mut param_3: *mut u8, HFILE16 param_4, param_5: u16)
...
void  pass1_1008_7898(param_1: u32, u32 *param_2, param_3: u16, param_4: u16, HFILE16 param_5, param_6: u16)
...
u16  write_to_file_1008_7954(param_1: u32, u32 *param_2, param_3: u16, HFILE16 param_4, param_5: u16)
...
u16 write_to_file_1008_7b4c(param_1: u32, mut param_2: *mut u16, HFILE16 param_3, param_4: u16)
...
BOOL16 read_file_1008_7bc8(param_1: u32, mut param_2: *mut u16, HFILE16 param_3, param_4: u16)
...
void read_file_1008_7c6e(param_1: u16, param_2: u16, param_3: &mut String, HFILE16 param_4)
        ...
        for(uStack1040 = 0x0; uStack1040 < lVar3; uStack1040 = uStack1040 + 0x1)
        {
            if(local_406[uStack1040] == *_PTR_s_dcbSC_1050_0336_1050_033c)
            {
                ...
                if(uVar2 != 0x0)
                {
                    ...
                    _llseek16((HFILE16)s_tile2_bmp_1050_1538, lVar3 * 0x10000, (lVar3 >> 0x10));
                    return;
                }
            }
        }
...
BOOL16 file_fn_1008_6e02(u1632_t *param_1, LPCSTR in_string, param_3: u16)
...
BOOL16 read_file_1008_6e78(u1632_t param_1, param_2: u16, LPCSTR in_string, param_4: u16)
...

{
    ...
    uVar1    = (puVar2 >> 0x10);
    var5     = read_file_1028_d7ba(uStack10, (uStack10 >> 0x10), param_3, param_4, puVar2);
    if(var5 != 0x0)
    {
        ...
        if(var5 != 0x0)
        {
            ...
            if(var5 != 0x0)
            {
                ...
                if(i_var3 != 0x0)
                {
                    b_var4 = read_file_1020_a65e(CONCAT22(param_4, local_e), param_3, param_4, local_e);
                    if(b_var4 != 0x0)
                    {
                        return;
                    }
...
BOOL16 read_file_1008_7146(i1632_t param_1, param_2: u16, LPCSTR param_3, param_4: u16)
...
BOOL16 file_fn_1008_726c(u1632_t param_1, param_2: u16, HFILE16 file_handle)
