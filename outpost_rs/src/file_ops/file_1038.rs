use crate::{
    defines::{Struct307, U32Ptr},
    global::AppContext,
    mem_1000::mem_op_1000_179c,
    pass::{
        pass_1008::pass1_1008_766e,
        pass_1030::{file_1030_b836, pass1_1030_ae6c},
        pass_1038::struct_1038_6520,
    },
    switch_ops::switch_1008::switch_1008_72bc,
    util::{CONCAT22, ZEXT24},
};

use super::file_1008::{
    file_1008_77cc, read_file_1008_7bc8, read_file_1008_7cfe, read_file_1008_7dee,
};

pub fn file_1038_774e(
    ctx: &mut AppContext,
    param_1: u32,
    param_2: u32,
    param_3: U32Ptr,
    ...
    if (pu_var5 != 0x0) {
        ...
        if ((((((BVar2 != 0x0)
            && (
                i_var3 = file_1008_77cc(
                    param_2,
                    (param_1 & 0xffff0000 | &i_var2.field_0xe),
                    param_3,
                    0x1008,
                    param_4,
                ),
                ...
                BVar2 != 0x0
                    && (
                        BVar2 = read_file_1008_7dee(
                            u_var4, u_var6, &local_8, 0x0, param_4, 0x2, 0x1008,
                        ),
                        BVar2 != 0x0,
                    ),
            )))
                ...
                BVar2 != 0x0
                    && ((
                        BVar2 = read_file_1008_7bc8(
                            param_2,
                            (param_1 & 0xffff0000 | &i_var2.field_0x1a),
                            0x1008,
                            param_4,
                        ),
                        BVar2 != 0x0
...
pub fn read_file_1038_7c02(
        ...
        ))
    {
        while (local_4 != 0x0) {
            ...
            file_1038_774e(
                CONCAT22(pu_var5, u_var3),
                CONCAT22(uVar9, uVar7),
                pu_var5,
                unaff_SS,
            );
            if (u_var3 == 0x0) {
