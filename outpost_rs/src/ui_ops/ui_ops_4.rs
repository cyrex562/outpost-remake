...

{
    ...
    uStack6 = load_string_1010_847e(_PTR_LOOP_1050_14cc, (_PTR_LOOP_1050_14cc >> 0x10), 0x1010);
...
void  pass1_1038_c52a(param_1: u16, param_2: u32, mut param_3: *mut u8, param_4: i16, param_5: u16)
...

{
    ...
    SetDlgItemText16((HWND16)s_tile2_bmp_1050_1538, local_40c, (SEGPTR)param_2);
    return;
}
...
void  unk_win_ui_op_1038_a18c(astruct_1 *param_1, param_2: u16)
...
void  show_win_1038_a396(astruct_1 *param_1, param_2: u16, param_3: u16)
...
void  win_ui_op_1038_a4ee(astruct_1 *param_1, param_2: u16)
...
void  win_ui_op_1038_a584(param_1: u16, param_2: i16, HWND16 param_3, param_4: u16)

{
    ...
    if(param_2 != 0x0)
    {
        ...
        GetWindowText16((HWND16)s_tile2_bmp_1050_1538, 0x50, local_52);
...
void  win_ui_op_1038_a788(param_1: u32, param_2: i16, HWND16 param_3, param_4: u16)
...
void  enable_win_1038_a8f8(param_1: u16, param_2: u16, param_3: u16, TwoWords param_4, HWND16 in_hwnd_5)
...
Struct20 * pass1_1038_aeca(Struct20 *param_1, param_2: u16)
...
void  pass1_1038_89f8(param_1: i16, param_2: u16, param_3: u16, param_4: u32, mut param_5: *mut u8, param_6: u16)
...
void  msg_box_ui_op_1038_8a3a(param_1: u32, param_2: &mut String, mut param_3: *mut u8, param_4: u16)
...
void  pass1_1038_8d98(param_1: i16, param_2: u16, param_3: u16, param_4: u32, mut param_5: *mut u8, param_6: u16, param_7: u16)
...
void  msg_box_op_1038_8dda(param_1: u32, param_2: &mut String, mut param_3: *mut u8, param_4: u16)
...

{
    ...
    if(iVar1 == 0x0)
    {
        ...
        while(true)
        {
            ...
            SendDlgItemMessage16((HWND16)s_tile2_bmp_1050_1538, local_50c, param_3, 0x0, 0x185b0401);
        }
...
void  win_dlg_op_1038_9294(astruct_1 *param_1, param_2: u16)
...
BOOL16  send_dlg_item_i16_1038_94da(param_1: i16, param_2: u16, param_3: u16, param_4: u16, param_5: i16, HWND16 param_6, BOOL16 param_7)

{
    ...
    if((-0x1 < iStack8) && (UStack6 = GetDlgItemi1616(param_6, 0x1, &local_c, param_7), local_c != 0x0))
    {
        ...
        {
            SetDlgItemi1616((HWND16)s_tile2_bmp_1050_1538, 0x1, UStack6, (iVar2 + 0x5a72));
...
void  pass1_1038_7dc6(param_1: i16, param_2: u16, param_3: u16, param_4: u32, mut param_5: *mut u8, param_6: u16, param_7: u16, param_8: u16)
...

{
    ...
    if(LVar3 != -0x1)
    {
        ...
        SendDlgItemMessage16((HWND16)s_tile2_bmp_1050_1538, pcVar2, (pcVar2 >> 0x10), 0x0, 0x18540401);
...
u16  send_dlg_item_msg_1038_8164(param_1: u16, param_2: u16, mut param_3: *mut u8, param_4: u16, HWND16 param_5)

{
    ...
    *param_3 = '\0';
    ...
    if((LVar1 != -0x1) && (LVar1 = SendDlgItemMessage16((HWND16)s_tile2_bmp_1050_1538, param_3, (param_3 >> 0x10), (WPARAM16)LVar1, CONCAT22(param_4, 0x40a)), LVar1 != -0x1))
    {
        return 0x1;
    }
    return 0x0;
...
void  msg_box_op_1038_81be(param_1: u32, param_2: &mut String, mut param_3: *mut u8, param_4: u16)
...
void  set_win_text_1038_8358(param_1: u32, HWND16 param_2, param_3: u16)
...

{
    ...
    while(true)
    {
        ...
        if(lVar2 == 0x0)
            break;
        uVar1 = (lVar2 + 0x4);
        SendDlgItemMessage16(0x1008, uVar1, (uVar1 >> 0x10), 0x0, CONCAT22(param_4, 0x401));
    }
    return;
}


LRESULT  send_dlg_item_msg_1038_844a(param_1: u32, HWND16 param_2, param_3: u16)
...

{
    ...
    if(uVar2 != 0x0)
    {
        ...
        LVar4 = SendDlgItemMessage16(0x1008, uVar3, (uVar3 >> 0x10), 0xffff, 0x1856040d);
        uVar2 = LVar4;
    }
    return uVar2;
}
...
void  pass1_1020_de32(param_1: u32, param_2: u16, mut param_3: *mut u8, param_4: i16, param_5: u16)
...
void  pass1_1020_8bcc(param_1: u32, param_2: u16)
...

{
    ...
    if(uStack6 != 0x0)
    {
        ...
        if((param_5 | uStack6) != 0x0)
        {
            ...
            InvalidateRect16(0x1008, 0x0, (BOOL16)&local_48);
...
void  set_struct_op_1020_921c(astruct_42 *param_1, param_2: u16)
...

{
    ...
    TrackPopupMenu16((HMENU16)s_tile2_bmp_1050_1538, 0x0, 0x0, (iVar2 + 0x8), 0x0, local_6.y, local_6.x);
    return;
}
