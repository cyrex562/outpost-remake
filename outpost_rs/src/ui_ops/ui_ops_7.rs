...
void  win_ui_cursor_op_1008_2e9a(astruct_72 **param_1, param_2: u16)

{
    ...
    if(local_102[0] != '\0')
    {
        ...
        win_ui_op_1008_1414(param_1, CONCAT22(param_2, local_102), s_tile2_bmp_1050_1538, param_2, in_AF, uVar3);
        SetCursor16((HCURSOR16)s_tile2_bmp_1050_1538);
    }
    return;
}

void  pass1_1008_3018(param_1: u32, mut param_2: *mut u8, param_3: i16, param_4: u16)
...
void  menu_ui_op_1008_09ba(param_1: u32, HWND16 param_2, RECT16 *param_3, HWND16 param_4)

{
    ...
    TrackPopupMenu16((HMENU16)s_tile2_bmp_1050_1538, 0x0, 0x0, PTR_LOOP_1050_0396, 0x0, local_6.y, local_6.x);
    return;
}
...
void  message_box_op_1008_12dc(param_1: u32, param_2: u32, HINSTANCE16 param_3, param_4: u16)
...
void  win_ui_op_1008_1414(astruct_72 **param_1, param_2: u32, LPCSTR param_3, param_4: u16, param_5: u8, param_6: u16)
...
void  cleanup_ui_op_1008_0618(mut param_1: *mut u16)
...
void  win_ui_cursor_op_1008_06c0(u32 *param_1, param_2: u32, param_3: u16, param_4: i16)
...
BOOL16 msg_box_op_1000_1f24(param_1: i16, param_2: u16, param_3: u16, param_4: u16)
...
BOOL16  pass1_1000_1f7e(mut param_1: *mut u16, param_2: u16)
