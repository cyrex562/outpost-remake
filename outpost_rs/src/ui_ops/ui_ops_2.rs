...
void  show_win_1040_3ae8(astruct_1 *param_1, param_2: u16)
...
void  dialog_item_ui_op_1040_3e08(astruct_2 *in_struct_1, param_2: u16)
...
void  win_ui_op_1040_410e(astruct_1 *param_1, param_2: u16, mut param_3: *mut u8)
...
void  win_ui_op_1040_42b2(param_1: u32, param_2: i16, HWND16 param_3, WORD *param_4)
...
void  pass1_1040_477e(astruct_1 *param_1, mut param_2: *mut u8, param_3: u16, param_4: u16)
...
u32  win_ui_op_1040_2512(u32 *param_1, param_2: u32, param_3: u16, HWND16 param_4, WNDCLASS16 *param_5, mut param_6: *mut u8)
...
void  dlg_ui_op_1040_2a64(astruct_1 *param_1, param_2: u16, param_3: u16)
    ...
    for(iStack14 = 0x0; iStack14 < iStack4; iStack14 = iStack14 + 0x1)
    {
        ...
        else
        {
            ...
            if(uVar3 != 0x0)
            {
                ...
                uVar1                         = (iVar6 + 0x98);
                SetDlgItemText16((HWND16)&USHORT_1050_1028, uVar1, (SEGPTR)(uVar1 >> 0x10));
                hwnd = (HWND16)s_tile2_bmp_1050_1538;
            }
        }
    }
    ...
    if(param_4._2_2_ == 0x158)
    {
        ...
        if(PTR_LOOP_1050_5d04 == 0x0)
        {
            for(iStack8 = 0x1; iStack8 < 0x5; iStack8 = iStack8 + 0x1)
            {
                ...
                SetDlgItemText16((HWND16)s_tile2_bmp_1050_1538, uVar2, (SEGPTR)(uVar2 >> 0x10));
            }
            uVar2 = (param_1 + 0x94);
            goto LAB_1040_2ccc;
        }
...
void  win_dlg_item_1040_2d48(param_1: u32, HWND16 param_2, BOOL16 param_3)
...
void  pass1_1040_0e86(Struct18 *param_1, param_2: u16)
...
void  set_win_pos_1040_0f10(HWND16 param_1, param_2: u16, param_3: i16)

{
    ...
    if((iVar3 + 0x98) == 0x0)
    {
        ...
        GetWindowRect16((HWND16)s_tile2_bmp_1050_1538, (param_3 + -0x2c));
        piVar1            = (param_3 + -0x20);
    ...
    GetWindowRect16((HWND16)s_tile2_bmp_1050_1538, (param_3 + -0xc));
...
void  win_ui_op_1040_12bc(astruct_1 *param_1, param_2: u16, mut param_3: *mut u8)

{
    ...
    SendMessage16((HWND16)s_tile2_bmp_1050_1538, 0x0, 0xffff, 0x4010000);
    move_win_1040_826c(param_1, -0x1, 0xffff);
    pcVar4 = load_string_1010_847e(_PTR_LOOP_1050_14cc, (_PTR_LOOP_1050_14cc >> 0x10), 0x1010);
...
void  win_msg_op_1040_13b2(param_1: u32, param_2: i16, HWND16 param_3, param_4: u16)

{
    ...
    if(param_2 != 0x0)
    {
        ...
        pcStack260 = load_string_1010_847e(_PTR_LOOP_1050_14cc, (_PTR_LOOP_1050_14cc >> 0x10), 0x1010);
        puVar6     = local_aa;
...
void  unk_win_ui_op_1040_19ea(astruct_32 *param_1, param_2: i16, HWND16 param_3)
...
void  unk_win_ui_op_1040_1d7a(astruct_33 *param_1, param_2: i16, HWND16 param_3)
...
void  create_win_1040_20d4(param_1: u16, param_2: u16, param_3: u16, astruct_1 *param_4)
...

{
    ...
    while(iVar7 = (param_2 + -0x6), piVar1 = (param_2 + -0x8), *piVar1 == iVar7 || *piVar1 < iVar7)
    {
        ...
        *(astruct_160 **)(param_2 + -0x24) = rect;
        ...
        {
            uVar2 = (param_2 + -0x18);
            enable_win_1040_9234(*(iVar7 + iVar8), (uVar2 + 0x6), &PTR_LOOP_1050_1040);
        }
        piVar1  = (param_2 + -0x8);
        *piVar1 = *piVar1 + 0x1;
    }
