...
void win_ui_op_1040_ae04(param_1: u32, WORD *param_2)
...
void msg_box_ui_op_1040_ad66(param_1: u32, param_2: &mut String, mut param_3: *mut u8, param_4: u16)
...
void pass1_1040_ad24(param_1: i16, param_2: u16, param_3: u16, param_4: u32, mut param_5: *mut u8, param_6: u16, param_7: u16)
...
void win_ui_dlg_op_1040_a94a(param_1: u32, param_2: u16)
...
void msg_box_op_1040_a85a(param_1: u32, param_2: &mut String, mut param_3: *mut u8, param_4: u16)
...
void unk_win_ui_op_1040_b230(astruct_1 *param_1, param_2: u16, param_3: u16)
...
void pass1_1040_b54a(param_1: i16, param_2: u16, param_3: u16, param_4: u32, mut param_5: *mut u8, param_6: u16, param_7: u16)
...
void destroy_window_1040_b726(u32 *param_1, param_2: i16, HWND16 in_win_handle_3)
...
void pass1_1040_c5ac(mut param_1: *mut u16)
...
void win_ui_op_1040_bbe2(param_1: i16, param_2: u16, param_3: u16, param_4: u32, HWND16 param_5, param_6: u16)
...
void win_ui_1040_b8d2(astruct_1 *param_1, param_2: u16, param_3: u16, param_4: u16)
...
u16 pass1_1040_b864(u32 *param_1, i16 *param_2, param_3: u16, param_4: u16, param_5: i16, param_6: u16)
...
void pass1_1040_b4c8(param_1: u32, mut param_2: *mut u8, param_3: i16, param_4: u16)
...
void win_ui_op_1040_d2ac(param_1: i16, param_2: u16, param_3: u16, param_4: u32, param_5: u16, param_6: u16, param_7: u16)
...
void msg_box_op_1040_d3d0(param_1: u32, param_2: &mut String, mut param_3: *mut u8, param_4: u16)
...
void send_dlg_item_1040_ce76(param_1: u32, HWND16 param_2, param_3: u16)

{
    ...
    if(WStack6 != 0xffff)
    {
        SendDlgItemMessage16((HWND16)s_tile2_bmp_1050_1538, local_106, param_3, WStack6, 0x1842040a);
...

{
    ...
    while(true)
    {
        ...
        SendDlgItemMessage16((HWND16)s_tile2_bmp_1050_1538, local_10a, param_5, 0x0, CONCAT22(param_4, 0x401));
    }
    return;
}
...
void msg_box_op_1040_cce4(param_1: u32, param_2: &mut String, mut param_3: *mut u8, param_4: u16)
...
void pass1_1040_cc8c(param_1: i16, param_2: u16, param_3: u16, param_4: u32, mut param_5: *mut u8, param_6: u16, param_7: u16)
...
void win_ui_op_1040_cace(param_1: u32, HWND16 param_2, param_3: u16)
...
void pass1_1040_caa6(param_1: u16, param_2: u32, mut param_3: *mut u8, param_4: i16, param_5: u16)
...
void get_dlg_item_1040_a3d0(param_1: u32, HWND16 param_2)
...
void load_icon_1040_8b92(param_1: u32, HINSTANCE16 param_2)
...

{
    ...
    if(handle != 0x0)
    {
        HStack8 = SelectObject16(s_tile2_bmp_1050_1538, handle);
    }
    DrawText16(s_tile2_bmp_1050_1538, 0x410, &iVar3->field_0x9e, rect, 0xffff);
    if(HStack8 != 0x0)
    {
        SelectObject16(s_tile2_bmp_1050_1538, HStack8);
    }
    return;
}
...
void create_window_1040_92dc(param_1: u32, param_2: u16)

{
    ...
    if((str_00 + 0x18) == 0x0)
    {
        ...
        *(HWND16 *)(str_00 + 0x18) = HVar1;
        lVar2                      = SetWindowLong16((HWND16)s_tile2_bmp_1050_1538, _PTR_LOOP_1050_5e18, CONCAT22(0xfffc, (_PTR_LOOP_1050_5e18 >> 0x10)));
        str                        = (lVar2 >> 0x10);
        (str_00 + 0x14)            = lVar2;
...
void mov_update_win_1040_93aa(astruct_65 *param_1, param_2: u16, param_3: u16, HWND16 param_4)
...
i16 string_1040_8520(Struct57 *param_1, param_2: u16, param_3: u16, param_4: i16, param_5: u16, param_6: u16, mut param_7: *mut u8, param_8: u16)
...
Struct18 *pass1_1040_83e6(Struct18 *param_1, param_2: u8, param_3: u16)
...
void move_win_1040_826c(astruct_1 *param_1, param_2: u16, BOOL16 param_3)
...
void menu_ui_op_1040_7f86(param_1: u32, HWND16 param_2, RECT16 *param_3)

{
    ...
    TrackPopupMenu16((HMENU16)s_tile2_bmp_1050_1538, 0x0, 0x0, (iVar2 + 0x6), 0x0, local_6.y, local_6.x);
    return;
}


u16 pass1_1040_79c0(u32 *param_1, i16 *param_2, param_3: u16, param_4: u16, param_5: u16)
...

{
    ...
    *(HWND16 *)&local_struct_1->field_0x6 = dialog_handle;
    GetWindowText16((HWND16)s_tile2_bmp_1050_1538, 0x50, &local_struct_1->max_count_field_0x10);
    lVar3 = GetWindowLong16((HWND16)s_tile2_bmp_1050_1538, -0x4);
    SetWindowLong16((HWND16)s_tile2_bmp_1050_1538, _PTR_LOOP_1050_5bcc, CONCAT22(0xfffc, (_PTR_LOOP_1050_5bcc >> 0x10)));
...
void msg_box_ui_op_1040_64ca(param_1: u32, param_2: &mut String, mut param_3: *mut u8, param_4: u16)
...
void show_win_1040_65ba(astruct_1 *param_1, param_2: u16)

{
    ...
    for(iStack10 = 0x1; iStack10 <= uStack8; iStack10 = iStack10 + 0x1)
    {
        ...
        {
            unaff_DI = puStack26;
            enable_win_1040_9234(*(iVar5 + iStack10 * 0x4), (unaff_DI + 0x6), hwnd);
        }
    }
...
void post_win_msg_1040_672e(param_1: i16, param_2: u16, param_3: u16, param_4: u32, param_5: u16, param_6: u16)
...

{
    ...
    if(param_2 == 0x8)
    {
        ...
        uVar1 = (param_1 + 0x94);
        EnableWindow16((HWND16)s_tile2_bmp_1050_1538, (uVar1 + 0x24));
        GetDlgItem16((HWND16)s_tile2_bmp_1050_1538, 0x108);
        uVar1 = (param_1 + 0x94);
        EnableWindow16((HWND16)s_tile2_bmp_1050_1538, (uVar1 + 0x26));
    }
    return;
}


void mixed_win_ui_op_1040_6942(astruct_1 *param_1, param_2: u16, param_3: u16)
...
u16 pass1_1040_7044(u32 *param_1, i16 *param_2, param_3: u16, param_4: u16, param_5: i16, param_6: u16)
...
void mixed_win_ui_op_1040_70b4(astruct_1 *param_1, param_2: u16, param_3: u16)
...
void pass1_1040_57d4(astruct_1 *param_1, mut param_2: *mut u8, param_3: i16, param_4: u16, param_5: u16)
