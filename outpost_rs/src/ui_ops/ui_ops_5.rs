void  unk_win_op_1020_65cc(astruct_60 *param_1, param_2: i16, param_3: u16)
    ...
    else
    {
        if(((0x0 < param_2 + -0x3) && (!SBORROW2(param_2 + -0x3, 0x1))) && (param_2 + -0x4 < 0x4))
        {
            ...
            if(BVar3 == 0x0)
            {
                ...
                {
                    InvalidateRect16((HWND16)s_tile2_bmp_1050_1538, 0x0, 0x0);
...
void  unk_win_ui_op_1020_67ce(Struct20 *in_struct_1, param_2: u16, param_3: u32)
...
u16  unk_destroy_win_op_1020_694c(param_1: u32, param_2: u16, HWND16 param_3, param_4: u16)
...
void  win_ui_op_1020_6ae6(u32 *param_1, param_2: u16, param_3: i16, param_4: i16, HWND16 param_5, WPARAM16 param_6)
...
void  enable_menu_item_1020_6b9a(HMENparam_1: u16, param_2: i16)
...
void  win_ui_fn_1020_6e98(param_1: u32, HWND16 in_win_handle, param_3: u16)
    ...
    if((window_name._2_2_ | window_name) != 0x0)
    {
        ...
        else
        {
            ...
            if((window_name + 0x4) == 0x0)
            {
                uVar9  = 0x0;
                uVar10 = 0x401;
                pcVar8 = load_string_1010_847e(_PTR_LOOP_1050_14cc, (_PTR_LOOP_1050_14cc >> 0x10), 0x1010);
...
void  unk_win_ui_op_1020_717e(mut param_1: *mut u16, param_2: u32, param_3: u16)
...
void  win_ui_cursor_op_1020_522e(astruct_52 *param_1, param_2: u16, param_3: u16)
...
void  ui_op_1020_536e(param_1: u32, param_2: u32, param_3: i16, param_4: i16, mut param_5: *mut u8)
...
void  set_cursor_1020_5764(param_1: u32, param_2: i16, param_3: u16)
...

{
    ...
    TrackPopupMenu16((HMENU16)s_tile2_bmp_1050_1538, 0x0, 0x0, iVar5->field_0x8, 0x0, local_10.y, local_10.x);
    return 0x1;
}
...
void  win_ui_op_1020_5e76(param_1: u32, param_2: u16, param_3: u16)
...
void  pass1_1020_434c(param_1: i16, param_2: u16, u32 *param_3, param_4: u16, param_5: u16, param_6: i16, param_7: u16, param_8: u16)
...

{
    ...
    if((iVar10 + 0x106) != 0x0)
    {
        if(*(HMENU16 *)(iVar10 + 0x106) == param_4)
        {
            ...
            if(BVar4 != 0x0)
            {
                uStack296 = load_string_1010_847e(_PTR_LOOP_1050_14cc, (_PTR_LOOP_1050_14cc >> 0x10), 0x1010);
...
void  win_sys_op_1020_493c(u32 *param_1, param_2: u16, mut param_3: *mut u8, param_4: u16, HCURSOR16 param_5, WNDCLASS16 *param_6)
...
BOOL16  enable_menu_item_1020_2c2a(HMENparam_1: u16, param_2: i16)
...

{
    ...
    SelectObject16(s_tile2_bmp_1050_1538, iVar1->field_0x1e);
    DeleteObject16(s_tile2_bmp_1050_1538);
    SelectPalette16(s_tile2_bmp_1050_1538, 0x0, iVar1->field_0x20);
    DeleteObject16(s_tile2_bmp_1050_1538);
...
Struct18 * pass1_1020_3616(Struct18 *param_1, param_2: u8, param_3: u16)
...

{
    ...
    *puStack1034 = 0x0;
    ...
    uVar3 = (uStack6 + 0xa);
    SetDlgItemText16((HWND16)s_tile2_bmp_1050_1538, uVar3, (SEGPTR)(uVar3 >> 0x10));
    uVar3 = (uStack6 + 0x12);
    SetDlgItemText16((HWND16)s_tile2_bmp_1050_1538, uVar3, (SEGPTR)(uVar3 >> 0x10));
    uVar3 = (uStack6 + 0xe);
    SetDlgItemText16((HWND16)s_tile2_bmp_1050_1538, uVar3, (SEGPTR)(uVar3 >> 0x10));
...
void  pass1_1020_3898(astruct_30 *param_1, param_2: u16)
...

{
    ...
    uVar8  = MoveWindow16(HVar9, 0x1, &paVar3->field_0x6, &paVar3->field_0x4, puVar7, paVar3);
    HVar9  = 0x1000;
