...
use crate::util::{read_string_from_addr, read_struct_from_addr, CONCAT22};
use crate::win_struct::CONTEXT;
use crate::winapi::{swi, DOS3Call};

pub fn call_fn_ptr_1000_0dc6(ctx: &mut AppContext, param_1: &mut Struct18, param_3: u16) -> bool {
...
pub fn fn_ptr_op_1000_1708(
    ...
    //LAB_1000_1724:
    loop {
        if (param_6 | param_4) != 0x0 {
            l_var3 = mem_op_1000_0a48(ctx, param_3 as u8, *param_1 as u16, param_6, 0);
            if l_var3 != 0x0 {
                return true;
            }
        }
        if ((param_3 & 0x8000) == 0x0) || ((ctx.PTR_LOOP_1050_5f3a | ctx.PTR_LOOP_1050_5f38) == 0x0)
        {
...
pub fn fn_ptr_op_1000_24cd(ctx: &mut AppContext, param_1: i16, param_2: u16) {
    let pc_var1: u32;
    let i_var2: i16;
    let c_var3: u8;
    let u_var5: u16;
...
pub fn call_fn_ptr_1008_3e0e(param_1: &mut Struct18) {
    let fn_ptr: u32;

    if param_1.field_0x4 != 0x0 {
        fn_ptr = ((param_1.field_0x4) + 0x4);
        (**fn_ptr)();
    }
    return;
}
