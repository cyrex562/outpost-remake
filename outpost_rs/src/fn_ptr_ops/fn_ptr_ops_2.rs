...
Struct18 * pass1_1038_3074(Struct18 *param_1, param_2: u8)
...
void  pass1_1038_33f8(mut param_1: *mut u16)
...
void  pass1_1038_11b0(param_1: u32, u32 *param_2, u32 *param_3, param_4: u16, param_5: u32, param_6: u16)

{
    ...
    while(true)
    {
        ...
        uVar2   = uVar3;
        pass1_1038_0f8c(param_1, (param_1 >> 0x10), param_2, uVar3, uVar2, param_5, 0x1030, param_6);
        if(uVar2 == 0x0)
            break;
...
void  pass1_1038_1220(param_1: u32, param_2: u32, param_3: u32, param_4: u16)

{
    ...
    if((puVar7 != 0x0) || (uVar4 != 0x0))
    {
        ...
        if(((puVar7 != 0x0) || (uVar5 != 0x0)) && (pass1_1038_11b0(param_1, CONCAT13((puVar6 >> 0x8), CONCAT12(puVar6, uVar3)), CONCAT22(puVar8, uVar4), uVar5, uVar9, param_4), uVar5 == 0x0))
        {
            if(puStack14 == 0x0)
            {
                return;
        ...
        {
            pass1_1038_11b0(param_1, CONCAT22(puVar6, uVar3), CONCAT22(puVar8, uVar4), uVar5, CONCAT22(uVar10, puVar7), param_4);
        }
        if(puStack14 != 0x0)
        {
            ppcVar1 = *puStack14;
...
void  pass1_1038_134a(param_1: u16, param_2: u16, u32 *param_3, u32 *param_4, u32 *param_5, param_6: u16, param_7: u16)
...
void  pass1_1038_13da(param_1: u16, param_2: u16, u32 *param_3, u32 *param_4, u32 *param_5, param_6: u16, param_7: u16)
...
void  pass1_1038_1482(param_1: u32, u32 *param_2, u32 *param_3, param_4: u16, param_5: u16, param_6: u16, param_7: u16, param_8: u16)

{
    ...
    uVar11  = (param_1 >> 0x10);
    uVar3   = param_1;
    pass1_1038_134a(uVar3, uVar11, CONCAT22(param_6, puVar4), CONCAT22(param_6, &local_6), param_3, puVar4, param_4);
    ...
    do
    {
        ...
        uStack14._2_2_ = uStack14._2_2_ | uStack14;
        ...
        pass1_1038_1a30(uVar3, uVar11, CONCAT22(uStack18._2_2_, uStack14._2_2_), &USHORT_1050_1028);
        ...
        if((uStack18._2_2_ | uStack14._2_2_) != 0x0)
        {
            ...
            for(uStack58 = 0x0; uVar5 = uStack56, uStack58 < uStack56; uStack58 = uStack58 + 0x1)
            {
                ...
                if(((local_46 != 0x0) && (0xd < local_42[0])) && (local_42[0] < 0x1d))
                {
                    ...
                    uVar5 = uVar7;
                    if((local_a._2_2_ <= local_46._2_2_) && ((local_a._2_2_ < local_46._2_2_ || (local_a < uVar5))))
                    {
                        uVar5          = local_a;
                        local_46._2_2_ = local_a._2_2_;
                    }
                    lStack74 = CONCAT22(local_46._2_2_, uVar5);
                    uStack34 = CONCAT22(uStack34._2_2_ + (-(uStack34 < uVar5) - local_46._2_2_), uStack34 - uVar5);
                    local_a  = CONCAT22(local_a._2_2_ + (-(local_a < uVar5) - local_46._2_2_), local_a - uVar5);
                    ...
                    if(local_a == 0x0)
                    {
                        ...
                        pass1_1038_134a(uVar3, uVar11, CONCAT22(param_6, &local_a), CONCAT22(param_6, &local_6), param_3, &local_a, 0x1020);
                        uVar5    = uVar7;
                        ...
                        if(uVar10 != 0x0)
                        {
                            ...
                            uStack26 = uVar5;
                            uStack24 = uVar10;
                            pass1_1038_1a30(uVar3, uVar11, CONCAT22(uVar10, uVar5), &USHORT_1050_1028);
...
void  pass1_1038_16f2(param_1: u32, u32 *param_2, u32 *param_3, param_4: u16, param_5: u16, param_6: u16, param_7: u16, param_8: u16, param_9: u8)

{
    ...
    uVar17  = (param_1 >> 0x10);
    uVar3   = param_1;
    pass1_1038_13da(uVar3, uVar17, CONCAT22(param_8, puVar6), CONCAT22(param_8, &local_6), param_3, puVar6, param_7);
            ...
            if((uVar11 | uVar9) != 0x0)
            {
                ...
                if((uVar9 | uStack46) != 0x0)
                {
                    ...
                    while(true)
                    {
                        ...
                        {
                            uVar14 = uVar9;
                            if((uStack42._2_2_ <= uVar9) && ((uStack42._2_2_ < uVar9 || (uStack42 < puVar7))))
                            {
                                uVar14 = uStack42._2_2_;
                                puVar7 = uStack42;
                            }
                            if((local_a._2_2_ <= uVar14) && ((local_a._2_2_ < uVar14 || (local_a < puVar7))))
                            {
                            ...
                            uStack42 = CONCAT22((uStack42._2_2_ - puVar12) - (uStack42 < puVar7), uStack42 - puVar7);
                            local_a  = CONCAT22((local_a._2_2_ - puVar12) - (local_a < puVar7), local_a - puVar7);
                            uVar13   = uVar14;
                            ...
                            if(local_a == 0x0)
                            {
                                ...
                                plStack50 = (long *)0x0;
                                puVar7    = &local_a;
                                pass1_1038_13da(uVar3, uVar17, CONCAT22(param_8, puVar7), CONCAT22(param_8, &local_6), param_3, puVar7, 0x1020);
...
void  pass1_1038_1940(param_1: u32, u32 *param_2, param_3: u32, param_4: u16, param_5: u16, param_6: u16)
...
void  pass1_1038_1b3a(param_1: u16, param_2: u16, param_3: u32, u32 *param_4, param_5: u16, param_6: u16, param_7: u16, param_8: u16)

{
    ...
    for(uStack18 = 0x0; uStack18 < uStack16; uStack18 = uStack18 + 0x1)
    {
        ...
        {
            pass1_1030_7ddc(uStack6, uStack14, local_16[0], uStack14, uStack14._2_2_, param_7, param_8, param_5);
            uStack14 = 0x0;
        }
        else
        {
            uStack14 = uStack14 - local_1a;
            pass1_1030_7ddc(uStack6, local_1a, local_16[0], local_1a, uStack14._2_2_, param_7, param_8, param_5);
        }
        if(uStack14 == 0x0)
            break;
    }
...
Struct18 * pass1_1038_1c02(Struct18 *param_1, param_2: u8)
...
void  pass1_1038_0340(param_1: u16, param_2: u16, param_3: i16, param_4: u32, param_5: u16, param_6: u16, param_7: u8)
...
LAB_1038_054b:
    ...
    if((uStack10._2_2_ | uStack10) != 0x0)
    {
        ...
        pass1_1028_9944((astruct_100 *)CONCAT22(param_6, local_13a), uStack10, CONCAT22(0x400, uStack30), *(iVar3 + 0x4), param_6, param_7);
...
void  pass1_1038_05d8(param_1: u16, param_2: u16, param_3: i16, param_4: u32, param_5: u32, param_6: u16, param_7: u8)

{
    ...
    uStack26 = 0x0;
    uStack30 = 0x0;
    pass1_1028_dc52((astruct_92 *)CONCAT13((param_6 >> 0x8), CONCAT12(param_6, &local_34)), 0x1, 0x0, 0x400);
    do
    {
        do
        {
...
LAB_1038_0841:
    ...
    if((uStack10._2_2_ | uStack10) != 0x0)
    {
        ...
        pass1_1028_9944((astruct_100 *)CONCAT22(param_6, local_158), uStack10, *(param_4 + 0x4), uStack64, param_6, param_7);
...
Struct18 * pass1_1038_0b6a(Struct18 *param_1, param_2: u8)
...
Struct18 * pass1_1030_e010(Struct18 *param_1, param_2: u8)
...
Struct18 * pass1_1030_e282(Struct18 *param_1, param_2: u8)
...
Struct18 * pass1_1030_e4be(Struct18 *param_1, param_2: u8)
...
Struct18 * pass1_1030_e602(Struct18 *param_1, param_2: u8)
...
Struct18 * pass1_1030_e75e(Struct18 *param_1, param_2: u8)
...
Struct18 * pass1_1030_e864(Struct18 *param_1, param_2: u8)
...
u16  pass1_1030_e8f8(param_1: u32, param_2: u16, param_3: u16, param_4: u16, param_5: u16, param_6: u16)

{
    ...
    if((iVar4 + 0x108) != 0x0)
    {
        ...
        uVar1     = (iVar4 + 0x108);
        uVar2     = (iVar4 + 0x10a);
        paStack20 = (Struct18 *)CONCAT22(uVar2, uVar1);
        if((uVar2 | uVar1) != 0x0)
        {
...
Struct18 * pass1_1030_eb14(Struct18 *param_1, param_2: u8)
...
Struct18 * pass1_1030_ec86(Struct18 *param_1, param_2: u8)
...
Struct18 * pass1_1030_d868(Struct18 *param_1, param_2: u8)
...
Struct18 * pass1_1030_dc08(Struct18 *param_1, param_2: u8)
...
Struct18 * pass1_1030_bbe6(Struct18 *param_1, param_2: u8)
...
Struct18 * pass1_1030_bc70(Struct18 *param_1, param_2: u8)
...
Struct18 * pass1_1030_bfe0(Struct18 *param_1, param_2: u8)
...
Struct18 * pass1_1030_c668(Struct18 *param_1, param_2: u8)
...
Struct18 * pass1_1030_c91a(Struct18 *param_1, param_2: u8)
...
Struct18 * pass1_1030_b90c(Struct18 *param_1, param_2: u8)
...
void  pass1_1030_b96c(mut param_1: *mut u16)
...
void  pass1_1030_bb0e(param_1: u32, param_2: u32, param_3: u16, param_4: u16, param_5: u16, param_6: u16)

{
    ...
    uVar2  = uVar4 & 0xffff;
    paVar1 = (Struct18 *)(uVar2 | in_DX << 0x10);
    puVar5 = (in_DX | uVar4);
    if(puVar5 != 0x0)
    {
        for(uStack8 = 0x4; uStack8 < 0x25; uStack8 = uStack8 + 0x1)
        {
            uVar6  = pass1_1020_bae6(uVar2, CONCAT22(uStack8, in_DX), uVar4, puVar5, param_6);
            uVar4  = uVar6 & 0xffff;
            ...
            if(puVar5 != 0x0)
            {
                ...
                vspri16f_op_1030_840a(s_truck_0x_08lx_unloaded__ld_of__s_1050_5798, 0x1020, param_6, puVar5);
...
void  pass1_1030_9f7a(mut param_1: *mut u16, param_2: u16, param_3: u16, param_4: u8)

{
    ...
    puVar3 = &local_8;
    pass1_1030_a278(param_1, CONCAT22(param_3, puVar3), puVar3, param_3, param_4);
    if(puVar3 != 0x0)
    {
        uVar5    = (param_1 >> 0x10);
        uVar4    = param_1;
        ...
        uStack12 = *(uVar1 + 0x8);
        uVar1    = (uVar4 + 0x4);
        struct_op_1028_87f0(param_3, param_4, (astruct_97 *)CONCAT22(param_3, local_130), 0x0, 0x0, param_2, &local_8, param_3, *(uVar1 + 0x4), uStack12);
        ...
        *param_1      = uStack16;
        ...
        if(0x0 < iStack4)
        {
            pass1_1030_a044(param_3, extraout_DX, param_4, uVar4, uVar5, CONCAT22(param_3, &local_8), uStack12);
        }
    }
    return;
}
...
void  pass1_1030_a044(param_1: u16, param_2: u16, param_3: u8, param_4: u16, param_5: u16, mut param_6: *mut u16, param_7: u32)

{
    ...
    puVar2 = &local_8;
    pass1_1008_3eb4(param_6, CONCAT22(param_1, puVar2), CONCAT22(param_1, &local_6), CONCAT22(param_1, &local_4));
    pass1_1030_627e(param_1, puVar2, param_2, globals._PTR_LOOP_1050_5740, param_6, param_7);
    puStack20 = puVar2;
    uStack18  = param_2;
        ...
        for(uStack70 = uStack12; uStack70 <= iStack16; uStack70 = uStack70 + 0x1)
        {
            for(puStack78 = uStack12._2_2_; puStack78 <= iStack14; puStack78 = (puStack78 + 0x1))
            {
                ...
                if(uStack66._3_1_ == '\0')
                {
                    ...
                    struct_op_1028_87f0(param_1, param_3, (astruct_97 *)CONCAT22(param_1, &local_17e), 0x0, 0x0, uVar9, param_6, (param_6 >> 0x10), CONCAT22(uVar11, uVar10), param_7);
...
void  pass1_1030_a278(mut param_1: *mut u16, mut param_2: *mut u16, param_3: u16, param_4: u16, param_5: u8)
...
LAB_1030_a305:
    if(uStack6 != 0x0)
    {
        ...
        uStack16 = *(uVar2 + 0x8);
        uVar2    = (uVar4 + 0x4);
        struct_op_1028_87f0(param_4, param_5, (astruct_97 *)CONCAT22(param_4, local_134), 0x0, 0x0, uStack6, puVar3, uVar5, *(uVar2 + 0x4), uStack16);
        ...
        *param_1      = uStack20;
        ...
        if(0x0 < (puVar3 + 0x1))
        {
            pass1_1030_a044(param_4, extraout_DX, param_5, uVar4, uVar6, (param_2 & 0xffff | uVar5 << 0x10), uStack16);
        }
    }
    return;
}
...
void  pass1_1030_a844(param_1: u32, mut param_2: *mut u16, param_3: i16, param_4: i16, param_5: u16)

{
    ...
    if((param_4 != 0x0) || (param_3 != 0x0))
    {
        ...
        ppcVar3  = (*puVar7 + 0x10);
        puStack6 = puVar7;
        (**ppcVar3)(&PTR_LOOP_1050_1038, puVar7, (&iVar8->field_0xc + 0x2));
        ...
        for(uStack34 = 0x0; uStack34 < uStack10; uStack34 = uStack34 + 0x1)
        {
            ...
            uVar10 = uVar4 | uVar15;
            uVar9  = uVar10;
            if((uVar10 != 0x0) && (uVar4 = pass1_1008_c6ae(_PTR_LOOP_1050_06e0, (uVar15 + 0xc), 0x46), uVar9 = uVar10, uVar4 != 0x0))
            {
                ...
                if((uVar10 | uVar4) != 0x0)
                {
                    ...
                    if((iVar1 == local_1c)
                       && (uVar15 = uVar8->field_0x4,
                           ...
                           iVar11 = uVar15,
                           uVar2  = (iVar11 + 0x4),
                           uVar5  = pass1_1030_addc(uVar8, uVar12, CONCAT22(param_5, &local_16), uVar2, (uVar2 >> 0x10), *(iVar11 + 0x8), &local_16, uVar10, param_5),
                           uVar9  = uVar10,
                           uVar5 != 0x0))
                    {
...
void  pass1_1030_aa18(param_1: u32, mut param_2: *mut u16, param_3: u16)

{
    ...
    case 0x7e:
        ...
        puVar13 = uStack14;
        uVar20  = (undefined)(uStack14 >> 0x10);
        goto LAB_1030_ab66;
    case 0x7c:
    case 0x7d:
        local_14 = local_16 + -0x1;
