...
void pass1_1010_abd2(Globals *globals, param_1: u16, param_2: u16, param_3: i16, mut param_4: *mut u8, param_5: i16, param_6: u16)

{
    ...
    puVar3    = mixed_1010_20ba(globals._PTR_LOOP_1050_0ed0, 0x35, param_6, param_4, param_5);
    bVar1     = false;
    iStack16  = param_3;
...
u32  pass1_1010_8c32(astruct_640 *param_1, param_2: u16, param_3: u16, param_4: u16)
    ...
    if(uVar5 != 0x0)
    {
        ...
        if(uVar5 == 0x1)
        {
            ...
            case 0x1:
                ...
                if(0x0 < iStack12)
                {
                    pcVar10 = load_string_1010_847e(_PTR_LOOP_1050_14cc, (_PTR_LOOP_1050_14cc >> 0x10), (HINSTANCE16)&USHORT_1050_1028);
        ...
        else
        {
            ...
            if(uVar5 - 0x2 == 0x0)
            {
                ...
                wspri16f16(&USHORT_1050_1028, spec, valist);
            LAB_1010_8def:
                fn_ptr_1000_17ce((Struct18 *)(uStack46 & 0xffff | ZEXT24(in_DX) << 0x10), 0x1000);
...
void  pass1_1010_8ef2(mut param_1: *mut u16, mut param_2: *mut u8, param_3: u16)
...
u32  pass1_1010_9298(astruct_79 *param_1, astruct_79 *param_2, param_3: u16, param_4: u16, mut param_5: *mut u8, param_6: u16)

{
    ...
    pass1_1000_4906((Struct20 *)CONCAT22(param_5, param_1[0x9].field_0x2), 0x0, 0x20c);
    return CONCAT22(param_2, param_1);
}

void  pass1_1010_9304(param_1: u16, param_2: u16, param_3: i16, param_4: u16, mut param_5: *mut u8)
...
void  pass1_1010_9372(u32 *param_1, param_2: u16, param_3: i16, param_4: i16, param_5: i16)
...
void  pass1_1010_9794(param_1: u32, param_2: u16)
...
void  pass1_1010_878c(astruct_87 **param_1, param_2: i16, HINSTANCE16 param_3)
...
void  pass1_1010_6abc(astruct_635 *param_1, param_2: u16, param_3: u16)
...
u32  string_1010_5286(param_1: u16, param_2: u16, param_3: u32, param_4: &mut String, param_5: u16)
...
void  win_sys_op_1010_5404(astruct_54 *param_1, param_2: u16, param_3: u16, param_4: u16)

{
    ...
    pcVar18  = load_string_1010_847e(_PTR_LOOP_1050_14cc, (_PTR_LOOP_1050_14cc >> 0x10), 0x1000);
    ...
    if(*param_1->field_0xe != '\0')
    {
        pCVar16 = &globals.PTR_LOOP_1050_1000;
    ...
    if(param_1->field_0x62 == 0x0)
    {
        ...
        do
        {
            ...
            {
                uVar15 = 0x1000;
                puVar9 = pass1_1000_4906((Struct20 *)CONCAT22(param_2, &param_1->field_0x22 + iStack42 * 0x8), 0x0, 0x8);
            }
    ...
    *(u16 **)&param_1->field_0x64 = puVar9;
    ...
    GetPrivateProfileString16(&globals.PTR_LOOP_1050_1000, uVar3, (uVar3 >> 0x10), (s_You_may_not_run_a_turn__The_game_1050_00df + 0x21), pcVar18, (pcVar18 >> 0x10));
    if(*param_1->field_0xe != '\0')
    {
        pcVar18 = param_1->field_0xe;
...
void  write_private_profile_str_1010_5b10(mut param_1: *mut u16)
...
void  pass1_1010_5d9c(param_1: u32, param_2: i16, mut param_3: *mut u8, param_4: i16, param_5: u16)
...

{
    ...
    uVar1 = (iVar7 + 0xe);
    uVar2 = (iVar7 + 0xa);
    GetPrivateProfileString16(param_3, uVar2, (uVar2 >> 0x10), (s_You_may_not_run_a_turn__The_game_1050_00df + 0x21), uVar1, (uVar1 >> 0x10));
    if(*(iVar7 + 0xe) != '\0')
    {
...
u16 * pass1_1010_62ec(mut param_1: *mut u16, param_2: u8)
...
u32  pass1_1010_451a(param_1: u32, mut param_2: *mut u8, param_3: i16, param_4: u16)
...
void  pass1_1010_4a8a(astruct_637 *param_1, param_2: u16, param_3: u16, param_4: u16)
...
void  struct_1010_4d5c(param_1: u32, param_2: u16, param_3: u16, param_4: u16, param_5: u16, param_6: i16, mut param_7: *mut u8)

{
    ...
    if(&iVar3->field_0x1a_addr_offset == 0x0)
    {
        ...
        &iVar3->field_0x1a_addr_offset = uVar2;
...
void  pass1_1010_4f48(param_1: u32, param_2: u16)

{
    ...
    fn_ptr_1000_17ce((Struct18 *)iVar6->field_0x1a_addr_offset, 0x1000);
...
u16 * pass1_1010_5004(mut param_1: *mut u16, param_2: u8, param_3: u16)
...
void  pass1_1010_503e(param_1: i16, param_2: u16, param_3: u16, mut param_4: *mut u8, param_5: u16)
...
void  pass1_1010_519a(param_1: u32, i16 *param_2, mut param_3: *mut u8, param_4: u16)
...
void  pass1_1010_35a4(u32 *param_1, param_2: u32, mut param_3: *mut u8)

{
    ...
    if(param_2 != 0x0)
    {
        ...
        {
            uVar2    = (puStack8 + 0x8);
            puStack8 = ((((u8)uStack12 & 0xf) - 0x1) * 0x4 + uVar2);
            uVar7    = 0x1000;
            puVar4   = puStack8;
...
void  pass1_1010_3680(param_1: u16, param_2: u16, param_3: u16, param_4: u16, param_5: u16, mut param_6: *mut u8, param_7: u16)
...
u16 * struct_1010_38f8(param_1: u32, param_2: i16, param_3: u16, mut param_4: *mut u8)
...
void  pass1_1010_394a(param_1: u16, param_2: u16, param_3: i16, param_4: u16, mut param_5: *mut u8)
...
u32  pass1_1010_3d82(astruct_628 *param_1, param_2: u16, param_3: u16, param_4: u16)
...
void  pass1_1010_3e3c(astruct_55 *param_1, param_2: u16, param_3: u16)
...
void  pass1_1010_41d6(param_1: u32, param_2: u32, mut param_3: *mut u8, param_4: u16, param_5: u8)

{
    ...
    uVar4    = iStack22 * 0x6;
    mem_op_1000_179c(uVar4, puVar8, 0x1000);
    paStack30 = (Struct18 *)CONCAT22(puVar8, uVar4);
    puVar9    = (puVar8 | uVar4);
    if(puVar9 == 0x0)
    {
    ...
    while(true)
    {
        ...
        paStack34 = (Struct18 *)CONCAT22(puVar9, uVar5);
