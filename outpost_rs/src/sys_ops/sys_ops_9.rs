...
void pass1_1010_28e6(astruct_631 *param_1, mut param_2: *mut u8, param_3: u16, mut param_4: *mut u8, param_5: u16)

{
    ...
    uVar2               = fn_ptr_op_1000_1708(0x40, 0x0, 0x1, globals.PTR_LOOP_1050_5f2c, globals.PTR_LOOP_1050_5f2e, 0x1000);
...

{
    ...
    load_string_1010_84e0(0x1000, globals._PTR_LOOP_1050_14cc, (_PTR_LOOP_1050_14cc >> 0x10), 0x80, puVar2, in_buf_len_5);
...
void pass1_1010_32f4(u32 *param_1, u32 *param_2, param_3: u16, param_4: u16)
...
void pass1_1010_16ee(param_1: u16, param_2: u16, param_3: u16, param_4: u16, param_5: u16, mut param_6: *mut u8)
...
void pass1_1010_1788(param_1: u16, param_2: u16, param_3: u32, mut param_4: *mut u8, param_5: i16, param_6: u16)
...
void pass1_1010_17c0(param_1: u32)
...
u32 pass1_1010_195e(astruct_79 *param_1, astruct_79 *param_2, param_3: u16)
...
u32 pass1_1010_1b6e(astruct_79 *param_1, astruct_79 *param_2, param_3: u16, param_4: u16, mut param_5: *mut u8)
...
void pass1_1010_1df2(param_1: u32, param_2: u16, param_3: u32, param_4: u16, param_5: u16)
...
void pass1_1010_043a(param_1: u32, long param_2, param_3: i16, param_4: u16)
...

{
    ...
    *param_2 = 0x0;
    ...
    iVar5 = iVar1 + 0x757;
    load_string_1010_84ac(_PTR_LOOP_1050_14cc, (_PTR_LOOP_1050_14cc >> 0x10), param_4);
    param_3         = iVar5;
    (param_3 + 0x2) = puVar8;
...
u32 pass1_1010_0946(param_1: u16, param_2: u16, param_3: i16, mut param_4: *mut u8, param_5: i16, param_6: u16)
...
void pass1_1010_09b4(param_1: u16, param_2: u16, mut param_3: *mut u8, char **param_4, param_5: u32, mut param_6: *mut u8, param_7: u16)
...
void pass1_1010_11c6(param_1: u32, param_2: u16, mut param_3: *mut u8)
...
void pass1_1008_eb74(param_1: u32, param_2: i16, mut param_3: *mut u8, param_4: i16, param_5: u16)
...
u32 struct_1008_ecb2(astruct_221 *param_1, param_2: u16, param_3: u16)
...
void mem_1008_ed1e(param_1: u16, param_2: u16, param_3: i16, param_4: u16, mut param_5: *mut u8)
...
void pass1_1008_ed8a(u32 *param_1, param_2: u16, param_3: i16, param_4: i16, param_5: i16, param_6: i16, param_7: u16)
...
void struct_1010_02e0(astruct_79 *param_1, astruct_79 *param_2, param_3: u16)
    ...
    for(uStack20 = 0x0; uStack20 < uVar12; uStack20 = uStack20 + 0x1)
    {
        ...
        if((((uVar19 | uVar10) != 0x0) && ((uVar10 + 0x1c) != 0x8000002)) && ((iVar20 = (uVar10 + 0x12), iVar20 == 0x5 || (iVar20 == 0x6))))
        {
            ...
            if((BVar7 == 0x0) && ((uVar10 + 0x1c) != lVar1))
            {
                ...
                pWVar16 = valist;
                wspri16f16(0x1020, (iVar21 + 0x22), valist);
...
void pass1_1008_d790(astruct_647 *param_1, param_2: u16, param_3: u16, param_4: u16)
...
void struct_1008_dd4e(astruct_209 *param_1, param_2: u16, param_3: u16)
...
void pass1_1008_ddca(mut param_1: *mut u16, param_2: u16)
...
void pass1_1008_de58(param_1: u32, long param_2, long param_3, param_4: u16)
...
void pass1_1008_e3ec(param_1: u32, u32 *param_2, u32 *param_3, param_4: u16)
...
void pass1_1008_c882(param_1: u32, param_2: u16)
