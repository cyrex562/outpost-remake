...
use crate::draw_ops::draw_1018::draw_text_1018_c742;
use crate::pass::pass_1008::pass1_1008_4772;
use crate::win_platform::types::{COLORREF, HDC16, HGDIOBJ16, HPEN16, HWND16, PAINTSTRUCT16, POINT16, RECT16};
use crate::win_platform::winapi::DeleteObject16;

pub fn  pass1_1038_9a48(Struct18 *param_1)
...
pub fn  pass1_1038_7d5c(Struct18 *param_1)
...
pub fn  unk_draw_op_1018_cda8(astruct_36 *param_1, param_2: u16)

{
    ...
    if(uVar5 == 0x0)
    {
        ...
        PostMessage16(s_tile2_bmp_1050_1538, 0x0, 0x0, CONCAT22(0x111, (iVar10 + 0xea)));
        return;
    }
    if((iVar10 + 0xf0) == 0x0)
    {
...
pub fn  unk_draw_op_1018_cfc0(astruct_36 *param_1, param_2: u16)
...
pub fn  palette_op_1020_92c4(mut param_1: *mut u16, param_2: HDC16)

{
    ...
    *param_1      = 0x96c8;
    ...
    if (iVar1 + 0x12) != 0x0
    {
        SelectPalette16(param_2, 0x0, (iVar1 + 0x12));
        DeleteObject16(s_tile2_bmp_1050_1538);
    }
    *param_1      = 0x3ab0;
    (iVar1 + 0x2) = 0x1008;
...
pub fn  mix_draw_op_1020_9312(param_1: u32, HWND16 param_2)
...
pub fn  draw_op_1020_9364(astruct_7 *param_1, HWND16 in_win_handle_2, param_3: u16)

{
    ...
    do
    {
        ...
        HStack50 = CreatePen16(s_tile2_bmp_1050_1538, uVar4, (uVar4 >> 0x10));
        HStack52 = SelectObject16(s_tile2_bmp_1050_1538, HStack50);
        MoveToEx16(s_tile2_bmp_1050_1538, local_38, param_3, *(POINT16 **)(uStack58 * 0x2 + puStack26));
        LineTo16(s_tile2_bmp_1050_1538, (puStack26 + uStack58 * 0x2), uStack6);
        iVar3 = (iStack20 - uStack58) * 0x2;
        MoveToEx16(s_tile2_bmp_1050_1538, local_38, param_3, *(POINT16 **)(iVar3 + puStack26));
        LineTo16(s_tile2_bmp_1050_1538, (puStack26 + iVar3), uStack6);
    ...
    FillRect16(s_tile2_bmp_1050_1538, pRVar6, &local_a);
    DeleteObject16(s_tile2_bmp_1050_1538);
    iStack62 = 0x8;
    for(uStack58 = 0x1; uStack58 < 0xa; uStack58 = uStack58 + 0x1)
    {
        ...
        FillRect16(s_tile2_bmp_1050_1538, pRVar6, &local_a);
        FillRect16(s_tile2_bmp_1050_1538, pRVar6, &local_12);
        DeleteObject16(s_tile2_bmp_1050_1538);
    ...
    do
    {
        ...
        MoveToEx16(s_tile2_bmp_1050_1538, local_38, param_3, *(POINT16 **)((iVar5 + uStack46) * 0x2 + puStack26));
        LineTo16(s_tile2_bmp_1050_1538, ((iStack20 - *piVar1) * 0x2 + puStack26), iVar3 + local_a.x);
        iVar3 = ((iStack22 - uStack58) * 0x2 + uStack42);
        MoveToEx16(s_tile2_bmp_1050_1538, local_38, param_3, *(POINT16 **)(*piVar1 * 0x2 + puStack26));
        LineTo16(s_tile2_bmp_1050_1538, ((iStack20 - *piVar1) * 0x2 + puStack26), iVar3 + local_a.x);
        SelectObject16(s_tile2_bmp_1050_1538, HStack52);
        DeleteObject16(s_tile2_bmp_1050_1538);
        uStack58 = uStack58 - 0x1;
...

{
    ...
    return param_1.clone();
}

Struct18 * pass1_1020_7526(Struct18 *param_1, param_2: u8, param_3: u16)
...
pub fn  struct_1020_7554(param_1: u16, Struct20 *param_2, param_3: u16, param_4: u16)
...
pub fn  pass1_1020_7824(astruct_666 *param_1, param_2: u16, param_3: u16, param_4: i16, param_5: u16)
...
pub fn  pass1_1020_78ac(mut param_1: *mut u16, param_2: u16)
...
pub fn  struct_1020_790e(mut param_1: *mut u16, param_2: u32, param_3: u16, param_4: u32, param_5: u16)
...
pub fn  draw_op_1020_7cc8(param_1: u32, HWND16 in_win_handle_2, param_3: u16)
...
pub fn  unk_draw_op_1020_7f7a(Struct20 *param_1, param_2: u16, param_3: u32)

{
    ...
    HVar3                     = LoadCursor16((HINSTANCE16)s_tile2_bmp_1050_1538, 0x7f00);
...
pub fn  win_ui_palette_op_1020_81c0(HWND16 param_1)

{
    ...
    if(0x0 < UVar1)
    {
        InvalidateRect16(s_tile2_bmp_1050_1538, (&PTR_LOOP_1050_0000 + 0x1), 0x0);
    }
    return;
}

pub fn  pass1_1020_6466(mut param_1: *mut u16, param_2: u16, param_3: u16)
...
pub fn  mix_draw_op_1020_650c(astruct_7 *param_1, HWND16 param_2, param_3: u16)
...
pub fn  realize_palette_1020_6896(param_1: u32, param_2: i16, HGDIOBJ16 param_3)
...
pub fn  pt_in_rect_1020_68fc(u32 *param_1, param_2: u16, param_3: u16)
...

{
    ...
    SetTextColor16(s_tile2_bmp_1050_1538, _PTR_LOOP_1050_441e);
    SetBkColor16(s_tile2_bmp_1050_1538, 0x0);
    return HVar1;
}

pub fn  palette_op_1020_7270(mut param_1: *mut u16, param_2: HDC16)
...
pub fn  invalidate_rect_1020_735a(param_1: u32, HWND16 param_2)
...
BOOL16  win_ui_op_1020_737a(param_1: u32, HWND16 param_2, param_3: u16)

{
    ...
    uVar10   = (iVar8 + 0x4);
    BVar4    = IsIconic16(s_tile2_bmp_1050_1538);
    if(BVar4 == 0x0)
    {
        uVar3              = (iVar8 + 0x1c);
        puVar6             = (uVar3 + 0x24);
        ...
        if(HStack52 != 0x0)
        {
            ShowWindow16(s_tile2_bmp_1050_1538, 0x1);
        }
    }
    else
    {
        if(PTR_LOOP_1050_0010 == 0x0)
        {
            ...
            if(BVar4 != 0x0)
            {
                ...
                HStack52           = HStack54;
                iStack50           = iStack56;
                FillRect16(s_tile2_bmp_1050_1538, local_rect, &local_brush_handle);
                DrawIcon16(s_tile2_bmp_1050_1538, BStack38, 0x2, 0x2);
            }
        }
    }
    BVar4 = EndPaint16(s_tile2_bmp_1050_1538, &local_pai16_struct);
    return BVar4;
}

pub fn  unk_draw_op_1020_3da4(astruct_24 *param_1, param_2: u32)
...
pub fn  win_ui_palette_op_1020_3e84(astruct_16 *param_1)

{
    ...
    SelectObject16(s_tile2_bmp_1050_1538, iVar1->field_0x1a_addr_offset);
    SelectPalette16(s_tile2_bmp_1050_1538, 0x0, iVar1->field_0x1c_addr_base);
    DeleteObject16(s_tile2_bmp_1050_1538);
...
pub fn  validate_rect_1020_3f12(param_1: u32, param_2: i16, HWND16 param_3)
...
pub fn  mixed_draw_op_1020_3fa0(param_1: u32, HWND16 param_2, param_3: u16)
...
Struct18 * pass1_1020_4064(Struct18 *param_1, param_2: u8)
...

{
    ...
    if((*(u8 *)(param_1 + 0xe) & 0x1) != 0x0)
    {
        ...
        Rectangle16(s_tile2_bmp_1050_1538, local_6 + param_2 + 0x5, local_4 + param_3 + 0x5, local_6 + param_2 + -0x5, local_4 + param_3 + -0x5);
        HVar2 = GetStockObject16(s_tile2_bmp_1050_1538);
        SelectObject16(s_tile2_bmp_1050_1538, HVar2);
        HVar2 = GetStockObject16(s_tile2_bmp_1050_1538);
        SelectObject16(s_tile2_bmp_1050_1538, HVar2);
...
pub fn  unk_draw_op_1020_41c8(Struct20 *param_1, param_2: u16, param_3: u16, param_4: u16)

{
    ...
    HVar2                      = LoadCursor16((HINSTANCE16)s_tile2_bmp_1050_1538, (s__s__ld_1050_019c + 0x3));
    uVar5->field_0xf2          = HVar2;
    puVar9                     = globals.PTR_LOOP_1050_038c;
    globals.PTR_LOOP_1050_0398         = LoadAccelerators16((HINSTANCE16)s_tile2_bmp_1050_1538, s_OpAccel_1050_43e8);
...
pub fn  destroy_cursor_1020_42f4(mut param_1: *mut u16, HMENparam_2: u16)
...
pub fn  load_draw_op_1020_2ede(mut param_1: *mut u16, param_2: u32, param_3: u16)

{
    ...
    *(HDC16 *)(iVar6 + 0x18) = HVar3;
    ...
    uVar1                        = (iVar6 + 0x14);
    uVar1                        = (uVar1 + 0x64);
    handle                       = CreatePen16(s_tile2_bmp_1050_1538, uVar1, (uVar1 >> 0x10));
...
pub fn  invalidate_rect_1020_3080(param_1: u32, param_2: i16, HWND16 param_3)
...
pub fn  draw_op_1020_30be(param_1: u32, HWND16 param_2, param_3: u16)
    ...
    else
    {
        if(PTR_LOOP_1050_0010 == 0x0)
        {
            ...
            if(iStack38 != 0x0)
            {
                ...
                iStack52 = iStack54;
                iStack50 = iStack56;
                FillRect16(s_tile2_bmp_1050_1538, pRStack40, &local_3c);
                hwnd = s_tile2_bmp_1050_1538;
...
pub fn  draw_op_1020_33c0(param_1: u32, param_2: u32, param_3: i16, param_4: u32, param_5: i16, param_6: u16, param_7: u16)
...

{
    ...
    bottom    = (local_a >> 0x10);
    Rectangle16(s_tile2_bmp_1050_1538, local_a + 0x6, bottom + 0x6, local_a, bottom);
    SelectObject16(s_tile2_bmp_1050_1538, handle_00);
...

{
    ...
    HGDIOBJ16   HVar16;
     ...
     let mut bVar22: u8;
     let mut bVar23: u8;
     let mut puVar24: *mut u8;
     let mut bVar25: u8;
     let mut pcVar26: String;
    ...
    *param_6 = 0x3c;
    puVar24  = CONCAT11((param_2 >> 0x8) + '<' + (*(u8 *)(param_3 + param_5) < 0x20), bVar22);
        ...
        *pbVar2 = *pbVar2 | bVar23;
        ...
        if(-*pcVar1 < '\0')
        {
            ...
            *pbVar2 = *pbVar2 | bVar12;
            ...
            code_r0x10203d96:
                pbVar2   = (u8 *)(param_3 + iVar13);
                *pbVar2  = *pbVar2 | (u8)puVar24;
                pbVar2   = (u8 *)(param_3 + iVar13);
                *pbVar2  = *pbVar2 & (u8)puVar24;
                pcVar27  = pcVar26 + 0x2;
                uVar21   = puVar24 & 0xff;
                puVar24  = (uVar21 | (u8)((puVar24 >> 0x8) * '\x02' + ((u8)uVar20 < 0x20)) << 0x8);
                pbVar2   = (u8 *)(param_3 + iVar13 + 0x1);
                *pbVar2  = *pbVar2 & (u8)uVar21;
                param_4  = &stack0xfff6;
                param_16 = pcStack4;
            ...
            *pbVar2 = *pbVar2 | bVar12;
            ...
            bVar12  = (u8)(uVar20 >> 0x8);
            uVar21  = uVar20 & 0xff | (u8)(bVar12 + *pbVar2) << 0x8;
...
pub fn  invalidate_rect_1020_1fb2(param_1: u32, param_2: i16, HWND16 param_3)
...
pub fn  unk_draw_op_1020_2020(param_1: u32, HWND16 param_2, param_3: u16)

{
    ...
    *(HGDIOBJ16 *)(puVar14 + -0x40) = HVar8;
    ...
    uVar2 = (puVar14 + 0x6);
    SelectPalette16(0x1010, 0x0, (uVar2 + 0x10));
    DeleteObject16(s_tile2_bmp_1050_1538);
...
pub fn  struct_1020_2524(Struct20 *param_1, param_2: u16, param_3: u16, param_4: u16)
...
pub fn  pass1_1020_27b0(astruct_664 *param_1, param_2: u16, param_3: u16, param_4: i16, param_5: u16)
...
pub fn  pass1_1020_2838(mut param_1: *mut u16, param_2: u16)
