...
use crate::win_platform::types::HDC16;
...
pub fn misc_draw_op_1018_5d6c(param_1: u32, param_2: HWND16) {
    ...
    u_var3 = (i_var4 + 0x14);
    pu_var1 = (u_var3 + 0xa);
    paVar6 = pass1_1008_9f48((i_var4 + 0x14));
    pass1_1008_5236((i_var4 + 0x18));
    pass1_1008_4480(
        pu_var1,
        (param_1 & 0xffff0000 | (i_var4 + 0x1c)),
        paVar6,
        unaff_SS,
    );
    ppcVar2 = (*pu_var1 + 0x4);
...
pub unsafe fn unk_draw_op_1018_623e(
    ...
    (iVar11 + 0x10) = pHVar6;
    u_var3 = (iVar11 + 0x6);
    uStack42 = (u_var3 + 0x30);
    u_var3 = (iVar11 + 0x6);
    uStack46 = (u_var3 + 0x12);
    uStack48 = 0x14;
    local_32 = 0x0;
    style = 0x1008;
    ...
    while ((puVar13 + -0x38) < (puVar13 + -0x28)) {
        ...
        u_var3 = (puVar13 + -0x2c);
        uVar16 = pass1_1008_4772((iVar11 + u_var3));
        // puVar9 = (uVar16 >> 0x10);
        (puVar13 + -0x44) = uVar16;
        (puVar13 + -0x42) = puVar9;
        u_var3 = (puVar13 + 0x6);
        ...
        uVar18 = 0x10;
        if ((iVar19 + 0x1a) == 0x0) {
            u_var5 = (iVar19 + 0x30) << 0x3;
            mem_op_1000_179c(u_var5, puVar9, 0x1000);
            (iVar19 + 0x1a) = u_var5;
            (iVar19 + 0x1c) = puVar9;
        }
        u_var3 = (iVar19 + 0x1a);
        iVar11 *= 0x8;
        (u_var3 + iVar11) = CONCAT11(uVar21, uVar20);
        u_var3 = (iVar19 + 0x1a);
        (u_var3 + iVar11 + 0x2) = uVar14;
        u_var3 = (iVar19 + 0x1a);
        (u_var3 + iVar11 + 0x4) = iVar7;
        u_var3 = (iVar19 + 0x1a);
        (u_var3 + iVar11 + 0x6) = iVar12;
        style = CONCAT11(uVar18, uVar17);
        u_var3 = (puVar13 + -0x44);
        pi_var1 = (puVar13 + -0x2e);
        *pi_var1 = *pi_var1 + (-((puVar13 + -0x38) == 0x0) & 0x5) + 0x14 + (u_var3 + 0x4);
...
pub fn draw_line_1018_6444(ctx: &mut AppContext, param_1: u32, param_2: HDC16) {
    ...
    //   i_var4 = (piVar6[0x2] - *piVar6 >> 0x1) + *piVar6;
...
pub unsafe fn mixed_draw_op_1018_6a7a(
    ...
    pu_var1 = mixed_1010_20ba(ctx, ctx.PTR_LOOP_1050_0ed0, 0x2, unaff_ss, in_dx, unaff_di);
    if ((pu_var1 + 0x20) == 0x0) {
...
pub unsafe fn unk_draw_op_1018_c578(
    ...
    hwnd = 0x1010;
    pu_stack38 = mixed_1010_20ba(ctx.PTR_LOOP_1050_0ed0, 0x2, param_2, in_dx, unaff_di);
...
pub unsafe fn unk_draw_op_1018_cda8(ctx: &mut AppContext, param_1: &mut Struct36, param_2: u16) {
    ...
    hwnd = 0x1010;
    puStack38 = mixed_1010_20ba(ctx.PTR_LOOP_1050_0ed0, 0x2, param_2, in_dx, unaff_DI);
    ...
    if ((iVar10 + 0xf0) == 0x0) {
        (iVar10 + 0xf0) = 0x1;
        hwnd = 0x1008;
        win_1008_5c5c(param_2, u_var5, u_var8, ctx.PTR_LOOP_1050_02a0, 0x1f3);
        uVar12 = (ctx.PTR_LOOP_1050_02a0 >> 0x10);
        if ((ctx.PTR_LOOP_1050_02a0 + 0x12) == 0x0) {
            hwnd = 0x1008;
            win_1008_5c5c(
                param_2,
    ...
    local_2a = BeginPaint16(hwnd, &local_22);
    pRStack44 = CreateSolidBrush16(ctx.s_tile2_bmp_1050_1538);
    local_34 = 0x0;
...
pub fn unk_draw_op_1018_cfc0(ctx: &mut AppContext, param_1: &mut Struct36, param_2: u16) {
    let pi_var1: U32Ptr;
    let i_var2: i16;
    ...
    if (((iVar10 + 0xf0) == 0x0) && ((iVar10 + 0xf4) != 0x0)) {
        ...
        if ((ctx.PTR_LOOP_1050_02a0 + 0x12) == 0x0) {
            hwnd = 0x1008;
            win_1008_5c5c(param_2, u_var5, uVar8, ctx.PTR_LOOP_1050_02a0, 0x1d3);
        }
    }
    local_2a = BeginPaint16(hwnd, &local_22);
    pRStack44 = CreateSolidBrush16(ctx.s_tile2_bmp_1050_1538);
    ...
    i_var2 = (uVar13 + 0x8);
    iVar7 = (0x1e0 - i_var2) / 0x2;
    (iVar10 + 0x10c) = iVar7 + i_var2 + (iVar10 + 0x110);
...
pub fn invalidate_rect_1018_edd8(param_1: u32, param_2: i16, param_3: u16) {
    ...
    u_var3 = pass1_1010_2b66((i_var1 + 0x14));
    // uStack8 = (u_var3 >> 0x10);
    uStack10 = u_var3;
    uStack14 = pass1_1008_4772((u_var3 & 0xffff | uStack8 << 0x10));
