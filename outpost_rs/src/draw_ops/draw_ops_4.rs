use crate::win_platform::types::{HWND16, POINT16};
use crate::win_platform::winapi::DeleteObject16;

pub fn  begin_end_pai16_1008_97c8(HWND16 param_1)
...
pub fn draw_op_1008_8288(param_1: u16, param_2: u32, HWND16 param_3)

{
    ...
    uStack4  = 0x0;
    HStack76 = CreatePen16(s_tile2_bmp_1050_1538, _PTR_LOOP_1050_0368, (_PTR_LOOP_1050_0368 >> 0x10));
    HStack78 = CreatePen16(s_tile2_bmp_1050_1538, DAT_1050_0364, (DAT_1050_0364 >> 0x10));
    ...
    HVar1    = SelectObject16(s_tile2_bmp_1050_1538, HVar1);
    HVar2    = GetStockObject16(s_tile2_bmp_1050_1538);
    HVar2    = SelectObject16(s_tile2_bmp_1050_1538, HVar2);
    Rectangle16(s_tile2_bmp_1050_1538, uStack82, uStack84, local_58.y, local_58.x);
    MoveTo16(s_tile2_bmp_1050_1538, uStack68, 0x0);
    LineTo16(s_tile2_bmp_1050_1538, uStack68, uStack62);
    uVar3 = (param_2 >> 0x10);
    ...
    iStack6  = iStack10;
    SelectObject16(s_tile2_bmp_1050_1538, HStack76);
    if(uStack4 == 0x0)
    {
        MoveTo16(s_tile2_bmp_1050_1538, uStack68 - 0x2, 0x1);
        LineTo16(s_tile2_bmp_1050_1538, 0x1, 0x1);
        LineTo16(s_tile2_bmp_1050_1538, 0x1, uStack62 - 0x1);
    }
    ...
    if(uStack4 == 0x0)
    {
        MoveTo16(s_tile2_bmp_1050_1538, uStack82 - 0x2, 0x1);
        x = uStack68 + 0x1;
        LineTo16(s_tile2_bmp_1050_1538, x, 0x1);
        LineTo16(s_tile2_bmp_1050_1538, x, uStack62 - 0x1);
    }
    SelectObject16(s_tile2_bmp_1050_1538, HStack78);
    SelectObject16(s_tile2_bmp_1050_1538, HStack80);
    Polygon16(s_tile2_bmp_1050_1538, (POINT16 *)(&PTR_LOOP_1050_0002 + 0x1), &local_10);
    Polygon16(s_tile2_bmp_1050_1538, (POINT16 *)(&PTR_LOOP_1050_0002 + 0x1), &local_1c);
    SelectObject16(s_tile2_bmp_1050_1538, HVar2);
    SelectObject16(s_tile2_bmp_1050_1538, HVar1);
...
Struct20 * unk_draw_op_1008_61b2(Struct20 *param_1, param_2: u16, param_3: u16, param_4: u32, param_5: u16)
...
pub fn  fill_rect_1008_62c0(HWND16 param_1)

{
    ...
    FillRect16(s_tile2_bmp_1050_1538, pRStack38, local_2e);
    EndPaint16((HWND16)s_tile2_bmp_1050_1538, &local_22);
    DeleteObject16(s_tile2_bmp_1050_1538);
    return;
}
...
HPALETTE16  palette_op_1008_4e08(astruct_13 *param_1, BOOL16 param_2, param_3: u16, param_4: HDC16)
...
pub fn  create_palette_1008_4e38(astruct_13 *in_struct_1, LOGPALETTE *in_log_palette_2, mut param_3: *mut u8)
...
pub fn  file_and_draw_op_1008_4f20(mut param_1: *mut u16, param_2: u32, param_3: u16, param_4: u32, param_5: u16)

{
    ...
    *param_1        = s_SCi16ernalPutBldg2_site_0x_08lx__1050_5099 + 0x9;
    ...
    color              = SetBkColor16(s_tile2_bmp_1050_1538, 0xffff);
    color_00           = SetTextColor16(s_tile2_bmp_1050_1538, *(COLORREF *)(iVar3 + 0x22));
...

{
    ...
    x_src      = (uVar1 >> 0x10);
    height_dst = uVar1;
    bits       = *(Ppub fn *)(height_dst + 0x4);
    height_src = (height_dst + 0x8);
    uVar1      = (iVar3 + 0x14);
    StretchDIBits16(param_2, 0x20, 0xcc, 0x0, height_dst, x_src, uVar1, (uVar1 >> 0x10), height_src, bits, (BITMAPINFO *)0x0, 0x0, CONCAT22(bits, height_src));
    return;
}
...
pub fn  set_sys_color_1008_357e(param_1: u32, param_2: i16, u16 in_index_3, param_4: u16)
    ...
    if(&iVar3->field_0xf8 == 0x0)
    {
        ...
        for(iStack132 = 0x0; iStack132 < 0x15; iStack132 = iStack132 + 0x1)
        {
            ...
            *(COLORREF *)(iVar4 + iStack132 * 0x4) = colorref_var2;
            ...
            in_index_3                             = s_tile2_bmp_1050_1538;
        }
    }
    count = in_index_3;
    if(param_2 != 0x0)
    {
        count         = s_tile2_bmp_1050_1538;
        colorref_var2 = GetSysColor16(in_index_3);
...
pub fn  fill_rect_1008_39ac(HWND16 in_win_handle_1)

{
    ...
    FillRect16(s_tile2_bmp_1050_1538, local_brush_handle_2, local_brush_handle);
...
pub fn  set_struct_op_1008_0536(mut param_1: *mut u16, HINSTANCE16 param_2, param_3: u16)
