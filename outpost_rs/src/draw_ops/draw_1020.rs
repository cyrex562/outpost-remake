...
use crate::pass::pass_1008::{
    pass1_1008_3e76, pass1_1008_3e94, pass1_1008_41bc, pass1_1008_4480, pass1_1008_4772,
    pass1_1008_5118, pass1_1008_57a4, pass1_1008_5b12, pass1_1008_8b20, pass1_1008_941a,
};
use crate::pass::pass_1010::{
    pass1_1010_1ea6, pass1_1010_375e, pass1_1010_3770, pass1_1010_454a, pass1_1010_4c2c,
    pass1_1010_4dc8, pass1_1010_4df0, pass1_1010_ecc6,
};
use crate::pass::pass_1018::{
    pass1_1018_017c, pass1_1018_0a50, pass1_1018_0a76, pass1_1018_0d9a, pass1_1018_1054,
...
use crate::util::{
    read_string_from_addr, read_struct_from_addr, CONCAT11, CONCAT12, CONCAT13, CONCAT22, SUB42,
    ZEXT24,
};
use crate::win_platform::types::{COLORREF, HDC16, HWND16, RECT16};
...
pub fn unk_draw_op_1020_0000(param_1: u32, param_2: HWND16, param_3: u16) {
    ...
    pass1_1008_4480(
        pu_stack38,
        (param_1 & 0xffff0000 | (i_var5 + 0x18)),
        &mut read_struct_from_addr::<Struct76>((i_var5 + 0x24) as u32),
        param_3,
    );
    // pa_stack46 = 0x0;
    // TODO: refactor
...
pub fn draw_op_1020_041e(ctx: &mut AppContext, param_1: u32, param_2: u16) {
    fill_rect_1020_065e(ctx, (param_1 + 0xe6), param_2);
    return;
}

pub fn fill_rect_1020_065e(ctx: &mut AppContext, param_1: u32, in_win_handle_2: HWND16) {
    let ppc_var1: u32;
    let u_var2: u32;
    let i_var3: i16;
    let u_var4: u16;
    ...
    DeleteObject16(ctx.s_tile2_bmp_1050_1538);
    EndPaint16(ctx.s_tile2_bmp_1050_1538, &mut paint_1);
    return;
}

pub fn unk_draw_op_1020_0c3e(ctx: &mut AppContext, param_1: u32, param_2: HWND16) {
    let pu_var1: u32;
    let ppc_var2: u32;
    let u_var3: u32;
...
pub fn win_ui_palette_op_1020_0cd2(
    ctx: &mut AppContext,
    param_1: u32,
    param_2: HWND16,
    extraout_dx: u16,
    ...
    if (u_var5 != 0x0) {
        ...
        struct_1 = read_struct_from_addr::<Struct13>(CONCAT22(extraout_dx, u_var5));
    ...
    if (bvar3 == false) {
        ...
        if ((u_var4 | u_var7) != 0x0) {
            ...
            pass1_1008_4480(
                ...
                read_struct_from_addr(u_var7 & 0xffff | u_var4 << 0x10),
                unaff_ss,
            );
        }
        ...
        draw_op_1020_1674(ctx, param_1, ctx.s_tile2_bmp_1050_1538);
    }
    EndPaint16(hwnd, &mut paint_1);
    return;
}

pub fn draw_op_1020_1674(ctx: &mut AppContext, struct_1: i32, obj_id: i16) {
    let func_ptr_1: U32Ptr;
    let var2: u16;
    let mut rect_1 = RECT16::new();
    let var4: u16;
    let var5: i16;
    ...
    if ctx.PTR_LOOP_1050_0010 == 0x0 {
        // u_var2 = (param_1 >> 0x10);
        func_ptr_1 = ((struct_1 + 0x14) + 0x2c) as u32;
        var12 = (**func_ptr_1)(obj_id, (struct_1 + 0x14));
        if var12 != 0x0 {
            obj_handle_1 = GetStockObject16(obj_id);
            GetClientRect16(ctx.s_tile2_bmp_1050_1538 as u16, &mut rect_2);
            // local_1a = 0x0;
            var4 = 0x0;
            var5 = (var9 - rect_2.x) + -0x1;
            var6 = (var11 - rect_2.y) + -0x1;
            var7 = var6;
            var8 = var5;
            FillRect16(ctx.s_tile2_bmp_1050_1538 as u16, &rect_1, obj_handle_1);
            DrawIcon16(ctx.s_tile2_bmp_1050_1538 as u16, var12, 0x2, 0x2);
        }
    }
    return;
}
...
pub fn invalidate_rect_1020_1fb2(
    ...
    u_stack6 = 0x46;
    u_stack20 = 0x46;
    i_stack18 = u_stack10 - local_e.x;
    u_stack4 = 0x5f;
    u_stack16 = 0x5f;
    InvalidateRect16(ctx.s_tile2_bmp_1050_1538, &local_16, false);
    return;
}
...
pub unsafe fn unk_draw_op_1020_2020(
    ...
    while (ptr_1 + -0x38) < (ptr_1 + -0x28) {
        ...
        pass1_1020_2286(
            ...
            &mut CONCAT13(
                (param_3 >> 0x8),
                CONCAT12(param_3 as u8, (ptr_1 + -0x30) as u16),
            ),
            ((u_var17 + 0x8) as i16),
        );
        u_var2 = (ptr_1 + -0x30);
        ...
        pass1_1008_4480(
            (ptr_1 + -0x26),
            CONCAT22(param_3, (ptr_1 + -0x36) as u16),
            read_struct_from_addr(u_var2 + i_var12),
            param_3,
        );
        ...
        if ((i_var21 + 0x1a) == 0x0) {
            ...
            mem_op_1000_179c(
                ctx,
                u_var4,
                read_struct_from_addr::<Struct79>(pu_var10),
                0x1000,
            );
        ...
        u_var2 = (ptr_1 + -0x44);
        pi_var18 = (ptr_1 + -0x2e);
        *pi_var18 = *pi_var18 + (-((ptr_1 + -0x38) == 0x0) & 0x5) + 0x14 + (u_var2 + 0x4);
        pi_var18 = (ptr_1 + -0x38);
    ...
    hvar9 = CreateSolidBrush16(ctx.s_tile2_bmp_1050_1538);
    (ptr_1 + -0x3e) = hvar9 as u32;
    hvar8 = SelectObject16(ctx.s_tile2_bmp_1050_1538, hvar9);
    (ptr_1 + -0x40) = hvar8 as u32;
    draw_line_1020_229c(ctx, (ptr_1 + 0x6), ctx.s_tile2_bmp_1050_1538);
    u_var2 = (ptr_1 + 0x6);
    ...
    if (hvar8 == 0x0) {
        ...
        hvar9 = CreateSolidBrush16(ctx.s_tile2_bmp_1050_1538);
        (ptr_1 + -0x3e) = hvar9 as u32;
        hvar7 = CreatePen16(ctx.s_tile2_bmp_1050_1538, 0xff, 0x0);
        (ptr_1 + -0x3a) = hvar7 as u32;
    ...
    SelectObject16(ctx.s_tile2_bmp_1050_1538, ((ptr_1 + -0x40) as u16));
    DeleteObject16(ctx.s_tile2_bmp_1050_1538);
    EndPaint16(ctx.s_tile2_bmp_1050_1538, (ptr_1 + -0x20));
    return;
}

pub fn draw_line_1020_229c(ctx: &mut AppContext, struct_1: u32, dc_handle: HDC16) {
    let var1: i16;
    let var2: i16;
    let var3: u32;
    let var4: i16;
...
pub fn realize_palette_1020_2992(ctx: &mut AppContext, param_1: i32, param_2: i16) {
    let ppc_var1: u32;
    let pu_var2: u32;
    ...
    if (param_2 != 0x0) {
        ...
        GetDC16(ctx.s_tile2_bmp_1050_1538);
        RealizePalette16(ctx.s_tile2_bmp_1050_1538);
    }
    return;
}
...
pub unsafe fn invalidate_rect_1020_2ae4(
    ...
    if (param_2 != 0x129) {
        ...
        if (param_2 == 0xfb) {
            pu_var6 = mixed_1010_20ba(ctx.PTR_LOOP_1050_0ed0, 0x30, param_4, in_dx, unaff_di);
        ...
        if (param_2 < 0xfc) {
            ...
            if (c_var2 == 'o') {
                ...
                let help_file_string: &String =
                    read_string_from_addr(ctx.s_New_failed_in_Op__Op_1050_0020 + 0xa);
                WinHelp16(0x1010, help_file_string, 0x0, CONCAT22(pa_var8, 0x1));
                return;
            }
            if (c_var2 == 'r') {
...
pub fn load_draw_op_1020_2ede(ctx: &mut AppContext, param_1: U32Ptr, param_2: u32, param_3: u16) {
    ...
    *(i_var6 + 0x18) = hvar3;
    ...
    u_var1 = (i_var6 + 0x14) as u32;
    u_var1 = (u_var1 + 0x64);
    handle = CreatePen16(ctx.s_tile2_bmp_1050_1538, u_var1 as i16, (u_var1 >> 0x10));
    (i_var6 + 0x1a) = handle as i16;
    hvar5 = SelectObject16(ctx.s_tile2_bmp_1050_1538, handle);
    (i_var6 + 0x1c) = hvar5 as i16;
    hvar5 = GetStockObject16(ctx.s_tile2_bmp_1050_1538);
...
pub fn draw_op_1020_30be(ctx: &mut AppContext, param_1: u32, param_2: HWND16, param_3: u16) {
    ...
    if (bvar3 == 0x0) {
        ...
        if ((u_var2 + 0x84) == 0x1) {
            unk_draw_op_1020_320e(ctx, param_1, local_24, param_3);
        }
        ...
        draw_op_1020_3488(ctx, param_1 as i32);
        ...
        if ctx.PTR_LOOP_1050_0010 == 0x0 {
            ...
            if i_stack38 != 0x0 {
                p_rstack40 = GetStockObject16(ctx.s_tile2_bmp_1050_1538);
...
pub fn unk_draw_op_1020_320e(ctx: &mut AppContext, param_1: u32, param_2: HDC16, param_3: u16) {
    ...
    if ((u_var3 + 0x84) == 0x1) {
        ...
        init_data = 0x0;
        u_var8 = pass1_1008_4772((pu_var1 & 0xffff | (i_var5 + 0x26) << 0x10));
...
pub fn draw_op_1020_33c0(
    ...
    if (param_3 != 0x0) {
        ...
        brush_handle = CreateSolidBrush16(ctx.s_tile2_bmp_1050_1538);
...
pub fn draw_op_1020_3488(ctx: &mut AppContext, param_1: i32) {
    ...
    hvar4 = GetStockObject16(ctx.s_tile2_bmp_1050_1538);
...
pub fn unk_draw_op_1020_3da4(ctx: &mut AppContext, param_1: &mut Struct24, param_2: i32) {
    ...
    (i_var8 + 0x2) = 0x1020;
    pu_var10 = mixed_1010_20ba(ctx.PTR_LOOP_1050_0ed0, 0x6, unaff_ss, in_dx, unaff_di);
...
pub fn validate_rect_1020_3f12(ctx: &mut AppContext, param_1: u32, param_2: i16, param_3: HWND16) {
    ...
    local_a = 0xf10000;
    u_stack6 = 0x1220030;
    ValidateRect16(ctx.s_tile2_bmp_1050_1538, &local_a);
    local_a = 0xf100f5;
    u_stack6 = 0x1220127;
    ValidateRect16(ctx.s_tile2_bmp_1050_1538, &local_a);
    return;
...
pub fn pass1_1020_4064(ctx: &mut AppContext, param_1: &mut Struct18, param_2: u8) {
    win_ui_palette_op_1020_3e84(ctx, param_1);
    if ((param_2 & 0x1) != 0x0) {
...
pub fn draw_rect_1020_40ce(
    ...
    Ellipse16(
        0x1008,
        i_var1 + local_6 + param_2,
        i_var1 + local_4 + param_3,
    ...
    if (((param_1 + 0xe) & 0x1) != 0x0) {
        ...
        handle = CreatePen16(ctx.s_tile2_bmp_1050_1538, 0xf9, 0x100);
...
pub unsafe fn unk_draw_op_1020_41c8(
    ...
    unk_draw_op_1020_7f7a(ctx, param_1, 0x8, CONCAT22(param_3, param_2) as i32);
    // u_var7 = (param_1 >> 0x10);
    u_var5 = param_1;
...
pub unsafe fn set_cursor_1020_5764(ctx: &mut AppContext, param_1: u32, param_2: i16, param_3: u16) {
    ...
    pu_stack6 = mixed_1010_20ba(ctx.PTR_LOOP_1050_0ed0, 0x2f, param_3, in_dx, unaff_di);
...
pub fn pt_in_rect_1020_5856(param_1: u32, param_2: &POINT16, param_3: u16) {
    ...
    if ((in_dx | param_3) != 0x0) {
        ...
        loop {
            ...
            if (*pu_var1 < u_stack10 || *pu_var1 == u_stack10) {
                break;
            }
            u_var3 = u_stack10;
        ...
        if (var3 == 0x0) {
            ...
            if (var3 != 0x0) {
                ...
                pt_in_rect_1020_5856(
                    param_1,
                    CONCAT22(param_6, u_stack30 as u16),
                    u_stack30 as u16,
                );
                    ...
                    if ((pu_stack26 == 0xb) || (pu_stack26 == 0x37)) {
                        ...
                        if ((u_var5 | u_stack46) != 0x0) {
                            ...
                            pass1_1018_161c(
                                param_6,
                                u_stack46,
                                CONCAT22(param_6, local_34),
                                u_stack18 as i16,
                                u_stack20 as i16,
                            );
                            pu_stack38 = mixed_1010_20ba(
                                ctx.PTR_LOOP_1050_0ed0,
                                0x2f,
                                param_6,
                                pu_var6,
...
pub fn mix_draw_op_1020_650c(
    ...
    if ((i_var3 + 0x10) != 0x0) || (u_var2 = (i_var3 + 0x14) as u32, (u_var2 + 0x24) != 0x0) {
        draw_op_1020_9364(ctx, param_1, param_2, param_3 as i16);
        if (i_var3 + 0x24) != 0x0 {
    ...
    EndPaint16(ctx.s_tile2_bmp_1050_1538, &local_28);
    return;
}
...
pub fn draw_op_1020_7cc8(
    ...
    if ((is_iconic == 0x0) || (ctx.PTR_LOOP_1050_0010 != 0x0)) {
        local_hdc_1 = GetWindowDC16(ctx.s_tile2_bmp_1050_1538);
        pa_stack10 = (ctx.PTR_LOOP_1050_4230 + 0xe);
        ...
        handle = CreatePen16(ctx.s_tile2_bmp_1050_1538, color as i16, 0x100);
        handle_00 = SelectObject16(ctx.s_tile2_bmp_1050_1538, handle);
        ...
        SelectObject16(ctx.s_tile2_bmp_1050_1538, handle_00);
        DeleteObject16(ctx.s_tile2_bmp_1050_1538);
        ReleaseDC16(ctx.s_tile2_bmp_1050_1538, local_hdc_1);
    }
    return;
}
...
pub fn unk_draw_op_1020_7f7a(
    ...
    pa_var6 = unk_draw_op_1008_61b2(
        ...
        param_2,
        param_3 as u16,
        CONCAT22(in_stack_0000000e, param_3._2_2_) as u16,
        unaff_ss as i32,
    );
    ...
    hvar3 = LoadCursor16(ctx.s_tile2_bmp_1050_1538, 0x7f00);
    i_var4.hcursor_field_0xc4 = hvar3;
    i_var4.field_0xc8 = 0x2028;
    i_var4.field_0xac = 0x47000000;
    i_var4.field_0xbc = (param_3._2_2_ + 0x8);
    pu_var7 = mixed_1010_20ba(ctx.PTR_LOOP_1050_0ed0, 0x48, unaff_ss, pu_var4, unaff_di);
    // u_var1 = (pu_var7 >> 0x10);
...
pub fn win_ui_palette_op_1020_81c0(ctx: &mut AppContext, param_1: HWND16) {
    ...
    u_var3 = (ctx.PTR_LOOP_1050_4230 >> 0x10);
    in_struct_1 = (ctx.PTR_LOOP_1050_4230 + 0xe);
    u_var2 = (ctx.PTR_LOOP_1050_4230 + 0x10);
...
pub fn invalidate_rect_1020_8d90(
    ...
    if u_stack6 != 0x0 {
        ...
        if (param_5 | u_stack6) != 0x0 {
            ...
            pass1_1008_41bc(ctx, CONCAT22(param_6, local_38));
        }
    }
    return;
}
...
pub fn draw_op_1020_9364(
    ...
    loop {
        ...
        hstack50 = CreatePen16(ctx.s_tile2_bmp_1050_1538, u_var4 as i16, (u_var4 >> 0x10));
    ...
    p_rvar6 = CreateSolidBrush16(ctx.s_tile2_bmp_1050_1538);
    ...
    local_12 = local_12 & 0xffff | ((i_stack20 * 0x2 + pu_stack26) + 0x1) << 0x10;
    ...
    loop {
        ...
        LineTo16(
            ctx.s_tile2_bmp_1050_1538,
            ((i_stack20 - *pi_var1) * 0x2 + pu_stack26),
            i_var3 + local_a.x,
        );
