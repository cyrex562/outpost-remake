...
pub fn pass1_1040_d1bc(globals: &mut Globals, Struct18 *param_1)
...
pub fn pass1_1040_ca74(globals: &mut Globals, Struct18 *param_1)
...
pub fn pass1_1040_c94a(globals: &mut Globals, Struct380* param_1, param_2: u16, mut param_3: *mut u8, param_4: i16, param_5: u16, param_6: u16)
...
pub fn palette_op_1040_c886(Globals *globals, param_1: u32, param_2: u8, param_3: u16, param_4: HDC16)
...
pub fn  draw_op_1040_c74c(u32 *param_1, param_2: u32, param_3: u16)

{
    ...
    handle             = CreatePen16(s_tile2_bmp_1050_1538, 0x2, 0x100);
    HVar4              = SelectObject16(s_tile2_bmp_1050_1538, HVar4);
    handle_00          = SelectObject16(s_tile2_bmp_1050_1538, handle);
    Rectangle16(s_tile2_bmp_1050_1538, (iVar5 + 0x24), (iVar5 + 0x22), 0x0, 0x0);
    MoveTo16(s_tile2_bmp_1050_1538, 0x0, (iVar5 + 0x36) * 0x2 + (iVar5 + 0x2a));
    LineTo16(s_tile2_bmp_1050_1538, (iVar5 + 0x24), (iVar5 + 0x36) * 0x2 + (iVar5 + 0x2a));
    SelectObject16(s_tile2_bmp_1050_1538, HVar4);
    HVar4 = SelectObject16(s_tile2_bmp_1050_1538, handle_00);
    DeleteObject16(s_tile2_bmp_1050_1538);
    uVar3   = *param_1;
    ppcVar2 = (uVar3 + 0x10);
...
pub fn unk_draw_op_1040_c226(param_1: u32, HWND16 param_2, param_3: u16)

{
    ...
    FrameRect16(s_tile2_bmp_1050_1538, pRStack38, &local_32);
    DeleteObject16(s_tile2_bmp_1050_1538);
...

{
    ...
    if(0x1 < iVar6)
    {
        ...
        uVar1 = uVar1 & 0xffff0000;
        uVar7 = (uVar1 >> 0x10);
        LineTo16(s_tile2_bmp_1050_1538, (iVar6 + 0x20), (iVar6 + 0x22) / 0x2 + (uVar1 | iVar6 + 0x1e));
    }
    return;
}
...

{
    ...
    if((iVar7 != 0x0) && (uVar2 = (iVar8 + 0x6), (uVar2 + 0x16) != 0x0))
    {
        ...
        for(iStack26 = 0x0; iStack26 < iVar7; iStack26 = iStack26 + 0x1)
        {
            ...
            LineTo16(s_tile2_bmp_1050_1538, iVar5, *pIVar6 + -0xf);
            hdc      = s_tile2_bmp_1050_1538;
            DVar11   = GetCurrentPosition16(s_tile2_bmp_1050_1538);
        ...
        LineTo16(s_tile2_bmp_1050_1538, (iVar7 + 0x24) / 0x2 + (iVar7 + 0x20), IStack16);
        DVar11 = GetCurrentPosition16(s_tile2_bmp_1050_1538);
        iVar7  = (DVar11 >> 0x10);
        if(iVar7 < iStack14)
        {
        ...
        MoveTo16(s_tile2_bmp_1050_1538, iStack14, IStack16);
        LineTo16(s_tile2_bmp_1050_1538, iStack18, IStack20);
    }
    return;
}


pub fn invalidate_rect_1040_c028(param_1: u32, param_2: i16, HWND16 param_3, RECT16 *param_4)
...
Struct18 *pass1_1040_be94(Struct18 *param_1, param_2: u8)
...
u32 pass1_1040_b74c(Struct18 *param_1, param_2: u8)
...
pub fn win_ui_op_1040_b372(param_1: u32, param_2: u16, param_3: u16, COLORREF in_colorref_4)
...
pub fn pass1_1040_ace8(Struct18 *param_1)
...
Struct18 *pass1_1040_abe2(Struct18 *param_1, param_2: u8)
...
u16 *unk_win_ui_op_1040_9854(mut param_1: *mut u16, param_2: u16)
...
pub fn draw_op_1040_9948(param_1: u16, param_2: u32, HWND16 param_3, RECT16 *param_4)

{
    ...
    mode = SetMapMode16(s_tile2_bmp_1050_1538, 0x1);
    ...
    if(iVar4->field_0x6 != '\0')
    {
        ...
        {
            HStack30 = SelectObject16(s_tile2_bmp_1050_1538, iVar4->field_0x5a);
        }
    ...
    handle    = CreatePen16(s_tile2_bmp_1050_1538, DAT_1050_5ec2, (DAT_1050_5ec2 >> 0x10));
    handle_00 = CreatePen16(s_tile2_bmp_1050_1538, DAT_1050_5ebe, (DAT_1050_5ebe >> 0x10));
    handle_01 = SelectObject16(s_tile2_bmp_1050_1538, handle);
    if(uStack34 != 0x0)
    {
        iStack78 = 0x0;
        do
        {
            MoveTo16(s_tile2_bmp_1050_1538, iStack20, iStack26);
            LineTo16(s_tile2_bmp_1050_1538, iStack20, iStack22);
            LineTo16(s_tile2_bmp_1050_1538, iStack24, iStack22);
            LineTo16(s_tile2_bmp_1050_1538, iStack24, iStack26);
            LineTo16(s_tile2_bmp_1050_1538, iStack20, iStack26);
    ...
    if((iVar4->field_0x4 & 0x2) == 0x0)
    {
        ...
        do
        {
            ...
            MoveTo16(s_tile2_bmp_1050_1538, iStack80, iStack86);
            LineTo16(s_tile2_bmp_1050_1538, iStack80, iStack82);
            LineTo16(s_tile2_bmp_1050_1538, iStack84, iStack82);
            iStack88 = 0x0;
            do
            {
                SelectObject16(s_tile2_bmp_1050_1538, handle_00);
                LineTo16(s_tile2_bmp_1050_1538, iStack84, iStack86);
                LineTo16(s_tile2_bmp_1050_1538, iStack80, iStack86);
    ...
    {
        MoveTo16(s_tile2_bmp_1050_1538, uStack14._2_2_, local_12.x);
        LineTo16(s_tile2_bmp_1050_1538, local_12.y, local_12.x);
        LineTo16(s_tile2_bmp_1050_1538, local_12.y, uStack14 + 0x1);
        if(iStack28 != 0x0)
        {
            iStack8 = iStack8 + 0x2;
            local_a = local_a + 0x2;
    ...
    if(iStack28 != 0x0)
    {
        if((iVar4->field_0x4 & 0x4) == 0x0)
        {
            ...
            color_00 = SetTextColor16(s_tile2_bmp_1050_1538, color);
            color_01 = SetBkColor16(s_tile2_bmp_1050_1538, 0x0);
            uVar3    = str_op_1000_3da4((param_2 & 0xffff0000 | ZEXT24(&iVar4->field_0x6)));
            DrawText16(0x1000, (&PTR_LOOP_1050_0000 + 0x1), &local_a, param_4, uVar3);
            SetTextColor16(s_tile2_bmp_1050_1538, color_00);
            SetBkColor16(s_tile2_bmp_1050_1538, color_01);
        }
        else
        {
            ...
            GrayString16(0x1000, iStack4 - iStack8, (iStack6 - local_a), CONCAT22(local_a, iStack8), uVar3, x, y, cx, cy);
        }
        if(HStack30 != 0x0)
        {
    ...
    SelectObject16(s_tile2_bmp_1050_1538, handle_01);
    SetMapMode16(s_tile2_bmp_1050_1538, mode);
    DeleteObject16(s_tile2_bmp_1050_1538);
    DeleteObject16(s_tile2_bmp_1050_1538);
...
pub fn mixed_draw_op_1040_8a06(param_1: u32, HWND16 param_2, param_3: u16)

{
    ...
    color    = SetBkColor16(s_tile2_bmp_1050_1538, 0x0);
    color_00 = SetTextColor16(s_tile2_bmp_1050_1538, CONCAT11(uVar1, uVar2));
    HStack62 = 0x0;
    handle   = GetProp16((HWND16)s_tile2_bmp_1050_1538, 0x5dfa);
    if(handle != 0x0)
    {
        HStack62 = SelectObject16(s_tile2_bmp_1050_1538, handle);
    }
    DrawText16(s_tile2_bmp_1050_1538, &PTR_LOOP_1050_0010, param_1 + 0x9e, rect, 0xffff);
    if(handle != 0x0)
    {
        SelectObject16(s_tile2_bmp_1050_1538, HStack62);
    }
    SetBkColor16(s_tile2_bmp_1050_1538, color);
    SetTextColor16(s_tile2_bmp_1050_1538, color_00);
    SelectPalette16(s_tile2_bmp_1050_1538, 0x0, b_force_background);
    DeleteObject16(s_tile2_bmp_1050_1538);
    EndPaint16((HWND16)s_tile2_bmp_1050_1538, &local_22);
...
pub fn pass1_1040_8e82(Struct18 *param_1)
...
pub fn pass1_1040_9252(param_1: u32, param_2: u16)
...
pub fn unk_draw_op_1040_9458(astruct_17 *param_1, param_2: u8, param_3: u16, param_4: HDC16)
...
pub fn draw_text_1040_94fc(astruct_37 *param_1, param_2: HDC16)

{
    ...
    color_00 = SetTextColor16(s_tile2_bmp_1050_1538, iVar1->field_0x3c);
    DrawText16(s_tile2_bmp_1050_1538, &PTR_LOOP_1050_0010, &iVar1->field_0x2e, rect, 0xffff);
    SetBkColor16(s_tile2_bmp_1050_1538, color);
    SetTextColor16(s_tile2_bmp_1050_1538, color_00);
    return;
}
...
pub fn draw_text_1040_9650(param_1: u32, HWND16 param_2)

{
    HDC16 hdc;

    hdc = GetDC16(param_2);
    DrawText16(s_tile2_bmp_1050_1538, 0x410, param_1 + 0x2e, (param_1 >> 0x10), 0xffff);
    ReleaseDC16((HWND16)s_tile2_bmp_1050_1538, hdc);
    return;
}


pub fn draw_op_1040_82ee(astruct_15 *param_1, COLORREF in_colorref_2)

{
    ...
    FrameRect16(s_tile2_bmp_1050_1538, l_brush_handle, &iVar1->field_0x82);
    FrameRect16(s_tile2_bmp_1050_1538, l_brush_handle, &local_12);
    DeleteObject16(s_tile2_bmp_1050_1538);
...
u32 set_text_bk_color_1040_7e5e(u32 *param_1, param_2: u16, param_3: u16, param_4: u16)
...
pub fn draw_op_1040_7bb2(astruct_14 *in_struct_1, HWND16 in_win_handle_2, param_3: u16)

{
    ...
    if(BVar2 == 0x0)
    {
        ...
        if(uStack8 != (astruct_13 *)0x0)
        {
            ...
            handle_00 = SelectObject16(s_tile2_bmp_1050_1538, handle);
            MoveTo16(s_tile2_bmp_1050_1538, 0x0, 0x0);
            LineTo16(s_tile2_bmp_1050_1538, 0x0, y);
            LineTo16(s_tile2_bmp_1050_1538, iVar3, y);
            LineTo16(s_tile2_bmp_1050_1538, iVar3, 0x0);
            LineTo16(s_tile2_bmp_1050_1538, 0x0, 0x0);
            ...
            if(((uVar4 & 0x800000) != 0x0) && ((uVar4 & 0x400000) != 0x0))
            {
                ...
                if(*count != '\0')
                {
                    ...
                    if(handle_01 != 0x0)
                    {
                        local_obj_handle_42 = SelectObject16(s_tile2_bmp_1050_1538, handle_01);
                    }
                    SetBkColor16(s_tile2_bmp_1050_1538, 0x0);
                    SetTextColor16(s_tile2_bmp_1050_1538, color);
                    str   = lstrlen16(s_tile2_bmp_1050_1538);
                    DVar5 = GetTextExtent16(s_tile2_bmp_1050_1538, str, count);
                    TextOut16(s_tile2_bmp_1050_1538, str, count, str_00, (iVar4->field_0x80 - iVar4->field_0x7c) / 0x2 - (DVar5 >> 0x10) / 0x2);
                    if(handle_01 != 0x0)
                    {
                        SelectObject16(s_tile2_bmp_1050_1538, local_obj_handle_42);
                    }
                }
            }
            ppcVar1 = (in_struct_1 + 0x64);
            (**ppcVar1)(s_tile2_bmp_1050_1538, in_struct_1, uStack8, local_hdc_4);
            HStack10 = SelectPalette16(s_tile2_bmp_1050_1538, 0x0, HStack10);
            DeleteObject16(s_tile2_bmp_1050_1538);
            SelectObject16(s_tile2_bmp_1050_1538, handle_00);
            DeleteObject16(s_tile2_bmp_1050_1538);
        }
...
Struct18 *pass1_1040_767e(Struct18 *param_1, param_2: u8)
...
Struct18 *pass1_1040_6360(Struct18 *param_1, param_2: u8)
...
pub fn pass1_1040_6862(Struct18 *param_1)
...
Struct18 *pass1_1040_4df2(Struct18 *param_1, param_2: u8)
...
pub fn pass1_1040_4f0a(Struct18 *param_1)
...
pub fn draw_op_1040_5a06(param_1: u32, HWND16 param_2, param_3: u16)

{
    ...
    MoveTo16(s_tile2_bmp_1050_1538, iVar5, 0x82);
    iStack68 = uVar4;
    y        = iStack68 * 0xa + 0x85;
    LineTo16(s_tile2_bmp_1050_1538, iVar5, y);
    HVar18 = local_2c;
    LineTo16(s_tile2_bmp_1050_1538, x, y);
    HVar17 = local_2c;
    LineTo16(s_tile2_bmp_1050_1538, x, 0x82);
    HVar16 = local_2c;
    LineTo16(s_tile2_bmp_1050_1538, iVar5, 0x82);
...
u16 get_dc_op_1040_3d5e(param_1: u32, HWND16 param_2, param_3: u16)
...
pub fn invalidate_rect_1040_3ddc(astruct_2 *in_struct_1, HWND16 in_win_handle_2)

{
    ...
    uStack6       = 0xdc0069;
    InvalidateRect16(in_win_handle_2, 0x0, (BOOL16)&local_b_erase);
    return;
}


Struct18 *pass1_1040_47fe(Struct18 *param_1, param_2: u8)
...
u32 draw_ui_op_1040_27cc(u32 *param_1, param_2: u16, param_3: u16, COLORREF param_4)
...
pub fn pass1_1040_2a22(Struct18 *param_1)
...
pub fn mix_draw_op_1040_21d6(param_1: u32, HWND16 param_2, param_3: u16)

{
    ...
    DrawText16(s_tile2_bmp_1050_1538, &PTR_LOOP_1050_0010, iVar6 + 0x92, rect, 0xffff);
    SetTextColor16(s_tile2_bmp_1050_1538, CONCAT11(*(iVar5 + 0x95), *(iVar5 + 0x96)));
    DrawText16(s_tile2_bmp_1050_1538, &PTR_LOOP_1050_0010, iVar6 + 0x9a, rect, 0xffff);
    if(handle != 0x0)
    {
        SelectObject16(s_tile2_bmp_1050_1538, HStack62);
    }
...
u32 set_text_bk_color_1040_0cc0(u32 *param_1, param_2: u16, param_3: u16, param_4: u16)
...
pub fn draw_op_1038_9dcc(astruct_10 *in_struct_1, param_2: i16, param_3: u16, COLORREF in_colorref_4, param_5: u16)
...
u16 call_fn_ptr_1038_9ffa(HWND16 win_handle, param_2: u16, astruct_733 *struct_1, param_4: u16)
...
pub fn unk_win_ui_op_1038_ac38(param_1: u16, param_2: u16)
...
pub fn pass1_1038_ae08(Struct18 *param_1)
...
pub fn pass1_1038_893a(Struct18 *param_1)
...
pub fn pass1_1038_8cf6(Struct18 *param_1)
...
pub fn draw_op_1038_92f6(param_1: u16, param_2: u16, param_3: u16, param_4: u32, HWND16 param_5, param_6: u16)
...
Struct18 *pass1_1038_997c(Struct18 *param_1, param_2: u8)
