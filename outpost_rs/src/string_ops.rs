...
void string_1040_a626(Struct381 *param_1, param_2: &mut String, param_3: u16)
...
{
     let mut char_var_1: u8;
     let mut char_var_2: u8;
//    i16  iVar3;
//     let mut uVar4: u16;
...
void pass1_1038_4d3c(Struct385 *param_1, param_2: &mut String, param_3: u16)
...
cstring pass1_1020_bd80(Globals *globals, param_1: u16)

{
    ...
    pcVar1 = load_string_1010_847e(globals._PTR_LOOP_1050_14cc, (globals._PTR_LOOP_1050_14cc >> 0x10), 0x1010);
    return pcVar1;
}

void string_1020_c0ca(Globals *globals, param_1: u16)
...
cstring string_1020_c0d8(Globals *globals, param_1: u16)
...
cstring *string_op_1020_c2f8(Globals *globals, param_1: u16)
...
void pass1_1020_6e52(Globals *globals, param_1: u16, param_2: u16, param_3: u16, param_4: i16, param_5: u16, param_6: i16)

{
    ...
    if(uVar1 == 0x0)
    {
        pcVar2 = load_string_1010_847e(globals._PTR_LOOP_1050_14cc, (globals._PTR_LOOP_1050_14cc >> 0x10), 0x1010);
    }
    else
    {
...
void spri16f_op_1018_34b6(param_1: u32, param_2: u8)
...
void unk_str_op_1018_35b0(param_1: u32, param_2: u16, param_3: u16)
...
BOOL16 string_1018_39d8(param_1: u16, param_2: u32, param_3: u32, param_4: u32)

{
    ...
    uVar4  = param_3;
    pcVar2 = load_string_1010_847e(_PTR_LOOP_1050_14cc, (_PTR_LOOP_1050_14cc >> 0x10), 0x1010);
...
void pass1_1010_dc36(param_1: u16, param_2: u16, param_3: u16, param_4: u32, mut param_5: *mut u16, param_6: u16)
...
void load_str_1010_ddf6(param_1: u32, param_2: u32)
...
void pass1_1010_de78(param_1: u32, param_2: u32)
...
char *load_string_1010_ac92(HINSTANCE16 param_1, param_2: u16, param_3: u16, param_4: i16)

{
    ...
    {
        pcVar1 = load_string_1010_847e(_PTR_LOOP_1050_14cc, (_PTR_LOOP_1050_14cc >> 0x10), param_1);
        return pcVar1;
    }
    return 0x0;
}

char *string_op_1010_ada6(HINSTANCE16 param_1, param_2: u16, param_3: u16, param_4: u16, param_5: i16, param_6: i16)
...
LAB_1010_adee:
    if(pcStack6 == 0x0)
    {
        pcStack6 = load_string_1010_847e(_PTR_LOOP_1050_14cc, (_PTR_LOOP_1050_14cc >> 0x10), param_1);
    }
    return pcStack6;
}
...

{
    ...
    pcVar1 = load_string_1010_847e(globals._PTR_LOOP_1050_14cc, (globals._PTR_LOOP_1050_14cc >> 0x10), param_1);
    return pcVar1;
}

char *load_string_1010_847e(cstring param_1_str_buf, param_2_buf_len: u16, HINSTANCE16 param_3_hinstance)
...
void load_string_1010_84ac(param_1: i16, param_2: u16, HINSTANCE16 param_3)
...
void load_string_1010_84e0(HINSTANCE16 in_hinstance_5, param_2: u16, param_3: u16, u16 in_resc_id_3, char *in_buffer_4, short in_buf_len_5)
...
void pass1_1010_85be(param_1: u32, param_2: i16, param_3: i16, param_4: u16)
...

{
    ...
    load_string_1010_84ac(_PTR_LOOP_1050_14cc, (_PTR_LOOP_1050_14cc >> 0x10), 0x1000);
...

{
    ...
    pcVar1 = load_string_1010_847e(_PTR_LOOP_1050_14cc, (_PTR_LOOP_1050_14cc >> 0x10), 0x1010);
    return pcVar1;
}
...
void pass1_1008_e320(astruct_102 *param_1, param_2: u32, param_3: u32, param_4: u16)

{
    ...
    uVar7              = param_2;
    pcVar5             = load_string_1010_847e(_PTR_LOOP_1050_14cc, (_PTR_LOOP_1050_14cc >> 0x10), 0x1010);
    uVar4              = (pcVar5 >> 0x10);
...
void load_str_and_spri16f_1008_b69c(astruct_25 *param_1, WORD *param_2, mut param_3: *mut u8)
...
void load_str_and_spri16f_1008_b78a(param_1: u32, WORD *param_2, mut param_3: *mut u8, param_4: u16)
...
void pass1_1008_9c86(param_1: u32, param_2: &mut String, param_3: i16)
...
u32 *str_1008_6d8a(u32 *param_1, param_2: &mut String, param_3: u16, param_4: u16, param_5: u8)
...
void struct_op_1008_48fe(astruct_81 *param_1, param_2: u16, param_3: &mut String, param_4: u16)
...
void  pass1_1008_48de(param_1: u16, param_2: u32, param_3: i16, param_4: u16, mut param_5: *mut u16, param_6: i16, param_7: i16, mut param_8: *mut u8, param_9: u16, param_10: u16, char param_11, param_12: u16, param_13: u8)
...
void pass1_1008_049c(param_1: u16, param_2: u16, param_3: &mut String)
...
u16 str_op_1000_3da4(param_1: &mut String)
...
u8 str_op_1000_3dbe(param_1: &mut String, param_2: &mut String, param_3: u16)
...
cstring poss_str_op_1000_28dc(param_1: i16)

{
     let mut piVar1: *mut i16;
     let mut piVar2: String;
    i16     iVar2;
     let mut piVar3: String;
...
void pass1_1000_2913(param_1: i16, param_2: u16, param_3: u16)
